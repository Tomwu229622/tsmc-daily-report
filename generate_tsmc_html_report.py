...
STOCK = {
    # 台股 2330
    "tw_price":       "2,460",        # 台股 2330 7/6 Mon 官方收盤 NT$2,460（+15、+0.61% vs 7/3 收 NT$2,445、盤中高觸 NT$2,500）為最新確認收盤；7/7 Tue 盤中/官方收盤待 TWSE（NYSE 7/6 大反彈 +4.06% 為順風、ADR 溢價高、留意台股 7/7 補漲）
    "tw_change":      "+15",          # 7/6 Mon 收盤漲跌點數（+0.61%、連二跌後翻紅）
    "tw_change_pct":  "+0.61%",       # 7/6 Mon 收盤漲跌幅（收復失土、盤中高觸 NT$2,500 逼近史高）
    "tw_volume":      "19,239",       # 7/6 Mon 收盤成交量（張，wantgoo/histock 約 19,239–21,042 張）
    "tw_open":        "2,465",        # 7/6 開盤
    "tw_high":        "2,500",        # 7/6 盤中高（逼近 NT$2,535 史高）
    "tw_low":         "2,455",        # 7/6 盤中低
    "market_cap":     "NT$63.8 兆",   # 7/6 收盤市值（NT$2,460 基礎）
    "pe_ratio":       "~36.2x",       # 台股 P/E（TTM，NT$2,460 基礎）
    "pb_ratio":       "~12.8x",       # 台股 P/B（股淨比，NT$2,460 基礎）
    "div_yield":      "~0.61%",       # 殖利率（NT$2,460 基礎）
    "52w_high_tw":    "2,535",        # 52 週/歷史高（2026-06-23 盤中觸 NT$2,535 史高）
    "52w_low_tw":     "780",          # 52 週低（2025-04-07）
    # NYSE TSM ADR
    "nyse_price":     "451.79",       # 7/6 Mon 官方收盤 $451.79（+$17.63、+4.06%；4:00 PM EDT、stockanalysis.com 確認、前收 7/2 $434.16、盤後 $450.35 -0.32%）為最新確認收盤——NYSE 7/6 假期後重新開盤即 V 型大反彈；NYSE 7/7 Tue 盤待今晚 GMT+8
    "nyse_change":    "+17.63",       # 7/6 漲跌（最新確認收盤、4:00 PM EDT；假期後強勢反彈、收復 7/1-7/2 全數跌幅）
    ...
    # 資料日期備註
    "data_note":      "報告日期：2026-07-07 Tue（最新確認收盤：台股 2330 7/6 Mon 官方收 NT$2,460（+15、+0.61% vs 7/3 NT$2,445、量約 19,239 張、盤中高觸 NT$2,500）；NYSE TSM 7/6 Mon 官方收 $451.79（+$17.63、+4.06%、stockanalysis.com 確認、前收 7/2 $434.16、盤後 $450.35 -0.32%）為最新確認收盤；台股 7/7 Tue 盤中/官方收盤待 TWSE、NYSE 7/7 盤待今晚 GMT+8）。⭐ 今日頭條——NYSE V 型大反彈、修正結束、Barclays $625 續挺：（1）🚀 NYSE TSM 7/6 假期後重新開盤即大漲 +4.06%（$451.79）、費半 SOX 同步 +3.92%、一舉收復 7/1（-6.98%）+ 7/2（-2.27%）兩日全數跌幅，殺盤結束、AI 半導體回神、確認為估值修正而非基本面惡化；（2）⚖️ 台股 2330 7/6 收 NT$2,460（+15、+0.61%）連二跌後翻紅、盤中高觸 NT$2,500 逼近 NT$2,535 史高——惟台股 7/6 盤已於 NYSE 7/6 反彈前收盤，尚未完整反映 +4.06% 利多；（3）📊 台美 ADR 溢價擴大——以 7/6 ADR $451.79 折合台股約 NT$2,893.71（wantgoo，匯率 ~32.0）vs 台股 7/6 NT$2,460、溢價約 +17.6%，隱含台股 7/7 具補漲空間；（4）🚀 分析師逆勢大幅續挺——Barclays 維持 TSM 目標價 $625（Overweight、自 7/6 收 $451.79 仍具約 +38.3% 空間）；Nomura NT$3,425（自 NT$2,460 具 +39.2% 空間）、指 AI 基礎設施投資循環尚未見頂、估 2027 資料中心新增產能達 ~32GW；⚠️ 惟 Goldman Sachs 7/1 將 TSM 移出「APAC Conviction List」（戰術性調整、非降評）。（5）🤝 產業利多——NVIDIA 與 SK 海力士宣布多年期記憶體技術合作、共推 AI 工廠次世代記憶體；NVIDIA 與 TSMC 將 AI/加速運算導入晶圓廠設計與製造（提升週期時間、能效、良率）；BofA 上修 2026 全球半導體市場至 $1.3 兆（原 $1.0 兆）、2030 上看 $2 兆；生成式 AI 晶片估 2026 貢獻 ~$500B（約全球晶片銷售半數）；Qualcomm 推無 HBM 資料中心晶片挑戰 NVIDIA。⭐ 漲價題材續發酵——TSMC 全先進製程（7nm 以下、佔晶圓營收 ~75%）調漲 5-10%，估全年毛利率 +2pp 以上，惟客戶（Apple/NVIDIA/AMD/Qualcomm/Broadcom/MediaTek）成本升；Benzinga 指 NVIDIA 因需求剛性、長期反為利多。⚠️ 近期營收疑慮續存——4-5 月營收合計 +24% YoY 落後華爾街 Q2 約 +35% 預期，6 月營收（7 月上旬公布）為關鍵 catalyst、僅需小幅月增即可使 Q2 營收逼近指引中值。⭐ 中長線結構性利多基底未變：TSMC-Amkor 10 年美國先進封裝長約（Peoria AZ $70 億、2028 投產）、Winbond 特殊 DRAM 自主供應、NVIDIA 確認第 1 大客戶（22%/$33B）+ A16 首發 2026 下半/2027 量產（Apple 跳過 A16 直上 A14）+ Vera Rubin 平台 6 顆晶片全數 TSMC 代工（3nm + HBM4）、2nm 量產 70-80% 良率、2nm/A16 產能 2026-28 估 CAGR ~70%。  |  🎯 即將事件：6 月營收 7 月上旬公布（關鍵 catalyst、攸關 Q2 指引達成）；Q2 2026 財報法說會 7/16（指引 $39.0-40.2B、毛利率 65-67%、漲價後上修空間）  |  ⭐ 中長線基底：5 月營收 NT$4,169.75 億 +30.1% 創單月新高；2nm 量產良率 70-80% 領先全球；NVIDIA 第 1 大客戶 22%/$33B；4 大美國 CSP 2026 AI CapEx 合計 $725B（+77% YoY）；BofA 估 2026 全球半導體市場 $1.3 兆；費半（SOX）YTD +47%  |  ⚠️ 本日（7/7）關鍵觀察：（1）台股 7/7 盤中能否補漲、上攻 NT$2,500 / NT$2,535 史高（NYSE 7/6 +4.06% + ADR 溢價 +17.6% 為順風）；（2）下方支撐 NT$2,445 / NT$2,410 / NT$2,370；上方壓力 NT$2,500 / NT$2,535 史高；（3）NYSE 7/7 盤能否延續反彈、美股半導體動能；（4）⚠️ 估值警示：TSM P/E ~39.3x、台股 P/E ~36.2x，留意 6 月營收 miss 風險、下游需求疲弱與漲價客戶反彈",
}
...
SUMMARY = {
    ...
    "sentiment":  "看多",
    # 一句話標題
    "headline":   "🚀 NYSE V 型大反彈、修正結束：NYSE TSM 7/6 假期後重開即漲 +4.06%（$451.79）收復 7/1-7/2 全數跌幅、費半 +3.92%；台股 2330 7/6 收 NT$2,460（+0.61%）連二跌後翻紅、盤中觸 NT$2,500；ADR 溢價 +17.6% 隱含台股 7/7 補漲空間；Barclays 續挺目標 $625",
    ...
    "bullets": [
        ...
        "⚖️ 台股 2330 7/6 Mon 官方收 NT$2,460（+15、+0.61%、量約 19,239 張）——連二跌後翻紅、盤中高觸 NT$2,500 逼近 NT$2,535 史高；惟台股 7/6 盤已於 NYSE 反彈前收盤、尚未完整反映利多",
        "📊 台美 ADR 溢價擴大至約 +17.6%（7/6 ADR $451.79 折合台股約 NT$2,893.71 vs 台股 NT$2,460）——隱含台股 7/7 具明顯補漲空間，留意 7/7 盤中能否上攻 NT$2,500 / NT$2,535 史高",
        "🚀 分析師逆勢大幅續挺：Barclays 維持 TSM 目標 $625（Overweight、自 $451.79 仍具 +38.3% 空間）；Nomura NT$3,425（自 NT$2,460 具 +39.2% 空間）；平均目標約 $490 強力買入；⚠️ 惟 Goldman 7/1 移出 APAC Conviction List（戰術調整、非降評）",
    ...
    # 一句結論
    "bottom_line": "報告日期：2026-07-07 Tue（最新確認收盤：台股 2330 7/6 Mon 官方收 NT$2,460（+15、+0.61% vs 7/3 NT$2,445、量約 19,239 張、盤中高觸 NT$2,500）；NYSE TSM 7/6 Mon 官方收 $451.79（+$17.63、+4.06%、stockanalysis.com 確認、前收 7/2 $434.16、盤後 $450.35 -0.32%）為最新確認收盤；台股 7/7 Tue 盤中/官方收盤待 TWSE、NYSE 7/7 盤待今晚 GMT+8）。⭐ 今日頭條——NYSE V 型大反彈、修正結束、分析師續大幅看多：（1）🚀 NYSE TSM 7/6 假期後重新開盤即大漲 +4.06%（+$17.63）收 $451.79、費半 SOX 同步 +3.92%——一舉收復 7/1（-6.98%）+ 7/2（-2.27%）兩日全數跌幅、殺盤結束、AI 半導體回神，確認 6/30-7/2 拉回為技術面過熱獲利了結（費半 YTD +47% 後修正）＋估值修正、而非基本面惡化；（2）⚖️ 台股 2330 7/6 收 NT$2,460（+15、+0.61%）連二跌後翻紅、盤中高觸 NT$2,500 逼近 NT$2,535 史高——惟台股 7/6 盤已於 NYSE 7/6 反彈前收盤、尚未完整反映 +4.06% 利多；（3）📊 台美 ADR 溢價擴大——以 7/6 ADR $451.79 折合台股約 NT$2,893.71（wantgoo、匯率 ~32.0）vs 台股 7/6 NT$2,460、溢價約 +17.6%，隱含台股 7/7 具明顯補漲空間；（4）🚀 分析師逆勢大幅續挺——Barclays 維持 TSM 目標價 $625（Overweight、自 7/6 收 $451.79 仍具約 +38.3% 上行空間）；Nomura（野村）上調台股目標至 NT$3,425（自 NT$2,460 具 +39.2% 空間），指 AI 基礎設施投資循環尚未見頂、估 2027 資料中心新增產能達 ~32GW；（5）⚠️ 惟 Goldman Sachs 7/1 將 TSM 移出「APAC Conviction List」（戰術性調整近期上檔預期、非降評）。🤝 NVIDIA 與 SK 海力士宣布多年期記憶體技術合作（AI 工廠次世代記憶體）；NVIDIA 與 TSMC 宣布將 AI/加速運算導入晶圓廠設計與製造流程（提升週期時間、能效與良率）；BofA 上修 2026 全球半導體市場規模至 $1.3 兆（原估 $1.0 兆）、估 2030 上看 $2 兆；Qualcomm 推無 HBM 資料中心晶片、瞄準 2029 年 $150 億營收挑戰 NVIDIA。⭐ 漲價題材續發酵：TSMC 通知客戶全先進製程調漲 5-10%（擴及 N7/N5/N3 及成熟製程、佔晶圓營收 ~75%），利多毛利率（估全年 +2pp 以上），惟客戶（含 Apple/NVIDIA/AMD/Qualcomm/Broadcom/MediaTek）成本升；Benzinga 指 NVIDIA 因 AI 需求剛性與轉嫁能力強、長期反為利多。6 月營收（7 月上旬公布）為關鍵 catalyst——4-5 月營收合計 +24% YoY 低於華爾街 Q2 約 +35% 預期、惟即使小幅月增亦可能使 Q2 營收逼近指引（$39.0-40.2B）中值。⚠️ 南韓公布逾 $1 兆美元 AI/晶片投資計畫（三星+SK 海力士 800 兆韓元）、中長期競爭加劇。⭐ 中長線結構性利多基底未變：（1）🤝 TSMC-Amkor 10 年美國先進封裝長約（Peoria AZ $70 億、2028 投產）；（2）⭐ TSMC-Winbond 特殊 DRAM 自主供應、降低 HBM 對韓系依賴；（3）🏆 NVIDIA 確認 TSMC 第 1 大客戶（22%/$33B）、A16 首發 2026 下半/2027 量產、Vera Rubin 平台 6 顆晶片全數 TSMC 代工（3nm+HBM4）、Apple 跳過 A16 直上 A14；（4）⭐ 2nm 已量產、初期良率 70-80% 領先全球、2nm/A16 產能 2026-28 估 CAGR ~70%；（5）4 大美國 CSP 2026 AI CapEx 合計 $725B（+77% YoY）；（6）⭐ 5 月營收 NT$4,169.75 億 +30.1% 創單月新高、1-5 月累計 NT$1.96 兆；（7）BofA 估 2026 全球半導體市場 $1.3 兆；（8）費半（SOX）Q2 大漲 +87.8% 創 1994 年以來最強單季。⚠️ 下行風險：（1）漲價恐引發客戶反彈與訂單調整；（2）4-5 月營收 +24% YoY 落後 Q2 ~35% 預期、6 月營收與 7/16 財報為關鍵驗證；（3）智慧型手機/PC 等下游終端需求疲弱；（4）估值警示——TSM P/E ~39.3x、台股 P/E ~36.2x；（5）台幣升值（每升 1% 毛利率 -40bps）。基本面未變：Q1 2026 淨利 NT$572.5B（$18.2B、+58.3% YoY）、毛利率 66.2% 雙創史高。技術面（基於 7/6 收 NT$2,460）：5MA NT$2,465 / 20MA NT$2,430 / 60MA NT$2,405 / 120MA NT$2,310；下方支撐 NT$2,445 / NT$2,410 / NT$2,370；上方壓力 NT$2,500 / NT$2,535（史高）。分析師仍全面看多（Barclays $625、Nomura NT$3,425），修正結束、NYSE V 型反彈確認估值修正而非基本面惡化。",
    # 重大警示（選填，空白則不顯示）
    "risk_alert":  "今日（7/7 Tue）關鍵觀察：（1）🚀 NYSE TSM 7/6 大反彈 +4.06%（$451.79、前收 7/2 $434.16）收復 7/1-7/2 全數跌幅、費半 SOX +3.92%、修正結束、AI 半導體回神；NYSE 7/7 盤待今晚 GMT+8；（2）⚖️ 台股 2330 7/6 收 NT$2,460（+0.61%）連二跌後翻紅、盤中高觸 NT$2,500；台股 7/7 盤中/官方收盤待 TWSE；（3）📊 ADR 溢價擴大至約 +17.6%（7/6 ADR $451.79 折合台股 NT$2,893.71 vs 台股 NT$2,460）、隱含台股 7/7 明顯補漲空間；（4）🚀 分析師逆勢大幅續挺——Barclays 維持目標 $625（自 $451.79 具 +38.3% 空間）、Nomura NT$3,425（自 NT$2,460 具 +39.2% 空間）、共識強力買入；⚠️ 惟 Goldman 7/1 將 TSM 移出 APAC Conviction List（戰術調整、非降評）；（5）🤝 NVIDIA-SK 海力士宣布多年期記憶體合作、NVIDIA-TSMC 導入 AI 入廠提升良率、BofA 上修 2026 半導體市場至 $1.3 兆（生成式 AI 晶片 ~$500B）、Qualcomm 推無 HBM 資料中心晶片；⭐ 漲價定價力擴及全先進製程（7nm 以下、佔晶圓營收 ~75%）、估全年毛利率 +2pp 以上；（6）⚠️ 4-5 月營收 +24% YoY 落後 ~35% 預期、6 月營收（7 月上旬）與 7/16 財報為關鍵 catalyst；下游手機/PC 需求疲弱、AMD 首發 2nm AI 晶片；（7）🏆 中長線基底未變：NVIDIA #1 客戶（22%/$33B）/A16 首發、Vera Rubin 6 顆晶片全 TSMC 代工、2nm 70-80% 良率、TSMC-Amkor 美國封裝長約；（8）⚠️ 估值警示：TSM P/E ~39.3x、台股 P/E ~36.2x；本日關鍵：台股 7/7 能否補漲上攻 NT$2,500 / NT$2,535 史高、下方支撐 NT$2,445 / NT$2,410",
}

# 三大法人買賣超（張）— 最新一日
INSTITUTIONAL = {
    "date":     "2026-07-06",       # 最新資料日（7/6 Mon 官方收盤；三大法人淨額為估算，官方明細以 TWSE 為準）
    "foreign":  2500,              # 外資 7/6 估買超約 2,500 張（台股 +0.61% 翻紅、連二跌後回補、盤中高觸 NT$2,500）
    "trust":    900,               # 投信 7/6 估買超約 900 張
    "dealer":   400,               # 自營商 7/6 估買超約 400 張
    # 近5日（由舊到新：6/30, 7/1, 7/2, 7/3, 7/6）；7/6 為官方收盤日、三大法人淨額為估算
    "foreign_5d": [8000, 15000, -8000, -3000, 2500],     # 外資 7/6 估買超約 2,500 張（翻紅回補）
    "trust_5d":   [1200, 2000, 500, 800, 900],           # 投信 7/6 估買超約 900 張
    "dealer_5d":  [650, 1000, -300, 200, 400],           # 自營 7/6 估買超約 400 張
    "foreign_ownership_pct": "74.9%",  # 外資持股比例（7/6 估持穩 74.9%）
    "foreign_ownership_shares": "約 193.8 億股",
}

# 技術分析指標（需每日從看盤軟體更新）
TECHNICAL = {
    "rsi_14":       60.0,   "rsi_signal": "RSI 估自 55 回升至 60（台股 7/6 收 NT$2,460、+0.61%、NYSE +4.06%），中性偏多、動能回溫、尚未進超買；台股 7/7 若補漲留意重返超買區",
    "macd":         0.48,  "macd_signal": "MACD 估自 +0.40 回升至 +0.48、紅柱轉增、動能回溫、多頭趨勢重獲確認；NYSE 7/6 +4.06% V 型反彈帶動、台股 7/6 翻紅",   "macd_color": "#4CAF50",
    "kdj_k":        70.0,   "kdj_d": 65.0, "kdj_j": 80.0, "kdj_signal": "KDJ K(70)/D(65)/J(80) 自低檔回升、7/6 翻紅帶動、動能轉強；J 值升近超買、台股 7/7 若續漲留意過熱",
    "ma5":       "2,468",   # 5MA（6/30 2465, 7/1 2505, 7/2 2465, 7/3 2445, 7/6 2460）— 基於 7/6 官方收盤
    "ma20":      "2,430",   # 20MA
    "ma60":      "2,405",   # 60MA 緩升
    "ma120":     "2,310",
    "bb_upper":  "2,565",   # 布林上軌
    ...
    "bb_lower":  "2,295",   # 布林下軌
    "vol_ma5":  "22,000",   # 5日均量（張，估、基於 6/30-7/6 五日均、假期後量縮）
    "trend":    "🚀 修正結束、V 型反彈：NYSE TSM 7/6 假期後重新開盤即大漲 +4.06% 收 $451.79（前收 7/2 $434.16）、費半 SOX 同步 +3.92%，一舉收復 7/1（-6.98%）+ 7/2（-2.27%）兩日全數跌幅、殺盤結束、AI 半導體回神；台股 2330 7/6 官方收 NT$2,460（+0.61%）連二跌後翻紅、盤中高觸 NT$2,500 逼近 NT$2,535 史高、站穩 5MA/20MA。📊 技術面（基於 7/6 官方收盤 NT$2,460）：RSI 自 55 回升至 60 動能回溫、MACD +0.48 紅柱轉增、KDJ J 值升近超買、多頭趨勢重獲確認，中期 60MA/120MA 趨勢偏多。下一觀察：（1）台股 7/7 能否補漲、上攻 NT$2,500 / NT$2,535 史高（NYSE 7/6 +4.06% + ADR 溢價 +17.6% 為順風）；（2）NYSE 7/7 盤能否延續反彈、美股半導體動能；（3）下方支撐 NT$2,445 / NT$2,410 / NT$2,370；（4）🚀 Barclays $625 + Nomura NT$3,425 + 共識強力買入為中長線支撐、惟須留意 6 月營收（7 月上旬）與 7/16 財報、Goldman 移出 APAC Conviction List；（5）⭐ 中長線基底未變：NVIDIA #1 客戶/A16 首發 + Vera Rubin 6 顆晶片全 TSMC 代工 + 2nm 70-80% 良率。",
    "support":  "2,445 / 2,410 / 2,370 (7/3 收、20MA、前低)",
    "resist":   "2,500 / 2,535 (7/6 盤中高、史高)",
    "note": "技術指標數值為估算（基於 7/6 官方收盤 NT$2,460），請以看盤軟體即時數據為準；NYSE TSM 7/6 大反彈 +4.06% 收 $451.79（前收 7/2 $434.16）收復 7/1-7/2 全數跌幅、費半 +3.92%、修正結束；台股 7/6 翻紅收 NT$2,460、盤中高觸 NT$2,500、RSI 自 55 回升至 60 動能回溫、KDJ J 值升近超買、MACD 紅柱轉增；上方壓力 NT$2,500 / NT$2,535 史高、下方支撐 NT$2,445 / NT$2,410；🚀 Barclays/Nomura 續挺目標 + 漲價定價力+共識偏多 + ADR 溢價 +17.6% 隱含補漲 vs ⚠️ 6 月營收與下游需求雜訊；台股 7/7 盤中待 TWSE、NYSE 7/7 盤待今晚 GMT+8",
}

# 期貨與選擇權（來源：台灣期交所 TAIFEX）
DERIVATIVES = {
    "date":          "2026-07-06",       # 最新資料日（7/6 Mon 盤後估、官方待 TAIFEX 公布）
    "futures_price": "2,475",            # 台積電期貨近月（7/6 收盤附近、翻紅轉正價差、反映 ADR 溢價與 7/7 補漲預期）
    "futures_oi":    "180,000",          # 未平倉量（口）（7/6 估）
    "futures_basis": "+15",              # 7/6 估轉正價差（NYSE 大反彈 + ADR 溢價 +17.6%、期貨領先反映 7/7 補漲）
    "call_oi":       "118,000",
    "put_oi":        "76,000",
    "pcr":           "0.64",             # Put/Call 比率（7/6 估自 0.70 回落至 0.64、NYSE 反彈後避險買盤退場、情緒偏多）
    "pcr_signal":    "偏多（Put/Call 7/6 估 0.64；台股 7/6 收 NT$2,460（+0.61%）翻紅、NYSE TSM 7/6 大反彈 +4.06%、避險買盤退場、期貨轉正價差 +15；⭐ ADR 溢價 +17.6% 隱含台股 7/7 補漲、Barclays $625 + Nomura NT$3,425 + 共識偏多為支撐；NYSE 7/7 盤待今晚）",
    "max_pain":      "2,460",            # 最大痛苦價格（近期到期、7/6 估）
    "key_strikes": [
        ("2,370", "Call 52,000 / Put 12,000", "整數支撐"),
        ("2,410", "Call 50,000 / Put 9,000",  "20MA、整數支撐"),
        ("2,445", "Call 46,000 / Put 7,500",  "7/3 收、支撐"),
        ("2,460", "Call 48,000 / Put 7,000",  "7/6 收、最大痛苦"),
        ("2,500", "Call 42,000 / Put 5,500",  "7/6 盤中高、整數壓力"),
        ("2,535", "Call 32,000 / Put 3,500",  "盤中史高"),
        ("2,600", "Call 24,000 / Put 2,500",  "上檔壓力"),
    ],
    "note": "衍生品數據需每日至台灣期交所(taifex.com.tw)更新；7/6 PCR 估自 0.70 回落至 0.64 反映 NYSE 大反彈 +4.06% 後避險情緒退場、期貨轉正價差 +15（反映 ADR 溢價 +17.6% 與 7/7 補漲預期）；NT$2,460 為最大痛苦、下方支撐 NT$2,445 / NT$2,410、上方壓力 NT$2,500 / NT$2,535 史高；🚀 Barclays $625 + Nomura NT$3,425 + 漲價定價力+共識偏多結構性利多、⚠️ 留意 6 月營收 miss 風險與下游需求疲弱；中長線基底未變（NVIDIA #1 客戶/A16 首發、Vera Rubin 6 顆晶片全 TSMC 代工、2nm 70-80% 良率、TSMC-Amkor 美國封裝長約）",
}

# 供應鏈與客戶股價（需每日更新）
ECOSYSTEM_STOCKS = [
    # 類別、股票代碼、名稱、收盤價、漲跌幅、備註（美股為 2026-07-06 Mon 假期後重新開盤收盤、費半 SOX +3.92% 大反彈；台股/韓股為 7/6 Mon 收盤；價格為估算，美股半導體 7/6 全面 V 型反彈收復 7/1-7/2 跌幅）
    ...
    ("記憶", "2344.TW", "華邦電 Winbond","33.40","+1.21%", "⭐ 與 TSMC 合作將 CUBE 特殊 DRAM 導入 WoW 3D 堆疊/SoIC、降低台灣對 Samsung/SK HBM 依賴（台股 7/6 隨大盤翻紅、價格為估算）"),
    ...
    ("封裝", "3711.TW", "日月光",      "331",    "+0.91%", "CoWoS / 先進封裝（台股 7/6 隨大盤翻紅；先進封裝瓶頸結構受惠）"),
    ...
    ("客戶", "2454.TW", "聯發科",      "4,790",  "+0.84%", "手機 SoC 客戶 9%；台股 7/6 隨大盤翻紅；面臨漲價成本；RTX Spark 由聯發科協同 NVIDIA 設計"),
...
# 法人評級彙整
ANALYST_RATINGS = [
    ("Nomura 野村",    "買入",     "NT$3,425", "2026-07-01", "🚀 7/1 大幅上調目標價自 NT$2,820 至 NT$3,425（自 7/2 收 NT$2,465 具 +38.9% 空間）；指 AI 基礎設施投資循環尚未見頂、估 2027 資料中心新增產能達 ~32GW"),
...
CONSENSUS = {
    ...
    "high_target":  "NT$3,425",
    "low_target":   "NT$2,100",
    "avg_target_us":"US$490.34",    # 分析師 12 個月平均目標（高 $625 Barclays / 低 $351；自 7/6 收 $451.79 具 +8.5% 上行空間；Barclays 維持 $625、Nomura 上調台股目標至 NT$3,425；Goldman 7/1 移出 APAC Conviction List）
    "analyst_count": 32,
    "buy": 32, "hold": 0, "sell": 0,
    "upside":       "+8.53%",  # 從 NYSE 7/6 收 $451.79 至平均目標 $490.34（NYSE V 型反彈後上行空間收斂、共識強力買入；待 7/16 法說會後重估）
}
...
IR_CALENDAR = [
    ...
    ("2026-07-06", "📊 NYSE 重新開盤、雙市待方向", "7/6 Mon NYSE 假期後重新開盤（美股 7/6 盤待今晚 GMT+8）；台股 2330 7/6 盤中官方收盤待 TWSE、最新確認收盤為 7/3 NT$2,445；🤝 NVIDIA-SK 海力士宣布多年期記憶體合作；⭐ 漲價題材（7nm 以下全製程 5-10%、佔營收 ~75%）+ Barclays $625 / Nomura NT$3,425 續撐；⚠️ 留意 6 月營收（7 月上旬）與 7/16 財報",  "#FFF9C4"),
...
RELATIVE = {
    "date":           "2026-07-03",       # 最新資料日（7/3 Fri 台股收盤；NYSE 為 7/2 最新確認收盤、7/3 國慶休市）
    "tsmc_tw_1d":     -0.81,   # 2330 7/3 官方收 NT$2,445（-20 vs 7/2 NT$2,465；跌幅收斂、守穩 NT$2,410）
    "taiex_1d":       -0.40,   # 加權指數 7/3 小幅收低（估）
    "sox_1d":         +0.82,   # SOX 7/2 科技設備類股回升（估）
    "tsmc_nyse_1d":   -2.27,   # TSM ADR 7/2 $434.16 (-$10.07 vs 7/1 $444.23；連二跌但跌幅較 7/1 -6.98% 大幅收斂)
    "tsmc_tw_5d":     +2.30,   # 5 日（NT$2,445 vs ~6/26 NT$2,340）
    "taiex_5d":       +1.50,
    "tsmc_tw_1m":     +8.20,   # 月線（NT$2,445 vs ~NT$2,260 ~6/3）
    "taiex_1m":       +8.2,
    "tsmc_tw_ytd":    +16.71,  # YTD 累計（NT$2,445 vs 年初 ~NT$2,095）
    "taiex_ytd":      +13.3,
    "sox_ytd":        +47.0,   # SOX YTD（費半 YTD +47%）
    "beta_60d":        1.38,   # 60 日滾動 Beta vs TAIEX
    # ADR 折溢價（以 7/2 NYSE 收盤 & 7/3 TW 收盤計算）
    "adr_price":     434.16,   # TSM NYSE 7/2 收盤（-2.27%、最新確認、前收 7/1 $444.23）
    "adr_parity":    393.72,   # 理論值 = 5 × NT$2,445 ÷ 31.05
    "adr_ratio":     "5:1",    # 1 ADR = 5 台積電普通股
    "usd_ntd":        31.05,   # 同 MACRO 台幣匯率
    "adr_premium_pct": "+10.27", # (434.16 - 393.72) / 393.72 × 100 = +10.27%
    "note": "ADR 理論值 = 5 × 台股收盤 ÷ 匯率（不含交易摩擦與流動性溢價）。⚖️ NYSE TSM 7/2 Thu 續跌 -2.27% 收 $434.16（-$10.07、前收 7/1 $444.23、市值約 $2.15 兆、P/E ~37.8）為連二跌（7/1 -6.98%、7/2 -2.27%）、惟跌幅大幅收斂——殺盤動能衰竭、屬技術面過熱獲利了結後的估值修正而非基本面惡化；NYSE 7/3 Fri 逢美國國慶休市、7/6 Mon 重新開盤。台股 2330 7/3 Fri 官方收 NT$2,445（-20、-0.81% vs 7/2 NT$2,465、量 26,455 張、市值 NT$63.4 兆）跌幅較 7/2 之 -1.60% 收斂、守穩 NT$2,410 支撐。⚠️ 籌碼面：7/3 估外資賣超 -3,000 張（賣壓收斂）、投信小買 +800、自營小買 +200（待官方確認）。📊 台美 ADR 溢價約 +10.3%（台股相對抗跌、NYSE 跌幅收斂）；🎯 今日（7/6 Mon）關鍵：NYSE 7/6 重新開盤後方向、台股 7/6 能否守穩 NT$2,410 / NT$2,370 支撐；⚠️ TSMC 4-5 月營收 +24% YoY 落後 ~35% 預期、6 月營收（7 月上旬）為關鍵 catalyst；🚀 重大利多：Barclays 將 TSM 目標價自 $470 大幅上調至 $625、Nomura NT$3,425；⭐ 中長線結構性基底未變：TSMC-Amkor 美國封裝長約 + NVIDIA 確認第 1 大客戶/A16 首發 + Vera Rubin 6 顆晶片全 TSMC 代工 + 2nm 量產 70-80% 良率 + CoWoS 擴產 + 4 大 CSP CapEx $725B",
}
...
NEWS = [
    {
        ...
        "title": "🚀 NYSE V 型大反彈、修正結束：NYSE TSM 7/6 假期後重開即漲 +4.06% 收 $451.79（收復 7/1-7/2 全數跌幅）、費半 SOX +3.92%；台股 2330 7/6 收 NT$2,460（+0.61%）翻紅",
        "body": "半導體 6/30-7/2 修正後強勢 V 型反彈、修正結束：（1）🚀 NYSE TSM 7/6 Mon 假期後重新開盤即大漲 +4.06%（+$17.63）收 $451.79（stockanalysis.com 確認、前收 7/2 $434.16、盤後 $450.35 -0.32%、市值約 $2.34 兆），一舉收復 7/1（-6.98%）+ 7/2（-2.27%）兩日全數跌幅；費半 SOX 同步 +3.92%、NVDA +4.2%、MU +4.4%、AMD +4.3% 全面回神，確認 6/30-7/2 拉回為技術面過熱獲利了結（費半 YTD +47% 後修正）＋估值修正、而非基本面惡化；（2）⚖️ 台股 2330 7/6 Mon 官方收 NT$2,460（+15、+0.61% vs 7/3 NT$2,445、量約 19,239 張、盤中高觸 NT$2,500 逼近 NT$2,535 史高）連二跌後翻紅——惟台股 7/6 盤已於 NYSE 7/6 反彈前收盤、尚未完整反映 +4.06% 利多；（3）📊 台美 ADR 溢價擴大至約 +17.6%（以 7/6 ADR $451.79 折合台股約 NT$2,893.71、匯率 ~32.0 計 vs 台股 NT$2,460），隱含台股 7/7 具明顯補漲空間；（4）🗓️ 台股 7/7 Tue 盤中/官方收盤待 TWSE、NYSE 7/7 盤待今晚 GMT+8。",
        "source": "stockanalysis.com / CNBC / Yahoo Finance / Yahoo 奇摩股市 / wantgoo / histock 2026-07-06", "impact": "正面",
    },
    {
        "tag": "產業趨勢", "tag_color": "#4CAF50",
        "title": "🚀 分析師大幅續挺：Barclays 維持 TSM 目標 $625（Overweight、自 $451.79 具 +38.3% 空間）；Nomura NT$3,425；惟 Goldman 7/1 移出 APAC Conviction List",
        "body": "分析師逆勢大幅看多、主流強力買入：（1）🚀 Barclays 維持 TSMC 目標價 $625（Overweight，7/2 自 $470 大幅上調），自 7/6 收 $451.79 仍隱含約 +38.3% 上行空間，強調 TSMC 為 AI 資本支出循環的終極受惠者、A14/A16 製程領先；（2）📈 Nomura（野村）上調台股目標至 NT$3,425（自 NT$2,820、+21.5%），自 7/6 收 NT$2,460 隱含約 +39.2% 空間，指 AI 基礎設施投資循環尚未見頂、預期資料中心新增產能 2027 年升至約 32GW；（3）📊 分析師 12 個月平均目標約 $490（強力買入、32 位分析師 0 賣出、自 $451.79 具 +8.5% 空間），多數視 6/30-7/2 拉回為估值修正而非基本面惡化——NYSE 7/6 V 型反彈已印證；（4）⚠️ 惟 Goldman Sachs 7/1 將 TSM 移出「APAC Conviction List」，屬對近期上檔空間的戰術性調整、並非降評。",
        "source": "Barclays / Nomura / TradingKey / Morningstar / 鉅亨網 2026-07-01 - 07-06", "impact": "正面",
    },
    {
