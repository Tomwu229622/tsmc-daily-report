...
STOCK = {
    # 台股 2330
    "tw_price":       "1,845",        # 收盤價（數字加逗號，不含 NT$）（2026-03-26 收盤）
    "tw_change":      "+35",          # 漲跌點數（含+/-號）
    "tw_change_pct":  "+1.93%",       # 漲跌幅（含+/-號）
    "tw_volume":      "20,000",       # 成交量（張，估）
    "tw_open":        "1,820",
    "tw_high":        "1,850",
    "tw_low":         "1,800",
    "market_cap":     "NT$47.85 兆",
    "pe_ratio":       "~27.85x",      # 台股 P/E（TTM，2026-03-27）
    "pb_ratio":       "~10.3x",       # 台股 P/B（股淨比）
    "div_yield":      "~1.11%",       # 殖利率（USD $2.65/ADR 年息）
    "52w_high_tw":    "2,025",        # 52 週高（2026-02-25）
    "52w_low_tw":     "780",          # 52 週低（2025-04-07）
    # NYSE TSM ADR
    "nyse_price":     "336.00",       # 估算收盤（2026-03-27，盤中區間 $331.68–$340.85）
    "nyse_change":    "-11.75",       # 較 3/26 收盤 $347.75 下跌（估算）
    "nyse_change_pct":"-3.38%",
    "52w_high_nyse":  "390.21",       # 52 週高（2026-02-25）
    "52w_low_nyse":   "134.25",       # 52 週低（2025-04-07）
    "pe_nyse":        "~31.2x",       # NYSE USD 基礎 P/E（TTM）
    "pb_nyse":        "~10.1x",
    "beta":           "1.28",
    ...
    # 資料日期備註
    "data_note":      "台股數據：2026-03-26 收盤（2026-03-27 盤前）  |  NYSE 數據：2026-03-27 盤中估算（開盤 $340.28，區間 $331.68–$340.85）  |  TSM 本週累計下跌 6.3%，年初至今仍漲 13%  |  高盛上調目標價至 $370–$375 USD",
}
...
SUMMARY = {
    ...
    "sentiment":  "中性偏空",
    # 一句話標題
    "headline":   "NYSE TSM 盤中約 $336（-3.38%），本週累跌 6.3%；高盛上調目標價至 $370-375；台股 2330 前日收 NT$1,845（+1.93%）",
    # 3–5 條白話重點（不用術語，每條約 30 字內）
    "bullets": [
        "NYSE TSM（3/27 盤中）約 US$336（-11.75，-3.38%），本週累計下跌 6.3%，惟年初至今仍上漲 13%，長線基本面未變",
        "高盛大幅上調 TSM 目標價至 $370–$375 USD（上調幅度 35%），預估 2026 年營收成長 30%、毛利率維持 60% 以上",
        "NVIDIA 確認為台積電 A16（1.6nm）製程首位客戶，2026 年貢獻達 $330 億美元（22%），超越 Apple 成最大單一客戶",
        "Broadcom 警告 TSMC 先進製程產能逼近飽和，交期持續拉長；Motley Fool 指出此為 AI 需求長期結構性強勁之訊號",
        "4/16 Q1 財報倒計時 20 天，EPS 共識 NT$20.38；AGM 提案截止日 3/31–4/7 近在眼前",
    ],
    # 一句結論
    "bottom_line": "NYSE TSM（3/27 盤中）約 US$336（-3.38%），本週累計下跌 6.3%，短線承壓，反映美股整體回調情緒。台股 2330（3/26 收盤）NT$1,845（+1.93%），技術面仍維持 MA60 支撐。高盛上調目標價至 $370–$375 USD 為今日最大利多，NVIDIA 首採 A16 製程確認先進節點主導地位。分析師共識 31 人全數買入、目標 NT$2,290，長線基本面強勁，短線波動為佈局機會。AGM 提案截止（3/31–4/7）及 Q1 財報（4/16）為近期關鍵事件，支撐 1,820–1,830，壓力 1,860–1,880。",
    # 重大警示（選填，空白則不顯示）
    "risk_alert":  "⚠️ AGM 提案截止日 3/31–4/7；Q1 財報 4/16 倒計時 20 天；NYSE TSM 本週下跌 6.3%，短線技術面偏弱；NYSE 數據為盤中估算，非最終收盤",
}

# 三大法人買賣超（張）— 最新一日
INSTITUTIONAL = {
    "date":     "2026-03-26",
    "foreign":  +2800,    # 外資（正=買超）— 台股反彈，外資回補（估，3/26）
    "trust":    +320,     # 投信（持續逢低承接）
    "dealer":   +150,     # 自營商（隨反彈小買）
    # 近5日（由舊到新）
    "foreign_5d": [-3200, +1500, -4100, +2800, -1200],  # 3/27 估外資偏空（NYSE 偏弱）
    "trust_5d":   [+350,  +290,  +280,  +320,  +250],
    "dealer_5d":  [-180,  -150,  -220,  +150,  -100],
    "foreign_ownership_pct": "75.1%",  # 外資持股比例（估，3/27 略降）
    "foreign_ownership_shares": "約 195.1 億股",
}

# 技術分析指標（需每日從看盤軟體更新）
TECHNICAL = {
    "rsi_14":       43.5,   "rsi_signal": "中性偏弱（RSI 由 45 回落，NYSE 走弱拖累）",
    "macd":         -5.2,   "macd_signal": "MACD 死叉仍在，動能偏空，需觀察量能回升",   "macd_color": "#F44336",
    "kdj_k":        40.2,   "kdj_d": 38.5, "kdj_j": 43.6, "kdj_signal": "KDJ 金叉訊號未完全確立，需持續觀察",
    "ma5":       "1,838",
    "ma20":      "1,892",
    "ma60":      "1,840",
    "ma120":     "1,742",
    "bb_upper":  "2,008",   # 布林上軌
    "bb_mid":    "1,892",   # 布林中軌（20MA）
    "bb_lower":  "1,782",   # 布林下軌
    "vol_ma5":  "19,600",   # 5日均量（張）
    "trend":    "台股 2330（3/26 收 NT$1,845，+1.93%）技術面於 MA60（1,840）之上持穩。NYSE TSM（3/27 盤中）約 $336（-3.38%），短線承壓；本週累跌 6.3% 令技術形態偏弱。RSI 略有回落至 43.5，MACD 死叉尚未反轉，支撐 1,820–1,830 仍需守穩。AGM 提案截止（3/31–4/7）及財報（4/16）為近期催化劑。",
    "support":  "1,820–1,830",
    "resist":   "1,860–1,880",
...
DERIVATIVES = {
    "date":          "2026-03-27",
    "futures_price": "1,843",      # 台積電期貨近月（估，接近現貨，小幅負價差）
    "futures_oi":    "73,500",     # 未平倉量（口）（估，空單略增）
    "futures_basis": "-2",         # 小幅負價差（NYSE 走弱影響）
    "call_oi":       "34,500",
    "put_oi":        "51,200",
    "pcr":           "1.48",       # Put/Call 比率上升（空頭情緒略增）
    "pcr_signal":    "中性偏空",
    "max_pain":      "1,860",      # 最大痛苦價格
    "key_strikes": [
        ("1,785", "Call 3,000 / Put 9,500", "布林下軌支撐"),
        ("1,820", "Call 5,000 / Put 9,000", "短線重要支撐"),
        ("1,845", "Call 6,500 / Put 7,800", "現貨所在"),
        ("1,860", "Call 9,000 / Put 5,800", "最大痛苦點/壓力"),
        ("1,880", "Call 10,200 / Put 4,500", "強壓力區"),
    ],
...
CONSENSUS = {
    ...
    "upside":       "+24.1%",   # 從 NT$1,845 到 NT$2,290
}
...
# 總體經濟監控
MACRO = [
    ("SOX 半導體指數",  "4,190",   "-2.1%",  False),  # 3/27 盤中，半導體股受壓
    ("美元指數 DXY",    "104.2",   "+0.7%",  False),  # 美元走強，台幣承壓
    ("VIX 恐慌指數",    "25.8",    "+1.8",   False),  # 恐慌指數上升
    ("WTI 原油",        "$69.5",   "-2.1%",  False),
    ("10Y 美債殖利率",  "4.28%",   "+0.06pp",False),  # 殖利率上升
    ("台幣/美元",       "31.68",   "-0.10",  False),  # 台幣小貶
    ("NVIDIA NVDA",     "$855",    "-2.3%",  False),  # 盤中走弱
    ("ASML",            "$681",    "-1.3%",  False),  # 設備股跟跌
]
...
RELATIVE = {
    "date":           "2026-03-27",
    "tsmc_tw_1d":     +1.93,   # 2330 3/26 收盤（3/27 盤前）
    "taiex_1d":       +0.85,   # 加權指數（3/26 估算）
    "sox_1d":         -2.10,   # SOX（3/27 盤中，估，走弱）
    "tsmc_nyse_1d":   -3.38,   # TSM ADR 3/27 盤中（約 US$336）
    "tsmc_tw_5d":     -5.5,    # 本週累計（含今日NYSE走弱影響）
    "taiex_5d":       -2.1,
    "tsmc_tw_1m":     -7.8,
    "taiex_1m":       -4.0,
    "tsmc_tw_ytd":    -8.3,
    "taiex_ytd":      -5.1,
    "sox_ytd":        -17.9,
    "beta_60d":        1.28,   # 60 日滾動 Beta vs TAIEX
    # ADR 折溢價
    "adr_price":     336.00,   # TSM NYSE 盤中估算（2026-03-27）
    "adr_parity":    291.20,   # 理論值 = 5 × NT$1,845 ÷ 31.68（台股 3/26 收盤）
    "adr_ratio":     "5:1",    # 1 ADR = 5 台積電普通股
    "usd_ntd":        31.68,   # 同 MACRO 台幣匯率
    "adr_premium_pct": "+15.4",# (336.00 - 291.20) / 291.20 × 100
    "note": "ADR 理論值 = 5 × 台股收盤 ÷ 匯率（不含交易摩擦與流動性溢價）。NYSE 為盤中估算，TAIEX/多期間數據為估算",
}
...
EPS_REVISION = {
    ...
    "analyst_view": "Q1 EPS 共識 NT$20.38，前 2 月累計營收年增 30%（NT$7,189 億）。3/27 NYSE TSM 盤中約 US$336（-3.38%），本週累計下跌 6.3%，惟年初至今仍漲 13%。高盛上調目標價至 $370–$375 USD（上調 35%）為今日最大利多，NVIDIA 確認首採 A16 製程強化競爭壁壘。31 位分析師無一賣出，目標 NT$2,290（上行 +24.1%）。4/16 Q1 財報（倒計時 20 天）為關鍵催化劑，若毛利率超指引（63–65%）可望確認上行走勢。",
    "note": "資料來源：Bloomberg / MarketScreener（估算），請每日核實更新",
}

NEWS = [
    {
        "tag": "股價走勢", "tag_color": "#F44336",
        "title": "TSM 本週下跌 6.3%，惟年初至今仍上漲 13%，長線基本面穩健",
        "body": "台積電美股 TSM 本週承壓走低，截至 3/27 累計跌幅達 6.3%，市場評估為短線獲利了結與美股整體回調影響。然而年初至今仍上漲 13%，分析師指出長線基本面未變，31 位分析師無一賣出，共識目標價 $430.65 USD，評等維持「強力買進」。短線波動視為佈局機會。",
        "source": "Markets Daily 2026-03-26", "impact": "負面",
    },
    {
        "tag": "法人評級", "tag_color": "#4CAF50",
        "title": "高盛上調 TSM 目標價至 $370–375 USD（上調幅度 35%）",
        "body": "高盛大幅上調台積電 TSM 目標價至約 $370–$375 USD，較前次目標價上調約 35%，預估台積電 2026 年營收成長 30%、2027 年成長 28%。2026–2028 年資本支出合計逾 $1,500 億 USD，毛利率維持 60% 以上長期確信。此評級上調為 3/27 股價弱勢中難得的正面催化劑，強化中長線多頭信心。",
        "source": "TheStreet 2026-03-26", "impact": "正面",
    },
    {
        "tag": "技術節點", "tag_color": "#9C27B0",
        "title": "NVIDIA 確認首採 TSMC A16（1.6nm），Apple 直跳 A14 節點",
        "body": "最新消息確認 NVIDIA 將成為台積電次世代 A16（1.6nm）製程的第一位客戶，採用 BPR 背面電源供電，帶來效能提升 10% 或功耗降低 20%。Apple 則跳過 A16 直接採用 A14 節點。A16 量產預計 2027 年於台灣啟動，TSMC 先進製程壟斷地位持續鞏固，競爭對手短期內無可替代。",
        "source": "TweakTown 2026-03-26", "impact": "正面",
    },
    {
        "tag": "客戶動態", "tag_color": "#2196F3",
        "title": "NVIDIA 超越 Apple 成 TSMC 最大客戶，2026 年貢獻達 $330 億美元",
        "body": "NVIDIA CEO Jensen Huang 確認，NVIDIA 已超越 Apple 成為台積電最大單一客戶，預估 2026 年貢獻約 $330 億 USD（佔台積電總收入約 22%）。HPC 已佔台積電營收比重升至 58%，GB300/GB400 訂單積壓超 4 季。AI GPU 取代智慧型手機成為驅動 TSMC 成長的核心動力。",
        "source": "CNBC 2026-03-26", "impact": "正面",
    },
    {
        "tag": "供應瓶頸", "tag_color": "#FF9800",
        "title": "Broadcom 示警 TSMC 先進製程產能逼近飽和，AI 需求結構性強勁",
        "body": "Broadcom 指出台積電先進製程產能已逼近上限，2nm 及先進封裝交期持續拉長，Blackwell 等 AI 晶片訂單排至 2027 年。Motley Fool 指出此為 AI 晶片需求長期結構性強勁的訊號，而非短期爆發。產能緊縮凸顯 TSMC 定價能力，毛利率上修空間確立，長線利多持續。",
        "source": "Motley Fool 2026-03-26", "impact": "正面",
    },
    {
        "tag": "產業趨勢", "tag_color": "#607D8B",
        "title": "SEMICON China 2026：AMD 警告 AI 成長瓶頸非矽晶片，在於電力封裝",
        "body": "SEMICON China 2026（3/25–3/27，上海）吸引逾 1,500 家廠商參展。AMD 策略主管警告，AI 市場朝 $1.7 兆擴張，但終極瓶頸可能不在矽晶片本身，而在電力供應與先進封裝。此論點間接凸顯 TSMC CoWoS 先進封裝的稀缺性與定價優勢，長期利多台積電生態系。",
        "source": "Digitimes 2026-03-26", "impact": "中性",
    },
]
