...
SUMMARY = {
    ...
    "sentiment":  "中性",
    # 一句話標題
    "headline":   "⚠️⚠️ AI 晶片股正式跌入熊市：SOX 自 6/22 高點 -20.2%、單週 -9%；台股 2330 7/17 崩跌 -7.29% 收 NT$2,290、三大法人單日賣超 2,617 億創台股史上最大、外資提款台積電破千億（連 7 賣 44,184 張）；惟基本面未變（Q2 大超預期、全年上修 >40%）、股價與基本面短線脫鉤——ADR 溢價逆勢擴大至 +12% 隱含台股超跌、今日 7/20 週一觀察技術性反彈",
    ...
    "bullets": [
        ...
        "📉 台股史詩級崩跌：2330 7/17 官方收 NT$2,290（-180、-7.29%、收盤即當日最低）、量爆增至 97,362 張（額 2,290 億、前日 3.2 倍）；三大法人合計賣超逾 2,617 億元創台股史上單日最大、外資提款台積電破千億",
        ...
        "⚠️ 風險續追蹤：AI 估值/情緒修正是否續探底、外資史詩級賣超能否止穩；美 232 條款關稅 25% + 輸中晶片轉運查驗；Intel 18A 競爭；台幣 ~32.2；技術面跌破 5MA/20MA、回測 60MA ~2,331、KDJ 死叉墜超賣",
    ],
    # 一句結論
    "bottom_line": "報告日期：2026-07-20 Mon（最新確認收盤：台股 2330 7/17 Fri 官方收 NT$2,290（-180、-7.29% vs 7/16 NT$2,470、開 2,375／高 2,395／低 2,290、量 97,362 張 TWSE 口徑、成交額 NT$2,290.52 億、成交 1,150,086 筆、TWSE 確認）；NYSE TSM 7/17 Fri 收 $398.37（-$11.37、-2.77% vs 7/16 $409.74、盤後 $397.72、stockanalysis.com 確認、自我檢核 409.74×(1-2.77%)=398.39 ✓））。⚠️⚠️ 最重要：全球 AI 晶片股正式跌入熊市——費城半導體指數（SOX）7/17 收跌 -1.6%（盤中一度 -5.7%）、自 6/22 歷史高點回落 -20.2%、單週 -9%（3-6 月自低點曾飆漲 +105%）；催化：（1）中國新創 Moonshot 發表號稱全球最大的開源 AI 模型 Kimi K3；（2）Alphabet 傳 Gemini 3.5 Pro 交付落後——市場對「巨額 AI 投資能否兌現、雲端資本支出能否持續」信心動搖、引爆全面獲利了結；MRVL/ARM/INTC 自高點已 -30%+。📉 台股同步史詩級崩跌：2330 7/17 收 NT$2,290（-7.29%、收盤即當日最低）、量爆增至 97,362 張；三大法人 7/17 合計賣超逾 2,617 億元創台股史上單日最大紀錄、外資提款台積電破千億——2330 遭外資賣超 44,184 張（連 7 賣、買 17,479／賣 61,663）；惟投信買超 1,489 張（連 2 買）、自營買超 2,759 張（連 7 買）逆勢承接、三大法人合計賣超 39,936 張。📊 台美 ADR 溢價逆勢擴大至 +12.0%（$398.37 vs 理論值 $355.6、匯率 ~32.2）——因台股 -7.29% 超跌於 ADR -2.77%、隱含台股 7/20 週一具技術性反彈空間。⭐ 關鍵判斷：本次為 AI 估值/情緒面修正、非 TSMC 基本面惡化——Q2 法說會（7/16）大超預期基本面完全未變：營收 $40.20B（+33.7% YoY）、EPS $4.31/ADR（+77.4%、連 11 季超預期）、毛利率 67.7% 超指引上緣；全年營收成長上修至「略高於 40%」、2026 CapEx 上調至 $60-64B（含 Arizona 追加 $100B 投資）、股利 NT$24/股（+33%）；HPC 占 66%、2nm 首度貢獻 3%；管理層明言「AI 需求比先前預期更強」——股價與基本面短線嚴重脫鉤。⭐ 今日重點：（1）📉 台股 7/20 週一觀察：崩跌後是否出現技術性反彈——ADR 溢價擴大至 +12% + 估值消化（P/E 26.2x）+ 內資逆勢承接為支撐、惟 AI 情緒面能否止穩為關鍵；（2）📊 籌碼：外資連 7 史詩級賣超能否止穩為最大觀察點、投信自營持續逆勢買進；（3）💡 估值大幅消化：台股 P/E 降至 ~26.2x TTM（前 ~28.3x）、TSM ~29.2x。技術面（官方收盤計算）：5MA ~2,412 / 20MA ~2,426 / 60MA ~2,331；7/17 收 2,290 跌破 5MA/20MA、回測 60MA ~2,331、RSI 約 40.5 跌破中軸、MACD 綠柱擴大至 ~-13（DIF 19 < DEA 32）、KDJ K32/D40/J16 死叉且 J 值墜入超賣；支撐 2,255（布林下軌）／2,200／2,150、壓力 2,331（60MA）／2,412（5MA）／2,470（7/16 高）。⚠️ 風險：AI 估值/情緒修正是否續探底、外資史詩級賣超能否止穩、美 232 條款關稅 25% + 輸中晶片轉運查驗、Intel 18A 競爭、台幣 ~32.2（每升值 1% 毛利率 -40bps）。⭐ 中長線基底未變：全年成長 >40%、CapEx $60-64B、AI 需求「比預期更強」、2nm 5 座廠爬坡且已貢獻 3% 營收、股利 +33%、NVIDIA #1 客戶/A16 首發、CoWoS 訂滿至 2027、漲價 5-10% 定價權——超跌後中長線價值浮現，惟需 AI 情緒面止穩確認。",
    # 重大警示（選填，空白則不顯示）
    "risk_alert":  "今日（7/20 Mon）關鍵觀察：（1）⚠️⚠️ AI 晶片股熊市是否續探底——SOX 已自 6/22 高點 -20.2% 正式進入熊市、單週 -9%；催化為 AI 投資報酬疑慮（Moonshot Kimi K3 開源模型、Alphabet Gemini 交付落後）而非 TSMC 基本面惡化，惟情緒面能否止穩為短線最大變數；（2）📉 台股 7/20 週一觀察技術性反彈：7/17 崩跌 -7.29% 收 2,290、收盤即當日最低——超跌（ADR 溢價擴大至 +12%）+ 估值消化（P/E 26.2x）+ 內資逆勢承接為支撐，守穩 2,255（布林下軌）／2,200 為短線關鍵、若破則下看 2,150；反彈壓力 2,331（60MA）／2,412（5MA）；（3）📊 籌碼：外資 7/17 賣超 44,184 張連 7 賣、三大法人單日賣超 2,617 億創史上最大——外資能否止穩為最大觀察點；投信 +1,489、自營 +2,759 逆勢承接續扮穩定力量；（4）✅ 基本面錨：Q2 大超預期（EPS +77.4%、全年上修 >40%、CapEx $60-64B、股利 +33%、Arizona 追加 $100B）完全未變、股價與基本面短線脫鉤——超跌後中長線價值浮現；（5）💱 美 232 條款關稅 25% + 輸中晶片轉運查驗、Intel 18A 競爭、台幣 ~32.2 續追蹤",
}
...
# 技術分析指標（需每日從看盤軟體更新）
TECHNICAL = {
    "rsi_14":       40.5,   "rsi_signal": "RSI(14) 約 40.5（官方收盤計算、估）——7/17 崩跌 -7.29% 後跌破中軸、轉弱；惟已接近超賣區、留意超跌反彈",
    "macd":         -13.0, "macd_signal": "MACD 綠柱擴大至 ~-13（DIF 19 < DEA 32、官方收盤計算、估）——7/17 巨量長黑後動能急轉空、綠柱由 -4.9 擴大至 -13、死叉確立",   "macd_color": "#F44336",
    "kdj_k":        32.0,   "kdj_d": 40.0, "kdj_j": 16.0, "kdj_signal": "KDJ K(32)/D(40)/J(16)（官方收盤計算、估）——7/17 崩跌後 K 下穿 D 形成死叉、J 值 16 墜入超賣區，短線轉弱、惟超賣後留意技術性反彈",
    "ma5":       "2,412",   # 5MA（官方收盤計算，7/13-7/17：2440/2420/2440/2470/2290）
    "ma20":      "2,426",   # 20MA（官方收盤計算、估）
    "ma60":      "2,331",  # 60MA（官方收盤計算、估）
    "ma120":     "2,105",  # 120MA（官方收盤計算、估）
    "bb_upper":  "2,596",  # 布林上軌（20MA+2σ、官方收盤計算、估；波動放大帶擴張）
    "bb_mid":    "2,426",   # 布林中軌（20MA）
    "bb_lower":  "2,256",  # 布林下軌（20MA-2σ、估）
    "vol_ma5":  "39,988",   # 5日均量（張、TWSE 口徑、含 7/17 爆量 97,362）
    "trend":    "📉 史詩級崩跌、技術面全面轉空：台股 2330 7/17 官方收 NT$2,290（-180、-7.29%、量爆增至 97,362 張 TWSE 口徑、前日 3.2 倍）——收盤即當日最低（開 2,375／高 2,395／低 2,290）、跌破 5MA（~2,412）與 20MA（~2,426）、回測 60MA（~2,331）。⚠️⚠️ 主因：全球 AI 晶片股正式跌入熊市——SOX 7/17 收 -1.6%（盤中一度 -5.7%）、自 6/22 史高 -20.2%、單週 -9%；催化 Moonshot Kimi K3 開源模型 + Alphabet Gemini 交付落後引爆 AI 投資報酬疑慮；台股三大法人單日賣超 2,617 億創史上最大、外資提款台積電破千億。NYSE TSM 7/17 收 $398.37（-2.77%）失守 $400、惟相對板塊抗跌。📊 技術指標（官方收盤計算、估）：RSI(14) ~40.5 跌破中軸、MACD 綠柱擴大至 ~-13（DIF 19 < DEA 32）、KDJ K(32)/D(40)/J(16) 死叉且墜超賣——短線動能急轉空。⭐ 關鍵：本次為 AI 估值/情緒修正、非基本面惡化（Q2 大超預期、全年上修 >40%、股利 +33%）——股價與基本面短線脫鉤、超跌後中長線價值浮現。下一觀察：（1）7/20 週一觀察技術性反彈——ADR 溢價逆勢擴大至 +12%、估值消化（P/E 26.2x）、內資逆勢承接（投信 +1,489、自營 +2,759）為支撐；（2）守穩支撐 2,255（布林下軌）／2,200／2,150；（3）反彈壓力 2,331（60MA）／2,412（5MA）／2,470（7/16 高）；（4）外資連 7 史詩級賣超能否止穩為最大觀察點；（5）AI 情緒面能否止穩為短線最大變數。",
    "support":  "2,255 / 2,200 / 2,150 (布林下軌、心理關卡、次一支撐)",
    "resist":   "2,331 / 2,412 / 2,470 (60MA、5MA、7/16 高)",
    "note": "均線與 RSI/MACD/KDJ/布林均依官方收盤價計算（2026-07-17 止、部分估算），請以看盤軟體為準；7/17 官方收 NT$2,290（-7.29%）跌破 5MA ~2,412 / 20MA ~2,426、回測 60MA ~2,331、RSI ~40.5、MACD 綠柱擴大至 -13、KDJ K32/D40/J16 死叉墜超賣；下方支撐 2,255 / 2,200 / 2,150、上方壓力 2,331 / 2,412 / 2,470；⚠️⚠️ AI 晶片股正式跌入熊市（SOX -20.2%）vs ✅ TSMC 基本面大超預期未變（全年上修 >40%、CapEx $60-64B、股利 +33%）——本次為估值/情緒修正、股價與基本面脫鉤；7/20 週一超跌反彈 vs 續探底、外資能否止穩為兩大變數",
}
...
DERIVATIVES = {
    ...
    "key_strikes": [
        ...
        ("2,255", "Call 50,000 / Put 15,000", "布林下軌、下方支撐"),
        ("2,290", "Call 45,000 / Put 11,000", "7/17 官方收、多空分界"),
        ("2,331", "Call 40,000 / Put 8,000",  "60MA、反彈壓力"),
        ("2,350", "Call 38,000 / Put 6,500",  "最大痛苦（估）"),
        ("2,412", "Call 30,000 / Put 4,500",  "5MA、上方壓力"),
        ("2,470", "Call 22,000 / Put 3,000",  "7/16 高、壓力帶"),
    ],
    "note": "衍生品數據為估算、需每日至台灣期交所(taifex.com.tw)核實；價位錨點按 TWSE 官方收盤（7/17 NT$2,290）；NT$2,350 為估最大痛苦、下方支撐 2,255（布林下軌）/ 2,200 / 2,150、上方壓力 2,331（60MA）/ 2,412（5MA）/ 2,470；⚠️⚠️ AI 晶片股正式跌入熊市（SOX -20.2%）、台股三大法人單日賣超 2,617 億創史上最大 vs ✅ TSMC 基本面大超預期未變（全年上修 >40%、CapEx $60-64B、股利 +33%）——本次為估值/情緒修正、非基本面惡化；7/20 週一超跌反彈 vs 續探底、外資連 7 賣能否止穩為關鍵；中長線基底未變（AI 需求「比預期更強」、2nm 已貢獻 3% 營收、NVIDIA #1 客戶/A16 首發、CoWoS 訂滿至 2027、Arizona 追加 $100B 投資）",
}

# 供應鏈與客戶股價（需每日更新）
ECOSYSTEM_STOCKS = [
    # 類別、股票代碼、名稱、收盤價、漲跌幅、備註（台股個股為 2026-07-17 Fri 官方/估收盤；美股為 7/17 Fri 收盤（尾盤自低點回升、SOX 收僅 -1.6%）；韓股 7/17 為估；台股/韓股個股標「估」）
    ("設備", "ASML",    "艾司摩爾",    "1,767.00", "-1.00%", "⭐ EUV 設備龍頭（估）；7/17 隨晶片股拋售但相對抗跌；TSMC CapEx 上調至 $60-64B 為設備鏈利多"),
    ("設備", "AMAT",    "應用材料",    "549.70", "-2.00%", "🛠️ AMAT-TSMC $5B EPIC Center 研發合作（估、7/17 隨 SOX 熊市回檔）；TSMC CapEx $60-64B 為設備鏈利多"),
    ("設備", "LRCX",    "科林研發",    "314.50", "-2.01%", "蝕刻設備（估、7/17 回檔）；TSMC CapEx $60-64B + WFE 上修為中長線支撐"),
    ("設備", "KLAC",    "科磊",        "216.10", "-1.49%", "量測設備（估、7/17 回檔）；2nm 量產驅動中長線"),
    ("記憶", "2344.TW", "華邦電 Winbond","161.70","-6.00%", "與 TSMC 合作 CUBE 特殊 DRAM 導入 WoW 3D 堆疊/SoIC（估、7/17 隨台股崩跌重挫）"),
    ("記憶", "000660.KS","SK 海力士",  "1,814,000 KRW", "-1.52%", "HBM4、與 NVIDIA 多年期合作（7/17 估、前兩日急跌後跌幅收斂）"),
    ("記憶", "MU",      "美光",        "848.95", "-0.50%", "HBM / DDR5（7/17 跌幅收斂 ~-0.5%）；AI 記憶體修正後 HBM4 中長線邏輯未變"),
    ("封裝", "3711.TW", "日月光",      "641.00", "-6.01%", "CoWoS / 先進封裝（估、7/17 隨台股崩跌重挫）"),
    ("封裝", "AMKR",    "Amkor",       "61.80",  "-1.94%", "⭐ TSMC-Amkor 10 年美國封裝長約、Peoria AZ $70 億 2028 投產（估、7/17 隨 SOX 回檔）"),
    ("客戶", "NVDA",    "輝達",        "203.30", "-1.98%", "🏆 TSMC #1 客戶 22%/$33B、A16 首發客戶；7/17 盤中一度 -3% 尾盤回升收 ~$203.30（AI 投資報酬疑慮引獲利了結）"),
    ("客戶", "AAPL",    "蘋果",        "331.60", "-0.50%", "⭐ #2 客戶 18%；7/17 相對抗跌（估）；跳過 A16 直上 A14"),
    ("客戶", "AVGO",    "博通",        "368.80", "-1.51%", "#3 客戶；custom XPU、與 NVIDIA 包下 CoWoS 新產能（7/17 盤中 -2% 尾盤回升、估）"),
    ("客戶", "AMD",     "超微",        "483.40", "-3.50%", "#4 客戶；MI350/MI450、首發 2nm AI 晶片（7/17 盤中一度 -5% 尾盤回升、估）"),
    ("客戶", "2454.TW", "聯發科",      "3,440",  "-7.03%", "手機 SoC 客戶 9%（估、7/17 隨台股崩跌重挫）；面臨漲價成本"),
    ("競爭", "INTC",    "英特爾",      "94.50",  "-2.56%", "18A 節點量產、吸引微軟/高通；亦為 TSMC 客戶（7/17 盤中一度 -4% 尾盤回升、估、自高點已 -30%+）"),
    ("競爭", "005930.KS","三星電子",   "252,000 KRW", "-1.18%", "跟進 TSMC 調漲 4/5nm 代工價約 15%；HBM4E 送樣（7/17 估、前兩日急跌後收斂）"),
    ("產業", "SOX",     "費城半導體指數","11,677.60", "-1.60%", "⚠️⚠️ 7/17 正式跌入熊市——自 6/22 史高 -20.2%、單週 -9%（盤中一度 -5.7% 尾盤收斂至 -1.6%）；3-6 月曾自低點飆 +105%"),
    ("處分後", "ARM",   "Arm Holdings","254.20", "-2.98%", "TSMC 4/29 全數出脫後（7/17 回檔、估、自高點已 -30%+）"),
]
...
NEWS = [
    ...
    {
        "tag": "警示", "tag_color": "#F44336",
        "title": "📉 台股 2330 7/17 崩跌 -7.29% 收 NT$2,290、三大法人單日賣超 2,617 億創史上最大",
        "body": "史詩級賣壓、台積電成重災區：（1）📉 台股 2330 7/17 官方收 NT$2,290（-180、-7.29%、開 2,375／高 2,395／低 2,290、收盤即當日最低）——量爆增至 97,362 張（TWSE 口徑、成交額 NT$2,290.52 億、成交 1,150,086 筆、前日 3.2 倍）；（2）💥 台股三大法人 7/17 合計賣超逾 2,617 億元、創台股史上單日最大紀錄、外資提款台積電破千億；（3）📊 技術面全面轉空：跌破 5MA ~2,412 / 20MA ~2,426、回測 60MA ~2,331、RSI ~40.5、KDJ K32/D40/J16 死叉墜超賣；（4）🎯 7/20 週一觀察超跌反彈——ADR 溢價逆勢擴大至 +12%、估值消化（P/E 26.2x）、內資逆勢承接為支撐。",
