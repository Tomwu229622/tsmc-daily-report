...
STOCK = {
    # 台股 2330
    "tw_price":       "2,370",        # 2026-06-29 Mon 官方收盤（+30、+1.28% vs 6/26 NT$2,340；NYSE 隔夜大漲 +5.26% 帶動、Winbond DRAM 合作+漲價定價力+BofA 上調題材；6/30 Tue 今日料開高、官方收盤待 TWSE）
    "tw_change":      "+30",          # 6/29 漲跌點數（+1.28%）
    "tw_change_pct":  "+1.28%",       # 6/29 漲跌幅（自 6/26 NT$2,340 反彈 30 點）
    "tw_volume":      "38,133",       # 6/29 官方成交量（張，量縮、成交額 903.37 億元、振幅 2.78%）
    "tw_open":        "2,330",        # 6/29 開盤（官方）
    "tw_high":        "2,395",        # 6/29 盤中高（官方）
    "tw_low":         "2,330",        # 6/29 盤中低（官方、開盤即低）
    "market_cap":     "NT$61.5 兆",   # 6/29 收盤市值（NT$2,370 基礎）
    "pe_ratio":       "~35.0x",       # 台股 P/E（TTM，NT$2,370 基礎）
    "pb_ratio":       "~12.3x",       # 台股 P/B（股淨比，NT$2,370 基礎）
    "div_yield":      "~0.63%",       # 殖利率（NT$2,370 基礎）
    ...
    # 資料日期備註
    "data_note":      "報告日期：2026-06-30 Tue（NYSE TSM 6/29 Mon 收盤 $455.10 為最新確認收盤；台股 2330 6/29 Mon 官方收 NT$2,370 為最新確認；台股 6/30 Tue 今日交易中、官方收盤請以 TWSE 為準）。⭐ 今日頭條——TSMC 雙市同步反彈、漲價題材升級為「定價力 + 自主供應鏈」雙主軸：（1）🚀 NYSE TSM 6/29 Mon 大漲 +5.26%（+$22.75）收 $455.10、創波段新高、市值約 $2.1 兆（P/E ~32.5、前收 $432.35），三大催化——⭐ TSMC 與華邦電（Winbond）合作將特殊 DRAM（採 CUBE 客製超高頻寬架構）導入 WoW 3D 晶圓堆疊與 SoIC 先進封裝、把關鍵記憶體生產留在台灣、降低對 Samsung/SK 海力士 HBM 依賴（台灣在地化估縮短週期 66%、降運輸成本 90%）；⭐ 漲價定價力擴及先進與成熟製程、印證 AI 需求下議價力；⭐ Bank of America 等多家機構上調目標（彙整平均目標 $468.08、最高 $600、最低 $351）；（2）📈 台股 2330 6/29 Mon 收 NT$2,370（+30、+1.28%、量縮至 38,133 張、成交額 903.37 億元、振幅 2.78%、開 2,330 / 高 2,395），自 6/26 NT$2,340 反彈；（3）📊 台股 6/30 Tue 今日料受隔夜 ADR +5.26% 激勵開高、官方收盤待 TWSE。📊 台美 ADR 溢價（以 6/29 ADR $455.10 + 台股 NT$2,370、匯率 31.05 計）：理論值 5×2,370÷31.05 = $381.64、溢價 (455.10-381.64)/381.64 = +19.25%（溢價走闊、ADR 領先台股、台股具補漲空間）。⚠️ 漲價雙面刃——利多毛利率（估全年 +2pp 以上），惟客戶（含 Apple/NVIDIA/AMD/Qualcomm/Broadcom/MediaTek）成本升、恐促部分客戶調整下單量或轉向替代；Benzinga 指 NVIDIA 因 AI 需求剛性與轉嫁能力強、長期反為利多。⚠️ 近期營收疑慮續存——TSMC 4-5 月營收合計 +24% YoY 低於華爾街 Q2 約 +35% 預期、6 月營收（7 月上旬公布）為關鍵 catalyst、僅需小幅月增即可使 Q2 營收逼近指引中值。⚠️ ITC 專利調查初判預計本週（6 月底）出爐、為短線關鍵雜訊。⭐ 中長線結構性利多基底未變：Winbond 特殊 DRAM 自主供應、TSMC-Amkor 10 年美國先進封裝長約（Peoria AZ $70 億、2028 投產）、NVIDIA 確認第 1 大客戶（22%/$33B）+ A16 首發 2027 量產、NVIDIA-TSMC AI 製程合作（cuLitho/缺陷檢測/工廠排程）、2nm 量產 70-80% 良率、2nm/A16 產能 2026-28 估 CAGR ~70%。⚠️ 風險續追蹤——（1）TSMC 遭美 ITC 專利調查（Longitude/Marlin 控訴）、6 月底預計初判、恐對含 AI 加速器技術晶片發布美國進口禁令；（2）Apple 同意與 Intel 合作在美生產晶片、Intel 18A-P 進入風險量產並與 UMC 結盟、Google/AMD/Tesla 接觸 Samsung。  |  🎯 即將事件：ITC 初判 6 月底（本週）；6 月營收 7 月上旬公布（關鍵 catalyst、攸關 Q2 指引達成）；Q2 2026 財報法說會 7/16（指引 $39.0-40.2B、毛利率 65-67%、漲價後上修空間）  |  ⭐ 中長線基底：5 月營收 NT$4,169.75 億 +30.1% 創單月新高；2nm 量產良率 70-80% 領先全球；NVIDIA 第 1 大客戶 22%/$33B；4 大美國 CSP 2026 AI CapEx 合計 $725B（+77% YoY）；2026 全球半導體市場估 +26% YoY 達 ~$975B；SIA/Deloitte 估 AI 資料中心晶片營收 2028 達 ~$1.2 兆（佔 AI 伺服器機櫃價值 95%）  |  ⚠️ 本日（6/30）關鍵觀察：（1）台股 2330 能否站回並守穩 5MA ~NT$2,396 / NT$2,400 並挑戰 NT$2,450；（2）ADR 溢價 +19.25%、台股具補漲空間；（3）下方支撐 NT$2,340 / NT$2,310 / NT$2,250；上方壓力 NT$2,450 / NT$2,490 / NT$2,535 史高；（4）⚠️ 估值警示：TSM P/E ~32.5x、台股 P/E ~35.0x，留意 ITC 初判、6 月營收 miss 風險與漲價客戶反彈",
}
...
SUMMARY = {
    ...
    "sentiment":  "看多",
    # 一句話標題
    "headline":   "🚀 TSMC 雙市反彈、漲價題材升級「定價力 + 自主供應鏈」：NYSE TSM 6/29 大漲 +5.26% 收 $455.10 創波段新高（Winbond 特殊 DRAM/WoW 合作降低 HBM 對 Samsung/SK 依賴 + 漲價定價力 + BofA 上調目標）；台股 2330 6/29 收 NT$2,370（+1.28%）反彈、6/30 今日料開高",
    # 3–5 條白話重點（不用術語，每條約 30 字內）
    "bullets": [
        "🚀 NYSE TSM 6/29 Mon 大漲 +5.26%（+$22.75）收 $455.10 創波段新高、市值約 $2.1 兆——Winbond DRAM 合作 + 漲價定價力 + BofA 上調目標三催化",
        "📈 台股 2330 6/29 Mon 收 NT$2,370（+30、+1.28%、量縮至 38,133 張、開 2,330/高 2,395）自 6/26 反彈；台股 6/30 今日料受隔夜 ADR 激勵開高",
        ...
        "📊 ADR 溢價走闊至 +19.25%（以 6/29 ADR $455.10 + 台股 NT$2,370、匯率 31.05 計）、ADR 領先、台股具補漲空間",
    ...
    # 一句結論
    "bottom_line": "報告日期：2026-06-30 Tue（NYSE TSM 6/29 Mon 收盤 $455.10 為最新確認收盤；台股 2330 6/29 Mon 官方收 NT$2,370 為最新確認；台股 6/30 Tue 今日交易中、官方收盤請以 TWSE 為準）。⭐ 今日頭條——TSMC 雙市同步反彈、漲價題材升級為「定價力 + 自主供應鏈」雙主軸：（1）🚀 NYSE TSM 6/29 大漲 +5.26%（+$22.75）收 $455.10、創波段新高、市值約 $2.1 兆（P/E ~32.5、前收 $432.35），三大催化——⭐ TSMC 與華邦電（Winbond）合作將特殊 DRAM（CUBE 客製超高頻寬架構）導入 WoW 3D 晶圓堆疊與 SoIC 先進封裝、把關鍵記憶體生產留在台灣、降低對 Samsung/SK 海力士 HBM 依賴（台灣在地化估縮短週期 66%、降運輸成本 90%）；⭐ 漲價定價力擴及先進與成熟製程、印證 AI 需求下議價力；⭐ Bank of America 等多家機構上調目標（彙整平均目標 $468.08、最高 $600、最低 $351）；（2）📈 台股 2330 6/29 收 NT$2,370（+30、+1.28%、量縮 38,133 張、成交額 903.37 億元、開 2,330/高 2,395）自 6/26 反彈；（3）📊 台股 6/30 今日料受隔夜 ADR +5.26% 激勵開高。📊 台美 ADR 溢價（以 6/29 ADR $455.10 + 台股 NT$2,370、匯率 31.05 計）：理論值 5×2,370÷31.05 = $381.64、溢價 +19.25%（溢價走闊、ADR 領先台股、台股具補漲空間）。⚠️ 漲價雙面刃：利多毛利率（估全年 +2pp 以上），惟客戶（含 Apple/NVIDIA/AMD/Qualcomm/Broadcom/MediaTek）成本升、恐促部分調整下單或轉向替代；Benzinga 指 NVIDIA 因 AI 需求剛性與轉嫁能力強、長期反為利多。6 月營收（7 月上旬公布）為關鍵 catalyst——4-5 月營收合計 +24% YoY 低於華爾街 Q2 約 +35% 預期、惟即使小幅月增亦可能使 Q2 營收逼近指引（$39.0-40.2B）中值。⚠️ ITC 專利調查初判預計本週（6 月底）出爐、為短線關鍵雜訊。⭐ 中長線結構性利多基底未變：（1）⭐ TSMC-Winbond 特殊 DRAM 自主供應、降低 HBM 對韓系依賴；（2）🤝 TSMC-Amkor 10 年美國先進封裝長約（Peoria AZ $70 億、2028 投產）；（3）🏆 NVIDIA 確認 TSMC 第 1 大客戶（22%/$33B）、A16 首發 2027 量產，Apple 跳過 A16 直上 A14；（4）⭐ NVIDIA-TSMC 深化 AI 導入晶圓廠（cuLitho/缺陷檢測/工廠排程）；（5）⭐ 2nm 已量產、初期良率 70-80% 領先全球、2nm/A16 產能 2026-28 估 CAGR ~70%；（6）4 大美國 CSP 2026 AI CapEx 合計 $725B（+77% YoY）；（7）⭐ 5 月營收 NT$4,169.75 億 +30.1% 創單月新高、1-5 月累計 NT$1.96 兆；（8）2026 全球半導體市場估 +26% YoY 達 ~$975B、SIA/Deloitte 估 AI 資料中心晶片營收 2028 達 ~$1.2 兆。⚠️ 下行風險：（1）漲價恐引發客戶反彈與訂單調整；（2）4-5 月營收 +24% YoY 落後 Q2 ~35% 預期、6 月營收為關鍵驗證；（3）TSMC 遭美 ITC 專利調查（Longitude/Marlin 控訴）、6 月底初判恐對含 AI 加速器晶片發布美國進口禁令；（4）Apple-Intel 合作、Intel 18A-P 風險量產+UMC 結盟、Google/AMD/Tesla 接觸 Samsung；（5）估值警示——TSM P/E ~32.5x、台股 P/E ~35.0x；（6）台幣升值（每升 1% 毛利率 -40bps）。基本面未變：Q1 2026 淨利 NT$572.5B（$18.2B、+58.3% YoY）、毛利率 66.2% 雙創史高。技術面（基於 6/29 收 NT$2,370）：5MA NT$2,396 / 20MA NT$2,400 / 60MA NT$2,370 / 120MA NT$2,270；RSI 回升至 52、KDJ 黃金交叉、MACD 死叉風險解除；下方支撐 NT$2,340 / NT$2,310 / NT$2,250；上方壓力 5MA NT$2,396 / NT$2,450 / NT$2,490 / NT$2,535（史高）。分析師全面看多、BofA 等上調目標（彙整平均 $468.08、最高 $600）。",
    # 重大警示（選填，空白則不顯示）
    "risk_alert":  "今日（6/30 Tue）關鍵觀察：（1）🚀 NYSE TSM 6/29 大漲 +5.26% 收 $455.10 創波段新高、台股 2330 6/29 收 NT$2,370（+1.28%）反彈、6/30 今日料受隔夜 ADR 激勵開高；（2）⭐ TSMC-Winbond 特殊 DRAM（WoW 3D 堆疊/CUBE 架構）合作降低 HBM 對 Samsung/SK 依賴——本波反彈核心利多；（3）⭐ 漲價升級為定價力、擴及先進+成熟製程、估全年毛利率 +2pp 以上；（4）📈 BofA 等上調目標（彙整平均 $468.08、最高 $600、最低 $351）；（5）📊 ADR 溢價走闊至 +19.25%、台股具補漲空間；（6）⚠️ 漲價雙面刃——客戶成本升、Benzinga 指 NVIDIA 可轉嫁長期反利多；（7）⚠️ 4-5 月營收 +24% YoY 落後 ~35% 預期、6 月營收（7 月上旬）為關鍵 catalyst；（8）⚠️ ITC 專利調查初判預計本週（6 月底）出爐——若不利恐對含 AI 加速器晶片發布美國進口禁令；（9）🏆 NVIDIA 確認 TSMC 第 1 大客戶（22%/$33B）、A16 首發 2027；（10）⚠️ 風險續追蹤——Apple-Intel 合作、Intel 18A-P 風險量產+UMC 結盟、Google/AMD/Tesla 接觸 Samsung；（11）⭐ 2nm 量產良率 70-80% 領先全球、2nm/A16 產能 2026-28 估 CAGR ~70%；（12）⚠️ 估值警示：TSM P/E ~32.5x、台股 P/E ~35.0x；本日關鍵：台股能否站回 5MA ~NT$2,396 / NT$2,400 並挑戰 NT$2,450；下方支撐 NT$2,340 / NT$2,310 / NT$2,250",
}

# 三大法人買賣超（張）— 最新一日
INSTITUTIONAL = {
    "date":     "2026-06-29",       # 最新資料日（6/29 Mon 盤後；以下數值為估算、官方待 TWSE/三大法人確認）
    "foreign":  2500,              # 外資 6/29 估買超約 2,500 張（台股 +1.28% 反彈、賣壓趨緩；官方待確認）
    "trust":    400,               # 投信 6/29 估買超約 400 張
    "dealer":   150,               # 自營商 6/29 估買超約 150 張
    # 近5日（由舊到新：6/23, 6/24, 6/25, 6/26, 6/29）；6/29 為估算、其餘部分為估算
    "foreign_5d": [-9000, -15000, 1500, -6104, 2500],     # 外資 6/29 估買超約 2,500 張
    "trust_5d":   [500, 800, 600, 179, 400],              # 投信 6/29 估買超約 400 張
    "dealer_5d":  [-200, -500, 300, -310, 150],           # 自營 6/29 估買超約 150 張
    "foreign_ownership_pct": "74.8%",  # 外資持股比例（6/29 估微升至 74.8%）
    "foreign_ownership_shares": "約 193.7 億股",
}

# 技術分析指標（需每日從看盤軟體更新）
TECHNICAL = {
    "rsi_14":       52.0,   "rsi_signal": "RSI 估回升至 52（台股 6/29 +1.28%），站回中軸、動能轉強；NYSE 隔夜 +5.26% 提振、6/30 留意能否延續反彈",
    "macd":         0.10,  "macd_signal": "MACD 估回升至 +0.10、紅柱轉增、動能改善、死叉風險解除、待量能確認",   "macd_color": "#4CAF50",
    "kdj_k":        52.0,   "kdj_d": 48.0, "kdj_j": 60.0, "kdj_signal": "KDJ K(52)/D(48)/J(60) 黃金交叉向上、6/29 反彈帶動、短線轉強",
    "ma5":       "2,396",   # 5MA（6/23 2490, 6/24 2390, 6/25 2390, 6/26 2340, 6/29 2370）— 基於 6/29 收
    "ma20":      "2,400",   # 20MA
    "ma60":      "2,370",   # 60MA 緩升
    "ma120":     "2,270",
    "bb_upper":  "2,540",   # 布林上軌
    ...
    "trend":    "🚀 TSMC 雙市同步反彈、漲價題材升級為「定價力 + 自主供應鏈」雙主軸：NYSE TSM 6/29 大漲 +5.26% 收 $455.10 創波段新高（Winbond 特殊 DRAM/WoW 合作 + 漲價定價力 + BofA 上調目標）；台股 2330 6/29 收 NT$2,370（+1.28%、量縮 38,133 張）自 6/26 反彈；台股 6/30 今日料受隔夜 ADR 激勵開高。📊 技術面（基於 6/29 收 NT$2,370）：RSI 回升至 52 站回中軸、MACD +0.10 死叉風險解除、KDJ 黃金交叉、惟收盤仍略低於 5MA NT$2,396、中期 60MA/120MA 趨勢偏多。下一觀察：（1）台股能否站回並守穩 5MA ~NT$2,396 / NT$2,400 並挑戰 NT$2,450；（2）下方支撐 NT$2,340 / NT$2,310 / NT$2,250；（3）上方壓力 NT$2,450 / NT$2,490 / NT$2,535 史高；（4）⭐ 漲價+Winbond 自主 DRAM 利多、惟須留意 6 月營收（7 月上旬）與 ITC 初判（本週）；（5）⭐ 中長線基底未變：NVIDIA #1 客戶/A16 首發 + 2nm 70-80% 良率 + BofA 等上調目標。",
    "support":  "2,340 / 2,310 / 2,250 / 2,200 (6/26 收、整數、整數、整數)",
    "resist":   "2,396 / 2,450 / 2,490 / 2,535 (5MA、整數、6/23 收、史高)",
    "note": "技術指標數值為估算（基於 6/29 收 NT$2,370），請以看盤軟體即時數據為準；台股 6/29 +1.28%、NYSE 6/29 +5.26% 大漲創波段新高、RSI 回升至 52、KDJ 黃金交叉、MACD 死叉風險解除；NT$2,396（5MA）為短線關鍵、上方壓力 NT$2,450；6/30 今日台股料開高、⭐ 漲價+Winbond 自主供應利多 vs ⚠️ 6 月營收與 ITC 初判雜訊拉鋸",
}

# 期貨與選擇權（來源：台灣期交所 TAIFEX）
DERIVATIVES = {
    "date":          "2026-06-29",       # 最新資料日（6/29 Mon 收盤估、6/30 今日盤後待公布）
    "futures_price": "2,372",            # 台積電期貨近月（6/29 收盤附近、小幅正價差）
    "futures_oi":    "170,000",          # 未平倉量（口）（6/29 估）
    "futures_basis": "+2",               # 6/29 估轉小幅正價差（雙市反彈、情緒轉樂觀）
    "call_oi":       "108,000",
    "put_oi":        "78,000",
    "pcr":           "0.72",             # Put/Call 比率（6/29 估 0.72、台股反彈、避險買盤降、情緒轉樂觀）
    "pcr_signal":    "中性偏多（Put/Call 6/29 估 0.72；台股 6/29 +1.28%、NYSE 隔夜 +5.26%、雙市反彈、情緒轉樂觀、期貨轉小幅正價差；⭐ 漲價+Winbond 自主供應為中長線支撐）",
    "max_pain":      "2,400",            # 最大痛苦價格（近期到期、6/29 估）
    "key_strikes": [
...
NEWS = [
    {
        ...
        "title": "🚀 TSMC 雙市大反彈：NYSE TSM 6/29 漲 +5.26% 收 $455.10 創波段新高；⭐ TSMC-Winbond 特殊 DRAM 合作（WoW 3D 堆疊）降低 HBM 對 Samsung/SK 依賴",
        "body": "今日頭條——TSMC 雙市同步反彈、漲價題材升級為「定價力 + 自主供應鏈」雙主軸：（1）🚀 NYSE TSM 6/29 Mon 大漲 +5.26%（+$22.75）收 $455.10、創波段新高、市值回升至約 $2.1 兆（P/E ~32.5、前收 $432.35）；台股 2330 6/29 收 NT$2,370（+30、+1.28%、量縮 38,133 張、開 2,330/高 2,395）自 6/26 反彈；（2）⭐ 核心催化：TSMC 與華邦電（Winbond）合作，將其 CUBE（Customized Ultra-Bandwidth Elements）特殊 DRAM 導入 WoW（wafer-on-wafer）3D 晶圓堆疊與 SoIC 先進封裝，把關鍵記憶體生產留在台灣、降低對 Samsung/SK 海力士 HBM 依賴——台灣在地化估縮短週期 66%、降運輸成本 90%；（3）📊 ADR 溢價走闊至 +19.25%（以 6/29 ADR $455.10 + 台股 NT$2,370、匯率 31.05 計）、台股 6/30 今日料受激勵開高。",
        "source": "stockanalysis / ainvest / cryptobriefing / TradingView 2026-06-29", "impact": "正面",
    },
    {
