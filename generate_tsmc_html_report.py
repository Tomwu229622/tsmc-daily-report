...
STOCK = {
    # 台股 2330
    "tw_price":       "1,995",        # 收盤價（數字加逗號，不含 NT$）（2026-04-14 估）
    "tw_change":      "+45",          # 漲跌點數（含+/-號，vs 4/10 收盤 NT$1,950）
    "tw_change_pct":  "+2.30%",       # 漲跌幅（含+/-號）
    "tw_volume":      "35,000",       # 成交量（張，4/14 估）
    "tw_open":        "1,960",
    "tw_high":        "2,010",
    "tw_low":         "1,960",
    "market_cap":     "NT$51.8 兆",
    "pe_ratio":       "~29.4x",       # 台股 P/E（TTM，NT$1,995 基礎，EPS 共識 NT$67.8）
    "pb_ratio":       "~10.7x",       # 台股 P/B（股淨比）
    "div_yield":      "~0.75%",       # 殖利率（已除息後調整，USD $2.65/ADR 年息）
    "52w_high_tw":    "2,025",        # 52 週高（2026-02-25）
    "52w_low_tw":     "780",          # 52 週低（2025-04-07）
    # NYSE TSM ADR
    "nyse_price":     "370.04",       # 最新報價（2026-04-11/14 估）
    "nyse_change":    "-0.56",        # 與 4/10 收盤相比（$370.60→$370.04）
    "nyse_change_pct":"-0.15%",
    "52w_high_nyse":  "390.21",       # 52 週高（2026-02-25）
    "52w_low_nyse":   "134.25",       # 52 週低（2025-04-07）
    "pe_nyse":        "~32.8x",       # NYSE USD 基礎 P/E（TTM）
    "pb_nyse":        "~10.5x",
    "beta":           "1.16",
    "div_next":       "Q2 除息已完成（4/9，US$0.968/ADR）；下次配息預計 2026-06",
    "ex_date":        "2026-04-09（Q2 除息完成，US$0.968/ADR）",
    "next_earnings":  "2026-04-16（Q1 2026 財報倒計時 2 天）",
    # 資料日期備註
    "data_note":      "📅 今日（4/14）週一開盤，台股 2330 估收 NT$1,995（+2.30%），反映 Q1 營收強勁利多  |  NYSE TSM：$370.04（-0.15%，上週五收盤）  |  ⭐ Q1 2026 營收 NT$1.134 兆（+35.1%），超越共識預期 NT$1.12 兆  |  3 月月營收 NT$415.2B（+45.2% YoY），季度最強月  |  Q2 除息（4/9）已完成（US$0.968/ADR）  |  ⏰ 4/16 Q1 完整財報（EPS 共識 NT$20.38）倒計時 2 天  |  NVIDIA 超越 Apple 成 TSMC 最大客戶（22%，~$330B）  |  全球半導體 2026 年總收入逾 $1.3 兆（Deloitte）",
}
...
SUMMARY = {
    ...
    "sentiment":  "看多",
    # 一句話標題
    "headline":   "4/14 週一開盤反彈：台股 2330 估 +2.30%（NT$1,995），Q1 財報 4/16 倒計時 2 天，全球半導體 2026 年收入逾 $1.3 兆",
    # 3–5 條白話重點（不用術語，每條約 30 字內）
    "bullets": [
        "⭐ TSMC Q1 2026 營收 NT$1.134 兆（+35.1% YoY），超越共識預期 NT$1.12 兆，創季度新高",
        "📈 台股 2330 今日（4/14）週一開盤反彈，估收 NT$1,995（+2.30%），NYSE TSM $370.04（上週五收盤）",
        "⏰ 4/16（後天）Q1 完整財報公布，EPS 共識 NT$20.38，市場關注 Q2 毛利率指引（63–65%）",
        "NVIDIA 確認超越 Apple 成 TSMC 最大客戶（22%，~$330 億美元），2nm 產能預訂量超過總計劃容量",
        "🌐 全球半導體 2026 年收入估逾 $1.3 兆（Deloitte），AI 晶片佔 30%，TSMC 受益最深",
    ],
    # 一句結論
    "bottom_line": "今日（4/14）週一，台股 2330 於 Q1 強勁營收利多推動下開盤走高，估收 NT$1,995（+2.30%），NYSE TSM 上週五報 $370.04（-0.15%）。TSMC Q1 2026 營收 NT$1.134 兆（+35.1%），強勢超越共識 NT$1.12 兆，3 月月營收 +45.2% YoY 為本季最強月。4/16（後天）Q1 完整財報為最近期重大催化劑，市場關注 Q2 毛利率指引（63–65%）及全年展望。分析師目標價最高上調至 US$515，31 位全數看多，中長線基本面強勁。",
    # 重大警示（選填，空白則不顯示）
    "risk_alert":  "⏰ 4/16（後天）Q1 完整財報（EPS 共識 NT$20.38）；⚠️ 關稅政策不確定性持續；中東地緣政治情勢（伊朗戰事）；中國地緣政治風險；3nm/2nm 產能瓶頸至 2028 年；先進封裝（CoWoS）已幾乎全被 NVIDIA 預訂，ABF 基板供應限制",
}

# 三大法人買賣超（張）— 最新一日
INSTITUTIONAL = {
    "date":     "2026-04-14",
    "foreign":  +3200,    # 外資（正=買超）— 4/14 週一反彈，Q1 財報前買盤（估）
    "trust":    +480,     # 投信（逢低承接，Q1 營收利多延續，估）
    "dealer":   +320,     # 自營商（估，財報前倒數做多）
    # 近5日（由舊到新，最後一筆為 4/14）
    "foreign_5d": [-3500, +1200, +2500, +1800, +3200],  # 4/14 財報前外資持續加碼（估）
    "trust_5d":   [+280,  +310,  +420,  +380,  +480],
    "dealer_5d":  [-350,  +150,  +280,  +200,  +320],
    "foreign_ownership_pct": "74.8%",  # 外資持股比例（估，4/14）
    "foreign_ownership_shares": "約 194.2 億股",
}

# 技術分析指標（需每日從看盤軟體更新）
TECHNICAL = {
    "rsi_14":       52.3,   "rsi_signal": "RSI 突破 50 中線（48.5→52.3），動能轉正，短線偏多，4/16 財報前看守 55 關口",
    "macd":         -3.8,   "macd_signal": "MACD 差距持續收窄（-6.2→-3.8），接近黃金交叉，財報催化劑可能觸發多頭突破",   "macd_color": "#FF9800",
    "kdj_k":        62.5,   "kdj_d": 51.8, "kdj_j": 83.9, "kdj_signal": "KDJ 黃金交叉強化，J 值 83.9 顯示強勢動能，4/14 反彈後短線偏多",
    "ma5":       "1,950",
    "ma20":      "1,880",
    "ma60":      "1,850",
    "ma120":     "1,760",
    "bb_upper":  "2,040",   # 布林上軌
    "bb_mid":    "1,880",   # 布林中軌（20MA）
    "bb_lower":  "1,720",   # 布林下軌
    "vol_ma5":  "32,000",   # 5日均量（張，4/14 估）
    "trend":    "台股 2330（4/14 週一開盤反彈，估收 NT$1,995，+2.30%），Q1 2026 營收 NT$1.134 兆（+35.1%）強勢利多持續發酵。NYSE TSM $370.04（-0.15%，上週五收）。技術面：突破 MA5 (1,950) 並向上測試 2,000 關口；RSI 穿越 50 轉多；4/16 Q1 財報（EPS 共識 NT$20.38）為最近期催化劑，毛利率若達 63-65% 指引將帶動突破 2,025 前高。",
    "support":  "1,950–1,970",
    "resist":   "2,000–2,025",
...
DERIVATIVES = {
    "date":          "2026-04-14",
    "futures_price": "2,005",      # 台積電期貨近月（估，4/14 反彈突破現貨）
    "futures_oi":    "82,000",     # 未平倉量（口）（估，財報前多單累積）
    "futures_basis": "+10",        # 正價差（4/14 反彈，財報前多頭氣氛強烈）
    "call_oi":       "42,000",
    "put_oi":        "44,000",
    "pcr":           "1.05",       # Put/Call 比率繼續下降（市場信心恢復）
    "pcr_signal":    "中性偏多（Put/Call 從 1.25 降至 1.05，4/16 財報前多頭部位增加）",
    "max_pain":      "1,950",      # 最大痛苦價格
    "key_strikes": [
        ("1,900", "Call 8,500 / Put 7,200",  "關鍵支撐（MA5 附近）"),
        ("1,950", "Call 14,500 / Put 5,800", "新支撐（今日高點）"),
        ("1,980", "Call 16,200 / Put 4,500", "最大痛苦區"),
        ("2,000", "Call 22,000 / Put 3,200", "心理關口，Call 大量堆積"),
        ("2,025", "Call 18,500 / Put 2,100", "上方壓力，52週高附近"),
    ],
...
# 供應鏈與客戶股價（需每日更新）
ECOSYSTEM_STOCKS = [
    # 類別、股票代碼、名稱、收盤價、漲跌幅、備註（2026-04-14 估）
    ("設備", "ASML",    "艾司摩爾",    "652.50", "+0.7%", "EUV 設備龍頭（Q1 財報倒計時，關注訂單）"),
    ("設備", "AMAT",    "應用材料",    "163.80", "+1.4%", "CVD/PVD 設備（AI 需求帶動出貨）"),
    ("設備", "LRCX",    "科林研發",    "765.20", "+0.6%", "蝕刻設備（穩步回升）"),
    ("設備", "KLAC",    "科磊",        "563.40", "+0.4%", "量測設備（2nm 驗證需求強勁）"),
    ("記憶", "000660.KS","SK 海力士",  "285,000 KRW", "+1.1%", "HBM3e/4 供應商"),
    ("記憶", "MU",      "美光",        "91.50",  "+1.4%", "HBM / DDR5（AI 需求持續強勁）"),
    ("封裝", "3711.TW", "日月光",      "215",    "+1.4%", "CoWoS 封裝（4/14 反彈）"),
    ("客戶", "NVDA",    "輝達",        "812.30", "+1.5%", "#1 客戶 22%（AI GPU 需求強勁）"),
    ("客戶", "AAPL",    "蘋果",        "203.50", "+0.8%", "#2 客戶 17%（iPhone AI 功能升級）"),
    ("客戶", "AVGO",    "博通",        "188.20", "+0.9%", "#3 客戶 13%（Custom XPU）"),
    ("客戶", "AMD",     "超微",        "153.80", "+1.7%", "#4 客戶 8%（2nm EPYC Venice）"),
    ("客戶", "2454.TW", "聯發科",      "1,285",  "+1.3%", "手機 SoC 客戶 9%，2nm 首批"),
    ("競爭", "INTC",    "英特爾",      "20.35",  "+1.2%", "Intel Foundry 爬坡中"),
    ("競爭", "005930.KS","三星電子",   "51,200 KRW", "+0.8%", "Samsung Foundry 良率追趕中"),
]
...
CONSENSUS = {
    ...
    "upside":       "+17.1%",   # 從 NT$1,955 到 NT$2,290（4/10 估）
}
...
IR_CALENDAR = [
    ...
    ("2026-04-13", "✅ 週日休市","週日，市場休息中；最後收盤：台股 NT$1,950（4/10）/ NYSE $370.60（4/10）","#9E9E9E"),
    ("2026-04-14", "📅 今日開盤","週一，台股 2330 估收 NT$1,995（+2.30%），Q1 財報前強勢反彈；NYSE TSM $370.04（上週五）","#607D8B"),
    ("2026-04-16", "⏰ Q1 2026 財報","預計法說會 15:00 TST；投資人電話會議同日；Q1 EPS 共識 NT$20.38；倒計時 2 天","#F44336"),
...
# 總體經濟監控
MACRO = [
    ("SOX 半導體指數",  "歷史新高區","~+1.2%", False),  # 4/14 估算，Q1 財報前信心回升
    ("美元指數 DXY",    "100.8",   "-0.4%",  False),  # 貿易戰令美元持續走弱
    ("VIX 恐慌指數",    "32.5",    "-2.5",   False),  # 恐慌指數持續下降，市場信心回溫
    ("WTI 原油",        "$63.5",   "-0.5%",  False),  # 供應擔憂持續緩和
    ("10Y 美債殖利率",  "4.10%",   "+0.02pp",True),   # 略升，市場風險偏好回溫
    ("台幣/美元",       "31.55",   "-0.05",  False),  # 台幣小幅走強
    ("NVIDIA NVDA",     "$812.30", "+1.5%",  False),  # #1 TSMC 客戶（22%），AI 需求強勁
    ("ASML",            "$652.50", "+0.7%",  False),  # 設備股跟隨半導體回升
]
...
VALUATION = {
    "pe_current":   29.4,   # 同 STOCK["pe_ratio"]（4/14 NT$1,995 估）
...
RELATIVE = {
    "date":           "2026-04-14",
    "tsmc_tw_1d":     +2.30,   # 2330 4/14 估收 NT$1,995（+2.30%），Q1 財報前反彈
    "taiex_1d":       +1.80,   # 加權指數（4/14 估算，隨半導體反彈）
    "sox_1d":         +1.20,   # SOX（4/14 估算）
    "tsmc_nyse_1d":   -0.15,   # TSM ADR 上週五 $370.04（-0.15%）
    "tsmc_tw_5d":     +2.30,   # 本週（4/14 週一）
    "taiex_5d":       +1.80,
    "tsmc_tw_1m":     -6.5,
    "taiex_1m":       -4.8,
    "tsmc_tw_ytd":    -9.5,    # Q1+4/1–4/14 累計（估）
    "taiex_ytd":      -7.8,
    "sox_ytd":        -24.0,
    "beta_60d":        1.16,   # 60 日滾動 Beta vs TAIEX
    # ADR 折溢價
    "adr_price":     370.04,   # TSM NYSE（2026-04-11 收盤）
    "adr_parity":    315.82,   # 理論值 = 5 × NT$1,995 ÷ 31.55（台股 4/14 估）
    "adr_ratio":     "5:1",    # 1 ADR = 5 台積電普通股
    "usd_ntd":        31.55,   # 同 MACRO 台幣匯率
    "adr_premium_pct": "+17.2",# (370.04 - 315.82) / 315.82 × 100
...
EPS_REVISION = {
    ...
    "analyst_view": "Q1 EPS 共識 NT$20.38，前 2 月累計營收年增 30%（NT$7,189 億）。4/8 台股 2330 收 NT$1,810（-2.43%），NYSE TSM $333.82（-4.01% 盤中），關稅風暴衝擊全球股市。4/10 將公布 3 月月營收（市場預估年增 ~30%），4/16 Q1 財報（倒計時 8 天）為近期最關鍵催化劑。美政府擬給予 TSMC 關稅豁免（$1,650 億美元亞利桑那廠投資換取），若落實為基本面重大利多。31 位分析師無一賣出，共識目標 NT$2,290（+26.5%），短線宏觀壓力大，中長線基本面催化劑強勁。",
...
NEWS = [
    {
        ...
        "title": "⭐ TSMC Q1 2026 財報後天公布（4/16），EPS 共識 NT$20.38，市場全面看升",
        "body": "TSMC Q1 2026 完整財報訂於 4/16（後天）法說會公布（EPS 共識 NT$20.38），延續 8 季 100% 超預期紀錄。Q1 已公布月營收 NT$1.134 兆（+35.1% YoY）大幅超越共識 NT$1.12 兆，3 月單月 NT$415.2B（+45.2% YoY）為季度最強月。市場關注 Q2 毛利率指引（共識 63–65%）、Q2 收入展望（$37–38B 估），及全年 30%+ 成長確認。至少 1 位分析師已上調目標價至 US$515。台股 2330 今日（4/14）估收 NT$1,995（+2.30%）反映財報前樂觀情緒。",
        "source": "CNBC / GuruFocus / TipRanks 2026-04-14", "impact": "正面",
    },
    {
        "tag": "客戶動態", "tag_color": "#2196F3",
        "title": "NVIDIA 正式超越 Apple 成 TSMC 最大客戶（22%），率先簽訂 A16 製程",
        "body": "NVIDIA CEO Jensen Huang 確認 NVIDIA 已成台積電最大單一客戶，2026 年貢獻約 $330 億美元（22% 佔比），Apple 退居第二（$270 億，17%）。NVIDIA 同時確定為 TSMC A16 次世代製程（2027 量產）首發客戶，Apple 則直接跳至 A14 節點。TSMC 2nm（N2）首批確認客戶包含 Apple、AMD、NVIDIA 及 MediaTek（Intel 缺席），訂單積壓量已超過 2026–2027 年總規劃產能，定價主導權進一步鞏固，2nm ASP 估較 3nm 提升 15–20%。",
        "source": "CNBC / TweakTown / Design-Reuse 2026-04-14", "impact": "正面",
    },
    {
        "tag": "產業趨勢", "tag_color": "#4CAF50",
        "title": "全球半導體 2026 年收入逾 $1.3 兆（Deloitte），AI 晶片佔 30% 創史高",
        "body": "Deloitte 最新預測，2026 年全球半導體總收入將突破 $1.3 兆美元，較 2025 年增長逾 26%，為二十年來最快增速。AI 晶片約佔行業總收入 30%（約 $500B），雲端廠商 AI 基建資本支出 2026 年成長 50%+。Amazon Trainium 正式挑戰 NVIDIA/AMD，亦為 TSMC 帶來更多 AI ASIC 訂單。台積電作為先進製程唯一大規模供應商，在此超大周期中受益最深。",
        "source": "Deloitte / IANS Live / Distill Intelligence 2026-04-10", "impact": "正面",
    },
    {
        "tag": "產品發布", "tag_color": "#9C27B0",
        "title": "TSMC 亞利桑那 2 座新先進封裝廠破土，緩解 CoWoS 瓶頸",
        "body": "TSMC 宣布將在亞利桑那州新增 2 座先進封裝（CoWoS）工廠，以緩解全球 AI 晶片封裝瓶頸。目前 TSMC CoWoS 產能以 80% CAGR 提升（2026 目標 ~35,000 wspm），但 ABF 基板仍為主要限制。NVIDIA 包攬逾 65% CoWoS 產能，其他 AI 晶片客戶等待隊列壓力大。新廠落成預計 2027–2028 年，可望同步降低供應鏈地緣政治集中風險，提升美國本土封裝比例。",
        "source": "CNBC 2026-04-08", "impact": "正面",
    },
    {
        "tag": "警示", "tag_color": "#F44336",
        "title": "AI 晶片供應短缺加劇：3nm 及先進封裝產能滿載至 2028 年",
        "body": "Seeking Alpha 分析指出，隨 AI 資料中心建設加速，TSMC 3nm 及先進封裝產能已幾乎完全被 NVIDIA/Apple/AMD 鎖定至 2028 年，AI 矽晶片短缺情形可能進一步惡化。新進入者如 Amazon Trainium、Google TPU v5 等自研晶片需求亦排隊等待 TSMC 產能，造成非超大雲端業者的 AI 算力獲取困難。短缺將支撐 TSMC 議價能力及 ASP 持續上升，但若需求突然下滑則積壓庫存風險增大。",
        "source": "Seeking Alpha 2026-04-10", "impact": "中性",
    },
    {
        "tag": "法規政策", "tag_color": "#FF9800",
        "title": "美台貿易框架初步達成，TSMC 可望享 15% 關稅優惠（美廠投資換取）",
        "body": "美台已達成初步貿易框架，台灣廠商（含 TSMC）享 15% 關稅率，以換取在美投資承諾。TSMC 亞利桑那 $1,650 億美元投資（3 座晶圓廠＋R&D）為主要籌碼，若關稅豁免正式落地，TSMC 美國業務相對英特爾等本土競爭者具顯著成本優勢。政策仍需國會批准，不確定性存在，但初步框架強化中長期在美競爭力。川普政府已另行宣布對半導體進口展開 301 調查，後續動向仍需持續追蹤。",
