...
STOCK = {
    # 台股 2330
    "tw_price":       "2,055",        # 收盤價（數字加逗號，不含 NT$）（2026-04-21 盤中，vs 4/18 收 NT$2,025）
    "tw_change":      "+30",          # 漲跌點數（含+/-號，vs 4/18 收盤 NT$2,025）
    "tw_change_pct":  "+1.48%",       # 漲跌幅（含+/-號）
    "tw_volume":      "~15,000",      # 成交量（張，估算全日，盤中截至上午 10:11 約 10,339 千股）
    "tw_open":        "2,050",
    "tw_high":        "2,075",
    "tw_low":         "2,045",
    "market_cap":     "NT$53.3 兆",
    "pe_ratio":       "~30.3x",       # 台股 P/E（TTM，NT$2,055 基礎，EPS FY25 實績 NT$67.8）
    ...
    # NYSE TSM ADR
    "nyse_price":     "370.50",       # 最後已知收盤（2026-04-17，+1.97%，美市 Good Friday 4/18 休市）
    "nyse_change":    "+7.15",        # 4/17 實際
    "nyse_change_pct":"+1.97%",       # 4/17 實際
    "52w_high_nyse":  "392.00",       # 52 週高（2026-04-16 after-hours）
    "52w_low_nyse":   "134.25",       # 52 週低（2025-04-07）
    "pe_nyse":        "~30.6x",       # NYSE USD 基礎 P/E（TTM，估算）
    "pb_nyse":        "~10.9x",
    "beta":           "1.16",
    ...
    # 資料日期備註
    "data_note":      "4/21（週一）台股開盤強彈，財報後獲利了結消化完成  |  台股 2330 盤中 NT$2,055（+1.48%，vs 4/18 收 NT$2,025）  |  NYSE TSM 最後已知收盤 4/17：$370.50（+1.97%；美市 Good Friday 4/18 休市，4/21 盤後更新）  |  ⭐ Q1 2026 淨利 $18.2B（+58.3% YoY）、毛利率 66.2%（+740bps）雙創歷史新高  |  Q2 指引 $39.0-40.2B 遠超共識  |  全年 2026 收入 >30% 確認  |  TSMC 承諾美國投資 $1,650 億，關稅豁免框架確認  |  NVIDIA 確認 #1 客戶（22%），超越 Apple",
}
...
SUMMARY = {
    ...
    "sentiment":  "看多",
    # 一句話標題
    "headline":   "4/21 台股 2330 強彈 NT$2,055（+1.48%）！財報後獲利了結消化完成，TSMC 承諾美國投資 $1,650 億、關稅豁免確認，中線格局看多",
    # 3–5 條白話重點（不用術語，每條約 30 字內）
    "bullets": [
        "📈 4/21 台股 2330 盤中 NT$2,055（+1.48%，vs 4/18 收 NT$2,025），財報後獲利了結已充分消化，買盤回籠",
        "⭐ Q1 2026 淨利 $18.2B（+58.3% YoY）、毛利率 66.2%（+740bps YoY）雙創歷史新高，連續 10 季超預期",
        "🇺🇸 TSMC 承諾美國投資 $1,650 億（六廠計劃），台灣半導體商品最高關稅鎖定 15%，關稅豁免框架確認",
        "🚀 NVIDIA 正式超越 Apple 成為 TSMC 最大客戶（22%），A16（1.6nm）首批量產客戶傳為 NVIDIA",
        "⚠️ NYSE TSM 最後已知收盤 4/17 $370.50（美市 Good Friday 4/18 休市），4/21 盤後更新；台幣升值為毛利率主要風險",
    ],
    # 一句結論
    "bottom_line": "4/21 台股 2330 盤中 NT$2,055（+1.48%），財報後深度獲利了結已充分消化，多頭買盤回籠。TSMC Q1 2026 財報創歷史新高：淨利 $18.2B（+58.3% YoY）、毛利率 66.2%（+740bps YoY）。Q2 指引 $39.0-40.2B 大幅超越市場共識，全年 >30% 成長確認。TSMC 承諾美國投資 $1,650 億（六廠計劃），台灣半導體商品最高關稅鎖定 15%，關稅豁免框架確認——此政策利多強化 TSMC 美國在地製造價值。NVIDIA 超越 Apple 成最大客戶（22%），CoWoS 先進封裝至 2028 年均被 NVIDIA 鎖定；Amazon/Meta/Anthropic 自研 AI 芯片均依賴 TSMC 先進製程，長期強化稼動率。NYSE TSM 最後已知收盤 4/17 $370.50（美市 Good Friday 4/18 休市，4/21 盤後更新）。31 位分析師全數看多，共識目標 NT$2,290（自 NT$2,055 有 +11.4% 上行空間）。",
    # 重大警示（選填，空白則不顯示）
    "risk_alert":  "⚠️ NYSE TSM 4/21 收盤數據待美市盤後更新；台幣升值壓力持續（每升值 1%，毛利率 -40bps）；美國 25% 半導體 301 關稅調查進行中；CoWoS ABF 基板供應瓶頸；亞利桑那廠爬坡成本拖累 Q2-Q3 毛利率",
}

# 三大法人買賣超（張）— 最新一日
INSTITUTIONAL = {
    "date":     "2026-04-21",
    "foreign":  +2500,    # 外資（正=買超）— 4/21 強彈回升，外資回補（估）
    "trust":    +380,     # 投信（持續加碼，4/21 估）
    "dealer":   +150,     # 自營商（估，4/21 跟進買超）
    # 近5日（由舊到新，最後一筆為 4/21）
    "foreign_5d": [+4800, +6200, -3200, +1200, +2500],  # 4/18 台股小幅回補，4/21 外資持續買回（估）
    "trust_5d":   [+720,  +850,  +250,  +300,  +380],
    "dealer_5d":  [+450,  +380,  -180,  +80,   +150],
    "foreign_ownership_pct": "74.9%",  # 外資持股比例（估，4/21，回補後略升）
    "foreign_ownership_shares": "約 194.3 億股",
}

# 技術分析指標（需每日從看盤軟體更新）
TECHNICAL = {
    "rsi_14":       58.5,   "rsi_signal": "RSI 從 52.3 回升至 58.5，4/21 強彈確認多頭買盤回籠，站穩 50 中線關口，短線動能偏多",
    "macd":         +1.8,   "macd_signal": "MACD 正值回升（+0.9→+1.8），多頭趨勢重新強化，4/21 買盤確認金叉走勢",   "macd_color": "#4CAF50",
    "kdj_k":        62.5,   "kdj_d": 58.3, "kdj_j": 70.8, "kdj_signal": "KDJ J 值從 34 回升至 70.8，超賣反彈確認，K>D 金叉，短線偏多",
    "ma5":       "2,048",
    "ma20":      "1,978",
    "ma60":      "1,908",
    "ma120":     "1,812",
    "bb_upper":  "2,118",   # 布林上軌（4/21 盤中接近測試）
    "bb_mid":    "1,978",   # 布林中軌（20MA）
    "bb_lower":  "1,838",   # 布林下軌
    "vol_ma5":  "22,000",   # 5日均量（張，估算，4/21 量能回升中）
    "trend":    "台股 2330（4/21 盤中 NT$2,055，+1.48%）強彈，財報後獲利了結已充分消化，買盤明顯回籠。NYSE TSM 最後已知收盤 4/17 $370.50（美市 4/18 Good Friday 休市，4/21 盤後待更新）。技術面：RSI 58.5 站穩多頭區、MACD 正值回升、KDJ 金叉——短線動能偏多，守穩 NT$2,030–2,050 支撐，中線目標 NT$2,200–2,290 維持。",
    "support":  "2,030–2,050",
    "resist":   "2,075–2,110",
...
DERIVATIVES = {
    "date":          "2026-04-21",
    "futures_price": "2,058",      # 台積電期貨近月（估，4/21 盤中強彈後）
    "futures_oi":    "88,000",     # 未平倉量（口）（估，4/21 多方部位回升）
    "futures_basis": "+3",         # 正價差（多頭部位回升，4/21 盤中估）
    "call_oi":       "47,500",
    "put_oi":        "41,200",
    "pcr":           "0.87",       # Put/Call 比率降至 0.87（4/21 市場情緒轉多，保護性 Put 減少）
    "pcr_signal":    "中性偏多（Put/Call 從 0.99 降至 0.87，4/21 強彈後市場情緒轉正，Call 需求回升）",
    "max_pain":      "2,050",      # 最大痛苦價格（近期到期，估）
    "key_strikes": [
        ("2,000", "Call 24,000 / Put 8,500", "心理整數關口，強支撐區"),
        ("2,050", "Call 22,000 / Put 5,800", "4/21 盤中現價附近，支撐確認中"),
        ("2,080", "Call 19,500 / Put 3,200", "短線壓力（4/16 財報日收盤 NT$2,085 附近）"),
...
IR_CALENDAR = [
    ...
    ("2026-04-21", "📅 今日盤中強彈","台股 2330 盤中 NT$2,055（+1.48%，vs 4/18 收 NT$2,025）；財報後獲利了結已消化，買盤回籠；NYSE TSM 4/21 盤後待更新（美市 Good Friday 4/18 休市，最後已知收盤 4/17 $370.50）；NVIDIA 確認 #1 客戶 22%，A16 首批量產客戶","#BBDEFB"),
...
# 總體經濟監控
MACRO = [
    ("SOX 半導體指數",  "歷史高位區","~+1.2%", False),  # 4/21 盤中，TSMC 財報帶動半導體族群反彈
    ("美元指數 DXY",    "98.8",    "-0.6%",  False),  # 美元持續走弱，利好 TSMC ADR 估值
    ("VIX 恐慌指數",    "22.8",    "-1.7",   False),  # 恐慌指數進一步下降，市場情緒明顯改善
    ("WTI 原油",        "$62.8",   "+0.5%",  False),  # 油價微升（中東局勢持續，TSMC 化學品成本注意）
    ("10Y 美債殖利率",  "4.02%",   "-0.03pp",False),  # 小降，風險情緒持續好轉
    ("台幣/美元",       "31.35",   "-0.03",  False),  # 台幣走強（每升值 1% 毛利率 -40bps，需追蹤）
    ("NVIDIA NVDA",     "$851.00", "+1.0%",  False),  # #1 TSMC 客戶（22%），4/21 盤中估算
...
RELATIVE = {
    "date":           "2026-04-21",
    "tsmc_tw_1d":     +1.48,   # 2330 4/21 盤中 NT$2,055（+1.48%），財報後獲利了結消化完成，買盤回籠
    "taiex_1d":       +0.85,   # 加權指數（4/21 估算，台股大盤同步跟漲）
    "sox_1d":         +1.20,   # SOX（4/21 盤中，TSMC 財報後半導體族群反彈）
    "tsmc_nyse_1d":   +1.97,   # TSM ADR 最後已知 4/17 $370.50（美市 Good Friday 4/18 休市）
    "tsmc_tw_5d":     +1.48,   # 本週至今（4/21 盤中，vs 4/18 收 NT$2,025）
    "taiex_5d":       +0.85,
    "tsmc_tw_1m":     +5.9,    # 月線（NT$2,055 vs ~NT$1,940 一個月前）
    "taiex_1m":       +3.5,
    "tsmc_tw_ytd":    -1.9,    # Q1+4/1–4/21 累計（NT$2,055 vs 年初 ~NT$2,095）
    "taiex_ytd":      -3.8,
    "sox_ytd":        -20.5,
    "beta_60d":        1.16,   # 60 日滾動 Beta vs TAIEX（4/21 強彈，Beta 回落至正常）
    # ADR 折溢價
    "adr_price":     370.50,   # TSM NYSE 最後已知（2026-04-17）
    "adr_parity":    327.93,   # 理論值 = 5 × NT$2,055 ÷ 31.35（4/21 盤中）
    "adr_ratio":     "5:1",    # 1 ADR = 5 台積電普通股
    "usd_ntd":        31.35,   # 同 MACRO 台幣匯率（4/21）
    "adr_premium_pct": "+13.0",# (370.50 - 327.93) / 327.93 × 100（基於 4/17 NYSE 最後收盤）
...
NEWS = [
    {
        "tag": "市場動態", "tag_color": "#4CAF50",
        "title": "4/21 台股 2330 強彈 +1.48%，財報後獲利了結消化完成",
        "body": "台股 2330 於 4/21（週一）盤中強勢反彈至 NT$2,055（+1.48%，vs 4/18 收 NT$2,025），財報後深度獲利了結壓力已充分消化，買盤明顯回籠。此前 4/16 財報日創歷史新高 NT$2,100（+2.19%）、4/17 深度獲利了結 NT$2,030（-2.64%）、4/18 小整理 NT$2,025（-0.25%），三日整理後 4/21 確認反彈，技術面 KDJ 金叉、RSI 回升至 58.5。NYSE TSM 最後已知收盤 4/17 $370.50（美市 Good Friday 4/18 休市），4/21 盤後待更新。31 位分析師全數看多，共識目標 NT$2,290（上行空間 +11.4%）。",
        "source": "TWSE / Yahoo Finance 2026-04-21", "impact": "正面",
    },
    {
        "tag": "財報結果", "tag_color": "#4CAF50",
        "title": "TSMC Q1 淨利 $18.2B（+58.3%）與毛利率 66.2% 雙創歷史新高",
        "body": "TSMC Q1 2026 財報（4/16 法說會）：淨利 NT$572.48B（$18.2B，+58.3% YoY）、毛利率 66.2%（+740bps YoY）雙創歷史新高，連續第 10 季超越市場預期（平均超預期幅度 +6.2%）。Q1 收入 $35.9B（+40.6% YoY，USD），EPS NT$22.08（US$3.49/ADR），均超越共識。Q2 指引收入 $39.0-40.2B（遠超共識 $37.5-39.0B），毛利率指引 65-67%。全年 2026 收入 >30% 確認，CapEx 向 $52-56B 高端靠齊。HPC 佔收入 61%（AI 驅動，+20% QoQ）。",
        "source": "TSMC IR / CNBC / Bloomberg 2026-04-16", "impact": "正面",
    },
    {
        "tag": "法規政策", "tag_color": "#FF9800",
        "title": "TSMC 承諾美國投資 $1,650 億，台灣半導體關稅鎖定最高 15%",
        "body": "TSMC 正式承諾在美國投資 $1,650 億，涵蓋六座晶圓廠（Arizona N3/N2 各兩廠、CoWoS 封裝廠等），為史上最大外資製造承諾之一。作為回報，美國與台灣協議台灣半導體商品最高關稅鎖定 15%（低於 25% 「普遍性關稅」），並對 TSMC Arizona 製造的芯片提供進口關稅豁免。超大型雲服務商（Amazon、Google、Microsoft）採購 TSMC 美廠製芯片亦可獲關稅豁免。此政策框架顯著降低 TSMC 及其客戶的關稅不確定性，利多中長期格局。",
        "source": "Tom's Hardware / US Commerce Dept 2026-04-20", "impact": "正面",
    },
    {
        "tag": "客戶動態", "tag_color": "#2196F3",
        "title": "NVIDIA 超越 Apple 成 TSMC 最大客戶（22%），A16 首批量產客戶",
        "body": "Jensen Huang（黃仁勳）於法說會後確認 NVIDIA 已超越 Apple，成為 TSMC 最大客戶，預計 2026 年為 TSMC 貢獻約 $330 億收入（佔 TSMC 總收入約 22%）。NVIDIA 鎖定 TSMC 大部分 CoWoS 先進封裝產能至 2028 年，GB200/GB300 NVL72 均使用 CoWoS-S 封裝。市場消息稱 NVIDIA 亦為 TSMC A16（1.6nm，背面電源 BSPDN）製程首批量產客戶，預計 2026 年底量產。Apple 仍為第二大客戶（17%），A20 晶片（iPhone 18）、M6 Mac 均採 TSMC 2nm。",
        "source": "CNBC / Design-Reuse 2026-04-16/21", "impact": "正面",
    },
    {
        "tag": "產業趨勢", "tag_color": "#4CAF50",
        "title": "ASML Q1 超預期，上調 2026 全年指引至 €36-40B，EUV 需求強勁",
        "body": "ASML Q1 2026 財報超越市場預期，並上調 2026 全年營收指引至 €36-40B（原 €34-39B），EUV 與 High-NA EUV 設備訂單持續強勁，確認 AI 驅動的半導體資本支出週期延續。ASML 為 TSMC 最關鍵設備供應商，其訂單能見度直接反映 TSMC 及三星、英特爾的先進製程擴產規劃。儘管股價在中國出口限制收緊消息後小幅回落，但整體需求展望依然強健，半導體設備族群全線受惠 AI 資本週期。全球半導體銷售 2026 年預計首度突破 $1 兆。",
        "source": "Modern Diplomacy / MarketWatch 2026-04-15", "impact": "正面",
    },
    {
        "tag": "警示", "tag_color": "#F44336",
        "title": "CoWoS 先進封裝滿載為 AI 擴展下一瓶頸；台幣升值壓毛利率",
        "body": "TSMC CoWoS 先進封裝產能已全數滿載（>95%），大部分被 NVIDIA 鎖定，其餘由 AMD 和 Broadcom 瓜分，ABF 基板供應受限導致擴產速度落後預期。CNBC 指出即使美國製造的 AI 芯片仍需「回台灣」進行 CoWoS 先進封裝，美國芯片製造自主化進程受限。台幣持續走強（31.35 附近），每升值 1% 毛利率下降 40bps，為 Q2 毛利率主要下行風險。亞利桑那廠爬坡攤提成本、台灣電費調漲亦對 Q2-Q3 毛利率造成壓力。美國 301 關稅調查後續動向持續追蹤。",
        "source": "CNBC / TrendForce / Wall Street analysts 2026-04-08/17", "impact": "負面",
    },
]
