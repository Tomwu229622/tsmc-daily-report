...
STOCK = {
    # 台股 2330
    "tw_price":       "2,410",        # 2026-06-18 Thu 實際收盤（+25，+1.05% vs 6/17 NT$2,385；盤中觸 NT$2,440 史高、量 49,982 張。⚠️ 前報估值 2,385 已更正為官方 2,410。6/19 Fri 端午節休市、6/22 Mon 今日交易中、官方收盤待 TWSE）
    "tw_change":      "+25",          # 6/18 漲跌點數（vs 6/17 NT$2,385）
    "tw_change_pct":  "+1.05%",       # 6/18 漲跌幅（台股加權指數同日 +901.85 點收 46,459 連 4 日創新高）
    "tw_volume":      "49,982",       # 6/18 成交量（張，官方）
    "tw_open":        "2,395",        # 6/18 開盤
    "tw_high":        "2,440",        # 6/18 盤中高（觸 NT$2,440 史高價）
    "tw_low":         "2,385",        # 6/18 盤中低
    "market_cap":     "NT$62.5 兆",   # 6/18 收盤市值（NT$2,410 基礎）
    "pe_ratio":       "~35.5x",       # 台股 P/E（TTM，NT$2,410 基礎）
    "pb_ratio":       "~12.5x",       # 台股 P/B（股淨比，NT$2,410 基礎）
    "div_yield":      "~0.62%",       # 殖利率（NT$2,410 基礎）
    "52w_high_tw":    "2,440",        # 52 週/歷史高（2026-06-18 盤中觸 NT$2,440 史高）
    "52w_low_tw":     "780",          # 52 週低（2025-04-07）
    # NYSE TSM ADR
    "nyse_price":     "462.12",       # 6/18 收盤（+$29.97，+6.94% vs $432.15；創紀錄飆漲、盤中觸 52 週新高 $465.22、來源 stockanalysis.com、成交量 2,582 萬股、P/E 33.14、市值 $1.98 兆）
    "nyse_change":    "+29.97",       # 6/18 漲跌（vs 6/17 $432.15）
    "nyse_change_pct":"+6.94%",       # 6/18 NYSE 創紀錄飆漲（Amkor 10 年封裝長約 + 分析師升評 + AI 需求驅動）
    "52w_high_nyse":  "465.22",       # 52 週/歷史高（2026-06-18 盤中觸 $465.22）
    "52w_low_nyse":   "206.20",       # 52 週低（區間）
    "pe_nyse":        "~33.1x",       # NYSE USD 基礎 P/E（TTM，stockanalysis.com 報 33.14x，$462.12 基礎）
    "pb_nyse":        "~13.0x",
    "beta":           "1.18",
    ...
    # 資料日期備註
    "data_note":      "報告日期：2026-06-22 Mon（NYSE TSM 6/18 收盤 $462.12 為最新確認數據；台股 2330 NT$2,410 為 6/18 Thu 官方收盤、6/19 Fri 端午節休市、6/22 Mon 今日交易中、官方收盤請以 TWSE 為準）。⭐⭐⭐ 今日頭條——NYSE TSM 創紀錄飆漲 +6.94% 收 $462.12：NYSE TSM 6/18 收 $462.12（+$29.97、+6.94% vs $432.15，來源 stockanalysis.com、成交量 2,582 萬股、P/E 33.14、市值 $1.98 兆）、盤中觸 52 週/歷史新高 $465.22；驅動：TSMC-Amkor 10 年美國封裝長約 + 分析師升評 + AI 結構性需求。台股 2330 6/18 Thu 官方收 NT$2,410（+25、+1.05% vs 6/17 NT$2,385、盤中觸 NT$2,440 史高、量 49,982 張）、台股加權指數同日大漲 +901.85 點收 46,459 連 4 日創新高；6/22 Mon 今日台股交易中、受 ADR +6.94% 飆漲帶動預期跳空跟漲、官方收盤待 TWSE。📊 台美 ADR 溢價（以 6/18 ADR $462.12 + 台股 NT$2,410 計）：理論值 5×2,410÷31.05 = $388.08、溢價 (462.12-388.08)/388.08 = +19.08%（溢價大幅擴大、反映台股 6/18 收盤早於 ADR 飆漲、6/22 台股有補漲壓力）。🤝 重大利多——TSMC-Amkor 簽 10 年美國先進封裝長約（6/16 公告、本波 ADR 飆漲主因之一）：Amkor 將於 Arizona 州 Peoria 廠就近承接 TSMC 亞利桑那晶圓的先進封裝與測試（InFO / CoWoS）、Peoria 廠投資 $20 億→$70 億、2028 投產、~2,000 就業、呼應 TSMC $165B 美國投資承諾。🏆 NVIDIA 確認 TSMC 第 1 大客戶（22%/$33B、超越 Apple）、為 A16（1.6nm）首發客戶 2027 量產；Apple 跳過 A16 直上 A14（1.4nm）。⚠️ 新增風險——（1）Apple 同意與 Intel 合作在美生產晶片以降低對 TSMC 依賴、Google/AMD/Tesla 接觸 Samsung 先進製程；Intel 因川普宣布 Apple-Intel 合作飆漲 +10.6% 創新高；（2）TSMC 遭美 ITC 專利調查（Longitude Licensing & Marlin Semiconductor 控訴）、6 月預計初判、恐對含關鍵 AI 加速器技術晶片發布美國進口禁令。  |  🎯 即將事件：6 月營收 7 月上旬公布；Q2 2026 財報法說會 7/16（指引 $39.0-40.2B、+10% QoQ、+32% YoY、毛利率 65-67%）  |  ⭐ 中長線結構性利多基底未變：5 月營收 NT$4,169.75 億 +30.1% 創單月新高；2nm 量產良率 70-80% 領先全球、年底月產能 100K 片；NVIDIA 第 1 大客戶 22%/$33B；4 大美國 CSP 2026 AI CapEx 合計 $725B（+77% YoY）；SIA/Deloitte 估 AI 資料中心晶片營收 2028 上看 $1.2 兆（4 年近 10 倍）；2026 全球半導體市場估 +25% YoY 達 ~$975B  |  ⚠️ 本日（6/22）關鍵觀察：（1）台股 2330 跳空跟漲後能否站穩 NT$2,440 / 挑戰 NT$2,500；（2）ADR 溢價 +19.08% 補漲動能；（3）下方支撐 NT$2,410 / NT$2,375 / NT$2,360；上方壓力 NT$2,440 史高 / NT$2,500 / NT$2,550；（4）⚠️ 估值警示：TSM P/E 33.1x、台股 P/E ~35.5x，留意台幣升值、短線過熱與 Apple-Intel/ITC 雜訊",
}
...
SUMMARY = {
    ...
    "sentiment":  "看多",
    # 一句話標題
    "headline":   "🚀 NYSE TSM 創紀錄飆漲 +6.94% 收 $462.12（盤中觸史高 $465.22）：Amkor 10 年美國封裝長約 + AI 需求驅動；台股 2330 6/18 收 NT$2,410（+1.05%）、6/22 受 ADR 帶動預期跳空跟漲（溢價 +19.08%）；⚠️ Apple-Intel 合作 + ITC 專利調查為新增雜訊",
    # 3–5 條白話重點（不用術語，每條約 30 字內）
    "bullets": [
        "🚀 NYSE TSM 6/18 創紀錄飆漲收 $462.12（+$29.97、+6.94% vs $432.15）、盤中觸 52 週/歷史新高 $465.22、市值 $1.98 兆",
        "📈 台股 2330 6/18 Thu 官方收 NT$2,410（+25、+1.05% vs 6/17 NT$2,385、盤中觸 NT$2,440 史高、量 49,982 張）；前報估值 2,385 已更正",
        "📊 ADR 溢價大幅擴大至 +19.08%（台股 6/18 收盤早於 ADR 飆漲）、6/22 今日台股有補漲壓力、官方收盤待 TWSE",
        "🤝 TSMC-Amkor 簽 10 年美國封裝長約（6/16 公告、本波 ADR 飆漲主因）：Peoria AZ $20 億→$70 億、2028 投產、~2,000 就業",
        "🏆 NVIDIA 確認 TSMC 第 1 大客戶（22%/$33B）、為 A16（1.6nm）首發客戶 2027 量產；Apple 跳過 A16 直上 A14",
        "⚠️ Apple 同意與 Intel 合作在美製造晶片降低對 TSMC 依賴、Google/AMD/Tesla 接觸 Samsung；Intel 飆漲 +10.6% 創新高",
        "⚠️ TSMC 遭美 ITC 專利調查（Longitude/Marlin 控訴）、6 月預計初判、恐對含 AI 加速器技術晶片發布美國進口禁令",
        "⚠️ 估值警示 TSM P/E 33.1x、台股 P/E ~35.5x，留意台幣升值與短線過熱",
    ],
    # 一句結論
    "bottom_line": "報告日期：2026-06-22 Mon（NYSE TSM 6/18 收盤 $462.12 為最新確認數據；台股 2330 NT$2,410 為 6/18 Thu 官方收盤、6/19 Fri 端午節休市、6/22 Mon 今日交易中、官方收盤請以 TWSE 為準）。🚀 今日頭條——NYSE TSM 創紀錄飆漲 +6.94% 收 $462.12、盤中觸 52 週/歷史新高 $465.22（+$29.97、+6.94% vs $432.15，來源 stockanalysis.com、成交量 2,582 萬股、P/E 33.14、市值 $1.98 兆）；本波飆漲主因：TSMC-Amkor 10 年美國先進封裝長約（6/16 公告）+ 分析師升評 + AI 結構性需求。📈 台股 2330 6/18 Thu 官方收 NT$2,410（+25、+1.05% vs 6/17 NT$2,385、盤中觸 NT$2,440 史高、量 49,982 張、市值 NT$62.5 兆）、台股加權指數同日大漲 +901.85 點收 46,459 連 4 日創新高（前報估值 2,385 已更正為官方 2,410）；6/22 Mon 今日台股交易中、受 ADR +6.94% 飆漲帶動預期跳空跟漲、官方收盤待 TWSE。📊 台美 ADR 溢價（以 6/18 ADR $462.12 + 台股 NT$2,410 計）：理論值 5×2,410÷31.05 = $388.08、溢價 (462.12-388.08)/388.08 = +19.08%（溢價大幅擴大、反映台股 6/18 收盤早於 ADR 飆漲、6/22 台股有補漲壓力）。🤝 重大利多——TSMC-Amkor 簽 10 年美國先進封裝長約（6/16 公告、本波飆漲主因）：Amkor 將於 Arizona 州 Peoria 廠就近承接 TSMC 亞利桑那晶圓的先進封裝與測試（InFO / CoWoS）、Peoria 廠投資 $20 億→$70 億、2028 投產、~2,000 就業、形成美國本土「晶圓製造→先進封裝→測試」完整在地產業鏈、呼應 TSMC $165B 美國投資承諾。⭐ 中長線結構性利多基底未變：（1）🏆 NVIDIA 確認 TSMC 第 1 大客戶（超越 Apple、22% / $33B）、為 A16（1.6nm）首發客戶 2027 量產；Apple 跳過 A16 直上 A14（1.4nm）；（2）⭐ NVIDIA Vera Rubin NVL72 採 TSMC N3 + CoWoS-L 封裝、首度搭載 8 層 HBM4；（3）💰 TSMC CFO 重申先進製程漲價——3nm H2 漲 ~15%、sub-5nm 漲 5-10%、反映定價權；（4）⭐ TSMC 2nm 已量產、初期良率 70-80% 領先全球、年底月產能目標 100K 片、2nm 至 2028 CAGR +70%；（5）📦 CoWoS 封裝瓶頸續為產業關鍵、TSMC 規劃 2026 底擴至 ~130K wpm、5.5 倍光罩封裝良率 >98%；（6）📊 SIA/Deloitte 估 AI 資料中心晶片營收 2028 上看 $1.2 兆（4 年近 10 倍）、晶片佔 AI server rack 價值 95%；（7）4 大美國 CSP 2026 AI CapEx 合計 $725B（+77% YoY）；（8）⭐ 5 月營收 NT$4,169.75 億 +30.1% 創單月新高、1-5 月累計 NT$1.96 兆；（9）2026 全球半導體市場估 +25% YoY 達 ~$975B。⚠️ 短期/中期下行風險：（1）⚠️ 客戶分散——Apple 同意與 Intel 合作在美生產晶片降低對 TSMC 依賴、Google/AMD/Tesla 接觸 Samsung 先進製程；Intel 因川普宣布 Apple-Intel 合作飆漲 +10.6% 創新高（屬中期觀察、TSMC 技術代差仍領先）；（2）⚠️ 法律風險——TSMC 遭美 ITC 專利調查（Longitude Licensing & Marlin Semiconductor 控訴）、6 月預計初判、恐對含關鍵 AI 加速器技術晶片發布美國進口禁令；（3）⚠️ 估值警示——TSM P/E 33.1x、台股 P/E ~35.5x，留意賣壓與台幣升值；（4）台幣升值壓力（每升 1% 毛利率 -40bps）。基本面未變：Q1 2026 淨利 NT$572.5B（$18.2B、+58.3% YoY）、毛利率 66.2% 雙創史高；2025 全年 EPS NT$66.25。技術面（基於 6/18 官方收 NT$2,410）：5MA NT$2,375 / 20MA NT$2,350 / 60MA NT$2,320 / 120MA NT$2,215；下方支撐 NT$2,410 / NT$2,375 / NT$2,360；上方壓力 NT$2,440（史高）/ NT$2,500 / NT$2,550。32 位分析師全數看多、平均目標 NT$2,530 上行空間 +4.98%（自 NT$2,410）。",
    # 重大警示（選填，空白則不顯示）
    "risk_alert":  "今日（6/22 Mon）關鍵觀察：（1）🚀 NYSE TSM 6/18 創紀錄飆漲收 $462.12（+6.94%）、盤中觸 52 週/歷史新高 $465.22、市值 $1.98 兆；（2）📈 台股 2330 6/18 官方收 NT$2,410（+1.05%、盤中觸 NT$2,440 史高）、市值 NT$62.5 兆；6/22 今日交易中、受 ADR 飆漲帶動預期跳空跟漲、官方收盤待 TWSE；（3）📊 ADR 溢價大幅擴大至 +19.08%、台股 6/22 有補漲壓力；（4）🤝 TSMC-Amkor 簽 10 年美國先進封裝長約（Peoria AZ $70 億、2028 投產、~2,000 就業、本波飆漲主因）；（5）🏆 NVIDIA 確認 TSMC 第 1 大客戶（22%/$33B）、為 A16 首發客戶 2027 量產；Apple 跳過 A16 直上 A14；（6）⚠️ 新增風險——Apple 同意與 Intel 合作在美生產晶片降低對 TSMC 依賴、Google/AMD/Tesla 接觸 Samsung；Intel 飆漲 +10.6% 創新高（中期觀察、技術代差仍領先）；（7）⚠️ 新增風險——TSMC 遭美 ITC 專利調查（Longitude/Marlin 控訴）、6 月預計初判、恐對含 AI 加速器技術晶片發布美國進口禁令；（8）💰 TSMC CFO 重申先進製程漲價——3nm H2 漲 ~15%、sub-5nm 漲 5-10%；（9）📦 CoWoS 瓶頸續為產業關鍵、TSMC 2026 底擴至 ~130K wpm、良率 >98%；（10）📊 SIA/Deloitte 估 AI 資料中心晶片營收 2028 上看 $1.2 兆（4 年近 10 倍）；（11）⭐ 5 月營收 NT$4,169.75 億 +30.1% 創單月新高；（12）⭐ 2nm 量產良率 70-80% 領先全球；（13）⭐ 4 大美國 CSP 2026 AI CapEx 合計 $725B（+77% YoY）；（14）⚠️ 估值警示：TSM P/E 33.1x、台股 P/E ~35.5x、留意台幣升值與短線過熱；32 位分析師全數看多、平均目標 NT$2,530；本日（6/22）關鍵：台股跳空跟漲後能否站穩 NT$2,440 / 挑戰 NT$2,500；下方支撐 NT$2,410 / NT$2,375 / NT$2,360",
}

# 三大法人買賣超（張）— 最新一日
INSTITUTIONAL = {
    "date":     "2026-06-18",       # 最新資料日（6/18 Thu 為官方最後交易日、6/19 端午休市、6/22 今日盤後待公布；6/18 三大法人為估算、官方以 TWSE 盤後為準）
    "foreign":  +12000,             # 外資 6/18 估大買超（隨股價 +1.05% 創史高、加權指數 +901 點；待官方確認）
    "trust":    +1500,              # 投信 6/18 估續買 +1,500 張
    "dealer":   +600,               # 自營商 6/18 估買超 +600 張
    # 近5日（由舊到新：6/12, 6/15, 6/16, 6/17, 6/18）；6/12-6/16 含實際、6/17-6/18 為估算
    "foreign_5d": [+3927, +5000, -382, +4000, +12000],       # 外資 6/12 實際 +3,927、6/16 實際 -382、6/18 估隨史高大買
    "trust_5d":   [-149, +1000, +3849, +800, +1500],         # 投信 6/12 實際 -149、6/16 實際 +3,849、6/18 估續買
    "dealer_5d":  [-181, +500, -158, +300, +600],            # 自營 6/12 實際 -181、6/16 實際 -158、6/18 估買超
    "foreign_ownership_pct": "75.0%",  # 外資持股比例（創史高後 6/18 估回升至 75.0%）
    "foreign_ownership_shares": "約 194.2 億股",
}

# 技術分析指標（需每日從看盤軟體更新）
TECHNICAL = {
    "rsi_14":       68.0,   "rsi_signal": "RSI 估自 58 升至 68（台股 6/18 +1.05% 創史高、NYSE 6/18 +6.94% 飆漲），多方動能轉強、逼近 70 超買區、留意短線過熱",
    "macd":         0.45,  "macd_signal": "MACD 估自 +0.25 擴大至 +0.45、紅柱放大、續守零軸上方、多頭動能轉強",   "macd_color": "#4CAF50",
    "kdj_k":        82.0,   "kdj_d": 76.0, "kdj_j": 92.0, "kdj_signal": "KDJ K(82)/D(76)/J(92) 全面走高、多頭排列、J 進入高檔超買區、續強但留意過熱回檔",
    "ma5":       "2,375",   # 5MA（6/12 2310, 6/15 2350, 6/16 2385, 6/17 2385, 6/18 2410）— 基於 6/18 官方收
    "ma20":      "2,350",   # 20MA 翻揚
    "ma60":      "2,320",   # 60MA 緩升
    "ma120":     "2,215",
    "bb_upper":  "2,490",   # 布林上軌
    "bb_mid":    "2,350",   # 布林中軌（20MA）
    "bb_lower":  "2,210",   # 布林下軌
    "vol_ma5":  "48,000",   # 5日均量（張，估、基於 6/12-6/18 五日均）
    "trend":    "🚀 NYSE TSM 6/18 創紀錄飆漲收 $462.12（+$29.97、+6.94% vs $432.15）、盤中觸 52 週/歷史新高 $465.22、市值 $1.98 兆；台股 2330 6/18 官方收 NT$2,410（+25、+1.05%、盤中觸 NT$2,440 史高、量 49,982 張）、加權指數 +901.85 點連 4 日創新高；6/22 今日台股交易中、受 ADR 飆漲帶動預期跳空跟漲。🤝 本波飆漲主因：TSMC-Amkor 10 年美國先進封裝長約（6/16 公告）+ 分析師升評 + AI 需求。📊 技術面（基於 6/18 官方收 NT$2,410）：RSI 68 逼近超買、MACD +0.45 紅柱放大、KDJ J(92) 高檔超買、多頭排列、短期 5MA NT$2,375 / 20MA NT$2,350 翻揚、中期 60MA/120MA 趨勢偏多。下一觀察：（1）📈 台股跳空跟漲後能否站穩 NT$2,440 史高 / 挑戰 NT$2,500；（2）下方支撐 NT$2,410 / NT$2,375 / NT$2,360；（3）上方壓力 NT$2,440 史高 / NT$2,500 / NT$2,550；（4）⚠️ 短線 RSI/KDJ 過熱、留意獲利了結；（5）⚠️ 新增雜訊：Apple-Intel 合作降低對 TSMC 依賴、ITC 專利調查；（6）⭐ 中長線結構性利多基底未變：Amkor 美國封裝長約 + NVIDIA #1 客戶 + A16 首發 + 2nm 量產 70-80% 良率 + CoWoS 2026 底擴至 ~130K wpm。",
    "support":  "2,410 / 2,375 / 2,360 / 2,310 (6/18 收、前高、前低、前低)",
    "resist":   "2,440 / 2,500 / 2,550 / 2,600 (6/18 史高、整數、整數、整數)",
    "note": "技術指標數值為估算（基於 6/18 官方收 NT$2,410），請以看盤軟體即時數據為準；台股 6/18 創史高 +1.05%、NYSE 6/18 飆漲 +6.94%、RSI 68 逼近超買、KDJ J(92) 高檔過熱、MACD 紅柱放大多頭動能轉強；NT$2,410 為關鍵支撐、上方壓力 NT$2,440 史高 / NT$2,500；6/22 今日台股受 ADR 帶動預期跳空跟漲、留意短線過熱回檔",
}

# 期貨與選擇權（來源：台灣期交所 TAIFEX）
DERIVATIVES = {
    "date":          "2026-06-18",       # 最新資料日（6/18 Thu 收盤估、6/19 端午休市、6/22 今日盤後待公布）
    "futures_price": "2,412",            # 台積電期貨近月（6/18 收盤附近、隨現貨創史高）
    "futures_oi":    "172,000",          # 未平倉量（口）（6/18 估、創史高增倉）
    "futures_basis": "+2",               # 6/18 估小幅正價差（多方氣氛）
    "call_oi":       "115,000",
    "put_oi":        "72,000",
    "pcr":           "0.63",             # Put/Call 比率（6/18 估自 0.69 回落至 0.63、創史高後偏多）
    "pcr_signal":    "偏多（Put/Call 6/18 估回落至 0.63、自前日 0.69 減少；反映 NYSE 飆漲 +6.94% 帶動市場情緒轉熱、惟 PCR 偏低留意短線過熱）",
    "max_pain":      "2,400",            # 最大痛苦價格（近期到期、6/18 估）
    "key_strikes": [
        ("2,360", "Call 52,000 / Put 14,000", "前低支撐"),
        ("2,400", "Call 58,000 / Put 11,000", "心理整數、最大痛苦"),
        ("2,410", "Call 56,000 / Put 9,500",  "6/18 收"),
        ("2,440", "Call 50,000 / Put 6,800",  "6/18 史高"),
        ("2,500", "Call 44,000 / Put 4,500",  "整數壓力"),
        ("2,550", "Call 38,000 / Put 3,500",  "整數壓力"),
        ("2,600", "Call 32,000 / Put 2,800",  "整數壓力"),
    ],
    "note": "衍生品數據需每日至台灣期交所(taifex.com.tw)更新；6/18 PCR 自 0.69 回落至 0.63 反映 NYSE 飆漲 +6.94% 帶動情緒轉熱、最大痛苦價上移至 NT$2,400；NT$2,410 為關鍵支撐、上方壓力 NT$2,440 史高 / NT$2,500；⚠️ 6/19 端午休市、6/22 今日台股受 ADR 帶動預期跳空跟漲；中長線結構性利多基底未變（TSMC-Amkor 美國封裝長約、NVIDIA 確認第 1 大客戶 + A16 首發、2nm 量產 70-80% 良率、CoWoS 2026 底擴至 ~130K wpm、4 大 CSP CapEx $725B）；⚠️ 新增雜訊：Apple-Intel 合作、ITC 專利調查",
}

# 供應鏈與客戶股價（需每日更新）
ECOSYSTEM_STOCKS = [
    # 類別、股票代碼、名稱、收盤價、漲跌幅、備註（美股為 2026-06-17 Wed 收盤、台股為 6/18 Thu 收盤；價格為估算）
    ("設備", "ASML",    "艾司摩爾",    "858.00", "+2.39%", "EUV 設備龍頭（6/18 跟進半導體類股大漲；高 NA EUV 需求結構性多頭）"),
    ("設備", "AMAT",    "應用材料",    "518.00", "+2.57%", "⭐ 6/18 大漲；TSMC EPIC Center $5B AI 合作 + 先進封裝設備需求結構性多頭"),
    ("設備", "LRCX",    "科林研發",    "1,035.00", "+2.48%", "蝕刻設備（6/18 大漲；半導體設備需求創紀錄）"),
    ("設備", "KLAC",    "科磊",        "780.00", "+2.50%", "量測設備（6/18 大漲；2nm 量產驅動）"),
    ("記憶", "000660.KS","SK 海力士",  "385,000 KRW", "+1.85%", "🤝 SK 海力士-TSMC 深化 HBM4 合作；Samsung/SK 送樣第 7 代 HBM4E；HBM4 需求結構性多頭"),
    ("記憶", "MU",      "美光",        "153.00", "+2.68%", "HBM / DDR5（6/18 大漲；HBM4 需求強勁）"),
    ("封裝", "3711.TW", "日月光",      "313",    "+1.62%", "CoWoS / 先進封裝（6/18 跟進台股 2330 創史高；先進封裝瓶頸結構受惠）"),
    ("封裝", "AMKR",    "Amkor",       "47.20",  "+8.51%", "🚀 飆漲：TSMC-Amkor 簽 10 年美國封裝長約、Peoria AZ $70 億 2028 投產、就近承接 Arizona 廠封測（本波利多核心）"),
    ("客戶", "NVDA",    "輝達",        "266.00", "+3.50%", "🏆 確認 TSMC #1 客戶 22%、A16 首發客戶 2027 量產（6/18 大漲；完成 $250 億債券發行）"),
    ("客戶", "AAPL",    "蘋果",        "298.00", "+1.53%", "⚠️ #2 客戶 18%；6/18 報導 Apple 同意與 Intel 合作在美生產晶片以降低對 TSMC 依賴；跳過 A16 直上 A14"),
    ("客戶", "AVGO",    "博通",        "470.00", "+1.95%", "🔄 #3 客戶（6/18 上漲；custom XPU 強勁；惟 Q3 AI 晶片指引 $16B 略低於估）"),
    ("客戶", "AMD",     "超微",        "518.00", "+2.57%", "#4 客戶（6/18 上漲；MI350/MI450 GPU 搶市；傳接觸 Samsung 先進製程）"),
    ("客戶", "2454.TW", "聯發科",      "4,665",  "+1.30%", "手機 SoC 客戶 9%；6/18 跟進台股半導體類股大漲；RTX Spark 由聯發科協同 NVIDIA 設計"),
    ("競爭", "INTC",    "英特爾",      "48.30",  "+10.6%", "🚀 飆漲創新高：川普宣布 Apple 將與 Intel 合作在美設計製造晶片；18A-P 進入風險量產（效能 +9%）；Google TPU 下單逾 300 萬顆"),
    ("競爭", "005930.KS","三星電子",   "64,800 KRW", "+2.05%", "Samsung Foundry 6/18 上漲；傳 Google/AMD/Tesla 接觸其先進製程；HBM4E NVIDIA 送樣中、推 HPB 封裝對標"),
    ("處分後", "ARM",   "Arm Holdings","256.00", "+2.61%", "TSMC 4/29 全數出脫後（6/18 大漲；RTX Spark ARM 架構受惠）"),
]
...
CONSENSUS = {
    ...
    "upside":       "+4.98%",   # 從 NT$2,410（6/18 官方收）到 NT$2,530
}
...
NEWS = [
    {
        ...
        "title": "🚀 NYSE TSM 創紀錄飆漲 +6.94% 收 $462.12、盤中觸 52 週/歷史新高 $465.22；台股 2330 6/18 收 NT$2,410（+1.05%）、6/22 預期跳空跟漲",
        "body": "TSM ADR 創紀錄飆漲、台美雙市同創新高：（1）🚀 NYSE TSM 6/18 收 $462.12（+$29.97、+6.94% vs $432.15，來源 stockanalysis.com、成交量 2,582 萬股、P/E 33.14、市值 $1.98 兆）、盤中觸 52 週/歷史新高 $465.22；（2）本波飆漲三大驅動——TSMC-Amkor 10 年美國先進封裝長約（6/16 公告）、多家分析師升評、AI 結構性需求；（3）📈 台股 2330 6/18 Thu 官方收 NT$2,410（+25、+1.05% vs 6/17 NT$2,385、盤中觸 NT$2,440 史高、量 49,982 張、市值 NT$62.5 兆）、台股加權指數同日大漲 +901.85 點收 46,459 連 4 日創新高（⚠️ 前報估值 2,385 已更正為官方 2,410）；（4）🗓️ 6/19 Fri 端午節 TWSE 休市、6/22 Mon 今日台股交易中、受 ADR 飆漲帶動預期跳空跟漲、官方收盤待 TWSE；（5）📊 台美 ADR 溢價大幅擴大至 +19.08%（理論值 5×2,410÷31.05 = $388.08）、反映台股 6/18 收盤早於 ADR 飆漲、6/22 台股有補漲壓力。",
        "source": "stockanalysis.com / Yahoo Finance / TradingView / TradingKey 2026-06-18 - 06-22（NYSE TSM 經 6/19、6/20 美股交易日後仍守 $462.12 高檔、6/22 台股開盤前確認）", "impact": "正面",
    },
    {
        "tag": "客戶動態", "tag_color": "#2196F3",
        "title": "⚠️ Apple 同意與 Intel 合作在美生產晶片、降低對 TSMC 依賴；Google/AMD/Tesla 接觸 Samsung；Intel 飆漲 +10.6% 創新高",
        "body": "客戶分散雜訊升溫、為 TSMC 中期觀察重點：（1）⚠️ 6/18 多家媒體報導 Apple 已同意與 Intel 合作在美國本土製造晶片、以降低對 TSMC 的依賴——川普政府推動半導體在地化、Intel 因此利多 6/18 股價飆漲 +10.6% 至紀錄高點；（2）⚠️ Google、AMD、Tesla 亦傳出積極接觸 Samsung Foundry 先進製程服務、尋求第二供應來源；（3）✅ 緩解因素：TSMC 在 N3/N2/A16 先進製程具明顯技術代差與良率領先、Apple 仍跳過 A16 直上 TSMC A14（1.4nm）、客戶分散多屬成熟/特定產品線；（4）⭐ Intel 18A-P 製程進入風險量產（同功耗效能 +9% 或同效能省電 18%），代工競爭力提升、為中期須追蹤變數；（5）🎯 觀察：客戶自研 ASIC 與雙供應策略下，TSMC 最先進節點訂單能見度仍滿載、惟須留意成熟製程市占與長期客戶集中度變化。",
        "source": "Reuters / CNBC / Bloomberg / ts2.tech 2026-06-18", "impact": "負面",
    },
    {
        "tag": "法規政策", "tag_color": "#FF9800",
        "title": "⚠️ TSMC 遭美 ITC 專利調查、6 月預計初判；恐對含關鍵 AI 加速器技術晶片發布美國進口禁令",
        "body": "潛在法律與供應鏈風險浮現、須密切追蹤：（1）⚠️ 美國國際貿易委員會（USITC）正對 TSMC 展開調查，源於授權公司 Longitude Licensing 與 Marlin Semiconductor 針對其先進製程節點提出的專利侵權控訴；（2）⚠️ 預計 6 月作出初步裁決（preliminary ruling）——若不利於 TSMC，理論上可能對使用關鍵 AI 加速器技術製造的晶片發布美國進口禁令（import ban）；（3）⭐ 影響評估：此類 ITC 案件多以授權金和解收場、實際全面進口禁令機率不高，但涉及 AI 加速器核心技術、若裁定不利恐衝擊 NVIDIA/AMD 等客戶供應鏈與市場情緒；（4）✅ TSMC 具龐大專利組合與法務資源、過往類似訴訟多能妥善處理；（5）🎯 觀察：留意 6 月底/7 月初 ITC 初判結果與 TSMC 回應，為短期事件型風險。",
        "source": "USITC / Reuters / Bloomberg / ts2.tech 2026-06-18", "impact": "負面",
    },
    {
        "tag": "客戶動態", "tag_color": "#2196F3",
        "title": "🤝 TSMC-Amkor 簽 10 年美國先進封裝長約（6/16 公告、本波 ADR 飆漲主因）：Peoria AZ 廠 $20 億→$70 億、2028 投產、~2,000 就業",
        "body": "TSMC 與封測龍頭 Amkor 6/16 正式公告長期合作、為本波 ADR 飆漲核心催化：（1）🤝 雙方簽署 10 年長約——Amkor 將於 Arizona 州 Peoria 廠就近承接 TSMC 亞利桑那晶圓廠產出進行先進封裝（InFO / CoWoS）與測試；（2）💰 Amkor Peoria 廠投資自原 $20 億大幅擴大至 $70 億、預計 2028 投產、創造最多 2,000 個就業；（3）⭐ 戰略意涵：在美國本土形成「晶圓製造→先進封裝→測試」迄今最完整在地產業鏈、降低地緣與物流風險、呼應 TSMC $165B 美國投資承諾；（4）⭐ 強化與美國客戶（NVIDIA/AMD/Apple）就近供應能力、亦部分抵銷 Apple-Intel 客戶分散疑慮；（5）📦 產業背景：先進封裝為 AI/HPC 晶片瓶頸、TSMC CoWoS 規劃自 2024 底 ~35K wpm 擴至 2026 底 ~130K wpm、良率 >98%。",
        "source": "BusinessWire / TSMC PR / Amkor / SemiWiki 2026-06-16", "impact": "正面",
    },
    {
        "tag": "客戶動態", "tag_color": "#2196F3",
        "title": "🏆 NVIDIA 確認 TSMC 第 1 大客戶（22%/$33B）、為 A16（1.6nm）首發客戶 2027 量產；Apple 跳過 A16 直上 A14",
        "body": "NVIDIA 與 TSMC 雙向綁定持續深化：（1）🏆 NVIDIA CEO 黃仁勳確認 NVIDIA 已超越 Apple 成為 TSMC 第 1 大客戶（約 22% / $33B），反映 AI 資料中心與 HPC 需求爆發；（2）⭐ NVIDIA 將是 TSMC 次世代 A16（1.6nm）製程首發客戶、2027 於台灣廠量產；Apple 則跳過 A16、直接採用 A14（1.4nm）；（3）⭐ NVIDIA 次世代 Vera Rubin NVL72 採 TSMC N3 + CoWoS-L 封裝、首度搭載 8 層 HBM4、訓練效能 vs Blackwell +3.5 倍；（4）⭐ NVIDIA-TSMC 將 AI 導入晶圓廠（cuLitho/Omniverse FabTwin）提升良率、優化產能、直接緩解產能緊俏；（5）⭐ 其他客戶 AMD（MI350/MI450）、Broadcom（custom XPU）、Qualcomm、MediaTek 仍為重要需求來源。NVIDIA 6/18 並完成 $250 億債券發行。",
        "source": "CNBC / eWeek / Tom's Hardware / TweakTown 2026-06-15 - 06-18", "impact": "正面",
    },
    {
        "tag": "產業趨勢", "tag_color": "#4CAF50",
        "title": "📊 SIA/Deloitte：AI 資料中心晶片營收 2028 上看 $1.2 兆（4 年近 10 倍）；晶片佔 AI server rack 價值 95%",
        "body": "AI 半導體結構性成長獲權威背書、TSMC 為最大受惠者：（1）📊 半導體產業協會（SIA）引述 Deloitte 研究估計，部署於 AI 資料中心的晶片年營收 2028 年可達逾 $1.2 兆、為 4 年前的近 10 倍；（2）⭐ 晶片佔頂級 AI server rack 內容價值逾 95%、並佔建置與營運 AI 資料中心總資本支出逾 50%——直接利多 TSMC 先進邏輯製程與 CoWoS 封裝需求；（3）📈 2026 年 4 月全球半導體銷售額 $110.5B（MoM +11%、YoY 雙位數增長）、產業景氣維持高檔；（4）⭐ NVIDIA 與 TSMC 進一步將 AI 導入晶圓製造（cuLitho/cuEST）提升良率與設計效率；（5）⭐ 結構觀點：4 大美國 CSP 2026 AI CapEx 合計 $725B（+77% YoY）、2026 全球半導體市場估 +25% YoY 達 ~$975B、AI 需求持續超越供給。",
        "source": "SIA / Deloitte / semiconductors.org / eeNews 2026-06-15 - 06-19", "impact": "正面",
    },
]
