...
STOCK = {
    # 台股 2330
    "tw_price":       "2,490",        # 台股 2330 7/7 Tue 官方收盤 NT$2,490（+30、+1.22% vs 7/6 收 NT$2,460）為最新確認收盤——補漲兌現、跟進 NYSE 7/6 +4.06% 大反彈 + Citi 上調目標 NT$3,800 催化；NYSE 7/7 Tue 盤待今晚 GMT+8
    "tw_change":      "+30",          # 7/7 Tue 收盤漲跌點數（+1.22%、連二漲、補漲兌現）
    "tw_change_pct":  "+1.22%",       # 7/7 Tue 收盤漲跌幅（跟進 NYSE 反彈 + Citi 上調目標至 NT$3,800）
    "tw_volume":      "24,800",       # 7/7 Tue 收盤成交量（張，估、上漲日放量）
    "tw_open":        "2,470",        # 7/7 開盤
    "tw_high":        "2,505",        # 7/7 盤中高（逼近 NT$2,535 史高）
    "tw_low":         "2,465",        # 7/7 盤中低
    "market_cap":     "NT$64.6 兆",   # 7/7 收盤市值（NT$2,490 基礎）
    "pe_ratio":       "~36.6x",       # 台股 P/E（TTM，NT$2,490 基礎）
    "pb_ratio":       "~12.9x",       # 台股 P/B（股淨比，NT$2,490 基礎）
    "div_yield":      "~0.60%",       # 殖利率（NT$2,490 基礎）
    "52w_high_tw":    "2,535",        # 52 週/歷史高（2026-06-23 盤中觸 NT$2,535 史高）
    "52w_low_tw":     "780",          # 52 週低（2025-04-07）
    # NYSE TSM ADR
    "nyse_price":     "432.57",       # 7/7 Tue 官方收盤 $432.57（-$19.22、-4.25%；stockanalysis.com 確認、前收 7/6 $451.79、日內 $428.11–$439.80）為最新確認 NYSE 收盤——回吐 7/6 假期後 V 型反彈（+4.06%）大部分漲幅、7/16 財報前估值修正 + 獲利了結；台股 2330 7/8 Wed 盤待今日 GMT+8
    "nyse_change":    "-19.22",       # 7/7 漲跌（最新確認 NYSE 收盤；回吐 7/6 反彈漲幅、費半半導體同步回檔）
    "nyse_change_pct":"-4.25%",       # 7/7 NYSE 回檔（7/16 財報前估值修正 + 獲利了結、AI 晶片股回落）
    "52w_high_nyse":  "479.00",       # 52 週/歷史高（區間，6/30 收 $477.57）
    "52w_low_nyse":   "223.70",       # 52 週低（區間）
    "pe_nyse":        "~37.6x",       # NYSE USD 基礎 P/E（TTM，$432.57 基礎、7/7 -4.25% 後回落）
    "pb_nyse":        "~12.9x",
    "beta":           "1.18",
    ...
    # 資料日期備註
    "data_note":      "報告日期：2026-07-08 Wed（最新確認收盤：NYSE TSM 7/7 Tue 官方收 $432.57（-$19.22、-4.25%、stockanalysis.com 確認、前收 7/6 $451.79、日內 $428.11–$439.80）為最新確認 NYSE 收盤；台股 2330 最新確認收盤仍為 7/7 Tue 官方收 NT$2,490（+30、+1.22% vs 7/6 NT$2,460、量估約 24,800 張、盤中高觸 NT$2,505）；台股 2330 7/8 Wed 盤待今日 GMT+8）。⭐ 今日頭條——NYSE V 型反彈後 7/7 回吐、財報前估值修正、台股 7/8 恐承壓補跌：（0）📉 NYSE TSM 7/7 Tue 收 $432.57（-$19.22、-4.25%）回吐 7/6 假期後 V 型反彈（+4.06%、$451.79）大部分漲幅、費半半導體同步回檔——為 7/16 Q2 財報前估值修正 + 獲利了結、AI 晶片股全面回落，並非基本面惡化；（1）⚖️ 台股 2330 最新確認收盤仍為 7/7 NT$2,490（+1.22%、連二漲）；7/8 Wed 盤待今日、料跟進 NYSE 7/7 -4.25% 承壓補跌、留意 NT$2,460 / NT$2,445 支撐能否守穩；（2）🚀 分析師仍逆勢大幅續挺——Citi（花旗）7/6 上調台股目標價自 NT$2,875 至 NT$3,800（+32%、維持買入、自 NT$2,490 具約 +52.6% 空間、預期 7/16 上修 2026 營收成長與 2027-28 資本支出至 $75-80B）；Nomura NT$3,425（自 NT$2,490 具 +37.6% 空間）；（3）📊 台美 ADR 溢價收斂——以 7/7 ADR $432.57 折合台股約 NT$2,768（匯率 ~32.0）vs 台股 7/7 NT$2,490、溢價約 +11.2%（自 7/6 +16.2% 收斂）；（4）🚀 分析師逆勢大幅續挺——Barclays 維持 TSM 目標價 $625（Overweight、自 7/6 收 $451.79 仍具約 +38.3% 空間）；Nomura NT$3,425（自 NT$2,490 具 +37.6% 空間）、指 AI 基礎設施投資循環尚未見頂、估 2027 資料中心新增產能達 ~32GW；⚠️ 惟 Goldman Sachs 7/1 將 TSM 移出「APAC Conviction List」（戰術性調整、非降評）。（5）🤝 產業利多——NVIDIA 與 SK 海力士宣布多年期記憶體技術合作、共推 AI 工廠次世代記憶體；NVIDIA 與 TSMC 將 AI/加速運算導入晶圓廠設計與製造（提升週期時間、能效、良率）；BofA 上修 2026 全球半導體市場至 $1.3 兆（原 $1.0 兆）、2030 上看 $2 兆；生成式 AI 晶片估 2026 貢獻 ~$500B（約全球晶片銷售半數）；Qualcomm 推無 HBM 資料中心晶片挑戰 NVIDIA。⭐ 漲價題材續發酵——TSMC 全先進製程（7nm 以下、佔晶圓營收 ~75%）調漲 5-10%，估全年毛利率 +2pp 以上，惟客戶（Apple/NVIDIA/AMD/Qualcomm/Broadcom/MediaTek）成本升；Benzinga 指 NVIDIA 因需求剛性、長期反為利多。⚠️ 近期營收疑慮續存——4-5 月營收合計 +24% YoY 落後華爾街 Q2 約 +35% 預期，6 月營收（7 月上旬公布）為關鍵 catalyst、僅需小幅月增即可使 Q2 營收逼近指引中值。⭐ 中長線結構性利多基底未變：TSMC-Amkor 10 年美國先進封裝長約（Peoria AZ $70 億、2028 投產）、Winbond 特殊 DRAM 自主供應、NVIDIA 確認第 1 大客戶（22%/$33B）+ A16 首發 2026 下半/2027 量產（Apple 跳過 A16 直上 A14）+ Vera Rubin 平台 6 顆晶片全數 TSMC 代工（3nm + HBM4）、2nm 量產 70-80% 良率、2nm/A16 產能 2026-28 估 CAGR ~70%。  |  🎯 即將事件：6 月營收 7 月上旬公布（關鍵 catalyst、攸關 Q2 指引達成）；Q2 2026 財報法說會 7/16（指引 $39.0-40.2B、毛利率 65-67%、Citi 預期上修全年展望）  |  ⭐ 中長線基底：5 月營收 NT$4,169.75 億 +30.1% 創單月新高；2nm 量產良率 70-80% 領先全球；NVIDIA 第 1 大客戶 22%/$33B；4 大美國 CSP 2026 AI CapEx 合計 $725B（+77% YoY）；BofA 估 2026 全球半導體市場 $1.3 兆；費半（SOX）YTD +47%  |  ⚠️ 本日（7/8）關鍵觀察：（1）台股 7/8 能否守穩 NT$2,460 / NT$2,445 / NT$2,410 支撐、消化 NYSE 7/7 -4.25% 補跌壓力；（2）上方壓力 NT$2,505 / NT$2,535 史高；（3）NYSE 7/8 盤能否止穩、美股半導體動能；（4）⚠️ 估值警示：TSM P/E ~37.6x、台股 P/E ~36.6x，留意 6 月營收 miss 風險、下游需求疲弱與漲價客戶反彈；（5）🚀 中長線順風：Citi NT$3,800 + Barclays $625 + Nomura NT$3,425 + 共識強力買入",
}
...
SUMMARY = {
    ...
    "sentiment":  "中性偏多",
    # 一句話標題
    "headline":   "📉 NYSE V 型反彈後 7/7 回吐 -4.25%（$432.57）、台股 7/8 恐承壓補跌：NYSE TSM 回吐 7/6 反彈（+4.06%）大部分漲幅、費半半導體同步回檔、7/16 財報前估值修正 + 獲利了結；台股 2330 最新確認收盤仍為 7/7 NT$2,490（+1.22%）、7/8 盤待今日；分析師仍大幅續挺（Citi NT$3,800／Barclays $625／Nomura NT$3,425）、結構性多頭基底未變",
    # 3–5 條白話重點（不用術語，每條約 30 字內）
    "bullets": [
        "🚀 Citi（花旗）7/6 大幅上調 TSMC 台股目標價自 NT$2,875 至 NT$3,800（+32%、維持買入、自 7/7 收 NT$2,490 仍具約 +52.6% 空間）——為 7/16 法說會前最新升評、預期 TSMC 上修 2026 全年營收成長與長期展望、上調 2027-28 資本支出估至 $75-80B",
        "⚖️ 台股 2330 7/7 Tue 官方收 NT$2,490（+30、+1.22%、量估約 24,800 張）——連二漲、補漲兌現、盤中高觸 NT$2,505 逼近 NT$2,535 史高；跟進 NYSE 7/6 +4.06% 大反彈 + Citi 升評雙催化",
        "📉 NYSE TSM 7/7 Tue 收 $432.57（-$19.22、-4.25%、前收 7/6 $451.79、日內 $428.11–$439.80）——回吐 7/6 假期後 V 型反彈（+4.06%）大部分漲幅、費半半導體同步回檔；為 7/16 Q2 財報前估值修正 + 獲利了結、AI 晶片股全面回落，並非基本面惡化",
        "📊 台美 ADR 溢價收斂至約 +11.2%（7/7 ADR $432.57 折合台股約 NT$2,768 vs 台股 7/7 NT$2,490，自 7/6 +16.2% 收斂）——NYSE 回檔後溢價回落，台股 7/8 恐承壓補跌、留意 NT$2,460 / NT$2,445 / NT$2,410 支撐能否守穩",
        "🚀 分析師逆勢大幅續挺：Citi NT$3,800（+32%）、Barclays 維持 TSM 目標 $625（Overweight、自 $451.79 具 +38.3% 空間）、Nomura NT$3,425（自 NT$2,490 具 +37.6% 空間）；共識強力買入；⚠️ 惟 Goldman 7/1 移出 APAC Conviction List（戰術調整、非降評）",
        "🤝 產業利多：NVIDIA 與 SK 海力士宣布多年期記憶體合作（AI 工廠次世代記憶體）；NVIDIA-TSMC 將 AI 導入晶圓廠製造；BofA 上修 2026 全球半導體市場至 $1.3 兆、生成式 AI 晶片估 ~$500B；Qualcomm 推無 HBM 資料中心晶片",
        "⭐ 漲價題材續發酵：全先進製程（7nm 以下、佔晶圓營收 ~75%）調漲 5-10%、估貢獻全年毛利率 +2pp 以上；Benzinga 指 NVIDIA 可轉嫁、長期反利多",
        "🏆 中長線基底未變：NVIDIA #1 客戶（22%/$33B）/A16 首發 + Vera Rubin 6 顆晶片全 TSMC 代工（3nm+HBM4）+ TSMC-Amkor 美國封裝長約 + 2nm 70-80% 良率、CAGR ~70%",
        "⚠️ 風險續追蹤：4-5 月營收 +24% YoY 落後 ~35% 預期、6 月營收（7 月上旬）與 7/16 財報為關鍵；下游手機/PC 需求疲弱；AMD 首發 2nm AI 晶片；估值偏高（TSM P/E ~39.3x、台股 ~36.2x）",
    ],
    # 一句結論
    "bottom_line": "報告日期：2026-07-08 Wed（最新確認收盤：NYSE TSM 7/7 Tue 官方收 $432.57（-$19.22、-4.25%、stockanalysis.com 確認、前收 7/6 $451.79、日內 $428.11–$439.80）為最新確認 NYSE 收盤；台股 2330 最新確認收盤仍為 7/7 Tue 官方收 NT$2,490（+30、+1.22% vs 7/6 NT$2,460、量估約 24,800 張、盤中高觸 NT$2,505）；台股 2330 7/8 Wed 盤待今日 GMT+8）。⭐ 今日頭條——NYSE V 型反彈後 7/7 回吐 -4.25%（$432.57）、財報前估值修正、台股 7/8 恐承壓補跌，惟分析師仍大幅續挺、結構性多頭基底未變：（0）🚀 Citi（花旗）7/6 大幅上調 TSMC 台股目標價自 NT$2,875 至 NT$3,800（+32%、維持買入、自 7/7 收 NT$2,490 仍具約 +52.6% 空間）——為 7/16 法說會前最新升評、預期 TSMC 上修 2026 全年營收成長與長期展望、並上調 2027-28 資本支出估至 $75-80B、看好 AI GPU/客製 ASIC/雲端 TPU/網通/光互連/CPU 全面需求；（1）📉 NYSE TSM 7/7 Tue 收 $432.57（-$19.22、-4.25%、前收 7/6 $451.79、日內 $428.11–$439.80）回吐 7/6 假期後 V 型反彈（+4.06%）大部分漲幅、費半半導體同步回檔——為 7/16 Q2 財報前估值修正 + 獲利了結、AI 晶片股全面回落，確認近期波動屬技術面/估值修正、而非基本面惡化；（2）⚖️ 台股 2330 7/7 收 NT$2,490（+30、+1.22%）連二漲、補漲兌現——跟進 NYSE 7/6 +4.06% 大反彈 + Citi 升評雙催化、盤中高觸 NT$2,505 逼近 NT$2,535 史高；（3）📊 台美 ADR 溢價收斂——以 7/7 ADR $432.57 折合台股約 NT$2,768（wantgoo、匯率 ~32.0）vs 台股 7/7 NT$2,490、溢價約 +11.2%（NYSE 回檔後自 7/6 +16.2% 收斂）；（4）🚀 分析師逆勢大幅續挺——Barclays 維持 TSM 目標價 $625（Overweight、自 7/6 收 $451.79 仍具約 +38.3% 上行空間）；Nomura（野村）上調台股目標至 NT$3,425（自 NT$2,490 具 +37.6% 空間），指 AI 基礎設施投資循環尚未見頂、估 2027 資料中心新增產能達 ~32GW；（5）⚠️ 惟 Goldman Sachs 7/1 將 TSM 移出「APAC Conviction List」（戰術性調整近期上檔預期、非降評）。🤝 NVIDIA 與 SK 海力士宣布多年期記憶體技術合作（AI 工廠次世代記憶體）；NVIDIA 與 TSMC 宣布將 AI/加速運算導入晶圓廠設計與製造流程（提升週期時間、能效與良率）；BofA 上修 2026 全球半導體市場規模至 $1.3 兆（原估 $1.0 兆）、估 2030 上看 $2 兆；Qualcomm 推無 HBM 資料中心晶片、瞄準 2029 年 $150 億營收挑戰 NVIDIA。⭐ 漲價題材續發酵：TSMC 通知客戶全先進製程調漲 5-10%（擴及 N7/N5/N3 及成熟製程、佔晶圓營收 ~75%），利多毛利率（估全年 +2pp 以上），惟客戶（含 Apple/NVIDIA/AMD/Qualcomm/Broadcom/MediaTek）成本升；Benzinga 指 NVIDIA 因 AI 需求剛性與轉嫁能力強、長期反為利多。6 月營收（7 月上旬公布）為關鍵 catalyst——4-5 月營收合計 +24% YoY 低於華爾街 Q2 約 +35% 預期、惟即使小幅月增亦可能使 Q2 營收逼近指引（$39.0-40.2B）中值。⚠️ 南韓公布逾 $1 兆美元 AI/晶片投資計畫（三星+SK 海力士 800 兆韓元）、中長期競爭加劇。⭐ 中長線結構性利多基底未變：（1）🤝 TSMC-Amkor 10 年美國先進封裝長約（Peoria AZ $70 億、2028 投產）；（2）⭐ TSMC-Winbond 特殊 DRAM 自主供應、降低 HBM 對韓系依賴；（3）🏆 NVIDIA 確認 TSMC 第 1 大客戶（22%/$33B）、A16 首發 2026 下半/2027 量產、Vera Rubin 平台 6 顆晶片全數 TSMC 代工（3nm+HBM4）、Apple 跳過 A16 直上 A14；（4）⭐ 2nm 已量產、初期良率 70-80% 領先全球、2nm/A16 產能 2026-28 估 CAGR ~70%；（5）4 大美國 CSP 2026 AI CapEx 合計 $725B（+77% YoY）；（6）⭐ 5 月營收 NT$4,169.75 億 +30.1% 創單月新高、1-5 月累計 NT$1.96 兆；（7）BofA 估 2026 全球半導體市場 $1.3 兆；（8）費半（SOX）Q2 大漲 +87.8% 創 1994 年以來最強單季。⚠️ 下行風險：（1）漲價恐引發客戶反彈與訂單調整；（2）4-5 月營收 +24% YoY 落後 Q2 ~35% 預期、6 月營收與 7/16 財報為關鍵驗證；（3）智慧型手機/PC 等下游終端需求疲弱；（4）估值警示——TSM P/E ~39.3x、台股 P/E ~36.6x；（5）台幣升值（每升 1% 毛利率 -40bps）。基本面未變：Q1 2026 淨利 NT$572.5B（$18.2B、+58.3% YoY）、毛利率 66.2% 雙創史高。技術面（基於 7/7 收 NT$2,490）：5MA NT$2,473 / 20MA NT$2,440 / 60MA NT$2,410 / 120MA NT$2,320；下方支撐 NT$2,460 / NT$2,445 / NT$2,410；上方壓力 NT$2,505 / NT$2,535（史高）。分析師仍全面看多（Citi NT$3,800、Barclays $625、Nomura NT$3,425），NYSE 7/7 回檔 -4.25% 屬 7/16 財報前估值修正 + 獲利了結、而非基本面惡化；台股 7/8 恐承壓補跌、關鍵在守穩 NT$2,460 / NT$2,445 / NT$2,410 支撐。",
    # 重大警示（選填，空白則不顯示）
    "risk_alert":  "今日（7/8 Wed）關鍵觀察：（1）📉 NYSE TSM 7/7 收 $432.57（-$19.22、-4.25%、前收 7/6 $451.79、日內 $428.11–$439.80）回吐 7/6 假期後 V 型反彈（+4.06%）大部分漲幅、費半半導體同步回檔、7/16 財報前估值修正 + 獲利了結、AI 晶片股全面回落；（2）⚖️ 台股 2330 最新確認收盤仍為 7/7 NT$2,490（+1.22%、連二漲、盤中高觸 NT$2,505）；7/8 盤待今日、料跟進 NYSE 7/7 -4.25% 承壓補跌、關鍵在守穩 NT$2,460 / NT$2,445 / NT$2,410 支撐；（3）📊 台美 ADR 溢價收斂至約 +11.2%（7/7 ADR $432.57 折合台股約 NT$2,768 vs 台股 7/7 NT$2,490、自 7/6 +16.2% 收斂）；NYSE 7/8 盤待今日 GMT+8、留意能否止穩；（4）🚀 分析師逆勢大幅續挺——Citi NT$3,800、Barclays 維持目標 $625（自 $451.79 具 +38.3% 空間）、Nomura NT$3,425（自 NT$2,490 具 +37.6% 空間）、共識強力買入；⚠️ 惟 Goldman 7/1 將 TSM 移出 APAC Conviction List（戰術調整、非降評）；（5）🤝 NVIDIA-SK 海力士宣布多年期記憶體合作、NVIDIA-TSMC 導入 AI 入廠提升良率、BofA 上修 2026 半導體市場至 $1.3 兆（生成式 AI 晶片 ~$500B）、Qualcomm 推無 HBM 資料中心晶片；⭐ 漲價定價力擴及全先進製程（7nm 以下、佔晶圓營收 ~75%）、估全年毛利率 +2pp 以上；（6）⚠️ 4-5 月營收 +24% YoY 落後 ~35% 預期、6 月營收（7 月上旬）與 7/16 財報為關鍵 catalyst；下游手機/PC 需求疲弱、AMD 首發 2nm AI 晶片；（7）🏆 中長線基底未變：NVIDIA #1 客戶（22%/$33B）/A16 首發、Vera Rubin 6 顆晶片全 TSMC 代工、2nm 70-80% 良率、TSMC-Amkor 美國封裝長約；（8）⚠️ 估值警示：TSM P/E ~39.3x、台股 P/E ~36.6x；本日關鍵：台股 7/8 能否守穩 NT$2,460 / NT$2,445 / NT$2,410 支撐、消化 NYSE 7/7 -4.25% 補跌壓力，上方壓力 NT$2,505 / NT$2,535 史高",
}

# 三大法人買賣超（張）— 最新一日
INSTITUTIONAL = {
    "date":     "2026-07-07",       # 最新資料日（7/7 Tue 官方收盤；三大法人淨額為估算，官方明細以 TWSE 為準）
    "foreign":  12000,             # 外資 7/7 估買超約 12,000 張（台股 +1.22% 補漲、Citi 升評 + NYSE 大反彈帶動、外資回補）
    "trust":    1500,              # 投信 7/7 估買超約 1,500 張
    "dealer":   600,               # 自營商 7/7 估買超約 600 張
    # 近5日（由舊到新：7/1, 7/2, 7/3, 7/6, 7/7）；7/7 為官方收盤日、三大法人淨額為估算
    "foreign_5d": [15000, -8000, -3000, 2500, 12000],    # 外資 7/7 估買超約 12,000 張（補漲回補）
    "trust_5d":   [2000, 500, 800, 900, 1500],           # 投信 7/7 估買超約 1,500 張
    "dealer_5d":  [1000, -300, 200, 400, 600],           # 自營 7/7 估買超約 600 張
    "foreign_ownership_pct": "75.0%",  # 外資持股比例（7/7 估回升至 75.0%）
    "foreign_ownership_shares": "約 193.8 億股",
}

# 技術分析指標（需每日從看盤軟體更新）
TECHNICAL = {
    "rsi_14":       64.0,   "rsi_signal": "RSI 估自 60 續升至 64（台股 7/7 收 NT$2,490、+1.22%、連二漲），中性偏多、動能延續、尚未進超買；續攻 NT$2,505/2,535 史高留意重返超買區",
    "macd":         0.55,  "macd_signal": "MACD 估自 +0.48 續升至 +0.55、紅柱續增、多頭趨勢確立；NYSE 7/6 +4.06% V 型反彈 + 台股 7/7 補漲 +1.22% + Citi 升評帶動",   "macd_color": "#4CAF50",
    "kdj_k":        75.0,   "kdj_d": 68.0, "kdj_j": 88.0, "kdj_signal": "KDJ K(75)/D(68)/J(88) 續升、7/7 補漲帶動、動能轉強；J 值升至高檔近超買、續漲留意過熱",
    "ma5":       "2,473",   # 5MA（7/1 2505, 7/2 2465, 7/3 2445, 7/6 2460, 7/7 2490）— 基於 7/7 官方收盤
    "ma20":      "2,440",   # 20MA
    "ma60":      "2,410",   # 60MA 緩升
    "ma120":     "2,320",
    "bb_upper":  "2,575",   # 布林上軌
    "bb_mid":    "2,440",   # 布林中軌（20MA）
    "bb_lower":  "2,305",   # 布林下軌
    "vol_ma5":  "22,500",   # 5日均量（張，估、基於 7/1-7/7 五日均）
    "trend":    "🚀 修正確認結束、補漲兌現：台股 2330 7/7 官方收 NT$2,490（+30、+1.22%）連二漲、跟進 NYSE 7/6 +4.06% 大反彈 + Citi 上調台股目標至 NT$3,800（+32%）雙催化、盤中高觸 NT$2,505 逼近 NT$2,535 史高、站穩 5MA/20MA；NYSE TSM 7/6 假期後重新開盤即大漲 +4.06% 收 $451.79（前收 7/2 $434.16）、費半 SOX 同步 +3.92%、一舉收復 7/1-7/2 兩日全數跌幅、AI 半導體回神。📊 技術面（基於 7/7 官方收盤 NT$2,490）：RSI 自 60 續升至 64 動能延續、MACD +0.55 紅柱續增、KDJ J 值升至高檔近超買、多頭趨勢確立，中期 60MA/120MA 趨勢偏多。⚠️ 惟 NYSE TSM 7/7 收 $432.57（-4.25%）回吐 7/6 反彈大部分漲幅、費半半導體同步回檔，台股 7/8 恐承壓補跌。下一觀察：（1）台股 7/8 能否守穩 NT$2,460 / NT$2,445 / NT$2,410 支撐、消化 NYSE 7/7 -4.25% 補跌壓力；（2）NYSE 7/8 盤能否止穩、美股半導體動能；（3）下方支撐 NT$2,460 / NT$2,445 / NT$2,410；（4）🚀 Citi NT$3,800 + Barclays $625 + Nomura NT$3,425 + 共識強力買入為中長線支撐、惟須留意 6 月營收（7 月上旬）與 7/16 財報、Goldman 移出 APAC Conviction List；（5）⭐ 中長線基底未變：NVIDIA #1 客戶/A16 首發 + Vera Rubin 6 顆晶片全 TSMC 代工 + 2nm 70-80% 良率。",
    "support":  "2,460 / 2,445 / 2,410 (7/6 收、7/3 收、20MA)",
    "resist":   "2,505 / 2,535 (7/7 盤中高、史高)",
    "note": "技術指標數值為估算（基於 7/7 官方收盤 NT$2,490），請以看盤軟體即時數據為準；台股 2330 7/7 補漲 +1.22% 收 NT$2,490、盤中高觸 NT$2,505、連二漲、跟進 NYSE 7/6 +4.06% 大反彈 + Citi 上調台股目標至 NT$3,800（+32%）；RSI 自 60 續升至 64 動能延續、KDJ J 值升至高檔近超買、MACD 紅柱續增；上方壓力 NT$2,505 / NT$2,535 史高、下方支撐 NT$2,460 / NT$2,445；🚀 Citi/Barclays/Nomura 續挺目標 + 漲價定價力 + 共識偏多 vs ⚠️ 6 月營收與下游需求雜訊；NYSE 7/7 盤待今晚 GMT+8",
}

# 期貨與選擇權（來源：台灣期交所 TAIFEX）
DERIVATIVES = {
    "date":          "2026-07-07",       # 最新資料日（7/7 Tue 盤後估、官方待 TAIFEX 公布）
    "futures_price": "2,505",            # 台積電期貨近月（7/7 收盤附近、正價差、反映 Citi 升評與後續動能）
    "futures_oi":    "182,000",          # 未平倉量（口）（7/7 估）
    "futures_basis": "+15",              # 7/7 估正價差（NYSE 大反彈 + Citi NT$3,800 升評、多頭續強）
    "call_oi":       "122,000",
    "put_oi":        "74,000",
    "pcr":           "0.61",             # Put/Call 比率（7/7 估自 0.64 續落至 0.61、補漲後多頭情緒延續）
    "pcr_signal":    "偏多（Put/Call 7/7 估 0.61；台股 7/7 收 NT$2,490（+1.22%）連二漲、補漲兌現、Citi 上調台股目標至 NT$3,800、NYSE 7/6 大反彈 +4.06%、期貨正價差 +15；⭐ Citi/Barclays/Nomura + 共識偏多為支撐；NYSE 7/7 盤待今晚）",
    "max_pain":      "2,490",            # 最大痛苦價格（近期到期、7/7 估）
    "key_strikes": [
        ("2,410", "Call 52,000 / Put 11,000", "20MA、整數支撐"),
        ("2,445", "Call 50,000 / Put 8,500",  "7/3 收、支撐"),
        ("2,460", "Call 48,000 / Put 7,500",  "7/6 收、支撐"),
        ("2,490", "Call 46,000 / Put 7,000",  "7/7 收、最大痛苦"),
        ("2,505", "Call 42,000 / Put 5,500",  "7/7 盤中高、整數壓力"),
        ("2,535", "Call 32,000 / Put 3,500",  "盤中史高"),
        ("2,600", "Call 24,000 / Put 2,500",  "上檔壓力"),
    ],
    "note": "衍生品數據需每日至台灣期交所(taifex.com.tw)更新；7/7 PCR 估自 0.64 續落至 0.61 反映台股補漲 +1.22% + Citi NT$3,800 升評後多頭情緒延續、期貨正價差 +15；NT$2,490 為最大痛苦、下方支撐 NT$2,460 / NT$2,445、上方壓力 NT$2,505 / NT$2,535 史高；🚀 Citi NT$3,800 + Barclays $625 + Nomura NT$3,425 + 漲價定價力+共識偏多結構性利多、⚠️ 留意 6 月營收 miss 風險與下游需求疲弱；中長線基底未變（NVIDIA #1 客戶/A16 首發、Vera Rubin 6 顆晶片全 TSMC 代工、2nm 70-80% 良率、TSMC-Amkor 美國封裝長約）",
}

# 供應鏈與客戶股價（需每日更新）
ECOSYSTEM_STOCKS = [
    # 類別、股票代碼、名稱、收盤價、漲跌幅、備註（美股為 2026-07-07 Tue 收盤、回吐 7/6 假期後反彈、費半 SOX 估 -3.5% 同步回檔、為最新確認 NYSE 收盤、7/8 盤待今日；台股/韓股為 7/7 Tue 收盤；價格為估算）
    ("設備", "ASML",    "艾司摩爾",    "864.00", "-3.50%", "EUV 設備龍頭（7/7 隨半導體回吐 7/6 反彈；上修財測、高 NA EUV 需求強）"),
    ("設備", "AMAT",    "應用材料",    "546.00", "-3.50%", "🛠️ 設備股 7/7 回檔（回吐前日反彈）；新一代設備加速 DRAM 與 AI 先進封裝"),
    ("設備", "LRCX",    "科林研發",    "1,060.00", "-3.50%", "蝕刻設備（7/7 回檔；WFE 全年展望上修）"),
    ("設備", "KLAC",    "科磊",        "787.00", "-3.60%", "量測設備（7/7 回檔；2nm 量產驅動中長線）"),
    ("記憶", "2344.TW", "華邦電 Winbond","33.85","+1.35%", "⭐ 與 TSMC 合作將 CUBE 特殊 DRAM 導入 WoW 3D 堆疊/SoIC、降低台灣對 Samsung/SK HBM 依賴（台股 7/7 隨大盤補漲、價格為估算）"),
    ("記憶", "000660.KS","SK 海力士",  "394,000 KRW", "+0.51%", "🤝 與 NVIDIA 宣布多年期記憶體技術合作（AI 工廠次世代記憶體）；南韓逾 $1 兆美元 AI/晶片投資；HBM4 需求強、HBM4E 送樣"),
    ("記憶", "MU",      "美光",        "149.30", "-4.00%", "HBM / DDR5（7/7 回檔；AI 記憶體需求勁揚、HBM4 中長線強勁）"),
    ("封裝", "3711.TW", "日月光",      "334",    "+0.91%", "CoWoS / 先進封裝（台股 7/7 隨大盤補漲；先進封裝瓶頸結構受惠）"),
    ("封裝", "AMKR",    "Amkor",       "51.60",  "-3.70%", "⭐ TSMC-Amkor 簽 10 年美國封裝長約、Peoria AZ $70 億 2028 投產（降地緣風險、本波利多核心）；7/7 隨半導體回檔"),
    ("客戶", "NVDA",    "輝達",        "204.10", "-3.50%", "🏆 確認 TSMC #1 客戶 22%、A16 首發客戶 2026 下半/2027 量產；市值逾 $5 兆；Benzinga 指漲價長期反利多；7/7 隨 AI 股回檔"),
    ("客戶", "AAPL",    "蘋果",        "299.50", "-1.50%", "⚠️ #2 客戶 18%；面臨 TSMC 漲價成本；跳過 A16 直上 A14；7/7 相對抗跌"),
    ("客戶", "AVGO",    "博通",        "464.60", "-4.00%", "⚠️ #3 客戶（7/7 回檔；面臨漲價成本；custom XPU 中長線強勁）"),
    ("客戶", "AMD",     "超微",        "508.00", "-4.50%", "#4 客戶（7/7 回檔；面臨漲價成本；瞄準 $1,200 億資料中心市場、MI350/MI450）"),
    ("客戶", "2454.TW", "聯發科",      "4,835",  "+0.94%", "手機 SoC 客戶 9%；台股 7/7 隨大盤補漲；面臨漲價成本；RTX Spark 由聯發科協同 NVIDIA 設計"),
    ("競爭", "INTC",    "英特爾",      "51.00",  "-2.85%", "Apple 將與 Intel 合作在美設計製造晶片；18A-P 進入風險量產（效能 +9%）；與 UMC 結盟挑戰 TSMC；7/7 隨半導體回檔"),
    ("競爭", "005930.KS","三星電子",   "67,800 KRW", "+0.59%", "⚠️ 南韓 $1 兆美元晶片投資領頭者；傳 Google/AMD/Tesla 接觸先進製程；HBM4E 送樣"),
    ("產業", "SOX",     "費城半導體指數","—",    "-3.50%", "📉 7/7 回吐 7/6 反彈（估 -3.5%）、AI 晶片股全面回檔、7/16 財報前估值修正；Q2（截至 6/30）曾大漲 +87.8% 創 1994 年以來最強單季、YTD +47%"),
    ("處分後", "ARM",   "Arm Holdings","256.00", "-3.40%", "TSMC 4/29 全數出脫後（7/7 回檔；RTX Spark ARM 架構中長線受惠）"),
]

# 法人評級彙整
ANALYST_RATINGS = [
    ("Citi 花旗",      "買入",     "NT$3,800", "2026-07-06", "🚀 7/6 大幅上調目標價自 NT$2,875 至 NT$3,800（+32%、自 7/7 收 NT$2,490 具 +52.6% 空間）；為 7/16 法說會前最新升評、預期 TSMC 上修 2026 全年營收成長與長期展望、上調 2027-28 資本支出估至 $75-80B；看好 AI GPU/客製 ASIC/雲端 TPU/網通/光互連/CPU 全面需求"),
    ("Nomura 野村",    "買入",     "NT$3,425", "2026-07-01", "🚀 7/1 大幅上調目標價自 NT$2,820 至 NT$3,425（自 7/7 收 NT$2,490 具 +37.6% 空間）；指 AI 基礎設施投資循環尚未見頂、估 2027 資料中心新增產能達 ~32GW"),
    ("Barclays",       "增持",     "US$625",   "2026-07-02", "🚀 7/2 大幅上調目標價自 $470 至 $625（維持 Overweight、自 7/2 收 $434.16 具 +43.9% 空間）；AI 需求結構性 + A14/A16 領先、TSMC 為 AI CapEx 循環終極受惠者"),
...
CONSENSUS = {
    ...
    "low_target":   "NT$2,100",
    "avg_target_us":"US$492.00",    # 分析師 12 個月平均目標（高 $625 Barclays / 低 $351；自 7/6 收 $451.79 具 +8.9% 上行空間；Citi 上調台股目標至 NT$3,800、Barclays 維持 $625、Nomura NT$3,425；Goldman 7/1 移出 APAC Conviction List）
    "analyst_count": 32,
    "buy": 32, "hold": 0, "sell": 0,
    "upside":       "+8.90%",  # 從 NYSE 7/6 收 $451.79 至平均目標 $492.00（共識強力買入、Citi 上調拉高平均；待 7/16 法說會後重估）
}
...
IR_CALENDAR = [
    ...
    ("2026-07-07", "🚀 台股補漲兌現、Citi 上調目標至 NT$3,800", "7/7 Tue 台股 2330 官方收 NT$2,490（+30、+1.22% vs 7/6 NT$2,460、量估約 24,800 張、盤中高觸 NT$2,505）連二漲、補漲兌現、逼近 NT$2,535 史高——跟進 NYSE 7/6 +4.06% 大反彈 + 🚀 Citi（花旗）7/6 大幅上調 TSMC 台股目標價自 NT$2,875 至 NT$3,800（+32%、維持買入、預期 7/16 法說會上修 2026 全年營收成長與長期展望、上調 2027-28 資本支出估至 $75-80B）雙催化；NYSE TSM 7/6 收 $451.79 為最新確認 NYSE 收盤、7/7 盤待今晚；ADR 溢價約 +12.7%；7/7 估三大法人合計買超（外資估 +12,000 張）",  "#9E9E9E"),
    ("2026-07-08", "📉 NYSE 7/7 回吐 -4.25%、台股 7/8 恐承壓補跌", "7/8 Wed NYSE TSM 7/7 Tue 收 $432.57（-$19.22、-4.25% vs 7/6 $451.79、日內 $428.11–$439.80、stockanalysis.com 確認）為最新確認 NYSE 收盤——回吐 7/6 假期後 V 型反彈（+4.06%）大部分漲幅、費半半導體同步回檔、7/16 Q2 財報前估值修正 + 獲利了結、AI 晶片股全面回落，並非基本面惡化；台股 2330 最新確認收盤仍為 7/7 NT$2,490（+1.22%、連二漲），7/8 盤待今日、料跟進 NYSE 承壓補跌、關鍵在守穩 NT$2,460 / NT$2,445 / NT$2,410 支撐；📊 ADR 溢價自 7/6 +16.2% 收斂至約 +11.2%；🚀 分析師仍大幅續挺：Citi NT$3,800、Barclays $625、Nomura NT$3,425",  "#FFF9C4"),
...
# 總體經濟監控
MACRO = [
    ("SOX 半導體指數",  "16,050.00","-3.50%", False),  # 7/7 回吐 7/6 反彈、半導體回檔（估）
    ("台股加權指數",    "45,850.00","+0.30%", False),  # 7/7 台股小漲、跟進 7/6 反彈（估）
    ("VIX 恐慌指數",    "18.5",    "+1.2",   False),   # 7/7 小升（半導體回檔、財報前觀望）
    ("WTI 原油",        "$70.0",   "-0.30%", False),   # 油價持穩偏弱
    ("10Y 美債殖利率",  "4.50%",   "+0.02pp",False),   # 美債殖利率持穩
    ("台幣/美元",       "31.05",   "0.00",   False),   # 台幣持穩（每升值 1% 毛利率 -40bps）
    ("NVIDIA NVDA",     "$204.10", "-3.50%", False),   # #1 TSMC 客戶（22%），7/7 隨 AI 股回檔 -3.50%
    ("ASML",            "$864.00", "-3.50%", False),   # 設備股 7/7 回檔 -3.50%
]
...
RELATIVE = {
    "date":           "2026-07-07",       # 最新資料日（台股 2330 7/7 Tue 收盤 NT$2,490 為最新確認；NYSE TSM 7/7 收 $432.57 為最新確認 NYSE 收盤、7/8 盤待今日）
    "tsmc_tw_1d":     +1.22,   # 2330 7/7 官方收 NT$2,490（+30 vs 7/6 NT$2,460；補漲兌現、Citi 升評）
    "taiex_1d":       +0.90,   # 加權指數 7/7 收高（估）
    "sox_1d":         -3.50,   # SOX 7/7 回檔（半導體同步回吐 7/6 反彈、估）
    "tsmc_nyse_1d":   -4.25,   # TSM ADR 7/7 $432.57 (-$19.22 vs 7/6 $451.79；回吐 7/6 V 型反彈大部分漲幅)
    "tsmc_tw_5d":     +1.00,   # 5 日（NT$2,490 vs ~6/30 NT$2,465）
    "taiex_5d":       +1.20,
    "tsmc_tw_1m":     +8.00,   # 月線（NT$2,490 vs ~NT$2,305 ~6/8）
    "taiex_1m":       +8.0,
    "tsmc_tw_ytd":    +18.85,  # YTD 累計（NT$2,490 vs 年初 ~NT$2,095）
    "taiex_ytd":      +13.8,
    "sox_ytd":        +47.0,   # SOX YTD（費半 YTD +47%）
    "beta_60d":        1.38,   # 60 日滾動 Beta vs TAIEX
    # ADR 折溢價（以 7/6 NYSE 收盤 & 7/7 TW 收盤計算）
    "adr_price":     432.57,   # TSM NYSE 7/7 收盤（-4.25%、最新確認 NYSE 收盤、前收 7/6 $451.79、日內 $428.11–$439.80）
    "adr_parity":    400.97,   # 理論值 = 5 × NT$2,490 ÷ 31.05
    "adr_ratio":     "5:1",    # 1 ADR = 5 台積電普通股
    "usd_ntd":        31.05,   # 同 MACRO 台幣匯率
    "adr_premium_pct": "+7.88", # (432.57 - 400.97) / 400.97 × 100 = +7.88%（以 31.05 匯率計；敘述文以 ~32.0 匯率估約 +11.2%）
    "note": "ADR 理論值 = 5 × 台股收盤 ÷ 匯率（不含交易摩擦與流動性溢價）。📉 NYSE TSM 7/7 Tue 收 $432.57（-$19.22、-4.25%、前收 7/6 $451.79、日內 $428.11–$439.80、stockanalysis.com 確認），回吐 7/6 假期後 V 型反彈（+4.06%、$451.79）大部分漲幅、費半半導體同步回檔、AI 晶片股全面回落——為 7/16 Q2 財報前估值修正 + 獲利了結、並非基本面惡化；NYSE 7/8 Wed 盤待今日 GMT+8。台股 2330 7/7 Tue 官方收 NT$2,490（+30、+1.22% vs 7/6 NT$2,460、量估約 24,800 張、市值 NT$64.6 兆）連二漲、補漲兌現——跟進 NYSE 反彈 + Citi 升評雙催化、盤中高觸 NT$2,505。⚠️ 籌碼面：7/7 估外資買超 +12,000 張（補漲回補）、投信 +1,500、自營 +600（待官方確認）。📊 台美 ADR 溢價約 +7.9%（31.05 匯率、~32.0 匯率估約 +11.2%、NYSE 回檔後收斂）；🎯 今日（7/8）關鍵：台股 7/8 能否守穩 NT$2,460 / NT$2,445 / NT$2,410 支撐、消化 NYSE 7/7 -4.25% 補跌壓力、NYSE 7/8 盤能否止穩；⚠️ TSMC 4-5 月營收 +24% YoY 落後 ~35% 預期、6 月營收（7 月上旬）為關鍵 catalyst；🚀 重大利多：Citi 7/6 上調台股目標至 NT$3,800（+32%）、Barclays $625、Nomura NT$3,425；⭐ 中長線結構性基底未變：TSMC-Amkor 美國封裝長約 + NVIDIA 確認第 1 大客戶/A16 首發 + Vera Rubin 6 顆晶片全 TSMC 代工 + 2nm 量產 70-80% 良率 + CoWoS 擴產 + 4 大 CSP CapEx $725B",
}
...
NEWS = [
    {
        ...
        "title": "🚀 Citi（花旗）大幅上調 TSMC 台股目標價至 NT$3,800（自 NT$2,875、+32%）、維持買入——7/16 法說會前最新升評、料上修 2026 營收成長與 2027-28 資本支出",
        "body": "花旗（Citi）於 7/6 大幅上調 TSMC 台股（2330）目標價自 NT$2,875 至 NT$3,800（+32%）、重申「買入」評等，自 7/7 收 NT$2,490 仍隱含約 +52.6% 上行空間，為 7/16 Q2 法說會前市場最新升評：（1）📈 花旗預期 TSMC 將於 7/16 上修 2026 全年營收成長預測與長期成長目標，反映 AI 相關需求能見度增強；（2）🔧 花旗上調 TSMC 2027-2028 資本支出估至 $75-80B，反映 TSMC 將持續加碼先進製程與次世代封裝以因應激增的 AI 需求；（3）🎯 花旗看好 TSMC 先進晶片需求橫跨 AI GPU、客製 AI 晶片、雲端 TPU、網通晶片、光互連與 CPU 等廣泛 AI 應用；（4）🚀 此升評帶動台股 2330 7/7 補漲 +1.22% 收 NT$2,490、盤中高觸 NT$2,505 逼近 NT$2,535 史高；TSM 年初至今累計上漲逾 +54%、逼近歷史新高。",
        "source": "Citi / TipRanks / Investing.com / Yahoo Finance / Blockonomi / Invezz 2026-07-06", "impact": "正面",
    },
    {
        "tag": "警示", "tag_color": "#F44336",
        "title": "📉 NYSE 回吐反彈：TSM 7/7 收 $432.57（-4.25%）回吐 7/6 V 型反彈大部分漲幅、費半半導體同步回檔；7/16 財報前估值修正 + 獲利了結、台股 7/8 恐承壓補跌",
        "body": "半導體 7/6 V 型反彈後 7/7 回吐、財報前估值修正：（1）📉 NYSE TSM 7/7 Tue 收 $432.57（-$19.22、-4.25%、前收 7/6 $451.79、日內 $428.11–$439.80、stockanalysis.com 確認）回吐 7/6 假期後 V 型反彈（+4.06%、$451.79）大部分漲幅；費半（SOX）估同步回檔約 -3.5%、NVDA -3.5%、AVGO -4.0%、AMD -4.5%、MU -4.0% 全面回落，屬 7/16 Q2 財報前估值修正 + 獲利了結（費半 YTD +47% 後高位震盪），並非基本面惡化；（2）⚖️ 台股 2330 最新確認收盤仍為 7/7 Tue 官方收 NT$2,490（+30、+1.22% vs 7/6 NT$2,460、量估約 24,800 張、盤中高觸 NT$2,505）連二漲；7/8 Wed 盤待今日、料跟進 NYSE 7/7 -4.25% 承壓補跌、關鍵在守穩 NT$2,460 / NT$2,445 / NT$2,410 支撐；（3）📊 台美 ADR 溢價收斂至約 +11.2%（以 7/7 ADR $432.57 折合台股約 NT$2,768、匯率 ~32.0 計 vs 台股 7/7 NT$2,490，自 7/6 +16.2% 收斂）；（4）🗓️ NYSE TSM 7/7 $432.57 為最新確認 NYSE 收盤、NYSE 7/8 盤待今日 GMT+8；🚀 分析師仍大幅續挺（Citi NT$3,800、Barclays $625、Nomura NT$3,425），結構性多頭基底未變。",
        "source": "stockanalysis.com / CNBC / Yahoo Finance / Yahoo 奇摩股市 / wantgoo / histock 2026-07-07 - 07-08", "impact": "負面",
    },
    {
        "tag": "產業趨勢", "tag_color": "#4CAF50",
        "title": "🚀 分析師大幅續挺：Citi NT$3,800（+32%）、Barclays 維持 $625（自 $451.79 具 +38.3% 空間）、Nomura NT$3,425；惟 Goldman 7/1 移出 APAC Conviction List",
        "body": "分析師逆勢大幅看多、主流強力買入：（1）🚀 Citi（花旗）7/6 大幅上調 TSMC 台股目標價自 NT$2,875 至 NT$3,800（+32%、維持買入），自 7/7 收 NT$2,490 具約 +52.6% 空間，為 7/16 法說會前最新升評、料上修 2026 全年營收成長與 2027-28 資本支出（$75-80B）；（2）🚀 Barclays 維持 TSMC 目標價 $625（Overweight，7/2 自 $470 大幅上調），自 7/6 收 $451.79 仍隱含約 +38.3% 上行空間，強調 TSMC 為 AI 資本支出循環的終極受惠者、A14/A16 製程領先；（3）📈 Nomura（野村）上調台股目標至 NT$3,425（自 NT$2,820、+21.5%），自 7/7 收 NT$2,490 隱含約 +37.6% 空間，指 AI 基礎設施投資循環尚未見頂、預期資料中心新增產能 2027 年升至約 32GW；（4）📊 分析師 12 個月平均目標約 $492（強力買入、32 位分析師 0 賣出、自 $451.79 具 +8.9% 空間）；（5）⚠️ 惟 Goldman Sachs 7/1 將 TSM 移出「APAC Conviction List」，屬對近期上檔空間的戰術性調整、並非降評。",
        "source": "Citi / Barclays / Nomura / TipRanks / TradingKey / Morningstar / 鉅亨網 2026-07-01 - 07-06", "impact": "正面",
    },
    {
        "tag": "客戶動態", "tag_color": "#2196F3",
        "title": "🤝 NVIDIA 與 SK 海力士宣布多年期記憶體技術合作（AI 工廠次世代記憶體）；NVIDIA-TSMC 將 AI 導入晶圓廠製造；Vera Rubin 6 顆晶片全數 TSMC 代工",
        "body": "AI 生態合作深化、客戶關係鞏固：（1）🤝 NVIDIA 與 SK 海力士宣布多年期技術合作、共同推進全球 AI 工廠布建所需的次世代記憶體（HBM），加速半導體設計與製造——強化 AI 記憶體供應鏈；（2）🤝 NVIDIA 與 TSMC 將 NVIDIA 加速運算與 AI 導入晶圓廠設計與製造全生命週期，改善先進廠週期時間、能效與良率——AI 反哺 TSMC 製造效率；（3）🏆 NVIDIA 下一代 Vera Rubin AI 平台採 6 顆並行晶片全數由 TSMC 代工、建構於 3nm 製程搭配 HBM4，較 Blackwell 訓練快 3.5×、推論快 5×；NVIDIA 已包下 TSMC 多數 CoWoS 產能、確認為 TSMC 第 1 大客戶（22%/$33B）、傳為 A16 首發客戶；（4）⚠️ 競爭面——AMD 將推出首款 2nm AI 晶片、促使 NVIDIA 加速評估 A16（背面供電 BSPD）。",
        "source": "NVIDIA Newsroom / CNBC / TweakTown / DigiTimes 2026-07-01 - 07-06", "impact": "正面",
    },
    {
        "tag": "產業趨勢", "tag_color": "#4CAF50",
        "title": "📈 AI 超級循環續發酵：BofA 上修 2026 全球半導體市場至 $1.3 兆、生成式 AI 晶片估貢獻 ~$500B；費半（SOX）YTD +47%；Qualcomm 推無 HBM 資料中心晶片挑戰 NVIDIA",
        "body": "產業總量再上修、印證 AI 結構性多頭：（1）📈 美銀（BofA）將 2026 全球半導體市場規模自 $1.0 兆上修至 $1.3 兆、估 2030 上看 $2 兆；另有預估 2026 全球晶片銷售達 $975B、其中生成式 AI 晶片貢獻約 $500B（約全球半數）；（2）🚀 費城半導體指數（SOX）年初至今大漲逾 +47%、AI 晶片股年內合計增添約 $2 兆市值、7/6 假期後 +3.92% 回神；（3）🆕 Qualcomm 揭示新款資料中心 AI 晶片、主打不需高頻寬記憶體（HBM）架構、瞄準 2029 年 $150 億營收挑戰 NVIDIA——加劇 AI 加速器競爭、惟多數仍委由 TSMC 代工；（4）🏆 TSMC 作為 NVIDIA、AMD、Qualcomm 主要代工與先進封裝供應商，被視為此結構性擴張最大受惠者；NVIDIA Blackwell 已售罄至 2026 年中、Rubin 架構提前約兩季；（5）⚠️ 惟 6/30-7/2 半導體曾出現獲利了結拋售、7/6 已 V 型反彈收復，市場關注 7/16 Q2 財報與 6 月營收（7 月上旬）能否驗證高成長預期。",
        "source": "BofA / intellectia.ai / Qualcomm / aimultiple 2026-07", "impact": "正面",
    },
    {
        "tag": "產品發布", "tag_color": "#9C27B0",
        "title": "⭐ TSMC 漲價續發酵：擴及 7nm 以下全先進製程、佔晶圓營收 ~75%、幅度 5-10%；Nvidia/AMD/Apple/Qualcomm/Broadcom/MediaTek 面臨更高晶圓成本",
        "body": "漲價題材結構性利多持續發酵、印證 TSMC 在 AI 需求下的議價力：（1）⭐ TSMC 對「所有 7nm 及以下先進製程」（合計約佔晶圓營收 75%）調漲 5-10%、視客戶/節點/產品而定，並可能延伸至 5nm/7nm 等較舊但仍先進的節點，要求客戶將更高成本計入未來訂單；（2）💰 以平均 5% 估算，可貢獻全年毛利率 +2pp 以上；TSMC 已將 2026 美元營收成長目標上修至 30% 以上；（3）⚠️ 漲價雙面刃——主要客戶（Nvidia/AMD/Apple/Qualcomm/Broadcom/MediaTek）晶圓成本升；Benzinga 指 NVIDIA 因 AI 需求剛性與轉嫁能力強、長期反為利多，惟毛利較薄之消費性客戶影響較大；（4）💰 2nm/A16 產能 2026-28 估 CAGR ~70%。",
        "source": "Tom's Hardware / Yahoo Finance / Benzinga 2026-06-30 - 07-02", "impact": "正面",
    },
    {
        "tag": "警示", "tag_color": "#F44336",
        "title": "⚠️ 近期營收疑慮續存：4-5 月營收 +24% YoY 落後 ~35% 預期、下游手機/PC 需求疲弱、CapEx $52-56B 壓縮毛利；6 月營收（7 月上旬）+ 7/16 財報為關鍵",
        "body": "短線基本面雜訊須留意、亦為 6/30-7/1 ADR 拉回主因之一：（1）⚠️ 營收動能——TSMC 4-5 月合併營收年增合計約 +24% YoY，低於華爾街對 Q2 約 +35% 的偏高預期；（2）⚠️ 下游疲弱＋毛利壓力——智慧型手機、PC 等消費性終端需求持續疲軟；2026 資本支出高達 $52-56B 以擴充 sub-3nm 製程，短期引入毛利率壓縮風險、若需求走軟恐固定成本稼動不足；（3）✅ 緩解觀點——6 月合併營收（7 月上旬公布）為關鍵 catalyst，分析師指即使僅小幅月增亦可能使 Q2 營收逼近公司指引（$39.0-40.2B）中值；5 月營收 NT$4,169.75 億（+30.1% YoY）創單月新高、1-5 月累計 NT$1.96 兆；（4）🎯 7 月上旬 6 月營收 + 7/16 Q2 法說會為短線方向關鍵。",
        "source": "TradingKey / Yahoo Finance / Barchart / Seeking Alpha 2026-07-01 - 07-02", "impact": "負面",
    },
]
