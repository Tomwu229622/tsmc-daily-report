...
STOCK = {
    # 台股 2330
    "tw_price":       "2,220",        # 2026-05-18 Mon 估收（-45，-1.99% vs 5/15 NT$2,265；跟進 ADR 5/15 -3.20% 回檔 + NVDA 5/20 財報倒數雙重壓力跳空走低）
    "tw_change":      "-45",           # 漲跌點數（vs 5/15 NT$2,265）
    "tw_change_pct":  "-1.99%",       # 漲跌幅
    "tw_volume":      "53,000",       # 成交量（張，5/18 量增反映賣壓；早盤 9:17 已成 6,460 張）
    "tw_open":        "2,225",        # 5/18 跳空開低
    "tw_high":        "2,245",        # 5/18 盤中高
    "tw_low":         "2,210",        # 5/18 盤中低
    "market_cap":     "NT$57.6 兆",   # 5/18 估市值
    "pe_ratio":       "~32.7x",       # 台股 P/E（TTM，NT$2,220 基礎）
    "pb_ratio":       "~11.5x",       # 台股 P/B（股淨比，NT$2,220 基礎）
    "div_yield":      "~0.68%",       # 殖利率（NT$2,220 基礎）
    "52w_high_tw":    "2,345",        # 52 週高（2026-05-07 盤中新高）
    "52w_low_tw":     "780",          # 52 週低（2025-04-07）
    # NYSE TSM ADR
    "nyse_price":     "404.35",       # 5/15 Fri 最新收盤（-13.37，-3.20% vs 5/14 $417.72；獲利了結 + Cathie Wood ARK 賣超 $40.6M + 地緣政治升溫）
    ...
    # 資料日期備註
    "data_note":      "今日（2026-05-18 Mon）報告基準資料：台股 2330 5/18 跟進 NYSE TSM 5/15 -3.20% 回檔訊號跳空走低、9:17 早盤即跌 -1.99% 觸 NT$2,220（-45 vs 5/15 NT$2,265）、盤中區間 NT$2,210-2,245、估收 NT$2,220（-45，-1.99%）；成交量估擴大至 53,000 張屬量增下跌反映賣壓；市值估降至 NT$57.6 兆（自 5/15 NT$58.8 兆）；NYSE TSM 最新收盤（5/15 Fri）$404.35（-13.37，-3.20% vs 5/14 $417.72）主因（1）連續飆漲後獲利了結；（2）Cathie Wood ARK 賣超 $40.6M TSM 加重情緒；（3）兩岸地緣政治升溫、媒體 5/17 報導台海封鎖風險再起、TSMC 與大客戶面臨潛在挑戰；距 5/7 盤中史高 $420.00 剩 -3.7%；台美 ADR 溢價估擴大至 +13.3%（5/18 台股 NT$2,220、台幣 31.10、理論值 5×2,220÷31.10 = $356.91，溢價 (404.35-356.91)/356.91 = +13.3%）  |  🚨 NVDA Q1 FY27 財報 5/20（Wed）距今僅 2 天為最重要 AI 算力指標、市場預期 Q1 營收 $78.5B（+78% YoY）、guidance $78.0B ±2%、毛利率 ~75%；TSMC 為 NVDA 最大客戶 NVDA Blackwell/Rubin 全包  |  🎯 結構性催化續存：TSMC 5/14 新竹 Technology Symposium 上修 2030 全球半導體市場預估至 $1.5 兆美元（自原 $1 兆，+50%）、AI/HPC 將占 55%、手機 20%、車用 10%；2026 年規劃 18 座晶圓廠與先進封裝設施新建；2nm/A16 製程 2026-2028 產能 CAGR +70%；CoWoS 良率突破 98% 北美擴產加速；AI 加速器晶圓需求 2022-2026 成長 11 倍；Arizona 2026 產出將是去年的 1.8 倍且良率追平台灣  |  ⭐ 利多續存：（1）NVIDIA 確認 TSMC 最大客戶（22% / $33B vs Apple 17% / $27B、$95B 採購承諾）；（2）AMAT EPIC Center $5B AI 晶片 R&D 合作；（3）Arizona 追加 $20B 資本注入；（4）台灣對美半導體投資將達 $200B+  |  ⚠️ 短線雜訊：（1）Cathie Wood ARK 5/15 賣超 $40.6M TSM 加重情緒；（2）兩岸地緣政治升溫、媒體 5/17 報導台海封鎖風險再起；（3）NVDA 5/20 財報前夕避險情緒升溫、SOX 5/15 -3.95% 收 11,053；（4）AMD/NVDA/AVGO 5/15 全面回檔 -4% 左右  |  5/18 估三大法人合計大幅賣超 -19,500 張（外資 -16,500、投信 -2,000、自營 -1,000）外資轉賣  |  Barclays $470 對應 NT$2,450（剩 +10.4%）、共識目標 NT$2,320（剩 +4.5%）|  催化：NVDA 5/20 Q1 FY27 財報距今 2 天為最重要 AI 算力指標；TSMC 5 月月營收預計 6/10 前公布；本週關注 NT$2,200 心理整數 + 60MA 守關、若失守將測試 NT$2,150 第一支撐",
}
...
SUMMARY = {
    ...
    "sentiment":  "中性偏空",
    # 一句話標題
    "headline":   "📉 台股 2330 5/18 跳空走低估收 NT$2,220（-1.99%）跟進 ADR 5/15 -3.20% $404.35；NVDA 5/20 財報倒數 2 天 + 地緣政治升溫雙重壓力",
    # 3–5 條白話重點（不用術語，每條約 30 字內）
    "bullets": [
        "📉 台股 2330 5/18 跳空走低估收 NT$2,220（-45，-1.99% vs 5/15 NT$2,265），跌破 5MA",
        "🇺🇸 NYSE TSM 5/15 回檔 -3.20% 收 $404.35（-$13.37）獲利了結、Cathie Wood 賣超 $40.6M",
        "🚨 NVDA Q1 FY27 財報 5/20（Wed）距今僅 2 天為最重要 AI 算力指標，市場避險情緒升溫",
        "⚠️ 兩岸地緣政治升溫、5/17 媒體報導台海封鎖風險再起、TSMC 與大客戶面臨挑戰",
        "🎯 結構性催化續存：TSMC 上修 2030 全球晶片市場至 $1.5T、CoWoS 良率破 98%",
        "🏦 5/18 估三大法人合計大幅賣超 -19,500 張（外資 -16,500、投信 -2,000、自營 -1,000）",
        "🛡️ 短線支撐 NT$2,200 心理整數 + 60MA / NT$2,150 第一支撐，反彈關卡 NT$2,265 5/15 收盤",
    ],
    # 一句結論
    "bottom_line": "今日（2026-05-18 Mon）報告摘要：台股 2330 5/18 跟進 NYSE TSM 5/15 -3.20% 回檔訊號跳空走低，9:17 早盤即跌 -1.99% 觸 NT$2,220（-45 vs 5/15 NT$2,265），盤中區間 NT$2,210-2,245、跌破 5MA NT$2,250 與前壓轉支撐 NT$2,235，成交量估擴大至 53,000 張屬量增下跌反映賣壓，市值估降至 NT$57.6 兆。NYSE TSM 5/15 Fri 回檔 -$13.37（-3.20%）收 $404.35，主因（1）連續飆漲後獲利了結；（2）Cathie Wood ARK 賣超 $40.6M TSM 加重情緒；（3）兩岸地緣政治升溫、媒體 5/17 報導台海封鎖風險再起；距 5/7 盤中 52 週高 $420.00 剩 -3.7%。台美 ADR 溢價估擴大至 +13.3%（理論值 = 5 × 2,220 ÷ 31.10 = $356.91，溢價 = ($404.35-$356.91)/$356.91 = +13.3%）反映台股加速回檔。🚨 NVDA Q1 FY27 財報 5/20（Wed）距今僅 2 天為最重要 AI 算力指標：市場預期 Q1 營收 $78.5B（+78% YoY）、guidance $78.0B ±2%、毛利率 ~75%；TSMC 為 NVDA 最大客戶 NVDA Blackwell/Rubin 全包，財報前夕避險情緒升溫。🎯 結構性催化續存：TSMC 在新竹（Hsinchu）2026 Technology Symposium 上修 2030 全球半導體市場預估至 $1.5 兆美元（自原 $1 兆、+50%）、AI 與 HPC 應用將占 55%、智慧型手機 20%、車用 10%；2026 年規劃新建 18 座晶圓廠與先進封裝設施；2nm 與 A16 製程 2026-2028 年產能 CAGR +70%、CoWoS 良率突破 98%（Digitimes 5/15 確認）、北美 CoWoS 擴產加速、AI 加速器晶圓需求 2022-2026 成長 11 倍。⭐ 利多續存：（1）NVIDIA 為 TSMC 最大客戶（22% / $33B vs Apple 17% / $27B、$95B 採購承諾）；（2）AMAT EPIC Center $5B AI 晶片 R&D 合作；（3）Arizona 追加 $20B 資本注入；（4）台灣對美半導體投資總額將達 $200B+。⚠️ 短線雜訊：（1）Cathie Wood ARK 5/15 賣超 $40.6M TSM 加重情緒；（2）兩岸地緣政治升溫、媒體 5/17 報導台海封鎖風險再起；（3）NVDA 5/20 財報前夕避險情緒升溫；（4）SOX 5/15 -3.95%、AMD/NVDA/AVGO 全面 -4% 回檔；（5）估值 P/E 32.7x 在 5 年 86 百分位高位。籌碼面：5/18 估三大法人合計大幅賣超約 -19,500 張——外資 -16,500 張、投信 -2,000 張、自營 -1,000 張，外資持股估降至 74.8%，短線籌碼明顯鬆動。基本面：Q1 2026 淨利 NT$572.5B（$18.2B，+58.3% YoY）、毛利率 66.2% 雙創史高；2026 全年 >30% 成長指引維持；CapEx $52-56B 高端確認；A14/A16 製程路線完整、NVIDIA 為 A16 首發客戶。即將事件：（1）NVDA Q1 FY27 財報 5/20（距今 2 天，最重要 AI 算力指標）；（2）TSMC 5 月月營收預計 6/10 前公布；（3）Q2 法說會 7 月第三週。技術面：5/18 估收 NT$2,220 跌破 5MA NT$2,250 與前壓轉支撐 NT$2,235，但守住 NT$2,200 心理整數；距共識目標 NT$2,320 剩 +4.5%、距 Barclays $470 對應 NT$2,450 剩 +10.4% 上行空間；RSI 估自 60.5 跌破中軸至 45.5、MACD +0.5 紅柱大幅收斂逼近翻黑、KDJ K(58)/D(62)/J(50) 死叉訊號浮現；下方支撐 NT$2,200 心理整數 + 60MA / NT$2,150 第一支撐 / NT$2,100。31 位分析師全數看多，0 賣出。",
    # 重大警示（選填，空白則不顯示）
    "risk_alert":  "今日（5/18 Mon）關鍵觀察：（1）⚠️ 台股 5/18 跳空下跌 -1.99% 跌破 5MA、本週關注 NT$2,200 心理整數 + 60MA 守關；（2）🚨 NVDA 5/20（Wed）Q1 FY27 財報距今僅 2 天為最重要 AI 算力指標、市場避險情緒升溫；（3）若跌破 NT$2,200 心理整數將測試 NT$2,150 第一支撐 / NT$2,100；（4）反彈關卡 NT$2,265 5/15 收盤 / NT$2,290 前壓 / NT$2,320 共識目標（剩 +4.5%）/ Barclays $470 對應 NT$2,450（剩 +10.4%）；（5）外資 5/18 估大幅賣超 -16,500 張、需關注是否續擴大；（6）Cathie Wood ARK 5/15 賣超 $40.6M TSM 為短線情緒拖累；（7）兩岸地緣政治升溫、媒體 5/17 報導台海封鎖風險再起、TSMC 與大客戶面臨挑戰；（8）短線估值 P/E 32.7x 在 5 年 86 百分位高位、需財報持續驗證；（9）台幣 31.10 升值壓力結構性續存；（10）CoWoS/ABF 基板瓶頸 + 美中 AI 晶片出口管制持續；（11）SOX 5/15 -3.95% 收 11,053、AMD/NVDA/AVGO 全面 -4% 回檔；（12）市值估降至 NT$57.6 兆，距前史高 NT$60.81 兆剩約 -5.3%；（13）🎯 結構性催化續存：TSMC 上修 2030 全球晶片市場至 $1.5T + CoWoS 良率破 98% 為長線多頭基底、回檔不改長線結構",
}

# 三大法人買賣超（張）— 最新一日
INSTITUTIONAL = {
    "date":     "2026-05-18",
    "foreign":  -16500,   # 外資（5/18 估算，跟進 ADR 回檔大幅賣超）
    "trust":    -2000,    # 投信（5/18 估算，連 2 賣超）
    "dealer":   -1000,    # 自營商（5/18 估算，避險賣超）
    # 近5日（由舊到新：5/12, 5/13, 5/14, 5/15, 5/18）
    "foreign_5d": [+5200, -12800, +5800, +16800, -16500],    # 5/18：大幅賣超 -16,500
    "trust_5d":   [+1200, -2000, +500, +1200, -2000],        # 5/18：轉賣超 -2,000
    "dealer_5d":  [+300, -700, +200, +500, -1000],            # 5/18：避險賣超 -1,000
    "foreign_ownership_pct": "74.8%",  # 外資持股比例（5/18 大幅下降）
    "foreign_ownership_shares": "約 194.0 億股",
}

# 技術分析指標（需每日從看盤軟體更新）
TECHNICAL = {
    "rsi_14":       45.5,   "rsi_signal": "RSI 估 45.5（5/18 -1.99% 跳空走低後自 60.5 跌破中軸至 45.5、進入弱勢區），多頭動能轉弱、需觀察是否守住 40 弱平衡",
    "macd":         +0.5,   "macd_signal": "MACD 估 +0.5 紅柱大幅收斂（自 +1.7 急降）、逼近翻黑、動能明顯轉弱",   "macd_color": "#FF9800",
    "kdj_k":        58.0,   "kdj_d": 62.0, "kdj_j": 50.0, "kdj_signal": "KDJ K(58)/D(62)/J(50)，K 跌破 D 死叉訊號浮現、J 自 88 高位重摔至 50、短期技術轉空",
    "ma5":       "2,248",   # 5MA 下彎（含 5/18 數據）
    "ma20":      "2,225",   # 20MA 趨平
    "ma60":      "2,150",   # 60MA 緩升
    "ma120":     "2,020",
    "bb_upper":  "2,390",   # 布林上軌
    ...
    "bb_lower":  "2,060",   # 布林下軌
    "vol_ma5":  "48,400",   # 5日均量（張，含 5/18 量增）
    "trend":    "台股 2330 5/18 Mon 跟進 NYSE TSM 5/15 -3.20% 回檔訊號跳空走低，9:17 早盤即跌 -1.99% 觸 NT$2,220（-45 vs 5/15 NT$2,265），盤中區間 NT$2,210-2,245 跌破 5MA NT$2,250 與前壓轉支撐 NT$2,235、成交量估擴大至 53,000 張屬量增下跌反映賣壓、市值估降至 NT$57.6 兆。NYSE TSM 最新收盤（5/15 Fri）$404.35（-13.37，-3.20% vs 5/14 $417.72）獲利了結為主、Cathie Wood ARK 賣超 $40.6M 加重短線賣壓、距 5/7 盤中史高 $420.00 剩 -3.7%、台美 ADR 溢價估擴大至 +13.3%。技術面：RSI 自 60.5 跌破中軸至 45.5 進入弱勢區、MACD +0.5 紅柱大幅收斂逼近翻黑、KDJ K(58)/D(62)/J(50) 死叉訊號浮現、5MA NT$2,250 失守、跌破前壓轉支撐 NT$2,235、需觀察 NT$2,200 心理整數 + 60MA NT$2,150 守關；中期多頭結構（60MA 2,150 / 120MA 2,020）仍完好但短線轉弱。下一觀察：（1）NVDA 5/20 Q1 FY27 財報距今僅 2 天為最重要 AI 算力指標、若超預期或將反彈、若不達標恐擴大跌幅；（2）本週關注 NT$2,200 心理整數 + 60MA 守關、若失守將測試 NT$2,150 第一支撐 / NT$2,100；（3）反彈關卡 NT$2,265 5/15 收盤 / NT$2,290 前壓 / NT$2,320 共識目標（剩 +4.5%）；（4）攻擊目標 NT$2,345 史高 / NT$2,450 Barclays 對應價（剩 +10.4%）；（5）🎯 5/14 TSMC 上修 2030 全球晶片市場至 $1.5T、AI/HPC 占 55%、18 座新廠規劃、2nm/A16 CAGR +70% 為結構性多頭催化、回檔不改長線結構。",
    "support":  "2,200 / 2,150 / 2,100 (心理整數+60MA、第一支撐、第二支撐)",
    "resist":   "2,265 / 2,290 / 2,320 / 2,450",
    "note": "技術指標數值為估算，請以看盤軟體即時數據為準；5/18 跳空下跌後 RSI 45.5 進入弱勢區、5MA 失守、ADR 溢價擴大、短線技術轉空",
}

# 期貨與選擇權（來源：台灣期交所 TAIFEX）
DERIVATIVES = {
    "date":          "2026-05-18",
    "futures_price": "2,210",      # 台積電期貨近月（估，5/18 逆價差擴大）
    "futures_oi":    "132,500",    # 未平倉量（口）（估，5/18 增加反映避險需求）
    "futures_basis": "-10",        # 逆價差 -10 點（避險需求大幅上升）
    "call_oi":       "78,500",
    "put_oi":        "62,200",
    "pcr":           "0.79",       # Put/Call 比率自 0.68 升至 0.79（避險需求明顯上升）
    "pcr_signal":    "中性偏空（Put/Call 0.79 升破 0.70 中軸、逼近 0.80 避險區，NVDA 5/20 財報前夕避險情緒升溫）",
    "max_pain":      "2,200",      # 最大痛苦價格（近期到期，5/18 下調）
    "key_strikes": [
        ("2,100", "Call 22,500 / Put 11,800", "第二支撐"),
        ("2,150", "Call 27,800 / Put 10,200", "第一支撐"),
        ("2,180", "Call 30,200 / Put 9,500",  "前 20MA 支撐"),
        ("2,200", "Call 32,500 / Put 9,000",  "心理整數+60MA"),
        ("2,220", "Call 36,200 / Put 7,800",  "5/18 估收盤"),
        ("2,235", "Call 35,200 / Put 7,000",  "前壓轉支撐"),
        ("2,265", "Call 38,200 / Put 5,800",  "5/15 收盤"),
    ...
    "note": "衍生品數據需每日至台灣期交所(taifex.com.tw)更新；5/18 跳空下跌後逆價差擴大至 -10、Put/Call 升至 0.79 避險需求明顯上升、NVDA 5/20 財報前夕情緒謹慎",
}

# 供應鏈與客戶股價（需每日更新）
ECOSYSTEM_STOCKS = [
    # 類別、股票代碼、名稱、收盤價、漲跌幅、備註（2026-05-15 美股收盤 + 台股 5/18 估收盤）
    ...
    ("封裝", "3711.TW", "日月光",      "270",    "-2.17%", "CoWoS 封裝（5/18 跟進回檔；2nm/CoWoS 訂單續強）"),
    ("客戶", "NVDA",    "輝達",        "225.32", "-4.00%", "🚨 #1 客戶 22%（5/15 -4% 獲利了結；5/20 Q1 FY27 財報距 2 天）"),
    ("客戶", "AAPL",    "蘋果",        "279.20", "-0.82%", "⚠️ #2 客戶 17%（5/15 微跌；Apple 將跳過 A16 直上 A14 製程）"),
    ("客戶", "AVGO",    "博通",        "428.50", "-3.88%", "#3 客戶 13%（5/15 回檔；Custom XPU 訂單續強）"),
    ("客戶", "AMD",     "超微",        "432.00", "-4.00%", "#4 客戶 8%（5/15 -4% 回檔；YTD +110% 後獲利了結；Zen 6 EPYC Venice 採 N2）"),
    ("客戶", "2454.TW", "聯發科",      "2,420",  "-1.43%", "手機 SoC 客戶 9%；5/18 跟進回檔"),
    ("競爭", "INTC",    "英特爾",      "23.30",  "-7.00%", "⚠️ Intel 5/15 重挫 -7%（Intel Foundry 18A 良率與時程仍有疑問）"),
...
CONSENSUS = {
    "rating":       "強烈買入",
    "avg_target_tw":"NT$2,320",  # 共識（Barclays 升評後）— 5/18 NT$2,220 距共識剩 +4.5%
    "high_target":  "NT$2,770",
    "low_target":   "NT$1,740",
    "avg_target_us":"US$525",    # 分析師上調目標（Barclays $470 上拉均值）
    "analyst_count": 31,
    "buy": 31, "hold": 0, "sell": 0,
    "upside":       "+4.5%",    # 從 NT$2,220（5/18 估收盤）到 NT$2,320
}
...
IR_CALENDAR = [
    ...
    ("2026-05-18", "📉 今日：跳空走低估收 NT$2,220（-1.99%）、ADR 5/15 -3.20% 跟進回檔 + NVDA 5/20 財報倒數","今日（5/18 Mon）台股 2330 跟進 NYSE TSM 5/15 -3.20% 回檔訊號跳空走低、9:17 早盤即跌 -1.99% 觸 NT$2,220（-45 vs 5/15 NT$2,265）、盤中區間 NT$2,210-2,245、估收 NT$2,220（-45，-1.99%）、量增至 53,000 張屬量增下跌反映賣壓、跌破 5MA NT$2,250 與前壓轉支撐 NT$2,235、市值估降至 NT$57.6 兆；NYSE TSM 5/15 Fri 回檔 -3.20% 收 $404.35（-$13.37）主因（1）連續飆漲後獲利了結；（2）Cathie Wood ARK 賣超 $40.6M TSM 加重情緒；（3）兩岸地緣政治升溫、媒體 5/17 報導台海封鎖風險再起；ADR 溢價自 +11.1% 擴大至 +13.3%；5/18 估三大法人合計大幅賣超 -19,500 張（外資 -16,500、投信 -2,000、自營 -1,000）外資轉賣；技術面 RSI 估自 60.5 跌破中軸至 45.5 進入弱勢區、MACD +0.5 紅柱大幅收斂逼近翻黑、KDJ K(58)/D(62)/J(50) 死叉訊號浮現；🚨 NVDA 5/20（Wed）Q1 FY27 財報距今 2 天為最重要 AI 算力指標；🎯 結構性催化續存：TSMC 上修 2030 全球晶片市場至 $1.5T、CoWoS 良率破 98%、18 座新廠規劃；本週關注 NT$2,200 心理整數 + 60MA 守關、若失守將測試 NT$2,150 第一支撐","#FFCDD2"),
    ("2026-05-20", "🚨 NVIDIA Q1 FY27 財報（Wed 距 2 天）","NVIDIA 5/20（Wed）公布 Q1 FY27 財報（距今僅 2 天）；市場預期 Q1 營收 $78.5B（+78% YoY）、guidance $78.0B ±2%、毛利率 ~75%、EPS $1.77；Blackwell/Rubin 出貨進度與 H2 指引為 TSMC #1 客戶（22%）風向標、最重要 AI 算力指標","#F44336"),
...
MACRO = [
    ...
    ("台股加權指數",    "40,560.00","-1.50%", False),  # 5/18 加權指數估跟進回檔
    ("VIX 恐慌指數",    "20.5",    "+4.5",   False),   # 恐慌指數明顯上升、地緣政治升溫+NVDA財報前夕
    ("WTI 原油",        "$67.2",   "+1.36%", False),   # 油價續反彈
    ("10Y 美債殖利率",  "4.12%",   "+0.02pp",False),   # 殖利率微升
    ("台幣/美元",       "31.10",   "0.00",   False),   # 台幣持平（每升值 1% 毛利率 -40bps）
    ("NVIDIA NVDA",     "$225.32", "-4.00%", True),    # #1 TSMC 客戶（22%），5/15 -4% 獲利了結，5/20 Q1 FY27 財報
...
VALUATION = {
    "pe_current":   32.7,   # 同 STOCK["pe_ratio"]（5/18 NT$2,220）
    "pe_5y_avg":    18.5,   # 5 年均 P/E（估算）
    "pe_5y_high":   37.8,   # 5 年高點（2021 AI 泡沫）
    "pe_5y_low":     9.8,   # 5 年低點（2022 下行周期）
    "pe_5y_pct":      86,   # 目前在 5 年區間的百分位（%，5/18 跳空下跌後微降至 86 百分位）
    "pe_10y_avg":   16.2,   # 10 年均 P/E（估算）
    "pe_10y_pct":     89,   # 目前在 10 年區間的百分位（%）
    "pb_current":  11.50,   # 同 STOCK["pb_ratio"]（5/18 NT$2,220）
    "pb_5y_avg":     5.8,
    "pb_5y_pct":      91,   # P/B 跳空下跌後微降
    "ev_ebitda":    19.5,   # EV/EBITDA（估算）
    "peg":          0.99,   # PEG = P/E ÷ 5 年 EPS CAGR ~33%
    "note": "P/E 歷史百分位為估算（Bloomberg/Refinitiv 基準），請每季更新基準值；5/18 跳空下跌後估值在 5 年 86% 高位、TSMC 上修 $1.5T 預測支撐估值結構性提升",
}
...
RELATIVE = {
    "date":           "2026-05-18",
    "tsmc_tw_1d":     -1.99,   # 2330 5/18 估收 NT$2,220（-45 vs 5/15 NT$2,265）
    "taiex_1d":       -1.50,   # 加權指數 5/18 估收約 40,560（估算）
    "sox_1d":         -3.95,   # SOX 5/15 跟隨 TSM 回檔
    "tsmc_nyse_1d":   -3.20,   # TSM ADR 5/15 $404.35（-$13.37 vs 5/14 $417.72）
    "tsmc_tw_5d":     -3.10,   # 5 日（NT$2,220 vs 5/11 NT$2,290 約 -3.1%）
    "taiex_5d":       -1.50,
    "tsmc_tw_1m":     +3.97,   # 月線（NT$2,220 vs ~NT$2,135 一個月前）
    "taiex_1m":       +5.5,
    "tsmc_tw_ytd":    +5.96,   # YTD 累計（NT$2,220 vs 年初 ~NT$2,095）
    "taiex_ytd":      +6.5,
    "sox_ytd":        +60.0,   # SOX YTD +60% 高位整理
    "beta_60d":        1.35,   # 60 日滾動 Beta vs TAIEX（5/18 波動率上升）
    # ADR 折溢價（以 5/15 NYSE 最新收盤計算）
    "adr_price":     404.35,   # TSM NYSE 5/15 最新收盤
    "adr_parity":    356.91,   # 理論值 = 5 × NT$2,220 ÷ 31.10
    "adr_ratio":     "5:1",    # 1 ADR = 5 台積電普通股
    "usd_ntd":        31.10,   # 同 MACRO 台幣匯率（5/18 持平）
    "adr_premium_pct": "+13.3",  # (404.35 - 356.91) / 356.91 × 100 = +13.3%（台股加速回檔、溢價擴大）
    "note": "ADR 理論值 = 5 × 台股收盤 ÷ 匯率（不含交易摩擦與流動性溢價）。5/18 台股 -1.99% 跳空下跌、ADR 最新 (5/15) -3.20%，台股回檔速度大於 ADR、溢價自 +11.1% 擴大至 +13.3%；NVDA 5/20 財報前避險情緒升溫",
}
...
FX_SENSITIVITY = {
    "spot":              31.10,  # 今日匯率（同 MACRO，5/18 持平）
...
NEWS = [
    {
        ...
        "title": "📉 台股 2330 5/18 跳空走低估收 NT$2,220（-1.99%）跟進 ADR 5/15 -3.20% 回檔",
        "body": "台股 2330 5/18 Mon 跟進 NYSE TSM 5/15 -3.20% 回檔 $404.35 訊號跳空走低，9:17 早盤即跌 -1.99% 觸 NT$2,220（-45 vs 5/15 NT$2,265），盤中區間 NT$2,210-2,245、量增至約 53,000 張屬量增下跌反映賣壓、跌破 5MA NT$2,250 與前壓轉支撐 NT$2,235、市值估降至 NT$57.6 兆。籌碼面：5/18 估三大法人合計大幅賣超 -19,500 張——外資 -16,500 張、投信 -2,000 張、自營 -1,000 張，外資轉賣、外資持股估降至 74.8%。技術面：RSI 估自 60.5 跌破中軸至 45.5 進入弱勢區、MACD +0.5 紅柱大幅收斂逼近翻黑、KDJ K(58)/D(62)/J(50) 死叉訊號浮現。本週關鍵：（1）🚨 NVDA 5/20（Wed）Q1 FY27 財報距今 2 天為最重要 AI 算力指標；（2）能否守住 NT$2,200 心理整數 + 60MA、若失守將測試 NT$2,150 第一支撐。",
        "source": "TWSE / 玩股網 / Yahoo股市 / 鉅亨網 2026-05-18", "impact": "負面",
    },
    {
        "tag": "客戶動態", "tag_color": "#2196F3",
        "title": "🚨 NVIDIA Q1 FY27 財報 5/20（Wed）距今僅 2 天；市場預期 Q1 營收 $78.5B（+78% YoY）",
        "body": "NVIDIA 將於 2026 年 5 月 20 日（Wed）盤後公布 Q1 FY27 財報、距今僅 2 天為最重要 AI 算力指標。市場預期數據：（1）Q1 營收 $78.5B（+78% YoY、市場上修自 $72.8B）；（2）NVIDIA guidance Q1 FY27 營收 $78.0B ±2%；（3）GAAP 毛利率 ~74.9%、Non-GAAP ~75.0%（±50bps）；（4）EPS 共識 $1.77；（5）資料中心部門預期 $72.8B（vs 2025/6 預估 $53.8B、+35%）。TSMC 為 NVDA 最大客戶 22% / $33B、Blackwell GB200/GB300 NVL72 + Rubin 全包，財報結果將直接影響 TSMC 2026 H2 訂單能見度。5/15 前夕避險：NVDA -4% 收 $225.32、AMD -4% 收 $432、SOX -3.95% 收 11,053、TSM ADR -3.20% 收 $404.35、AVGO -3.88%。市場觀察重點：H2 指引能否續強、Rubin 路徑時程、毛利率防守 75%。",
        "source": "S&P Global / Motley Fool / IG International / Wall Street Horizon 2026-05-18", "impact": "中性",
    },
    {
        "tag": "警示", "tag_color": "#F44336",
