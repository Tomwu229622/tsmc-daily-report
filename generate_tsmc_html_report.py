...
STOCK = {
    ...
    # NYSE TSM ADR
    "nyse_price":     "426.77",       # 6/9 Tue 實際收盤（-0.03，-0.01% vs 6/8 $426.80；高位整理消化 6/8 +2.80% 反彈）
    "nyse_change":    "-0.03",        # 6/9 漲跌（vs 6/8 $426.80）
    "nyse_change_pct":"-0.01%",       # 6/9 NYSE 高位持平整理
    ...
    # 資料日期備註
    "data_note":      "報告日期：2026-06-10 Wed（今日台股盤中、市場聚焦 13:30 TSMC 5 月月營收公布；以 6/9 Tue 實際收盤為最新確認資料）。✅ 重大確認——6/9 Tue 台股 2330 反彈站穩：實際收 NT$2,305（+10，+0.44% vs 6/8 NT$2,295）、開盤 NT$2,305 跳空 +10 點跟進 NYSE 6/8 +2.80% 反彈、盤中區間 NT$2,295-2,320 量縮至 33,206 張、成交金額 NT$765.81 億；台股加權指數 6/9 大漲 +1,201.66 點重返 44K 收 44,704.44。NYSE TSM 6/9 Tue 高位整理收 $426.77（-0.03，-0.01% vs 6/8 $426.80）已消化 6/8 +2.80% 反彈漲幅、盤中區間 $405.60-$438.09 波動加劇但收平。📊 今日（6/10 Wed）：⭐ 13:30 GMT+8 TSMC 5 月月營收公布為短線最關鍵催化、市場估 NT$420B+（MoM +2-3% vs 4 月 NT$410.73B）；台股 2330 盤中量縮觀望，預計月營收公布後決定方向。台美 ADR 溢價以 6/9 收盤計：理論值 5×2,305÷31.05 = $371.18、溢價 (426.77-371.18)/371.18 = +14.98%。  |  🎯 即將事件（短線最關鍵催化）：⭐ TSMC 5 月月營收今日（6/10 Wed 13:30）公布、市場估 NT$420B+、為止跌反彈關鍵訊號；Q2 2026 財報 7/16  |  ⭐ 結構性利多續存（中長線基底未變）：6/4 AGM CEO Wei 確認 AI 需求超供應、2026 >30% 成長；TSMC 2nm 量產良率達 70-80% 領先全球、年底月產能 100K 片；NVIDIA $150B/年投資台灣；NVIDIA-TSMC AI 製程合作（cuLitho/cuEST/FabTwin）；Intel CEO 確認長期夥伴；TSMC 3nm 下半年漲價 15%；SIA 估 2028 AI 資料中心晶片年營收 $1.2 兆；6/9 PwC 報告：TSMC 市值年增 +101% 躋身全球第 9 大市值企業（自第 12 名躍升）  |  ⚠️ 本日（6/10）關鍵觀察：（1）13:30 月營收公布為短線方向定錨；（2）若 NT$425B+ 預期突破 5MA NT$2,355 / NT$2,400 整數；若不及 NT$405B 恐跌破 NT$2,250 心理整數；（3）下方支撐 NT$2,295 / NT$2,250 / NT$2,200 / NT$2,155（120MA）；反彈壓力 NT$2,320 / NT$2,355（5MA）/ NT$2,365",
}
...
IR_CALENDAR = [
    ...
    ("2026-06-10", "⭐⭐⭐ TSMC 5 月月營收 13:30 公布為短線最關鍵催化；今日台股盤中觀望","今日（6/10 Wed）⭐⭐⭐ 13:30 GMT+8 TSMC 5 月合併月營收公布為短線方向定錨；4 月 NT$410.73B（+17.5% YoY、-1.1% MoM）；市場估 5 月 NT$420B+（MoM +2-3%）；若 NT$425B+ 預期突破 5MA NT$2,330 挑戰 NT$2,400 整數；若不及 NT$405B 恐跌破 NT$2,250 心理整數；台股 2330 盤中量縮觀望、月營收公布後決定方向；NYSE TSM 6/10 將反映 6/9 高位持平整理是否延續；⭐ 中長線基底未變：AGM CEO Wei 確認 AI 需求超供應、2nm 量產 70-80% 良率、3nm 漲價 15%、NVIDIA $150B/年投資、NVIDIA-TSMC AI 製程合作、Intel 確認長期夥伴、PwC 全球市值排名第 9；本日支撐：NT$2,295 / NT$2,250 心理整數 / NT$2,200；反彈壓力：NT$2,320 / 5MA NT$2,330 / NT$2,400","#FFE0B2"),
...
NEWS = [
    {
        ...
        "title": "⭐⭐⭐ 今日（6/10 Wed 13:30）TSMC 5 月月營收公布為短線最關鍵催化；市場估 NT$420B+",
        "body": "TSMC 將於今日（6/10 Wed 13:30 GMT+8）公布 5 月合併月營收、為短線方向定錨：（1）⭐⭐⭐ 公布時間：2026-06-10 Wed 13:30 GMT+8（TSMC 投資人關係官網確認）；（2）4 月月營收 NT$410.73B（+17.5% YoY、-1.1% MoM）、1-4 月累計 NT$1,544.83B（+29.9% YoY）；（3）⭐ 市場估 5 月 NT$420B+（MoM +2-3% vs 4 月 NT$410.73B、+18% YoY）；（4）⭐ 三種情境意涵：（a）若 NT$425B+ → 預期突破 5MA NT$2,330 挑戰 NT$2,400 整數、止跌反彈關鍵訊號；（b）若 NT$415-420B → 區間整理 NT$2,295-2,355；（c）若 NT$405B- → 跌破 NT$2,250 心理整數、加深下行壓力；（5）Q1 2026 實際營收 NT$1.134 兆（+35.1% YoY）、CEO Wei 確認 2026 全年成長 >30% 指引；（6）3 月 NT$415.2B（+45.2% YoY、+30.7% MoM）為近期高點；（7）⭐ 月營收為驗證 6/4 AGM CEO Wei 「AI 需求超供應」論述的關鍵數據；（8）2026 Q2 法說會 7/16 將進一步揭露 2026 H2 展望；（9）⭐ 配合 PwC 報告 TSMC 市值年增 +101% 躋身全球第 9，本月營收將是市場驗證 AI 結構性需求的最重要指標。",
        "source": "TSMC Investor Relations / 玩股網 / Yahoo股市 / NineScrolls 2026-06-10", "impact": "中性",
    },
    {
