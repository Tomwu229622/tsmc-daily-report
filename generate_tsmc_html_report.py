...
STOCK = {
    # 台股 2330
    "tw_price":       "2,425",        # 台股 2330 7/3 Fri 盤中 09:12 GMT+8 NT$2,425（-40、-1.62% vs 7/2 收 NT$2,465）；⚠️ 跌破 NT$2,450 心理整數支撐、跟進 NYSE 7/2 續跌 -2.27% 承壓、測試 NT$2,410 支撐；官方收盤待 TWSE
    "tw_change":      "-40",          # 7/3 盤中漲跌點數（-1.62%，09:12 即時）
    "tw_change_pct":  "-1.62%",       # 7/3 盤中漲跌幅（跌破 NT$2,450 支撐、跟進 NYSE 7/2 -2.27% 續跌承壓）
    "tw_volume":      "8,748",        # 7/3 盤中成交量（張，09:12 早盤、量能待午後放大）
    "tw_open":        "2,415",        # 7/3 開盤（跳空低開、跌破 NT$2,450 反映 NYSE 7/2 續跌）
    "tw_high":        "2,430",        # 7/3 盤中高（09:12）
    "tw_low":         "2,415",        # 7/3 盤中低（09:12）
    "market_cap":     "NT$62.9 兆",   # 7/3 盤中市值（NT$2,425 基礎）
    "pe_ratio":       "~35.7x",       # 台股 P/E（TTM，NT$2,425 基礎）
    "pb_ratio":       "~12.6x",       # 台股 P/B（股淨比，NT$2,425 基礎）
    "div_yield":      "~0.62%",       # 殖利率（NT$2,425 基礎）
    "52w_high_tw":    "2,535",        # 52 週/歷史高（2026-06-23 盤中觸 NT$2,535 史高）
    "52w_low_tw":     "780",          # 52 週低（2025-04-07）
    # NYSE TSM ADR
    "nyse_price":     "434.16",       # 7/2 Thu 收盤（-$10.07，-2.27%；4:00 PM EDT 官方收盤、最新確認；自 6/30 史新高 $477.57 連二日回落；市值約 $2.25 兆、P/E ~37.7）；NYSE 7/3 Fri 因美國國慶（7/4 週六順延至 7/3）休市
    "nyse_change":    "-10.07",       # 7/2 漲跌（最新確認收盤、4:00 PM EDT；跌幅較 7/1 之 -6.98% 大幅收斂、殺盤趨緩）
    "nyse_change_pct":"-2.27%",       # 7/2 NYSE 續跌（自 6/30 史新高 $477.57 連二日回落、修正延續惟跌勢趨緩；7/1 -6.98% → 7/2 -2.27%）
    "52w_high_nyse":  "479.00",       # 52 週/歷史高（區間，6/30 收 $477.57）
    "52w_low_nyse":   "223.70",       # 52 週低（區間）
    "pe_nyse":        "~37.7x",       # NYSE USD 基礎 P/E（TTM，$434.16 基礎）
    "pb_nyse":        "~12.9x",
    "beta":           "1.18",
    ...
    # 資料日期備註
    "data_note":      "報告日期：2026-07-03 Fri（⚠️ 台股 2330 7/3 Fri 盤中 09:12 GMT+8 NT$2,425（-40、-1.62% vs 7/2 收 NT$2,465），官方收盤待 TWSE；NYSE TSM 7/2 Thu 收盤 $434.16（-$10.07、-2.27%）為最新確認收盤、自 6/30 史新高 $477.57 連二日回落、市值約 $2.25 兆（P/E ~37.7）；NYSE 7/3 Fri 因美國國慶（7/4 週六、聯邦假期順延至 7/3）休市）。⚠️ 今日頭條——台股補跌延續、跌破 NT$2,450 支撐＋分析師逆勢續挺：（1）📉 台股 2330 7/3 開盤跳空低開 NT$2,415、09:12 報 NT$2,425（-1.62%），⚠️ 跌破 NT$2,450 心理整數支撐、跟進 NYSE 7/2 續跌 -2.27% 承壓、測試 NT$2,410 支撐；（2）📉 NYSE TSM 7/2 續跌 -2.27%（-$10.07）收 $434.16、自 6/30 史新高 $477.57 連二日回落——⭐ 惟跌幅自 7/1 之 -6.98% 大幅收斂至 -2.27%、殺盤動能趨緩，反映估值修正而非基本面惡化；NYSE 7/3 因美國國慶休市；（3）🚀 分析師逆勢續挺——Nomura（野村）與 Barclays 於 7/1-7/2 進一步上調 TSM 目標價，Nomura 上調至 NT$3,425（自 NT$2,465 具 +38.9% 空間）、指 AI 基礎設施投資循環尚未見頂、估 2027 資料中心新增產能達 ~32GW；TradingKey 彙整分析師 12 個月平均目標 $476.24（高 $625 / 低 $351、自 7/2 收 $434.16 具 +9.7% 空間）；（4）⚠️ 惟 Goldman Sachs 7/1 將 TSM 移出「APAC Conviction List」（戰術性調整近期上檔預期，非降評）；（5）📊 台美 ADR 溢價（以 7/2 ADR $434.16 + 台股 7/2 NT$2,465、匯率 ~31.9 計）：理論值 5×2,465÷31.9 = $386.4、溢價 (434.16-386.4)/386.4 = +12.4%。（6）🤝 產業利多——NVIDIA 與 TSMC 宣布將 AI/加速運算導入晶圓廠設計與製造流程，提升週期時間、能效與良率；BofA 上修 2026 全球半導體市場規模至 $1.3 兆（原估 $1.0 兆）、估 2030 上看 $2 兆。⭐ 漲價題材續發酵——TSMC 全先進製程調漲 5-10%（擴及 N7/N5/N3 及成熟製程、佔晶圓營收 ~74%），估全年毛利率 +2pp 以上，惟客戶（Apple/NVIDIA/AMD/Qualcomm/Broadcom/MediaTek）成本升；Benzinga 指 NVIDIA 因 AI 需求剛性與轉嫁能力強、長期反為利多。⚠️ 近期營收疑慮續存——4-5 月營收合計 +24% YoY 落後華爾街 Q2 約 +35% 預期，6 月營收（7 月上旬公布）為關鍵 catalyst、僅需小幅月增即可使 Q2 營收逼近指引中值。⚠️ 南韓公布逾 $1 兆美元 AI/晶片投資計畫（三星+SK 海力士 800 兆韓元），中長期競爭加劇。⭐ 中長線結構性利多基底未變：TSMC-Amkor 10 年美國先進封裝長約（Peoria AZ $70 億、2028 投產）、Winbond 特殊 DRAM 自主供應、NVIDIA 確認第 1 大客戶（22%/$33B）+ A16 首發 2026 下半/2027 量產（Apple 跳過 A16 直上 A14）+ Vera Rubin 平台 6 顆晶片全數 TSMC 代工（3nm + HBM4）、2nm 量產 70-80% 良率、2nm/A16 產能 2026-28 估 CAGR ~70%。  |  🎯 即將事件：6 月營收 7 月上旬公布（關鍵 catalyst、攸關 Q2 指引達成）；Q2 2026 財報法說會 7/16（指引 $39.0-40.2B、毛利率 65-67%、漲價後上修空間）  |  ⭐ 中長線基底：5 月營收 NT$4,169.75 億 +30.1% 創單月新高；2nm 量產良率 70-80% 領先全球；NVIDIA 第 1 大客戶 22%/$33B；4 大美國 CSP 2026 AI CapEx 合計 $725B（+77% YoY）；BofA 估 2026 全球半導體市場 $1.3 兆；費半（SOX）Q2 大漲 +87.8% 創 1994 年以來最強單季  |  ⚠️ 本日（7/3）關鍵觀察：（1）台股 7/3 盤前未開、留意開盤能否守穩 NT$2,450 支撐（NYSE 7/2 跌勢趨緩降低補跌壓力）；（2）ADR 溢價約 +12.4%；（3）下方支撐 NT$2,450 / NT$2,410 / NT$2,370；上方壓力 NT$2,505 / NT$2,535 史高；（4）⚠️ 估值警示：TSM P/E ~37.7x、台股 P/E ~36.3x，留意 6 月營收 miss 風險、下游需求疲弱與漲價客戶反彈",
}
...
SUMMARY = {
    ...
    "sentiment":  "中性偏多",
    # 一句話標題
    "headline":   "📉 台股補跌、跌破 NT$2,450：2330 7/3 盤中 NT$2,425（-1.62%、09:12）、跌破心理整數支撐、跟進 NYSE 7/2 續跌 -2.27% 收 $434.16、測試 NT$2,410；⭐ Nomura/Barclays 逆勢續挺（目標 NT$3,425、+38.9% 空間）；NYSE 7/3 國慶休市",
    # 3–5 條白話重點（不用術語，每條約 30 字內）
    "bullets": [
        "📉 台股 2330 7/3 Fri 開盤跳空低開 NT$2,415、09:12 報 NT$2,425（-40、-1.62%）——⚠️ 跌破 NT$2,450 心理整數支撐、跟進 NYSE 7/2 續跌承壓、測試 NT$2,410 支撐；官方收盤待 TWSE",
        "📉 NYSE TSM 7/2 Thu 續跌 -2.27%（-$10.07）收 $434.16、自 6/30 史新高 $477.57 連二日回落——⭐ 惟跌幅自 7/1 之 -6.98% 大幅收斂、殺盤動能趨緩，反映估值修正而非基本面惡化；NYSE 7/3 因美國國慶休市",
        "🚀 分析師逆勢續挺：Nomura（野村）上調 TSM 目標價至 NT$3,425（自 NT$2,465 具 +38.9% 空間）、Barclays 亦上調——指 AI 基礎設施投資循環尚未見頂、2027 資料中心新增產能達 ~32GW",
        "📊 分析師 12 個月平均目標 $476.24（高 $625 / 低 $351、TradingKey 7/2 彙整）——自 7/2 收 $434.16 具 +9.7% 空間；⚠️ 惟 Goldman Sachs 7/1 將 TSM 移出 APAC Conviction List（戰術調整、非降評）",
        "🤝 產業利多：NVIDIA 與 TSMC 宣布將 AI/加速運算導入晶圓廠設計製造流程（提升週期、能效、良率）；BofA 上修 2026 全球半導體市場至 $1.3 兆（原 $1.0 兆）、2030 上看 $2 兆",
        "⭐ 漲價題材續發酵：全先進製程調漲 5-10%（含 N7/N5/N3、佔晶圓營收 ~74%）、估貢獻全年毛利率 +2pp 以上；Benzinga 指 NVIDIA 可轉嫁、長期反利多",
        "🏆 中長線基底未變：NVIDIA #1 客戶（22%/$33B）/A16 首發 + Vera Rubin 6 顆晶片全 TSMC 代工（3nm+HBM4）+ TSMC-Amkor 美國封裝長約 + 2nm 70-80% 良率；費半 Q2 +87.8% 史上最強單季",
        "⚠️ 風險續追蹤：4-5 月營收 +24% YoY 落後 ~35% 預期、6 月營收（7 月上旬）與 7/16 財報為關鍵；下游手機/PC 需求疲弱；南韓 $1 兆晶片投資；估值偏高（TSM P/E ~37.7x、台股 ~36.3x）",
    ],
    # 一句結論
    "bottom_line": "報告日期：2026-07-03 Fri（⚠️ 台股 2330 7/3 Fri 盤中 09:12 GMT+8 NT$2,425（-40、-1.62% vs 7/2 收 NT$2,465），官方收盤待 TWSE；NYSE TSM 7/2 Thu 收盤 $434.16（-$10.07、-2.27%）為最新確認收盤、自 6/30 史新高 $477.57 連二日回落；NYSE 7/3 Fri 因美國國慶（7/4 週六順延至 7/3）休市）。⚠️ 今日頭條——台股補跌延續、跌破 NT$2,450 支撐＋分析師逆勢續挺：（1）📉 台股 2330 7/3 開盤跳空低開 NT$2,415、09:12 報 NT$2,425（-1.62%），⚠️ 跌破 NT$2,450 心理整數支撐、跟進 NYSE 7/2 續跌 -2.27% 承壓、測試 NT$2,410 支撐；（2）📉 NYSE TSM 7/2 續跌 -2.27%（-$10.07）收 $434.16、市值約 $2.25 兆（P/E ~37.7）、自 6/30 史新高 $477.57 連二日回落——⭐ 惟跌幅自 7/1 之 -6.98% 大幅收斂至 -2.27%、殺盤動能趨緩，催化仍為技術面過熱獲利了結（費半 Q2 +87.8% 史上最強單季後拉回）、估值修正、4-5 月營收 +24% YoY 落後華爾街 Q2 約 +35% 預期、下游手機/PC 需求疲弱、7/16 財報前觀望，惟屬估值修正而非基本面惡化；NYSE 7/3 因美國國慶休市；（3）🚀 分析師逆勢續挺——Nomura（野村）上調 TSM 目標價至 NT$3,425（自 NT$2,465 具 +38.9% 上行空間）、Barclays 亦上調，指 AI 基礎設施投資循環尚未見頂、估 2027 資料中心新增產能達 ~32GW；TradingKey 7/2 彙整分析師 12 個月平均目標 $476.24（高 $625 / 低 $351、自 $434.16 具 +9.7% 空間）；（4）⚠️ 惟 Goldman Sachs 7/1 將 TSM 移出「APAC Conviction List」（戰術性調整近期上檔預期、非降評）。📊 台美 ADR 溢價（以 7/2 ADR $434.16 + 台股 7/2 NT$2,465、匯率 ~31.9 計）：理論值 5×2,465÷31.9 = $386.4、溢價 +12.4%。🤝 產業利多：NVIDIA 與 TSMC 宣布將 AI/加速運算導入晶圓廠設計與製造流程（提升週期時間、能效與良率）；BofA 上修 2026 全球半導體市場規模至 $1.3 兆（原估 $1.0 兆）、估 2030 上看 $2 兆。⭐ 漲價題材續發酵：TSMC 通知客戶全先進製程調漲 5-10%（擴及 N7/N5/N3 及成熟製程、佔晶圓營收 ~74%），利多毛利率（估全年 +2pp 以上），惟客戶（含 Apple/NVIDIA/AMD/Qualcomm/Broadcom/MediaTek）成本升；Benzinga 指 NVIDIA 因 AI 需求剛性與轉嫁能力強、長期反為利多。6 月營收（7 月上旬公布）為關鍵 catalyst——4-5 月營收合計 +24% YoY 低於華爾街 Q2 約 +35% 預期、惟即使小幅月增亦可能使 Q2 營收逼近指引（$39.0-40.2B）中值。⚠️ 南韓公布逾 $1 兆美元 AI/晶片投資計畫（三星+SK 海力士 800 兆韓元）、中長期競爭加劇。⭐ 中長線結構性利多基底未變：（1）🤝 TSMC-Amkor 10 年美國先進封裝長約（Peoria AZ $70 億、2028 投產）；（2）⭐ TSMC-Winbond 特殊 DRAM 自主供應、降低 HBM 對韓系依賴；（3）🏆 NVIDIA 確認 TSMC 第 1 大客戶（22%/$33B）、A16 首發 2026 下半/2027 量產、Vera Rubin 平台 6 顆晶片全數 TSMC 代工（3nm+HBM4）、Apple 跳過 A16 直上 A14；（4）⭐ 2nm 已量產、初期良率 70-80% 領先全球、2nm/A16 產能 2026-28 估 CAGR ~70%；（5）4 大美國 CSP 2026 AI CapEx 合計 $725B（+77% YoY）；（6）⭐ 5 月營收 NT$4,169.75 億 +30.1% 創單月新高、1-5 月累計 NT$1.96 兆；（7）BofA 估 2026 全球半導體市場 $1.3 兆；（8）費半（SOX）Q2 大漲 +87.8% 創 1994 年以來最強單季。⚠️ 下行風險：（1）漲價恐引發客戶反彈與訂單調整；（2）4-5 月營收 +24% YoY 落後 Q2 ~35% 預期、6 月營收與 7/16 財報為關鍵驗證；（3）智慧型手機/PC 等下游終端需求疲弱；（4）估值警示——TSM P/E ~37.7x、台股 P/E ~36.3x；（5）台幣升值（每升 1% 毛利率 -40bps）。基本面未變：Q1 2026 淨利 NT$572.5B（$18.2B、+58.3% YoY）、毛利率 66.2% 雙創史高。技術面（基於 7/2 收 NT$2,465）：5MA NT$2,423 / 20MA NT$2,420 / 60MA NT$2,390 / 120MA NT$2,290；下方支撐 NT$2,450 / NT$2,410 / NT$2,370；上方壓力 NT$2,505 / NT$2,535（史高）。分析師仍全面看多（Nomura 上調至 NT$3,425、平均目標 $476.24），拉回被視為估值修正而非基本面惡化。",
    # 重大警示（選填，空白則不顯示）
    "risk_alert":  "今日（7/3 Fri）關鍵觀察：（1）📉 台股 2330 7/3 盤中 NT$2,425（-1.62%、09:12）、⚠️ 跌破 NT$2,450 心理整數支撐、跟進 NYSE 續跌承壓、測試 NT$2,410 支撐；官方收盤待 TWSE；（2）📉 NYSE TSM 7/2 續跌 -2.27%（-$10.07）收 $434.16、自 6/30 史高連二日回落，⭐ 惟跌幅自 7/1 -6.98% 大幅收斂至 -2.27%、殺盤趨緩、屬估值修正而非基本面惡化；NYSE 7/3 因美國國慶休市；（3）📊 ADR 溢價約 +12.4%（7/2 ADR $434.16 vs 理論 $386.4）；（4）🚀 分析師逆勢續挺——Nomura 上調目標至 NT$3,425（自 NT$2,465 具 +38.9% 空間）、Barclays 亦上調；平均目標 $476.24（自 $434.16 具 +9.7% 空間）、拉回視為估值修正；⚠️ 惟 Goldman 7/1 將 TSM 移出 APAC Conviction List（戰術調整、非降評）；（5）🤝 NVIDIA-TSMC 導入 AI 入廠提升良率、BofA 上修 2026 半導體市場至 $1.3 兆；⭐ 漲價定價力擴及全先進製程（佔晶圓營收 ~74%）、估全年毛利率 +2pp 以上；（6）⚠️ 4-5 月營收 +24% YoY 落後 ~35% 預期、6 月營收（7 月上旬）與 7/16 財報為關鍵 catalyst；下游手機/PC 需求疲弱、南韓 $1 兆晶片投資中長期競爭加劇；（7）🏆 中長線基底未變：NVIDIA #1 客戶（22%/$33B）/A16 首發、Vera Rubin 6 顆晶片全 TSMC 代工、2nm 70-80% 良率、TSMC-Amkor 美國封裝長約、費半 Q2 +87.8% 史上最強單季；（8）⚠️ 估值警示：TSM P/E ~37.7x、台股 P/E ~36.3x；本日關鍵：台股 7/3 開盤能否守穩 NT$2,450 / NT$2,410；上方壓力 NT$2,505 / NT$2,535 史高",
}

# 三大法人買賣超（張）— 最新一日
INSTITUTIONAL = {
    "date":     "2026-07-02",       # 最新資料日（7/2 Thu 官方收盤；三大法人淨額為估算，官方明細以 TWSE 為準）
    "foreign":  -8000,             # 外資 7/2 估賣超約 8,000 張（台股補跌 -1.60%、跟進 NYSE 7/1 重挫、外資轉調節）
    "trust":    500,               # 投信 7/2 估買超約 500 張
    "dealer":   -300,              # 自營商 7/2 估賣超約 300 張
    # 近5日（由舊到新：6/26, 6/29, 6/30, 7/1, 7/2）；7/2 為官方收盤日、三大法人淨額為估算
    "foreign_5d": [-6104, 2500, 8000, 15000, -8000],     # 外資 7/2 估賣超約 8,000 張
    "trust_5d":   [179, 400, 1200, 2000, 500],           # 投信 7/2 估買超約 500 張
    "dealer_5d":  [-310, 150, 650, 1000, -300],          # 自營 7/2 估賣超約 300 張
    "foreign_ownership_pct": "74.9%",  # 外資持股比例（7/2 估微降至 74.9%）
    "foreign_ownership_shares": "約 193.8 億股",
}

# 技術分析指標（需每日從看盤軟體更新）
TECHNICAL = {
    "rsi_14":       60.0,   "rsi_signal": "RSI 估自 68 回落至 60（台股 7/2 補跌 -1.60% 收 NT$2,465），退出漸近超買區、動能轉中性偏多；守穩 NT$2,450 支撐、留意 7/3 能否止穩",
    "macd":         0.50,  "macd_signal": "MACD 估自 +0.62 回落至 +0.50、紅柱縮短但仍為正、動能放緩、多頭趨勢未破；留意 NYSE 7/1 重挫後台股 7/3 是否止穩",   "macd_color": "#4CAF50",
    "kdj_k":        72.0,   "kdj_d": 66.0, "kdj_j": 84.0, "kdj_signal": "KDJ K(72)/D(66)/J(84) 自超買高檔回落、7/2 補跌帶動、J 值退出超買（<100）、短線過熱壓力緩解",
    "ma5":       "2,423",   # 5MA（6/26 2340, 6/29 2395, 6/30 2410, 7/1 2505, 7/2 2465）— 基於 7/2 官方收盤
    "ma20":      "2,420",   # 20MA
    "ma60":      "2,390",   # 60MA 緩升
    "ma120":     "2,290",
    "bb_upper":  "2,560",   # 布林上軌
    ...
    "trend":    "📉 修正延續、惟跌勢趨緩：NYSE TSM 7/2 續跌 -2.27%（-$10.07）收 $434.16、自 6/30 史高連二日回落、跌幅自 7/1 -6.98% 大幅收斂；⚠️ 台股 2330 7/3 Fri 盤前尚未開盤、最新收 7/2 NT$2,465（-1.60%）、守穩 NT$2,450 心理整數支撐、仍站穩 5MA NT$2,423 / 20MA NT$2,420。📊 技術面（基於 7/2 官方收盤 NT$2,465）：RSI 自 68 回落至 60 退出漸近超買區、MACD +0.50 紅柱縮短但仍為正、KDJ J 值自超買高檔（104）回落至 84 退出超買、短線過熱壓力緩解，中期 60MA/120MA 趨勢仍偏多。下一觀察：（1）台股 7/3 開盤能否守穩 NT$2,450 / NT$2,410 支撐（NYSE 7/2 跌勢趨緩降低補跌壓力）；（2）下方支撐 NT$2,450 / NT$2,410 / NT$2,370；（3）上方壓力 NT$2,505 / NT$2,535 史高；（4）🚀 Nomura 上調目標至 NT$3,425 + Barclays 上調 + 共識平均目標 $476.24 為中長線支撐、惟須留意 6 月營收（7 月上旬）與 7/16 財報、Goldman 移出 APAC Conviction List；（5）⭐ 中長線基底未變：NVIDIA #1 客戶/A16 首發 + Vera Rubin 6 顆晶片全 TSMC 代工 + 2nm 70-80% 良率 + 費半 Q2 +87.8% 史上最強單季。",
    "support":  "2,410 / 2,370 / 2,340 (7/3 跌破 2,450、下一測試 2,410)",
    "resist":   "2,505 / 2,535 / 2,560 (7/1 收、史高、布林上軌)",
    "note": "技術指標數值為估算（基於 7/2 官方收盤 NT$2,465、台股 7/3 盤前尚未開盤），請以看盤軟體即時數據為準；NYSE TSM 7/2 續跌 -2.27% 收 $434.16、跌勢自 7/1 -6.98% 大幅收斂、殺盤趨緩；台股守穩 NT$2,450 支撐、RSI 自 68 回落至 60 退出漸近超買、KDJ J 值退出超買、MACD 紅柱縮短仍為正；上方壓力 NT$2,505 / NT$2,535 史高、下方支撐 NT$2,450 / NT$2,410；🚀 Nomura/Barclays 上調目標 + 漲價定價力+共識偏多 vs ⚠️ 6 月營收與下游需求雜訊拉鋸；7/3 台股盤中待 TWSE",
}

# 期貨與選擇權（來源：台灣期交所 TAIFEX）
DERIVATIVES = {
    "date":          "2026-07-02",       # 最新資料日（7/2 Thu 盤後估、官方待 TAIFEX 公布）
    "futures_price": "2,458",            # 台積電期貨近月（7/2 收盤附近、逆價差反映補跌後謹慎）
    "futures_oi":    "180,000",          # 未平倉量（口）（7/2 估）
    "futures_basis": "-7",               # 7/2 估逆價差（補跌後市場情緒仍謹慎）
    "call_oi":       "110,000",
    "put_oi":        "80,000",
    "pcr":           "0.73",             # Put/Call 比率（7/2 估微升至 0.73、補跌後避險買盤續增、情緒中性偏謹慎）
    "pcr_signal":    "中性（Put/Call 7/2 估 0.73；台股 7/2 收 NT$2,465（-1.60%）、NYSE TSM 7/2 續跌 -2.27%、避險買盤續增、期貨維持逆價差；⭐ 惟 NYSE 跌勢趨緩、台股守穩 NT$2,450、Nomura/Barclays 上調目標（NT$3,425）+ 共識偏多為中長線支撐；台股 7/3 盤前待開盤）",
    "max_pain":      "2,450",            # 最大痛苦價格（近期到期、7/2 估）
    "key_strikes": [
        ("2,340", "Call 54,000 / Put 16,000", "整數支撐"),
        ("2,370", "Call 52,000 / Put 12,000", "整數支撐"),
        ("2,410", "Call 50,000 / Put 9,000",  "整數支撐"),
        ("2,450", "Call 46,000 / Put 7,000",  "7/2 守穩、最大痛苦"),
        ("2,465", "Call 40,000 / Put 6,000",  "7/2 收"),
        ("2,505", "Call 38,000 / Put 5,000",  "7/1 收"),
        ("2,535", "Call 30,000 / Put 3,500",  "盤中史高"),
    ],
    "note": "衍生品數據需每日至台灣期交所(taifex.com.tw)更新；7/2 PCR 估自 0.72 微升至 0.73 反映台股補跌 -1.60% 後避險情緒、期貨維持逆價差（-7）；NT$2,450 為最大痛苦、7/2 守穩、下方支撐 NT$2,410 / NT$2,370、上方壓力 NT$2,505 / NT$2,535 史高；🚀 Nomura 上調目標 NT$3,425 + 漲價定價力+共識偏多結構性利多、⚠️ 留意 6 月營收 miss 風險與下游需求疲弱；中長線基底未變（NVIDIA #1 客戶/A16 首發、Vera Rubin 6 顆晶片全 TSMC 代工、2nm 70-80% 良率、TSMC-Amkor 美國封裝長約、共識平均目標 $487.56）",
}

# 供應鏈與客戶股價（需每日更新）
ECOSYSTEM_STOCKS = [
    # 類別、股票代碼、名稱、收盤價、漲跌幅、備註（美股為 2026-07-02 Thu 收盤估、NYSE 7/3 Fri 因美國國慶休市；台股為 7/2 Thu 收盤、7/3 Fri 盤前尚未開盤；價格為估算，7/2 美股半導體隨 TSM 續跌但跌勢趨緩）
...
ANALYST_RATINGS = [
    ...
    ("Barclays",       "增持",     "US$470+",  "2026-07-02", "⭐ 7/2 進一步上調目標價；AI 需求結構性 + A14/A16 領先、TSMC 為 AI CapEx 循環終極受惠者"),
...
CONSENSUS = {
    ...
    "low_target":   "NT$2,100",
    "avg_target_us":"US$476.24",    # 分析師 12 個月平均目標（TradingKey 7/2 彙整、高 $625 / 低 $351；自 7/2 收 $434.16 具 +9.7% 上行空間；Nomura 上調台股目標至 NT$3,425、Barclays 亦上調；Goldman 7/1 移出 APAC Conviction List）
    "analyst_count": 32,
    "buy": 32, "hold": 0, "sell": 0,
    "upside":       "+9.69%",   # 從 NYSE 7/2 收 $434.16 至平均目標 $476.24（拉回視為估值修正、共識仍偏多；待 7/16 法說會後重估）
}
...
RELATIVE = {
    "date":           "2026-07-02",       # 最新資料日（7/2 Thu 台股收盤；NYSE 為 7/1 最新確認收盤）
    "tsmc_tw_1d":     -1.60,   # 2330 7/2 官方收 NT$2,465（-40 vs 7/1 NT$2,505；跟進 NYSE 7/1 重挫補跌、惟相對抗跌）
    "taiex_1d":       -0.90,   # 加權指數 7/2 收低（半導體補跌拖累、估）
    "sox_1d":         -3.50,   # SOX 7/1 隨 TSM 重挫拉回（估）
    "tsmc_nyse_1d":   -6.98,   # TSM ADR 7/1 $444.23 (-$33.34 vs 6/30 $477.57；自史新高獲利了結重挫)
    "tsmc_tw_5d":     +3.14,   # 5 日（NT$2,465 vs 6/25 NT$2,390）
    "taiex_5d":       +1.80,
    "tsmc_tw_1m":     +8.60,   # 月線（NT$2,465 vs ~NT$2,270 ~6/2）
    "taiex_1m":       +8.5,
    "tsmc_tw_ytd":    +17.66,  # YTD 累計（NT$2,465 vs 年初 ~NT$2,095）
    "taiex_ytd":      +13.5,
    "sox_ytd":        +60.0,   # SOX YTD（7/1 拉回後）
    "beta_60d":        1.38,   # 60 日滾動 Beta vs TAIEX
    # ADR 折溢價（以 7/1 NYSE 收盤 & 7/2 TW 收盤計算）
    "adr_price":     444.23,   # TSM NYSE 7/1 收盤（-6.98%、最新確認）
    "adr_parity":    396.94,   # 理論值 = 5 × NT$2,465 ÷ 31.05
    "adr_ratio":     "5:1",    # 1 ADR = 5 台積電普通股
    "usd_ntd":        31.05,   # 同 MACRO 台幣匯率
    "adr_premium_pct": "+11.91", # (444.23 - 396.94) / 396.94 × 100 = +11.91%
    "note": "ADR 理論值 = 5 × 台股收盤 ÷ 匯率（不含交易摩擦與流動性溢價）。⚠️ NYSE TSM 7/1 Wed 重挫 -6.98% 收 $444.23（-$33.34 vs 6/30 史新高 $477.57、市值約 $2.30 兆、P/E ~38.6）——技術面過熱獲利了結（費半 Q2 +87.8% 史上最強單季後拉回）、估值修正、4-5 月營收落後預期、下游需求疲弱、7/16 財報前觀望；盤後回升 +$3.35 至約 $447.58；台股 2330 7/2 Thu 官方收 NT$2,465（-40、-1.60% vs 7/1 NT$2,505、量約 35,000 張、市值 NT$64.0 兆）跟進 NYSE 補跌、終結連 3 漲，⭐ 惟跌幅遠小於美股、守穩 NT$2,450 支撐相對抗跌。⚠️ 籌碼面：7/2 估外資轉賣超 -8,000 張、投信小買、自營小賣（待官方確認）。📊 台美 ADR 溢價自 +10.13% 微升至 +11.91%（台股僅部分補跌、相對抗跌、補跌壓力大致釋放）；🎯 今日（7/2 Thu）關鍵：台股 7/3 能否止穩、守穩 NT$2,450 / NT$2,410 支撐；⚠️ TSMC 4-5 月營收 +24% YoY 落後 ~35% 預期、6 月營收（7 月上旬）為關鍵 catalyst；🚀 重大利多：Nomura 將 TSM 目標價自 NT$2,820 上調至 NT$3,425；⭐ 中長線結構性基底未變：TSMC-Amkor 美國封裝長約 + NVIDIA 確認第 1 大客戶/A16 首發 + Vera Rubin 6 顆晶片全 TSMC 代工 + 2nm 量產 70-80% 良率 + CoWoS 擴產 + 4 大 CSP CapEx $725B",
}
...
NEWS = [
    {
        ...
        "title": "📉 修正延續、惟跌勢趨緩：NYSE TSM 7/2 續跌 -2.27% 收 $434.16（連二日回落、自 6/30 史高 $477.57）；台股 2330 7/3 盤前尚未開盤、最新收 NT$2,465",
        "body": "半導體修正進入第二日、惟殺盤動能明顯趨緩：（1）📉 NYSE TSM 7/2 Thu 官方收盤 $434.16（-$10.07、-2.27%、前收 $444.23），自 6/30 史新高 $477.57 連二日回落、市值約 $2.25 兆（P/E ~37.7）；（2）⭐ 惟跌幅自 7/1 之 -6.98% 大幅收斂至 -2.27%、殺盤動能明顯趨緩，反映技術面過熱獲利了結後的估值修正而非基本面惡化；（3）⚠️ 台股 2330 7/3 Fri 盤前尚未開盤（08:51 GMT+8）、最新確認收盤為 7/2 Thu NT$2,465（-40、-1.60%、守穩 NT$2,450 支撐），7/3 開盤恐跟進 NYSE 續跌承壓、關鍵觀察能否守穩 NT$2,450；（4）🗓️ NYSE 7/3 Fri 因美國國慶（7/4 週六、聯邦假期順延至 7/3）休市；（5）📊 台美 ADR 溢價約 +12.4%（以 7/2 ADR $434.16 + 台股 7/2 NT$2,465、匯率 ~31.9 計、理論值 $386.4）。",
        "source": "stockanalysis.com / Yahoo Finance / CNBC / Yahoo 奇摩股市 2026-07-02 - 07-03", "impact": "負面",
    },
    {
        "tag": "產業趨勢", "tag_color": "#4CAF50",
        "title": "🚀 分析師逆勢續挺：Nomura 上調 TSM 目標價至 NT$3,425（+38.9% 空間）、Barclays 亦上調；惟 Goldman 7/1 將 TSM 移出 APAC Conviction List",
        "body": "拉回中分析師多空並陳、主流仍偏多：（1）🚀 Nomura（野村）7/1 大幅上調 TSMC 目標價至 NT$3,425（自 NT$2,820、上調約 +21.5%）、自 7/2 收 NT$2,465 隱含約 +38.9% 上行空間，指 AI 基礎設施投資循環尚未見頂、預期資料中心新增產能將於 2027 年升至約 32GW；（2）📈 Barclays 亦於近日進一步上調目標價，強調 TSMC 為 AI 資本支出循環的終極受惠者；（3）📊 TradingKey 7/2 彙整分析師 12 個月平均目標 $476.24（高 $625 / 低 $351），自 7/2 收 $434.16 具 +9.7% 上行空間，多數視拉回為估值修正而非基本面惡化；（4）⚠️ 惟 Goldman Sachs 7/1 將 TSM 移出「APAC Conviction List」，屬對近期上檔空間的戰術性調整、並非降評，短線情緒面雜訊。",
        "source": "TradingKey / GuruFocus / Nomura / Barclays / 鉅亨網 2026-07-01 - 07-02", "impact": "正面",
    },
    {
        "tag": "客戶動態", "tag_color": "#2196F3",
        "title": "🤝 NVIDIA 與 TSMC 宣布將 AI/加速運算導入晶圓廠設計與製造——提升週期時間、能效與良率；Vera Rubin 6 顆晶片全數 TSMC 代工（3nm+HBM4）",
        "body": "客戶關係深化、AI 反哺半導體製造：（1）🤝 NVIDIA 與 TSMC 宣布 TSMC 將於半導體設計與製造全生命週期導入 NVIDIA 加速運算與 AI，改善先進晶圓廠的週期時間、能效、良率與營運生產力——AI 需求反哺 TSMC 自身製造效率；（2）🏆 NVIDIA 下一代 Vera Rubin AI 平台採「6 顆並行晶片」策略全數由 TSMC 代工、建構於 3nm 製程並搭配 HBM4，較 Blackwell 訓練快 3.5×、推論快 5×；NVIDIA 已包下 TSMC 多數 CoWoS 先進封裝產能；（3）🏆 NVIDIA 確認超越 Apple 成 TSMC 最大客戶（約 22%、$33B）、傳為 A16 製程首發客戶（2026 下半/2027 量產）；Apple 仍為第 2 大客戶（約 18%）、選擇跳過 A16 直上 A14；（4）⚠️ 主要客戶面臨 TSMC 漲價成本，Benzinga 指 NVIDIA 因需求剛性與轉嫁能力強、長期反為利多。",
        "source": "NVIDIA Newsroom / eeNews Europe / CNBC / TweakTown 2026-07-01 - 07-02", "impact": "正面",
    },
    {
        "tag": "產業趨勢", "tag_color": "#4CAF50",
        "title": "📈 BofA 上修 2026 全球半導體市場規模至 $1.3 兆（原估 $1.0 兆）、估 2030 上看 $2 兆——AI 晶片為核心成長引擎",
        "body": "產業總量預期再上修、印證 AI 超級循環：（1）📈 美銀（BofA）將 2026 全球半導體市場規模預估自 $1.0 兆上修至 $1.3 兆、並估 2030 有機會倍增至 $2 兆，AI 晶片與資料中心為核心成長引擎；（2）🏆 TSMC 作為 NVIDIA、AMD 等 AI 領導者的主要代工與先進封裝供應商，被廣泛視為此結構性擴張的最大受惠者；（3）📊 分析師強調 AI 資本支出循環「遠未見頂」、資料中心產能將持續擴張至 2027（Nomura 估 ~32GW）；（4）⚠️ 惟近期半導體出現拋售（TSM 自 6/30 史高連二日回落），市場關注 Q2 財報（7/16）與 6 月營收（7 月上旬）能否驗證高成長預期。",
        "source": "BofA / crispidea / intellectia.ai 2026-07 / Kavout Market Lens 2026-07", "impact": "正面",
    },
    {
    ...
    {
        "tag": "產業趨勢", "tag_color": "#4CAF50",
        "title": "🇺🇸 TSMC 台灣供應鏈加速赴美設廠、創造在地新商機；Arizona 首廠已量產、第二廠 2026 下半移機、第三廠興建中",
        "body": "TSMC $165B 美國投資帶動整條台灣半導體供應鏈西進：（1）🇺🇸 隨 TSMC 亞利桑那基地擴張，台灣上游材料、化學品、設備與封裝供應商加速赴美設廠就近服務、創造新的合作與投資商機；（2）🏭 TSMC Arizona 首座晶圓廠已投入量產、第二廠預計 2026 下半年進行移機（tool move-in）、第三廠興建中——強化美國半導體在地化供應鏈、呼應地緣政治去風險趨勢；（3）💰 惟 2026 資本支出高達 $52-56B 以擴充 sub-3nm 先進製程，市場關注若下游需求走軟恐有固定成本稼動不足與毛利率壓力風險；（4）⭐ 搭配 TSMC-Amkor 10 年美國先進封裝長約（Peoria AZ $70 億、2028 投產），美國本土「晶圓製造+先進封裝」一條龍生態逐步成形。",
        "source": "GlobeNewswire / CNBC 2026-07-01", "impact": "正面",
    },
    {
        "tag": "警示", "tag_color": "#F44336",
