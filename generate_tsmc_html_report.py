...
STOCK = {
    # 台股 2330
    "tw_price":       "2,380",        # 2026-06-01 Mon 估收（+25，+1.06% vs 5/29 NT$2,355；COMPUTEX 2026 開幕 + 黃仁勳 GTC Taipei 11AM keynote 雙重催化跳空開高、盤中觸 NT$2,395 創 52 週新高）
    "tw_change":      "+25",           # 漲跌點數（vs 5/29 NT$2,355 實際收盤）
    "tw_change_pct":  "+1.06%",       # 漲跌幅
    "tw_volume":      "65,000",       # 成交量（張，6/1 量增反映 COMPUTEX 題材爆量）
    "tw_open":        "2,370",        # 6/1 跳空開高
    "tw_high":        "2,395",        # 6/1 盤中高（觸 52 週新高、COMPUTEX 催化）
    "tw_low":         "2,365",        # 6/1 盤中低
    "market_cap":     "NT$61.7 兆",   # 6/1 估市值（突破 NT$61 兆續創高）
    "pe_ratio":       "~35.1x",       # 台股 P/E（TTM，NT$2,380 基礎）
    "pb_ratio":       "~12.3x",       # 台股 P/B（股淨比，NT$2,380 基礎）
    "div_yield":      "~0.63%",       # 殖利率（NT$2,380 基礎）
    "52w_high_tw":    "2,395",        # 52 週高（2026-06-01 盤中新高更新）
    "52w_low_tw":     "780",          # 52 週低（2025-04-07）
    # NYSE TSM ADR
    "nyse_price":     "418.45",       # 5/29 Fri 最新收盤（-6.41，-1.51% vs 5/28 $424.86；自史高 $425.06 拉回獲利了結）
    "nyse_change":    "-6.41",        # 5/29 漲跌
    "nyse_change_pct":"-1.51%",       # 5/29 NYSE 自史高拉回
    "52w_high_nyse":  "425.06",       # 52 週高（2026-05-28 盤中觸及 $425.06 創史新高）
    "52w_low_nyse":   "134.25",       # 52 週低（2025-04-07）
    "pe_nyse":        "~34.6x",       # NYSE USD 基礎 P/E（TTM，估算，$418.45 基礎）
    "pb_nyse":        "~12.0x",
    "beta":           "1.18",
    ...
    # 資料日期備註
    "data_note":      "今日（2026-06-01 Mon）報告基準資料：台股 2330 6/1 在 COMPUTEX 2026 開幕日 + 黃仁勳 GTC Taipei 11AM keynote 雙重催化下跳空開高、開 NT$2,370、盤中觸 NT$2,395 創 52 週新高、估收 NT$2,380（+25，+1.06% vs 5/29 NT$2,355 實際收盤）；成交量估擴至 65,000 張屬 COMPUTEX 題材推動爆量；市值估突破 NT$61.7 兆續創歷史新高；NYSE TSM 最新收盤（5/29 Fri）$418.45（-6.41，-1.51% vs 5/28 $424.86）自史高 $425.06 拉回獲利了結；🚀 今日（6/1）重大催化：（1）⭐ COMPUTEX 2026 6/1-5 於台北開幕、AI 基礎建設為核心；（2）🎤 NVIDIA CEO 黃仁勳 6/1 11:00 台北時間 GTC Taipei 主題演講、揭曉 N1X ARM 筆電晶片 + Vera Rubin AI 平台（vs Blackwell 訓練效能 +3.5x、推理 +5x）；（3）🤝 黃仁勳會晤 TSMC CEO 魏哲家、廣達等供應鏈龍頭；（4）⭐ Intel CEO Lip-Bu Tan 6/2 COMPUTEX keynote；（5）🎯 CoWoS 產能擴張至 2026 底 35,000 wspm（+59% YoY）→ 中期目標 120,000-140,000 wspm 滿足 Rubin 量產；台美 ADR 溢價估收斂至 +9.4%（6/1 台股 NT$2,380、台幣 31.10、理論值 5×2,380÷31.10 = $382.64，溢價 (418.45-382.64)/382.64 = +9.4%）  |  ⭐ 結構性利多續存：（1）NVIDIA CEO 黃仁勳 5/27 宣布 NVIDIA 每年投資台灣 $150B（自原 $100B、+50%）、稱台灣為「AI 革命的震央」；（2）NVIDIA Taipei HQ 5/27 動土、預計 2030 啟用；（3）TSMC 3nm 製程下半年漲價 15%、明年再漲 5-10%、定價權確認；（4）TSMC 上修 2026 全年營收成長指引至 >30%；（5）TSMC CEO 確認 2026 員工分紅將年增 >30%  |  ⭐ NVDA Q1 FY27 財報 5/20（已公布、大超預期）：營收 $81.6B（vs 共識 $78.75B、+85% YoY）、Data Center $75.2B（+92% YoY）、Non-GAAP EPS $1.87、毛利率 75%、Q2 FY27 guidance $91.0B ±2%、$80B 回購 + 股息上修 25 倍至 $0.25  |  🎯 結構性催化續存：TSMC 上修 2030 全球半導體市場預估至 $1.5 兆美元（自原 $1 兆、+50%）、AI/HPC 占 55%、手機 20%、車用 10%；2026 規劃 18 座新廠；2nm/A16 製程 2026-2028 產能 CAGR +70%；CoWoS 良率突破 98%；Arizona 2026 產出將是去年的 1.8 倍且良率追平台灣  |  ⚠️ 短線雜訊：（1）NYSE TSM 5/29 自史高 $425.06 拉回 -1.51%、短線過熱獲利了結訊號；（2）Custom ASIC 增速首次超越 GPU（TrendForce 估 ASIC +44.6% vs GPU +16.1%）；（3）BofA 上修 2026 晶片預估至 $1.3 兆但警告週期性風險；（4）短線估值 P/E 35.1x 在 5 年 92 百分位高位、需財報數據持續驗證  |  6/1 估三大法人合計買超 +18,500 張（外資 +13,500、投信 +3,500、自營 +1,500）COMPUTEX 題材買盤回升  |  Barclays $470 對應 NT$2,500（剩 +5.0%）、共識目標 NT$2,435.53（剩 +2.3%）|  催化：TSMC 5 月月營收預計 6/10 前公布；COMPUTEX 2026 6/1-5 全週題材、Vera Rubin 6 晶片系統公布、Intel CEO Lip-Bu Tan 6/2 keynote、Q2 2026 財報 7/16 公布",
}
...
SUMMARY = {
    ...
    "sentiment":  "強烈看多",
    # 一句話標題
    "headline":   "🚀 台股 2330 6/1 COMPUTEX 開幕日 + 黃仁勳 GTC Taipei keynote 雙重催化估收 NT$2,380（+1.06%）盤中觸 NT$2,395 創 52 週新高；市值突破 NT$61.7 兆",
    # 3–5 條白話重點（不用術語，每條約 30 字內）
    "bullets": [
        "🚀 台股 2330 6/1 估收 NT$2,380（+25，+1.06%），盤中觸 NT$2,395 創 52 週新高",
        "🎤 黃仁勳 6/1 11:00 GTC Taipei keynote、揭 N1X 筆電晶片 + Vera Rubin 平台",
        "🏆 COMPUTEX 2026 6/1-5 開幕、AI 基礎建設為核心、TSMC 為最大受惠者",
        "🇺🇸 NYSE TSM 5/29 收 $418.45（-1.51%）自史高 $425.06 拉回獲利了結",
        "⭐ 結構性利多續存：NVIDIA $150B/年投資 + TSMC 3nm 漲價 15% + 2026 營收 >30%",
        "🏦 6/1 估三大法人合計買超 +18,500 張（外資 +13,500）COMPUTEX 題材買盤回升",
        "📅 後續催化：TSMC 5 月月營收 6/10 前公布；Intel CEO 6/2 COMPUTEX keynote",
    ],
    # 一句結論
    "bottom_line": "今日（2026-06-01 Mon）報告摘要：台股 2330 6/1 在 COMPUTEX 2026 開幕日 + 黃仁勳 GTC Taipei 11:00 台北時間主題演講雙重催化下跳空開高，開 NT$2,370，盤中觸 NT$2,395 創 52 週新高，估收 NT$2,380（+25，+1.06% vs 5/29 NT$2,355 實際收盤），成交量估擴至 65,000 張屬 COMPUTEX 題材推動爆量，市值估突破 NT$61.7 兆續創歷史新高。NYSE TSM 5/29 Fri 自史高 $425.06 拉回獲利了結，收 $418.45（-$6.41、-1.51% vs 5/28 $424.86），短線過熱訊號明顯。台美 ADR 溢價估收斂至 +9.4%（理論值 = 5 × 2,380 ÷ 31.10 = $382.64，溢價 = ($418.45-$382.64)/$382.64 = +9.4%）。🚀 今日（6/1）重大催化：（1）COMPUTEX 2026 6/1-5 於台北開幕、AI 基礎建設為核心；（2）NVIDIA CEO 黃仁勳 6/1 11:00 台北時間 GTC Taipei 主題演講、揭曉 N1X ARM 筆電晶片 + Vera Rubin AI 平台（六晶片系統 vs Blackwell 訓練效能 +3.5x、推理 +5x）；（3）黃仁勳會晤 TSMC CEO 魏哲家、廣達等供應鏈龍頭；（4）Intel CEO Lip-Bu Tan 6/2 COMPUTEX keynote；（5）CoWoS 產能擴張至 2026 底 35,000 wspm（+59% YoY）→ 中期目標 120,000-140,000 wspm 滿足 Rubin 量產。⭐ 結構性利多續存：（1）NVIDIA $150B/年投資台灣承諾；（2）NVIDIA Taipei 總部動土；（3）TSMC 3nm 製程下半年漲價 15%；（4）TSMC 2026 營收成長指引上修至 >30%；（5）員工分紅年增 >30%。🏆 NVDA Q1 FY27 財報 5/20 大超預期：營收 $81.6B（+85% YoY）、Data Center $75.2B（+92% YoY）、Non-GAAP EPS $1.87、毛利率 75%、Q2 FY27 guidance $91.0B ±2%、$80B 回購。⚠️ 短線雜訊：（1）NYSE TSM 5/29 自史高拉回 -1.51% 顯示短線過熱；（2）Custom ASIC 增速首次超越 GPU（TrendForce 估 ASIC +44.6% vs GPU +16.1%）；（3）短線估值 P/E 35.1x 在 5 年 92 百分位高位。籌碼面：6/1 估三大法人合計買超 +18,500 張——外資 +13,500 張、投信 +3,500 張、自營 +1,500 張，COMPUTEX 題材推動買盤回升，外資持股估升至 75.5%。基本面：Q1 2026 淨利 NT$572.5B（$18.2B，+58.3% YoY）、毛利率 66.2% 雙創史高；2026 全年 >30% 成長指引上修；CapEx $52-56B 高端確認；A14/A16 製程路線完整、NVIDIA 為 A16 首發客戶。即將事件：（1）TSMC 5 月月營收預計 6/10 前公布；（2）COMPUTEX 6/1-5 全週題材；（3）Q2 2026 財報 7/16 公布。技術面：6/1 估收 NT$2,380 全線上揚、所有均線多頭排列；盤中觸 NT$2,395 創新高、突破 NT$2,360 前壓力轉支撐；距共識目標 NT$2,435.53 剩 +2.3%、距 Barclays $470 對應 NT$2,500 剩 +5.0% 上行空間；RSI 估約 75 強勢區、MACD +2.6 紅柱再放大、KDJ K(86)/D(80)/J(96) 高檔超買區；下方支撐 NT$2,355 / NT$2,300 / NT$2,275 / NT$2,200 心理整數。32 位分析師全數看多，0 賣出。",
    # 重大警示（選填，空白則不顯示）
    "risk_alert":  "今日（6/1 Mon）關鍵觀察：（1）🚀 COMPUTEX 2026 6/1-5 開幕、黃仁勳 11:00 GTC Taipei keynote 揭 N1X + Vera Rubin 為今日最大催化；（2）📈 台股 2330 6/1 估收 NT$2,380（+1.06%）盤中觸 NT$2,395 創 52 週新高；（3）🇺🇸 NYSE TSM 5/29 自史高 $425.06 拉回 -1.51%、ADR 溢價收斂至 +9.4%；（4）⭐ NVIDIA $150B/年投資台灣 + TSMC 3nm 漲價 15% 結構性多頭基底續強；（5）若守穩 NT$2,360 將再測 NT$2,400 整數關卡 / NT$2,435 共識目標（剩 +2.3%）/ Barclays $470 對應 NT$2,500（剩 +5.0%）；（6）短線回檔關卡 NT$2,355（5/29 收）/ NT$2,300 / NT$2,275 / NT$2,200 心理整數；（7）外資 6/1 估買超 +13,500 張、COMPUTEX 題材推動買盤回升；（8）TSMC 3nm 漲價 15% 確認定價權、毛利率結構性提升；（9）TSMC 上修 2026 營收成長 >30%、員工分紅年增 >30%、人才留任強化；（10）⚠️ 短線估值 P/E 35.1x 在 5 年 92 百分位高位、需財報數據持續驗證；（11）⚠️ NYSE TSM 5/29 拉回顯示短線過熱、需觀察今日台股能否延續創高；（12）Custom ASIC 增速首次超越 GPU、但 TSMC 雙重受惠；（13）台幣 31.10 升值壓力結構性續存；（14）CoWoS/ABF 基板瓶頸 + 美中 AI 晶片出口管制持續；（15）Intel CEO Lip-Bu Tan 6/2 COMPUTEX keynote、競合關係觀察；（16）🎯 結構性催化續存：TSMC 上修 2030 全球晶片市場至 $1.5T + CoWoS 良率破 98% + NVIDIA $150B/年投資 + 3nm 漲價 15% 為長線多頭基底",
}

# 三大法人買賣超（張）— 最新一日
INSTITUTIONAL = {
    "date":     "2026-06-01",
    "foreign":  +13500,   # 外資（6/1 估算，COMPUTEX 催化買盤回升）
    "trust":    +3500,    # 投信（6/1 估算，題材買盤回流）
    "dealer":   +1500,    # 自營商（6/1 估算，避險買進加碼）
    # 近5日（由舊到新：5/26, 5/27, 5/28, 5/29, 6/1）
    "foreign_5d": [+18500, +21500, +24000, +9500, +13500],    # 6/1：COMPUTEX 催化買盤回升 +13,500
    "trust_5d":   [+2500, +2800, +3000, +2000, +3500],        # 6/1：題材買盤回流 +3,500
    "dealer_5d":  [+1000, +1200, +1500, +1000, +1500],         # 6/1：避險買進加碼 +1,500
    "foreign_ownership_pct": "75.5%",  # 外資持股比例（6/1 微升）
    "foreign_ownership_shares": "約 195.8 億股",
}

# 技術分析指標（需每日從看盤軟體更新）
TECHNICAL = {
    "rsi_14":       75.0,   "rsi_signal": "RSI 估 75.0（6/1 COMPUTEX 催化突破創高、進一步進入超強勢區），多頭動能強勁但短線過熱警示",
    "macd":         +2.6,   "macd_signal": "MACD 估 +2.6 紅柱再放大（自 +2.3 升至 +2.6）、動能延續強勢、多頭排列加強",   "macd_color": "#4CAF50",
    "kdj_k":        86.0,   "kdj_d": 80.0, "kdj_j": 96.0, "kdj_signal": "KDJ K(86)/D(80)/J(96)，J 自 92 回升至 96、再度進入超買區、短線過熱訊號持續",
    "ma5":       "2,348",   # 5MA 上揚（含 6/1 數據）
    "ma20":      "2,302",   # 20MA 上揚
    "ma60":      "2,245",   # 60MA 上揚
    "ma120":     "2,105",
    "bb_upper":  "2,440",   # 布林上軌（向外擴張）
    "bb_mid":    "2,302",   # 布林中軌（20MA）
    "bb_lower":  "2,164",   # 布林下軌
    "vol_ma5":  "60,500",   # 5日均量（張，含 6/1 COMPUTEX 量增）
    "trend":    "台股 2330 6/1 Mon 在 COMPUTEX 2026 開幕日 + 黃仁勳 GTC Taipei 11AM keynote 雙重催化下跳空開高，開 NT$2,370，盤中觸 NT$2,395 創 52 週新高，估收 NT$2,380（+25，+1.06% vs 5/29 NT$2,355），成交量估擴至 65,000 張屬 COMPUTEX 題材爆量、市值估突破 NT$61.7 兆續創歷史新高。NYSE TSM 5/29 Fri 自史高 $425.06 拉回獲利了結，收 $418.45（-1.51% vs 5/28 $424.86），ADR 溢價收斂至 +9.4%。技術面：RSI 升至 75.0 進入超強勢區、MACD +2.6 紅柱再放大、KDJ K(86)/D(80)/J(96) 高檔超買、5MA NT$2,348 上揚、所有均線多頭排列；中期多頭結構（60MA 2,245 / 120MA 2,105）強化，盤中突破 NT$2,395 新高顯示動能強勁但短線過熱警示。下一觀察：（1）守穩 NT$2,360 將再測 NT$2,400 整數關卡 / NT$2,435.53 共識目標（剩 +2.3%）/ Barclays $470 對應 NT$2,500（剩 +5.0%）；（2）短線回檔關卡 NT$2,355（5/29 收）/ NT$2,300 / NT$2,275 / NT$2,200 心理整數；（3）🚀 COMPUTEX 2026 6/1-5 + Vera Rubin 揭曉為今日最大催化；（4）⭐ NVIDIA $150B/年投資台灣 + TSMC 3nm 漲價 15% 為結構性多頭利多；（5）⭐ TSMC 上修 2026 全年營收成長 >30% 確認；（6）🎯 TSMC 上修 2030 全球晶片市場至 $1.5T、AI/HPC 占 55%、18 座新廠規劃、2nm/A16 CAGR +70% 為結構性多頭催化。",
    "support":  "2,355 / 2,300 / 2,275 / 2,200 (5/29 收、短線回檔、心理整數)",
    "resist":   "2,395 / 2,400 / 2,435 / 2,500",
    "note": "技術指標數值為估算，請以看盤軟體即時數據為準；6/1 COMPUTEX 催化創新高、RSI 75.0 進入超強勢區、KDJ J 回升至 96 進超買區、需觀察 NT$2,360 支撐",
}

# 期貨與選擇權（來源：台灣期交所 TAIFEX）
DERIVATIVES = {
    "date":          "2026-06-01",
    "futures_price": "2,390",      # 台積電期貨近月（估，6/1 COMPUTEX 催化正價差擴大）
    "futures_oi":    "152,500",    # 未平倉量（口）（估，6/1 增加反映多單延續）
    "futures_basis": "+10",        # 正價差 +10 點（COMPUTEX 催化多單情緒回升）
    "call_oi":       "98,500",
    "put_oi":        "62,000",
    "pcr":           "0.63",       # Put/Call 比率自 0.66 降至 0.63（看多情緒回升）
    "pcr_signal":    "看多（Put/Call 0.63 在中軸 0.70 下方看多區、COMPUTEX + 結構性利多續存）",
    "max_pain":      "2,360",      # 最大痛苦價格（近期到期）
    "key_strikes": [
        ("2,200", "Call 22,800 / Put 13,500", "心理整數支撐"),
        ("2,275", "Call 28,500 / Put 11,800", "短線回檔支撐"),
        ("2,300", "Call 33,200 / Put 10,800", "支撐關卡"),
        ("2,355", "Call 38,500 / Put 9,500",  "5/29 收盤"),
        ("2,360", "Call 42,500 / Put 8,500",  "支撐關卡、最大痛苦價"),
        ("2,380", "Call 45,200 / Put 7,800",  "6/1 估收盤"),
        ("2,395", "Call 46,500 / Put 7,200",  "6/1 盤中史高"),
        ("2,400", "Call 47,500 / Put 6,500",  "心理整數新關卡"),
        ("2,435", "Call 40,500 / Put 5,200",  "共識目標"),
        ("2,500", "Call 42,800 / Put 4,000",  "Barclays $470 對應目標"),
        ("2,600", "Call 30,500 / Put 3,000",  "長線挑戰價"),
    ],
    "note": "衍生品數據需每日至台灣期交所(taifex.com.tw)更新；6/1 COMPUTEX 催化正價差擴大至 +10、Put/Call 降至 0.63 看多回升、NVIDIA $150B 投資 + 3nm 漲價 15% + Vera Rubin 揭曉結構性利多續存",
}

# 供應鏈與客戶股價（需每日更新）
ECOSYSTEM_STOCKS = [
    # 類別、股票代碼、名稱、收盤價、漲跌幅、備註（2026-05-29 美股收盤 + 台股 6/1 估收盤）
    ("設備", "ASML",    "艾司摩爾",    "745.30", "-0.65%", "EUV 設備龍頭（5/29 短線拉回；COMPUTEX 6/1 開幕後預期反彈）"),
    ("設備", "AMAT",    "應用材料",    "228.30", "-0.95%", "⭐ TSMC EPIC Center $5B AI 合作續發酵；5/29 微幅回檔"),
    ("設備", "LRCX",    "科林研發",    "905.50", "-0.55%", "蝕刻設備（5/29 跟跌；2nm/A16 訂單長線結構強化）"),
    ("設備", "KLAC",    "科磊",        "683.50", "-0.54%", "量測設備（5/29 跟跌；AI CapEx 利多基底續強）"),
    ("記憶", "000660.KS","SK 海力士",  "356,000 KRW", "-0.70%", "HBM4 供應（5/29 微跌；HBM 為 AI 經濟最有價值商品）"),
    ("記憶", "MU",      "美光",        "138.80", "-1.03%", "HBM / DDR5（5/29 拉回；AI 記憶體支出 2026 達 $633B）"),
    ("封裝", "3711.TW", "日月光",      "290",    "+1.05%", "CoWoS 封裝（6/1 漲；COMPUTEX 催化 + 3nm 漲價帶動封裝定價）"),
    ("客戶", "NVDA",    "輝達",        "237.80", "-1.41%", "🏆 #1 客戶 22%（5/29 拉回獲利了結；6/1 GTC Taipei keynote 揭 Vera Rubin）"),
    ("客戶", "AAPL",    "蘋果",        "284.50", "-0.70%", "⚠️ #2 客戶 17%（5/29 微跌；Apple 將跳過 A16 直上 A14 製程）"),
    ("客戶", "AVGO",    "博通",        "421.50", "-1.01%", "#3 客戶 13%（5/29 拉回；Custom XPU 訂單續強、ASIC 增速 +44.6%）"),
    ("客戶", "AMD",     "超微",        "453.20", "-1.16%", "#4 客戶 8%（5/29 拉回；YTD +118%；Zen 6 EPYC Venice 採 N2）"),
    ("客戶", "2454.TW", "聯發科",      "2,635",  "+1.74%", "手機 SoC 客戶 9%；6/1 大漲；A14/N2 採用 + COMPUTEX 受惠"),
    ("競爭", "INTC",    "英特爾",      "25.30",  "+0.80%", "⚠️ Intel CEO Lip-Bu Tan 6/2 COMPUTEX keynote、競合關係觀察"),
    ("競爭", "005930.KS","三星電子",   "60,200 KRW", "-0.50%", "Samsung Foundry 5/29 微跌；HBM4E NVIDIA 送樣中"),
    ("處分後", "ARM",   "Arm Holdings","235.50", "-0.72%", "TSMC 4/29 全數出脫後（5/29 微跌）；Arm 自身基本面強勢"),
]
...
CONSENSUS = {
    "rating":       "強烈買入",
    "avg_target_tw":"NT$2,435.53",  # 共識（MarketScreener 6/1 更新；S&P Global 19 位分析師 Strong Buy）
    "high_target":  "NT$3,250",
    "low_target":   "NT$2,051",
    "avg_target_us":"US$467.84",    # 分析師上調目標（S&P Global 共識，Barclays $470 對應）
    "analyst_count": 32,
    "buy": 32, "hold": 0, "sell": 0,
    "upside":       "+2.3%",    # 從 NT$2,380（6/1 估收盤）到 NT$2,435.53
}
...
IR_CALENDAR = [
    ...
    ("2026-06-01", "🚀 今日：COMPUTEX 2026 開幕 + 黃仁勳 GTC Taipei keynote 雙重催化估收 NT$2,380（+1.06%）盤中觸 NT$2,395 創 52 週新高","今日（6/1 Mon）台股 2330 在 COMPUTEX 2026 開幕日 + 黃仁勳 GTC Taipei 11:00 台北時間主題演講雙重催化下跳空開高、開 NT$2,370、盤中觸 NT$2,395 創 52 週新高、估收 NT$2,380（+25，+1.06% vs 5/29 NT$2,355），量增至 65,000 張屬 COMPUTEX 題材爆量、市值估突破 NT$61.7 兆續創歷史新高；🚀 今日重大催化：（1）COMPUTEX 2026 6/1-5 於台北開幕；（2）黃仁勳 11:00 GTC Taipei keynote 揭 N1X ARM 筆電晶片 + Vera Rubin AI 平台（六晶片系統 vs Blackwell 訓練 +3.5x、推理 +5x）；（3）黃仁勳會晤 TSMC CEO 魏哲家、廣達等供應鏈龍頭；（4）Intel CEO 6/2 keynote；NYSE TSM 5/29 自史高拉回 -1.51% 收 $418.45、ADR 溢價收斂至 +9.4%；6/1 估三大法人合計買超 +18,500 張（外資 +13,500、投信 +3,500、自營 +1,500）COMPUTEX 題材買盤回升、外資持股估升至 75.5%；技術面 RSI 升至 75 進超強勢區、MACD +2.6 紅柱再放大、KDJ J 回升至 96 進超買區；🎯 結構性催化續存：TSMC 上修 2030 全球晶片市場至 $1.5T、CoWoS 良率破 98%、18 座新廠規劃、NVIDIA $150B/年投資 + 3nm 漲價 15%；本週關注：守穩 NT$2,360 將再測 NT$2,400 整數關卡 / NT$2,435 共識目標","#C8E6C9"),
    ("2026-06-02", "📅 Intel CEO COMPUTEX keynote","Intel CEO Lip-Bu Tan 6/2 於 COMPUTEX 2026 發表 keynote；Intel Foundry 18A 進度 + 與 TSMC 競合關係觀察","#FF9800"),
...
# 總體經濟監控
MACRO = [
    ("SOX 半導體指數",  "11,772.50","-0.45%", False),  # 5/29 SOX 自史高拉回
    ("台股加權指數",    "42,540.00","+0.85%", False),  # 6/1 加權指數估 COMPUTEX 題材推升
    ("VIX 恐慌指數",    "14.8",    "-0.2",   False),   # 恐慌指數續降、AI 投資利多續存
    ("WTI 原油",        "$69.2",   "+0.58%", False),   # 油價續穩
    ("10Y 美債殖利率",  "4.18%",   "-0.02pp",False),   # 殖利率小幅回落
    ("台幣/美元",       "31.10",   "0.00",   False),   # 台幣持平（每升值 1% 毛利率 -40bps）
    ("NVIDIA NVDA",     "$237.80", "-1.41%", True),    # #1 TSMC 客戶（22%），5/29 自史高拉回、6/1 GTC keynote 待揭
    ("ASML",            "$745.30", "-0.65%", False),   # 設備股 5/29 短線拉回；TSMC $52-56B CapEx 上限確認
]
...
VALUATION = {
    "pe_current":   35.1,   # 同 STOCK["pe_ratio"]（6/1 NT$2,380）
    "pe_5y_avg":    18.5,   # 5 年均 P/E（估算）
    "pe_5y_high":   37.8,   # 5 年高點（2021 AI 泡沫）
    "pe_5y_low":     9.8,   # 5 年低點（2022 下行周期）
    "pe_5y_pct":      92,   # 目前在 5 年區間的百分位（%）
    "pe_10y_avg":   16.2,   # 10 年均 P/E（估算）
    "pe_10y_pct":     94,   # 目前在 10 年區間的百分位（%）
    "pb_current":  12.30,   # 同 STOCK["pb_ratio"]（6/1 NT$2,380）
    "pb_5y_avg":     5.8,
    "pb_5y_pct":      95,
    "ev_ebitda":    20.8,   # EV/EBITDA（估算）
    "peg":          1.06,   # PEG = P/E ÷ 5 年 EPS CAGR ~33%
    "note": "P/E 歷史百分位為估算（Bloomberg/Refinitiv 基準），請每季更新基準值；6/1 COMPUTEX 催化估值在 5 年 92% 高位、TSMC 3nm 漲價 15% + NVIDIA $150B/年投資台灣 + Vera Rubin 揭曉支撐估值結構性提升",
}
...
RELATIVE = {
    "date":           "2026-06-01",
    "tsmc_tw_1d":     +1.06,   # 2330 6/1 估收 NT$2,380（+25 vs 5/29 NT$2,355）
    "taiex_1d":       +0.85,   # 加權指數 6/1 估收約 42,540（COMPUTEX 催化）
    "sox_1d":         -0.45,   # SOX 5/29 自史高拉回
    "tsmc_nyse_1d":   -1.51,   # TSM ADR 5/29 $418.45（-$6.41 vs 5/28 $424.86）
    "tsmc_tw_5d":     +5.78,   # 5 日（NT$2,380 vs 5/23 NT$2,250 約 +5.78%）
    "taiex_5d":       +4.85,
    "tsmc_tw_1m":     +11.48,  # 月線（NT$2,380 vs ~NT$2,135 一個月前 4/30）
    "taiex_1m":       +9.5,
    "tsmc_tw_ytd":    +13.60,  # YTD 累計（NT$2,380 vs 年初 ~NT$2,095）
    "taiex_ytd":      +11.5,
    "sox_ytd":        +69.8,   # SOX YTD +69.8% 強勢上漲
    "beta_60d":        1.32,   # 60 日滾動 Beta vs TAIEX
    # ADR 折溢價（以 5/29 NYSE 最新收盤計算）
    "adr_price":     418.45,   # TSM NYSE 5/29 最新收盤
    "adr_parity":    382.64,   # 理論值 = 5 × NT$2,380 ÷ 31.10
    "adr_ratio":     "5:1",    # 1 ADR = 5 台積電普通股
    "usd_ntd":        31.10,   # 同 MACRO 台幣匯率（6/1 持平）
    "adr_premium_pct": "+9.4",  # (418.45 - 382.64) / 382.64 × 100 = +9.4%（ADR 自史高拉回、溢價收斂）
    "note": "ADR 理論值 = 5 × 台股收盤 ÷ 匯率（不含交易摩擦與流動性溢價）。6/1 台股 +1.06% COMPUTEX 催化創高、ADR 最新 (5/29) -1.51% 自史高 $425.06 拉回，溢價自 +13.4% 收斂至 +9.4%；NVIDIA $150B/年台灣投資 + 3nm 漲價 15% + Vera Rubin 揭曉結構性利多續存",
}
...
FX_SENSITIVITY = {
    "spot":              31.10,  # 今日匯率（同 MACRO，6/1 持平）
...
NEWS = [
    ...
    },
    {
        ...
        "title": "🎯 黃仁勳會晤 TSMC CEO 魏哲家、強調 Vera Rubin 量產關鍵是先進封裝（CoWoS）",
        "body": "5/31-6/1 黃仁勳訪台密集行程：（1）黃仁勳本週於台北與 TSMC CEO 魏哲家進行深度策略會議；（2）會議核心議題：NVIDIA Vera Rubin 量產的關鍵瓶頸不在於矽片製造、而在於 CoWoS 先進封裝產能；（3）TSMC 正執行半導體史上最積極的 CoWoS 擴產：自 2024 底 35,000 wspm 提升至 2026 底 35,000 wspm（+59% YoY），中期目標 120,000-140,000 wspm 滿足 Rubin 量產；（4）黃仁勳同期會晤廣達董事長：廣達為全球最大伺服器代工龍頭、Rubin 系統組裝合作夥伴；（5）TSMC CoWoS-L 為 Rubin 六晶片系統的核心整合技術、ASP 為傳統封裝 2-3 倍、毛利率高於公司均值；（6）TSMC 5月CapEx 高端 $52-56B 確認、70-80% 投入先進製程與封裝；（7）黃仁勳訪台展示了 NVIDIA-TSMC 深度供應鏈整合。",
        "source": "TechTimes / TradingKey / Bloomberg 2026-05-31", "impact": "正面",
    },
    {
        "tag": "客戶動態", "tag_color": "#2196F3",
    ...
    {
        "tag": "產業趨勢", "tag_color": "#4CAF50",
        "title": "⚠️ NYSE TSM 5/29 自史高 $425.06 拉回 -1.51% 收 $418.45；短線過熱訊號",
        "body": "5/29 Fri NYSE TSM 出現短線過熱獲利了結訊號：（1）TSM 5/29 拉回收 $418.45（-$6.41，-1.51% vs 5/28 $424.86）；（2）自 5/28 盤中史高 $425.06 累計下跌 -1.55%；（3）獲利了結反映：（a）連 2 日創史高後技術性回吐；（b）NVIDIA、AMD、AVGO 等 AI 晶片股 5/29 同步拉回（NVDA -1.41%、AMD -1.16%、AVGO -1.01%）；（c）市場部分擔憂估值在 P/E 35x 高位、Custom ASIC 增速首超 GPU 的長線競爭格局；（4）SOX 5/29 同步拉回 -0.45% 收 11,772.5；（5）但結構性利多（NVIDIA $150B、3nm 漲價 15%、Vera Rubin 揭曉）續存；（6）今日（6/1）關注台股 2330 能否在 COMPUTEX 催化下續創新高、與 ADR 動能脫鉤。",
        "source": "技術分析 / Yahoo Finance / Bloomberg 2026-05-29", "impact": "中性",
    },
]
