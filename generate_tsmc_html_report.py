...
STOCK = {
    # 台股 2330
    "tw_price":       "2,085",        # 收盤價（數字加逗號，不含 NT$）（2026-04-17 財報後首日，獲利了結）
    "tw_change":      "-10",          # 漲跌點數（含+/-號，vs 4/16 收盤 NT$2,095）
    "tw_change_pct":  "-0.48%",       # 漲跌幅（含+/-號）
    "tw_volume":      "35,000",       # 成交量（張，財報後縮量整理）
    "tw_open":        "2,090",
    "tw_high":        "2,095",
    "tw_low":         "2,075",
    "market_cap":     "NT$54.1 兆",
    "pe_ratio":       "~30.7x",       # 台股 P/E（TTM，NT$2,085 基礎，EPS FY25 實績 NT$67.8）
    "pb_ratio":       "~11.1x",       # 台股 P/B（股淨比）
    "div_yield":      "~0.72%",       # 殖利率（已除息後調整，USD $2.65/ADR 年息）
    "52w_high_tw":    "2,110",        # 52 週高（2026-04-16，昨日日中新高）
    "52w_low_tw":     "780",          # 52 週低（2025-04-07）
    # NYSE TSM ADR
    "nyse_price":     "390.00",       # 估算（財報後整理，vs 4/16 $392.00）
    "nyse_change":    "-2.00",        # 估算
    "nyse_change_pct":"-0.51%",       # 估算
    "52w_high_nyse":  "392.00",       # 52 週高（2026-04-16，財報日新高）
    "52w_low_nyse":   "134.25",       # 52 週低（2025-04-07）
    "pe_nyse":        "~34.2x",       # NYSE USD 基礎 P/E（TTM，估算）
    "pb_nyse":        "~11.2x",
    "beta":           "1.16",
    ...
    # 資料日期備註
    "data_note":      "4/17 財報後首日（獲利了結整理）  |  台股 2330 收 NT$2,085（-0.48%，財報後正常回落）  |  NYSE TSM 估算 $390.00（-0.51%）  |  ⭐ Q1 2026 淨利 NT$572.5B（$18.1B，+58% YoY）創歷史新高  |  Q2 指引 $39.0-40.2B 遠超共識 $37.5-39.0B  |  全年 2026 收入年增 >30% 確認  |  CapEx 指引至 $52-56B 高端  |  NVIDIA 超越 Apple 成 TSMC 最大客戶（22% vs 17%）  |  TSMC 警告伊朗戰爭供應鏈風險，但分散採購可控",
}
...
SUMMARY = {
    ...
    "sentiment":  "看多",
    # 一句話標題
    "headline":   "4/17 財報後首日整理：Q1 淨利 +58%（$18.1B）創歷史高，Q2 指引 $39-40.2B 遠超共識，台股 -0.48% 屬正常獲利了結",
    # 3–5 條白話重點（不用術語，每條約 30 字內）
    "bullets": [
        "⭐ Q1 2026 淨利 NT$572.5B（$18.1B，+58% YoY）創歷史新高，連續 10 季超越市場預期",
        "🚀 Q2 2026 指引 $39.0-40.2B 遠超市場共識 $37.5-39.0B，全年 >30% 成長目標確認",
        "📉 台股 2330 收 NT$2,085（-0.48%），屬財報後正常獲利了結；NYSE TSM 估算 $390.00（-0.51%）",
        "🏆 NVIDIA 超越 Apple 成 TSMC 最大客戶（22% 營收佔比），AI 晶片需求持續驅動業績",
        "⚠️ TSMC 警告伊朗戰爭推高供應鏈成本，但多元採購可控；能源成本為 Q2 毛利率主要觀察變數",
    ],
    # 一句結論
    "bottom_line": "TSMC Q1 2026 財報結果亮眼，淨利 NT$572.5B（$18.1B，+58%）創歷史新高，超越分析師預期。Q2 指引 $39.0-40.2B 遠超市場共識 $37.5-39.0B，全年 2026 收入 >30% 成長目標確認，CapEx 向 $52-56B 高端靠齊。財報後首日（4/17）台股 2330 收 NT$2,085（-0.48%）屬正常獲利了結，中長線基本面持續強化。NVIDIA 正式超越 Apple 成 TSMC 最大客戶（22% vs 17%），確認 AI 基礎設施資本週期受益地位。TSMC 警告伊朗戰爭推高供應鏈成本，但稱已建立安全庫存並多元採購，短期影響有限。分析師 31 位全數看多，共識目標 NT$2,290（自 NT$2,085 有 +9.8% 上行空間）。",
    # 重大警示（選填，空白則不顯示）
    "risk_alert":  "⚠️ 伊朗戰爭持續推高氦氣等關鍵化學品供應鏈成本；台灣電費調漲 + 美國廠爬坡成本壓縮 Q2 毛利率；美國對半導體展開 301 關稅調查，後續動向需追蹤；ABF 基板供應持續受限；台幣升值壓力（每升值 1%，毛利率 -40bps）",
}

# 三大法人買賣超（張）— 最新一日
INSTITUTIONAL = {
    "date":     "2026-04-17",
    "foreign":  -1500,    # 外資（正=買超）— 4/17 財報後獲利了結（估）
    "trust":    +280,     # 投信（持續小幅加碼，估）
    "dealer":   -120,     # 自營商（估，財報後小幅減碼）
    # 近5日（由舊到新，最後一筆為 4/17）
    "foreign_5d": [+1800, +3200, +4800, +6200, -1500],  # 4/17 財報後外資獲利了結（估）
    "trust_5d":   [+380,  +480,  +720,  +850,  +280],
    "dealer_5d":  [+200,  +320,  +450,  +380,  -120],
    "foreign_ownership_pct": "75.2%",  # 外資持股比例（估，4/17）
    "foreign_ownership_shares": "約 195.0 億股",
}

# 技術分析指標（需每日從看盤軟體更新）
TECHNICAL = {
    "rsi_14":       60.5,   "rsi_signal": "RSI 從 66.2 回落至 60.5，財報後獲利了結，仍維持多頭區間（>50），支撐在 55-60 附近",
    "macd":         +1.8,   "macd_signal": "MACD 持續正值（+2.1→+1.8），多頭趨勢維持，財報後小幅收斂，中線看多格局不變",   "macd_color": "#4CAF50",
    "kdj_k":        72.3,   "kdj_d": 75.4, "kdj_j": 66.0, "kdj_signal": "KDJ 超買解除（J 值從 101.7 降至 66.0），財報後正常回落，轉為多頭整固",
    "ma5":       "2,055",
    "ma20":      "1,952",
    "ma60":      "1,890",
    "ma120":     "1,798",
    "bb_upper":  "2,120",   # 布林上軌（收盤回落至上軌下方）
    "bb_mid":    "1,952",   # 布林中軌（20MA）
    "bb_lower":  "1,784",   # 布林下軌
    "vol_ma5":  "36,000",   # 5日均量（張，財報後縮量整理）
    "trend":    "台股 2330（4/17 財報後首日，收 NT$2,085，-0.48%）。財報後正常獲利了結，Q2 指引 $39-40.2B 遠超共識為中長線正面。NYSE TSM 估算 $390.00（-0.51%）。技術面：RSI 60.5 仍在多頭區，MACD 正值維持，KDJ 超買解除轉為整固，短線支撐在 NT$2,055–2,080，若守穩則中線目標 NT$2,200–2,290。",
    "support":  "2,055–2,080",
    "resist":   "2,110–2,150",
...
DERIVATIVES = {
    "date":          "2026-04-17",
    "futures_price": "2,082",      # 台積電期貨近月（估，4/17 財報後縮量整理）
    "futures_oi":    "88,000",     # 未平倉量（口）（估，財報後小幅降低）
    "futures_basis": "-3",         # 負價差（財報後多頭部位縮減）
    "call_oi":       "48,000",
    "put_oi":        "41,000",
    "pcr":           "0.85",       # Put/Call 比率升至 0.85（財報後部分保護性部位增加）
    "pcr_signal":    "中性（Put/Call 從 0.73 升至 0.85，財報後部分多頭獲利了結，市場轉為觀望）",
    "max_pain":      "2,050",      # 最大痛苦價格
    "key_strikes": [
        ("2,000", "Call 25,000 / Put 5,500", "心理關口，已大幅突破"),
        ("2,050", "Call 22,000 / Put 2,800", "近期支撐轉換區"),
        ("2,100", "Call 18,000 / Put 2,200", "昨日（4/16）財報日收盤，短線壓力"),
        ("2,150", "Call 12,000 / Put 1,500", "中線目標區（Q2 指引超預期後）"),
...
IR_CALENDAR = [
    ...
    ("2026-04-17", "✅ 財報後首日整理","台股 2330 收 NT$2,085（-0.48%），財報後正常獲利了結；NYSE TSM 估算 $390.00（-0.51%）；NVIDIA 確認超越 Apple 成 TSMC 最大客戶（22%）；TSMC 警告伊朗戰爭供應鏈衝擊","#9E9E9E"),
...
# 總體經濟監控
MACRO = [
    ("SOX 半導體指數",  "歷史高位區","~-0.5%", False),  # 4/17 財報後小幅整理
    ("美元指數 DXY",    "99.5",    "-0.3%",  False),  # 美元繼續走弱
    ("VIX 恐慌指數",    "25.8",    "-0.7",   False),  # 恐慌指數小降，市場相對平穩
    ("WTI 原油",        "$62.5",   "-0.5%",  False),  # 油價持穩偏弱（伊朗停火未完成）
    ("10Y 美債殖利率",  "4.08%",   "-0.02pp",False),  # 小降，風險情緒尚可
    ("台幣/美元",       "31.38",   "-0.02",  False),  # 台幣小幅走強
    ("NVIDIA NVDA",     "$835.60", "-0.3%",  False),  # #1 TSMC 客戶（22%），財報後小幅整理
    ("ASML",            "$675.40", "-0.7%",  False),  # 設備股，Q1 財報後整理，全年指引維持
]
...
RELATIVE = {
    "date":           "2026-04-17",
    "tsmc_tw_1d":     -0.48,   # 2330 4/17 收 NT$2,085（-0.48%），財報後獲利了結
    "taiex_1d":       -0.30,   # 加權指數（4/17 估算，財報後大盤小幅回落）
    "sox_1d":         -0.50,   # SOX（4/17 估算，半導體板塊整理）
    "tsmc_nyse_1d":   -0.51,   # TSM ADR 4/17 估算 $390.00（-0.51%，財報後整理）
    "tsmc_tw_5d":     +7.15,   # 本週（4/14~4/17：+2.56%+1.26%+2.19%-0.48%）
    "taiex_5d":       +5.50,
    "tsmc_tw_1m":     +7.2,    # 略低於昨日新高後回落
    "taiex_1m":       +4.0,
    "tsmc_tw_ytd":    -2.9,    # Q1+4/1–4/17 累計（財報後小幅回落）
    "taiex_ytd":      -4.0,
    "sox_ytd":        -21.5,
    "beta_60d":        1.16,   # 60 日滾動 Beta vs TAIEX
    # ADR 折溢價
    "adr_price":     390.00,   # TSM NYSE 估算（2026-04-17）
    "adr_parity":    332.01,   # 理論值 = 5 × NT$2,085 ÷ 31.38（台股 4/17）
    "adr_ratio":     "5:1",    # 1 ADR = 5 台積電普通股
    "usd_ntd":        31.38,   # 同 MACRO 台幣匯率
    "adr_premium_pct": "+17.5",# (390.00 - 332.01) / 332.01 × 100
...
EPS_REVISION = {
    ...
    "analyst_view": "Q1 2026 財報確認：淨利 NT$572.5B（$18.1B，+58% YoY）創歷史新高，連續第 10 季超越市場預期（平均超預期幅度 +6.2%）。Q2 指引收入 $39.0-40.2B（遠超共識 $37.5-39.0B），全年 2026 收入年增 >30% 目標確認，CapEx 向 $52-56B 高端靠齊。財報後（4/17）台股 2330 收 NT$2,085（-0.48%），NYSE TSM 估算 $390.00（-0.51%），屬正常獲利了結。NVIDIA 正式超越 Apple 成 TSMC 最大客戶（22% 佔比），法說會確認 CoWoS 封裝供不應求。31 位分析師全數看多，共識目標 NT$2,290（自 NT$2,085 有 +9.8% 上行空間），部分分析師已上調至 US$515。",
...
NEWS = [
    {
        ...
        "title": "TSMC Q1 淨利 +58% 達 $18.1B，Q2 指引 $39-40.2B 大幅超越預期",
        "body": "TSMC 公布 Q1 2026 財報，淨利 NT$572.5B（約 $18.1B，+58% YoY）創歷史新高，連續第 10 季超越市場預期。Q1 收入 $35.9B（+35.1% YoY，+8.4% QoQ）超越共識。最亮眼為 Q2 指引：收入 $39.0-40.2B，遠超市場共識 $37.5-39.0B，意味季度環比成長約 10%。全年 2026 收入年增 >30% 目標確認，CapEx 向 $52-56B 高端靠齊。財報後首日（4/17）台股 -0.48% 屬正常獲利了結，中長線基本面顯著強化。",
        "source": "CNBC / Bloomberg / Taipei Times 2026-04-16/17", "impact": "正面",
    },
    {
        "tag": "地緣政治", "tag_color": "#607D8B",
        "title": "TSMC 警告伊朗戰爭推高供應鏈成本，氦氣等關鍵材料採多元佈局",
        "body": "TSMC 在 Q1 2026 財報法說會上警告，伊朗戰爭持續推高全球供應鏈成本，尤其影響氦氣、氫氣等晶片製造關鍵化學品供應。TSMC 執行長表示，公司已從多個供應來源採購特種化學品及氣體，並建立安全庫存，預計短期內對營運無顯著衝擊。但中東地緣政治局勢持續升高，能源成本上漲對 TSMC 製造成本有潛在壓力，為 Q2 毛利率主要觀察變數。美國對半導體展開 301 進口關稅調查，後續政策走向仍需持續追蹤。",
        "source": "Washington Times / ABC News / CNBC 2026-04-16", "impact": "中性",
    },
    {
        "tag": "客戶動態", "tag_color": "#2196F3",
        "title": "NVIDIA 正式超越 Apple 成 TSMC 最大客戶，佔 2026 年營收 22%",
        "body": "NVIDIA CEO 黃仁勳正式確認 NVIDIA 已取代 Apple 成為 TSMC 最大客戶，2026 年預計貢獻 TSMC 約 $33B 收入（22%），Apple 退居第二約 $27B（17%）。此轉換反映 AI GPU 需求爆發性成長，NVIDIA Blackwell/GB300 晶片比手機 SoC 更複雜，單位製造成本更高，大幅提升 TSMC 每晶圓平均售價（ASP）。AMD 亦確認為 TSMC N2 節點首批客戶，EPYC Venice（Zen 6）預計 2026 年量產，進一步強化 TSMC 先進製程護城河。",
        "source": "CNBC / eWeek / Digitimes 2026-01-26/04-17", "impact": "正面",
    },
    {
