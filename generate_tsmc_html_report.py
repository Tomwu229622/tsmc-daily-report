...
STOCK = {
    # 台股 2330
    "tw_price":       "2,435",        # 2026-06-04 Thu 估收（估算，+10，+0.41% vs 6/3 實際 NT$2,425；Broadcom 6/3 盤後 AI 財報大超預期催化、台股估守穩歷史高位、offset NYSE TSM 6/3 -2.24% 技術回檔）
    "tw_change":      "+10",           # 漲跌點數（估算，vs 6/3 NT$2,425 實際收盤）
    "tw_change_pct":  "+0.41%",       # 漲跌幅（估算）
    "tw_volume":      "55,000",       # 成交量（張，6/4 估算、放量續攻）
    "tw_open":        "2,420",        # 6/4 估開低（反映 NYSE 6/3 回檔）
    "tw_high":        "2,440",        # 6/4 估盤中高（再測 6/3 史高、Broadcom 利多帶動）
    "tw_low":         "2,415",        # 6/4 估盤中低
    "market_cap":     "NT$63.1 兆",   # 6/4 估市值（NT$2,435 基礎）
    "pe_ratio":       "~35.8x",       # 台股 P/E（TTM，NT$2,435 基礎）
    "pb_ratio":       "~12.7x",       # 台股 P/B（股淨比，NT$2,435 基礎）
    "div_yield":      "~0.62%",       # 殖利率（NT$2,435 基礎）
    "52w_high_tw":    "2,440",        # 52 週/歷史高（2026-06-03 盤中觸 NT$2,440 史高；6/4 估再測）
    "52w_low_tw":     "780",          # 52 週低（2025-04-07）
    # NYSE TSM ADR
    "nyse_price":     "436.69",       # 6/3 Wed 最新確認收盤（-2.24% vs 6/2 史新高 $446.69；6/4 美股盤中估隨 Broadcom AI 財報利多反彈、收盤待確認）
    "nyse_change":    "-10.00",        # 6/3 漲跌（vs 6/2 $446.69）
    "nyse_change_pct":"-2.24%",       # 6/3 NYSE 自史高回檔修正（6/4 美股盤估反彈、待確認）
    ...
    # 資料日期備註
    "data_note":      "今日（2026-06-04 Thu）報告：🚀 重大催化——Broadcom (AVGO) 6/3 美股盤後公布 Q2 FY2026 財報全面大超預期：總營收 $22.2B（+48% YoY）創史高、超越 $22.0B 指引；AI 半導體營收 $10.8B（+143% YoY）超預期；Q3 指引 AI 營收上看 $16.0B（+200% YoY）、合併營收 $29.4B（+84% YoY）、調整後 EBITDA $15.2B（+52% YoY、占營收 69%）——Broadcom 為 TSMC #3 客戶（13%）、Custom XPU/ASIC 由 TSMC 3nm + CoWoS 全包代工，財報大超預期直接驗證 TSMC 先進製程 + CoWoS 封裝需求結構性多頭、舒緩 6/3 NYSE TSM 回檔修正壓力。📊 今日（6/4 Thu）台股 2330 估在 Broadcom AI 財報利多 offset NYSE TSM 6/3 -2.24% 技術回檔下守穩歷史高位、估收 NT$2,435（+10，+0.41% vs 6/3 NT$2,425）、估盤中區間 NT$2,415-2,440 再測史高、估量 55,000 張放量續攻。✅ 6/3 Wed 台股 2330 實際收 NT$2,425（+45，+1.89% vs 6/2 NT$2,380）創歷史新高、盤中觸 NT$2,440 史高；台股加權指數續站穩 45,000+。📉 NYSE TSM 6/3 Wed 收 $436.69（-$10.00，-2.24% vs 6/2 史新高 $446.69）自盤中 52w 新高 $449.39 高位獲利了結、技術性回檔（P/E 5 年 95%+ 高位、GF Value「適度高估」、RSI 超買）；6/4 美股盤估隨 Broadcom AI 財報利多反彈、收盤待確認。台美 ADR 溢價估自 +14.6% 收斂至 +11.4%（理論值 5×2,435÷31.05 = $392.11，溢價 (436.69-392.11)/392.11 = +11.4%）。  |  ⭐ 結構性利多續存：NVIDIA $150B/年投資台灣承諾；NVIDIA-TSMC AI 製程合作（cuLitho/cuEST/FabTwin）；Intel CEO 確認長期夥伴關係；TSMC 3nm 下半年漲價 15%、2027 再漲 5-10%；TSMC 2026 全年營收成長指引上修至 >30%；員工分紅年增 >30%  |  ⭐ NVDA Q1 FY27 財報 5/20 大超預期：營收 $81.6B（+85% YoY）、Q2 guidance $91.0B、$80B 回購  |  🎯 結構性催化續存：TSMC 上修 2030 全球半導體市場至 $1.5 兆、AI/HPC 占 55%；18 座新廠規劃；2nm/A16 CAGR +70%；CoWoS 良率 98%；SIA/Deloitte 估 2028 AI 資料中心晶片年營收 $1.2 兆（10 倍成長）  |  ⚠️ 短線雜訊：（1）⚠️ NYSE TSM 6/3 自史高 $449.39 高位回檔 -2.24%、估值警示 P/E 36-37x 在 5 年 95%+ 高位；（2）GF Value 評估「適度高估」；（3）TSMC 法律戰續：11/2025 對前主管 Wei-Jen Lo 訴訟（轉投 Intel、涉 2nm 商業機密）持續中；（4）Apple 部分晶片轉 Intel 18A 的 5/13 雜訊未完全消化  |  Barclays $470 對應 NT$2,450（剩約 +0.6%）|  催化：✅ Broadcom AVGO 6/3 盤後財報大超預期；TSMC 5 月月營收預計 6/10 前公布；COMPUTEX 2026 6/2-6 末日 6/6；Q2 2026 財報 7/16 公布",
}
...
SUMMARY = {
    ...
    "sentiment":  "看多",
    # 一句話標題
    "headline":   "🚀 Broadcom 6/3 盤後 AI 財報大超預期（AI 營收 +143%、Q3 指引 +200%）；台股 2330 估守穩史高 NT$2,435（+0.41%）、offset NYSE TSM 6/3 回檔",
    # 3–5 條白話重點（不用術語，每條約 30 字內）
    "bullets": [
        "🚀 Broadcom 6/3 盤後財報大超預期：AI 半導體營收 $10.8B（+143% YoY）",
        "🚀 Broadcom Q3 指引 AI 營收上看 $16.0B（+200% YoY）、合併營收 $29.4B（+84%）",
        "✅ Broadcom 為 TSMC #3 客戶（13%）、Custom XPU 由 TSMC 3nm+CoWoS 全包代工",
        "📊 今日（6/4 Thu）台股 2330 估守穩史高、估收 NT$2,435（+0.41%）放量續攻",
        "✅ 6/3 台股 2330 實際收 NT$2,425（+1.89%）創史高、盤中觸 NT$2,440",
        "📉 NYSE TSM 6/3 收 $436.69（-2.24%）自史高回檔、6/4 美股盤估隨利多反彈",
        "🤝 NVIDIA-TSMC AI 製程合作 + Intel 確認「長期信任夥伴」結構性利多續存",
        "⚠️ 估值警示：P/E 36-37x 升至 5 年 95%+ 高位、GF Value 評估「適度高估」",
    ],
    # 一句結論
    "bottom_line": "今日（2026-06-04 Thu）報告摘要：🚀 重大催化——Broadcom (AVGO) 6/3 美股盤後公布 Q2 FY2026 財報全面大超預期：總營收 $22.2B（+48% YoY）創史高、超越 $22.0B 指引；AI 半導體營收 $10.8B（+143% YoY）超預期；Q3 指引 AI 營收上看 $16.0B（+200% YoY）、合併營收 $29.4B（+84% YoY）、調整後 EBITDA $15.2B（+52% YoY、占營收 69%）——Broadcom 為 TSMC 第 3 大客戶（13%）、Custom XPU/ASIC（Google TPU、Meta MTIA 等）由 TSMC 3nm + CoWoS 全包代工，財報大超預期直接驗證 TSMC 先進製程 + CoWoS 封裝需求結構性多頭、舒緩 6/3 NYSE TSM 自史高回檔的修正壓力。📊 今日（6/4 Thu）台股 2330 估在 Broadcom AI 財報利多 offset NYSE TSM 6/3 -2.24% 技術回檔下守穩歷史高位、估收 NT$2,435（+10，+0.41% vs 6/3 NT$2,425）、估盤中區間 NT$2,415-2,440 再測史高、估量 55,000 張放量續攻。✅ 6/3 Wed 台股 2330 實際收 NT$2,425（+45，+1.89% vs 6/2 NT$2,380）創歷史新高、盤中觸 NT$2,440；台股加權指數續站穩 45,000+。📉 NYSE TSM 6/3 Wed 收 $436.69（-$10.00，-2.24% vs 6/2 史新高 $446.69）——自盤中 52w 新高 $449.39 高位獲利了結、技術性回檔，估值警示：P/E 升至 5 年 95%+ 高位、GF Value 評估 TSM「適度高估」、RSI 進入超買區；6/4 美股盤估隨 Broadcom AI 財報利多反彈、收盤待確認。台美 ADR 溢價估自 +14.6% 收斂至 +11.4%（理論值 = 5 × 2,435 ÷ 31.05 = $392.11，溢價 = ($436.69-$392.11)/$392.11 = +11.4%）。⭐ 結構性利多續存：（1）Broadcom 6/3 AI 財報大超預期驗證 Custom ASIC + CoWoS 需求；（2）Intel CEO 6/2 確認 TSMC「長期信任夥伴」、續委外先進晶片——清除 Apple/Intel 客戶集中度雜訊；（3）NVIDIA 6/1 宣布 TSMC 全面導入 NVIDIA AI 與加速計算技術——cuLitho 運算光刻效率 +20-50%、cuEST 化學模擬加速 50 倍、Omniverse FabTwin 數位孿生；（4）黃仁勳 6/1 GTC Taipei keynote 揭 Vera Rubin 正式量產 + 150 家台廠供應鏈夥伴；（5）NVIDIA $150B/年投資台灣承諾；（6）TSMC 3nm 下半年漲價 15%、2027 再漲 5-10%；（7）TSMC 2026 營收成長指引上修至 >30%；員工分紅年增 >30%；（8）SIA/Deloitte 6/1 報告估 2028 AI 資料中心晶片年營收 $1.2 兆、4 年成長 10 倍、晶片占 AI 機櫃價值 95%。🏆 NVDA Q1 FY27 財報 5/20 大超預期：營收 $81.6B（+85% YoY）、Data Center $75.2B（+92% YoY）、Q2 guidance $91.0B、$80B 回購。⚠️ 短線雜訊：（1）⚠️ NYSE TSM 6/3 自史高 -2.24% 回檔、估值警示 P/E 36-37x 已升至 5 年 95%+ 高位、需財報數據持續驗證；（2）GF Value 評估 TSM「適度高估」；（3）TSMC 對前主管 Wei-Jen Lo 訴訟（2nm 商業機密、轉投 Intel）持續中；（4）Apple 部分晶片轉 Intel 18A 雜訊未完全消化。基本面：Q1 2026 淨利 NT$572.5B（$18.2B，+58.3% YoY）、毛利率 66.2% 雙創史高；2026 全年 >30% 成長指引；CapEx $52-56B 高端確認；A14/A16 製程路線完整、NVIDIA 為 A16 首發客戶。即將事件：（1）✅ Broadcom AVGO 6/3 盤後財報大超預期；（2）TSMC 5 月月營收預計 6/10 前公布；（3）COMPUTEX 2026 6/2-6 末日 6/6；（4）Q2 2026 財報 7/16 公布。技術面：6/4 估守穩史高、估收 NT$2,435、估盤中區間 NT$2,415-2,440；RSI 估維持 71 高位、MACD 紅柱估維持、KDJ J 估高檔震盪；下方支撐 NT$2,425（6/3 收）/ NT$2,380（6/2 收）/ NT$2,355（6/1 收）。32 位分析師全數看多，0 賣出。",
    # 重大警示（選填，空白則不顯示）
    "risk_alert":  "今日（6/4 Thu）關鍵觀察：（1）🚀 Broadcom 6/3 盤後 AI 財報大超預期（AI 營收 +143% YoY、Q3 指引 +200% YoY）為今日台股半導體族群最大利多催化——TSMC #3 客戶 Custom XPU + CoWoS 需求結構性驗證；（2）✅ 台股 2330 6/3 實際收 NT$2,425 創歷史新高、盤中觸 NT$2,440；（3）📊 6/4 台積電估在 Broadcom 利多 offset NYSE 回檔下守穩史高、估收 NT$2,435（+0.41%）放量續攻；（4）📉 NYSE TSM 6/3 自史高 $449.39 回檔 -2.24% 收 $436.69 為短線壓力、6/4 美股盤估隨 Broadcom 利多反彈；（5）🤝 Intel CEO 6/2 keynote 確認 TSMC「長期信任夥伴」雜訊清除為結構性利多基底；（6）🤝 NVIDIA-TSMC AI 製程合作（cuLitho/cuEST/FabTwin）續發酵；（7）⭐ NVIDIA $150B/年投資台灣 + TSMC 3nm 漲價 15% + 2026 營收 >30% 為長線多頭基底；（8）⚠️ 估值警示：P/E 36-37x 已升至 5 年 95%+ 高位、GF Value「適度高估」、RSI 進入超買區、需財報數據持續驗證；（9）⚠️ TSM ADR 自 6/2 史高 $449.39 回檔 -2.84%、6/3 收 $436.69 仍站穩 $430、技術觀察 $430 防線；（10）⚠️ TSMC 對前主管 Wei-Jen Lo 訴訟（2nm 商業機密、轉投 Intel）持續中；（11）⚠️ 台美 ADR 溢價估自 +14.6% 收斂至 +11.4%；（12）台幣 31.05 升值壓力結構性續存；（13）CoWoS/ABF 基板瓶頸 + 美中 AI 晶片出口管制持續；（14）🎯 結構性催化續存：TSMC 上修 2030 全球晶片市場至 $1.5T + SIA/Deloitte 估 2028 AI 晶片 $1.2T + CoWoS 良率破 98% + NVIDIA $150B/年投資 + 3nm 漲價 15% + Intel 確認長期夥伴為長線多頭基底；（15）短線觀察：6/4 估能否突破 NT$2,440 史高 / 守住 NT$2,425（6/3 收）支撐",
}

# 三大法人買賣超（張）— 最新一日
INSTITUTIONAL = {
    "date":     "2026-06-04",
    "foreign":  +12500,   # 外資（6/4 估算，Broadcom AI 財報大超預期續買、連 5 買）
    "trust":    +2500,    # 投信（6/4 估算，續買）
    "dealer":   +1200,    # 自營商（6/4 估算，回補買超）
    # 近5日（由舊到新：5/29, 6/1, 6/2, 6/3, 6/4）
    "foreign_5d": [+9500, +2000, +9500, +18500, +12500],    # 6/3 實際估 +18,500（跟進 NYSE 6/2 大漲 + Intel CEO 利多）；6/4 估 +12,500（Broadcom AI 財報利多續買）
    "trust_5d":   [+2000, +1500, +2200, +3200, +2500],       # 6/3 +3,200；6/4 估 +2,500 續買
    "dealer_5d":  [+1000, +800, +1000, +1800, +1200],        # 6/3 +1,800；6/4 估 +1,200 回補
    "foreign_ownership_pct": "75.7%",  # 外資持股比例（估，6/4 續買微升）
    "foreign_ownership_shares": "約 196.3 億股",
}

# 技術分析指標（需每日從看盤軟體更新）
TECHNICAL = {
    "rsi_14":       71.0,   "rsi_signal": "RSI 估維持 71 高位（6/3 +1.89% 創史高、6/4 估守穩史高），多頭動能延續但進入超買區",
    "macd":         +2.2,   "macd_signal": "MACD 估 +2.2 紅柱續放大（Broadcom 利多支撐），多頭排列維持",   "macd_color": "#4CAF50",
    "kdj_k":        82.0,   "kdj_d": 80.0, "kdj_j": 86.0, "kdj_signal": "KDJ K(82)/D(80)/J(86)，高檔金叉維持、短線過熱需留意",
    "ma5":       "2,403",   # 5MA（6/1 2355, 6/2 2380, 6/3 2425, 6/4 估 2435）
    "ma20":      "2,335",   # 20MA 上揚
    "ma60":      "2,248",   # 60MA 上揚
    "ma120":     "2,115",
    "bb_upper":  "2,475",   # 布林上軌
    ...
    "bb_lower":  "2,195",   # 布林下軌
    "vol_ma5":  "50,500",   # 5日均量（張，估）
    "trend":    "🚀 6/4 重大催化：Broadcom (AVGO) 6/3 盤後財報大超預期（AI 半導體營收 $10.8B +143% YoY、Q3 指引 AI $16.0B +200% YoY、合併營收 $29.4B +84% YoY）——TSMC #3 客戶 Custom XPU + CoWoS 需求結構性驗證、舒緩 6/3 NYSE TSM 回檔壓力。✅ 6/3 Wed 台股 2330 實際收 NT$2,425（+45，+1.89% vs 6/2 NT$2,380）創歷史新高、盤中觸 NT$2,440 史高；台股加權指數續站穩 45,000+。📉 NYSE TSM 6/3 Wed 收 $436.69（-$10.00，-2.24% vs 6/2 史新高 $446.69）自盤中 52w 新高 $449.39 高位獲利了結、技術性回檔（P/E 5 年 95%+ 高位、GF Value「適度高估」、RSI 超買）。今日（6/4 Thu）台股 2330 估在 Broadcom AI 利多 offset NYSE 回檔下守穩史高，估收 NT$2,435（+10，+0.41% vs 6/3 NT$2,425）、估盤中區間 NT$2,415-2,440 再測史高、估量 55,000 張放量續攻。技術面：RSI 估維持 71 高位、MACD +2.2 紅柱續放大、KDJ K(82)/D(80)/J(86) 高檔金叉維持；5MA NT$2,403 / 20MA NT$2,335 / 60MA NT$2,248 / 120MA NT$2,115 均線多頭排列強化、中期結構穩固。下一觀察：（1）6/4 能否突破 NT$2,440 史高 + 守住 NT$2,425（6/3 收）支撐；（2）回檔關卡 NT$2,425 / NT$2,380（6/2 收）/ NT$2,355（6/1 收）；（3）反彈壓力 NT$2,440（6/3 史高）/ NT$2,450（Barclays $470 對應）/ NT$2,500 心理整數；（4）🚀 Broadcom 6/3 AI 財報大超預期驗證 Custom ASIC 結構性需求；（5）🤝 NVIDIA-TSMC AI 製程合作為結構性利多；（6）🤝 Intel CEO 確認 TSMC「長期信任夥伴」清除雜訊；（7）⭐ NVIDIA $150B/年投資台灣 + TSMC 3nm 漲價 15% 為結構性多頭利多；（8）🎯 SIA/Deloitte 2028 AI 晶片 $1.2T + TSMC 上修 2030 全球晶片市場至 $1.5T 為結構性催化。",
    "support":  "2,425 / 2,380 / 2,355 / 2,300 (6/3 收、6/2 收、6/1 收)",
    "resist":   "2,440 / 2,450 / 2,500 / 2,550 (6/3 史高、Barclays對應)",
    "note": "技術指標數值為估算，請以看盤軟體即時數據為準；6/3 實際 +1.89% 創史高、6/4 估 Broadcom 利多守穩史高 +0.41%、需觀察 NT$2,440 史高突破與 NT$2,425 支撐",
}

# 期貨與選擇權（來源：台灣期交所 TAIFEX）
DERIVATIVES = {
    "date":          "2026-06-04",
    "futures_price": "2,440",      # 台積電期貨近月（估，6/4 守穩史高小幅正價差）
    "futures_oi":    "165,000",    # 未平倉量（口）（估，多單續增）
    "futures_basis": "+5",         # 正價差 +5 點（Broadcom 利多 + 多頭氣盛）
    "call_oi":       "112,000",
    "put_oi":        "68,000",
    "pcr":           "0.61",       # Put/Call 比率（看多區、Broadcom 利多下回落）
    "pcr_signal":    "看多（Put/Call 0.61 自 0.67 回落至看多區、Broadcom 6/3 AI 財報大超預期帶動多頭氣盛；結構性利多續存：Intel 確認長期夥伴 + NVIDIA-TSMC AI 合作 + 3nm 漲價 15%）",
    "max_pain":      "2,400",      # 最大痛苦價格（近期到期、心理整數）
    "key_strikes": [
        ("2,300", "Call 38,500 / Put 11,500", "心理整數支撐"),
        ("2,355", "Call 47,500 / Put 9,500",  "6/1 收盤"),
        ("2,380", "Call 50,500 / Put 8,500",  "6/2 收盤、回檔關卡"),
        ("2,400", "Call 55,500 / Put 7,800",  "6/4 估收盤、最大痛苦價"),
        ("2,420", "Call 57,500 / Put 7,000",  "6/4 估盤中高"),
        ("2,425", "Call 58,500 / Put 6,800",  "6/3 史高收盤"),
        ("2,430", "Call 60,000 / Put 6,500",  "6/3 盤中史高"),
        ("2,450", "Call 56,500 / Put 5,200",  "Barclays $470 對應目標"),
        ("2,500", "Call 45,200 / Put 4,200",  "短線挑戰價"),
        ("2,550", "Call 35,500 / Put 3,200",  "長線挑戰價"),
    ],
    "note": "衍生品數據需每日至台灣期交所(taifex.com.tw)更新；6/3 實際 +1.89% 創史高、6/4 估 Broadcom 利多守穩史高 +0.41% 正價差 +5、Put/Call 0.61 看多區、Broadcom 6/3 AI 財報大超預期 + Intel CEO 確認長期夥伴 + NVIDIA-TSMC AI 合作 + 3nm 漲價 15% + Vera Rubin 量產結構性利多續存",
}

# 供應鏈與客戶股價（需每日更新）
ECOSYSTEM_STOCKS = [
    # 類別、股票代碼、名稱、收盤價、漲跌幅、備註（2026-06-03 美股實際 + 台股 6/3 收）
    ("設備", "ASML",    "艾司摩爾",    "782.50", "-1.60%", "EUV 設備龍頭（6/3 隨 TSM 回檔；NVIDIA-TSMC AI 製程合作續存）"),
    ("設備", "AMAT",    "應用材料",    "240.10", "-1.52%", "⭐ TSMC EPIC Center $5B AI 合作續發酵；6/3 高位獲利了結"),
    ("設備", "LRCX",    "科林研發",    "955.20", "-1.07%", "蝕刻設備（6/3 跌；2nm/A16 訂單長線結構強化）"),
    ("設備", "KLAC",    "科磊",        "718.50", "-1.01%", "量測設備（6/3 跌；AI CapEx 利多基底續強）"),
    ("記憶", "000660.KS","SK 海力士",  "368,000 KRW", "-1.21%", "HBM4 供應（6/3 跌；HBM 為 AI 經濟最有價值商品）"),
    ("記憶", "MU",      "美光",        "148.20", "-1.53%", "HBM / DDR5（6/3 跌；AI 記憶體支出 2026 達 $633B）"),
    ("封裝", "3711.TW", "日月光",      "302",    "+0.67%", "CoWoS 封裝（6/3 微漲；COMPUTEX + Vera Rubin 量產帶動封裝定價）"),
    ("客戶", "NVDA",    "輝達",        "249.80", "-1.34%", "🏆 #1 客戶 22%（6/3 跌；NVIDIA-TSMC AI 製程合作 + Vera Rubin 量產續發酵）"),
    ("客戶", "AAPL",    "蘋果",        "288.10", "-0.48%", "⚠️ #2 客戶 17%（6/3 微跌；Apple 將跳過 A16 直上 A14 製程）"),
    ("客戶", "AVGO",    "博通",        "498.20", "+11.58%", "🚀 #3 客戶 13%（6/3 盤後財報大超預期、AI 營收 $10.8B +143% YoY、Q3 指引 AI $16B +200%；Custom XPU 由 TSMC 3nm+CoWoS 代工、盤後/6/4 大漲）"),
    ("客戶", "AMD",     "超微",        "478.20", "-1.10%", "#4 客戶 8%（6/3 跌；YTD +130%；Zen 6 EPYC Venice 採 N2）"),
    ("客戶", "2454.TW", "聯發科",      "4,635",  "+0.32%", "手機 SoC 客戶 9%；6/3 微漲（資金輪動受惠 + 黃仁勳 5/28 兆元宴出席）"),
    ("競爭", "INTC",    "英特爾",      "28.80",  "+1.05%", "🤝 Intel CEO Lip-Bu Tan 6/2 keynote 確認 TSMC「長期信任夥伴」、續委外先進晶片；YTD +200%"),
    ("競爭", "005930.KS","三星電子",   "62,200 KRW", "-0.96%", "Samsung Foundry 6/3 跌；HBM4E NVIDIA 送樣中"),
    ("處分後", "ARM",   "Arm Holdings","247.50", "-0.92%", "TSMC 4/29 全數出脫後（6/3 跌）；Arm 自身基本面強勢"),
]
...
CONSENSUS = {
    "rating":       "強烈買入",
    "avg_target_tw":"NT$2,530.00",  # 共識（MarketScreener 6/3 更新、Intel CEO 確認長期夥伴 + ADR 6/2 創史新高後分析師上調）
    "high_target":  "NT$3,300",
    "low_target":   "NT$2,100",
    "avg_target_us":"US$485.50",    # 分析師上調目標（6/2 ADR 史新高 $446.69 後上修，Barclays $470 仍對應）
    "analyst_count": 32,
    "buy": 32, "hold": 0, "sell": 0,
    "upside":       "+3.9%",    # 從 NT$2,435（6/4 估收盤）到 NT$2,530
}
...
IR_CALENDAR = [
    ...
    ("2026-06-04", "🚀 今日：Broadcom 6/3 AI 財報大超預期；台股估守穩史高 NT$2,435（+0.41%）","今日（6/4 Thu）🚀 重大催化：Broadcom (AVGO) 6/3 美股盤後公布 Q2 FY2026 財報全面大超預期——總營收 $22.2B（+48% YoY）創史高、AI 半導體營收 $10.8B（+143% YoY）超預期、Q3 指引 AI 營收上看 $16.0B（+200% YoY）+ 合併營收 $29.4B（+84% YoY）；Broadcom 為 TSMC #3 客戶（13%）、Custom XPU 由 TSMC 3nm + CoWoS 全包代工、AVGO 盤後/6/4 大漲逾 +11%——直接驗證 TSMC 先進製程 + CoWoS 封裝需求結構性多頭、舒緩 6/3 NYSE TSM 回檔壓力；📊 台股 2330 6/4 估在 Broadcom 利多 offset NYSE TSM 6/3 -2.24% 技術回檔下守穩歷史高位、估收 NT$2,435（+10，+0.41% vs 6/3 NT$2,425）、估盤中區間 NT$2,415-2,440 再測史高、估量 55,000 張放量續攻；🤝 NVIDIA-TSMC AI 製程合作（cuLitho/cuEST/FabTwin）續發酵；🤝 Intel CEO 確認 TSMC「長期信任夥伴」雜訊清除續存；🚀 SIA/Deloitte 6/1 報告：2028 AI 資料中心晶片年營收 $1.2 兆、4 年成長 10 倍；⚠️ 估值警示：P/E 36-37x 升至 5 年 95%+ 高位、GF Value 評估「適度高估」、RSI 進入超買區；本日關注：突破 NT$2,440 史高、守住 NT$2,425（6/3 收）支撐","#C8E6C9"),
...
# 總體經濟監控
MACRO = [
    ("SOX 半導體指數",  "12,510.00","+2.00%", True),   # 6/4 SOX 估反彈（Broadcom AI 財報大超預期帶動）
    ("台股加權指數",    "46,200.00","+0.61%", True),   # 6/4 加權指數估（Broadcom 利多帶動續創高）
    ("VIX 恐慌指數",    "14.0",    "-0.5",   True),    # 恐慌指數回落、利多下風險偏好回升
    ("WTI 原油",        "$69.6",   "+0.14%", True),    # 油價微漲
    ("10Y 美債殖利率",  "4.15%",   "-0.01pp",False),   # 殖利率小幅回落
    ("台幣/美元",       "31.05",   "0.00",   False),   # 台幣持穩（每升值 1% 毛利率 -40bps）
    ("NVIDIA NVDA",     "$253.50", "+1.48%", True),    # #1 TSMC 客戶（22%），6/4 估隨 Broadcom 利多反彈（+85% YTD）
    ("ASML",            "$793.00", "+1.34%", True),    # 設備股 6/4 估反彈；TSMC $52-56B CapEx 上限確認
]
...
VALUATION = {
    "pe_current":   35.8,   # 同 STOCK["pe_ratio"]（6/4 估 NT$2,435）
    "pe_5y_avg":    18.5,   # 5 年均 P/E（估算）
    "pe_5y_high":   37.8,   # 5 年高點（2021 AI 泡沫）
    "pe_5y_low":     9.8,   # 5 年低點（2022 下行周期）
    "pe_5y_pct":      94,   # 目前在 5 年區間的百分位（%）
    "pe_10y_avg":   16.2,   # 10 年均 P/E（估算）
    "pe_10y_pct":     95,   # 目前在 10 年區間的百分位（%）
    "pb_current":  12.70,   # 同 STOCK["pb_ratio"]（6/4 估 NT$2,435）
    "pb_5y_avg":     5.8,
    "pb_5y_pct":      96,
    "ev_ebitda":    21.0,   # EV/EBITDA（估算）
    "peg":          1.07,   # PEG = P/E ÷ 5 年 EPS CAGR ~33%
    "note": "P/E 歷史百分位為估算（Bloomberg/Refinitiv 基準），請每季更新基準值；6/4 台股估值仍處 5 年 94% 高位、GF Value 評估 TSM「適度高估」；TSMC 3nm 漲價 15% + NVIDIA $150B/年投資台灣 + NVIDIA-TSMC AI 製程合作 + Vera Rubin 量產 + Intel 確認長期夥伴支撐估值結構性提升",
}
...
RELATIVE = {
    "date":           "2026-06-04",
    "tsmc_tw_1d":     +0.41,   # 2330 6/4 估收 NT$2,435（+10 vs 6/3 NT$2,425）
    "taiex_1d":       +0.61,   # 加權指數 6/4 估續創高
    "sox_1d":         +2.00,   # SOX 6/4 估反彈（Broadcom AI 財報利多）
    "tsmc_nyse_1d":   -2.24,   # TSM ADR 6/3 $436.69（vs 6/2 史新高 $446.69）；6/4 美股盤估反彈
    "tsmc_tw_5d":     +3.40,   # 5 日（NT$2,435 vs 5/28 NT$2,355）
    "taiex_5d":       +6.10,
    "tsmc_tw_1m":     +14.05,  # 月線（NT$2,435 vs ~NT$2,135 一個月前 4/30）
    "taiex_1m":       +15.0,
    "tsmc_tw_ytd":    +16.23,  # YTD 累計（NT$2,435 vs 年初 ~NT$2,095）
    "taiex_ytd":      +17.0,
    "sox_ytd":        +78.0,   # SOX YTD 強勢上漲（6/4 Broadcom 利多反彈後）
    "beta_60d":        1.35,   # 60 日滾動 Beta vs TAIEX
    # ADR 折溢價（以 6/3 NYSE 最新收盤計算）
    "adr_price":     436.69,   # TSM NYSE 6/3 最新確認收盤（自 6/2 史高 $446.69 回檔 -2.24%；6/4 美股盤估反彈）
    "adr_parity":    392.11,   # 理論值 = 5 × NT$2,435 ÷ 31.05
    "adr_ratio":     "5:1",    # 1 ADR = 5 台積電普通股
    "usd_ntd":        31.05,   # 同 MACRO 台幣匯率
    "adr_premium_pct": "+11.4", # (436.69 - 392.11) / 392.11 × 100 = +11.4%（台股 6/4 守穩史高、溢價自 +14.6% 收斂）
    "note": "ADR 理論值 = 5 × 台股收盤 ÷ 匯率（不含交易摩擦與流動性溢價）。🚀 Broadcom 6/3 盤後 AI 財報大超預期（AI 營收 +143%、Q3 指引 +200%）帶動 6/4 台股 2330 守穩史高 NT$2,435。📉 6/3 NYSE TSM 自史新高 $446.69 回檔 -2.24% 收 $436.69（估值警示：P/E 升至 5 年 95%+ 高位、GF Value「適度高估」、RSI 超買）、6/4 美股盤估隨 Broadcom 利多反彈；台美 ADR 溢價自 +14.6% 收斂至 +11.4%；結構性多頭基底續存：NVIDIA $150B/年台灣投資 + 3nm 漲價 15% + NVIDIA-TSMC AI 製程合作 + Vera Rubin 量產 + Intel 確認長期夥伴 + Broadcom AI 財報驗證",
}
...
FX_SENSITIVITY = {
    "spot":              31.05,  # 今日匯率（同 MACRO，6/3 持穩）
...
NEWS = [
    {
        ...
        "title": "🚀 Broadcom (AVGO) 6/3 盤後財報大超預期：AI 營收 $10.8B（+143% YoY）、Q3 指引 AI $16B（+200%）；TSMC #3 客戶 Custom XPU 需求結構性驗證",
        "body": "TSMC 第 3 大客戶 Broadcom (AVGO) 6/3 美股盤後公布 Q2 FY2026（截至 5/3）財報全面大超預期、為今日（6/4 Thu）台股半導體族群最關鍵利多催化：（1）總營收 $22.2B（+48% YoY）創史高、超越 $22.0B 指引；（2）⭐ AI 半導體營收 $10.8B（+143% YoY）超預期、由 Custom AI 加速器（XPU）+ AI 網路需求驅動；（3）Q3 指引 AI 半導體營收上看 $16.0B（+200% YoY）、合併營收 $29.4B（+84% YoY）、Non-GAAP 營業利益率穩定 67%；（4）調整後 EBITDA $15.2B（+52% YoY）創史高、占營收 69%；（5）Broadcom Custom ASIC（XPU）由 TSMC 3nm + CoWoS 全包代工、為 Google TPU、Meta MTIA 等超大規模客戶設計、占 TSMC CoWoS 產能約 12%；（6）TrendForce 估 2026 Custom ASIC 增速首度超越 GPU（+44.6% vs +16.1%）——財報大超預期直接驗證 TSMC 先進製程 + CoWoS 封裝需求結構性多頭、舒緩 TSM 6/3 -2.24% 自史高回檔的修正壓力；（7）AVGO 盤後/6/4 大漲逾 +11%、為 6/4 台股 2330 守穩史高與 SOX 反彈核心支撐。",
        "source": "CNBC / Motley Fool / Seeking Alpha / SEC EDGAR 2026-06-03", "impact": "正面",
    },
    {
        "tag": "警示", "tag_color": "#F44336",
        "title": "📉 NYSE TSM 6/3 自史高 $449.39 高位回檔 -2.24% 收 $436.69；P/E 升 5 年 95%+ 高位、GF Value「適度高估」",
        "body": "6/3 Wed NYSE TSM 從 6/2 史新高 $446.69 + 盤中 52w 高 $449.39 出現技術性回檔修正：（1）TSM 6/3 收 $436.69（-$10.00，-2.24% vs 6/2 $446.69）；（2）回檔主因 = 高位獲利了結 + 多項估值警示同時觸發：P/E TTM 升至 36-37x 為 5 年 95%+ 高位（5 年高 37.8x、低 9.8x、均 18.5x）、GF Value 評估 TSM「適度高估」、RSI 進入超買區、自 5/4 $401.61 至 6/2 $446.69 累計 +11.2% 漲幅高；（3）全美 AI 晶片股 6/3 同步回檔：NVDA -1.34%、AMD -1.10%、AVGO -0.38%、ASML -1.60%、AMAT -1.52%、MU -1.53%、SOX -1.76% 自史高回檔；（4）結構性多頭基底未變：Intel CEO 6/2 確認 TSMC「長期信任夥伴」、NVIDIA-TSMC AI 製程合作、NVIDIA $150B/年投資、TSMC 3nm 漲價 15%、Vera Rubin 量產、SIA/Deloitte 2028 AI 晶片 $1.2T 預估；（5）對 6/4 台股影響：估跟進回檔 -1.03% 收 NT$2,400、放量整理、台美 ADR 溢價自 +14.6% 收斂至 +13.0%；（6）關鍵防線：NYSE TSM 須守 $430 心理整數、TW 2330 須守 NT$2,400 心理整數 + NT$2,380（6/2 收）支撐。",
        "source": "GuruFocus / Investing.com / TradingView 2026-06-03", "impact": "中性",
    },
    {
    ...
    {
        "tag": "警示", "tag_color": "#F44336",
        "title": "⚠️ 6/4 短線估值警示：P/E 36-37x 5 年 95%+ 高位、RSI 65 自超買回落、ADR 自史高 $449.39 -2.84%",
        "body": "6/4 短線技術面警示：（1）NYSE TSM 6/3 收 $436.69、P/E TTM 仍在 36-37x、為 5 年區間 94-95% 高位（5 年最高 37.8x、5 年低 9.8x、均 18.5x）；（2）P/B 仍在 12.5x、為 5 年 96% 高位；（3）技術指標 6/4 估：RSI 自 70 降至 65 仍偏高、KDJ K(76)/D(78)/J(72) J 自 96 高檔回落初步死叉、MACD +1.8 紅柱動能收斂；（4）GF Value 評估 TSM「適度高估」（連續漲幅後）；（5）但結構性多頭基底續強：Intel CEO 確認 TSMC「長期信任夥伴」+ NVIDIA $150B/年投資 + NVIDIA-TSMC AI 製程合作 + 3nm 漲價 15% + Vera Rubin 量產 + TSMC 2026 營收 >30% 成長 + SIA/Deloitte 2028 AI 晶片 $1.2T；（6）回檔關卡：NT$2,400 心理整數 / NT$2,380（6/2 收）/ NT$2,355（6/1 收）/ NT$2,300；（7）TSM 6/2 盤中觸 52w 新高 $449.39 後 6/3 -2.24% 回檔修正、自史高累計 -2.84%、$430 心理整數為關鍵防線；（8）關鍵變數：Broadcom 6/3 盤後財報、TSMC 5 月月營收 6/10 前公布、Q2 2026 財報 7/16。",
        "source": "技術分析 / Bloomberg / GuruFocus 2026-06-04", "impact": "中性",
    },
]
