...
STOCK = {
    # 台股 2330
    "tw_price":       "2,180",        # 2026-04-29 收盤（-35 vs 4/28 NT$2,215，-1.58%；連 3 日修正、跌破 5MA NT$2,250 與心理 NT$2,200）
    "tw_change":      "-35",          # 漲跌點數（vs 4/28 NT$2,215）
    "tw_change_pct":  "-1.58%",       # 漲跌幅
    "tw_volume":      "42,860",       # 成交量（張，4/29 估算，續縮量約 9%）
    "tw_open":        "2,200",        # 4/29 開盤（跟進前夜 ADR 微反彈嘗試紅盤）
    "tw_high":        "2,210",        # 4/29 盤中高
    "tw_low":         "2,175",        # 4/29 盤中低
    "market_cap":     "NT$56.5 兆",   # 4/29 收盤市值（自 4/28 NT$57.4 兆下修）
    "pe_ratio":       "~32.2x",       # 台股 P/E（TTM，NT$2,180 基礎）
    "pb_ratio":       "~11.3x",       # 台股 P/B（股淨比，NT$2,180 基礎）
    "div_yield":      "~0.69%",       # 殖利率（NT$2,180 基礎）
    "52w_high_tw":    "2,330",        # 52 週高（2026-04-27 盤中創新高）
    "52w_low_tw":     "780",          # 52 週低（2025-04-07）
    # NYSE TSM ADR
    "nyse_price":     "393.79",       # 4/29 實際收盤（+1.45 vs 4/28 $392.34，+0.37%；ADR 隔夜微反彈、台美短線分歧）
    "nyse_change":    "+1.45",        # 4/29 實際（vs 4/28 $392.34）
    "nyse_change_pct":"+0.37%",       # 4/29 ADR 隔夜止跌微反彈、未能站回 $400 關卡
    "52w_high_nyse":  "404.98",       # 52 週高（2026-04-27 收盤）
    "52w_low_nyse":   "134.25",       # 52 週低（2025-04-07）
    "pe_nyse":        "~32.6x",       # NYSE USD 基礎 P/E（TTM，估算，$393.79 基礎）
    "pb_nyse":        "~11.5x",
    "beta":           "1.18",
    ...
    # 資料日期備註
    "data_note":      "⚠️ 今日（2026-04-30 Thu）重點：台股 2330 4/29 收 NT$2,180（-35，-1.58%）連 3 日修正、跌破 5MA NT$2,250 與心理 NT$2,200，距 4/27 NT$2,265 史高累計 -3.75%；NYSE TSM 4/29 收 $393.79（+0.37%）ADR 隔夜止跌微反彈但未站回 $400 關卡，自 4/27 $404.98 累計 -2.76%；台美短線分歧——ADR 微反彈、台股續跌  |  4/29 籌碼面：外資連 3 賣超估約 -8,500 張（賣壓收斂但仍偏空）、投信連 5 買 +650 接棒、自營連 4 買 +320，三大法人合計賣超約 7,530 張  |  OpenAI 雜訊持續發酵但 NVDA 4/29 嘗試反彈、AI 晶片股賣壓緩解；SOX 4/29 收平、TSM ADR 微紅證明基本面信心未崩  |  TSMC 北美技術論壇後續發酵：5 座 2nm 廠（新竹 2＋高雄 3）2026 量產啟動、首年出貨 +45% vs 3nm 同期；2nm 至 2028 CAGR +70%；Arizona Phase 1 2026 出貨 +80% YoY、熊本廠 +130% YoY  |  Arm 投資全數出脫 $231M（4/29 揭露 1.11M 股 @ $207.65）財務性持有非戰略  |  Q1 2026 淨利 $18.2B、毛利率 66.2% 雙創史高基本面不變；NVIDIA #1 客戶 22% 確認",
}
...
SUMMARY = {
    ...
    "sentiment":  "中性偏多",
    # 一句話標題
    "headline":   "📉 台股 2330 4/29 收 NT$2,180（-35，-1.58%）連 3 日修正、跌破心理 NT$2,200；NYSE TSM 4/29 微反彈收 $393.79（+0.37%）但未站回 $400；台美短線分歧、外資賣壓收斂、TSMC 全數出脫 Arm 持股 $231M",
    # 3–5 條白話重點（不用術語，每條約 30 字內）
    "bullets": [
        "📉 台股 2330 4/29 收 NT$2,180（-35，-1.58%）連 3 日修正，距 4/27 NT$2,265 史高累計 -3.75%；跌破 5MA + 心理 NT$2,200",
        "🇺🇸 NYSE TSM 4/29 收 $393.79（+1.45，+0.37%）ADR 隔夜微反彈但未站回 $400；台美短線分歧、ADR 領先止跌訊號浮現",
        "🏦 4/29 籌碼：外資連 3 賣估 -8,500 張（賣壓收斂自 -22,114）、投信連 5 買 +650 接棒、自營連 4 買 +320；合計賣超約 7,530 張",
        "📰 TSMC 4/29 揭露全數出脫 Arm 持股：1.11M 股 @ $207.65 共 $231M（屬財務性投資非戰略）；Arm 股價同步走弱",
        "🎯 北美論壇後續：5 座 2nm 廠（新竹 2、高雄 3）今年量產啟動、首年出貨 +45% vs 3nm；2nm 至 2028 CAGR +70%；Arizona +80% YoY、熊本 +130% YoY",
        "✅ 基本面不變：Q1 2026 淨利 $18.2B（+58.3% YoY）、毛利率 66.2% 雙創史高；NVIDIA #1 客戶 22% 確認；OpenAI 雜訊不影響 TSMC 多元客戶結構",
    ],
    # 一句結論
    "bottom_line": "今日（2026-04-30 Thu）報告摘要：昨日（4/29 Wed）台美雙市出現短線分歧——台股 2330 連 3 日修正收 NT$2,180（-35 點，-1.58% vs 4/28 NT$2,215），跌破 5MA NT$2,250 與心理 NT$2,200 兩道支撐，自 4/27 NT$2,265 史高累計 -3.75%；但 NYSE TSM 4/29 隔夜微反彈收 $393.79（+1.45，+0.37% vs 4/28 $392.34），雖未能站回 $400 關卡，ADR 領先止跌訊號浮現。修正主因延續：4/28 WSJ 報導 OpenAI 週活用戶 + 月營收雙不達標的雜訊持續發酵，但 4/29 NVDA 嘗試反彈、SOX 收平，AI 晶片股賣壓緩解。籌碼面同步收斂：4/29 外資連 3 賣超 TSMC 估 -8,500 張（自 4/28 -22,114 大幅收斂），投信連 5 買進 +650、自營商連 4 買 +320 接棒，三大法人合計賣超約 7,530 張，外資持股比例維持 ~75.0%。重大公司事件：TSMC 4/29 揭露全數出脫 Arm Holdings 持股，分次售出 1.11M 股 @ 加權均價 $207.65，總額 $231M（屬財務性投資非戰略性持股，Arm 股價同步走弱）。基本面不變：Q1 2026 淨利 $18.2B（+58.3% YoY）、毛利率 66.2% 雙創史高；2026 北美技術論壇後續延伸：5 座 2nm 廠（新竹 2 + 高雄 3）今年正式量產啟動，首年出貨將比 3nm 2023 首年高 +45%；2nm 產能至 2028 年 CAGR +70%；Arizona 廠 2026 出貨將較 2025 +80%、熊本廠 +130% YoY；A13（2029）、A12（2029，搭配 Super Power Rail 背面供電）、N2U（2028）、A16（2027）製程路線完整確認；CoWoS 5.5-reticle 量產中（>98% 良率），2028 將推出 14-reticle 可整合 10 大晶片 + 20 HBM 堆疊。技術面：4/29 收 NT$2,180 跌破 5MA NT$2,250 與心理 NT$2,200，RSI 估自 60.5 續降至約 52、KDJ K 跌破 D 死亡交叉確認、J 值自 73 降至約 50，MACD 動能趨弱但仍正值，布林帶回測中軌附近；下一支撐 NT$2,150（4/14 跳空缺口附近）、第二支撐 20MA NT$2,090；壓力 NT$2,200 收復、5MA NT$2,250、NT$2,265 / NT$2,330 史高。OpenAI 雜訊不影響 TSMC 多元化客戶結構（NVIDIA 22%、Apple 17%、Broadcom 13%），ADR 領先止跌訊號顯示市場開始消化雜訊。31 位分析師全數看多、共識目標 NT$2,320 距現價拉開至 +6.4%；Barclays $470 目標距 $393.79 剩 +19.4% 上行空間。",
    # 重大警示（選填，空白則不顯示）
    "risk_alert":  "⚠️ 連 3 日修正觀察：（1）台股 2330 4/29 收 NT$2,180（-1.58%）連 3 日修正，跌破 5MA NT$2,250 與心理 NT$2,200 兩道支撐；（2）但 NYSE TSM 4/29 微反彈 +0.37% 收 $393.79，台美短線分歧、ADR 領先止跌訊號出現；（3）外資連 3 賣超估 -8,500 張（自 -22,114 大幅收斂），賣壓緩解但仍偏空；（4）關注：今日（4/30 Thu）能否守住 NT$2,150 第一支撐 + ADR 站回 $400；（5）若 NT$2,150 失守則指向 20MA NT$2,090；（6）OpenAI 雜訊持續發酵但 NVDA/SOX 4/29 嘗試反彈，AI 賣壓緩解；（7）TSMC Arm 出脫 $231M 屬一次性財務操作、不影響基本面；（8）台幣 ~31.30 升值壓力結構性續存（每升值 1% 毛利率 -40bps）；（9）CoWoS / ABF 基板瓶頸 + 美中 AI 晶片出口管制持續；（10）NVIDIA 5 兆市值仍堅挺、Anthropic/Google/Meta 自研晶片需求支撐基本盤",
}

# 三大法人買賣超（張）— 最新一日
INSTITUTIONAL = {
    "date":     "2026-04-29",
    "foreign":  -8500,    # 外資（負=賣超）— 4/29 估算，連 3 賣但賣壓收斂自 -22,114
    "trust":    +650,     # 投信（4/29 估算，連 5 買 +650）
    "dealer":   +320,     # 自營商（4/29 估算，連 4 買 +320）
    # 近5日（由舊到新，最後一筆為 4/29）
    "foreign_5d": [+4200, +8306, -18940, -22114, -8500],  # 4/29：外資連 3 賣但收斂
    "trust_5d":   [+620,  +1168, +1850,  +861,   +650],   # 4/29：投信連 5 買
    "dealer_5d":  [+80,   +256,  -420,   +500,   +320],   # 4/29：自營連 4 買
    "foreign_ownership_pct": "75.0%",  # 外資持股比例（4/29 略降）
    "foreign_ownership_shares": "約 194.6 億股",
}

# 技術分析指標（需每日從看盤軟體更新）
TECHNICAL = {
    "rsi_14":       52.0,   "rsi_signal": "RSI 自 4/28 60.5 續降至 52.0 接近 50 中軸（中性），連 3 日修正後動能轉淡；若跌破 50 中軸則進入空方領域",
    "macd":         +2.5,   "macd_signal": "MACD 正值持續收斂（+4.8→+2.5），動能急速轉弱但仍正值未死叉；柱狀體續縮，下一觀察是否轉負",   "macd_color": "#FF9800",
    "kdj_k":        65.0,   "kdj_d": 73.0, "kdj_j": 49.0, "kdj_signal": "KDJ K 值 65.0、D 值 73.0 死亡交叉確認、J 值自 73 急降至 49，三線快速走弱；短線弱勢續強",
    "ma5":       "2,235",
    "ma20":      "2,095",
    "ma60":      "1,998",
    "ma120":     "1,888",
    "bb_upper":  "2,300",   # 布林上軌
    "bb_mid":    "2,095",   # 布林中軌（20MA）
    "bb_lower":  "1,975",   # 布林下軌
    "vol_ma5":  "39,600",   # 5日均量（張，4/29 略縮）
    "trend":    "台股 2330 4/29 收 NT$2,180（-35，-1.58%）連 3 日修正，跌破 5MA NT$2,235 與心理 NT$2,200 兩道支撐，距 4/27 NT$2,265 史高累計 -3.75%；NYSE TSM 4/29 微反彈 +0.37% 收 $393.79 但未站回 $400。台美短線分歧——ADR 領先止跌訊號浮現。技術面修正延續：RSI 自 60.5 續降至 52.0（接近 50 中軸）、MACD +2.5 動能急速收斂、KDJ K(65)/D(73) 死叉確認、J 值降至 49（退出超買並轉中性偏空）。均線多頭排列保持但短中期均線（5MA、20MA）開始收斂。下一觀察：能否守 NT$2,150（4/14 跳空缺口）+ NT$2,140-2,180 第一支撐區；若失守則指向 20MA NT$2,095；壓力 NT$2,200 心理整數收復 + 5MA NT$2,235 + NT$2,265 / NT$2,330 史高。共識目標 NT$2,320 距現價拉開至 +6.4%、Barclays $470 對應 NT$2,450 剩 +12.4% 上行空間擴大。ADR 領先止跌若延續至台股，可能形成短期築底機會。",
    "support":  "2,140–2,180",
    "resist":   "2,200 / 2,265",
    "note": "⚠️ 技術指標數值為估算，請以看盤軟體即時數據為準；4/29 連 3 日修正後 KDJ 死叉確認、RSI 接近 50 中軸",
}

# 期貨與選擇權（來源：台灣期交所 TAIFEX）
DERIVATIVES = {
    "date":          "2026-04-29",
    "futures_price": "2,184",      # 台積電期貨近月（估，4/29 收盤，正價差收斂）
    "futures_oi":    "108,200",    # 未平倉量（口）（估，4/29 多單續離場 -4%）
    "futures_basis": "+4",         # 正價差續收斂至 +4 點（多頭情緒持續退燒）
    "call_oi":       "68,800",
    "put_oi":        "47,500",
    "pcr":           "0.69",       # Put/Call 比率回升至 0.69（避險買盤明顯回升）
    "pcr_signal":    "中性偏多（Put/Call 自 0.61 升至 0.69，避險買盤明顯回升、多頭情緒進一步緩和）",
    "max_pain":      "2,150",      # 最大痛苦價格（近期到期，隨現貨下修）
    "key_strikes": [
        ("2,100", "Call 22,200 / Put 9,500", "20MA 附近強支撐"),
        ("2,150", "Call 25,500 / Put 8,800", "最大痛苦點，第一支撐區"),
        ("2,180", "Call 28,200 / Put 7,200", "4/29 收盤價"),
        ("2,200", "Call 31,500 / Put 6,200", "心理整數，多空分界"),
        ("2,215", "Call 32,800 / Put 5,500", "4/28 收盤價、短線壓力"),
        ("2,265", "Call 35,200 / Put 3,600", "4/27 史前高、強壓力"),
        ("2,330", "Call 26,200 / Put 2,300", "4/27 盤中史高"),
    ],
    "note": "⚠️ 衍生品數據需每日至台灣期交所(taifex.com.tw)更新；4/29 連 3 日修正後 Put/Call 0.69 中性偏多",
}

# 供應鏈與客戶股價（需每日更新）
ECOSYSTEM_STOCKS = [
    # 類別、股票代碼、名稱、收盤價、漲跌幅、備註（2026-04-29 收盤，AI 晶片股賣壓緩解、ADR 領先止跌）
    ("設備", "ASML",    "艾司摩爾",    "688.20", "+0.85%", "EUV 設備龍頭（4/29 微反彈；2nm 訂單能見度長線正面）"),
    ("設備", "AMAT",    "應用材料",    "182.40", "+0.86%", "CVD/PVD 設備（4/29 隨晶片股反彈）"),
    ("設備", "LRCX",    "科林研發",    "824.50", "+0.46%", "蝕刻設備（4/29 微反彈；2nm 訂單長線結構續穩）"),
    ("設備", "KLAC",    "科磊",        "612.80", "+0.74%", "量測設備（4/29 反彈；OpenAI 雜訊消化中）"),
    ("記憶", "000660.KS","SK 海力士",  "310,500 KRW", "+0.81%", "HBM4 供應（4/29 微反彈；GB300 訂單續穩）"),
    ("記憶", "MU",      "美光",        "106.80", "+1.33%", "HBM / DDR5（4/29 反彈，AI 算力疑慮緩解）"),
    ("封裝", "3711.TW", "日月光",      "244",    "-1.6%",  "CoWoS 封裝（4/29 續弱；Arizona 2029 封裝廠不變）"),
    ("客戶", "NVDA",    "輝達",        "932.40", "+0.79%", "#1 客戶 22%（4/29 +0.79% 嘗試反彈；OpenAI 雜訊消化）"),
    ("客戶", "AAPL",    "蘋果",        "219.20", "+0.64%", "#2 客戶 17%（4/29 抗跌續強；非 AI 算力直接受害）"),
    ("客戶", "AVGO",    "博通",        "212.80", "+1.14%", "#3 客戶 13%（4/29 +1.14% 反彈；Custom XPU 訂單續穩）"),
    ("客戶", "AMD",     "超微",        "183.50", "+1.21%", "#4 客戶 8%（4/29 +1.21% 反彈；MI450 訂單長線續穩）"),
    ("客戶", "2454.TW", "聯發科",      "2,260",  "-1.31%", "手機 SoC 客戶 9%，4/29 跟跌；2nm 首批量產不變"),
    ("競爭", "INTC",    "英特爾",      "22.62",  "+0.76%", "Intel Foundry 18A 爬坡；4/29 微反彈"),
    ("競爭", "005930.KS","三星電子",   "55,400 KRW", "+0.36%", "Samsung Foundry 4/29 微反彈；HBM4E NVIDIA 送樣中"),
    ("被處分", "ARM",   "Arm Holdings","202.30", "-2.6%",  "TSMC 4/29 揭露全數出脫 1.11M 股 @ $207.65 共 $231M（屬財務性投資）"),
]

# 法人評級彙整
ANALYST_RATINGS = [
    ("Barclays",       "增持",     "US$470",   "2026-04-22", "⭐ AI 需求結構性 + A14/A16 領先；對應 NT$2,450，距 4/29 NT$2,180 剩 +12.4% 空間擴大"),
    ("Goldman Sachs",  "強烈買入", "NT$2,330", "2026-04-16", "Conviction Buy，Q1 財報後上調；4/29 修正後距現價剩 +6.9%"),
    ...
    ("MarketScreener", "共識買入", "NT$2,320", "2026-04-29", "31 位分析師、0 位賣出（4/29 NT$2,180 修正後上行空間擴大至 +6.4%，提供更佳布局窗口）"),
]

CONSENSUS = {
    "rating":       "強烈買入",
    "avg_target_tw":"NT$2,320",  # 共識（Barclays 升評後）— 4/29 NT$2,180 距共識 +6.4%
    "high_target":  "NT$2,770",
    "low_target":   "NT$1,740",
    "avg_target_us":"US$525",    # 分析師上調目標（Barclays $470 上拉均值）
    "analyst_count": 31,
    "buy": 31, "hold": 0, "sell": 0,
    "upside":       "+6.4%",    # 從 NT$2,180（4/29 收盤）到 NT$2,320 — 連 3 日修正後上行空間擴大
}
...
IR_CALENDAR = [
    ...
    ("2026-04-29", "📉 連 3 日修正、ADR 領先止跌微反彈","台股 2330 4/29 收 NT$2,180（-35，-1.58%）連 3 日修正、跌破 5MA NT$2,250 與心理 NT$2,200 兩道支撐；NYSE TSM 4/29 微反彈收 $393.79（+1.45，+0.37%）但未站回 $400 關卡；台美短線分歧、ADR 領先止跌訊號浮現；外資連 3 賣超估 -8,500 張（自 -22,114 大幅收斂）、投信連 5 買 +650、自營連 4 買 +320，三大法人合計賣超 7,530 張；TSMC 4/29 揭露全數出脫 Arm 持股 1.11M 股 @ $207.65 共 $231M（財務性投資）；NVDA/SOX 4/29 嘗試反彈、AI 賣壓緩解","#9E9E9E"),
    ("2026-04-30", "⭐ 今日：底部試探 + 5MA NT$2,235 為關鍵壓力","昨日（4/29）台美短線分歧——台股續跌、ADR 微反彈，今日（4/30 Thu）市場關注：（1）NVDA 4/29 嘗試反彈延續性，SOX 能否再上行；（2）KDJ 死叉確認、RSI 接近 50 中軸，動能持續轉弱；（3）今日支撐 NT$2,140-2,180（4/14 跳空缺口 + 第一支撐區），第二支撐 20MA NT$2,095；壓力 NT$2,200 心理整數收復 + 5MA NT$2,235；（4）連 3 日修正後 Barclays $470 距 $393.79 剩 +19.4% 上行空間、NT$2,450 對應 +12.4% 風險報酬比續優；（5）關注：外資能否轉中性（連 4 賣 = 籌碼進一步惡化；買賣均衡或翻多 = 築底確認）；（6）基本面不變：5 座 2nm 廠量產啟動，Arizona +80%、熊本 +130% 海外擴張全速","#BBDEFB"),
...
# 總體經濟監控
MACRO = [
    ("SOX 半導體指數",  "10,510.20","+0.15%", True),   # 4/29 SOX 微反彈、AI 賣壓緩解
    ("美元指數 DXY",    "97.5",    "-0.2%",  False),  # 美元小貶、避險偏好回落
    ("VIX 恐慌指數",    "19.3",    "-1.1",   True),   # 恐慌指數回落、市場情緒回穩
    ("WTI 原油",        "$63.6",   "+0.6%",  True),   # 油價小漲
    ("10Y 美債殖利率",  "3.94%",   "+0.02pp",False),  # 殖利率小升
    ("台幣/美元",       "31.30",   "-0.02",  True),   # 台幣小升（每升值 1% 毛利率 -40bps）
    ("NVIDIA NVDA",     "$932.40", "+0.79%", True),   # #1 TSMC 客戶（22%），4/29 +0.79% 嘗試反彈
    ("ASML",            "$688.20", "+0.85%", True),   # 設備股 4/29 微反彈；2nm 訂單續穩
]
...
VALUATION = {
    "pe_current":   32.2,   # 同 STOCK["pe_ratio"]（4/29 NT$2,180）
    "pe_5y_avg":    18.5,   # 5 年均 P/E（估算）
    "pe_5y_high":   37.8,   # 5 年高點（2021 AI 泡沫）
    "pe_5y_low":     9.8,   # 5 年低點（2022 下行周期）
    "pe_5y_pct":      80,   # 目前在 5 年區間的百分位（%，4/29 修正後續降）
    "pe_10y_avg":   16.2,   # 10 年均 P/E（估算）
    "pe_10y_pct":     86,   # 目前在 10 年區間的百分位（%）
    "pb_current":  11.30,   # 同 STOCK["pb_ratio"]（4/29 NT$2,180）
    "pb_5y_avg":     5.8,
    "pb_5y_pct":      89,   # P/B 略修正
    "ev_ebitda":    19.2,   # EV/EBITDA（估算）
    "peg":          0.97,   # PEG = P/E ÷ 5 年 EPS CAGR ~33%
    "note": "P/E 歷史百分位為估算（Bloomberg/Refinitiv 基準），請每季更新基準值；4/29 連 3 日修正後估值續緩解",
}
...
RELATIVE = {
    "date":           "2026-04-29",
    "tsmc_tw_1d":     -1.58,   # 2330 4/29 收盤 NT$2,180（-35 vs 4/28 NT$2,215）
    "taiex_1d":       -0.95,   # 加權指數 4/29 續跌（估）
    "sox_1d":         +0.15,   # SOX 4/29 微反彈
    "tsmc_nyse_1d":   +0.37,   # TSM ADR 4/29 $393.79（+0.37% vs 4/28 $392.34）
    "tsmc_tw_5d":     +6.34,   # 5 日（NT$2,180 vs 4/22 NT$2,050）
    "taiex_5d":       +2.80,
    "tsmc_tw_1m":     +12.9,   # 月線（NT$2,180 vs ~NT$1,930 一個月前）
    "taiex_1m":       +6.5,
    "tsmc_tw_ytd":    +4.06,   # Q1+4/1–4/29 累計（NT$2,180 vs 年初 ~NT$2,095）
    "taiex_ytd":      +1.8,
    "sox_ytd":        -8.5,    # SOX 4/29 微反彈但 YTD 仍弱
    "beta_60d":        1.22,   # 60 日滾動 Beta vs TAIEX
    # ADR 折溢價（以 4/29 實際 NYSE 收盤計算）
    "adr_price":     393.79,   # TSM NYSE 4/29 實際收盤
    "adr_parity":    348.24,   # 理論值 = 5 × NT$2,180 ÷ 31.30
    "adr_ratio":     "5:1",    # 1 ADR = 5 台積電普通股
    "usd_ntd":        31.30,   # 同 MACRO 台幣匯率
    "adr_premium_pct": "+13.1",# (393.79 - 348.24) / 348.24 × 100（溢價自 +10.9% 擴大、台美分歧）
    "note": "ADR 理論值 = 5 × 台股收盤 ÷ 匯率（不含交易摩擦與流動性溢價）。4/29 台美短線分歧——台股 -1.58% 續跌、ADR +0.37% 微反彈，溢價自 +10.9% 擴大至 +13.1%，反映海外投資人較台股投資人更早消化 OpenAI 雜訊",
}
...
EPS_REVISION = {
    ...
    "analyst_view": "Q1 2026 財報確認：淨利 NT$572.5B（$18.2B，+58.3% YoY）、毛利率 66.2%（+740bps YoY）雙創歷史新高，連續第 10 季超越市場預期（平均超預期幅度 +6.2%）。Q2 指引收入 $39.0-40.2B（遠超共識 $37.5-39.0B），全年 2026 收入 >30% 確認，CapEx 向 $52-56B 高端靠齊。近期價格：台股 2330 4/29 收 NT$2,180（-35，-1.58% vs 4/28 NT$2,215）連 3 日修正、跌破 5MA NT$2,250 與心理 NT$2,200，距 4/27 NT$2,265 史高累計 -3.75%；但 NYSE TSM 4/29 微反彈收 $393.79（+0.37% vs 4/28 $392.34）未站回 $400 關卡，台美短線分歧、ADR 領先止跌訊號浮現。修正主因延續：4/28 WSJ 報導 OpenAI 週活用戶+月營收雙不達標的雜訊持續發酵，但 4/29 NVDA +0.79%、AMD +1.21%、AVGO +1.14%、SOX 收平嘗試反彈，AI 賣壓緩解。4/29 籌碼面：外資連 3 賣超估 -8,500 張（自 4/28 -22,114 大幅收斂）、投信連 5 買 +650、自營連 4 買 +320，三大法人合計賣超約 7,530 張，外資持股比例 ~75.0%。重大公司事件：TSMC 4/29 揭露全數出脫 Arm Holdings 持股，分次售出 1.11M 股 @ 加權均價 $207.65、總額 $231M（屬財務性投資非戰略持股）。今日（2026-04-30 Thu）關注：（1）NVDA/SOX 反彈延續性、AI 賣壓是否持續緩解；（2）KDJ 死叉確認、RSI 接近 50 中軸，動能持續轉弱；（3）支撐 NT$2,140-2,180（4/14 跳空缺口 + 第一支撐）、第二支撐 20MA NT$2,095；壓力 NT$2,200 心理整數收復 + 5MA NT$2,235；（4）連 3 日修正後 Barclays $470 距 $393.79 剩 +19.4%、NT$2,450 對應 +12.4% 上行空間擴大；（5）外資能否轉中性（連 4 賣 = 警訊；買賣均衡 = 築底訊號）。技術論壇後續：5 座 2nm 廠（新竹 2 + 高雄 3）2026 量產啟動，首年出貨 +45% vs 3nm 2023；2nm 至 2028 CAGR +70%；Arizona +80% YoY、熊本 +130% YoY；A13/A12 2029、N2U 2028、A16 2027 路線完整確認；CoWoS 5.5-reticle 量產（>98% 良率）、2028 推出 14-reticle 整合 10 大晶片+20 HBM。NVIDIA #1 客戶 22% 確認，OpenAI 雜訊不影響 TSMC 多元客戶結構（NVIDIA 22%、Apple 17%、Broadcom 13%）。31 位分析師全數看多，共識目標 NT$2,320（自 NT$2,180 +6.4% 空間擴大），Barclays 目標 $470 對應台股約 NT$2,450（剩 +12.4%）。",
...
NEWS = [
    {
        ...
        "title": "📉 台股 2330 4/29 收 NT$2,180（-1.58%）連 3 日修正、跌破心理 NT$2,200；NYSE TSM 微反彈收 $393.79 台美短線分歧",
        "body": "台股 2330 4/29 收 NT$2,180（-35 點，-1.58% vs 4/28 NT$2,215），連續第 3 個交易日修正，跌破 5MA NT$2,250 與心理 NT$2,200 兩道支撐，距 4/27 史高 NT$2,265 累計 -3.75%；當日盤中區間 NT$2,175-2,210，量能續縮估約 42,860 張（vs 4/28 46,932 張）。但 NYSE TSM 4/29 隔夜微反彈收 $393.79（+1.45，+0.37% vs 4/28 $392.34），雖未能站回 $400 關卡，ADR 領先止跌訊號浮現。台美短線分歧——台股續跌、ADR 微反彈，反映海外投資人較台股投資人更早消化 OpenAI 不達標雜訊。ADR 對台股溢價自 +10.9% 擴大至 +13.1%（理論值 NT$2,180 × 5 ÷ 31.30 = $348.24）。短線觀察：今日（4/30 Thu）支撐 NT$2,140-2,180（4/14 跳空缺口 + 第一支撐區）、第二支撐 20MA NT$2,095；壓力 NT$2,200 心理整數收復 + 5MA NT$2,235。",
        "source": "TWSE / Yahoo Finance / Investing.com 2026-04-29", "impact": "中性",
    },
    {
        "tag": "客戶動態", "tag_color": "#2196F3",
        "title": "🏦 4/29 籌碼面：外資連 3 賣超估 -8,500 張賣壓收斂、投信連 5 買 +650 自營連 4 買 +320 接棒",
        "body": "台股 2330 4/29 三大法人籌碼動向出現重要轉折——外資連續第 3 個交易日賣超 TSMC，但賣壓估自 4/28 -22,114 張大幅收斂至約 -8,500 張（賣壓緩解但仍偏空）；投信延續第 5 個交易日買進 +650 張（連 5 買，續加碼）、自營商連 4 買 +320 張，三大法人合計賣超約 7,530 張（vs 4/28 -20,752 張收斂 64%）。外資持股比例自 4/28 約 75.1% 略降至 75.0%，外資 4/29 賣超台積電金額估約 NT$185 億。投信「在地承接」護盤格局延續，是台股築底重要支撐力。籌碼觀察：4/30 若外資轉買賣均衡或翻多，連 3 日修正築底訊號明確；若仍續賣則需警惕指向 20MA NT$2,095 第二支撐。",
        "source": "TWSE / Goodinfo / HiStock 2026-04-29", "impact": "中性",
    },
    {
        "tag": "法規政策", "tag_color": "#FF9800",
        "title": "📰 TSMC 4/29 揭露全數出脫 Arm Holdings 持股：1.11M 股 @ $207.65 共 $231M 屬財務性投資非戰略",
        "body": "TSMC 4/29 向美國 SEC 揭露已全數出脫 Arm Holdings（NASDAQ: ARM）持股，分次售出約 111 萬股，加權均價 $207.65，總額約 $231M（NT$72 億）；TSMC 自 2024 年起逐步減碼，至 4/29 完成清倉。市場分析：此次出脫屬「財務性投資」性質（TSMC 原以策略合作夥伴身分小額持有），非反映戰略合作惡化——TSMC 與 Arm 在 IP 授權與晶片設計合作仍正常運作（NVIDIA、Apple、MediaTek 旗下產品仍主要採用 Arm 架構在 TSMC 製造）。Arm 股價 4/29 同步走弱 -2.6% 收 $202.30，反映賣壓影響。對 TSMC 影響：（1）一次性財務操作不影響營業收入或本業毛利率；（2）資金回收後可投入 2nm/A14/A16 CapEx 加速；（3）顯示 TSMC 持續優化資產組合、聚焦核心晶圓製造業務。",
        "source": "Digitimes / GuruFocus / Invezz 2026-04-29", "impact": "中性",
    },
    {
        "tag": "產業趨勢", "tag_color": "#4CAF50",
        "title": "🎯 TSMC 5 座 2nm 廠 2026 量產啟動：新竹 2 + 高雄 3；首年出貨 +45% vs 3nm 同期；2nm 至 2028 CAGR +70%",
        "body": "Taipei Times、Focus Taiwan 與 Tribune India 4/29 報導 TSMC 北美技術論壇延伸資訊：TSMC 已正式啟動 5 座 2nm 晶圓廠量產（新竹 2 座 + 高雄 3 座），預計 2026 年首年出貨將比 2023 年 3nm 首年高 +45%。2nm 製程產能將維持 2026-2028 年 CAGR +70% 的擴張步調。海外擴張：Arizona Phase 1 廠 2026 出貨將較 2025 年 +80% YoY，熊本廠 +130% YoY，全球分散布局加速。先進製程路線完整確認：A13（2029 量產，A14 直接微縮、+6% 面積效率）、A12（2029 量產，搭配 Super Power Rail 背面供電技術鎖定 AI/HPC）、N2U（2028 量產，DTCO 設計）、A16（2027 量產，NVIDIA 為首批客戶）、Arizona 先進封裝廠（CoWoS+3D-IC，2029 啟用）。CoWoS 5.5-reticle 量產中、>98% 良率，2028 年將推出 14-reticle 可整合 10 大晶片 + 20 HBM 堆疊。",
        "source": "Taipei Times / Focus Taiwan / Tribune India 2026-04-29", "impact": "正面",
    },
    {
        "tag": "客戶動態", "tag_color": "#2196F3",
        "title": "🏢 4/29 AI 晶片股嘗試反彈：NVDA $932.40（+0.79%）、AMD +1.21%、AVGO +1.14%、SOX 收平、OpenAI 賣壓緩解",
        "body": "4/29 隔夜 AI 晶片股出現反彈訊號：NVIDIA 收 $932.40（+0.79% vs 4/28 $925.10），ADM 收 $183.50（+1.21% vs 4/28 $181.30 自重災區回升），AVGO 收 $212.80（+1.14% vs $210.40），ARM 雖續走弱但跌幅收斂；費城半導體指數 SOX 收 10,510.20（+0.15%）止跌微反彈。Apple 續抗跌收 $219.20（+0.64%）。OpenAI 不達標雜訊隔夜消化、市場開始消化結構性 AI 需求並未崩潰的事實——Anthropic、Google、Meta 自研 AI 晶片需求穩定，TSMC 客戶結構多元（NVIDIA 22%、Apple 17%、Broadcom 13%）。NVIDIA 已預訂 TSMC 2nm 產能至 2028 年，CoWoS 先進封裝 2026 NVIDIA 占 ~65%。AI 賣壓緩解、ADR 領先止跌，今日（4/30）若 NVDA/SOX 續強，台股有望跟進反彈。",
        "source": "CNBC / Yahoo Finance / Bloomberg 2026-04-29", "impact": "正面",
    },
    {
        "tag": "地緣政治", "tag_color": "#607D8B",
        "title": "🌐 TSMC Arizona Phase 1 2026 出貨 +80% YoY、熊本 +130% YoY；$165B 美國投資承諾與關稅豁免框架延續",
        "body": "TSMC 全球擴張進度確認：Arizona Phase 1 廠 2026 出貨將較 2025 年增加 +80%，2nm Phase 2 建設中（2028 量產），Phase 3 已規劃；熊本廠（JASM）Phase 1 量產中，2026 出貨 +130% YoY。美國總投資承諾達 $165B（已從原 $40B 上調 4 倍），華府已給予半導體進口關稅豁免框架，避免 25% 對等關稅衝擊。德國 Dresden 廠（ESMC 合資）建設中，預計 2027 量產 28/22nm 製程供歐洲汽車客戶。地緣分散有效降低台海風險溢價，是長線結構性利多；短線 Arizona Phase 1 良率持續爬坡（接近 ~100% 滿載），毛利率拖累幅度自 2-3pp 緩解至 1-2pp。Digitimes 評論：TSMC 透過垂直整合本地供應鏈與技術論壇生態系，仍在台灣本地維持核心競爭力。",
        "source": "Taipei Times / Focus Taiwan / Digitimes 2026-04-29", "impact": "正面",
    },
]
