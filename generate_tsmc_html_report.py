...
STOCK = {
    # 台股 2330
    "tw_price":       "2,275",        # 2026-06-11 Thu 盤中（+20，+0.89% vs 6/10 NT$2,255；逢低買盤、5 月營收創高後利多消化反彈）
    "tw_change":      "+20",          # 6/11 盤中漲跌點數（vs 6/10 NT$2,255）
    "tw_change_pct":  "+0.89%",       # 6/11 盤中漲跌幅
    "tw_volume":      "30,500",       # 6/11 盤中成交量（張，估、量縮整理 vs 6/10 42,439）
    "tw_open":        "2,245",        # 6/11 估開盤（跟進 NYSE 6/10 -4.47% 低開後翻紅）
    "tw_high":        "2,290",        # 6/11 盤中高（估）
    "tw_low":         "2,240",        # 6/11 盤中低（估）
    "market_cap":     "NT$59.0 兆",   # 6/11 盤中市值（NT$2,275 基礎）
    "pe_ratio":       "~33.5x",       # 台股 P/E（TTM，NT$2,275 基礎）
    "pb_ratio":       "~11.9x",       # 台股 P/B（股淨比，NT$2,275 基礎）
    "div_yield":      "~0.66%",       # 殖利率（NT$2,275 基礎）
    "52w_high_tw":    "2,440",        # 52 週/歷史高（2026-06-03 盤中觸 NT$2,440 史高）
    "52w_low_tw":     "780",          # 52 週低（2025-04-07）
    # NYSE TSM ADR
    "nyse_price":     "408.75",       # 6/10 Wed 實際收盤（-$19.14，-4.47% vs 6/9 $427.89；US 6/11 尚未開盤，維持 6/10 收盤）
    "nyse_change":    "-19.14",       # 6/10 漲跌（vs 6/9 $427.89）
    "nyse_change_pct":"-4.47%",       # 6/10 NYSE 重挫（US 6/11 尚未開盤）
    "52w_high_nyse":  "449.39",       # 52 週高（2026-06-02 盤中觸及 $449.39 創史新高）
    "52w_low_nyse":   "134.25",       # 52 週低（2025-04-07）
    "pe_nyse":        "~33.8x",       # NYSE USD 基礎 P/E（TTM，估算，$408.75 基礎）
    "pb_nyse":        "~11.7x",
    "beta":           "1.18",
    ...
    # 資料日期備註
    "data_note":      "報告日期：2026-06-11 Thu（今日台股盤中即時；NYSE TSM 維持 6/10 Wed 收盤、美股 6/11 尚未開盤）。⭐⭐⭐ 今日頭條——TSMC 5 月合併月營收正式公布 NT$4,169.75 億（NT$416.975 億元、US$13.17B）：年增 +30.1%、月增 +1.5%、創史上單月新高（超越 3 月與 4 月前高）；1–5 月累計 NT$1.96 兆、年增 +30%；公司可望挑戰單季營收新高（超越前高 NT$1.23 兆）。Taipei Times 6/11 確認 record revenue、CEO Wei 重申「全球半導體供應將數年內持續落後 AI 需求」。✅ 6/11 盤中逢低買盤：台股 2330 盤中翻紅至 NT$2,275（+20，+0.89% vs 6/10 NT$2,255）、量縮整理約 30,500 張、市值回升 NT$59.0 兆——昨日 -2.17% 利多出盡後低接買盤湧現、record-revenue 基本面獲確認。⚠️ 昨日（6/10）回顧：台股收 NT$2,255（-2.17%）放量、NYSE TSM 重挫 -4.47% 收 $408.75（-$19.14）——sell-the-news + 半導體類股回檔共振。台美 ADR 溢價以 6/10 ADR 收盤 + 6/11 台股盤中計：理論值 5×2,275÷31.05 = $366.35、溢價 (408.75-366.35)/366.35 = +11.57%（隨台股反彈進一步收斂）。  |  🎯 即將事件：Q2 2026 財報法說會 7/16（指引 $39.0-40.2B、+10% QoQ、+32% YoY、毛利率 65-67%）；下次月營收 7 月上旬公布 6 月數據  |  ⭐ 結構性利多續存（中長線基底未變）：TSMC CFO 6/10 暗示先進製程續漲價（3nm H2 漲 15%、sub-5nm 漲 5-10%）；6/4 AGM CEO Wei 確認 AI 需求超供應、2026 >30% 成長；TSMC 2nm 量產良率達 70-80% 領先全球、年底月產能 100K 片；4 大美國 CSP（Google/AWS/MSFT/Meta）2026 AI CapEx 合計 $725B（+77% YoY）；NVIDIA $150B/年投資台灣 + RTX Spark 超晶片由 TSMC 代工；NVIDIA-TSMC AI 製程合作（cuLitho/cuEST/FabTwin）；Intel CEO 確認長期夥伴；PwC 報告 TSMC 市值年增 +101% 躋身全球第 9 大市值企業  |  ⚠️ 本日（6/11）關鍵觀察：（1）台股 2330 盤中翻紅能否守住 NT$2,250 並站回 NT$2,295 / 5MA NT$2,310；（2）下方支撐 NT$2,250 / NT$2,200（心理整數）/ NT$2,165（120MA）；上方壓力 NT$2,295 / NT$2,305 / NT$2,365；（3）今晚 NYSE TSM 6/11 走勢為次日台股關鍵指標",
}
...
SUMMARY = {
    ...
    "sentiment":  "中性偏多",
    # 一句話標題
    "headline":   "✅ 利多消化後反彈：TSMC 5 月營收創高 NT$4,169.75 億（+30.1% YoY）確認，6/11 台股 2330 盤中翻紅至 NT$2,275（+0.89%）、逢低買盤回補",
    # 3–5 條白話重點（不用術語，每條約 30 字內）
    "bullets": [
        "✅ 6/11 盤中翻紅：台股 2330 盤中 NT$2,275（+20，+0.89% vs 6/10 NT$2,255）、量縮整理約 30,500 張、市值回升 NT$59.0 兆",
        "⭐ TSMC 5 月營收正式公布 NT$4,169.75 億（NT$416.975 億元、US$13.17B）、年增 +30.1%、創史上單月新高",
        "📊 5 月營收月增 +1.5%（超越 4 月與 3 月前高）、1-5 月累計 NT$1.96 兆、年增 +30%",
        "⚠️ 昨日（6/10）利多出盡：台股 -2.17%、NYSE TSM 重挫 -4.47% 收 $408.75（US 6/11 尚未開盤）",
        "🚀 公司可望挑戰單季營收新高（超越前高 NT$1.23 兆）、Q2 指引 $39.0-40.2B（+32% YoY）",
        "💰 TSMC CFO 暗示先進製程續漲價（3nm H2 漲 15%、sub-5nm 漲 5-10%）支撐毛利率；CEO Wei 重申供應數年落後需求",
        "⭐ 中長線基底未變：AI 需求超供應 + 2026 >30% 成長 + 2nm 量產 70-80% 良率 + 4 大 CSP CapEx $725B + PwC 市值全球第 9",
        "⚠️ 估值警示：TSM P/E ~33.5x 仍在 5 年 88-90% 高位、關鍵守住 NT$2,250、站回 NT$2,295",
    ],
    # 一句結論
    "bottom_line": "報告日期：2026-06-11 Thu（今日台股盤中即時；NYSE TSM 維持 6/10 Wed 收盤、美股 6/11 尚未開盤）。⭐⭐⭐ 今日頭條——TSMC 5 月合併月營收正式公布 NT$4,169.75 億（NT$416.975 億元、US$13.17B）：年增 +30.1%、月增 +1.5%、創史上單月新高（超越 3 月與 4 月前高）；1–5 月累計營收 NT$1.96 兆、年增 +30%；Taipei Times 6/11 確認 record revenue、分析師認為公司 well-positioned 達成 Q2 指引、並可望挑戰單季營收新高（超越前高 NT$1.23 兆）；CEO C.C. Wei 重申「全球半導體供應將數年內持續落後 AI 需求、要滿足客戶需求還需很長時間」。✅ 股價方面，昨日（6/10）利多出盡 sell-the-news 拋售後，今日（6/11）台股 2330 盤中逢低買盤回補翻紅至 NT$2,275（+20，+0.89% vs 6/10 NT$2,255）、量縮整理約 30,500 張、市值回升 NT$59.0 兆——record-revenue 基本面獲確認、低接買盤湧現。⚠️ 昨日（6/10）回顧：台股 2330 收 NT$2,255（-2.17%）放量 42,439 張、NYSE TSM 重挫 -4.47% 收 $408.75（-$19.14）、盤中 $407.70-$426.32——典型 sell-the-news + 半導體類股回檔共振、6/3 史高 NT$2,440 後高位獲利了結延續；US 6/11 尚未開盤、今晚 ADR 走勢為次日台股關鍵。台美 ADR 溢價以 6/10 ADR + 6/11 台股盤中計：理論值 5×2,275÷31.05 = $366.35、溢價 (408.75-366.35)/366.35 = +11.57%（隨台股反彈進一步收斂）。⭐ 中長線結構性利多基底未變：（1）💰 TSMC CFO 6/10 暗示先進製程續漲價——3nm H2 漲 15%、sub-5nm 漲 5-10%、反映 AI 強勁需求下的定價權；（2）🏛️ 6/4 AGM CEO Wei 確認 AI 需求將持續超越全球半導體供應、2026 >30% 成長指引；（3）⭐ TSMC 2nm 已開始量產、採用 nanosheet GAA 電晶體、初期良率 70-80% 領先全球；2026 年底 2nm 月產能目標 100,000 片；2nm 至 2028 CAGR +70%；（4）NVIDIA 仍為 TSMC 第 1 大客戶（22% / $33B）、Apple 第 2 大（18% / $27B）；（5）NVIDIA-TSMC AI 製程合作（cuLitho/cuEST/FabTwin）；（6）Intel CEO 6/2 確認 TSMC「長期信任夥伴」；（7）SIA 估 2028 AI 資料中心晶片年營收 $1.2 兆（+10x vs 2024）；（8）PwC 報告 TSMC 市值年增 +101% 躋身全球第 9 大市值企業。⚠️ 短期下行風險：（1）利多出盡 sell-the-news、6/3 史高後高位獲利了結延續；（2）Fed 升息預期升溫、10Y 美債殖利率 4.5%+；（3）美對中 AI 晶片出口管制擴大；（4）⚠️ 估值警示 TSM P/E ~33.8x 仍在 5 年 88-90% 高位；（5）半導體類股 6/5 以來波動加劇。基本面未變：Q1 2026 淨利 NT$572.5B（$18.2B、+58.3% YoY）、毛利率 66.2% 雙創史高；2025 全年 EPS NT$66.25。技術面（基於 6/11 盤中 NT$2,275）：5MA NT$2,310 / 20MA NT$2,320 / 60MA NT$2,300 / 120MA NT$2,170；下方支撐 NT$2,250 / NT$2,200 心理整數 / NT$2,165（120MA）；上方壓力 NT$2,295 / NT$2,305 / NT$2,365。32 位分析師全數看多、平均目標 NT$2,530 上行空間 +11.21%。",
    # 重大警示（選填，空白則不顯示）
    "risk_alert":  "今日（6/11 Thu）關鍵觀察：（1）✅ 台股 2330 盤中翻紅至 NT$2,275（+0.89% vs 6/10 NT$2,255）、逢低買盤回補、量縮整理約 30,500 張——昨日 -2.17% 利多出盡後低接湧現；（2）⭐⭐⭐ TSMC 5 月營收正式公布 NT$4,169.75 億（NT$416.975 億元）——年增 +30.1%、月增 +1.5%、創史上單月新高、1-5 月累計 NT$1.96 兆 +30%、Taipei Times 6/11 確認 record revenue；基本面強勁；（3）📉 昨日（6/10）回顧：台股收 NT$2,255（-2.17%）放量、NYSE TSM 重挫 -4.47% 收 $408.75；US 6/11 尚未開盤、今晚 ADR 走勢為次日台股關鍵；（4）💰 TSMC CFO 暗示 3nm H2 漲 15%、sub-5nm 漲 5-10% 續存利多；CEO Wei 重申供應數年落後需求；（5）🏆 PwC 報告 TSMC 市值年增 +101% 躋身全球第 9 大市值企業；（6）⭐ TSMC 2nm 量產初期良率 70-80% 領先全球、年底月產能目標 100K 片；（7）⭐ 4 大美國 CSP 2026 AI CapEx 合計 $725B（+77% YoY）；（8）⭐ 中長線結構性利多基底未變：AGM CEO Wei 確認 AI 需求超供應 + 2026 >30% 成長 + NVIDIA $150B/年投資 + RTX Spark 由 TSMC 代工 + Intel 確認長期夥伴；（9）⚠️ 估值警示 TSM P/E ~33.5x 仍在 5 年 88-90% 高位；（10）⚠️ Fed 升息預期升溫、10Y 美債殖利率突破 4.5%；（11）⚠️ 美對中 AI 晶片出口管制擴大；（12）台幣 31.05 升值壓力結構性續存；（13）📊 台美 ADR 溢價收斂至 +11.57%；（14）32 位分析師全數看多、平均目標 NT$2,530 上行空間 +11.21%；本日（6/11）關鍵：盤中翻紅能否守住 NT$2,250、站回 NT$2,295 / 5MA NT$2,310；下方支撐 NT$2,200 心理整數 / NT$2,165（120MA）",
}

# 三大法人買賣超（張）— 最新一日
INSTITUTIONAL = {
    "date":     "2026-06-11",       # 最新資料日（6/11 Thu 盤中估）
    "foreign":  +4500,              # 外資 6/11 估轉買超（逢低回補、營收創高確認）
    "trust":    +800,               # 投信 6/11 估買超
    "dealer":   +300,               # 自營商 6/11 估小幅買超
    # 近5日（由舊到新：6/5, 6/8, 6/9, 6/10, 6/11）
    "foreign_5d": [-2500, -18500, +5500, -12000, +4500],   # 6/11 估轉買超 +4,500（逢低回補）
    "trust_5d":   [-200, -1500, +800, -1500, +800],         # 6/11 估買超
    "dealer_5d":  [-200, -800, +200, -500, +300],           # 6/11 估小幅買超
    "foreign_ownership_pct": "75.1%",  # 外資持股比例（6/11 估，較 6/10 75.0% 略升）
    "foreign_ownership_shares": "約 194.7 億股",
}

# 技術分析指標（需每日從看盤軟體更新）
TECHNICAL = {
    "rsi_14":       47.0,   "rsi_signal": "RSI 估自 42 回升至 47（6/11 盤中翻紅 +0.89%），動能止穩、仍待站回中軸 50",
    "macd":         -0.15,  "macd_signal": "MACD 估自 -0.2 收斂至 -0.15、綠柱縮短、跌勢趨緩；需連續紅 K 確認翻多",   "macd_color": "#F44336",
    "kdj_k":        42.0,   "kdj_d": 40.0, "kdj_j": 46.0, "kdj_signal": "KDJ K(42)/D(40)/J(46) J 自 15 反彈至 46 脫離超賣區、低檔黃金交叉初現；逢低買盤回補確認",
    "ma5":       "2,310",   # 5MA（6/5 2365, 6/8 2305, 6/9 2305, 6/10 2255, 6/11 2275）— 基於 6/11 盤中
    "ma20":      "2,320",   # 20MA 轉壓力
    ...
    "bb_lower":  "2,190",   # 布林下軌
    "vol_ma5":  "39,000",   # 5日均量（張，估、基於 6/5-6/11 五日均；6/11 量縮至約 30,500）
    "trend":    "✅ 6/11 Thu 利多消化後反彈：台股 2330 盤中翻紅至 NT$2,275（+20，+0.89% vs 6/10 NT$2,255）、量縮整理約 30,500 張、市值回升 NT$59.0 兆——昨日 -2.17% 利多出盡 sell-the-news 後逢低買盤回補、record-revenue 基本面（5 月營收 NT$4,169.75 億、+30.1% YoY）獲確認。NYSE TSM 維持 6/10 收盤 $408.75（US 6/11 尚未開盤）、今晚 ADR 走勢為次日台股關鍵。📊 技術面（基於 6/11 盤中 NT$2,275）：RSI 47 自 42 回升仍待站回中軸、MACD -0.15 綠柱縮短跌勢趨緩、KDJ J(46) 自 15 反彈脫離超賣低檔金叉初現、短期 5MA NT$2,310 為近壓、中期 60MA/120MA 仍多頭。下一觀察：（1）✅ 盤中翻紅能否守住 NT$2,250、站回 NT$2,295 / 5MA NT$2,310；（2）下方支撐 NT$2,250 / NT$2,200 心理整數 / NT$2,165（120MA）；（3）上方壓力 NT$2,295 / NT$2,305（6/9 收）/ NT$2,365 / NT$2,400 整數；（4）⭐ 中長線結構性利多基底未變：CFO 暗示 3nm 漲 15% + CEO Wei 重申供應數年落後需求 + 2026 >30% 成長 + 2nm 量產 70-80% 良率；（5）🏆 PwC 報告 TSMC 市值躋身全球第 9；（6）⚠️ 需 NYSE TSM 6/11 同步止穩確認。",
    "support":  "2,250 / 2,200 / 2,165 / 2,155 (6/10 低、心理整數、120MA、心理整數)",
    "resist":   "2,295 / 2,305 / 2,310 / 2,365 / 2,400 (反彈關卡、6/9 收、5MA、6/5 收、整數)",
    "note": "技術指標數值為估算（基於 6/11 盤中 NT$2,275），請以看盤軟體即時數據為準；6/11 量縮翻紅、KDJ J 自 15 反彈至 46 低檔金叉初現、MACD 綠柱縮短跌勢趨緩；NT$2,250 為今日關鍵支撐、站回 NT$2,295 確認反彈",
}

# 期貨與選擇權（來源：台灣期交所 TAIFEX）
DERIVATIVES = {
    "date":          "2026-06-11",       # 最新資料日（6/11 Thu 盤中估）
    "futures_price": "2,275",            # 台積電期貨近月（6/11 盤中附近）
    "futures_oi":    "163,000",          # 未平倉量（口）（6/11 估、量縮整理）
    "futures_basis": "-4",               # 6/11 估逆價差收斂（避險情緒緩和）
    "call_oi":       "94,000",
    "put_oi":        "82,500",
    "pcr":           "0.88",             # Put/Call 比率（6/11 估自 0.95 回落至 0.88、空方避險縮手）
    "pcr_signal":    "中性（Put/Call 6/11 估回落至 0.88、自 6/10 0.95 縮減；反映盤中翻紅後避險買盤縮手、市場情緒回穩）",
    "max_pain":      "2,300",            # 最大痛苦價格（近期到期、6/11 估）
    "key_strikes": [
    ...
    "note": "衍生品數據需每日至台灣期交所(taifex.com.tw)更新；6/11 PCR 自 0.95 回落至 0.88 反映盤中翻紅後避險買盤縮手、逆價差自 -8 收斂至 -4、最大痛苦價維持 NT$2,300；NT$2,250 為今日關鍵支撐、站回 NT$2,295 確認反彈；中長線結構性利多基底未變（CFO 暗示 3nm 漲 15%、CEO Wei 重申供應數年落後需求、2nm 量產 70-80% 良率、Intel CEO 確認長期夥伴、NVIDIA-TSMC AI 合作、4 大 CSP CapEx $725B、PwC 報告 TSMC 全球市值排名躍升至第 9）",
}

# 供應鏈與客戶股價（需每日更新）
ECOSYSTEM_STOCKS = [
    # 類別、股票代碼、名稱、收盤價、漲跌幅、備註（美股為 2026-06-10 收盤、US 6/11 尚未開盤；台股為 6/11 盤中回穩；價格為估算）
    ("設備", "ASML",    "艾司摩爾",    "808.00", "-1.52%", "EUV 設備龍頭（6/10 回檔；6/10 年會 Musk 出席談 SpaceX/Tesla $55B 德州 Terafab 計畫）"),
    ("設備", "AMAT",    "應用材料",    "486.50", "-1.76%", "⭐ 6/10 回檔消化前波漲幅；Q2 財季營收創高、上修 2026 設備業務成長 >30%；TSMC EPIC Center $5B AI 合作續存"),
    ("設備", "LRCX",    "科林研發",    "975.00", "-1.52%", "蝕刻設備（6/10 回檔；半導體設備需求 $36.55B 創紀錄）"),
    ("設備", "KLAC",    "科磊",        "733.00", "-1.61%", "量測設備（6/10 回檔；2nm 量產驅動）"),
    ("記憶", "000660.KS","SK 海力士",  "366,000 KRW", "-0.68%", "HBM4 供應（6/10 小跌；AI 記憶體需求結構性多頭）"),
    ("記憶", "MU",      "美光",        "142.30", "-1.73%", "HBM / DDR5（6/10 回檔 -1.73%）"),
    ("封裝", "3711.TW", "日月光",      "293",    "+1.38%", "CoWoS 封裝（6/11 盤中跟進台股 2330 +0.89% 回穩反彈）"),
    ("客戶", "NVDA",    "輝達",        "243.20", "-1.86%", "🏆 #1 客戶 22%（6/10 回檔 -1.86%；Computex RTX Spark 由 TSMC 代工、結構性需求未變）"),
    ("客戶", "AAPL",    "蘋果",        "289.00", "-0.86%", "⚠️ #2 客戶 18%（6/10 小跌；Apple 將跳過 A16 直上 A14 製程）"),
    ("客戶", "AVGO",    "博通",        "444.00", "-1.38%", "🔄 #3 客戶 13%（6/10 回檔；Hock Tan 確認「custom AI chips only」策略、2027 AI 指引 >$100B 不變）"),
    ("客戶", "AMD",     "超微",        "485.00", "-1.72%", "#4 客戶 8%（6/10 回檔 -1.72%、YTD +115%；MI400 資料中心 GPU 持續搶市）"),
    ("客戶", "2454.TW", "聯發科",      "4,450",  "+1.25%", "手機 SoC 客戶 9%；6/11 盤中跟進台股半導體類股回穩 +1.25%；RTX Spark 由聯發科協同 NVIDIA 設計"),
    ("競爭", "INTC",    "英特爾",      "37.10",  "-1.07%", "6/10 小跌；Google AI 訂單催化、Wells Fargo 目標 $110、Barclays 升至 $100；Intel CEO 6/2 仍確認 TSMC「長期信任夥伴」"),
    ("競爭", "005930.KS","三星電子",   "61,800 KRW", "-0.64%", "Samsung Foundry 6/10 小跌；HBM4E NVIDIA 送樣中"),
    ("處分後", "ARM",   "Arm Holdings","239.00", "-1.28%", "TSMC 4/29 全數出脫後（6/10 回檔；半導體連動）"),
]
...
CONSENSUS = {
    ...
    "upside":       "+11.21%",   # 從 NT$2,275（6/11 盤中）到 NT$2,530
}
...
IR_CALENDAR = [
    ...
    ("2026-06-11", "✅ 利多消化後反彈、盤中翻紅 NT$2,275（+0.89%）；Taipei Times 確認 record revenue、CEO Wei 重申供應數年落後需求","6/11 Thu 台股 2330 盤中翻紅至 NT$2,275（+20，+0.89% vs 6/10 NT$2,255）、量縮整理約 30,500 張、市值回升 NT$59.0 兆——昨日 6/10 利多出盡 -2.17% sell-the-news 後逢低買盤回補、record-revenue 基本面（5 月營收 NT$4,169.75 億、+30.1% YoY、創單月新高）獲確認；Taipei Times 6/11 確認 record revenue、CEO C.C. Wei 重申「全球半導體供應將數年內持續落後 AI 需求」；6/11 估三大法人合計轉買超 +5,600 張（外資 +4,500、投信 +800、自營 +300）；NYSE TSM 維持 6/10 收盤 $408.75（US 6/11 尚未開盤）、今晚 ADR 走勢為次日台股關鍵；台美 ADR 溢價收斂至 +11.57%；技術面 RSI 自 42 回升至 47、KDJ J 自 15 反彈至 46 低檔金叉初現","#C8E6C9"),
...
# 總體經濟監控
MACRO = [
    ("SOX 半導體指數",  "12,920.00","-2.31%", False),  # 6/10 SOX/SOXX 收盤（US 6/11 尚未開盤）、TSM -4.47% 領跌
    ("台股加權指數",    "44,650.00","+1.06%", True),   # 6/11 盤中回穩反彈（估）、半導體類股逢低回補
    ("VIX 恐慌指數",    "18.6",    "+0.8",   False),   # 6/10 收盤（US 6/11 尚未開盤）；半導體回檔避險
    ("WTI 原油",        "$70.5",   "-0.42%", False),   # 油價小跌
    ("10Y 美債殖利率",  "4.48%",   "+0.02pp",False),   # 自 4.46% 微升、Fed 升息預期續存
    ("台幣/美元",       "31.05",   "0.00",   False),   # 台幣持穩（每升值 1% 毛利率 -40bps）
    ("NVIDIA NVDA",     "$243.20", "-1.86%", False),   # #1 TSMC 客戶（22%），6/10 回檔 -1.86%
    ("ASML",            "$808.00", "-1.52%", False),   # 設備股 6/10 回檔 -1.52%（6/10 年會 Musk 出席談 Terafab）
]
...
VALUATION = {
    "pe_current":   33.5,   # 同 STOCK["pe_ratio"]（6/11 盤中 NT$2,275）
...
RELATIVE = {
    "date":           "2026-06-11",       # 最新資料日（6/11 Thu 台股盤中；NYSE 為 6/10 收盤）
    "tsmc_tw_1d":     +0.89,   # 2330 6/11 盤中 NT$2,275（+20 vs 6/10 NT$2,255；逢低回補）
    "taiex_1d":       +1.06,   # 加權指數 6/11 盤中估回穩 +1.06%
    "sox_1d":         -2.31,   # SOX 6/10 收盤（US 6/11 尚未開盤）、TSM -4.47% 領跌
    "tsmc_nyse_1d":   -4.47,   # TSM ADR 6/10 $408.75 (-$19.14 vs 6/9 $427.89；US 6/11 尚未開盤)
    "tsmc_tw_5d":     -3.81,   # 5 日（NT$2,275 vs 6/4 NT$2,365）
    "taiex_5d":       -0.93,
    "tsmc_tw_1m":     -0.65,   # 月線（NT$2,275 vs NT$2,290 ~5/8）
    "taiex_1m":       +7.8,
    "tsmc_tw_ytd":    +8.59,   # YTD 累計（NT$2,275 vs 年初 ~NT$2,095）
    "taiex_ytd":      +12.5,
    "sox_ytd":        +66.5,   # SOX YTD 自高位回檔
    "beta_60d":        1.38,   # 60 日滾動 Beta vs TAIEX（反彈後微降）
    # ADR 折溢價（以 6/10 NYSE 收盤 & 6/11 TW 盤中計算）
    "adr_price":     408.75,   # TSM NYSE 6/10 實際收盤（US 6/11 尚未開盤）
    "adr_parity":    366.35,   # 理論值 = 5 × NT$2,275 ÷ 31.05
    "adr_ratio":     "5:1",    # 1 ADR = 5 台積電普通股
    "usd_ntd":        31.05,   # 同 MACRO 台幣匯率
    "adr_premium_pct": "+11.57", # (408.75 - 366.35) / 366.35 × 100 = +11.57%（隨台股反彈進一步收斂）
    "note": "ADR 理論值 = 5 × 台股收盤 ÷ 匯率（不含交易摩擦與流動性溢價）。✅ 6/11 Thu 台股 2330 盤中翻紅至 NT$2,275（+0.89% vs 6/10 NT$2,255）、量縮整理約 30,500 張——昨日 6/10 利多出盡 -2.17% 後逢低買盤回補、record-revenue 基本面（5 月營收 NT$4,169.75 億、+30.1% YoY）獲確認。⚠️ 昨日（6/10）回顧：NYSE TSM 重挫 -4.47% 收 $408.75（US 6/11 尚未開盤、維持此收盤）；📊 台美 ADR 溢價以 6/10 ADR + 6/11 台股盤中計算收斂至 +11.57%；🎯 今日（6/11 Thu）短線關鍵：盤中翻紅守住 NT$2,250、站回 NT$2,295；今晚 NYSE TSM 6/11 走勢為次日台股關鍵；⭐ 中長線結構性基底未變：CFO 暗示 3nm 漲 15% + CEO Wei 重申供應數年落後需求 + 2nm 量產 70-80% 良率 + NVIDIA $150B/年台灣投資 + 4 大 CSP CapEx $725B + Intel 確認長期夥伴 + PwC 報告 TSMC 市值躍居全球第 9",
}
...
NEWS = [
    {
        ...
        "title": "⭐⭐⭐ TSMC 5 月營收正式公布 NT$4,169.75 億（US$13.17B）、年增 +30.1%、創史上單月新高；1-5 月累計 NT$1.96 兆 +30%",
        "body": "TSMC 6/10 正式公布 5 月合併月營收、為市場焦點：（1）⭐ 5 月營收 NT$4,169.75 億（NT$416.975 億元、US$13.17B）、年增 +30.1%、月增 +1.5%、創史上單月新高（超越 3 月與 4 月前高）；（2）⭐ 1-5 月累計營收 NT$1.96 兆、年增 +30%；（3）分析師認為公司 well-positioned 達成 Q2 指引（$39.0-40.2B、+10% QoQ、+32% YoY）、並可望挑戰單季營收新高（超越前高 NT$1.23 兆）；（4）⭐ 與 CEO Wei 6/4 AGM「AI 需求將持續超越全球半導體供應」及 2026 全年 >30% 成長指引一致；（5）創高反映 N3/N2 先進製程滿載 + CoWoS 產能瓶頸下強勁出貨、NVIDIA/Apple/AMD/Google AI 與行動晶片拉貨延續；（6）【更正聲明】前一份 6/10 報告所載 5 月營收 NT$320.52B（NT$3,205 億、-8.3% MoM）為公布前誤植之估值、官方正式數字為 NT$416.975 億元（+30.1% YoY、+1.5% MoM、創單月新高）；（7）⭐ 對 TSMC 意涵：5 月營收驗證 AI 結構性需求、配合 PwC 報告市值躍升全球第 9，結構性多頭基底穩固；（8）下一里程碑：6 月營收 7 月上旬公布、Q2 2026 法說會 7/16 揭露 H2 展望。",
        "source": "Taipei Times / 鉅亨網 / TradingKey / The Motley Fool / TSMC IR 2026-06-10 - 06-11", "impact": "正面",
    },
    {
        "tag": "產業趨勢", "tag_color": "#4CAF50",
        "title": "✅ 利多消化後反彈：6/11 台股 2330 盤中翻紅至 NT$2,275（+0.89%）、逢低買盤回補；昨日 6/10 -2.17% sell-the-news 賣壓緩和",
        "body": "TSMC 5 月營收創高後股價走勢——昨日 sell-the-news、今日逢低回穩：（1）✅ 6/11 Thu 盤中台股 2330 翻紅至 NT$2,275（+20，+0.89% vs 6/10 NT$2,255）、量縮整理約 30,500 張（vs 6/10 42,439）、市值回升 NT$59.0 兆——昨日 -2.17% 利多出盡後逢低買盤湧現、record-revenue 基本面（5 月營收 NT$4,169.75 億、+30.1% YoY）獲確認；（2）⚠️ 昨日（6/10）回顧：台股 2330 收 NT$2,255（-50，-2.17%）放量、NYSE TSM 重挫 -4.47% 收 $408.75（-$19.14）、盤中 $407.70-$426.32——典型 record-revenue-yet-shares-decline 的 sell-the-news + 6/3 史高 NT$2,440 後高位獲利了結 + 半導體類股回檔共振；（3）US 6/11 尚未開盤、NYSE TSM 維持 6/10 收盤 $408.75、今晚 ADR 走勢為次日台股關鍵；（4）6/11 估三大法人合計轉買超約 +5,600 張（外資 +4,500、投信 +800、自營 +300）、外資持股比例回升至 75.1%；（5）台美 ADR 溢價自 +12.57% 進一步收斂至 +11.57%（隨台股反彈）；（6）✅ 技術面止穩：RSI 估自 42 回升至 47、MACD 綠柱縮短、KDJ J 自 15 反彈至 46 脫離超賣低檔金叉初現；（7）🎯 今日（6/11）關鍵：盤中翻紅能否守住 NT$2,250、站回 NT$2,295 / 5MA NT$2,310。",
        "source": "Yahoo Finance / gurufocus / cnyes 鉅亨 / TWSE / Goodinfo 2026-06-10 - 06-11", "impact": "正面",
    },
    {
        "tag": "產品發布", "tag_color": "#9C27B0",
        "title": "💰 TSMC CFO 暗示先進製程續漲價：3nm H2 漲 15%、sub-5nm 漲 5-10%；反映 AI 需求下定價權",
        "body": "TSMC 管理層 6/10 釋出進一步漲價訊號、強化毛利率展望：（1）💰 TSMC CFO 暗示先進製程價格將續漲——3nm（N3）下半年漲價最高達 15%、sub-5nm 製程漲 5-10%；（2）⭐ 漲價基礎：AI 晶片需求強勁、N3/N2 先進製程滿載、CoWoS 產能瓶頸、TSMC 在 2nm 以下製程具技術代差優勢與定價權；（3）⭐ 對毛利率意涵：漲價可抵銷海外擴廠（Arizona/熊本/德國）初期稀釋與台幣升值壓力、支撐毛利率維持 65-67% 高檔（Q1 2026 已達 66.2% 創史高）；（4）漲價對客戶（NVIDIA/Apple/AMD/Google）接受度高——AI 晶片佔客戶總成本比重低、且 TSMC 為唯一可靠先進產能來源；（5）⚠️ 業界觀察：漲價反映生產成本上升（先進製程設備、材料、海外建廠），但需留意是否影響成熟製程客戶與行動晶片需求彈性；（6）⭐ 對 TSMC 意涵：與 6/4 AGM CEO Wei 確認「3nm H2 漲 15% + 2027 再漲 5-10%」計畫一致、定價權為 AI 結構性需求超供應的直接體現。",
        "source": "Windows Central / Crypto Briefing / Taipei Times 2026-06-10 - 06-11", "impact": "正面",
    },
    {
        "tag": "客戶動態", "tag_color": "#2196F3",
        "title": "🏆 NVIDIA 確認超越 Apple 成 TSMC 第 1 大客戶 22% / $33B；NVIDIA-TSMC AI 製程合作深化",
        "body": "TSMC 主要客戶結構與動能更新：（1）🏆 NVIDIA 已超越 Apple 成為 TSMC 最大客戶——NVIDIA 2026 預估貢獻 TSMC 營收約 $33B（22%）vs Apple $27B（18%）；CEO 黃仁勳已公開確認、反映 AI 資料中心晶片需求爆發；（2）⭐ NVIDIA-TSMC 6/1 宣布 AI 製程合作（cuLitho +20-50%、cuEST 加速 50 倍、Omniverse FabTwin）、將 AI 與加速運算導入晶片製造、提升良率與產能效率；（3）此合作直接解決 TSMC 核心挑戰——在產能緊俏下為 NVIDIA、AMD、Google 等 AI 客戶生產足夠先進晶片；（4）⭐ NVIDIA Computex 2026 RTX Spark 超晶片由 TSMC N3E + CoWoS 代工、為新增量訂單；（5）AMD Q1 2026 營收 $10.3B（+38% YoY）大超預期、MI400 持續搶市；（6）Apple 將跳過 A16 直上 A14（2028 量產）、A16 首發客戶為 NVIDIA；（7）Intel CEO 6/2 確認 TSMC「長期信任夥伴」；（8）⭐ 對 TSMC 意涵：「首次由 AI（而非消費電子）主導最先進晶片製造步調」、NVIDIA + AMD + Apple 三大客戶 2026 合計貢獻 ~50% 營收。",
        "source": "CNBC / Dealroom / Simply Wall St / TweakTown 2026-06-10", "impact": "正面",
    },
    {
        "tag": "產業趨勢", "tag_color": "#4CAF50",
        "title": "⭐ SIA-Deloitte 估 2028 AI 資料中心晶片年營收 $1.2 兆（10x 成長）；晶片占 AI 伺服器 95% 價值",
        "body": "美國半導體產業協會 (SIA) 與 Deloitte 6/1 發布報告、確認 AI 資料中心晶片市場結構性多頭：（1）⭐ 2028 AI 資料中心晶片年營收估達 $1.2 兆、較 2024 增加近 10 倍；（2）⭐ 晶片占 AI 伺服器機架（rack）總價值 95%、占 AI 資料中心總資本支出 50%+；（3）⭐ 半導體設備銷售 2026 創 $36.55B 紀錄、由 AI 晶片產能投資驅動；（4）4 大美國 CSP（Alphabet/AWS/Microsoft/Meta）2026 AI CapEx 合計 $725B（+77% YoY）；（5）BofA 上修 2026 全球晶片市場至 $1.3 兆、點名 NVIDIA、Broadcom、Marvell、AMD 為四大成長引擎、全數為 TSMC 先進製程客戶；（6）TrendForce 估 Custom ASIC 增速 2026 首度超越 GPU（+44.6% vs +16.1%）；（7）⚠️ 短期雜訊：6/5 Broadcom 全年 AI 指引未上修曾引爆半導體拋售、市場對 AI CapEx 增速放緩仍有疑慮；（8）⭐ 對 TSMC 意涵：無論 GPU 或 ASIC 路線勝出、TSMC 3nm/2nm + CoWoS 皆為必經產能；$1.2 兆市場驗證 CEO Wei「AI 需求將持續超越全球半導體供應」論述。",
        "source": "SIA / Semiconductors.org / kavout / Yahoo Finance (BofA) 2026-06-01 - 06-10", "impact": "正面",
    },
    {
        "tag": "客戶動態", "tag_color": "#2196F3",
        "title": "🚀 NVIDIA RTX Spark 超晶片 Computex 2026 發表、TSMC 代工；Intel/AMD 股價承壓、ARM/Qualcomm 受惠",
        "body": "NVIDIA Computex 2026 RTX Spark 超晶片掀起半導體生態鏈震盪、TSMC 為核心受惠者：（1）🚀 RTX Spark「超晶片」結合 20 核 ARM Grace CPU + Blackwell RTX GPU、AI 效能達 1 petaflop、已搭載 Microsoft 新 Surface Laptop Ultra（128GB RAM）；（2）⭐ 由 TSMC N3E + CoWoS 先進封裝代工、為新增量訂單；（3）市場反應：消息推升 ARM、Qualcomm（agentic AI PC 期待）、但 Intel、AMD 股價承壓（PC 處理器競爭加劇疑慮）；（4）⭐ 對 TSMC 意涵：無論 x86（Intel/AMD）或 ARM（NVIDIA/Qualcomm/Apple）陣營勝出、先進製程晶片皆由 TSMC 代工、TSMC 為「賣鏟者」最大贏家；（5）AI PC 與 agentic AI 為 2026-2027 新成長動能、帶動 N3/N2 製程需求；（6）NVIDIA 6/1 GTC Taipei keynote 同步揭 Vera Rubin 正式量產（vs Blackwell 訓練 +3.5x、推理 +5x）、150 家台廠供應鏈夥伴；（7）⭐ 結構性多頭：AI 算力需求自資料中心擴散至終端裝置（PC/手機/機器人）、TSMC 先進製程產能成關鍵瓶頸。",
        "source": "peerlist semipulse / EE Times / NVIDIA Computex 2026 2026-06-01 - 06-10", "impact": "正面",
    },
]
