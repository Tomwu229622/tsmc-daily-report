...
STOCK = {
    # 台股 2330
    "tw_price":       "2,405",        # 2026-06-02 Tue 估收（估算，+50，+2.12% vs 6/1 NT$2,355；6/2 台股尚未收盤、追趕 ADR 6/1 +4.73% 大漲訊號）
    "tw_change":      "+50",           # 漲跌點數（估算，vs 6/1 NT$2,355 實際收盤）
    "tw_change_pct":  "+2.12%",       # 漲跌幅（估算）
    "tw_volume":      "52,000",       # 成交量（張，6/2 估算）
    "tw_open":        "2,395",        # 6/2 估跳空開高（追趕 ADR 6/1 +4.73%）
    "tw_high":        "2,415",        # 6/2 估盤中高（回測 6/1 盤中天價 NT$2,415）
    "tw_low":         "2,385",        # 6/2 估盤中低
    "market_cap":     "NT$62.4 兆",   # 6/2 估市值（NT$2,405 基礎）
    "pe_ratio":       "~35.4x",       # 台股 P/E（TTM，NT$2,405 基礎）
    "pb_ratio":       "~12.5x",       # 台股 P/B（股淨比，NT$2,405 基礎）
    "div_yield":      "~0.62%",       # 殖利率（NT$2,405 基礎）
    "52w_high_tw":    "2,415",        # 52 週/歷史高（2026-06-01 盤中天價 NT$2,415）
    "52w_low_tw":     "780",          # 52 週低（2025-04-07）
    # NYSE TSM ADR
    "nyse_price":     "439.78",       # 6/1 Mon 最新收盤（+4.73% vs 5/29 $418.45；COMPUTEX 開幕 + GTC Taipei keynote + NVIDIA-TSMC AI 製程合作三重催化、市值 $2.28T 創史新高）
    "nyse_change":    "+19.88",        # 6/1 漲跌
    "nyse_change_pct":"+4.73%",       # 6/1 NYSE 大漲創史新高
    "52w_high_nyse":  "443.18",       # 52 週高（2026-06-01 盤中觸及 $443.18 創史新高）
    ...
    # 資料日期備註
    "data_note":      "今日（2026-06-02 Tue）報告基準資料：⚠️ 6/1 Mon 台股 2330 雖盤中衝上天價 NT$2,415（市值 62.62 兆），但終場收平盤 NT$2,355（0.00% vs 5/29，高檔獲利了結、資金輪動至聯發科 +5.68% 等 AI 股），未跟進指數——台股加權指數 6/1 大漲 +604.97（+1.35%）收 45,337.91 創歷史新高、首度站穩 45,000。6/2 台股市場尚未收盤，本報告以估算值呈現：估收 NT$2,405（+50，+2.12% vs 6/1 NT$2,355、追趕 ADR），估開 NT$2,395、估盤中回測 6/1 天價 NT$2,415、估量 52,000 張。NYSE TSM 6/1 Mon 大漲 +4.73% 收 $439.78（vs 5/29 $418.45）、盤中觸 $443.18、市值 $2.28 兆雙創史新高。🚀 今日（6/2）關鍵催化：（1）⭐ COMPUTEX 2026 正式開幕日（6/2-6 全週題材）；（2）🎤 Intel CEO Lip-Bu Tan 6/2 13:30 台北時間 COMPUTEX keynote、聚焦 18A 量產進度（Panther Lake/Nova Lake/Clearwater Forest 全採 18A）+ Foundry 外部客戶宣告 + 與 TSMC 競合關係（18A 良率預計 2027 才達業界水準、Q1 Foundry 外部營收僅 $174M）；（3）🤝 NVIDIA 6/1 宣布 TSMC 全面導入 NVIDIA AI 與加速計算技術（cuLitho 運算光刻效率 +20-50%、cuEST 化學模擬加速 50 倍、Omniverse FabTwin 數位孿生）；（4）🏆 黃仁勳 6/1 GTC Taipei keynote 揭 Vera Rubin 正式量產（vs Blackwell 訓練 +3.5x、推理 +5x、成本降至 1/7）、N1X ARM 筆電晶片、150 家台廠供應鏈夥伴；台美 ADR 溢價估擴大至 +13.6%（6/2 估台股 NT$2,405、台幣 31.05、理論值 5×2,405÷31.05 = $387.28，溢價 (439.78-387.28)/387.28 = +13.6%、反映台股個股落後 ADR、催化跟漲動能）  |  ⭐ 結構性利多續存：NVIDIA $150B/年投資台灣承諾；NVIDIA-TSMC AI 製程合作（cuLitho/cuEST/FabTwin）；TSMC 3nm 下半年漲價 15%、2027 再漲 5-10%；TSMC 2026 全年營收成長指引上修至 >30%；員工分紅年增 >30%  |  ⭐ NVDA Q1 FY27 財報 5/20 大超預期：營收 $81.6B（+85% YoY）、Data Center $75.2B（+92% YoY）、Q2 FY27 guidance $91.0B、$80B 回購  |  🎯 結構性催化續存：TSMC 上修 2030 全球半導體市場預估至 $1.5 兆、AI/HPC 占 55%；2026 規劃 18 座新廠；2nm/A16 製程 2026-2028 CAGR +70%；CoWoS 良率突破 98%  |  ⚠️ 短線雜訊：（1）短線估值 P/E ~35.4x 在 5 年高位、需財報數據持續驗證；（2）TSM ADR 自 6/1 史高 $443.18 高位、技術超買警示；（3）6/1 台股個股收平盤顯示高檔換手壓力、漲多獲利了結；（4）Intel CEO 6/2 keynote 若揭重大外部客戶搶單恐成短線雜訊  |  Barclays $470 對應 NT$2,450（剩約 +1.9%）|  催化：TSMC 5 月月營收預計 6/10 前公布；COMPUTEX 2026 6/2-6、Intel CEO 6/2 keynote、Q2 2026 財報 7/16 公布",
}
...
SUMMARY = {
    ...
    "sentiment":  "看多",
    # 一句話標題
    "headline":   "🇺🇸 NYSE TSM 6/1 大漲 +4.73% 創史新高 $439.78（市值 $2.28T）；台股 2330 6/1 盤中天價 NT$2,415 但收平盤 NT$2,355；6/2 估反彈追趕 ADR、Intel CEO COMPUTEX keynote",
    # 3–5 條白話重點（不用術語，每條約 30 字內）
    "bullets": [
        "🇺🇸 NYSE TSM 6/1 大漲 +4.73% 收 $439.78、盤中觸 $443.18、市值 $2.28T 創史新高",
        "⚠️ 台股 2330 6/1 盤中衝天價 NT$2,415 但收平盤 NT$2,355（高檔獲利了結、資金輪動）",
        "📈 台股指數 6/1 大漲 604 點收 45,337 創新高；6/2 台積電估反彈 NT$2,405（+2.12%）追趕 ADR",
        "🤝 NVIDIA-TSMC 6/1 宣布 AI 製程合作（cuLitho/cuEST/FabTwin、效率 +20-50%）",
        "🏆 黃仁勳 GTC Taipei keynote 揭 Vera Rubin 量產、150 家台廠供應鏈夥伴",
        "🎤 Intel CEO Lip-Bu Tan 6/2 13:30 台北 COMPUTEX keynote、18A 量產進度待揭",
        "⭐ 結構性利多續存：NVIDIA $150B/年投資 + 3nm 漲價 15% + 2026 營收 >30%",
    ],
    # 一句結論
    "bottom_line": "今日（2026-06-02 Tue）報告摘要：⚠️ 6/1 Mon 台股 2330 雖盤中衝上天價 NT$2,415（市值 62.62 兆）但終場收平盤 NT$2,355（0.00% vs 5/29），未跟進大盤——高檔獲利了結 + 資金輪動至聯發科（+5.68% 收 NT$4,555）等其他 AI 股；台股加權指數 6/1 大漲 +604.97（+1.35%）收 45,337.91 創歷史新高、首度站穩 45,000。6/2 台股市場尚未收盤，本報告以估算值呈現：估收 NT$2,405（+50，+2.12% vs 6/1 NT$2,355、追趕 ADR）、估盤中回測 6/1 天價 NT$2,415、估量 52,000 張。NYSE TSM 6/1 Mon 大漲 +4.73% 收 $439.78（vs 5/29 $418.45）、盤中觸 $443.18、市值 $2.28 兆雙創史新高，三重催化：COMPUTEX 開幕 + GTC Taipei keynote + NVIDIA-TSMC AI 製程合作。台美 ADR 溢價估擴大至 +13.6%（理論值 = 5 × 2,405 ÷ 31.05 = $387.28，溢價 = ($439.78-$387.28)/$387.28 = +13.6%），反映台股個股暫落後 ADR、催化 6/2 跟漲動能。🚀 今日（6/2）關鍵催化：（1）COMPUTEX 2026 正式開幕日；（2）Intel CEO Lip-Bu Tan 6/2 13:30 台北時間 COMPUTEX keynote、聚焦 18A 量產進度（Panther Lake/Nova Lake/Clearwater Forest 全採 18A）+ Foundry 外部客戶宣告 + 與 TSMC 競合關係；（3）NVIDIA 6/1 正式宣布 TSMC 全面導入 NVIDIA AI 與加速計算技術——cuLitho 運算光刻效率 +20-50%、cuEST 化學模擬加速 50 倍、Omniverse FabTwin 數位孿生；（4）黃仁勳 6/1 GTC Taipei keynote 揭 Vera Rubin 正式量產（vs Blackwell 訓練 +3.5x、推理 +5x、成本降至 1/7）、N1X ARM 筆電晶片、150 家台廠供應鏈夥伴。⭐ 結構性利多續存：NVIDIA $150B/年投資台灣承諾；NVIDIA Taipei 總部 5/27 動土；TSMC 3nm 下半年漲價 15%、2027 再漲 5-10%；TSMC 2026 營收成長指引上修至 >30%；員工分紅年增 >30%。🏆 NVDA Q1 FY27 財報 5/20 大超預期：營收 $81.6B（+85% YoY）、Data Center $75.2B（+92% YoY）、Non-GAAP EPS $1.87、毛利率 75%、Q2 FY27 guidance $91.0B ±2%、$80B 回購。⚠️ 短線雜訊：（1）6/1 台股個股收平盤顯示高檔換手、漲多獲利了結壓力；（2）TSM ADR 自 6/1 史高 $443.18 高位、技術超買警示；（3）短線估值 P/E ~35.4x 在 5 年高位、需財報數據持續驗證；（4）Intel CEO 6/2 keynote 若揭重大外部客戶搶單恐成短線雜訊。基本面：Q1 2026 淨利 NT$572.5B（$18.2B，+58.3% YoY）、毛利率 66.2% 雙創史高；2026 全年 >30% 成長指引；CapEx $52-56B 高端確認；A14/A16 製程路線完整、NVIDIA 為 A16 首發客戶。即將事件：（1）TSMC 5 月月營收預計 6/10 前公布；（2）COMPUTEX 6/2-6 題材；（3）Q2 2026 財報 7/16 公布。技術面：6/2 估反彈追趕 ADR、估收 NT$2,405、回測 6/1 天價 NT$2,415；RSI 估約 68 強勢區、MACD +2.0 紅柱、KDJ K(78)/D(72)/J(90) 偏高；下方支撐 NT$2,355（6/1 收）/ NT$2,300 / NT$2,255 心理整數。32 位分析師全數看多，0 賣出。",
    # 重大警示（選填，空白則不顯示）
    "risk_alert":  "今日（6/2 Tue）關鍵觀察：（1）🚀 NYSE TSM 6/1 +4.73% 大漲 $439.78、盤中觸 $443.18、市值 $2.28T 創史新高為今日台股最大催化；（2）⚠️ 6/1 台股 2330 盤中衝天價 NT$2,415 卻收平盤 NT$2,355、未跟進大盤、高檔獲利了結 + 資金輪動，台股個股動能明顯落後 ADR；（3）📈 6/2 估反彈 NT$2,405（+2.12%）追趕 ADR、回測天價 NT$2,415；（4）🤝 NVIDIA-TSMC 6/1 宣布 AI 製程合作（cuLitho/cuEST/FabTwin）為結構性利多；（5）🎤 Intel CEO Lip-Bu Tan 6/2 13:30 台北 COMPUTEX keynote、18A 量產進度 + Foundry 外部客戶 + 競合關係觀察；（6）⭐ NVIDIA $150B/年投資台灣 + TSMC 3nm 漲價 15% 結構性多頭基底續強；（7）⚠️ 台美 ADR 溢價估擴大至 +13.6%、台股個股估值落後 ADR；（8）TSMC 3nm 漲價 15%、2027 再漲 5-10% 確認定價權、毛利率結構性提升；（9）TSMC 上修 2026 營收成長 >30%、員工分紅年增 >30%、人才留任強化；（10）⚠️ 短線估值 P/E ~35.4x 在 5 年高位、需財報數據持續驗證；（11）⚠️ TSM ADR 自 6/1 史高 $443.18 高位、技術超買警示；（12）台幣 31.05 升值壓力結構性續存；（13）CoWoS/ABF 基板瓶頸 + 美中 AI 晶片出口管制持續；（14）Intel CEO 6/2 keynote 若揭重大外部客戶搶單恐成短線雜訊；（15）🎯 結構性催化續存：TSMC 上修 2030 全球晶片市場至 $1.5T + CoWoS 良率破 98% + NVIDIA $150B/年投資 + 3nm 漲價 15% + NVIDIA-TSMC AI 製程合作為長線多頭基底",
}

# 三大法人買賣超（張）— 最新一日
INSTITUTIONAL = {
    "date":     "2026-06-02",
    "foreign":  +12000,   # 外資（6/2 估算，追趕 ADR、買盤回升）
    "trust":    +2500,    # 投信（6/2 估算，題材買盤）
    "dealer":   +1200,    # 自營商（6/2 估算，避險買進）
    # 近5日（由舊到新：5/27, 5/28, 5/29, 6/1, 6/2）
    "foreign_5d": [+21500, +24000, +9500, +2000, +12000],    # 6/1：TSMC 收平盤、資金輪動、外資 TSMC 買超縮至 +2,000；6/2 估追趕 ADR +12,000
    "trust_5d":   [+2800, +3000, +2000, +1500, +2500],        # 6/1：投信 +1,500；6/2 估 +2,500
    "dealer_5d":  [+1200, +1500, +1000, +800, +1200],         # 6/1：自營 +800；6/2 估 +1,200
    "foreign_ownership_pct": "75.4%",  # 外資持股比例（估）
    "foreign_ownership_shares": "約 195.6 億股",
}

# 技術分析指標（需每日從看盤軟體更新）
TECHNICAL = {
    "rsi_14":       68.0,   "rsi_signal": "RSI 估 68.0（6/1 收平盤後 6/2 估反彈、回落至強勢區未及超買），多頭動能仍偏強",
    "macd":         +2.0,   "macd_signal": "MACD 估 +2.0 紅柱（6/1 收平盤動能略收斂、6/2 反彈），多頭排列維持",   "macd_color": "#4CAF50",
    "kdj_k":        78.0,   "kdj_d": 72.0, "kdj_j": 90.0, "kdj_signal": "KDJ K(78)/D(72)/J(90)，J 在高檔但較前日回落、短線偏多",
    "ma5":       "2,347",   # 5MA（5/27 2300, 5/28 2320, 5/29 2355, 6/1 2355, 6/2 估 2405）
    "ma20":      "2,290",   # 20MA 上揚
    "ma60":      "2,210",   # 60MA 上揚
    "ma120":     "2,090",
    "bb_upper":  "2,440",   # 布林上軌
    "bb_mid":    "2,290",   # 布林中軌（20MA）
    "bb_lower":  "2,140",   # 布林下軌
    "vol_ma5":  "48,000",   # 5日均量（張，估）
    "trend":    "⚠️ 6/1 Mon 台股 2330 盤中衝上天價 NT$2,415 但終場收平盤 NT$2,355（0.00% vs 5/29），未跟進大盤（高檔獲利了結、資金輪動至聯發科等其他 AI 股）；台股加權指數 6/1 大漲 +604.97（+1.35%）收 45,337.91 創歷史新高。6/2 台股尚未收盤，估反彈追趕 ADR、估收 NT$2,405（+50，+2.12% vs 6/1 NT$2,355）、估盤中回測 6/1 天價 NT$2,415。NYSE TSM 6/1 Mon 大漲 +4.73% 收 $439.78（vs 5/29 $418.45）、盤中觸 $443.18、市值 $2.28T 創史新高，ADR 溢價估擴大至 +13.6%（台股個股暫落後 ADR）。技術面：RSI 估 68.0 強勢區、MACD +2.0 紅柱、KDJ K(78)/D(72)/J(90) 偏高；5MA NT$2,347 / 20MA NT$2,290 / 60MA NT$2,210 / 120MA NT$2,090 均線多頭排列、中期結構穩固。下一觀察：（1）6/2 能否守穩並回測 6/1 天價 NT$2,415、突破將挑戰 NT$2,440 / NT$2,450（Barclays $470 對應）；（2）短線回檔關卡 NT$2,355（6/1 收）/ NT$2,300 / NT$2,255 心理整數；（3）🤝 NVIDIA-TSMC 6/1 宣布 AI 製程合作（cuLitho/cuEST/FabTwin）為結構性利多；（4）🎤 Intel CEO Lip-Bu Tan 6/2 13:30 台北 COMPUTEX keynote、18A 量產進度 + 競合關係觀察；（5）⭐ NVIDIA $150B/年投資台灣 + TSMC 3nm 漲價 15% 為結構性多頭利多；（6）🎯 TSMC 上修 2030 全球晶片市場至 $1.5T、AI/HPC 占 55%、18 座新廠規劃、2nm/A16 CAGR +70% 為結構性多頭催化。",
    "support":  "2,355 / 2,300 / 2,255 / 2,200 (6/1 收、心理整數)",
    "resist":   "2,415 / 2,440 / 2,450 / 2,500",
    "note": "技術指標數值為估算，請以看盤軟體即時數據為準；6/1 台股個股收平盤、6/2 估反彈追趕 ADR、需觀察 NT$2,415 天價回測與 NT$2,355 支撐",
}

# 期貨與選擇權（來源：台灣期交所 TAIFEX）
DERIVATIVES = {
    "date":          "2026-06-02",
    "futures_price": "2,415",      # 台積電期貨近月（估，6/2 反彈追趕 ADR）
    "futures_oi":    "152,000",    # 未平倉量（口）（估）
    "futures_basis": "+10",        # 正價差 +10 點（ADR 大漲帶動多單情緒回升）
    "call_oi":       "100,000",
    "put_oi":        "62,000",
    "pcr":           "0.62",       # Put/Call 比率（看多區）
    "pcr_signal":    "看多（Put/Call 0.62 在中軸 0.70 下方看多區、ADR 大漲 + NVIDIA-TSMC AI 合作續存）",
    "max_pain":      "2,355",      # 最大痛苦價格（近期到期、6/1 收盤）
    "key_strikes": [
        ("2,255", "Call 35,200 / Put 10,500", "心理整數支撐"),
        ("2,300", "Call 38,500 / Put 9,500",  "心理整數支撐"),
        ("2,355", "Call 47,500 / Put 7,500",  "6/1 收盤、最大痛苦價"),
        ("2,395", "Call 48,500 / Put 7,200",  "6/2 估開盤"),
        ("2,405", "Call 49,200 / Put 6,800",  "6/2 估收盤"),
        ("2,415", "Call 51,500 / Put 6,200",  "6/1 盤中天價"),
        ("2,440", "Call 52,200 / Put 5,800",  "短線壓力"),
        ("2,450", "Call 53,800 / Put 5,200",  "Barclays $470 對應目標"),
        ("2,500", "Call 42,500 / Put 4,200",  "短線挑戰價"),
        ("2,550", "Call 32,500 / Put 3,200",  "長線挑戰價"),
        ("2,600", "Call 22,500 / Put 2,500",  "長線心理整數"),
    ],
    "note": "衍生品數據需每日至台灣期交所(taifex.com.tw)更新；6/1 台股個股收平盤、6/2 估反彈正價差 +10、Put/Call 0.62 看多區、NVIDIA-TSMC AI 合作 + 3nm 漲價 15% + Vera Rubin 量產結構性利多續存",
}
...
ECOSYSTEM_STOCKS = [
    ...
    ("封裝", "3711.TW", "日月光",      "295",    "+1.72%", "CoWoS 封裝（6/1 漲；COMPUTEX + Vera Rubin 量產帶動封裝定價）"),
    ...
    ("客戶", "2454.TW", "聯發科",      "4,555",  "+5.68%", "手機 SoC 客戶 9%；6/1 大漲 +245 元（資金輪動受惠）；A14/N2 採用 + COMPUTEX"),
...
CONSENSUS = {
    ...
    "upside":       "+4.4%",    # 從 NT$2,405（6/2 估收盤）到 NT$2,510
}
...
IR_CALENDAR = [
    ...
    ("2026-06-02", "🚀 今日：估反彈追趕 ADR 估收 NT$2,405（+2.12%）回測天價 NT$2,415；Intel CEO 6/2 keynote","今日（6/2 Tue）台股市場尚未收盤，本報告以估算值呈現：台股 2330 估反彈追趕 ADR 6/1 +4.73% 大漲訊號，估收 NT$2,405（+50，+2.12% vs 6/1 NT$2,355）、估盤中回測 6/1 天價 NT$2,415、估量 52,000 張；🚀 今日關鍵催化：（1）COMPUTEX 2026 正式開幕日；（2）Intel CEO Lip-Bu Tan 6/2 13:30 台北時間 COMPUTEX keynote、聚焦 18A 量產進度（Panther Lake/Nova Lake/Clearwater Forest 全採 18A）+ Foundry 外部客戶宣告 + 與 TSMC 競合關係（18A 良率預計 2027 達業界水準）；（3）NVIDIA-TSMC 6/1 AI 製程合作續發酵；（4）黃仁勳 GTC Taipei keynote 揭 Vera Rubin 正式量產續存；NYSE TSM 6/1 +4.73% 收 $439.78 創史新高、台美 ADR 溢價擴大至 +13.6%（個股暫落後 ADR）；6/2 估三大法人合計買超 +15,700 張（外資 +12,000、投信 +2,500、自營 +1,200）；技術面 RSI 估 68 強勢區、MACD +2.0 紅柱、KDJ J 90 偏高；🎯 結構性催化續存：TSMC 上修 2030 全球晶片市場至 $1.5T、CoWoS 良率破 98%、18 座新廠規劃、NVIDIA $150B/年投資 + 3nm 漲價 15% + NVIDIA-TSMC AI 製程合作；本週關注：回測 6/1 天價 NT$2,415 突破將挑戰 NT$2,440 / NT$2,450（Barclays $470 對應）","#C8E6C9"),
...
MACRO = [
    ...
    ("台股加權指數",    "45,565.00","+0.50%", False),  # 6/2 加權指數估（6/1 收 45,337.91 +1.35% 創高後）
...
VALUATION = {
    "pe_current":   35.4,   # 同 STOCK["pe_ratio"]（6/2 估 NT$2,405）
    ...
    "pb_current":  12.50,   # 同 STOCK["pb_ratio"]（6/2 估 NT$2,405）
    "pb_5y_avg":     5.8,
    "pb_5y_pct":      95,
    "ev_ebitda":    21.0,   # EV/EBITDA（估算）
    "peg":          1.07,   # PEG = P/E ÷ 5 年 EPS CAGR ~33%
    "note": "P/E 歷史百分位為估算（Bloomberg/Refinitiv 基準），請每季更新基準值；6/1 台股個股收平盤後估值略回落至 5 年 94% 高位、TSMC 3nm 漲價 15% + NVIDIA $150B/年投資台灣 + NVIDIA-TSMC AI 製程合作 + Vera Rubin 量產支撐估值結構性提升",
}
...
RELATIVE = {
    "date":           "2026-06-02",
    "tsmc_tw_1d":     +2.12,   # 2330 6/2 估收 NT$2,405（+50 vs 6/1 NT$2,355）
    "taiex_1d":       +0.50,   # 加權指數 6/2 估（接續 6/1 45,338 +1.35% 創高後）
    "sox_1d":         +4.64,   # SOX 6/1 大漲 COMPUTEX + Vera Rubin
    "tsmc_nyse_1d":   +4.73,   # TSM ADR 6/1 $439.78（vs 5/29 $418.45）
    "tsmc_tw_5d":     +6.89,   # 5 日（NT$2,405 vs 5/26 ~NT$2,250）
    "taiex_5d":       +8.00,
    "tsmc_tw_1m":     +12.65,  # 月線（NT$2,405 vs ~NT$2,135 一個月前 4/30）
    "taiex_1m":       +14.0,
    "tsmc_tw_ytd":    +14.80,  # YTD 累計（NT$2,405 vs 年初 ~NT$2,095）
    "taiex_ytd":      +16.0,
    ...
    "adr_parity":    387.28,   # 理論值 = 5 × NT$2,405 ÷ 31.05
    "adr_ratio":     "5:1",    # 1 ADR = 5 台積電普通股
    "usd_ntd":        31.05,   # 同 MACRO 台幣匯率
    "adr_premium_pct": "+13.6", # (439.78 - 387.28) / 387.28 × 100 = +13.6%（台股個股暫落後 ADR、溢價擴大）
    "note": "ADR 理論值 = 5 × 台股收盤 ÷ 匯率（不含交易摩擦與流動性溢價）。⚠️ 6/1 台股 2330 收平盤 NT$2,355 未跟進大盤、而 ADR 6/1 +4.73% 大漲 $439.78 創史新高，台美溢價擴大至 +13.6%（台股個股動能落後 ADR、催化 6/2 跟漲）；NVIDIA $150B/年台灣投資 + 3nm 漲價 15% + NVIDIA-TSMC AI 製程合作 + Vera Rubin 量產結構性利多續存",
}
...
NEWS = [
    ...
    },
    {
        ...
        "title": "🚀 NYSE TSM 6/1 大漲 +4.73% 收 $439.78、盤中觸 $443.18、市值 $2.28T 創史新高；台股個股暫落後 ADR",
        "body": "6/1 Mon NYSE TSM 在 COMPUTEX 開幕 + GTC Taipei keynote + NVIDIA-TSMC AI 製程合作三重催化下大漲：（1）TSM 收 $439.78（+4.73% vs 5/29 $418.45）、盤中觸 $443.18、市值突破 $2.28 兆美元雙創史新高；（2）⚠️ 對比之下台股 2330 6/1 盤中雖衝天價 NT$2,415 但收平盤 NT$2,355（0.00%）、未跟進大盤——高檔獲利了結 + 資金輪動至聯發科（+5.68%）等其他 AI 股，台美 ADR 溢價因而擴大至 +13.6%、台股個股估值暫落後 ADR、催化 6/2 跟漲動能；（3）GuruFocus 報導 TSM 在 4.7% 大漲後 GF Value 評估「適度高估」；（4）AI 晶片股齊漲：NVDA +4.50%、AMD +4.92%、AVGO +4.51%、ASML +4.45%、AMAT +4.47%、MU +5.33%、INTC +5.93%；（5）SOX +4.64% 至 12,318.5；（6）短線估值警示：P/E ~36.4x（USD 基礎）已升至 5 年高位、技術超買訊號持續累積；（7）今日（6/2）關注台股 2330 能否反彈追趕 ADR、6/2 Intel CEO keynote 為短線變數。",
        "source": "GuruFocus / TradingKey / Yahoo Finance / 經濟日報 / ETtoday 2026-06-01", "impact": "正面",
    },
    {
        "tag": "產業趨勢", "tag_color": "#4CAF50",
