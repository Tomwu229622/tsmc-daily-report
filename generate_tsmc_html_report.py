...
IR_CALENDAR = [
    ...
    ("2026-06-26", "⚠️ ADR 隔夜漲幅回吐至約 $435；台股交易中", "6/26 Fri NYSE TSM 6/26 盤中回吐隔夜漲幅、最新約 $435.42（-1.2% vs $440.83、日內區間 $432.50–$452.56）——漲價題材熱度降溫；台股 2330 今日交易中、官方收盤待 TWSE；24/7 Wall St 探討 TSM 年底前能否站上 $500",  "#FFF9C4"),
