...
STOCK = {
    # 台股 2330
    "tw_price":       "2,490",        # 2026-06-23 Tue 官方收盤（-20，-0.80% vs 6/22 NT$2,510；盤中觸史高 NT$2,535 後拉回、量 34,148 張、相對抗跌。6/24 Wed 今日交易中、料跟進 NYSE 6/23 -6.69% 暴跌跳空走低、官方收盤待 TWSE）
    "tw_change":      "-20",          # 6/23 漲跌點數（vs 6/22 NT$2,510）
    "tw_change_pct":  "-0.80%",       # 6/23 漲跌幅（自史高小幅獲利了結、盤中創史高 NT$2,535 後收低）
    "tw_volume":      "34,148",       # 6/23 成交量（張，官方）
    "tw_open":        "2,510",        # 6/23 開盤
    "tw_high":        "2,535",        # 6/23 盤中高（創歷史新高 NT$2,535）
    "tw_low":         "2,490",        # 6/23 盤中低（收最低）
    "market_cap":     "NT$64.6 兆",   # 6/23 收盤市值（NT$2,490 基礎）
    "pe_ratio":       "~36.7x",       # 台股 P/E（TTM，NT$2,490 基礎）
    ...
    # NYSE TSM ADR
    "nyse_price":     "436.39",       # 6/23 Tue 收盤（-$31.28，-6.69% vs 6/22 $467.67；半導體全面拋售、Micron -11.4%、市值約 $1.97 兆、P/E ~31.3）
    "nyse_change":    "-31.28",       # 6/23 漲跌（vs 6/22 $467.67）
    "nyse_change_pct":"-6.69%",       # 6/23 NYSE 暴跌（半導體類股全面拋售：Broadcom 指引不如預期 + BoFA 升息報告 + 亞股下挫 + AI 過熱疑慮 + 財報前獲利了結）
    "52w_high_nyse":  "476.79",       # 52 週/歷史高（區間，6/23 盤前曾觸 $477.82）
    "52w_low_nyse":   "213.88",       # 52 週低（區間）
    "pe_nyse":        "~31.3x",       # NYSE USD 基礎 P/E（TTM，$436.39 基礎）
    "pb_nyse":        "~12.6x",
    "beta":           "1.18",
    ...
    # 資料日期備註
    "data_note":      "報告日期：2026-06-24 Wed（NYSE TSM 6/23 Tue 收盤 $436.39 為最新確認數據；台股 2330 NT$2,490 為 6/23 Tue 官方收盤、6/24 Wed 今日交易中、官方收盤請以 TWSE 為準）。⚠️⚠️ 今日頭條——半導體全面拋售、ADR 暴跌但台股相對抗跌：NYSE TSM 6/23 Tue 暴跌 -6.69% 收 $436.39（-$31.28 vs 6/22 $467.67、市值回落約 $1.97 兆、P/E ~31.3），受半導體類股全面拋售拖累——Micron 重挫 -11.4%、Broadcom 財報指引不如市場預期引爆「sell-the-news」、BoFA 升息報告推升 10Y 美債殖利率、亞股下挫、AI 過熱疑慮升溫與財報前獲利了結共振。台股 2330 6/23 Tue 官方收 NT$2,490（-20、-0.80% vs 6/22 NT$2,510、量 34,148 張、市值 NT$64.6 兆）相對抗跌、盤中一度觸歷史新高 NT$2,535 後拉回收最低。6/24 Wed 今日台股交易中、料跟進 ADR 6/23 暴跌跳空走低、官方收盤待 TWSE。📊 台美 ADR 溢價（以 6/23 ADR $436.39 + 台股 NT$2,490 計）：理論值 5×2,490÷31.05 = $400.97、溢價 (436.39-400.97)/400.97 = +8.83%（自 6/22 +15.71% 大幅收斂、反映 ADR 暴跌而台股抗跌）。📉 拉回主因——（1）AI 晶片股集體獲利了結、Broadcom 指引不如預期引爆類股賣壓；（2）⚠️ TSMC 4-5 月營收合計 +24% YoY 低於華爾街 Q2 約 +35% 預期、近期營收恐有 miss 風險、6 月營收（7 月上旬公布）為關鍵 catalyst；（3）估值偏高（P/E 5 年 90%+ 高位）+ 升息預期。📈 逆勢利多——Susquehanna 將 TSM 目標價自 $500 上調至 $575（看好 AI 結構性需求）。⭐ 中長線結構性利多基底未變：TSMC-Amkor 10 年美國先進封裝長約（6/16 公告、Peoria AZ $70 億、2028 投產）、NVIDIA 確認第 1 大客戶（22%/$33B）+ A16 首發 2027 量產、NVIDIA-TSMC AI 製程合作（cuLitho/缺陷檢測/工廠排程）、CoPoS 面板級封裝加速、2nm 量產 70-80% 良率。⚠️ 風險續追蹤——（1）Apple 同意與 Intel 合作在美生產晶片降低對 TSMC 依賴、Google/AMD/Tesla 接觸 Samsung；（2）TSMC 遭美 ITC 專利調查（Longitude/Marlin 控訴）、6 月底預計初判、恐對含 AI 加速器技術晶片發布美國進口禁令。  |  🎯 即將事件：6 月營收 7 月上旬公布（關鍵 catalyst、攸關 Q2 指引達成）；Q2 2026 財報法說會 7/16（指引 $39.0-40.2B、+10% QoQ、+32% YoY、毛利率 65-67%）  |  ⭐ 中長線基底：5 月營收 NT$4,169.75 億 +30.1% 創單月新高；2nm 量產良率 70-80% 領先全球；NVIDIA 第 1 大客戶 22%/$33B；4 大美國 CSP 2026 AI CapEx 合計 $725B（+77% YoY）；2026 全球半導體市場估 +25% YoY 達 ~$975B  |  ⚠️ 本日（6/24）關鍵觀察：（1）台股 2330 跟進 ADR 暴跌跳空後能否守穩 NT$2,450 / NT$2,410 支撐；（2）ADR 溢價收斂至 +8.83%、留意台股補跌風險；（3）下方支撐 NT$2,450 / NT$2,410 / NT$2,375；上方壓力 NT$2,510 / NT$2,535 史高 / NT$2,550；（4）⚠️ 估值警示：TSM P/E ~31.3x、台股 P/E ~36.7x，留意 6 月營收 miss 風險、台幣升值與 Apple-Intel/ITC 雜訊",
}
...
SUMMARY = {
    ...
    "sentiment":  "中性偏多",
    # 一句話標題
    "headline":   "⚠️ 半導體全面拋售、ADR 暴跌但台股抗跌：NYSE TSM 6/23 -6.69% 收 $436.39（Micron -11.4%、Broadcom 指引引爆賣壓）、台股 2330 6/23 收 NT$2,490（-0.80%、盤中觸史高 2,535）；6/24 料跟進跳空走低、Susquehanna 逆勢上調目標至 $575",
    # 3–5 條白話重點（不用術語，每條約 30 字內）
    "bullets": [
        "⚠️ NYSE TSM 6/23 Tue 暴跌 -6.69% 收 $436.39（-$31.28 vs 6/22 $467.67、市值回落約 $1.97 兆、P/E ~31.3）",
        "📉 半導體類股全面拋售：Micron -11.4%、Broadcom 財報指引不如預期引爆「sell-the-news」、AI 過熱疑慮 + 財報前獲利了結",
        "🛡️ 台股 2330 6/23 官方收 NT$2,490（-20、-0.80%、量 34,148 張）相對抗跌、盤中一度觸歷史新高 NT$2,535 後拉回收最低",
        "📊 ADR 溢價自 +15.71% 大幅收斂至 +8.83%（ADR 暴跌而台股抗跌）；6/24 今日台股料跟進跳空走低、官方收盤待 TWSE",
        "⚠️ TSMC 4-5 月營收合計 +24% YoY 低於華爾街 ~35% 預期、近期營收恐 miss、6 月營收（7 月上旬）為關鍵 catalyst",
        "📈 逆勢利多：Susquehanna 將 TSM 目標價自 $500 上調至 $575（看好 AI 結構性需求）",
        "⭐ 中長線基底未變：TSMC-Amkor 美國封裝長約 + NVIDIA #1 客戶/A16 首發 + NVIDIA-TSMC AI 製程合作 + 2nm 70-80% 良率",
        "⚠️ 風險續追蹤：Apple-Intel 合作降低對 TSMC 依賴、Google/AMD/Tesla 接觸 Samsung；TSMC 遭美 ITC 專利調查 6 月底待初判",
    ],
    # 一句結論
    "bottom_line": "報告日期：2026-06-24 Wed（NYSE TSM 6/23 Tue 收盤 $436.39 為最新確認數據；台股 2330 NT$2,490 為 6/23 Tue 官方收盤、6/24 Wed 今日交易中、官方收盤請以 TWSE 為準）。⚠️ 今日頭條——半導體全面拋售、ADR 暴跌但台股相對抗跌：NYSE TSM 6/23 Tue 暴跌 -6.69% 收 $436.39（-$31.28 vs 6/22 $467.67、市值回落約 $1.97 兆、P/E ~31.3），受半導體類股全面拋售拖累——Micron 重挫 -11.4%、Broadcom 財報指引不如市場預期引爆「sell-the-news」、BoFA 升息報告推升 10Y 美債殖利率、亞股下挫、AI 過熱疑慮升溫與財報前獲利了結共振，單日逾千億美元半導體市值蒸發。台股 2330 6/23 Tue 官方收 NT$2,490（-20、-0.80% vs 6/22 NT$2,510、量 34,148 張、市值 NT$64.6 兆）相對抗跌、盤中一度觸歷史新高 NT$2,535 後拉回收最低。6/24 Wed 今日台股交易中、料跟進 ADR 6/23 暴跌跳空走低、官方收盤待 TWSE。📊 台美 ADR 溢價（以 6/23 ADR $436.39 + 台股 NT$2,490 計）：理論值 5×2,490÷31.05 = $400.97、溢價 (436.39-400.97)/400.97 = +8.83%（自 6/22 +15.71% 大幅收斂、反映 ADR 暴跌而台股抗跌、台股短線恐有補跌壓力）。📉 拉回主因：（1）AI 晶片股集體獲利了結、Broadcom 指引不如預期引爆類股賣壓；（2）⚠️ TSMC 4-5 月營收合計 +24% YoY 低於華爾街 Q2 約 +35% 預期、近期營收恐有 miss 風險、6 月營收（7 月上旬公布）為關鍵 catalyst、僅需小幅月增即可使 Q2 營收逼近指引中值；（3）估值偏高（P/E 5 年 90%+ 高位）+ 升息預期。📈 逆勢利多——Susquehanna 將 TSM 目標價自 $500 大幅上調至 $575、續看好 AI 結構性需求。⭐ 中長線結構性利多基底未變：（1）🤝 TSMC-Amkor 10 年美國先進封裝長約（6/16 公告、Peoria AZ $20 億→$70 億、2028 投產、~2,000 就業、InFO/CoWoS、呼應 TSMC $165B 美國投資承諾）；（2）🏆 NVIDIA 確認 TSMC 第 1 大客戶（超越 Apple、22% / $33B）、為 A16（1.6nm）首發客戶 2027 量產；Apple 跳過 A16 直上 A14（1.4nm）；（3）⭐ NVIDIA-TSMC 深化 AI 導入晶圓廠合作（cuLitho 運算微影、缺陷檢測、工廠排程）、提升良率與產能；NVIDIA RTX Spark 超晶片（ARM Grace + Blackwell、1 petaflop）由 TSMC 代工；（4）⭐ TSMC 2nm 已量產、初期良率 70-80% 領先全球、年底月產能目標 100K 片；（5）📦 CoPoS 面板級封裝加速布局、目標 6 月底完成驗證、與 CoWoS 互補緩解 AI 封裝瓶頸、CoWoS 規劃 2026 底擴至 ~130K wpm 良率 >98%；（6）4 大美國 CSP 2026 AI CapEx 合計 $725B（+77% YoY）；（7）⭐ 5 月營收 NT$4,169.75 億 +30.1% 創單月新高、1-5 月累計 NT$1.96 兆；（8）2026 全球半導體市場估 +25% YoY 達 ~$975B、AI 晶片市場估 ~$500B。⚠️ 短期/中期下行風險：（1）⚠️ 近期營收 miss 風險——4-5 月 +24% YoY 落後 Q2 ~35% 預期、6 月營收為關鍵驗證；（2）⚠️ 半導體類股集體回檔、AI 過熱與升息疑慮；（3）⚠️ 客戶分散——Apple 同意與 Intel 合作在美生產晶片降低對 TSMC 依賴、Google/AMD/Tesla 接觸 Samsung 先進製程（中期觀察、技術代差仍領先）；（4）⚠️ 法律風險——TSMC 遭美 ITC 專利調查（Longitude Licensing & Marlin Semiconductor 控訴）、6 月底預計初判、恐對含 AI 加速器技術晶片發布美國進口禁令；（5）⚠️ 估值警示——TSM P/E ~31.3x、台股 P/E ~36.7x，仍在 5 年 90%+ 高位；（6）台幣升值壓力（每升 1% 毛利率 -40bps）。基本面未變：Q1 2026 淨利 NT$572.5B（$18.2B、+58.3% YoY）、毛利率 66.2% 雙創史高；2025 全年 EPS NT$66.25。技術面（基於 6/23 官方收 NT$2,490）：5MA NT$2,415 / 20MA NT$2,390 / 60MA NT$2,345 / 120MA NT$2,240；下方支撐 NT$2,450 / NT$2,410 / NT$2,375；上方壓力 NT$2,510 / NT$2,535（史高）/ NT$2,550。32 位分析師全數看多、平均目標 NT$2,530 上行空間 +1.61%（自 NT$2,490、待 7/16 法說會後重估）。",
    # 重大警示（選填，空白則不顯示）
    "risk_alert":  "今日（6/24 Wed）關鍵觀察：（1）⚠️ NYSE TSM 6/23 暴跌 -6.69% 收 $436.39、半導體類股全面拋售（Micron -11.4%、Broadcom 指引引爆 sell-the-news）、市值回落約 $1.97 兆；（2）🛡️ 台股 2330 6/23 官方收 NT$2,490（-0.80%）相對抗跌、盤中觸史高 NT$2,535 後拉回；6/24 今日料跟進 ADR 暴跌跳空走低、官方收盤待 TWSE；（3）📊 ADR 溢價自 +15.71% 大幅收斂至 +8.83%、台股短線恐有補跌壓力；（4）⚠️ TSMC 4-5 月營收合計 +24% YoY 低於華爾街 ~35% 預期、近期營收恐 miss、6 月營收（7 月上旬）為關鍵 catalyst；（5）📈 逆勢利多：Susquehanna 將 TSM 目標價自 $500 上調至 $575；（6）🤝 TSMC-Amkor 簽 10 年美國先進封裝長約（Peoria AZ $70 億、2028 投產、~2,000 就業）；（7）🏆 NVIDIA 確認 TSMC 第 1 大客戶（22%/$33B）、為 A16 首發客戶 2027 量產；NVIDIA-TSMC 深化 AI 製程合作；（8）⚠️ 風險續追蹤——Apple 同意與 Intel 合作在美生產晶片降低對 TSMC 依賴、Google/AMD/Tesla 接觸 Samsung（中期觀察、技術代差仍領先）；（9）⚠️ TSMC 遭美 ITC 專利調查（Longitude/Marlin 控訴）、6 月底預計初判、恐對含 AI 加速器技術晶片發布美國進口禁令；（10）📦 TSMC 加速 CoPoS 面板級封裝、目標 6 月底完成驗證；（11）⭐ 2nm 量產良率 70-80% 領先全球；（12）⭐ 4 大美國 CSP 2026 AI CapEx 合計 $725B（+77% YoY）；（13）⚠️ 估值警示：TSM P/E ~31.3x、台股 P/E ~36.7x、仍在 5 年 90%+ 高位、留意 6 月營收 miss 風險與台幣升值；32 位分析師全數看多、平均目標 NT$2,530（上行 +1.61%、待法說會重估）；本日（6/24）關鍵：台股跟進 ADR 暴跌跳空後能否守穩 NT$2,450 / NT$2,410 支撐；上方壓力 NT$2,510 / NT$2,535 史高",
}

# 三大法人買賣超（張）— 最新一日
INSTITUTIONAL = {
    "date":     "2026-06-23",       # 最新資料日（6/23 Tue 為官方最後交易日、6/24 今日盤後待公布；6/23 三大法人為估算、官方以 TWSE 盤後為準）
    "foreign":  -9000,              # 外資 6/23 估轉賣超（自史高獲利了結、NYSE ADR 暴跌 -6.69% 帶動賣壓；待官方確認）
    "trust":    +500,               # 投信 6/23 估縮手小買 +500 張
    "dealer":   -200,               # 自營商 6/23 估小幅賣超 -200 張
    # 近5日（由舊到新：6/16, 6/17, 6/18, 6/22, 6/23）；6/19 端午休市；6/16 含實際、其餘為估算
    "foreign_5d": [-382, +4000, +12000, +18000, -9000],      # 外資 6/16 實際 -382、6/23 估轉賣超
    "trust_5d":   [+3849, +800, +1500, +2000, +500],         # 投信 6/16 實際 +3,849、6/23 估縮手小買
    "dealer_5d":  [-158, +300, +600, +800, -200],            # 自營 6/16 實際 -158、6/23 估小賣
    "foreign_ownership_pct": "75.0%",  # 外資持股比例（6/23 獲利了結後估微降至 75.0%）
    "foreign_ownership_shares": "約 194.3 億股",
}

# 技術分析指標（需每日從看盤軟體更新）
TECHNICAL = {
    "rsi_14":       66.0,   "rsi_signal": "RSI 估自 74 回落至 66（台股 6/23 -0.80% 自史高拉回、NYSE 6/23 暴跌 -6.69%），多方動能轉弱、退出超買區、⚠️ 6/24 料跟進 ADR 暴跌、留意跌破中軸",
    "macd":         0.40,  "macd_signal": "MACD 估自 +0.60 收斂至 +0.40、紅柱縮短、仍守零軸上方但動能轉弱、⚠️ 留意高檔死叉",   "macd_color": "#4CAF50",
    "kdj_k":        80.0,   "kdj_d": 80.0, "kdj_j": 80.0, "kdj_signal": "KDJ K(80)/D(80)/J(80) 自高檔回落、6/23 長上影線（觸 2,535 後收 2,490）、高檔死叉訊號浮現、⚠️ 多頭動能衰竭",
    "ma5":       "2,415",   # 5MA（6/16 2375, 6/17 2315, 6/18 2385, 6/22 2510, 6/23 2490）— 基於 6/23 官方收
    "ma20":      "2,390",   # 20MA 翻揚
    "ma60":      "2,345",   # 60MA 緩升
    "ma120":     "2,240",
    "bb_upper":  "2,580",   # 布林上軌
    "bb_mid":    "2,390",   # 布林中軌（20MA）
    "bb_lower":  "2,240",   # 布林下軌
    "vol_ma5":  "42,000",   # 5日均量（張，估、基於 6/16-6/23 五日均）
    "trend":    "⚠️ 半導體全面拋售、ADR 暴跌但台股相對抗跌：NYSE TSM 6/23 暴跌 -6.69% 收 $436.39（半導體類股全面拋售、Micron -11.4%、Broadcom 指引引爆 sell-the-news）、市值回落約 $1.97 兆；台股 2330 6/23 官方收 NT$2,490（-20、-0.80%、量 34,148 張）相對抗跌、盤中觸史高 NT$2,535 後拉回收最低；6/24 今日台股交易中、料跟進 ADR 暴跌跳空走低。📊 技術面（基於 6/23 官方收 NT$2,490）：RSI 自 74 回落至 66 退出超買、MACD +0.40 紅柱縮短動能轉弱、KDJ 高檔死叉浮現、6/23 留長上影線示警、短期 5MA NT$2,415、中期 60MA/120MA 趨勢仍偏多。下一觀察：（1）📉 台股跟進 ADR 暴跌跳空後能否守穩 NT$2,450 / NT$2,410 支撐；（2）下方支撐 NT$2,450 / NT$2,410 / NT$2,375；（3）上方壓力 NT$2,510 / NT$2,535 史高 / NT$2,550；（4）⚠️ 近期營收 miss 風險（4-5 月 +24% YoY 落後 ~35% 預期）、6 月營收 7 月上旬為關鍵；（5）⚠️ 雜訊續追蹤：Apple-Intel 合作、ITC 專利調查；（6）⭐ 中長線結構性利多基底未變：Amkor 美國封裝長約 + NVIDIA #1 客戶 + A16 首發 + 2nm 量產 70-80% 良率 + Susquehanna 目標升至 $575。",
    "support":  "2,450 / 2,410 / 2,375 / 2,310 (整數、前低、前低、前低)",
    "resist":   "2,510 / 2,535 / 2,550 / 2,600 (6/22 收、6/23 盤中史高、整數、整數)",
    "note": "技術指標數值為估算（基於 6/23 官方收 NT$2,490），請以看盤軟體即時數據為準；台股 6/23 自史高拉回 -0.80% 相對抗跌、NYSE 6/23 暴跌 -6.69%、RSI 66 退出超買、KDJ 高檔死叉浮現、MACD 紅柱縮短動能轉弱；NT$2,450 為關鍵支撐、上方壓力 NT$2,510 / NT$2,535 史高；6/24 今日台股料跟進 ADR 暴跌、⚠️ 留意補跌與營收 miss 風險",
}

# 期貨與選擇權（來源：台灣期交所 TAIFEX）
DERIVATIVES = {
    "date":          "2026-06-23",       # 最新資料日（6/23 Tue 收盤估、6/24 今日盤後待公布）
    "futures_price": "2,485",            # 台積電期貨近月（6/23 收盤附近、隨現貨拉回）
    "futures_oi":    "175,000",          # 未平倉量（口）（6/23 估、高檔小幅減倉）
    "futures_basis": "-5",               # 6/23 估轉小幅逆價差（避險情緒升溫）
    "call_oi":       "112,000",
    "put_oi":        "74,000",
    "pcr":           "0.66",             # Put/Call 比率（6/23 估自 0.59 回升至 0.66、避險買盤增、情緒轉謹慎）
    "pcr_signal":    "中性偏多（Put/Call 6/23 估回升至 0.66、自前日 0.59 增加；反映 ADR 暴跌 -6.69% + 台股自史高拉回帶動避險買盤增、情緒轉謹慎）",
    "max_pain":      "2,450",            # 最大痛苦價格（近期到期、6/23 估）
    "key_strikes": [
        ("2,410", "Call 50,000 / Put 15,000", "前低支撐"),
        ("2,450", "Call 56,000 / Put 12,000", "心理整數、最大痛苦"),
        ("2,490", "Call 54,000 / Put 9,000",  "6/23 收"),
        ("2,510", "Call 48,000 / Put 6,500",  "6/22 收"),
        ("2,535", "Call 42,000 / Put 5,000",  "6/23 盤中史高"),
        ("2,550", "Call 38,000 / Put 4,000",  "整數壓力"),
        ("2,600", "Call 32,000 / Put 3,000",  "整數壓力"),
    ],
    "note": "衍生品數據需每日至台灣期交所(taifex.com.tw)更新；6/23 PCR 自 0.59 回升至 0.66 反映 ADR 暴跌 -6.69% + 台股自史高拉回帶動避險買盤增、情緒轉謹慎、期貨轉小幅逆價差；NT$2,450 為關鍵支撐/最大痛苦、上方壓力 NT$2,510 / NT$2,535 史高；⚠️ 6/24 今日台股料跟進 ADR 暴跌跳空、留意營收 miss 風險；中長線結構性利多基底未變（TSMC-Amkor 美國封裝長約、NVIDIA 確認第 1 大客戶 + A16 首發、2nm 量產 70-80% 良率、Susquehanna 目標升至 $575）；⚠️ 雜訊續追蹤：Apple-Intel 合作、ITC 專利調查",
}
...
NEWS = [
    {
        ...
        "title": "⚠️ 半導體全面拋售：NYSE TSM 6/23 暴跌 -6.69% 收 $436.39、台股 2330 相對抗跌收 NT$2,490（-0.80%）",
        "body": "AI 晶片股 6/23 集體重挫、TSMC 台美兩市表現分歧：（1）⚠️ NYSE TSM 6/23 Tue 暴跌 -6.69% 收 $436.39（-$31.28 vs 6/22 $467.67、市值回落約 $1.97 兆、P/E ~31.3）；（2）📉 全類股拋售——Micron 重挫 -11.4% 為最弱、AMD -6.25%、AVGO -5.02%、ASML/AMAT/LRCX/KLAC 跌 4.5-5%、SOX 大跌；崩跌觸發：Broadcom 財報指引不如市場預期引爆「sell-the-news」、BoFA 升息報告推升 10Y 美債殖利率、亞股下挫、AI 過熱疑慮與財報前獲利了結共振，單日逾千億美元半導體市值蒸發；（3）🛡️ 台股 2330 6/23 官方收 NT$2,490（-20、-0.80%、量 34,148 張、市值 NT$64.6 兆）相對抗跌、盤中一度觸歷史新高 NT$2,535 後拉回收最低；（4）📊 台美 ADR 溢價自 +15.71% 大幅收斂至 +8.83%（ADR 暴跌而台股抗跌）；（5）🎯 6/24 今日台股交易中、料跟進 ADR 暴跌跳空走低、官方收盤待 TWSE。",
        "source": "GuruFocus / TradingKey / TheStreet / Yahoo Finance / cnyes 2026-06-23", "impact": "負面",
    },
    {
        "tag": "警示", "tag_color": "#F44336",
