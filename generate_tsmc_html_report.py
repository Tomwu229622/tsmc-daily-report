...
STOCK = {
    # 台股 2330
    "tw_price":       "2,510",        # 2026-06-22 Mon 官方收盤（+100，+4.15% vs 6/18 NT$2,410；創歷史新高、量 39,134 張。6/19 Fri 端午節休市。6/23 Tue 今日交易中、開盤 NT$2,455 跳空小幅拉回、官方收盤待 TWSE）
    "tw_change":      "+100",         # 6/22 漲跌點數（vs 6/18 NT$2,410）
    "tw_change_pct":  "+4.15%",       # 6/22 漲跌幅（受 6/18-6/19 NYSE 飆漲帶動跳空大漲、創史高）
    "tw_volume":      "39,134",       # 6/22 成交量（張，官方）
    "tw_open":        "2,455",        # 6/22 開盤
    "tw_high":        "2,510",        # 6/22 盤中高（收最高、創 NT$2,510 史高價）
    "tw_low":         "2,455",        # 6/22 盤中低
    "market_cap":     "NT$65.1 兆",   # 6/22 收盤市值（NT$2,510 基礎）
    "pe_ratio":       "~37.0x",       # 台股 P/E（TTM，NT$2,510 基礎）
    "pb_ratio":       "~13.0x",       # 台股 P/B（股淨比，NT$2,510 基礎）
    "div_yield":      "~0.60%",       # 殖利率（NT$2,510 基礎）
    "52w_high_tw":    "2,510",        # 52 週/歷史高（2026-06-22 收 NT$2,510 史高）
    "52w_low_tw":     "780",          # 52 週低（2025-04-07）
    # NYSE TSM ADR
    "nyse_price":     "467.67",       # 6/22 Mon 收盤（+$5.55，+1.20% vs 6/19 ~$462.12；創收盤紀錄新高、盤中觸 $465+、市值約 $2.4 兆、P/E ~33.5）
    "nyse_change":    "+5.55",        # 6/22 漲跌（vs 6/19 ~$462.12）
    "nyse_change_pct":"+1.20%",       # 6/22 NYSE 收盤再創新高（延續 6/18 +6.94% 飆漲後高檔續攻、AI 需求 + Amkor 封裝長約）
    "52w_high_nyse":  "467.67",       # 52 週/歷史高（2026-06-22 收盤新高）
    "52w_low_nyse":   "206.20",       # 52 週低（區間）
    "pe_nyse":        "~33.5x",       # NYSE USD 基礎 P/E（TTM，$467.67 基礎）
    "pb_nyse":        "~13.5x",
    "beta":           "1.18",
    ...
    # 資料日期備註
    "data_note":      "報告日期：2026-06-23 Tue（NYSE TSM 6/22 Mon 收盤 $467.67 為最新確認數據；台股 2330 NT$2,510 為 6/22 Mon 官方收盤、6/19 Fri 端午節休市、6/23 Tue 今日交易中、官方收盤請以 TWSE 為準）。⭐⭐⭐ 今日頭條——台美雙市再創歷史新高：台股 2330 6/22 Mon 官方收 NT$2,510（+100、+4.15% vs 6/18 NT$2,410、收最高、量 39,134 張、市值 NT$65.1 兆）創歷史新高，受 6/18 NYSE +6.94% 飆漲與 6/19 美股交易帶動跳空大漲；NYSE TSM 6/22 Mon 收 $467.67（+$5.55、+1.20% vs 6/19 ~$462.12）再創收盤紀錄新高、市值約 $2.4 兆、P/E ~33.5。6/23 Tue 今日台股開盤 NT$2,455（自史高小幅跳空拉回、屬爆漲後獲利了結）、交易中、官方收盤待 TWSE。📊 台美 ADR 溢價（以 6/22 ADR $467.67 + 台股 NT$2,510 計）：理論值 5×2,510÷31.05 = $404.18、溢價 (467.67-404.18)/404.18 = +15.71%（溢價較 6/18 +19.08% 收斂、反映台股 6/22 已補漲跟上 ADR）。🤝 重大利多延續——TSMC-Amkor 簽 10 年美國先進封裝長約（6/16 公告、本波飆漲主因之一）：Amkor 將於 Arizona 州 Peoria 廠就近承接 TSMC 亞利桑那晶圓的先進封裝與測試（InFO / CoWoS）、Peoria 廠投資 $20 億→$70 億、2028 投產、~2,000 就業、呼應 TSMC $165B 美國投資承諾。🏆 NVIDIA 確認 TSMC 第 1 大客戶（22%/$33B、超越 Apple）、為 A16（1.6nm）首發客戶 2027 量產；Apple 跳過 A16 直上 A14（1.4nm）。📦 新增產業動態——TSMC 加速 CoPoS（面板級封裝）布局：以矩形玻璃面板取代圓形晶圓、擴大 AI GPU/HPC 封裝產能、目標 6 月底前完成材料與設備驗證；惟 Samsung 在 PLP（面板級封裝）技術仍領先數年、構成競爭壓力。⚠️ 風險續追蹤——（1）Apple 同意與 Intel 合作在美生產晶片以降低對 TSMC 依賴、Google/AMD/Tesla 接觸 Samsung 先進製程；（2）TSMC 遭美 ITC 專利調查（Longitude Licensing & Marlin Semiconductor 控訴）、6 月預計初判、恐對含關鍵 AI 加速器技術晶片發布美國進口禁令。  |  🎯 即將事件：6 月營收 7 月上旬公布；Q2 2026 財報法說會 7/16（指引 $39.0-40.2B、+10% QoQ、+32% YoY、毛利率 65-67%）  |  ⭐ 中長線結構性利多基底未變：5 月營收 NT$4,169.75 億 +30.1% 創單月新高；2nm 量產良率 70-80% 領先全球、年底月產能 100K 片；NVIDIA 第 1 大客戶 22%/$33B；4 大美國 CSP 2026 AI CapEx 合計 $725B（+77% YoY）；SIA/Deloitte 估 AI 資料中心晶片營收 2028 上看 $1.2 兆（4 年近 10 倍）；2026 全球半導體市場估 +25% YoY 達 ~$975B  |  ⚠️ 本日（6/23）關鍵觀察：（1）台股 2330 自 NT$2,510 史高拉回後能否守穩 NT$2,455 / 重返 NT$2,500；（2）ADR 溢價收斂至 +15.71%；（3）下方支撐 NT$2,455 / NT$2,410 / NT$2,375；上方壓力 NT$2,510 史高 / NT$2,550 / NT$2,600；（4）⚠️ 估值警示：TSM P/E ~33.5x、台股 P/E ~37.0x，留意台幣升值、短線過熱與 Apple-Intel/ITC 雜訊",
}
...
SUMMARY = {
    ...
    "sentiment":  "看多",
    # 一句話標題
    "headline":   "🚀 台美雙市再創歷史新高：台股 2330 6/22 收 NT$2,510（+4.15%、史高）、NYSE TSM 6/22 收 $467.67（+1.20%、紀錄高）；Amkor 封裝長約 + AI 需求續驅動；6/23 開盤 NT$2,455 自史高拉回、⚠️ Apple-Intel/ITC 雜訊未消",
    # 3–5 條白話重點（不用術語，每條約 30 字內）
    "bullets": [
        "🚀 台股 2330 6/22 Mon 官方收 NT$2,510（+100、+4.15% vs 6/18 NT$2,410、量 39,134 張、市值 NT$65.1 兆）創歷史新高",
        "📈 NYSE TSM 6/22 Mon 收 $467.67（+$5.55、+1.20%）再創收盤紀錄新高、市值約 $2.4 兆、延續 6/18 +6.94% 飆漲",
        "📊 ADR 溢價收斂至 +15.71%（自 6/18 +19.08%）、反映台股 6/22 已補漲跟上 ADR；6/23 開盤 NT$2,455 自史高拉回",
        "🤝 TSMC-Amkor 簽 10 年美國封裝長約（6/16 公告、本波飆漲主因）：Peoria AZ $20 億→$70 億、2028 投產、~2,000 就業",
        "🏆 NVIDIA 確認 TSMC 第 1 大客戶（22%/$33B）、為 A16（1.6nm）首發客戶 2027 量產；Apple 跳過 A16 直上 A14",
        "📦 TSMC 加速 CoPoS 面板級封裝布局、擴大 AI GPU/HPC 封裝產能；惟 Samsung PLP 技術仍領先數年構成競爭壓力",
        "⚠️ Apple 同意與 Intel 合作在美製造晶片降低對 TSMC 依賴、Google/AMD/Tesla 接觸 Samsung；TSMC 遭美 ITC 專利調查 6 月待初判",
        "⚠️ 估值警示 TSM P/E ~33.5x、台股 P/E ~37.0x，留意台幣升值與短線過熱",
    ],
    # 一句結論
    "bottom_line": "報告日期：2026-06-23 Tue（NYSE TSM 6/22 Mon 收盤 $467.67 為最新確認數據；台股 2330 NT$2,510 為 6/22 Mon 官方收盤、6/19 Fri 端午節休市、6/23 Tue 今日交易中、官方收盤請以 TWSE 為準）。🚀 今日頭條——台美雙市再創歷史新高：台股 2330 6/22 Mon 官方收 NT$2,510（+100、+4.15% vs 6/18 NT$2,410、收最高、量 39,134 張、市值 NT$65.1 兆）創歷史新高，受 6/18 NYSE +6.94% 飆漲與 6/19 美股交易帶動跳空大漲；NYSE TSM 6/22 Mon 收 $467.67（+$5.55、+1.20% vs 6/19 ~$462.12）再創收盤紀錄新高、市值約 $2.4 兆、P/E ~33.5。6/23 Tue 今日台股開盤 NT$2,455（自史高小幅跳空拉回、屬爆漲後獲利了結）、交易中、官方收盤待 TWSE。📊 台美 ADR 溢價（以 6/22 ADR $467.67 + 台股 NT$2,510 計）：理論值 5×2,510÷31.05 = $404.18、溢價 (467.67-404.18)/404.18 = +15.71%（溢價較 6/18 +19.08% 收斂、反映台股 6/22 已補漲跟上 ADR）。🤝 重大利多——TSMC-Amkor 簽 10 年美國先進封裝長約（6/16 公告、本波飆漲主因）：Amkor 將於 Arizona 州 Peoria 廠就近承接 TSMC 亞利桑那晶圓的先進封裝與測試（InFO / CoWoS）、Peoria 廠投資 $20 億→$70 億、2028 投產、~2,000 就業、形成美國本土「晶圓製造→先進封裝→測試」完整在地產業鏈、呼應 TSMC $165B 美國投資承諾。📦 新增產業動態——TSMC 加速 CoPoS（Chip-on-Panel-on-Substrate）面板級封裝布局：以矩形玻璃面板取代圓形晶圓、擴大 AI GPU/HPC 封裝產能、目標 6 月底前完成材料與設備驗證；惟 Samsung 在 PLP 面板級封裝技術仍領先數年、構成競爭壓力。⭐ 中長線結構性利多基底未變：（1）🏆 NVIDIA 確認 TSMC 第 1 大客戶（超越 Apple、22% / $33B）、為 A16（1.6nm）首發客戶 2027 量產；Apple 跳過 A16 直上 A14（1.4nm）；（2）⭐ NVIDIA Vera Rubin NVL72 採 TSMC N3 + CoWoS-L 封裝、首度搭載 8 層 HBM4；（3）💰 TSMC CFO 重申先進製程漲價——3nm H2 漲 ~15%、sub-5nm 漲 5-10%、反映定價權；（4）⭐ TSMC 2nm 已量產、初期良率 70-80% 領先全球、年底月產能目標 100K 片、2nm 至 2028 CAGR +70%；（5）📦 CoWoS 封裝瓶頸續為產業關鍵、TSMC 規劃 2026 底擴至 ~130K wpm、5.5 倍光罩封裝良率 >98%；（6）📊 SIA/Deloitte 估 AI 資料中心晶片營收 2028 上看 $1.2 兆（4 年近 10 倍）、晶片佔 AI server rack 價值 95%；（7）4 大美國 CSP 2026 AI CapEx 合計 $725B（+77% YoY）；（8）⭐ 5 月營收 NT$4,169.75 億 +30.1% 創單月新高、1-5 月累計 NT$1.96 兆；（9）2026 全球半導體市場估 +25% YoY 達 ~$975B。⚠️ 短期/中期下行風險：（1）⚠️ 客戶分散——Apple 同意與 Intel 合作在美生產晶片降低對 TSMC 依賴、Google/AMD/Tesla 接觸 Samsung 先進製程（屬中期觀察、TSMC 技術代差仍領先）；（2）⚠️ 法律風險——TSMC 遭美 ITC 專利調查（Longitude Licensing & Marlin Semiconductor 控訴）、6 月預計初判、恐對含關鍵 AI 加速器技術晶片發布美國進口禁令；（3）⚠️ 估值警示——TSM P/E ~33.5x、台股 P/E ~37.0x，留意賣壓與台幣升值；（4）台幣升值壓力（每升 1% 毛利率 -40bps）；（5）⚠️ 短線過熱——RSI/KDJ 進入高檔超買區、6/23 自史高拉回留意獲利了結。基本面未變：Q1 2026 淨利 NT$572.5B（$18.2B、+58.3% YoY）、毛利率 66.2% 雙創史高；2025 全年 EPS NT$66.25。技術面（基於 6/22 官方收 NT$2,510）：5MA NT$2,425 / 20MA NT$2,380 / 60MA NT$2,335 / 120MA NT$2,230；下方支撐 NT$2,455 / NT$2,410 / NT$2,375；上方壓力 NT$2,510（史高）/ NT$2,550 / NT$2,600。32 位分析師全數看多、平均目標 NT$2,530 上行空間 +0.80%（自 NT$2,510、目標趨近、有待法說會後上修）。",
    # 重大警示（選填，空白則不顯示）
    "risk_alert":  "今日（6/23 Tue）關鍵觀察：（1）🚀 台股 2330 6/22 官方收 NT$2,510（+4.15%、收最高、創歷史新高）、市值 NT$65.1 兆；6/23 開盤 NT$2,455 自史高小幅拉回、交易中、官方收盤待 TWSE；（2）📈 NYSE TSM 6/22 收 $467.67（+1.20%）再創收盤紀錄新高、市值約 $2.4 兆；（3）📊 ADR 溢價收斂至 +15.71%（自 6/18 +19.08%）、台股已補漲跟上；（4）🤝 TSMC-Amkor 簽 10 年美國先進封裝長約（Peoria AZ $70 億、2028 投產、~2,000 就業、本波飆漲主因）；（5）🏆 NVIDIA 確認 TSMC 第 1 大客戶（22%/$33B）、為 A16 首發客戶 2027 量產；Apple 跳過 A16 直上 A14；（6）📦 TSMC 加速 CoPoS 面板級封裝布局擴大 AI 封裝產能、惟 Samsung PLP 領先；（7）⚠️ 風險續追蹤——Apple 同意與 Intel 合作在美生產晶片降低對 TSMC 依賴、Google/AMD/Tesla 接觸 Samsung（中期觀察、技術代差仍領先）；（8）⚠️ TSMC 遭美 ITC 專利調查（Longitude/Marlin 控訴）、6 月預計初判、恐對含 AI 加速器技術晶片發布美國進口禁令；（9）💰 TSMC CFO 重申先進製程漲價——3nm H2 漲 ~15%、sub-5nm 漲 5-10%；（10）📦 CoWoS 瓶頸續為產業關鍵、TSMC 2026 底擴至 ~130K wpm、良率 >98%；（11）📊 SIA/Deloitte 估 AI 資料中心晶片營收 2028 上看 $1.2 兆（4 年近 10 倍）；（12）⭐ 5 月營收 NT$4,169.75 億 +30.1% 創單月新高；（13）⭐ 2nm 量產良率 70-80% 領先全球；（14）⭐ 4 大美國 CSP 2026 AI CapEx 合計 $725B（+77% YoY）；（15）⚠️ 估值警示：TSM P/E ~33.5x、台股 P/E ~37.0x、留意台幣升值與短線過熱；32 位分析師全數看多、平均目標 NT$2,530（已趨近、待法說會上修）；本日（6/23）關鍵：台股自 NT$2,510 史高拉回後能否守穩 NT$2,455 / 重返 NT$2,500；下方支撐 NT$2,455 / NT$2,410 / NT$2,375",
}

# 三大法人買賣超（張）— 最新一日
INSTITUTIONAL = {
    "date":     "2026-06-22",       # 最新資料日（6/22 Mon 為官方最後交易日、6/19 端午休市、6/23 今日盤後待公布；6/22 三大法人為估算、官方以 TWSE 盤後為準）
    "foreign":  +18000,             # 外資 6/22 估大買超（隨股價 +4.15% 創史高、受 ADR 飆漲帶動跳空大漲；待官方確認）
    "trust":    +2000,              # 投信 6/22 估續買 +2,000 張
    "dealer":   +800,               # 自營商 6/22 估買超 +800 張
    # 近5日（由舊到新：6/15, 6/16, 6/17, 6/18, 6/22）；6/19 端午休市；6/16 含實際、其餘為估算
    "foreign_5d": [+5000, -382, +4000, +12000, +18000],      # 外資 6/16 實際 -382、6/22 估隨史高大買
    "trust_5d":   [+1000, +3849, +800, +1500, +2000],        # 投信 6/16 實際 +3,849、6/22 估續買
    "dealer_5d":  [+500, -158, +300, +600, +800],            # 自營 6/16 實際 -158、6/22 估買超
    "foreign_ownership_pct": "75.1%",  # 外資持股比例（創史高後 6/22 估回升至 75.1%）
    "foreign_ownership_shares": "約 194.5 億股",
}

# 技術分析指標（需每日從看盤軟體更新）
TECHNICAL = {
    "rsi_14":       74.0,   "rsi_signal": "RSI 估自 68 升至 74（台股 6/22 +4.15% 創史高、NYSE 6/22 +1.20% 紀錄高），多方動能強、已進入 70+ 超買區、⚠️ 短線過熱、6/23 自史高拉回留意獲利了結",
    "macd":         0.60,  "macd_signal": "MACD 估自 +0.45 擴大至 +0.60、紅柱續放大、續守零軸上方、多頭動能強",   "macd_color": "#4CAF50",
    "kdj_k":        88.0,   "kdj_d": 82.0, "kdj_j": 96.0, "kdj_signal": "KDJ K(88)/D(82)/J(96) 全面走高、多頭排列、J 深入高檔超買區、⚠️ 過熱、留意短線回檔",
    "ma5":       "2,425",   # 5MA（6/16 2385, 6/17 2385, 6/18 2410, 6/22 2510）— 基於 6/22 官方收
    "ma20":      "2,380",   # 20MA 翻揚
    "ma60":      "2,335",   # 60MA 緩升
    "ma120":     "2,230",
    "bb_upper":  "2,560",   # 布林上軌
    "bb_mid":    "2,380",   # 布林中軌（20MA）
    "bb_lower":  "2,230",   # 布林下軌
    "vol_ma5":  "44,000",   # 5日均量（張，估、基於 6/16-6/22 五日均）
    "trend":    "🚀 台美雙市再創歷史新高：台股 2330 6/22 官方收 NT$2,510（+100、+4.15%、收最高、量 39,134 張）創史高、受 ADR 飆漲帶動跳空大漲；NYSE TSM 6/22 收 $467.67（+1.20%）再創收盤紀錄新高、市值約 $2.4 兆；6/23 今日台股開盤 NT$2,455 自史高小幅拉回、交易中。🤝 本波飆漲主因：TSMC-Amkor 10 年美國先進封裝長約（6/16 公告）+ 分析師升評 + AI 需求。📊 技術面（基於 6/22 官方收 NT$2,510）：RSI 74 進入超買、MACD +0.60 紅柱續放大、KDJ J(96) 深入高檔超買、多頭排列、短期 5MA NT$2,425 / 20MA NT$2,380 翻揚、中期 60MA/120MA 趨勢偏多。下一觀察：（1）📈 台股自 NT$2,510 史高拉回後能否守穩 NT$2,455 / 重返 NT$2,500；（2）下方支撐 NT$2,455 / NT$2,410 / NT$2,375；（3）上方壓力 NT$2,510 史高 / NT$2,550 / NT$2,600；（4）⚠️ 短線 RSI/KDJ 過熱、6/23 拉回留意獲利了結；（5）⚠️ 雜訊續追蹤：Apple-Intel 合作降低對 TSMC 依賴、ITC 專利調查；（6）⭐ 中長線結構性利多基底未變：Amkor 美國封裝長約 + NVIDIA #1 客戶 + A16 首發 + 2nm 量產 70-80% 良率 + CoWoS 2026 底擴至 ~130K wpm。",
    "support":  "2,455 / 2,410 / 2,375 / 2,310 (6/23 開、6/18 收、前高、前低)",
    "resist":   "2,510 / 2,550 / 2,600 / 2,650 (6/22 史高、整數、整數、整數)",
    "note": "技術指標數值為估算（基於 6/22 官方收 NT$2,510），請以看盤軟體即時數據為準；台股 6/22 創史高 +4.15%、NYSE 6/22 紀錄高 +1.20%、RSI 74 進入超買、KDJ J(96) 高檔過熱、MACD 紅柱續放大多頭動能強；NT$2,455 為關鍵支撐、上方壓力 NT$2,510 史高 / NT$2,550；6/23 今日台股自史高拉回、⚠️ 留意短線過熱回檔",
}

# 期貨與選擇權（來源：台灣期交所 TAIFEX）
DERIVATIVES = {
    "date":          "2026-06-22",       # 最新資料日（6/22 Mon 收盤估、6/19 端午休市、6/23 今日盤後待公布）
    "futures_price": "2,512",            # 台積電期貨近月（6/22 收盤附近、隨現貨創史高）
    "futures_oi":    "178,000",          # 未平倉量（口）（6/22 估、創史高增倉）
    "futures_basis": "+2",               # 6/22 估小幅正價差（多方氣氛）
    "call_oi":       "118,000",
    "put_oi":        "70,000",
    "pcr":           "0.59",             # Put/Call 比率（6/22 估自 0.63 回落至 0.59、創史高後偏多、惟偏低留意過熱）
    "pcr_signal":    "偏多（Put/Call 6/22 估回落至 0.59、自前日 0.63 減少；反映台股 +4.15% 創史高帶動市場情緒轉熱、⚠️ PCR 偏低留意短線過熱）",
    "max_pain":      "2,450",            # 最大痛苦價格（近期到期、6/22 估）
    "key_strikes": [
        ("2,410", "Call 54,000 / Put 13,000", "前收支撐"),
        ("2,450", "Call 58,000 / Put 10,000", "心理整數、最大痛苦"),
        ("2,455", "Call 56,000 / Put 9,000",  "6/23 開"),
        ("2,510", "Call 50,000 / Put 6,500",  "6/22 史高"),
        ("2,550", "Call 44,000 / Put 4,200",  "整數壓力"),
        ("2,600", "Call 38,000 / Put 3,200",  "整數壓力"),
        ("2,650", "Call 32,000 / Put 2,600",  "整數壓力"),
    ],
    "note": "衍生品數據需每日至台灣期交所(taifex.com.tw)更新；6/22 PCR 自 0.63 回落至 0.59 反映台股 +4.15% 創史高帶動情緒轉熱、最大痛苦價上移至 NT$2,450；NT$2,455 為關鍵支撐、上方壓力 NT$2,510 史高 / NT$2,550；⚠️ 6/19 端午休市、6/23 今日台股自史高拉回；中長線結構性利多基底未變（TSMC-Amkor 美國封裝長約、NVIDIA 確認第 1 大客戶 + A16 首發、2nm 量產 70-80% 良率、CoWoS 2026 底擴至 ~130K wpm、4 大 CSP CapEx $725B）；⚠️ 雜訊續追蹤：Apple-Intel 合作、ITC 專利調查",
}

# 供應鏈與客戶股價（需每日更新）
ECOSYSTEM_STOCKS = [
    # 類別、股票代碼、名稱、收盤價、漲跌幅、備註（美股為 2026-06-22 Mon 收盤、台股為 6/22 Mon 收盤；價格為估算）
    ("設備", "ASML",    "艾司摩爾",    "872.00", "+1.63%", "EUV 設備龍頭（6/22 續漲；高 NA EUV 需求結構性多頭）"),
    ("設備", "AMAT",    "應用材料",    "526.00", "+1.54%", "⭐ 6/22 續漲；TSMC EPIC Center $5B AI 合作 + 先進封裝設備需求結構性多頭"),
    ("設備", "LRCX",    "科林研發",    "1,052.00", "+1.64%", "蝕刻設備（6/22 續漲；半導體設備需求創紀錄）"),
    ("設備", "KLAC",    "科磊",        "792.00", "+1.54%", "量測設備（6/22 續漲；2nm 量產驅動）"),
    ("記憶", "000660.KS","SK 海力士",  "392,000 KRW", "+1.82%", "🤝 SK 海力士-TSMC 深化 HBM4 合作；Samsung/SK 送樣第 7 代 HBM4E；HBM4 需求結構性多頭"),
    ("記憶", "MU",      "美光",        "156.50", "+2.29%", "HBM / DDR5（6/22 續漲；HBM4 需求強勁、LPDDR6 接棒）"),
    ("封裝", "3711.TW", "日月光",      "320",    "+2.24%", "CoWoS / 先進封裝（6/22 跟進台股 2330 創史高；先進封裝瓶頸結構受惠）"),
    ("封裝", "AMKR",    "Amkor",       "49.50",  "+4.87%", "🚀 續強：TSMC-Amkor 簽 10 年美國封裝長約、Peoria AZ $70 億 2028 投產、就近承接 Arizona 廠封測（本波利多核心）"),
    ("客戶", "NVDA",    "輝達",        "274.00", "+3.01%", "🏆 確認 TSMC #1 客戶 22%、A16 首發客戶 2027 量產（6/22 續漲；完成 $250 億債券發行；cuLitho 助 TSMC 提良率）"),
    ("客戶", "AAPL",    "蘋果",        "301.00", "+1.01%", "⚠️ #2 客戶 18%；Apple 同意與 Intel 合作在美生產晶片以降低對 TSMC 依賴；跳過 A16 直上 A14"),
    ("客戶", "AVGO",    "博通",        "478.00", "+1.70%", "🔄 #3 客戶（6/22 續漲；custom XPU 強勁；惟 6/5 Q3 AI 晶片指引 $16B 略低於估）"),
    ("客戶", "AMD",     "超微",        "528.00", "+1.93%", "#4 客戶（6/22 續漲；MI350/MI450 GPU 搶市；傳接觸 Samsung 先進製程）"),
    ("客戶", "2454.TW", "聯發科",      "4,720",  "+1.18%", "手機 SoC 客戶 9%；6/22 跟進台股半導體類股大漲；RTX Spark 由聯發科協同 NVIDIA 設計"),
    ("競爭", "INTC",    "英特爾",      "49.80",  "+3.11%", "🚀 續強創高：Apple 將與 Intel 合作在美設計製造晶片；18A-P 進入風險量產（效能 +9%）；與 UMC 結盟挑戰 TSMC"),
    ("競爭", "005930.KS","三星電子",   "66,200 KRW", "+2.16%", "Samsung Foundry 6/22 上漲；傳 Google/AMD/Tesla 接觸其先進製程；PLP 面板級封裝領先、與 TSMC CoPoS 競爭；HBM4E 送樣中"),
    ("處分後", "ARM",   "Arm Holdings","261.00", "+1.95%", "TSMC 4/29 全數出脫後（6/22 續漲；RTX Spark ARM 架構受惠）"),
]
...
CONSENSUS = {
    ...
    "upside":       "+0.80%",   # 從 NT$2,510（6/22 官方收）到 NT$2,530（目標趨近、待 7/16 法說會後上修）
}
...
NEWS = [
    {
        ...
        "title": "🚀 台美雙市再創歷史新高：台股 2330 6/22 收 NT$2,510（+4.15%、史高）、NYSE TSM 6/22 收 $467.67（+1.20%、紀錄高、市值約 $2.4 兆）",
        "body": "TSMC 台美雙市於 6/22 同步再創歷史新高、延續 6/18 飆漲動能：（1）🚀 台股 2330 6/22 Mon 官方收 NT$2,510（+100、+4.15% vs 6/18 NT$2,410、收最高、量 39,134 張、市值 NT$65.1 兆）創歷史新高，受 6/18 NYSE +6.94% 飆漲與 6/19 美股交易日帶動跳空大漲；（2）📈 NYSE TSM 6/22 Mon 收 $467.67（+$5.55、+1.20% vs 6/19 ~$462.12）再創收盤紀錄新高、市值衝上約 $2.4 兆、P/E ~33.5；（3）三大驅動續發酵——TSMC-Amkor 10 年美國先進封裝長約（6/16 公告）、多家分析師升評、AI 結構性需求；（4）🗓️ 6/19 Fri 端午節 TWSE 休市、6/23 Tue 今日台股開盤 NT$2,455（自史高小幅跳空拉回、屬爆漲後獲利了結）、交易中、官方收盤待 TWSE；（5）📊 台美 ADR 溢價收斂至 +15.71%（理論值 5×2,510÷31.05 = $404.18、自 6/18 +19.08% 收斂），反映台股已補漲跟上 ADR。",
        "source": "stockanalysis.com / Yahoo Finance / TradingView / cnyes / 鉅亨網 2026-06-22 - 06-23", "impact": "正面",
    },
    {
        "tag": "產業趨勢", "tag_color": "#4CAF50",
        "title": "📦 TSMC 加速 CoPoS 面板級封裝布局、目標 6 月底完成材料/設備驗證；惟 Samsung PLP 技術仍領先數年",
        "body": "TSMC 全力衝刺次世代面板級封裝、搶攻 AI 封裝產能：（1）📦 TSMC 正加速推進 CoPoS（Chip-on-Panel-on-Substrate）——以較大的矩形玻璃面板取代傳統圓形晶圓進行封裝，可大幅提升單批產出面積、支撐 AI GPU 與 HPC 晶片爆發的封裝需求；（2）⏱️ TSMC 力拚於 6 月底前完成材料與設備的驗證（qualification）、加快量產時程；（3）⚠️ 競爭壓力——Samsung Electronics 在 PLP（Panel-Level Packaging）面板級封裝技術上維持數年領先，對 TSMC 形成追趕壓力；（4）⭐ 戰略意涵：CoPoS 與既有 CoWoS 互補、共同緩解 AI 晶片先進封裝瓶頸；TSMC CoWoS 規劃自 2024 底 ~35K wpm 擴至 2026 底 ~130K wpm、良率 >98%；（5）🎯 觀察：先進封裝為 AI 算力供應鏈關鍵卡口、CoPoS 量產時程與良率將牽動 NVIDIA/AMD 等客戶出貨。",
        "source": "DIGITIMES / TrendForce / SemiWiki 2026-06-22", "impact": "正面",
    },
    {
        "tag": "客戶動態", "tag_color": "#2196F3",
        "title": "🤝 TSMC-Amkor 簽 10 年美國先進封裝長約（6/16 公告、本波飆漲主因）：Peoria AZ 廠 $20 億→$70 億、2028 投產、~2,000 就業",
        "body": "TSMC 與封測龍頭 Amkor 6/16 正式公告長期合作、為本波雙市飆漲核心催化：（1）🤝 雙方簽署 10 年長約——Amkor 將於 Arizona 州 Peoria 廠就近承接 TSMC 亞利桑那晶圓廠產出進行先進封裝（InFO / CoWoS）與測試；（2）💰 Amkor Peoria 廠投資自原 $20 億大幅擴大至 $70 億、預計 2028 投產、創造最多 2,000 個就業；（3）⭐ 戰略意涵：在美國本土形成「晶圓製造→先進封裝→測試」迄今最完整在地產業鏈、降低地緣與物流風險、呼應 TSMC $165B 美國投資承諾；（4）⭐ 強化與美國客戶（NVIDIA/AMD/Apple）就近供應能力、亦部分抵銷 Apple-Intel 客戶分散疑慮；（5）📦 產業背景：先進封裝為 AI/HPC 晶片瓶頸、TSMC CoWoS 規劃 2026 底擴至 ~130K wpm、良率 >98%。",
        "source": "BusinessWire / TSMC PR / Amkor / SemiWiki 2026-06-16", "impact": "正面",
    },
    {
        "tag": "客戶動態", "tag_color": "#2196F3",
        "title": "🏆 NVIDIA 確認 TSMC 第 1 大客戶（22%/$33B）、為 A16（1.6nm）首發客戶 2027 量產；6 月完成 $250 億債券發行",
        "body": "NVIDIA 與 TSMC 雙向綁定持續深化：（1）🏆 NVIDIA CEO 黃仁勳確認 NVIDIA 已超越 Apple 成為 TSMC 第 1 大客戶（約 22% / $33B），反映 AI 資料中心與 HPC 需求爆發；（2）⭐ NVIDIA 將是 TSMC 次世代 A16（1.6nm）製程首發客戶、2027 於台灣廠量產；Apple 則跳過 A16、直接採用 A14（1.4nm）；（3）💰 NVIDIA 6 月完成 $250 億（$25B）優先無擔保債券發行（到期日 2028–2056）、強化 AI 基礎建設彈藥；（4）⭐ NVIDIA-TSMC 將 AI 導入晶圓廠（cuLitho/Omniverse FabTwin）提升良率、優化產能、直接緩解產能緊俏；（5）⭐ 其他客戶 AMD（MI350/MI450）、Broadcom（custom XPU）、Qualcomm、MediaTek 仍為重要需求來源。",
        "source": "CNBC / eWeek / Tom's Hardware / SEC 8-K 2026-06-15 - 06-22", "impact": "正面",
    },
    {
        "tag": "地緣政治", "tag_color": "#607D8B",
        "title": "⚠️ Apple 同意與 Intel 合作在美生產晶片、降低對 TSMC 依賴；Google/AMD/Tesla 接觸 Samsung 先進製程",
        "body": "客戶分散雜訊升溫、為 TSMC 中期觀察重點：（1）⚠️ 多家媒體報導 Apple 已同意與 Intel 合作在美國本土製造晶片、以降低對 TSMC 的依賴——呼應川普政府推動半導體在地化；（2）⚠️ Google、AMD、Tesla 亦傳出積極接觸 Samsung Foundry 先進製程服務、尋求第二供應來源；Intel 18A-P 進入風險量產（同功耗效能 +9%）並與台灣 UMC 結盟挑戰 TSMC 代工地位；（3）✅ 緩解因素：TSMC 在 N3/N2/A16 先進製程具明顯技術代差與良率領先、Apple 仍跳過 A16 直上 TSMC A14（1.4nm）、客戶分散多屬成熟/特定產品線；（4）🎯 觀察：客戶自研 ASIC 與雙供應策略下，TSMC 最先進節點訂單能見度仍滿載、惟須留意成熟製程市占與長期客戶集中度變化。",
        "source": "Reuters / CNBC / Bloomberg / ts2.tech 2026-06-18 - 06-22", "impact": "負面",
    },
    {
        ...
        "source": "USITC / Reuters / Bloomberg / ts2.tech 2026-06-18 - 06-22", "impact": "負面",
    },
]
