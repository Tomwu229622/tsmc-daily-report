...
STOCK = {
    # 台股 2330
    "tw_price":       "2,310",        # 2026-06-12 Fri 實際收盤（+60，+2.67% vs 6/11 收 NT$2,250；跟進 NYSE TSM 6/11 +3.20% 反彈、放量上攻；6/15 Mon 官方收盤待確認）
    "tw_change":      "+60",          # 6/12 實際漲跌點數（vs 6/11 收 NT$2,250）
    "tw_change_pct":  "+2.67%",       # 6/12 實際漲跌幅
    "tw_volume":      "45,000",       # 6/12 成交量（張，估）
    "tw_open":        "2,290",        # 6/12 開盤（跟進 NYSE 6/11 +3.20% 跳空高開）
    "tw_high":        "2,325",        # 6/12 盤中高（估）
    "tw_low":         "2,285",        # 6/12 盤中低（估）
    "market_cap":     "NT$59.9 兆",   # 6/12 收盤市值（NT$2,310 基礎）
    "pe_ratio":       "~34.0x",       # 台股 P/E（TTM，NT$2,310 基礎）
    "pb_ratio":       "~12.0x",       # 台股 P/B（股淨比，NT$2,310 基礎）
    "div_yield":      "~0.65%",       # 殖利率（NT$2,310 基礎）
    "52w_high_tw":    "2,440",        # 52 週/歷史高（2026-06-03 盤中觸 NT$2,440 史高）
    "52w_low_tw":     "780",          # 52 週低（2025-04-07）
    # NYSE TSM ADR
    "nyse_price":     "423.93",       # 6/12 Fri 實際收盤（+$2.86，+0.68% vs 6/11 $421.07；連 2 日上漲，來源 stockanalysis.com）
    "nyse_change":    "+2.86",        # 6/12 漲跌（vs 6/11 $421.07）
    "nyse_change_pct":"+0.68%",       # 6/12 NYSE 連 2 日收紅（反彈延續、消化 sell-the-news）
    "52w_high_nyse":  "450.16",       # 52 週高（2026-06 區間更新，來源 Google Finance）
    "52w_low_nyse":   "206.20",       # 52 週低（區間更新）
    "pe_nyse":        "~35.1x",       # NYSE USD 基礎 P/E（TTM，估算，$423.93 基礎）
    "pb_nyse":        "~12.2x",
    "beta":           "1.18",
    ...
    # 資料日期備註
    "data_note":      "報告日期：2026-06-15 Mon（NYSE TSM 6/12 Fri 收盤為最新確認數據、週末休市；台股 2330 6/12 Fri 收盤為最新確認、6/15 Mon 官方收盤待確認）。⭐⭐⭐ 今日頭條——TSMC 反彈延續、台美雙市連 2 日收紅：NYSE TSM 6/12 Fri 收 $423.93（+$2.86、+0.68% vs 6/11 $421.07，來源 stockanalysis.com）連 2 日上漲、消化 6/10 sell-the-news 賣壓；台股 2330 6/12 Fri 放量收 NT$2,310（+60、+2.67% vs 6/11 NT$2,250）跟進 NYSE 6/11 +3.20% 反彈、市值回升 NT$59.9 兆、加權指數 6/12 大漲 +1,019.58 點站回 44,000+。💡 重大技術進展——TSMC CoPoS 玻璃基板封裝突破：分析師郭明錤 6/10 揭露 TSMC 規劃 2028 H2 量產 CoPoS（Chip-on-Panel-on-Structure）玻璃基板封裝、可支援超越光罩 9.5 倍的超大封裝、NVIDIA Feynman AI 晶片為潛在首批採用者；為次世代 AI 大晶片（CoWoS 尺寸瓶頸）解方。💰 結構性利多續存：TSMC CFO 確認先進製程 H2 漲價——3nm 漲 ~15%、sub-5nm 漲 5-10%（AI 需求 + 3nm 產能短缺驅動）；CEO C.C. Wei 重申「全球晶片供應將數年內持續落後 AI 需求」、Q2 月產能 160K–175K 片仍供不應求。⚠️ 競爭雜訊：Google 向 Intel Foundry 下單逾 300 萬顆自研 TPU（2028 交付）、Intel 6/8 大漲逾 11%；Samsung 推進 HPB 封裝對標 TSMC CoPoS——市場解讀部分客戶在 TSMC 產能緊俏下尋求分散。台美 ADR 溢價（以 6/12 ADR $423.93 + 6/12 台股 NT$2,310 計）：理論值 5×2,310÷31.05 = $371.98、溢價 (423.93-371.98)/371.98 = +13.97%。  |  🎯 即將事件：6 月營收 7 月上旬公布；Q2 2026 財報法說會 7/16（指引 $39.0-40.2B、+10% QoQ、+32% YoY、毛利率 65-67%）  |  ⭐ 中長線結構性利多基底未變：5 月營收 NT$4,169.75 億 +30.1% 創單月新高；2nm 量產良率 70-80% 領先全球、年底月產能 100K 片；NVIDIA 第 1 大客戶 22%/$33B + RTX Spark 由 TSMC 代工；4 大美國 CSP（Google/AWS/MSFT/Meta）2026 AI CapEx 合計 $725B（+77% YoY）；NVIDIA-TSMC AI 製程合作（cuLitho/cuEST/FabTwin）；Intel CEO 確認長期夥伴；PwC 報告 TSMC 市值年增 +101% 躋身全球第 9 大市值企業  |  ⚠️ 本日（6/15）關鍵觀察：（1）台股 2330 6/12 站回 NT$2,310 / 5MA 後、6/15 能否續攻挑戰 NT$2,365；（2）外資能否在 ADR 連 2 紅後止賣轉買；（3）下方支撐 NT$2,250 / NT$2,200（心理整數）/ NT$2,180（120MA）；上方壓力 NT$2,365 / NT$2,400 / NT$2,440",
}
...
SUMMARY = {
    ...
    "sentiment":  "中性偏多",
    # 一句話標題
    "headline":   "✅ TSMC 反彈延續、台美雙市連 2 日收紅：NYSE TSM 6/12 收 $423.93（+0.68%）、台股 2330 6/12 放量收 NT$2,310（+2.67%）；CoPoS 玻璃封裝突破成新亮點",
    # 3–5 條白話重點（不用術語，每條約 30 字內）
    "bullets": [
        "✅ NYSE TSM 6/12 Fri 收 $423.93（+$2.86、+0.68% vs 6/11 $421.07）連 2 日收紅、反彈延續",
        "📈 台股 2330 6/12 Fri 放量收 NT$2,310（+60、+2.67% vs 6/11 NT$2,250）、市值回升 NT$59.9 兆",
        "🚀 台股加權指數 6/12 大漲 +1,019.58 點、站回 44,000 點之上、半導體類股全面反彈",
        "💡 技術突破：TSMC CoPoS 玻璃基板封裝 2028 H2 量產、支援超光罩 9.5 倍超大封裝、NVIDIA Feynman 首批採用",
        "💰 TSMC CFO 確認先進製程 H2 漲價（3nm 漲 ~15%、sub-5nm 漲 5-10%）；CEO Wei 重申供應數年落後 AI 需求",
        "⚠️ 競爭雜訊：Google 向 Intel Foundry 下單逾 300 萬顆自研 TPU（2028）、Samsung 推進 HPB 封裝對標",
        "⭐ 中長線基底未變：5 月營收 NT$4,169.75 億 +30.1% 創單月新高 + 2nm 量產 70-80% 良率 + 4 大 CSP CapEx $725B",
        "⚠️ 估值警示：TSM P/E ~35.1x 仍在 5 年高位、6/15 關鍵守住 NT$2,250、上攻挑戰 NT$2,365",
    ],
    # 一句結論
    "bottom_line": "報告日期：2026-06-15 Mon（NYSE TSM 6/12 Fri 收盤為最新確認數據、週末休市；台股 2330 6/12 Fri 收盤為最新確認、6/15 Mon 官方收盤待確認）。⭐⭐⭐ 今日頭條——TSMC 反彈延續、台美雙市連 2 日收紅：NYSE TSM 6/12 Fri 收 $423.93（+$2.86、+0.68% vs 6/11 $421.07，來源 stockanalysis.com）連 2 日上漲、消化 6/10 sell-the-news 賣壓；台股 2330 6/12 Fri 放量收 NT$2,310（+60、+2.67% vs 6/11 NT$2,250）跟進 NYSE 6/11 +3.20% 反彈、市值回升 NT$59.9 兆；台股加權指數 6/12 大漲 +1,019.58 點站回 44,000+。💡 重大技術進展——TSMC CoPoS 玻璃基板封裝突破：分析師郭明錤 6/10 揭露 TSMC 規劃 2028 H2 量產 CoPoS（Chip-on-Panel-on-Structure）玻璃基板封裝、製程中以 310×310mm 玻璃為臨時載板、最終為玻璃核心基板、可支援超越光罩 9.5 倍的超大封裝、成本與良率優於 CoWoS；NVIDIA Feynman 次世代 AI 晶片為潛在首批採用者、解決 CoWoS 尺寸瓶頸。台美 ADR 溢價（以 6/12 ADR $423.93 + 6/12 台股 NT$2,310 計）：理論值 5×2,310÷31.05 = $371.98、溢價 (423.93-371.98)/371.98 = +13.97%。⭐ 中長線結構性利多基底未變：（1）💡 CoPoS 玻璃封裝 2028 量產、次世代 AI 大晶片解方；（2）💰 TSMC CFO 確認先進製程 H2 漲價——3nm 漲 ~15%、sub-5nm 漲 5-10%、反映 AI 強勁需求 + 3nm 產能短缺下的定價權；（3）🏛️ CEO C.C. Wei 重申「全球晶片供應將數年內持續落後 AI 需求」、Q2 月產能 160K–175K 片仍供不應求、2026 >30% 成長指引；（4）⭐ TSMC 2nm 已量產、nanosheet GAA、初期良率 70-80% 領先全球、年底月產能目標 100K 片；2nm 至 2028 CAGR +70%；（5）NVIDIA 第 1 大客戶（22% / $33B）、Apple 第 2 大（18% / $27B）；（6）NVIDIA-TSMC AI 製程合作（cuLitho/cuEST/Omniverse FabTwin）導入晶圓廠提升良率；（7）NVIDIA RTX Spark 超晶片由 TSMC N3E + CoWoS 代工；（8）4 大美國 CSP 2026 AI CapEx 合計 $725B（+77% YoY）；（9）⭐ 5 月營收 NT$4,169.75 億 +30.1% 創單月新高、1-5 月累計 NT$1.96 兆；（10）PwC 報告 TSMC 市值年增 +101% 躋身全球第 9 大市值企業。⚠️ 短期下行風險：（1）⚠️ 競爭雜訊——Google 向 Intel Foundry 下單逾 300 萬顆自研 TPU（2028 交付）、Samsung 推進 HPB 封裝對標 CoPoS、Intel 6/8 大漲逾 11%；（2）外資 6/9-6/11 連 3 日賣超、籌碼面尚待轉多；（3）Fed 升息預期升溫、10Y 美債殖利率 4.5%+；（4）美對中 AI 晶片出口管制擴大；（5）⚠️ 估值警示 TSM P/E ~35.1x 仍在 5 年高位。基本面未變：Q1 2026 淨利 NT$572.5B（$18.2B、+58.3% YoY）、毛利率 66.2% 雙創史高；2025 全年 EPS NT$66.25。技術面（基於 6/12 收 NT$2,310）：5MA NT$2,285 / 20MA NT$2,320 / 60MA NT$2,300 / 120MA NT$2,180；下方支撐 NT$2,250 / NT$2,200 心理整數 / NT$2,180（120MA）；上方壓力 NT$2,365 / NT$2,400 / NT$2,440。32 位分析師全數看多、平均目標 NT$2,530 上行空間 +9.52%（自 NT$2,310）。",
    # 重大警示（選填，空白則不顯示）
    "risk_alert":  "今日（6/15 Mon）關鍵觀察：（1）✅ NYSE TSM 6/12 Fri 收 $423.93（+0.68%）連 2 日收紅、反彈延續、消化 sell-the-news 賣壓；（2）📈 台股 2330 6/12 Fri 放量收 NT$2,310（+2.67%）、加權指數大漲 +1,019.58 點站回 44,000+；（3）💡 重大技術進展：TSMC CoPoS 玻璃基板封裝 2028 H2 量產、支援超光罩 9.5 倍超大封裝、NVIDIA Feynman 首批採用、解決 CoWoS 尺寸瓶頸；（4）💰 TSMC CFO 確認 3nm H2 漲 ~15%、sub-5nm 漲 5-10% 續存利多；CEO Wei 重申供應數年落後 AI 需求、Q2 月產能 160K–175K 片；（5）⚠️ 競爭雜訊：Google 向 Intel Foundry 下單逾 300 萬顆自研 TPU（2028 交付）、Samsung 推進 HPB 封裝對標 CoPoS、Intel 6/8 大漲逾 11%；（6）🏆 PwC 報告 TSMC 市值年增 +101% 躋身全球第 9 大市值企業；（7）⭐ 5 月營收 NT$4,169.75 億 +30.1% 創單月新高、1-5 月累計 NT$1.96 兆；（8）⭐ TSMC 2nm 量產良率 70-80% 領先全球、年底月產能 100K 片；（9）⭐ 4 大美國 CSP 2026 AI CapEx 合計 $725B（+77% YoY）；（10）⭐ NVIDIA-TSMC AI 製程合作 + RTX Spark 由 TSMC 代工；（11）⚠️ 估值警示 TSM P/E ~35.1x 仍在 5 年高位；（12）⚠️ Fed 升息預期升溫、10Y 美債殖利率 4.5%+；（13）📊 台美 ADR 溢價 +13.97%；（14）32 位分析師全數看多、平均目標 NT$2,530 上行空間 +9.52%；本日（6/15）關鍵：台股能否站穩 NT$2,310 / 5MA 並挑戰 NT$2,365、外資是否止賣轉買；下方支撐 NT$2,250 / NT$2,200 心理整數 / NT$2,180（120MA）",
}

# 三大法人買賣超（張）— 最新一日
INSTITUTIONAL = {
    "date":     "2026-06-12",       # 最新資料日（6/11 Thu 實際確認；6/12 Fri 為估算、官方數據待公布；6/15 Mon 盤後公布）
    "foreign":  +9500,              # 外資 6/12 估反手買超（隨股價 +2.67% 放量上攻、跟進 ADR 反彈；待官方確認）
    "trust":    +1200,              # 投信 6/12 估續買 +1,200 張
    "dealer":   +650,               # 自營商 6/12 估續買 +650 張
    # 近5日（由舊到新：6/8, 6/9, 6/10, 6/11, 6/12）；6/9-6/11 為實際數據、6/8/6/12 為估算
    "foreign_5d": [-18500, -15008, -15543, -4904, +9500],   # 外資 6/9-6/11 連 3 日實際賣超、6/12 估反手買超
    "trust_5d":   [-1500, +2661, -3, +600, +1200],           # 投信 6/9 +2,661、6/11 +600（實際）、6/12 估續買
    "dealer_5d":  [-800, -1031, -826, +340, +650],           # 自營 6/11 +340（實際）、6/12 估續買
    "foreign_ownership_pct": "74.8%",  # 外資持股比例（連 3 日賣超後 6/12 估回升至 74.8%）
    "foreign_ownership_shares": "約 194.0 億股",
}

# 技術分析指標（需每日從看盤軟體更新）
TECHNICAL = {
    "rsi_14":       56.0,   "rsi_signal": "RSI 估自 51 回升至 56（台股 6/12 +2.67%、NYSE 6/12 +0.68% 連 2 紅），站穩中軸上方、動能轉正",
    "macd":         0.10,  "macd_signal": "MACD 估自 -0.05 翻正至 +0.10、紅柱浮現、零軸上方金叉確認、動能由空翻多",   "macd_color": "#4CAF50",
    "kdj_k":        62.0,   "kdj_d": 53.0, "kdj_j": 80.0, "kdj_signal": "KDJ K(62)/D(53)/J(80) J 自 62 續升至 80、低檔金叉延續、動能強勁；隨台美雙市連 2 紅站上中軸",
    "ma5":       "2,285",   # 5MA（6/8 2305, 6/9 2305, 6/10 2255, 6/11 2250, 6/12 2310）— 基於 6/12 收盤
    "ma20":      "2,320",   # 20MA 轉支撐
    "ma60":      "2,300",   # 60MA 上揚
    "ma120":     "2,180",
    "bb_upper":  "2,440",   # 布林上軌
    ...
    "bb_lower":  "2,190",   # 布林下軌
    "vol_ma5":  "43,000",   # 5日均量（張，估、基於 6/8-6/12 五日均）
    "trend":    "✅ 6/12 Fri 反彈延續、台美雙市連 2 日收紅：NYSE TSM 6/12 收 $423.93（+$2.86、+0.68% vs 6/11 $421.07）連 2 紅、消化 6/10 sell-the-news 賣壓；台股 2330 6/12 放量收 NT$2,310（+60、+2.67% vs 6/11 NT$2,250）跟進 NYSE 6/11 +3.20% 反彈、市值回升 NT$59.9 兆、加權指數 +1,019.58 點站回 44,000+。💡 技術突破：TSMC CoPoS 玻璃基板封裝 2028 H2 量產、支援超光罩 9.5 倍超大封裝、NVIDIA Feynman 首批採用。📊 技術面（基於 6/12 收 NT$2,310）：RSI 56 站穩中軸上方、MACD +0.10 翻正紅柱浮現零軸上方金叉、KDJ J(80) 低檔金叉延續動能強、短期 5MA NT$2,285 翻為支撐、中期 20MA/60MA/120MA 多頭排列。下一觀察：（1）✅ 6/15 能否站穩 NT$2,310 / 5MA 並挑戰 NT$2,365；（2）下方支撐 NT$2,250 / NT$2,200 心理整數 / NT$2,180（120MA）；（3）上方壓力 NT$2,365 / NT$2,400 整數 / NT$2,440（6/3 史高）；（4）⭐ 中長線結構性利多基底未變：CoPoS 封裝突破 + CFO 確認 3nm H2 漲 ~15% + CEO Wei 重申供應數年落後需求 + 2026 >30% 成長 + 2nm 量產 70-80% 良率；（5）🏆 PwC 報告 TSMC 市值躋身全球第 9；（6）⚠️ 競爭雜訊：Google 向 Intel Foundry 下單逾 300 萬顆 TPU、Samsung 推進 HPB 封裝。",
    "support":  "2,250 / 2,200 / 2,180 / 2,155 (前低、心理整數、120MA、心理整數)",
    "resist":   "2,365 / 2,400 / 2,425 / 2,440 (前高、整數、6/3 收、6/3 史高)",
    "note": "技術指標數值為估算（基於 6/12 收盤 NT$2,310），請以看盤軟體即時數據為準；台美雙市 6/12 連 2 日收紅、KDJ J 自 62 續升至 80 低檔金叉延續、MACD 翻正紅柱浮現零軸上方金叉；NT$2,250 為關鍵支撐、6/15 站穩 NT$2,310 / 5MA 並挑戰 NT$2,365 確認反彈延續",
}

# 期貨與選擇權（來源：台灣期交所 TAIFEX）
DERIVATIVES = {
    "date":          "2026-06-12",       # 最新資料日（6/12 Fri 收盤估）
    "futures_price": "2,308",            # 台積電期貨近月（6/12 收盤附近）
    "futures_oi":    "170,000",          # 未平倉量（口）（6/12 估、反彈增倉）
    "futures_basis": "-2",               # 6/12 估小幅逆價差（現貨反彈強於期貨）
    "call_oi":       "102,000",
    "put_oi":        "78,000",
    "pcr":           "0.76",             # Put/Call 比率（6/12 估自 0.81 續降至 0.76、空方避險續縮手）
    "pcr_signal":    "偏多（Put/Call 6/12 估降至 0.76、自 6/11 0.81 續減；反映台美雙市連 2 紅後避險買盤縮手、市場情緒轉樂觀）",
    "max_pain":      "2,300",            # 最大痛苦價格（近期到期、6/12 估）
    "key_strikes": [
        ("2,150", "Call 22,000 / Put 31,000", "深支撐"),
        ("2,200", "Call 28,000 / Put 27,500", "心理整數關鍵支撐"),
        ("2,250", "Call 35,500 / Put 18,500", "前低、心理整數"),
        ("2,300", "Call 53,000 / Put 10,500", "最大痛苦 / 心理整數"),
        ("2,310", "Call 55,000 / Put 9,500",  "6/12 收"),
        ("2,365", "Call 58,000 / Put 7,200",  "前高、反彈關卡"),
        ("2,400", "Call 52,500 / Put 6,800",  "心理整數"),
        ("2,425", "Call 48,000 / Put 5,800",  "6/3 收"),
        ("2,440", "Call 45,500 / Put 5,200",  "6/3 史高"),
    ],
    "note": "衍生品數據需每日至台灣期交所(taifex.com.tw)更新；6/12 PCR 自 0.81 續降至 0.76 反映台美雙市連 2 紅後避險買盤續縮手、最大痛苦價維持 NT$2,300；NT$2,250 為關鍵支撐、6/15 站穩 NT$2,310 並挑戰 NT$2,365；中長線結構性利多基底未變（CoPoS 玻璃封裝 2028 量產、CFO 確認 3nm H2 漲 ~15%、CEO Wei 重申供應數年落後需求、2nm 量產 70-80% 良率、Intel CEO 確認長期夥伴、NVIDIA-TSMC AI 合作、4 大 CSP CapEx $725B、PwC 報告 TSMC 全球市值排名躍升至第 9）",
}

# 供應鏈與客戶股價（需每日更新）
ECOSYSTEM_STOCKS = [
    # 類別、股票代碼、名稱、收盤價、漲跌幅、備註（美股為 2026-06-12 Fri 收盤、台股為 6/12 Fri 收盤；價格為估算）
    ("設備", "ASML",    "艾司摩爾",    "828.00", "+0.73%", "EUV 設備龍頭（6/12 連 2 紅；高 NA EUV 需求結構性多頭）"),
    ("設備", "AMAT",    "應用材料",    "498.00", "+0.71%", "⭐ 6/12 續漲；TSMC EPIC Center $5B AI 合作 + CoPoS 玻璃封裝設備需求"),
    ("設備", "LRCX",    "科林研發",    "996.00", "+0.61%", "蝕刻設備（6/12 續漲；半導體設備需求創紀錄）"),
    ("設備", "KLAC",    "科磊",        "750.00", "+0.67%", "量測設備（6/12 續漲；2nm 量產驅動）"),
    ("記憶", "000660.KS","SK 海力士",  "371,000 KRW", "+0.54%", "HBM4 供應（AI 記憶體需求結構性多頭）"),
    ("記憶", "MU",      "美光",        "146.50", "+1.03%", "HBM / DDR5（6/12 續漲 +1.03%）"),
    ("封裝", "3711.TW", "日月光",      "303",    "+1.68%", "CoWoS / CoPoS 封裝（6/12 跟進台股 2330 反彈）"),
    ("客戶", "NVDA",    "輝達",        "251.00", "+1.01%", "🏆 #1 客戶 22%（6/12 續漲；Feynman AI 晶片擬採 TSMC CoPoS 玻璃封裝、RTX Spark 由 TSMC 代工）"),
    ("客戶", "AAPL",    "蘋果",        "292.50", "+0.34%", "⚠️ #2 客戶 18%（6/12 小漲；Apple 將跳過 A16 直上 A14 製程）"),
    ("客戶", "AVGO",    "博通",        "455.00", "+0.89%", "🔄 #3 客戶 13%（6/12 續漲；Hock Tan 確認「custom AI chips only」策略、2027 AI 指引 >$100B 不變）"),
    ("客戶", "AMD",     "超微",        "498.00", "+1.01%", "#4 客戶 8%（6/12 續漲、YTD +130%；MI400 資料中心 GPU 持續搶市；EPYC Venice 採 2nm）"),
    ("客戶", "2454.TW", "聯發科",      "4,560",  "+1.22%", "手機 SoC 客戶 9%；6/12 跟進台股半導體類股反彈；RTX Spark 由聯發科協同 NVIDIA 設計"),
    ("競爭", "INTC",    "英特爾",      "41.80",  "+1.46%", "🚀 6/8 大漲逾 11% 後續穩：Google 下單逾 300 萬顆自研 TPU 予 Intel Foundry（2028 交付）；Intel CEO 6/2 仍確認 TSMC「長期信任夥伴」"),
    ("競爭", "005930.KS","三星電子",   "62,900 KRW", "+0.80%", "Samsung Foundry 6/12 小漲；推進 HPB 封裝對標 TSMC CoPoS；HBM4E NVIDIA 送樣中"),
    ("處分後", "ARM",   "Arm Holdings","246.00", "+0.82%", "TSMC 4/29 全數出脫後（6/12 續漲；RTX Spark ARM 架構受惠）"),
]
...
CONSENSUS = {
    ...
    "upside":       "+9.52%",   # 從 NT$2,310（6/12 收盤）到 NT$2,530
}
...
IR_CALENDAR = [
    ...
    ("2026-06-15", "📈 報告日；台股盤中觀察能否站穩 NT$2,310 / 5MA 並挑戰 NT$2,365","6/15 Mon 報告日（NYSE 週末休市、最新確認為 6/12 收 $423.93）；台股 2330 6/15 盤中觀察：在 6/12 放量上攻 +2.67% 後能否站穩 NT$2,310 / 5MA 並挑戰 NT$2,365 前高、外資能否在 ADR 連 2 紅後止賣轉買為關鍵；催化續存：CoPoS 玻璃封裝突破 + CFO 確認 3nm H2 漲 ~15% + CEO Wei 重申供應數年落後 AI 需求 + 5 月營收創高 NT$4,169.75 億 +30.1%；⚠️ 競爭雜訊：Google 向 Intel Foundry 下單逾 300 萬顆自研 TPU、Samsung 推進 HPB 封裝對標 CoPoS；下方支撐 NT$2,250 / NT$2,200 / NT$2,180（120MA）","#FFF9C4"),
...
# 總體經濟監控
MACRO = [
    ("SOX 半導體指數",  "13,250.00","+2.55%", True),   # 6/11 SOX 反彈（估）、TSM +3.20% 領漲
    ("台股加權指數",    "45,200.00","+1.10%", True),   # 6/12 盤中估跟進反彈、半導體類股回補
    ("VIX 恐慌指數",    "17.5",    "-1.1",   True),    # 6/11 回落（估）；風險情緒回穩
    ("WTI 原油",        "$70.8",   "+0.43%", True),    # 油價小漲
    ("10Y 美債殖利率",  "4.47%",   "-0.01pp",True),    # 自 4.48% 微降
    ("台幣/美元",       "31.05",   "0.00",   False),   # 台幣持穩（每升值 1% 毛利率 -40bps）
    ("NVIDIA NVDA",     "$248.50", "+2.18%", True),    # #1 TSMC 客戶（22%），6/11 反彈 +2.18%
    ("ASML",            "$822.00", "+1.73%", True),    # 設備股 6/11 反彈 +1.73%
]
...
VALUATION = {
    "pe_current":   33.9,   # 同 STOCK["pe_ratio"]（6/12 盤中估 NT$2,300）
...
RELATIVE = {
    "date":           "2026-06-12",       # 最新資料日（6/12 Fri 台股盤中估；NYSE 為 6/11 收盤）
    "tsmc_tw_1d":     +2.22,   # 2330 6/12 盤中估 NT$2,300（+50 vs 6/11 NT$2,250；跟進 ADR 反彈）
    "taiex_1d":       +1.10,   # 加權指數 6/12 盤中估反彈 +1.10%
    "sox_1d":         +2.55,   # SOX 6/11 反彈（估）、TSM +3.20% 領漲
    "tsmc_nyse_1d":   +3.20,   # TSM ADR 6/11 $421.07 (+$12.32 vs 6/10 $408.75；強勢反彈)
    "tsmc_tw_5d":     -2.74,   # 5 日（NT$2,300 vs 6/5 NT$2,365）
    "taiex_5d":       +0.30,
    "tsmc_tw_1m":     +0.44,   # 月線（NT$2,300 vs NT$2,290 ~5/8）
    "taiex_1m":       +8.5,
    "tsmc_tw_ytd":    +9.79,   # YTD 累計（NT$2,300 vs 年初 ~NT$2,095）
    "taiex_ytd":      +13.0,
    "sox_ytd":        +68.0,   # SOX YTD（反彈後）
    "beta_60d":        1.38,   # 60 日滾動 Beta vs TAIEX
    # ADR 折溢價（以 6/11 NYSE 收盤 & 6/12 TW 盤中估計算）
    "adr_price":     421.07,   # TSM NYSE 6/11 實際收盤（+3.20%）
    "adr_parity":    370.37,   # 理論值 = 5 × NT$2,300 ÷ 31.05
    "adr_ratio":     "5:1",    # 1 ADR = 5 台積電普通股
    "usd_ntd":        31.05,   # 同 MACRO 台幣匯率
    "adr_premium_pct": "+13.69", # (421.07 - 370.37) / 370.37 × 100 = +13.69%
    "note": "ADR 理論值 = 5 × 台股收盤 ÷ 匯率（不含交易摩擦與流動性溢價）。✅ NYSE TSM 6/11 Thu 強勢反彈 +3.20% 收 $421.07（+$12.32 vs 6/10 $408.75），消化 6/10 -4.48% sell-the-news 賣壓、record-revenue 基本面（5 月營收 NT$4,169.75 億、+30.1% YoY）獲市場重新確認；台股 2330 6/11 收 NT$2,250（持平）、6/12 預期跟進 ADR 反彈、盤中估 ~NT$2,300（+2.22%）。⚠️ 籌碼面警訊：真實數據外資 6/9-6/11 連 3 日賣超（-15,008 / -15,543 / -4,904 張），惟 6/11 賣壓大幅收斂、投信與自營轉買。📊 台美 ADR 溢價以 6/11 ADR + 6/12 台股盤中估計算為 +13.69%；🎯 今日（6/12 Fri）短線關鍵：台股能否跟進 ADR 反彈站回 NT$2,295 / 5MA、外資是否止賣轉買；⭐ 中長線結構性基底未變：CFO 確認 3nm H2 漲 ~15% + CEO Wei 重申供應數年落後需求 + 2nm 量產 70-80% 良率 + NVIDIA $150B/年台灣投資 + 4 大 CSP CapEx $725B + Intel 確認長期夥伴 + PwC 報告 TSMC 市值躍居全球第 9",
}
...
NEWS = [
    {
        ...
        "title": "✅ TSMC 反彈延續、台美雙市連 2 日收紅：NYSE TSM 6/12 收 $423.93（+0.68%）、台股 2330 6/12 放量收 NT$2,310（+2.67%）、加權指數 +1,019.58 點站回 44,000+",
        "body": "TSMC 在 5 月營收創高後的「sell-the-news」回檔後反彈延續、台美雙市連 2 日收紅：（1）🏆 NYSE TSM 6/12 Fri 收 $423.93（+$2.86、+0.68% vs 6/11 $421.07，來源 stockanalysis.com）連 2 日上漲、成交量約 1,034 萬股、消化 6/10 sell-the-news 拋售；（2）📈 台股 2330 6/12 Fri 放量上攻收 NT$2,310（+60、+2.67% vs 6/11 NT$2,250）、市值回升 NT$59.9 兆、跟進 NYSE 6/11 +3.20% 反彈；（3）🚀 台股加權指數 6/12 大漲 +1,019.58 點站回 44,000 點之上、半導體類股全面反彈；（4）⭐ record-revenue 基本面確認——5 月合併月營收 NT$4,169.75 億（US$13.17B）、年增 +30.1%、月增 +1.5%、創史上單月新高；1-5 月累計 NT$1.96 兆、年增 +30%；（5）📊 台美 ADR 溢價（以 6/12 ADR $423.93 + 6/12 台股 NT$2,310 計）為 +13.97%；（6）🎯 後續關鍵：6/15 台股能否站穩 NT$2,310 / 5MA 並挑戰 NT$2,365、外資是否止賣轉買；下一里程碑：6 月營收 7 月上旬公布、Q2 2026 法說會 7/16。",
        "source": "stockanalysis.com / Yahoo Finance / cnyes 鉅亨 / wantgoo 玩股網 2026-06-12", "impact": "正面",
    },
    {
        "tag": "產品發布", "tag_color": "#9C27B0",
        "title": "💰 TSMC CFO 確認先進製程下半年漲價：3nm 漲約 15%、sub-5nm 漲 5-10%；AI 需求 + 3nm 產能短缺驅動",
        "body": "TSMC 管理層 6/11 釋出進一步漲價訊號、強化毛利率展望：（1）💰 TSMC CFO 確認下半年將調漲晶圓代工價格——最搶手的 3nm（N3）製程漲幅約 15%、sub-5nm 製程漲 5-10%；（2）⭐ 漲價基礎：AI 晶片需求強勁、3nm 製程產能短缺、上游成本上升、TSMC 在先進製程具技術代差優勢與定價權；（3）⭐ 對毛利率意涵：漲價可抵銷海外擴廠（Arizona/熊本/德國）初期稀釋與台幣升值壓力、支撐毛利率維持 65-67% 高檔（Q1 2026 已達 66.2% 創史高）；（4）漲價對客戶（NVIDIA/Apple/AMD/Google）接受度高——AI 晶片佔客戶總成本比重低、且 TSMC 為唯一可靠先進產能來源；（5）⚠️ 業界觀察：Windows Central 分析此舉恐沿供應鏈傳導至終端 PC/GPU/手機售價；（6）⭐ 對 TSMC 意涵：與 6/4 AGM CEO Wei 確認的「3nm H2 漲 15% + 2027 再漲 5-10%」計畫一致、定價權為 AI 結構性需求超供應的直接體現。",
        "source": "GuruFocus / Windows Central / Taipei Times 2026-06-11", "impact": "正面",
    },
    {
        "tag": "產業趨勢", "tag_color": "#4CAF50",
        "title": "⭐ TSMC CEO Wei：全球晶片供應數年內持續落後 AI 需求；Q2 月產能 160K-175K 片仍供不應求",
        "body": "TSMC CEO C.C. Wei 重申 AI 結構性需求超越供應的核心論述：（1）⭐ Wei 表示全球晶片產能將在未來數年持續無法滿足 AI 驅動的需求、產能仍是全球運算基礎建設擴張的關鍵瓶頸；（2）⭐ 儘管 TSMC 持續擴產、Q2 月晶圓產出估達 160,000-175,000 片，AI 需求仍超越市場預期、供應緊張未解；（3）⭐ 與 6/4 AGM 確認的 2026 全年 >30% 成長指引、5 月營收 +30.1% 創單月新高一致；（4）此論述支撐 TSMC 先進製程（N3/N2）滿載與 CoWoS 產能瓶頸下的強勁定價權與訂單能見度；（5）⭐ 對 TSMC 意涵：供不應求格局確立 TSMC 在 AI 供應鏈的不可取代地位、為漲價（3nm H2 +15%）提供基本面支撐；（6）配合 PwC 報告 TSMC 市值年增 +101% 躋身全球第 9 大市值企業、結構性多頭基底穩固。",
        "source": "Bloomberg / Taipei Times / TSMC IR 2026-06-04 - 06-11", "impact": "正面",
    },
    {
        "tag": "客戶動態", "tag_color": "#2196F3",
        "title": "⚠️ Google 向 Intel Foundry 下單逾 300 萬顆自研 TPU（2028 交付）、Intel 6/8 大漲逾 11%；客戶分散雜訊浮現",
        "body": "AI 晶片代工版圖出現分散訊號、為 TSMC 中期觀察重點：（1）⚠️ 多家媒體報導 Google 已向 Intel Foundry 下單逾 300 萬顆自研 TPU（張量處理器）、自 2028 年起交付——Intel 股價 6/8 Mon 大漲逾 11%；（2）市場解讀為部分超大型客戶在 TSMC 產能緊俏下尋求第二供應來源、降低單一供應商集中度；（3）⚠️ 對 TSMC 短期意涵：TPU 為 Google 最大宗自研 AI 晶片之一，若部分產能轉至 Intel 18A/14A 製程，恐影響 TSMC 部分 ASIC 代工市占；（4）✅ 緩解因素：交付時點為 2028、TSMC 2nm/A16 屆時已量產、技術代差仍領先；Intel CEO 6/2 仍公開確認 TSMC 為「長期信任夥伴」、Intel 自身先進晶片仍委外 TSMC；（5）⭐ 結構觀點：AI 晶片總量持續爆發（SIA 估 2028 AI 資料中心晶片年營收 $1.2 兆、10x 成長），TSMC 即便面對局部分散、整體先進製程需求仍遠超供給；（6）🎯 觀察：客戶自研 ASIC（Google TPU、Amazon Trainium、Meta MTIA）多數仍由 TSMC 代工，需追蹤後續訂單流向。",
        "source": "go markets / distill intelligence / Reuters 2026-06-08 - 06-11", "impact": "中性",
    },
    {
        "tag": "產品發布", "tag_color": "#9C27B0",
        "title": "⭐ NVIDIA 與 TSMC 將 AI 導入晶圓廠：cuLitho / cuEST / Omniverse FabTwin 加速製程設計與製造",
        "body": "NVIDIA 宣布 TSMC 採用 NVIDIA 加速運算與 AI 推進半導體設計與製造、深化雙方合作：（1）⭐ TSMC 導入 NVIDIA cuLitho（運算微影、加速 20-50%）、cuEST（蝕刻/沉積模擬加速達 50 倍）、Omniverse FabTwin（晶圓廠數位孿生）等 AI 工具；（2）⭐ 直接效益：提升先進製程良率、縮短製程開發週期、優化產能效率——直接緩解 TSMC「產能供不應求」核心挑戰；（3）此合作使 TSMC 能在產能緊俏下為 NVIDIA、AMD、Google 等 AI 客戶生產更多先進晶片；（4）🏆 NVIDIA 為 TSMC 第 1 大客戶（22% / $33B）、Apple 第 2 大（18% / $27B）；（5）⭐ NVIDIA Computex 2026 RTX Spark 超晶片由 TSMC N3E + CoWoS 代工、為新增量訂單；（6）⭐ 對 TSMC 意涵：AI 不僅是 TSMC 的需求來源、也成為其提升製造效率的工具，形成「AI 製造 AI 晶片」的正向循環。",
        "source": "StockTitan / NVIDIA / TSMC 2026-06-10 - 06-11", "impact": "正面",
    },
    {
        "tag": "產品發布", "tag_color": "#9C27B0",
        "title": "💡 TSMC CoPoS 玻璃基板封裝突破：2028 H2 量產、支援超光罩 9.5 倍超大封裝、NVIDIA Feynman 潛在首批採用、解決 CoWoS 尺寸瓶頸",
        "body": "TSMC 次世代先進封裝突破為 AI 大晶片提供關鍵解方：（1）💡 分析師郭明錤 6/10 揭露 TSMC 規劃 2028 下半年量產 CoPoS（Chip-on-Panel-on-Structure）玻璃基板封裝技術；（2）⭐ 技術特點：製程中以 310×310mm 玻璃為臨時載板、最終切割為玻璃核心基板，相較傳統 CoWoS 圓形晶圓載板，矩形玻璃面板可大幅提升材料利用率、降低成本、改善翹曲與散熱；（3）⭐ 可支援超越光罩（reticle）9.5 倍尺寸的超大封裝，滿足次世代 AI 晶片堆疊更多運算 chiplet 與 HBM 高頻寬記憶體的需求；（4）🏆 NVIDIA 次世代 Feynman AI 晶片被點名為潛在首批採用者、解決 CoWoS 封裝尺寸物理瓶頸；（5）⚠️ 競爭：Samsung 同步推進 HPB（Hybrid/High-Performance Bonding）封裝技術對標；（6）⭐ 對 TSMC 意涵：CoPoS 鞏固 TSMC 在先進封裝（CoWoS→CoPoS）的技術代差與護城河、延續「設計+製造+封裝」一站式整合優勢、為 2028+ AI 大晶片世代卡位、強化長線結構性訂單能見度。",
        "source": "Digital Trends / Sammy Fans / wccftech / GuruFocus（Ming-Chi Kuo）2026-06-10 - 06-11", "impact": "正面",
    },
]
