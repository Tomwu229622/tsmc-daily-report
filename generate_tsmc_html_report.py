...
STOCK = {
    # 台股 2330
    "tw_price":       "2,100",        # 收盤價（數字加逗號，不含 NT$）（2026-04-16 財報日，創52週新高）
    "tw_change":      "+45",          # 漲跌點數（含+/-號，vs 4/15 收盤 NT$2,055）
    "tw_change_pct":  "+2.19%",       # 漲跌幅（含+/-號）
    "tw_volume":      "42,000",       # 成交量（張，4/16 財報日量增）
    "tw_open":        "2,065",
    "tw_high":        "2,110",
    "tw_low":         "2,060",
    "market_cap":     "NT$54.5 兆",
    "pe_ratio":       "~31.0x",       # 台股 P/E（TTM，NT$2,100 基礎，EPS 共識 NT$67.8）
    "pb_ratio":       "~11.2x",       # 台股 P/B（股淨比）
    "div_yield":      "~0.71%",       # 殖利率（已除息後調整，USD $2.65/ADR 年息）
    "52w_high_tw":    "2,110",        # 52 週高（2026-04-16，今日日中新高）
    "52w_low_tw":     "780",          # 52 週低（2025-04-07）
    # NYSE TSM ADR
    "nyse_price":     "392.00",       # 財報後反應（2026-04-16，+3.19% from $379.89）
    "nyse_change":    "+12.11",       # 與 4/15 收盤相比（$379.89→$392.00）
    "nyse_change_pct":"+3.19%",
    "52w_high_nyse":  "392.00",       # 52 週高（2026-04-16，財報日新高）
    "52w_low_nyse":   "134.25",       # 52 週低（2025-04-07）
    "pe_nyse":        "~34.5x",       # NYSE USD 基礎 P/E（TTM）
    "pb_nyse":        "~11.4x",
    "beta":           "1.16",
    ...
    # 資料日期備註
    "data_note":      "⭐ 今日（4/16）Q1 2026 財報法說會  |  台股 2330 收 NT$2,100（+2.19%），創 52 週新高（法說會前台股已收盤）  |  NYSE TSM：$392.00（+3.19%，財報後反應）  |  Q1 2026 營收 NT$1.134 兆（$35.7B，+35.1% YoY），超越共識  |  EPS 共識 NT$20.38（9 季 100% 超預期）  |  Q2 指引 $37.5-39.0B（法說會 14:00 TST 公布）  |  ASML 上調 2026 全年指引至 €36-40B（Q1 財報超預期）  |  NVIDIA 鎖定 TSMC CoWoS 大部分封裝產能",
}
...
SUMMARY = {
    ...
    "sentiment":  "強烈看多",
    # 一句話標題
    "headline":   "4/16 財報日突破：Q1 $35.7B 超預期，台股 2330 +2.19%（NT$2,100）創新高，NYSE TSM 財報後 +3.19% 至 $392",
    # 3–5 條白話重點（不用術語，每條約 30 字內）
    "bullets": [
        "⭐ TSMC Q1 2026 財報法說會今日（4/16）舉行，Q1 營收 $35.7B（+35.1%）超越共識，EPS 共識 NT$20.38",
        "📈 台股 2330 收 NT$2,100（+2.19%），創 52 週新高；NYSE TSM 財報後 +3.19% 至 $392.00",
        "🔑 Q2 2026 指引今日法說會（14:00 TST）公布，市場期待收入 $37.5-39.0B，毛利率指引 65-67%",
        "ASML Q1 2026 財報超預期，上調 2026 全年指引至 €36-40B，確認 AI 半導體設備需求強勁",
        "🌐 NVIDIA 鎖定 TSMC 大部分 CoWoS 封裝產能；全球晶片銷售 2026 年預計超 $1 兆",
    ],
    # 一句結論
    "bottom_line": "今日（4/16）為 TSMC Q1 2026 財報法說會重要日，台股 2330 收 NT$2,100（+2.19%），創 52 週新高，法說會前市場持續強勢。NYSE TSM 財報後 +3.19% 至 $392.00，選擇權市場已定價 ~5% 波動。Q1 2026 營收 NT$1.134 兆（$35.7B，+35.1%）超越共識，預計延續 9 季 100% 超預期紀錄。法說會最受關注：Q2 收入指引（共識 $37-38B）、Q2 毛利率指引（共識 65-67%）、全年 30%+ 展望確認。ASML 同日上調全年指引，半導體設備需求強勁確認。分析師 31 位全數看多，目標價共識 NT$2,290，部分已上調至 US$515，基本面進一步確認。",
    # 重大警示（選填，空白則不顯示）
    "risk_alert":  "⏰ 今日（4/16）Q2 指引若低於預期恐引發獲利了結；能源成本上升恐壓縮毛利率（Wall Street 警告 margin peak）；⚠️ 關稅政策不確定性；中東地緣政治情勢；3nm/2nm 產能瓶頸至 2028 年；ABF 基板供應限制",
}

# 三大法人買賣超（張）— 最新一日
INSTITUTIONAL = {
    "date":     "2026-04-16",
    "foreign":  +6200,    # 外資（正=買超）— 4/16 財報日積極買入（估）
    "trust":    +850,     # 投信（財報日加碼，估）
    "dealer":   +380,     # 自營商（估，財報日做多）
    # 近5日（由舊到新，最後一筆為 4/16）
    "foreign_5d": [+2500, +1800, +3200, +4800, +6200],  # 4/16 財報日外資大買（估）
    "trust_5d":   [+420,  +380,  +480,  +720,  +850],
    "dealer_5d":  [+280,  +200,  +320,  +450,  +380],
    "foreign_ownership_pct": "75.4%",  # 外資持股比例（估，4/16）
    "foreign_ownership_shares": "約 195.4 億股",
}

# 技術分析指標（需每日從看盤軟體更新）
TECHNICAL = {
    "rsi_14":       66.2,   "rsi_signal": "RSI 升至 66.2（63.8→66.2），突破 65 強勢區，財報日動能強勁，短線留意 70 過熱關口",
    "macd":         +2.1,   "macd_signal": "MACD 黃金交叉持續擴大（+1.2→+2.1），多頭趨勢確立，財報催化劑加持，中線看多",   "macd_color": "#4CAF50",
    "kdj_k":        82.1,   "kdj_d": 72.3, "kdj_j": 101.7, "kdj_signal": "KDJ 超買區（J 值持續高位），財報日動能強烈，短線注意財報後賣壓",
    "ma5":       "2,050",
    "ma20":      "1,940",
    "ma60":      "1,880",
    "ma120":     "1,790",
    "bb_upper":  "2,120",   # 布林上軌（價格接近上軌，強勢）
    "bb_mid":    "1,940",   # 布林中軌（20MA）
    "bb_lower":  "1,760",   # 布林下軌
    "vol_ma5":  "37,000",   # 5日均量（張，4/16 財報日量增）
    "trend":    "台股 2330（4/16 財報日，收 NT$2,100，+2.19%），創 52 週新高。NYSE TSM +3.19% 至 $392.00（財報後反應）。技術面：MACD 黃金交叉持續擴大，RSI 66.2 強勢；KDJ J 值超買，財報日後需關注回調；Q2 毛利率指引若達 65-67%，技術目標看 NT$2,200–2,290。",
    "support":  "2,055–2,080",
    "resist":   "2,110–2,150",
...
DERIVATIVES = {
    "date":          "2026-04-16",
    "futures_price": "2,105",      # 台積電期貨近月（估，4/16 財報日）
    "futures_oi":    "95,000",     # 未平倉量（口）（估，財報日持續高位）
    "futures_basis": "+5",         # 正價差（財報日多頭氣氛）
    "call_oi":       "52,000",
    "put_oi":        "38,000",
    "pcr":           "0.73",       # Put/Call 比率降至 0.73（市場做多信心高漲）
    "pcr_signal":    "偏多（Put/Call 從 0.81 降至 0.73，財報日多頭部位持續增加）",
    "max_pain":      "2,000",      # 最大痛苦價格
    "key_strikes": [
        ("2,000", "Call 28,000 / Put 5,200", "心理關口，已大幅突破"),
        ("2,050", "Call 26,000 / Put 2,100", "支撐轉換（4/15 收盤關口）"),
        ("2,100", "Call 22,000 / Put 1,800", "今日收盤關口"),
        ("2,150", "Call 16,000 / Put 1,200", "財報後潛在目標區"),
        ("2,200", "Call 9,500 / Put 800",    "法說會超預期目標區"),
    ],
...
# 供應鏈與客戶股價（需每日更新）
ECOSYSTEM_STOCKS = [
    # 類別、股票代碼、名稱、收盤價、漲跌幅、備註（2026-04-16 財報日）
    ("設備", "ASML",    "艾司摩爾",    "680.20", "+2.2%", "EUV 設備龍頭（Q1 2026 超預期，上調全年指引至 €36-40B）"),
    ("設備", "AMAT",    "應用材料",    "172.30", "+2.3%", "CVD/PVD 設備（TSMC 2nm 擴產受惠）"),
    ("設備", "LRCX",    "科林研發",    "785.60", "+0.9%", "蝕刻設備（2nm 良率爬坡帶動訂單）"),
    ("設備", "KLAC",    "科磊",        "578.40", "+1.3%", "量測設備（2nm/A16 驗證需求強勁）"),
    ("記憶", "000660.KS","SK 海力士",  "295,000 KRW", "+1.4%", "HBM4 供應（NVIDIA GB300 主力）"),
    ("記憶", "MU",      "美光",        "96.50",  "+2.4%", "HBM / DDR5（AI 資料中心需求持續）"),
    ("封裝", "3711.TW", "日月光",      "225",    "+2.3%", "CoWoS 封裝（財報日同步強攻）"),
    ("客戶", "NVDA",    "輝達",        "838.20", "+1.5%", "#1 客戶 22%（CoWoS 封裝產能鎖定至 2028）"),
    ("客戶", "AAPL",    "蘋果",        "208.90", "+1.0%", "#2 客戶 17%（A20 採 2nm，iPhone 18）"),
    ("客戶", "AVGO",    "博通",        "195.80", "+1.8%", "#3 客戶 13%（Custom XPU，AI ASIC）"),
    ("客戶", "AMD",     "超微",        "161.40", "+2.5%", "#4 客戶 8%（MI400/2nm EPYC Venice）"),
    ("客戶", "2454.TW", "聯發科",      "1,345",  "+1.9%", "手機 SoC 客戶 9%，2nm 首批量產"),
    ("競爭", "INTC",    "英特爾",      "21.20",  "+1.7%", "Intel Foundry 18A 爬坡，仍落後 TSMC"),
    ("競爭", "005930.KS","三星電子",   "53,200 KRW", "+1.5%", "Samsung Foundry 良率改善中"),
]
...
CONSENSUS = {
    ...
    "upside":       "+9.0%",    # 從 NT$2,100 到 NT$2,290（4/16 新高後）
}

# 財報倒計時
EARNINGS = {
    "next_date":   "2026-07（Q2 2026 財報，7 月第三週預估）",
    "quarter":     "Q1 2026（今日法說會，4/16 14:00 TST）",
    "rev_guide_lo":"$34.6B",
    "rev_guide_hi":"$35.8B",
    "rev_guide_mid":"$35.2B",
    "gm_guide":    "63–65%",
    ...
    "last_beat":   "+7.23%",
    "beat_rate":   "100%（近 9 季全部超預期）",
    # ⭐ Q1 2026 實際財報數據（4/16 法說會公布）
    "q1_rev_actual":"NT$1.134 兆（$35.7B，+35.1% YoY）",  # 超越共識，近高端指引
...
IR_CALENDAR = [
    ...
    ("2026-04-16", "⭐ Q1 2026 財報法說會","台股 2330 收 NT$2,100（+2.19%，財報前），創 52 週新高；NYSE TSM $392.00（+3.19%，財報後）；法說會 14:00 TST；Q1 EPS 共識 NT$20.38；Q2 指引 $37.5-39.0B（法說會公布）","#4CAF50"),
...
# 總體經濟監控
MACRO = [
    ("SOX 半導體指數",  "歷史新高區","~+1.8%", False),  # 4/16 財報日，TSMC 財報提振半導體板塊
    ("美元指數 DXY",    "99.8",    "-0.4%",  False),  # 美元持續弱勢
    ("VIX 恐慌指數",    "26.5",    "-1.5",   False),  # 恐慌指數下降，市場信心回升
    ("WTI 原油",        "$62.8",   "-0.3%",  False),  # 油價持穩
    ("10Y 美債殖利率",  "4.10%",   "-0.02pp",False),  # 略降，資金偏向風險資產
    ("台幣/美元",       "31.40",   "-0.05",  False),  # 台幣小幅走強（外資匯入）
    ("NVIDIA NVDA",     "$838.20", "+1.5%",  False),  # #1 TSMC 客戶（22%），財報日強勢
    ("ASML",            "$680.20", "+2.2%",  False),  # 設備股，Q1 財報超預期上調全年指引
]
...
RELATIVE = {
    "date":           "2026-04-16",
    "tsmc_tw_1d":     +2.19,   # 2330 4/16 收 NT$2,100（+2.19%），財報日創新高
    "taiex_1d":       +1.50,   # 加權指數（4/16 估算，TSMC 財報帶動大盤）
    "sox_1d":         +1.80,   # SOX（4/16 估算）
    "tsmc_nyse_1d":   +3.19,   # TSM ADR 4/16 $392.00（+3.19%，財報後）
    "tsmc_tw_5d":     +7.68,   # 本週（4/14~4/16，三日合計：+2.56%+1.26%+2.19%）
    "taiex_5d":       +5.82,
    "tsmc_tw_1m":     +7.7,    # 回升（4/16 創新高）
    "taiex_1m":       +4.3,
    "tsmc_tw_ytd":    -2.4,    # Q1+4/1–4/16 累計（新高後 YTD 收窄）
    "taiex_ytd":      -3.7,
    "sox_ytd":        -21.0,
    "beta_60d":        1.16,   # 60 日滾動 Beta vs TAIEX
    # ADR 折溢價
    "adr_price":     392.00,   # TSM NYSE（2026-04-16 財報後）
    "adr_parity":    333.76,   # 理論值 = 5 × NT$2,100 ÷ 31.40（台股 4/16）
    "adr_ratio":     "5:1",    # 1 ADR = 5 台積電普通股
    "usd_ntd":        31.40,   # 同 MACRO 台幣匯率（台幣走強）
    "adr_premium_pct": "+17.5",# (392.00 - 333.76) / 333.76 × 100
...
EPS_REVISION = {
    ...
    "fy_vs_3m_ago":  "+8.1%",
    "fy_trend":      "上修",
    "beat_streak":    9,       # 連續超預期季數（Q1 2026 預計延續）
    "beat_avg_pct":  "+5.8%",  # 近 9 季平均超預期幅度
    ...
    "analyst_view": "Q1 EPS 共識 NT$20.38（高點 NT$22.10），4/16 財報法說會今日舉行（14:00 TST）。台股 2330 收 NT$2,100（+2.19%），創 52 週新高；NYSE TSM +3.19% 至 $392.00（財報後反應）。Q1 月營收 NT$1.134 兆（+35.1% YoY）超越共識 NT$1.12 兆，預計延續 9 季 100% 超預期紀錄。法說會最受關注：Q2 收入指引（共識 $37-38B）、Q2 毛利率指引（共識 65-67%）、全年 30%+ 確認。ASML 同日上調 2026 全年指引 €36-40B，確認半導體設備需求強勁。31 位分析師全數看多，共識目標 NT$2,290（+9.0% 上行），部分已上調至 US$515。",
...
NEWS = [
    {
        ...
        "title": "TSMC Q1 2026 財報法說會今日（4/16）公布，Q1 $35.7B 超預期",
        "body": "TSMC Q1 2026 完整財報法說會今日（4/16）14:00 TST 舉行。Q1 營收 NT$1.134 兆（$35.7B，+35.1% YoY）已確認超越共識 NT$1.12 兆，EPS 共識 NT$20.38，預計延續 9 季 100% 超預期紀錄。市場最關注 Q2 毛利率指引（共識 65-67%）及 Q2 收入展望（共識 $37-38B）。台股 2330 收 NT$2,100（+2.19%，創 52 週新高）；NYSE TSM 財報後 +3.19% 至 $392.00，選擇權市場定價 ~5% 波動。分析師目標價共識 NT$2,290，部分上調至 US$515。",
        "source": "TSMC IR / GuruFocus / TipRanks 2026-04-16", "impact": "正面",
    },
    {
        "tag": "產業趨勢", "tag_color": "#4CAF50",
        "title": "ASML Q1 2026 財報超預期，上調全年指引至 36-40B 歐元",
        "body": "ASML 公布 Q1 2026 財報，Revenue 及 Profit 均優於預期，將 2026 全年銷售指引上調至 €36-40B（原 €34-39B），EUV 訂單需求持續強勁。ASML CEO 指出「半導體產業成長展望持續固化，AI 相關基礎設施投資為主要動力」。ASML 為 TSMC 2nm/A16 製程關鍵 EUV 設備供應商（含 High-NA EUV），其正面展望間接確認 TSMC 先進製程擴產計畫進展順利，股價 4/16 收 $680.20（+2.2%），為供應鏈整體正面信號。",
        "source": "CNBC / Modern Diplomacy / ASML IR 2026-04-15/16", "impact": "正面",
    },
    {
        "tag": "客戶動態", "tag_color": "#2196F3",
        "title": "NVIDIA 鎖定 TSMC CoWoS 大部分封裝產能，外包部分工序至 ASE/Amkor",
        "body": "NVIDIA 已鎖定 TSMC 大部分先進封裝（CoWoS）產能用於 GB200/GB300 NVL72，供不應求程度使 TSMC 需將部分工序外包至 ASE 及 Amkor。CoWoS 以 80% CAGR 擴充（2026 年目標 ~35,000 wspm），NVIDIA 佔約 65% 配額。此次確認 TSMC 定價主導權極強，CoWoS ASP 約為 HPC 裸晶圓 2-3 倍，毛利率高於公司均值。AMD（18%）與 Broadcom（12%）分配名額不變，整體顯示 TSMC 封裝生態系議價能力持續提升。",
        "source": "CNBC / Benzinga / TrendForce 2026-04-08/16", "impact": "正面",
    },
    {
        "tag": "產業趨勢", "tag_color": "#4CAF50",
        "title": "全球晶片銷售 2026 年預計超 $1 兆，TSMC 掌控 72% 先進製程市場",
        "body": "Digitimes 及 Deloitte 最新報告全球半導體銷售 2026 年將超 $1 兆（AI 相關佔 30%），較 2025 年成長 26%。台積電掌控全球約 72% 最先進晶片（3nm 以下）製造，為 AI 超大型資本週期最大受益者。雲端廠商（Google、Amazon、Microsoft）AI 基建資本支出 2026 年成長 50%+，為 TSMC N3/N2 產能需求主力。台積電 2026 全年 CapEx $52-56B（+30% YoY），加速 N2/A16 產能擴增，2nm 訂單已超額至 2027-2028 年。",
        "source": "Digitimes / Deloitte / Benzinga 2026-04-13/16", "impact": "正面",
    },
    {
        "tag": "地緣政治", "tag_color": "#607D8B",
        "title": "中東供應鏈風險持續，美台 15% 關稅優惠框架初達共識",
        "body": "儘管霍姆茲海峽實質關閉（4/7 美伊以停火未完全解除），Apple 及 NVIDIA 等主要客戶訂單維持強勁，TSMC Q1 財報未見顯著衝擊。美台已達成初步貿易框架，台灣廠商享 15% 關稅率，TSMC 亞利桑那 $1,650 億美元投資為主要談判籌碼，若正式落地則中長期競爭力進一步強化。川普政府另行宣布對半導體進口展開 301 調查，後續動向需持續追蹤。",
        "source": "HeyGoTrade / CNBC / Tom's Hardware 2026-04-14/16", "impact": "中性",
    },
    {
        "tag": "警示", "tag_color": "#F44336",
        "title": "能源成本上升壓縮毛利率，Q2 指引為近期最大觀察變數",
        "body": "多位華爾街分析師警告，能源成本持續上升可能壓縮 TSMC 毛利率。台灣電費調漲及亞利桑那廠高能耗將增加 COGS。雖然 Q1 毛利率指引 63-65% 仍創歷史高，但部分機構認為此可能為近期峰值（margin peak）。今日法說會（4/16）Q2 毛利率指引若未能達到市場預期 65-67%，短線可能引發獲利了結賣壓。ABF 基板供應仍受限，需關注良率及產能瓶頸對 Q2 收益的影響。",
        "source": "TradingKey / CoinCentral / Blockonomi 2026-04-15/16", "impact": "負面",
    },
]
