...
SUMMARY = {
    ...
    "sentiment":  "看空",
    # 一句話標題
    "headline":   "⚠️ 股災第 2 日：台股 7/29 再挫 -1,564.18 點（-3.76%）收 40,039.18、2330 收 NT$2,200（-80、-3.51%）盤中觸 2,180——兩日累跌 -6.4%、KDJ J 值 -9.3 轉負極度超賣；美股由分化轉全面補跌：TSM -4.50% 收 $374.67、SOX -5.33% 自史高 -28.6%、VIX 升破 20；FOMC 鷹派按兵不動（9-3、3 票主張升息）；⭐ 盤後 MSFT 財報大超預期（營收 $90.01B、Azure +43%、盤後 +2.4~3%）投下第一根修復錨、META EPS miss 盤後 -6.2%——AI CapEx 未收縮、對 TSMC 訂單能見度正面；✅ 籌碼賣壓收斂：外資 -11,211 張（自 -14,659 收斂）、投信 +1,652 放大 6 倍、BFI82U 賣超收斂 70%；今晚 AAPL/AMZN 財報接棒",
    ...
    "bullets": [
        ...
        "⭐ 盤後財報第一根錨：MSFT 營收 $90.01B 大超預期、Azure +43%（固定匯率）、FY26 Azure 首破 $1,000 億——盤後 +2.4~3%；META 營收 +28% 超預期惟 EPS miss ~14%、2026 CapEx $125–145B 續擴——盤後 -6.2%；共同訊息：AI CapEx 未收縮、對 TSMC 先進製程訂單能見度正面，市場對「燒錢 vs 回報」開始分層計價",
        "⚠️ 韓股未止跌：SK 海力士 7/29 財報全面創史高（營益 60.54 兆韓元、+557% YoY）仍重挫 -9.61%、三星 -5.23%；今晨（7/30）KOSPI 盤中 ~5,617、SK 再 -5.6%——槓桿去化第 3 日未止（7/29 KOSPI 收盤值 Yahoo 缺漏、未能證實精確跌幅）",
...
TECHNICAL = {
    ...
    "trend":    "⚠️ 股災第 2 日、抗跌角色弱化：台股 2330 7/29 官方收 NT$2,200（-80、-3.51%、開 2,260／高 2,280／低 2,180、量 68,140 張）——13:00 後恐慌殺盤觸 2,180、尾盤拉回收 2,200；大盤同日 -1,564.18 點（-3.76%）收 40,039.18 貼近 4 萬關口。📊 技術指標（官方收盤計算）：KDJ 死叉第 4 日且 J 值 -9.3 轉負（極度超賣、歷史罕見）、RSI(14) 35.6 逼近超賣線、MACD 綠柱急擴 -47.8 且 DIF -22.2 深陷零軸下——中期空方全面主導、短線極度超跌並存。✅ 籌碼修復訊號：外資賣超收斂 24% 至 -11,211 張、投信買超放大 6 倍至 +1,652 張、自營 +4,893 連 5 買、BFI82U 全市場賣超收斂 70% 至 -351.5 億。⚠️ 美股 7/29 由分化轉全面補跌：TSM -4.50% 收 $374.67、SOX -5.33% 自史高 -28.6%、VIX 升破 20——惟盤後 MSFT 財報大超預期（Azure +43%、盤後 +2.4~3%）投下修復錨。下一觀察：（1）守 2,180（7/29 低）、失守下看 2,134（120MA）／2,100；（2）收復布林下軌 2,248 → 2,280 → 2,317（5MA）為修復三關卡；（3）外資賣超收斂延續＋今晚 AAPL/AMZN 財報。",
...
ECOSYSTEM_STOCKS = [
    ...
    ("記憶", "000660.KS","SK 海力士",  "1,401,000 KRW", "-9.61%", "⚠️ 7/29 Q2 財報全面創史高（營收 79.32 兆韓元 +257%、營益 60.54 兆韓元 +557% YoY、HBM4 已量產出貨）仍重挫 -9.61% 收 140.1 萬韓元——「創高財報救不了股價」、槓桿去化主導；7/30 盤中再 -5.6% 至 ~132.2 萬"),
    ...
    ("競爭", "005930.KS","三星電子",   "208,500 KRW", "-5.23%", "⚠️ 7/29 續挫 -5.23% 收 20.85 萬韓元（Yahoo API、兩日累計 -17.9%）；7/30 盤中 ~20.85 萬持平初步止穩；7/7 已公布 Q2 初值營益 89.4 兆韓元暴增"),
...
NEWS = [
    ...
    {
        "tag": "警示", "tag_color": "#F44336",
        "title": "⚠️ 韓股未止跌：SK 海力士財報創史高仍 -9.61%、今晨再挫",
        "body": "槓桿去化第 3 日：（1）⚠️ SK 海力士 7/29 早盤公布 Q2 財報全面創史高（營收 79.32 兆韓元 +257% YoY、營益 60.54 兆韓元 +557% YoY、營益率 76%、HBM4 已量產出貨）、股價仍重挫 -9.61% 收 140.1 萬韓元——「創高財報救不了股價」、賣壓純屬籌碼與槓桿而非基本面；三星同日 -5.23% 收 20.85 萬；（2）⚠️ 今晨（7/30）續弱：KOSPI 盤中 ~5,617（較 7/28 收盤累計約 -6.8%；7/29 指數收盤值 Yahoo 序列缺漏、精確單日跌幅未能證實）、SK 海力士盤中再 -5.6% 至 ~132.2 萬、三星持平；（3）🎯 對台股意涵：韓股融資追繳與雙倍槓桿 ETF 斷頭的去化進程未見底、續為亞股最大外部變數；惟 2330 籌碼面（外資賣超收斂、投信/自營低接）已先行改善。",
