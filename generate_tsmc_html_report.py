...
STOCK = {
    # 台股 2330
    "tw_price":       "2,315",        # 2026-06-17 Wed 收盤（-60，-2.53% vs 6/16 NT$2,375；跟進 NYSE TSM 6/16 -3.53% 自高回檔、獲利了結；估算、官方收盤請以 TWSE 為準）
    "tw_change":      "-60",          # 6/17 漲跌點數（vs 6/16 收 NT$2,375）
    "tw_change_pct":  "-2.53%",       # 6/17 漲跌幅（跟進 NYSE 6/16 -3.53% 回檔）
    "tw_volume":      "50,000",       # 6/17 成交量（張，估、量縮整理）
    "tw_open":        "2,310",        # 6/17 開盤（跟進 NYSE 6/16 -3.53% 跳空低開）
    "tw_high":        "2,340",        # 6/17 盤中高（估）
    "tw_low":         "2,295",        # 6/17 盤中低（估）
    "market_cap":     "NT$60.0 兆",   # 6/17 收盤市值（NT$2,315 基礎）
    "pe_ratio":       "~34.1x",       # 台股 P/E（TTM，NT$2,315 基礎）
    "pb_ratio":       "~12.0x",       # 台股 P/B（股淨比，NT$2,315 基礎）
    "div_yield":      "~0.65%",       # 殖利率（NT$2,315 基礎）
    "52w_high_tw":    "2,440",        # 52 週/歷史高（2026-06-03 盤中觸 NT$2,440 史高）
    "52w_low_tw":     "780",          # 52 週低（2025-04-07）
    # NYSE TSM ADR
    "nyse_price":     "425.83",       # 6/16 Tue 收盤（-$15.57，-3.53% vs 6/15 $441.40；自近史高獲利了結、來源 stockanalysis.com、成交量 1,109 萬股）
    "nyse_change":    "-15.57",       # 6/16 漲跌（vs 6/15 $441.40）
    "nyse_change_pct":"-3.53%",       # 6/16 NYSE 回檔（逼近史高 $450.16 後獲利了結）；6/17 美股盤後待確認
    "52w_high_nyse":  "450.16",       # 52 週高（2026-06 區間，來源 stockanalysis.com）
    "52w_low_nyse":   "206.20",       # 52 週低（區間）
    "pe_nyse":        "~33.1x",       # NYSE USD 基礎 P/E（TTM，stockanalysis.com 報 33.07x，$425.83 基礎）
    "pb_nyse":        "~12.0x",
    "beta":           "1.18",
    ...
    # 資料日期備註
    "data_note":      "報告日期：2026-06-17 Wed（NYSE TSM 6/16 Tue 收盤為最新確認數據、6/17 美股盤後待確認；台股 2330 NT$2,315 為 6/17 估算、官方收盤請以 TWSE 為準）。⭐⭐⭐ 今日頭條——TSMC 台美雙市自高回檔、獲利了結：NYSE TSM 6/16 Tue 收 $425.83（-$15.57，-3.53% vs 6/15 $441.40，來源 stockanalysis.com、成交量 1,109 萬股、P/E 33.07、市值 $1.97 兆），逼近 52 週/史高 $450.16 後高位獲利了結、技術性回檔；台股 2330 6/17 Wed 跟進 ADR 回檔估收 NT$2,315（-60、-2.53% vs 6/16 NT$2,375）、市值回落 NT$60.0 兆。🤝 重大合作進展——TSMC-Amkor 簽 10 年美國先進封裝長約：雙方宣布於 Arizona 深化先進封裝（advanced packaging）長期合作、Amkor 將就近承接 TSMC 亞利桑那廠晶圓的封裝測試、強化美國半導體供應鏈在地化、呼應 TSMC $165B 美國投資承諾。🤝 SK 海力士-TSMC 深化 HBM4 合作：崔泰源 6/3 會晤魏哲家、就 HBM4 基底晶粒（base die）、先進邏輯製程、客製化 AI 記憶體展開合作。💰 結構性利多續存：TSMC CFO 重申先進製程漲價勢在必行（通膨+AI 強勁需求）——3nm 漲 ~15%、sub-5nm 漲 5-10%；CEO C.C. Wei 重申「全球晶片供應將數年內持續落後 AI 需求」、不願成為 AI 供應鏈瓶頸、Arizona 廠訂單已滿至 2027。🏆 NVIDIA 確認 TSMC 第 1 大客戶（22%/$33B、超越 Apple）；NVIDIA-TSMC 將 AI 導入晶圓廠（cuLitho/cuEST/FabTwin）提升良率與產能。📦 CoWoS 封裝瓶頸續為產業關鍵：TSMC 規劃自 2024 底 ~35K wpm 擴至 2026 底 ~130K wpm、量產全球最大 5.5 倍光罩封裝、良率 >98%。⚠️ 競爭雜訊：Google 向 Intel Foundry 下單逾 300 萬顆自研 TPU（2028 交付）；Samsung 推進 HPB 封裝、擴 HBM 後段產能。台美 ADR 溢價（以 6/16 ADR $425.83 + 6/17 台股 NT$2,315 計）：理論值 5×2,315÷31.05 = $372.79、溢價 (425.83-372.79)/372.79 = +14.23%。  |  🎯 即將事件：6 月營收 7 月上旬公布；Q2 2026 財報法說會 7/16（指引 $39.0-40.2B、+10% QoQ、+32% YoY、毛利率 65-67%）  |  ⭐ 中長線結構性利多基底未變：5 月營收 NT$4,169.75 億 +30.1% 創單月新高；2nm 量產良率 70-80% 領先全球、年底月產能 100K 片；NVIDIA 第 1 大客戶 22%/$33B；4 大美國 CSP（Google/AWS/MSFT/Meta）2026 AI CapEx 合計 $725B（+77% YoY）；先進封裝瓶頸為產業關鍵、TSMC CoWoS 產能 2026 大幅擴張；PwC 報告 TSMC 市值年增 +101% 躋身全球第 9 大市值企業  |  ⚠️ 本日（6/17）關鍵觀察：（1）台股 2330 回檔後能否守穩 NT$2,310 / NT$2,300 心理整數；（2）NYSE TSM 自史高 $450.16 回檔、留意賣壓延續；（3）下方支撐 NT$2,300 / NT$2,250 / NT$2,200（心理整數）；上方壓力 NT$2,375（6/16 收）/ NT$2,400 / NT$2,440 史高；（4）⚠️ 估值警示：TSM P/E 33.1x、台股 P/E ~34x，留意台幣升值與短線過熱",
}
...
SUMMARY = {
    ...
    "sentiment":  "中性偏多",
    # 一句話標題
    "headline":   "📉 TSMC 台美雙市自高回檔：NYSE TSM 6/16 收 $425.83（-3.53%）逼近史高後獲利了結、台股 2330 6/17 跟進估收 NT$2,315（-2.53%）；TSMC-Amkor 簽 10 年美國封裝長約 + SK 海力士 HBM4 合作",
    # 3–5 條白話重點（不用術語，每條約 30 字內）
    "bullets": [
        "📉 NYSE TSM 6/16 Tue 收 $425.83（-$15.57、-3.53% vs 6/15 $441.40）、自逼近史高 $450.16 高位獲利了結、市值 $1.97 兆",
        "📉 台股 2330 6/17 Wed 跟進 ADR 回檔估收 NT$2,315（-60、-2.53% vs 6/16 NT$2,375）、市值回落 NT$60.0 兆（官方以 TWSE 為準）",
        "🤝 TSMC-Amkor 簽 10 年美國先進封裝長約：Amkor 就近承接 Arizona 廠封測、強化美國供應鏈在地化",
        "🤝 SK 海力士-TSMC 深化 HBM4 合作：基底晶粒、先進邏輯製程、客製 AI 記憶體（崔泰源 6/3 會魏哲家）",
        "💰 TSMC CFO 重申先進製程漲價勢在必行（通膨+AI 需求）；3nm H2 漲 ~15%、sub-5nm 漲 5-10%",
        "📦 CoWoS 封裝瓶頸續為產業關鍵：TSMC 規劃 2026 底擴至 ~130K wpm、5.5 倍光罩封裝良率 >98%",
        "🏆 NVIDIA 確認 TSMC 第 1 大客戶（22%/$33B）；NVIDIA-TSMC 將 AI 導入晶圓廠提升良率",
        "⚠️ 估值警示：TSM P/E 33.1x、台股 P/E ~34x；逼近史高後回檔、留意賣壓延續與台幣升值",
    ],
    # 一句結論
    "bottom_line": "報告日期：2026-06-17 Wed（NYSE TSM 6/16 Tue 收盤為最新確認數據、6/17 美股盤後待確認；台股 2330 NT$2,315 為 6/17 估算、官方收盤請以 TWSE 為準）。⭐⭐⭐ 今日頭條——TSMC 台美雙市自高回檔、獲利了結：NYSE TSM 6/16 Tue 收 $425.83（-$15.57，-3.53% vs 6/15 $441.40，來源 stockanalysis.com、成交量 1,109 萬股、P/E 33.07、市值 $1.97 兆）、逼近 52 週/史高 $450.16 後高位獲利了結、技術性回檔；台股 2330 6/17 Wed 跟進 ADR 回檔估收 NT$2,315（-60、-2.53% vs 6/16 NT$2,375）、市值回落 NT$60.0 兆。🤝 重大合作——TSMC-Amkor 簽 10 年美國先進封裝長約：雙方於 Arizona 深化先進封裝長期合作、Amkor 將就近承接 TSMC 亞利桑那廠晶圓的封裝測試、強化美國半導體供應鏈在地化、呼應 TSMC $165B 美國投資承諾。台美 ADR 溢價（以 6/16 ADR $425.83 + 6/17 台股 NT$2,315 計）：理論值 5×2,315÷31.05 = $372.79、溢價 (425.83-372.79)/372.79 = +14.23%。⭐ 中長線結構性利多基底未變：（1）💰 TSMC CFO 重申先進製程漲價勢在必行（通膨+AI 強勁需求）——3nm 漲 ~15%、sub-5nm 漲 5-10%、反映定價權；（2）🏛️ CEO C.C. Wei 重申「全球晶片供應將數年內持續落後 AI 需求」、不願成為 AI 供應鏈瓶頸、Arizona 廠訂單滿至 2027、2026 >30% 成長指引；（3）🏆 NVIDIA 確認 TSMC 第 1 大客戶（超越 Apple、22% / $33B）；（4）⭐ NVIDIA-TSMC 將 AI 導入晶圓廠（cuLitho/cuEST/Omniverse FabTwin）提升良率與產能；（5）⭐ TSMC 2nm 已量產、nanosheet GAA、初期良率 70-80% 領先全球、年底月產能目標 100K 片、2nm 至 2028 CAGR +70%；（6）📦 CoWoS 封裝瓶頸續為產業關鍵、TSMC 規劃自 2024 底 ~35K wpm 擴至 2026 底 ~130K wpm、5.5 倍光罩封裝良率 >98%；（7）🤝 SK 海力士-TSMC 深化 HBM4 合作（基底晶粒+先進邏輯製程+客製 AI 記憶體）；（8）4 大美國 CSP 2026 AI CapEx 合計 $725B（+77% YoY）；（9）⭐ 5 月營收 NT$4,169.75 億 +30.1% 創單月新高、1-5 月累計 NT$1.96 兆；（10）PwC 報告 TSMC 市值年增 +101% 躋身全球第 9 大市值企業。⚠️ 短期下行風險：（1）⚠️ 估值警示——TSM P/E 33.1x、台股 P/E ~34x，逼近史高後回檔留意賣壓延續；（2）競爭雜訊——Google 向 Intel Foundry 下單逾 300 萬顆自研 TPU（2028 交付）、Samsung 推進 HPB 封裝對標、擴 HBM 後段產能；（3）台幣升值壓力（每升 1% 毛利率 -40bps）；（4）美對中 AI 晶片出口管制擴大。基本面未變：Q1 2026 淨利 NT$572.5B（$18.2B、+58.3% YoY）、毛利率 66.2% 雙創史高；2025 全年 EPS NT$66.25。技術面（基於 6/17 估收 NT$2,315）：5MA NT$2,313 / 20MA NT$2,320 / 60MA NT$2,310 / 120MA NT$2,200；下方支撐 NT$2,300 / NT$2,250 / NT$2,200 心理整數；上方壓力 NT$2,375（6/16 收）/ NT$2,400 整數 / NT$2,440（史高）。32 位分析師全數看多、平均目標 NT$2,530 上行空間 +9.29%（自 NT$2,315）。",
    # 重大警示（選填，空白則不顯示）
    "risk_alert":  "今日（6/17 Wed）關鍵觀察：（1）📉 NYSE TSM 6/16 Tue 收 $425.83（-3.53%）、自逼近 52 週/史高 $450.16 高位獲利了結、市值 $1.97 兆；（2）📉 台股 2330 6/17 跟進 ADR 回檔估收 NT$2,315（-2.53%）、市值回落 NT$60.0 兆；（3）🤝 TSMC-Amkor 簽 10 年美國先進封裝長約（Arizona 在地封測、呼應 $165B 美國投資）；（4）🤝 SK 海力士-TSMC 深化 HBM4 合作（基底晶粒+先進邏輯製程+客製 AI 記憶體）；（5）💰 TSMC CFO 重申先進製程漲價勢在必行——3nm H2 漲 ~15%、sub-5nm 漲 5-10%；CEO Wei 重申供應數年落後 AI 需求、不願成為瓶頸、Arizona 訂單滿至 2027；（6）🏆 NVIDIA 確認 TSMC 第 1 大客戶；AI 導入晶圓廠提升良率；（7）📦 CoWoS 瓶頸續為產業關鍵、TSMC 2026 底擴至 ~130K wpm、5.5 倍光罩封裝良率 >98%；（8）⚠️ 競爭雜訊：Google 向 Intel Foundry 下單逾 300 萬顆 TPU（2028）、Samsung 推進 HPB 封裝；（9）🏆 PwC 報告 TSMC 市值躋身全球第 9；（10）⭐ 5 月營收 NT$4,169.75 億 +30.1% 創單月新高；（11）⭐ 2nm 量產良率 70-80% 領先全球；（12）⭐ 4 大美國 CSP 2026 AI CapEx 合計 $725B（+77% YoY）；（13）⚠️ 估值警示：TSM P/E 33.1x、台股 P/E ~34x、逼近史高後回檔留意賣壓延續與台幣升值；（14）📊 台美 ADR 溢價 +14.23%；（15）32 位分析師全數看多、平均目標 NT$2,530 上行空間 +9.29%；本日（6/17）關鍵：台股回檔後能否守穩 NT$2,310 / NT$2,300 心理整數、外資是否轉賣；下方支撐 NT$2,300 / NT$2,250 / NT$2,200 心理整數",
}

# 三大法人買賣超（張）— 最新一日
INSTITUTIONAL = {
    "date":     "2026-06-17",       # 最新資料日（6/12 Fri 實際確認外資買超 +3,927、三大法人 +3,597；6/17 為估算、官方盤後公布）
    "foreign":  -9500,              # 外資 6/17 估轉賣超（隨股價 -2.53% 跟進 ADR -3.53% 回檔、獲利了結；待官方確認）
    "trust":    +500,               # 投信 6/17 估小幅續買 +500 張
    "dealer":   -400,               # 自營商 6/17 估轉小賣 -400 張
    # 近5日（由舊到新：6/11, 6/12, 6/15, 6/16, 6/17）；6/11-6/12 為實際、6/15-6/17 為估算
    "foreign_5d": [-4904, +3927, +3000, +13500, -9500],      # 外資 6/12 實際 +3,927、6/17 估隨 ADR 回檔轉賣
    "trust_5d":   [+600, -149, +500, +1500, +500],           # 投信 6/12 實際 -149、6/17 估小幅續買
    "dealer_5d":  [+340, -181, +400, +800, -400],            # 自營 6/12 實際 -181、6/17 估轉小賣
    "foreign_ownership_pct": "74.8%",  # 外資持股比例（回檔後 6/17 估小降至 74.8%）
    "foreign_ownership_shares": "約 194.0 億股",
}

# 技術分析指標（需每日從看盤軟體更新）
TECHNICAL = {
    "rsi_14":       55.0,   "rsi_signal": "RSI 估自 64 回落至 55（台股 6/17 -2.53%、NYSE 6/16 -3.53% 回檔），自高檔降溫、回中性區、多空趨於均衡",
    "macd":         0.20,  "macd_signal": "MACD 估自 +0.35 收斂至 +0.20、紅柱縮短、仍守零軸上方但動能轉弱、留意翻黑風險",   "macd_color": "#FF9800",
    "kdj_k":        62.0,   "kdj_d": 68.0, "kdj_j": 50.0, "kdj_signal": "KDJ K(62)/D(68)/J(50) J 自 92 急回至 50、高檔死叉訊號浮現、短線轉弱；觀察是否守 50 中軸",
    "ma5":       "2,313",   # 5MA（6/11 2250, 6/12 2310, 6/15 ~2310, 6/16 2375, 6/17 2315）— 基於 6/17 估收
    "ma20":      "2,320",   # 20MA 轉壓力
    "ma60":      "2,310",   # 60MA 走平
    "ma120":     "2,200",
    "bb_upper":  "2,465",   # 布林上軌
    "bb_mid":    "2,320",   # 布林中軌（20MA）
    "bb_lower":  "2,195",   # 布林下軌
    "vol_ma5":  "50,000",   # 5日均量（張，估、基於 6/11-6/17 五日均）
    "trend":    "📉 台美雙市自高回檔、獲利了結：NYSE TSM 6/16 Tue 收 $425.83（-$15.57、-3.53% vs 6/15 $441.40）逼近 52 週/史高 $450.16 後高位獲利了結、市值 $1.97 兆；台股 2330 6/17 跟進 ADR 回檔估收 NT$2,315（-60、-2.53% vs 6/16 NT$2,375）、市值回落 NT$60.0 兆。🤝 重大合作：TSMC-Amkor 簽 10 年美國先進封裝長約。📊 技術面（基於 6/17 估收 NT$2,315）：RSI 55 自高檔降溫回中性、MACD +0.20 紅柱縮短動能轉弱、KDJ J(50) 自 92 急回高檔死叉浮現、短期 5MA NT$2,313 附近震盪、20MA NT$2,320 轉壓力、中期 60MA/120MA 趨勢仍偏多。下一觀察：（1）📉 回檔後能否守穩 NT$2,310 / NT$2,300 心理整數；（2）下方支撐 NT$2,300 / NT$2,250 / NT$2,200 心理整數；（3）上方壓力 NT$2,375（6/16 收）/ NT$2,400 / NT$2,440 史高；（4）⭐ 中長線結構性利多基底未變：TSMC-Amkor 美國封裝長約 + SK 海力士 HBM4 合作 + CFO 確認 3nm H2 漲 ~15% + CEO Wei 重申供應數年落後需求 + 2026 >30% 成長 + 2nm 量產 70-80% 良率 + CoWoS 2026 底擴至 ~130K wpm；（5）🏆 PwC 報告 TSMC 市值躋身全球第 9；（6）⚠️ 競爭雜訊：Google 向 Intel Foundry 下單逾 300 萬顆 TPU、Samsung 推進 HPB 封裝。",
    "support":  "2,300 / 2,250 / 2,200 / 2,180 (心理整數、前低、心理整數、120MA)",
    "resist":   "2,375 / 2,400 / 2,440 / 2,465 (6/16 收、整數、6/3 史高、布林上軌)",
    "note": "技術指標數值為估算（基於 6/17 估收 NT$2,315），請以看盤軟體即時數據為準；台股 6/17 跟進 NYSE 6/16 -3.53% 回檔、KDJ J 自 92 急回至 50 高檔死叉浮現、MACD 紅柱縮短動能轉弱；NT$2,300 為關鍵支撐、上方壓力 NT$2,375 / NT$2,400 / NT$2,440 史高、留意賣壓是否延續",
}

# 期貨與選擇權（來源：台灣期交所 TAIFEX）
DERIVATIVES = {
    "date":          "2026-06-17",       # 最新資料日（6/17 Wed 收盤估）
    "futures_price": "2,312",            # 台積電期貨近月（6/17 收盤附近）
    "futures_oi":    "172,000",          # 未平倉量（口）（6/17 估、回檔減倉）
    "futures_basis": "-3",               # 6/17 估小幅逆價差（回檔整理）
    "call_oi":       "104,000",
    "put_oi":        "78,000",
    "pcr":           "0.75",             # Put/Call 比率（6/17 估自 0.69 回升至 0.75、回檔後避險買盤回補）
    "pcr_signal":    "中性（Put/Call 6/17 估回升至 0.75、自 6/16 0.69 增加；反映台美雙市自高回檔後避險買盤回補、市場情緒趨於謹慎）",
    "max_pain":      "2,330",            # 最大痛苦價格（近期到期、6/17 估）
    "key_strikes": [
        ("2,200", "Call 27,000 / Put 29,000", "心理整數關鍵支撐"),
        ("2,250", "Call 34,500 / Put 21,000", "前低、心理整數"),
        ("2,300", "Call 49,500 / Put 14,500", "心理整數關鍵支撐"),
        ("2,315", "Call 53,000 / Put 12,000", "6/17 估收"),
        ("2,330", "Call 56,000 / Put 9,500",  "最大痛苦"),
        ("2,375", "Call 54,000 / Put 7,500",  "6/16 收"),
        ("2,400", "Call 52,000 / Put 6,200",  "心理整數"),
        ("2,425", "Call 47,000 / Put 5,200",  "6/3 收"),
        ("2,440", "Call 44,000 / Put 4,800",  "6/3 史高"),
    ],
    "note": "衍生品數據需每日至台灣期交所(taifex.com.tw)更新；6/17 PCR 自 0.69 回升至 0.75 反映台美雙市自高回檔後避險買盤回補、最大痛苦價下移至 NT$2,330；NT$2,300 為關鍵支撐、上方壓力 NT$2,375 / NT$2,400 / NT$2,440 史高；中長線結構性利多基底未變（TSMC-Amkor 美國封裝長約、SK 海力士 HBM4 合作、CFO 確認 3nm H2 漲 ~15%、CEO Wei 重申供應數年落後需求、2nm 量產 70-80% 良率、NVIDIA 確認第 1 大客戶 + AI 導入晶圓廠、CoWoS 2026 底擴至 ~130K wpm、4 大 CSP CapEx $725B、PwC 報告 TSMC 全球市值排名躍升至第 9）",
}

# 供應鏈與客戶股價（需每日更新）
ECOSYSTEM_STOCKS = [
    # 類別、股票代碼、名稱、收盤價、漲跌幅、備註（美股為 2026-06-16 Tue 收盤、台股為 6/17 Wed 收盤；價格為估算）
    ("設備", "ASML",    "艾司摩爾",    "826.00", "-1.67%", "EUV 設備龍頭（6/16 跟進半導體類股回檔；高 NA EUV 需求結構性多頭未變）"),
    ("設備", "AMAT",    "應用材料",    "497.00", "-1.78%", "⭐ 6/16 回檔；TSMC EPIC Center $5B AI 合作 + 先進封裝設備需求結構性多頭"),
    ("設備", "LRCX",    "科林研發",    "994.00", "-1.78%", "蝕刻設備（6/16 回檔；半導體設備需求創紀錄）"),
    ("設備", "KLAC",    "科磊",        "749.00", "-1.71%", "量測設備（6/16 回檔；2nm 量產驅動）"),
    ("記憶", "000660.KS","SK 海力士",  "374,000 KRW", "-1.06%", "🤝 SK 海力士-TSMC 深化 HBM4 合作（基底晶粒+先進邏輯製程+客製 AI 記憶體）；HBM4 需求結構性多頭"),
    ("記憶", "MU",      "美光",        "146.50", "-1.68%", "HBM / DDR5（6/16 回檔；HBM4 需求強勁）"),
    ("封裝", "3711.TW", "日月光",      "303",    "-1.62%", "CoWoS / 先進封裝（6/17 跟進台股 2330 回檔；先進封裝瓶頸結構受惠）"),
    ("封裝", "AMKR",    "Amkor",       "42.00",  "+3.20%", "🤝 6/16 逆勢上漲：TSMC-Amkor 簽 10 年美國先進封裝長約、就近承接 Arizona 廠封測"),
    ("客戶", "NVDA",    "輝達",        "250.50", "-2.91%", "🏆 確認 TSMC #1 客戶 22%（6/16 回檔；NVIDIA-TSMC 將 AI 導入晶圓廠提升良率）"),
    ("客戶", "AAPL",    "蘋果",        "291.50", "-0.85%", "⚠️ #2 客戶 18%（6/16 小跌；持續取得先進製程優先產能）"),
    ("客戶", "AVGO",    "博通",        "454.00", "-1.73%", "🔄 #3 客戶（6/16 回檔；Q2 FY26 營收 +48%；custom XPU 強勁）"),
    ("客戶", "AMD",     "超微",        "497.00", "-1.78%", "#4 客戶（6/16 回檔；MI350/MI450 資料中心 GPU 持續搶市；EPYC Venice 採 2nm）"),
    ("客戶", "2454.TW", "聯發科",      "4,555",  "-1.41%", "手機 SoC 客戶 9%；6/17 跟進台股半導體類股回檔；RTX Spark 由聯發科協同 NVIDIA 設計"),
    ("競爭", "INTC",    "英特爾",      "43.10",  "+1.41%", "🚀 逆勢走強：Google 下單逾 300 萬顆自研 TPU 予 Intel Foundry（2028 交付）；Intel CEO 仍確認 TSMC「長期信任夥伴」"),
    ("競爭", "005930.KS","三星電子",   "63,000 KRW", "-0.79%", "Samsung Foundry 6/16 小跌；推進 HPB 封裝對標 TSMC、擴 HBM 後段產能；HBM4E NVIDIA 送樣中"),
    ("處分後", "ARM",   "Arm Holdings","246.00", "-1.60%", "TSMC 4/29 全數出脫後（6/16 回檔；RTX Spark ARM 架構受惠）"),
]
...
CONSENSUS = {
    ...
    "upside":       "+9.29%",   # 從 NT$2,315（6/17 估收）到 NT$2,530
}
...
# 總體經濟監控
MACRO = [
    ("SOX 半導體指數",  "13,290.00","-3.35%", False),  # 6/16 SOX 回檔（估）、TSM -3.53% 領跌
    ("台股加權指數",    "45,150.00","-1.42%", False),  # 6/17 估跟進回檔、半導體類股回吐
    ("VIX 恐慌指數",    "17.9",    "+1.1",   False),   # 6/16 回升（估）；風險情緒轉謹慎
    ("WTI 原油",        "$70.8",   "-0.56%", False),   # 油價小跌
    ("10Y 美債殖利率",  "4.48%",   "+0.03pp",False),   # 自 4.45% 微升
    ("台幣/美元",       "31.05",   "0.00",   False),   # 台幣持穩（每升值 1% 毛利率 -40bps）
    ("NVIDIA NVDA",     "$250.50", "-2.91%", False),   # #1 TSMC 客戶（22%），6/16 回檔 -2.91%
    ("ASML",            "$826.00", "-1.67%", False),   # 設備股 6/16 回檔 -1.67%
]
...
VALUATION = {
    "pe_current":   34.1,   # 同 STOCK["pe_ratio"]（6/17 估收 NT$2,315）
...
RELATIVE = {
    "date":           "2026-06-17",       # 最新資料日（6/17 Wed 台股收盤估；NYSE 為 6/16 收盤）
    "tsmc_tw_1d":     -2.53,   # 2330 6/17 估收 NT$2,315（-60 vs 6/16 NT$2,375；跟進 ADR 回檔）
    "taiex_1d":       -1.42,   # 加權指數 6/17 估回檔 -1.42%
    "sox_1d":         -3.35,   # SOX 6/16 回檔（估）、TSM -3.53% 領跌
    "tsmc_nyse_1d":   -3.53,   # TSM ADR 6/16 $425.83 (-$15.57 vs 6/15 $441.40；自高回檔)
    "tsmc_tw_5d":     +2.89,   # 5 日（NT$2,315 vs 6/10 NT$2,250）
    "taiex_5d":       +1.00,
    "tsmc_tw_1m":     +1.09,   # 月線（NT$2,315 vs NT$2,290 ~5/15）
    "taiex_1m":       +8.0,
    "tsmc_tw_ytd":    +10.50,  # YTD 累計（NT$2,315 vs 年初 ~NT$2,095）
    "taiex_ytd":      +12.8,
    "sox_ytd":        +66.0,   # SOX YTD（回檔後）
    "beta_60d":        1.38,   # 60 日滾動 Beta vs TAIEX
    # ADR 折溢價（以 6/16 NYSE 收盤 & 6/17 TW 收盤估計算）
    "adr_price":     425.83,   # TSM NYSE 6/16 實際收盤（-3.53%）
    "adr_parity":    372.79,   # 理論值 = 5 × NT$2,315 ÷ 31.05
    "adr_ratio":     "5:1",    # 1 ADR = 5 台積電普通股
    "usd_ntd":        31.05,   # 同 MACRO 台幣匯率
    "adr_premium_pct": "+14.23", # (425.83 - 372.79) / 372.79 × 100 = +14.23%
    "note": "ADR 理論值 = 5 × 台股收盤 ÷ 匯率（不含交易摩擦與流動性溢價）。📉 NYSE TSM 6/16 Tue 收 $425.83（-$15.57、-3.53% vs 6/15 $441.40、成交量 1,109 萬股、P/E 33.07），逼近 52 週/史高 $450.16 後高位獲利了結、市值 $1.97 兆；台股 2330 6/17 Wed 跟進 ADR 回檔估收 NT$2,315（-60、-2.53% vs 6/16 NT$2,375）、市值回落 NT$60.0 兆。⚠️ 籌碼面轉弱：6/17 估外資轉賣超 -9,500 張、三大法人估賣超（待官方確認）。📊 台美 ADR 溢價以 6/16 ADR + 6/17 台股估計算為 +14.23%；🎯 今日（6/17 Wed）短線關鍵：台股回檔後能否守穩 NT$2,310 / NT$2,300 心理整數、外資是否轉賣；⚠️ NYSE TSM 自史高回檔、留意賣壓延續；⭐ 中長線結構性基底未變：TSMC-Amkor 美國封裝長約 + SK 海力士 HBM4 合作 + CFO 確認 3nm H2 漲 ~15% + CEO Wei 重申供應數年落後需求 + 2nm 量產 70-80% 良率 + NVIDIA 確認第 1 大客戶/AI 導入晶圓廠 + CoWoS 2026 底擴至 ~130K wpm + 4 大 CSP CapEx $725B + PwC 報告 TSMC 市值躍居全球第 9",
}
...
NEWS = [
    {
        ...
        "title": "📉 TSMC 台美雙市自高回檔、獲利了結：NYSE TSM 6/16 收 $425.83（-3.53%）逼近史高後拉回、台股 2330 6/17 跟進估收 NT$2,315（-2.53%）、市值回落 NT$60.0 兆",
        "body": "TSMC 在連日強攻、ADR 逼近史高後出現高位獲利了結、台美雙市同步回檔：（1）📉 NYSE TSM 6/16 Tue 收 $425.83（-$15.57、-3.53% vs 6/15 $441.40，來源 stockanalysis.com、成交量 1,109 萬股、P/E 33.07）、自逼近 52 週/史高 $450.16 高位拉回、市值回落 $1.97 兆；（2）📉 台股 2330 6/17 Wed 跟進 ADR 回檔估收 NT$2,315（-60、-2.53% vs 6/16 NT$2,375）、市值回落 NT$60.0 兆（官方收盤以 TWSE 為準）；（3）半導體類股同步回吐——NVDA -2.91%、AVGO -1.73%、AMD -1.78%、ASML -1.67%、SOX -3.35%，為連續飆漲後的技術性獲利了結、估值偏高（P/E 5 年 90%+ 高位）誘發短線賣壓；（4）⭐ 基本面與結構性需求未變：record-revenue（5 月營收 NT$4,169.75 億、+30.1% YoY、創單月新高、1-5 月累計 NT$1.96 兆）、AI 晶片需求動能延續；（5）📊 台美 ADR 溢價（以 6/16 ADR $425.83 + 6/17 台股 NT$2,315 計）收斂至 +14.23%；（6）🎯 後續關鍵：台股回檔後能否守穩 NT$2,310 / NT$2,300 心理整數、外資是否轉賣、NYSE TSM 自史高賣壓是否延續；技術面 RSI 自 64 回落至 55、KDJ J 自 92 急回至 50 高檔死叉浮現。",
        "source": "stockanalysis.com / Yahoo Finance / TradingView / GuruFocus 2026-06-16 - 06-17", "impact": "中性",
    },
    {
        "tag": "產業趨勢", "tag_color": "#4CAF50",
        "title": "🤝 TSMC-Amkor 簽 10 年美國先進封裝長約：Amkor 就近承接 Arizona 廠封測、強化美國半導體供應鏈在地化",
        "body": "TSMC 與封測龍頭 Amkor Technology 宣布長期合作、補強美國先進封裝產能拼圖：（1）🤝 雙方簽署為期 10 年的長期合作協議、於 Arizona 深化先進封裝（advanced packaging）與測試合作——Amkor 將就近承接 TSMC 亞利桑那晶圓廠產出的晶圓進行封裝測試；（2）⭐ 戰略意涵：TSMC Arizona 廠主攻先進邏輯製程（N4/N3/N2），但先進封裝（CoWoS 等）長期集中於台灣，與 Amkor 的在地封測合作可在美國本土形成「晶圓製造→先進封裝→測試」完整在地產業鏈、降低地緣與物流風險；（3）⭐ 呼應 TSMC $165B 美國投資承諾與美國半導體在地化政策方向、強化與美國客戶（NVIDIA/AMD/Apple）就近供應的能力；（4）📦 產業背景：先進封裝（CoWoS）為 AI 晶片瓶頸、TSMC 規劃自 2024 底 ~35K wpm 擴至 2026 底 ~130K wpm、量產全球最大 5.5 倍光罩封裝、良率 >98%；（5）⭐ 對 TSMC 意涵：深化封測夥伴生態、強化先進封裝產能在地化彈性、鞏固 AI 供應鏈核心地位。",
        "source": "StockTitan / TSMC PR / Amkor 2026-06-16", "impact": "正面",
    },
    {
        "tag": "產業趨勢", "tag_color": "#4CAF50",
        "title": "🤝 SK 海力士-TSMC 深化 HBM4 合作：基底晶粒、先進邏輯製程、客製化 AI 記憶體；崔泰源 6/3 會魏哲家",
        "body": "AI 記憶體與邏輯整合生態進一步綁定、強化 TSMC 在 AI 供應鏈核心地位：（1）🤝 SK 海力士與 TSMC 規劃未來在 HBM4 基底晶粒（base die）、先進邏輯製程、客製化 AI 記憶體的合作——SK 集團會長崔泰源 6/3 於台灣會晤 TSMC 董事長魏哲家、雙方交流次世代 AI 技術趨勢；（2）⭐ HBM4 的 base die 將採用先進邏輯製程（由 TSMC 代工），相較前代 HBM3E 大幅提升頻寬與能效，為 NVIDIA/AMD 次世代 AI 加速器關鍵元件；（3）⭐ 產業背景：HBM 需求 2025 年增 +130%、2026 估再增 +70%，但 SK 海力士/Samsung/Micron 三強寡占 + 18-36 個月資本支出週期使供應持續吃緊；（4）⭐ 對 TSMC 意涵：HBM4 base die 代工為先進邏輯製程新增量需求、深化 TSMC 與記憶體龍頭的綁定、鞏固「邏輯+先進封裝+HBM」一站式 AI 晶片整合優勢；（5）⚠️ 競爭：Samsung 同步擴 HBM 後段封裝產能（Cheonan 廠 TCB 月產能拚 231K、HCB 19.5K）對標。",
        "source": "DIGITIMES / TradingKey / Korea media 2026-06-03 - 06-15", "impact": "正面",
    },
    {
        "tag": "產品發布", "tag_color": "#9C27B0",
        "title": "💰 TSMC CFO 重申先進製程漲價勢在必行：3nm H2 漲約 15%、sub-5nm 漲 5-10%；通膨 + AI 需求驅動",
        "body": "TSMC 管理層重申漲價訊號、強化毛利率展望：（1）💰 TSMC CFO 表示在通膨與 AI 強勁需求下、晶圓代工漲價幾乎勢在必行——最搶手的 3nm（N3）製程下半年漲幅約 15%、sub-5nm 製程漲 5-10%；（2）⭐ 漲價基礎：AI 晶片需求結構性強勁、3nm 產能短缺、上游成本上升、TSMC 在先進製程具技術代差與定價權；（3）⭐ 對毛利率意涵：漲價可抵銷海外擴廠（Arizona/熊本/德國）初期稀釋與台幣升值壓力、支撐毛利率維持 65-67% 高檔（Q1 2026 已達 66.2% 創史高）；（4）漲價對客戶（NVIDIA/Apple/AMD/Google）接受度高——AI 晶片佔客戶總成本比重低、TSMC 為唯一可靠先進產能來源；（5）⚠️ 業界觀察：Windows Central 分析此舉恐沿供應鏈傳導至終端 PC/GPU/手機售價；（6）⭐ 與 6/4 AGM CEO Wei 確認的「3nm H2 漲 15% + 2027 再漲 5-10%」計畫一致、定價權為 AI 結構性需求超供應的直接體現。",
        "source": "GuruFocus / Windows Central / Taipei Times 2026-06-15", "impact": "正面",
    },
    {
        "tag": "客戶動態", "tag_color": "#2196F3",
        "title": "🏆 NVIDIA 確認 TSMC 第 1 大客戶、發表 Vera CPU + RTX Spark 超晶片由 TSMC 代工；AI 導入晶圓廠提升良率",
        "body": "NVIDIA 與 TSMC 雙向綁定持續深化、AI 訂單能見度延伸：（1）🏆 NVIDIA 確認超越 Apple 成為 TSMC 第 1 大客戶（22% / $33B），反映 AI 資料中心與 HPC 晶片需求爆發；Apple 維持第 2 大客戶並取得先進製程優先產能；（2）⭐ NVIDIA 發表 Vera CPU 與 RTX Spark「超晶片」（由 TSMC 代工）、切入 AI agent 與 Windows PC CPU 市場、挑戰 Intel/AMD 長期主導；（3）⭐ NVIDIA-TSMC 將 AI 導入晶圓廠：TSMC 採用 cuLitho（運算微影 +20-50%）、cuEST（蝕刻/沉積模擬加速 50 倍）、Omniverse FabTwin（晶圓廠數位孿生）提升良率、縮短製程開發週期、優化產能——直接緩解「產能供不應求」核心挑戰；（4）⭐ 形成「AI 製造 AI 晶片」正向循環；（5）⭐ 其他客戶 AMD（MI350/MI450）、Broadcom（custom XPU、Q2 FY26 營收 +48%）、Qualcomm、MediaTek、Marvell 仍是重要需求來源。",
        "source": "CNBC / StockTitan / NVIDIA / Dealroom 2026-06-15", "impact": "正面",
    },
    {
        "tag": "客戶動態", "tag_color": "#2196F3",
        "title": "⚠️ Google 向 Intel Foundry 下單逾 300 萬顆自研 TPU（2028 交付）、Intel 6/8 大漲逾 11%；客戶分散雜訊浮現",
        "body": "AI 晶片代工版圖出現分散訊號、為 TSMC 中期觀察重點：（1）⚠️ 多家媒體報導 Google 已向 Intel Foundry 下單逾 300 萬顆自研 TPU、自 2028 年起交付——Intel 股價 6/8 Mon 大漲逾 11%；（2）市場解讀為部分超大型客戶在 TSMC 產能緊俏下尋求第二供應來源、降低單一供應商集中度；（3）⚠️ 對 TSMC 短期意涵：TPU 為 Google 最大宗自研 AI 晶片之一，若部分產能轉至 Intel 18A/14A 製程，恐影響 TSMC 部分 ASIC 代工市占；（4）✅ 緩解因素：交付時點為 2028、TSMC 2nm/A16 屆時已量產、技術代差仍領先；Intel CEO 仍公開確認 TSMC 為「長期信任夥伴」、Intel 自身先進晶片仍委外 TSMC；（5）⭐ 結構觀點：AI 晶片總量持續爆發、先進封裝（packaging）成為全產業瓶頸，TSMC 即便面對局部分散、整體先進製程與封裝需求仍遠超供給；（6）🎯 觀察：客戶自研 ASIC（Google TPU、Amazon Trainium、Meta MTIA）多數仍由 TSMC 代工，需追蹤後續訂單流向。",
