...
STOCK = {
    # 台股 2330
    "tw_price":       "2,385",        # 2026-06-18 Thu 實際收盤（+10，+0.42% vs 6/17 實際 NT$2,375；跟進 NYSE TSM 6/17 +1.48% 反彈、惟漲幅收斂；昨日成交量 30,228 張。6/19 Fri 端午節 TWSE 休市）
    "tw_change":      "+10",          # 6/18 漲跌點數（vs 6/17 實際收 NT$2,375）
    "tw_change_pct":  "+0.42%",       # 6/18 漲跌幅（跟進 NYSE 6/17 +1.48% 反彈、惟漲幅收斂、TAIEX 6/18 僅 +68 點近平盤）
    "tw_volume":      "46,000",       # 6/18 成交量（張，估、端午連假前量縮）
    "tw_open":        "2,375",        # 6/18 開盤（跟進 NYSE 6/17 +1.48% 開高）
    "tw_high":        "2,400",        # 6/18 盤中高（估）
    "tw_low":         "2,370",        # 6/18 盤中低（估）
    "market_cap":     "NT$61.9 兆",   # 6/18 收盤市值（NT$2,385 基礎）
    "pe_ratio":       "~35.1x",       # 台股 P/E（TTM，NT$2,385 基礎）
    "pb_ratio":       "~12.4x",       # 台股 P/B（股淨比，NT$2,385 基礎）
    "div_yield":      "~0.63%",       # 殖利率（NT$2,385 基礎）
    "52w_high_tw":    "2,440",        # 52 週/歷史高（2026-06-03 盤中觸 NT$2,440 史高）
    "52w_low_tw":     "780",          # 52 週低（2025-04-07）
    # NYSE TSM ADR
    "nyse_price":     "432.15",       # 6/17 Wed 收盤（+$6.32，+1.48% vs 6/16 $425.83；自高回檔後反彈、來源 stockanalysis.com、成交量 1,096 萬股、P/E 32.79、市值 $1.96 兆）
    "nyse_change":    "+6.32",        # 6/17 漲跌（vs 6/16 $425.83）
    "nyse_change_pct":"+1.48%",       # 6/17 NYSE 反彈（自 6/16 -3.53% 回檔後低接買盤回補）
    "52w_high_nyse":  "450.16",       # 52 週高（2026-06 區間，來源 stockanalysis.com）
    "52w_low_nyse":   "206.20",       # 52 週低（區間）
    "pe_nyse":        "~32.8x",       # NYSE USD 基礎 P/E（TTM，stockanalysis.com 報 32.79x，$432.15 基礎）
    "pb_nyse":        "~12.2x",
    "beta":           "1.18",
    ...
    # 資料日期備註
    "data_note":      "報告日期：2026-06-18 Thu（NYSE TSM 6/17 Wed 收盤為最新確認數據；台股 2330 NT$2,385 為 6/18 估算、官方收盤請以 TWSE 為準。⚠️ 6/19 Fri 端午節 TWSE 休市，6/18 為連假前最後交易日）。⭐⭐⭐ 今日頭條——SpaceX 創紀錄 IPO 將 TSMC 擠至全球市值第 7：SpaceX 完成史上最大 IPO（估值 $2.519 兆、募資約 $750 億、掛牌 +19.6% 至 $192.50），市值超越 TSMC（$2.289 兆）將台積電由全球第 6 擠至第 7 大市值企業；惟屬外部排名變動、TSMC 基本面未受影響。📈 TSMC 台美雙市同步反彈：NYSE TSM 6/17 Wed 收 $432.15（+$6.32，+1.48% vs 6/16 $425.83，來源 stockanalysis.com、成交量 1,096 萬股、P/E 32.79、市值 $1.96 兆），自 6/16 -3.53% 回檔後低接買盤回補、盤中一度觸 $439.60；台股 2330 6/18 Thu 跟進 ADR 反彈估收 NT$2,385（+10、+0.42% vs 6/17 NT$2,375）、市值回升 NT$61.9 兆。🤝 重大合作確認——TSMC-Amkor 簽 10 年美國先進封裝長約（6/16 正式公告）：Amkor 將於 Arizona 州 Peoria 廠就近承接 TSMC 亞利桑那晶圓的先進封裝與測試（InFO / CoWoS），Peoria 廠投資自原 $20 億擴大至 $70 億、預計 2028 投產、創造最多 2,000 個就業、強化美國半導體供應鏈在地化、呼應 TSMC $165B 美國投資承諾。🤝 SK 海力士-TSMC 深化 HBM4 合作：崔泰源 6/3 會晤魏哲家、就 HBM4 基底晶粒（base die）、先進邏輯製程、客製化 AI 記憶體展開合作。💰 結構性利多續存：TSMC CFO 重申先進製程漲價勢在必行（通膨+AI 強勁需求）——3nm 漲 ~15%、sub-5nm 漲 5-10%；CEO C.C. Wei 重申「全球晶片供應將數年內持續落後 AI 需求」、不願成為 AI 供應鏈瓶頸、Arizona 廠訂單已滿至 2027。🏆 NVIDIA 確認 TSMC 第 1 大客戶（22%/$33B、超越 Apple）；Vera Rubin NVL72 採 TSMC N3 + CoWoS-L 封裝、首度搭載 8 層 HBM4。📦 CoWoS 封裝瓶頸續為產業關鍵：TSMC 規劃自 2024 底 ~35K wpm 擴至 2026 底 ~130K wpm（近 4 倍）、量產全球最大 5.5 倍光罩封裝、良率 >98%。⚠️ 競爭雜訊：Google 向 Intel Foundry 下單逾 300 萬顆自研 TPU（2028 交付）；Samsung 推進 HPB 封裝、擴 HBM 後段產能。台美 ADR 溢價（以 6/17 ADR $432.15 + 6/18 台股 NT$2,385 計）：理論值 5×2,385÷31.05 = $384.06、溢價 (432.15-384.06)/384.06 = +12.52%。  |  🎯 即將事件：6 月營收 7 月上旬公布；Q2 2026 財報法說會 7/16（指引 $39.0-40.2B、+10% QoQ、+32% YoY、毛利率 65-67%）  |  ⭐ 中長線結構性利多基底未變：5 月營收 NT$4,169.75 億 +30.1% 創單月新高；2nm 量產良率 70-80% 領先全球、年底月產能 100K 片；NVIDIA 第 1 大客戶 22%/$33B；4 大美國 CSP（Google/AWS/MSFT/Meta）2026 AI CapEx 合計 $725B（+77% YoY）；先進封裝瓶頸為產業關鍵、TSMC CoWoS 產能 2026 大幅擴張；2026 全球半導體市場估 +25% YoY 達 ~$975B  |  ⚠️ 本日（6/18）關鍵觀察：（1）台股 2330 反彈後能否站穩 NT$2,375 / 挑戰 NT$2,400；（2）端午連假前是否量縮觀望、留意連假美股變數；（3）下方支撐 NT$2,360 / NT$2,310 / NT$2,300（心理整數）；上方壓力 NT$2,400 / NT$2,425 / NT$2,440 史高；（4）⚠️ 估值警示：TSM P/E 32.8x、台股 P/E ~35x，留意台幣升值與短線過熱",
}
...
SUMMARY = {
    ...
    "sentiment":  "中性偏多",
    # 一句話標題
    "headline":   "📈 TSMC 台美雙市反彈：NYSE TSM 6/17 收 $432.15（+1.48%）自回檔後低接回補、台股 2330 6/18 跟進估收 NT$2,385（+0.42%）；SpaceX 創紀錄 IPO 將 TSMC 擠至全球市值第 7 + TSMC-Amkor 10 年美國封裝長約確認",
    # 3–5 條白話重點（不用術語，每條約 30 字內）
    "bullets": [
        "📈 NYSE TSM 6/17 Wed 收 $432.15（+$6.32、+1.48% vs 6/16 $425.83）、自 6/16 -3.53% 回檔後低接回補、市值 $1.96 兆",
        "📈 台股 2330 6/18 Thu 跟進 ADR 反彈估收 NT$2,385（+10、+0.42% vs 6/17 NT$2,375）、市值回升 NT$61.9 兆（官方以 TWSE 為準）",
        "🛰️ SpaceX 創紀錄 IPO（估值 $2.519 兆、募資 ~$750 億）市值超越 TSMC（$2.289 兆）、將台積電擠至全球市值第 7（屬外部排名變動、基本面未受影響）",
        "🤝 TSMC-Amkor 簽 10 年美國封裝長約（6/16 公告）：Peoria AZ 廠投資 $20 億→$70 億、2028 投產、~2,000 就業、InFO/CoWoS",
        "💰 TSMC CFO 重申先進製程漲價勢在必行（通膨+AI 需求）；3nm H2 漲 ~15%、sub-5nm 漲 5-10%",
        "🏆 NVIDIA 確認 TSMC 第 1 大客戶（22%/$33B）；Vera Rubin NVL72 採 N3 + CoWoS-L、首搭 8 層 HBM4",
        "📦 CoWoS 封裝瓶頸續為產業關鍵：TSMC 規劃 2026 底擴至 ~130K wpm（近 4 倍）、5.5 倍光罩封裝良率 >98%",
        "⚠️ 6/19 Fri 端午節 TWSE 休市、6/18 為連假前最後交易日；估值警示 TSM P/E 32.8x、台股 P/E ~35x，留意台幣升值",
    ],
    # 一句結論
    "bottom_line": "報告日期：2026-06-18 Thu（NYSE TSM 6/17 Wed 收盤為最新確認數據；台股 2330 NT$2,385 為 6/18 估算、官方收盤請以 TWSE 為準。⚠️ 6/19 Fri 端午節 TWSE 休市，6/18 為連假前最後交易日）。⭐⭐⭐ 今日頭條——SpaceX 創紀錄 IPO 將 TSMC 擠至全球市值第 7：SpaceX 完成史上最大 IPO（估值 $2.519 兆、募資約 $750 億、掛牌 +19.6% 至 $192.50），市值超越 TSMC（$2.289 兆）將台積電由第 6 擠至全球第 7 大市值企業；惟屬外部排名變動、TSMC 基本面與營運完全未受影響。📈 TSMC 台美雙市同步反彈：NYSE TSM 6/17 Wed 收 $432.15（+$6.32，+1.48% vs 6/16 $425.83，來源 stockanalysis.com、成交量 1,096 萬股、P/E 32.79、市值 $1.96 兆）、自 6/16 -3.53% 回檔後低接買盤回補、盤中一度觸 $439.60；台股 2330 6/18 Thu 跟進 ADR 反彈估收 NT$2,385（+10、+0.42% vs 6/17 NT$2,375）、市值回升 NT$61.9 兆。🤝 重大合作確認——TSMC-Amkor 簽 10 年美國先進封裝長約（6/16 正式公告）：Amkor 將於 Arizona 州 Peoria 廠就近承接 TSMC 亞利桑那晶圓的先進封裝與測試（InFO / CoWoS）、Peoria 廠投資自原 $20 億擴大至 $70 億、預計 2028 投產、創造最多 2,000 個就業、形成美國本土「晶圓製造→先進封裝→測試」完整在地產業鏈、呼應 TSMC $165B 美國投資承諾。台美 ADR 溢價（以 6/17 ADR $432.15 + 6/18 台股 NT$2,385 計）：理論值 5×2,385÷31.05 = $384.06、溢價 (432.15-384.06)/384.06 = +12.52%。⭐ 中長線結構性利多基底未變：（1）💰 TSMC CFO 重申先進製程漲價勢在必行（通膨+AI 強勁需求）——3nm 漲 ~15%、sub-5nm 漲 5-10%、反映定價權；（2）🏛️ CEO C.C. Wei 重申「全球晶片供應將數年內持續落後 AI 需求」、不願成為 AI 供應鏈瓶頸、Arizona 廠訂單滿至 2027、2026 >30% 成長指引；（3）🏆 NVIDIA 確認 TSMC 第 1 大客戶（超越 Apple、22% / $33B）；（4）⭐ NVIDIA Vera Rubin NVL72 採 TSMC N3 + CoWoS-L 封裝、首度搭載 8 層 HBM4；（5）⭐ TSMC 2nm 已量產、nanosheet GAA、初期良率 70-80% 領先全球、年底月產能目標 100K 片、2nm 至 2028 CAGR +70%；（6）📦 CoWoS 封裝瓶頸續為產業關鍵、TSMC 規劃自 2024 底 ~35K wpm 擴至 2026 底 ~130K wpm、5.5 倍光罩封裝良率 >98%；（7）🤝 SK 海力士-TSMC 深化 HBM4 合作（基底晶粒+先進邏輯製程+客製 AI 記憶體）；（8）4 大美國 CSP 2026 AI CapEx 合計 $725B（+77% YoY）；（9）⭐ 5 月營收 NT$4,169.75 億 +30.1% 創單月新高、1-5 月累計 NT$1.96 兆；（10）2026 全球半導體市場估 +25% YoY 達 ~$975B。⚠️ 短期下行風險：（1）⚠️ 估值警示——TSM P/E 32.8x、台股 P/E ~35x，留意賣壓與台幣升值；（2）競爭雜訊——Google 向 Intel Foundry 下單逾 300 萬顆自研 TPU（2028 交付）、Samsung 推進 HPB 封裝對標、擴 HBM 後段產能；（3）台幣升值壓力（每升 1% 毛利率 -40bps）；（4）端午連假（6/19 休市）期間美股變數。基本面未變：Q1 2026 淨利 NT$572.5B（$18.2B、+58.3% YoY）、毛利率 66.2% 雙創史高；2025 全年 EPS NT$66.25。技術面（基於 6/18 估收 NT$2,385）：5MA NT$2,355 / 20MA NT$2,335 / 60MA NT$2,315 / 120MA NT$2,210；下方支撐 NT$2,360 / NT$2,310 / NT$2,300 心理整數；上方壓力 NT$2,400 整數 / NT$2,425 / NT$2,440（史高）。32 位分析師全數看多、平均目標 NT$2,530 上行空間 +6.08%（自 NT$2,385）。",
    # 重大警示（選填，空白則不顯示）
    "risk_alert":  "今日（6/18 Thu）關鍵觀察：（1）📈 NYSE TSM 6/17 Wed 收 $432.15（+1.48%）、自 6/16 -3.53% 回檔後低接回補、市值 $1.96 兆；（2）📈 台股 2330 6/18 跟進 ADR 反彈估收 NT$2,385（+0.42%）、市值回升 NT$61.9 兆；（3）🛰️ SpaceX 創紀錄 IPO（估值 $2.519 兆）市值超越 TSMC（$2.289 兆）、將台積電擠至全球市值第 7（屬外部排名變動、基本面未受影響）；（4）🤝 TSMC-Amkor 簽 10 年美國先進封裝長約（Peoria AZ $70 億、2028 投產、~2,000 就業、呼應 $165B 美國投資）；（5）🤝 SK 海力士-TSMC 深化 HBM4 合作（基底晶粒+先進邏輯製程+客製 AI 記憶體）；（6）💰 TSMC CFO 重申先進製程漲價勢在必行——3nm H2 漲 ~15%、sub-5nm 漲 5-10%；CEO Wei 重申供應數年落後 AI 需求、Arizona 訂單滿至 2027；（7）🏆 NVIDIA 確認 TSMC 第 1 大客戶；Vera Rubin NVL72 採 N3 + CoWoS-L + 8 層 HBM4；（8）📦 CoWoS 瓶頸續為產業關鍵、TSMC 2026 底擴至 ~130K wpm、5.5 倍光罩封裝良率 >98%；（9）⚠️ 競爭雜訊：Google 向 Intel Foundry 下單逾 300 萬顆 TPU（2028）、Samsung 推進 HPB 封裝；（10）⭐ 5 月營收 NT$4,169.75 億 +30.1% 創單月新高；（11）⭐ 2nm 量產良率 70-80% 領先全球；（12）⭐ 4 大美國 CSP 2026 AI CapEx 合計 $725B（+77% YoY）；（13）⚠️ 估值警示：TSM P/E 32.8x、台股 P/E ~35x、留意台幣升值；（14）📊 台美 ADR 溢價 +12.52%；（15）⚠️ 6/19 Fri 端午節 TWSE 休市、6/18 為連假前最後交易日、留意連假美股變數；32 位分析師全數看多、平均目標 NT$2,530 上行空間 +6.08%；本日（6/18）關鍵：台股反彈後能否站穩 NT$2,375 / 挑戰 NT$2,400；下方支撐 NT$2,360 / NT$2,310 / NT$2,300 心理整數",
}

# 三大法人買賣超（張）— 最新一日
INSTITUTIONAL = {
    "date":     "2026-06-18",       # 最新資料日（6/16 Tue 實際外資小賣 -382、投信 +3,849、自營 -158、三大法人 +3,309；6/17-6/18 為估算、官方盤後公布）
    "foreign":  +6000,              # 外資 6/18 估轉買超（隨股價 +0.42% 跟進 ADR +1.48% 反彈、低接回補；待官方確認）
    "trust":    +800,               # 投信 6/18 估續買 +800 張
    "dealer":   +300,               # 自營商 6/18 估轉小買 +300 張
    # 近5日（由舊到新：6/12, 6/15, 6/16, 6/17, 6/18）；6/12-6/16 含實際、6/17-6/18 為估算
    "foreign_5d": [+3927, +5000, -382, -7500, +6000],        # 外資 6/12 實際 +3,927、6/16 實際 -382、6/18 估隨 ADR 反彈轉買
    "trust_5d":   [-149, +1000, +3849, +500, +800],          # 投信 6/12 實際 -149、6/16 實際 +3,849、6/18 估續買
    "dealer_5d":  [-181, +500, -158, -300, +300],            # 自營 6/12 實際 -181、6/16 實際 -158、6/18 估轉小買
    "foreign_ownership_pct": "74.9%",  # 外資持股比例（反彈後 6/18 估回升至 74.9%）
    "foreign_ownership_shares": "約 194.2 億股",
}

# 技術分析指標（需每日從看盤軟體更新）
TECHNICAL = {
    "rsi_14":       58.0,   "rsi_signal": "RSI 估自 55 回升至 58（台股 6/18 +0.42%、NYSE 6/17 +1.48% 反彈），自中性區回升、多方動能回溫、未過熱",
    "macd":         0.25,  "macd_signal": "MACD 估自 +0.20 回升至 +0.25、紅柱止縮微張、續守零軸上方、動能回穩",   "macd_color": "#4CAF50",
    "kdj_k":        66.0,   "kdj_d": 64.0, "kdj_j": 70.0, "kdj_signal": "KDJ K(66)/D(64)/J(70) J 自 50 回升至 70、低檔金叉浮現、短線轉強；留意 J 接近高檔",
    "ma5":       "2,355",   # 5MA（6/12 2310, 6/15 ~2350, 6/16 2375, 6/17 2360, 6/18 2385）— 基於 6/18 估收
    "ma20":      "2,335",   # 20MA 走平翻揚
    "ma60":      "2,315",   # 60MA 緩升
    "ma120":     "2,210",
    "bb_upper":  "2,470",   # 布林上軌
    "bb_mid":    "2,335",   # 布林中軌（20MA）
    "bb_lower":  "2,200",   # 布林下軌
    "vol_ma5":  "47,000",   # 5日均量（張，估、基於 6/12-6/18 五日均）
    "trend":    "📈 台美雙市同步反彈：NYSE TSM 6/17 Wed 收 $432.15（+$6.32、+1.48% vs 6/16 $425.83）自 6/16 -3.53% 回檔後低接回補、市值 $1.96 兆；台股 2330 6/18 跟進 ADR 反彈估收 NT$2,385（+10、+0.42% vs 6/17 NT$2,375）、市值回升 NT$61.9 兆。🛰️ SpaceX 創紀錄 IPO 將 TSMC 擠至全球市值第 7（屬外部排名變動）。🤝 重大合作：TSMC-Amkor 簽 10 年美國先進封裝長約（6/16 公告）。📊 技術面（基於 6/18 估收 NT$2,385）：RSI 58 自中性回升、MACD +0.25 紅柱止縮微張、KDJ J(70) 自 50 回升低檔金叉浮現、短期 5MA NT$2,355 站上、20MA NT$2,335 翻揚、中期 60MA/120MA 趨勢偏多。下一觀察：（1）📈 反彈後能否站穩 NT$2,375 / 挑戰 NT$2,400；（2）下方支撐 NT$2,360 / NT$2,310 / NT$2,300 心理整數；（3）上方壓力 NT$2,400 / NT$2,425 / NT$2,440 史高；（4）⚠️ 6/19 Fri 端午節 TWSE 休市、留意連假美股變數；（5）⭐ 中長線結構性利多基底未變：TSMC-Amkor 美國封裝長約 + SK 海力士 HBM4 合作 + CFO 確認 3nm H2 漲 ~15% + CEO Wei 重申供應數年落後需求 + 2026 >30% 成長 + 2nm 量產 70-80% 良率 + CoWoS 2026 底擴至 ~130K wpm；（6）⚠️ 競爭雜訊：Google 向 Intel Foundry 下單逾 300 萬顆 TPU、Samsung 推進 HPB 封裝。",
    "support":  "2,360 / 2,310 / 2,300 / 2,250 (6/17 收、前低、心理整數、前低)",
    "resist":   "2,400 / 2,425 / 2,440 / 2,470 (整數、6/3 收、6/3 史高、布林上軌)",
    "note": "技術指標數值為估算（基於 6/18 估收 NT$2,385），請以看盤軟體即時數據為準；台股 6/18 跟進 NYSE 6/17 +1.48% 反彈、KDJ J 自 50 回升至 70 低檔金叉浮現、MACD 紅柱止縮微張動能回穩；NT$2,360 為關鍵支撐、上方壓力 NT$2,400 / NT$2,425 / NT$2,440 史高；6/19 端午節休市、留意連假變數",
}

# 期貨與選擇權（來源：台灣期交所 TAIFEX）
DERIVATIVES = {
    "date":          "2026-06-18",       # 最新資料日（6/18 Thu 收盤估）
    "futures_price": "2,382",            # 台積電期貨近月（6/18 收盤附近）
    "futures_oi":    "168,000",          # 未平倉量（口）（6/18 估、連假前減倉）
    "futures_basis": "-3",               # 6/18 估小幅逆價差（連假前整理）
    "call_oi":       "108,000",
    "put_oi":        "75,000",
    "pcr":           "0.69",             # Put/Call 比率（6/18 估自 0.75 回落至 0.69、反彈後偏多）
    "pcr_signal":    "中性偏多（Put/Call 6/18 估回落至 0.69、自 6/17 0.75 減少；反映台美雙市反彈後市場情緒回溫、惟端午連假前避險需求仍在）",
    "max_pain":      "2,360",            # 最大痛苦價格（近期到期、6/18 估）
    "key_strikes": [
        ("2,250", "Call 34,000 / Put 22,000", "前低、心理整數"),
        ("2,300", "Call 48,000 / Put 15,500", "心理整數關鍵支撐"),
        ("2,360", "Call 55,000 / Put 11,000", "6/17 收、最大痛苦"),
        ("2,385", "Call 53,000 / Put 9,000",  "6/18 估收"),
        ("2,400", "Call 51,000 / Put 7,500",  "心理整數"),
        ("2,425", "Call 47,000 / Put 5,800",  "6/3 收"),
        ("2,440", "Call 44,000 / Put 4,800",  "6/3 史高"),
    ],
    "note": "衍生品數據需每日至台灣期交所(taifex.com.tw)更新；6/18 PCR 自 0.75 回落至 0.69 反映台美雙市反彈後市場情緒回溫、最大痛苦價上移至 NT$2,360；NT$2,360 為關鍵支撐、上方壓力 NT$2,400 / NT$2,425 / NT$2,440 史高；⚠️ 6/19 Fri 端午節 TWSE 休市；中長線結構性利多基底未變（TSMC-Amkor 美國封裝長約、SK 海力士 HBM4 合作、CFO 確認 3nm H2 漲 ~15%、CEO Wei 重申供應數年落後需求、2nm 量產 70-80% 良率、NVIDIA 確認第 1 大客戶 + Vera Rubin NVL72 採 N3+CoWoS-L、CoWoS 2026 底擴至 ~130K wpm、4 大 CSP CapEx $725B）",
}

# 供應鏈與客戶股價（需每日更新）
ECOSYSTEM_STOCKS = [
    # 類別、股票代碼、名稱、收盤價、漲跌幅、備註（美股為 2026-06-17 Wed 收盤、台股為 6/18 Thu 收盤；價格為估算）
    ("設備", "ASML",    "艾司摩爾",    "838.00", "+1.45%", "EUV 設備龍頭（6/17 跟進半導體類股反彈；高 NA EUV 需求結構性多頭未變）"),
    ("設備", "AMAT",    "應用材料",    "505.00", "+1.61%", "⭐ 6/17 反彈；TSMC EPIC Center $5B AI 合作 + 先進封裝設備需求結構性多頭"),
    ("設備", "LRCX",    "科林研發",    "1,010.00", "+1.61%", "蝕刻設備（6/17 反彈；半導體設備需求創紀錄）"),
    ("設備", "KLAC",    "科磊",        "761.00", "+1.60%", "量測設備（6/17 反彈；2nm 量產驅動）"),
    ("記憶", "000660.KS","SK 海力士",  "378,000 KRW", "+1.07%", "🤝 SK 海力士-TSMC 深化 HBM4 合作（基底晶粒+先進邏輯製程+客製 AI 記憶體）；HBM4 需求結構性多頭"),
    ("記憶", "MU",      "美光",        "149.00", "+1.71%", "HBM / DDR5（6/17 反彈；HBM4 需求強勁）"),
    ("封裝", "3711.TW", "日月光",      "308",    "+1.65%", "CoWoS / 先進封裝（6/18 跟進台股 2330 反彈；先進封裝瓶頸結構受惠）"),
    ("封裝", "AMKR",    "Amkor",       "43.50",  "+3.57%", "🤝 續強：TSMC-Amkor 簽 10 年美國封裝長約、Peoria AZ $70 億 2028 投產、就近承接 Arizona 廠封測"),
    ("客戶", "NVDA",    "輝達",        "257.00", "+2.59%", "🏆 確認 TSMC #1 客戶 22%（6/17 反彈；Vera Rubin NVL72 採 N3+CoWoS-L+8 層 HBM4）"),
    ("客戶", "AAPL",    "蘋果",        "293.50", "+0.69%", "⚠️ #2 客戶 18%（6/17 小漲；持續取得先進製程優先產能）"),
    ("客戶", "AVGO",    "博通",        "461.00", "+1.54%", "🔄 #3 客戶（6/17 反彈；Q2 FY26 營收 +48%；custom XPU 強勁）"),
    ("客戶", "AMD",     "超微",        "505.00", "+1.61%", "#4 客戶（6/17 反彈；MI350/MI450 資料中心 GPU 持續搶市；EPYC Venice 採 2nm）"),
    ("客戶", "2454.TW", "聯發科",      "4,605",  "+1.10%", "手機 SoC 客戶 9%；6/18 跟進台股半導體類股反彈；RTX Spark 由聯發科協同 NVIDIA 設計"),
    ("競爭", "INTC",    "英特爾",      "43.60",  "+1.16%", "🚀 走強：Google 下單逾 300 萬顆自研 TPU 予 Intel Foundry（2028 交付）；Intel CEO 仍確認 TSMC「長期信任夥伴」"),
    ("競爭", "005930.KS","三星電子",   "63,500 KRW", "+0.79%", "Samsung Foundry 6/17 小漲；推進 HPB 封裝對標 TSMC、擴 HBM 後段產能；HBM4E NVIDIA 送樣中"),
    ("處分後", "ARM",   "Arm Holdings","249.50", "+1.42%", "TSMC 4/29 全數出脫後（6/17 反彈；RTX Spark ARM 架構受惠）"),
]
...
CONSENSUS = {
    ...
    "upside":       "+6.08%",   # 從 NT$2,385（6/18 估收）到 NT$2,530
}
...
IR_CALENDAR = [
    ...
    ("2026-06-19", "🎌 端午節 TWSE 休市", "6/19 Fri 端午節台股休市；NYSE TSM 照常交易、連假期間美股變數待觀察",                                        "#FF9800"),
...
# 總體經濟監控
MACRO = [
    ("SOX 半導體指數",  "13,650.00","+2.71%", True),   # 6/17 SOX 反彈（估）、TSM +1.48% 跟漲
    ("台股加權指數",    "45,650.00","+0.15%", True),   # 6/18 實際 +68.2 點近平盤、半導體類股小幅回溫
    ("VIX 恐慌指數",    "17.2",    "-0.7",   True),    # 6/17 回落（估）；風險情緒回溫
    ("WTI 原油",        "$70.5",   "-0.42%", False),   # 油價小跌
    ("10Y 美債殖利率",  "4.46%",   "-0.02pp",False),   # 自 4.48% 微降
    ("台幣/美元",       "31.05",   "0.00",   False),   # 台幣持穩（每升值 1% 毛利率 -40bps）
    ("NVIDIA NVDA",     "$257.00", "+2.59%", True),    # #1 TSMC 客戶（22%），6/17 反彈 +2.59%
    ("ASML",            "$838.00", "+1.45%", True),    # 設備股 6/17 反彈 +1.45%
]
...
RELATIVE = {
    "date":           "2026-06-18",       # 最新資料日（6/18 Thu 台股收盤估；NYSE 為 6/17 收盤）
    "tsmc_tw_1d":     +0.42,   # 2330 6/18 實際收 NT$2,385（+10 vs 6/17 實際 NT$2,375；跟進 ADR 反彈、漲幅收斂）
    "taiex_1d":       +0.15,   # 加權指數 6/18 實際 +68.2 點近平盤
    "sox_1d":         +2.71,   # SOX 6/17 反彈（估）、TSM +1.48% 跟漲
    "tsmc_nyse_1d":   +1.48,   # TSM ADR 6/17 $432.15 (+$6.32 vs 6/16 $425.83；回檔後反彈)
    "tsmc_tw_5d":     +3.25,   # 5 日（NT$2,385 vs 6/11 NT$2,310）
    "taiex_5d":       +2.00,
    "tsmc_tw_1m":     +4.15,   # 月線（NT$2,385 vs NT$2,290 ~5/15）
    "taiex_1m":       +9.0,
    "tsmc_tw_ytd":    +13.84,  # YTD 累計（NT$2,385 vs 年初 ~NT$2,095）
    "taiex_ytd":      +13.5,
    "sox_ytd":        +70.0,   # SOX YTD（反彈後）
    "beta_60d":        1.38,   # 60 日滾動 Beta vs TAIEX
    # ADR 折溢價（以 6/17 NYSE 收盤 & 6/18 TW 收盤估計算）
    "adr_price":     432.15,   # TSM NYSE 6/17 實際收盤（+1.48%）
    "adr_parity":    384.06,   # 理論值 = 5 × NT$2,385 ÷ 31.05
    "adr_ratio":     "5:1",    # 1 ADR = 5 台積電普通股
    "usd_ntd":        31.05,   # 同 MACRO 台幣匯率
    "adr_premium_pct": "+12.52", # (432.15 - 384.06) / 384.06 × 100 = +12.52%
    "note": "ADR 理論值 = 5 × 台股收盤 ÷ 匯率（不含交易摩擦與流動性溢價）。📈 NYSE TSM 6/17 Wed 收 $432.15（+$6.32、+1.48% vs 6/16 $425.83、成交量 1,096 萬股、P/E 32.79），自 6/16 -3.53% 回檔後低接買盤回補、盤中觸 $439.60、市值 $1.96 兆；台股 2330 6/18 Thu 跟進 ADR 反彈估收 NT$2,385（+10、+0.42% vs 6/17 NT$2,375）、市值回升 NT$61.9 兆。✅ 籌碼面回溫：6/18 估外資轉買超 +6,000 張、三大法人估買超（待官方確認）。📊 台美 ADR 溢價以 6/17 ADR + 6/18 台股估計算為 +12.52%；🎯 今日（6/18 Thu）短線關鍵：台股反彈後能否站穩 NT$2,375 / 挑戰 NT$2,400、外資買盤是否延續；⚠️ 6/19 Fri 端午節 TWSE 休市、留意連假美股變數；🛰️ SpaceX 創紀錄 IPO 將 TSMC 擠至全球市值第 7（屬外部排名變動、基本面未受影響）；⭐ 中長線結構性基底未變：TSMC-Amkor 美國封裝長約 + SK 海力士 HBM4 合作 + CFO 確認 3nm H2 漲 ~15% + CEO Wei 重申供應數年落後需求 + 2nm 量產 70-80% 良率 + NVIDIA 確認第 1 大客戶/Vera Rubin NVL72 採 N3+CoWoS-L + CoWoS 2026 底擴至 ~130K wpm + 4 大 CSP CapEx $725B",
}
...
NEWS = [
    {
        ...
        "title": "🛰️ SpaceX 創紀錄 IPO 將 TSMC 擠至全球市值第 7；NYSE TSM 6/17 反彈 +1.48% 收 $432.15、台股 2330 6/18 跟進估收 NT$2,385（+0.42%）",
        "body": "TSMC 排名變動與股價反彈同步登場：（1）🛰️ SpaceX 完成史上最大規模 IPO——估值高達 $2.519 兆、募資約 $750 億、掛牌首日大漲 +19.6% 至 $192.50，市值超越 TSMC（$2.289 兆）、將台積電由全球第 6 擠至第 7 大市值企業；惟此屬外部排名變動、TSMC 營運與基本面完全未受影響；（2）📈 NYSE TSM 6/17 Wed 收 $432.15（+$6.32、+1.48% vs 6/16 $425.83，來源 stockanalysis.com、成交量 1,096 萬股、P/E 32.79、市值 $1.96 兆）、自 6/16 -3.53% 回檔後低接買盤回補、盤中一度觸 $439.60；（3）📈 台股 2330 6/18 Thu 跟進 ADR 反彈估收 NT$2,385（+10、+0.42% vs 6/17 NT$2,375）、市值回升 NT$61.9 兆（官方收盤以 TWSE 為準）；（4）半導體類股同步回溫——NVDA +2.59%、AMD +1.61%、ASML +1.45%、SOX +2.71%；（5）⚠️ 6/19 Fri 端午節 TWSE 休市、6/18 為連假前最後交易日、留意連假美股變數；（6）📊 台美 ADR 溢價（以 6/17 ADR $432.15 + 6/18 台股 NT$2,385 計）為 +12.52%。",
        "source": "Benzinga / stockanalysis.com / Yahoo Finance / TradingView 2026-06-17 - 06-18", "impact": "中性",
    },
    {
        "tag": "產業趨勢", "tag_color": "#4CAF50",
        "title": "🤝 TSMC-Amkor 簽 10 年美國先進封裝長約（6/16 公告）：Peoria AZ 廠投資 $20 億→$70 億、2028 投產、~2,000 就業",
        "body": "TSMC 與封測龍頭 Amkor Technology 6/16 正式公告長期合作、補強美國先進封裝產能拼圖：（1）🤝 雙方簽署為期 10 年的長期合作協議——Amkor 將於 Arizona 州 Peoria 廠就近承接 TSMC 亞利桑那晶圓廠產出的晶圓進行先進封裝（advanced packaging）與測試，技術涵蓋 Integrated Fan-Out（InFO）與 CoWoS；（2）💰 Amkor Peoria 廠投資自原規劃的 $20 億大幅擴大至 $70 億、預計 2028 投產、創造最多 2,000 個就業；（3）⭐ 戰略意涵：TSMC Arizona 廠主攻先進邏輯製程（N4/N3/N2），與 Amkor 的在地封測合作可在美國本土形成「晶圓製造→先進封裝→測試」迄今最完整的在地產業鏈、降低地緣與物流風險；（4）⭐ 呼應 TSMC $165B 美國投資承諾與美國半導體在地化政策、強化與美國客戶（NVIDIA/AMD/Apple）就近供應能力；（5）📦 產業背景：先進封裝為 AI/HPC 晶片瓶頸、TSMC CoWoS 規劃自 2024 底 ~35K wpm 擴至 2026 底 ~130K wpm、良率 >98%。",
        "source": "BusinessWire / TSMC PR / Amkor / SemiWiki / Cryptobriefing 2026-06-16", "impact": "正面",
    },
    {
        "tag": "客戶動態", "tag_color": "#2196F3",
        "title": "🏆 NVIDIA 確認 TSMC 第 1 大客戶（22%/$33B）；Vera Rubin NVL72 採 TSMC N3 + CoWoS-L、首度搭載 8 層 HBM4",
        "body": "NVIDIA 與 TSMC 雙向綁定持續深化、AI 訂單能見度延伸：（1）🏆 NVIDIA 確認超越 Apple 成為 TSMC 第 1 大客戶（22% / $33B），反映 AI 資料中心與 HPC 晶片需求爆發；Apple 維持第 2 大客戶並取得先進製程優先產能；（2）⭐ NVIDIA 次世代 Vera Rubin NVL72 平台採用 TSMC 第三代 3nm 製程與 CoWoS-L 封裝、並首度支援 8 層 HBM4 高頻寬記憶體、訓練效能 vs Blackwell +3.5 倍、推理 +5 倍；（3）⭐ NVIDIA 並發表 Vera CPU 與 RTX Spark「超晶片」（由 TSMC 代工）、切入 AI agent 與 Windows PC CPU 市場、挑戰 Intel/AMD；（4）⭐ NVIDIA-TSMC 將 AI 導入晶圓廠（cuLitho/cuEST/Omniverse FabTwin）提升良率、縮短製程開發、優化產能、直接緩解產能緊俏；（5）⭐ 其他客戶 AMD（MI350/MI450）、Broadcom（custom XPU、Q2 FY26 +48%）、Qualcomm、MediaTek 仍是重要需求來源。",
        "source": "CNBC / Tom's Hardware / NVIDIA / Dealroom 2026-06-15 - 06-17", "impact": "正面",
    },
    {
        "tag": "產業趨勢", "tag_color": "#4CAF50",
        "title": "🤝 SK 海力士-TSMC 深化 HBM4 合作：基底晶粒、先進邏輯製程、客製化 AI 記憶體；崔泰源 6/3 會魏哲家",
        "body": "AI 記憶體與邏輯整合生態進一步綁定、強化 TSMC 在 AI 供應鏈核心地位：（1）🤝 SK 海力士與 TSMC 規劃在 HBM4 基底晶粒（base die）、先進邏輯製程、客製化 AI 記憶體的合作——SK 集團會長崔泰源 6/3 於台灣會晤 TSMC 董事長魏哲家、交流次世代 AI 技術趨勢；（2）⭐ HBM4 的 base die 將採用先進邏輯製程（由 TSMC 代工），相較前代 HBM3E 大幅提升頻寬與能效，為 NVIDIA/AMD 次世代 AI 加速器關鍵元件；NVIDIA 對 HBM4 鎖定約 11 Gb/s pin speed、對記憶體廠良率為一大挑戰；（3）⭐ 產業背景：HBM 需求 2025 年增 +130%、2026 估再增 +70%，但 SK 海力士/Samsung/Micron 三強寡占 + 長資本支出週期使供應持續吃緊；（4）⭐ 對 TSMC 意涵：HBM4 base die 代工為先進邏輯製程新增量需求、鞏固「邏輯+先進封裝+HBM」一站式 AI 晶片整合優勢；（5）⚠️ 競爭：Samsung 同步擴 HBM 後段封裝產能對標。",
        "source": "DIGITIMES / SK hynix / SemiAnalysis / Korea media 2026-06-03 - 06-15", "impact": "正面",
    },
    {
        "tag": "產品發布", "tag_color": "#9C27B0",
        "title": "💰 TSMC CFO 重申先進製程漲價勢在必行：3nm H2 漲約 15%、sub-5nm 漲 5-10%；通膨 + AI 需求驅動",
        "body": "TSMC 管理層重申漲價訊號、強化毛利率展望：（1）💰 TSMC CFO 表示在通膨與 AI 強勁需求下、晶圓代工漲價幾乎勢在必行——最搶手的 3nm（N3）製程下半年漲幅約 15%、sub-5nm 製程漲 5-10%；（2）⭐ 漲價基礎：AI 晶片需求結構性強勁、3nm 產能短缺、上游成本上升、TSMC 在先進製程具技術代差與定價權；（3）⭐ 對毛利率意涵：漲價可抵銷海外擴廠（Arizona/熊本/德國）初期稀釋與台幣升值壓力、支撐毛利率維持 65-67% 高檔（Q1 2026 已達 66.2% 創史高）；（4）漲價對客戶（NVIDIA/Apple/AMD/Google）接受度高——AI 晶片佔客戶總成本比重低、TSMC 為唯一可靠先進產能來源；（5）⭐ 與 6/4 AGM CEO Wei 確認的「3nm H2 漲 15% + 2027 再漲 5-10%」計畫一致、定價權為 AI 結構性需求超供應的直接體現。",
        "source": "GuruFocus / Windows Central / Taipei Times 2026-06-15", "impact": "正面",
    },
    {
        "tag": "客戶動態", "tag_color": "#2196F3",
        "title": "⚠️ Google 向 Intel Foundry 下單逾 300 萬顆自研 TPU（2028 交付）；客戶分散雜訊浮現",
        "body": "AI 晶片代工版圖出現分散訊號、為 TSMC 中期觀察重點：（1）⚠️ 多家媒體報導 Google 已向 Intel Foundry 下單逾 300 萬顆自研 TPU、自 2028 年起交付——Intel 6/8 股價曾大漲逾 11%；（2）市場解讀為部分超大型客戶在 TSMC 產能緊俏下尋求第二供應來源、降低單一供應商集中度；（3）⚠️ 對 TSMC 短期意涵：若部分 TPU 產能轉至 Intel 18A/14A 製程，恐影響 TSMC 部分 ASIC 代工市占；（4）✅ 緩解因素：交付時點為 2028、TSMC 2nm/A16 屆時已量產、技術代差仍領先；Intel CEO 仍公開確認 TSMC 為「長期信任夥伴」、Intel 自身先進晶片仍委外 TSMC；（5）⭐ 結構觀點：AI 晶片總量持續爆發、先進封裝成為全產業瓶頸（2026 全球半導體市場估 +25% YoY 達 ~$975B），TSMC 整體先進製程與封裝需求仍遠超供給；（6）🎯 觀察：客戶自研 ASIC（Google TPU、Amazon Trainium、Meta MTIA）多數仍由 TSMC 代工，需追蹤訂單流向。",
        "source": "go markets / distill intelligence / Reuters 2026-06-08 - 06-15", "impact": "中性",
    },
]
