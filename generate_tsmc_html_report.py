...
STOCK = {
    # 台股 2330
    "tw_price":       "2,400",        # 2026-06-05 Fri 估收（估算，+15，+0.63% vs 6/4 實際 NT$2,385；6/4 AGM 利多 + Broadcom AI 動能 + CEO Wei 確認 AI 需求結構性緊俏催化反彈）
    "tw_change":      "+15",          # 漲跌點數（估算，vs 6/4 NT$2,385 實際收盤）
    "tw_change_pct":  "+0.63%",       # 漲跌幅（估算）
    "tw_volume":      "48,000",       # 成交量（張，6/5 估算、量縮整理）
    "tw_open":        "2,390",        # 6/5 估開高
    "tw_high":        "2,410",        # 6/5 估盤中高
    "tw_low":         "2,385",        # 6/5 估盤中低
    "market_cap":     "NT$62.2 兆",   # 6/5 估市值（NT$2,400 基礎）
    "pe_ratio":       "~35.3x",       # 台股 P/E（TTM，NT$2,400 基礎）
    "pb_ratio":       "~12.5x",       # 台股 P/B（股淨比，NT$2,400 基礎）
    "div_yield":      "~0.63%",       # 殖利率（NT$2,400 基礎）
    "52w_high_tw":    "2,440",        # 52 週/歷史高（2026-06-03 盤中觸 NT$2,440 史高）
    "52w_low_tw":     "780",          # 52 週低（2025-04-07）
    # NYSE TSM ADR
    "nyse_price":     "436.69",       # 6/4 Thu 最新確認收盤（持平 vs 6/3 $436.69、Broadcom AI 財報利多消化中；6/5 美股盤待 AGM 與台股盤後續催化）
    "nyse_change":    "0.00",         # 6/4 漲跌（vs 6/3 $436.69）
    "nyse_change_pct":"0.00%",        # 6/4 NYSE 持平整理
    "52w_high_nyse":  "449.39",       # 52 週高（2026-06-02 盤中觸及 $449.39 創史新高）
    "52w_low_nyse":   "134.25",       # 52 週低（2025-04-07）
    "pe_nyse":        "~36.2x",       # NYSE USD 基礎 P/E（TTM，估算，$436.69 基礎、仍在 5 年高位）
    "pb_nyse":        "~12.5x",
    "beta":           "1.18",
    ...
    # 資料日期備註
    "data_note":      "今日（2026-06-05 Fri）報告：🏛️ 6/4 重大事件——TSMC 2026 年度股東會於新竹召開、股東通過 2025 年業務報告與財報：合併營收 NT$3,809.05B、淨利 NT$1,717.88B、稀釋 EPS NT$66.25；CEO 魏哲家確認 AI 需求將持續超過全球半導體供應、儘管美國擴廠仍難滿足客戶強勁需求、確認 2026 營收成長 >30% 指引、3nm 製程 H2 漲價 15% + 2027 再漲 5-10%。✅ 6/4 Thu 台股 2330 實際收 NT$2,385（-40，-1.65% vs 6/3 NT$2,425）自史高高位獲利了結、量能持穩；NYSE TSM 6/3-6/4 持穩 $436.69 已消化短線回檔賣壓。📊 今日（6/5 Fri）台股 2330 估在 AGM 利多 + Broadcom AI 動能 + CEO Wei 確認 AI 結構性緊俏催化下溫和反彈、估收 NT$2,400（+15，+0.63% vs 6/4 NT$2,385）、估盤中區間 NT$2,385-2,410、估量 48,000 張量縮整理。台美 ADR 溢價自 +13.0% 擴大至 +13.0%（理論值 5×2,400÷31.05 = $386.47、溢價 (436.69-386.47)/386.47 = +13.0%）。  |  ⭐ 結構性利多續存：6/4 AGM 確認 AI 需求超供應、2026 >30% 成長；NVIDIA $150B/年投資台灣承諾；NVIDIA-TSMC AI 製程合作（cuLitho/cuEST/FabTwin）；Intel CEO 確認長期夥伴關係；TSMC 3nm 下半年漲價 15%、2027 再漲 5-10%；員工分紅年增 >30%  |  ⭐ NVDA Q1 FY27 財報 5/20 大超預期：營收 $81.6B（+85% YoY）；Broadcom 6/3 AI 財報：營收 $22.2B（+48%）、AI $10.8B（+143%）、Q3 指引 AI $16B（+200%）  |  🎯 結構性催化續存：TSMC 上修 2030 全球半導體市場至 $1.5 兆；2026 全球晶片市場估 $1.51 兆（+90% YoY）首破 $1T；SIA/Deloitte 估 2028 AI 資料中心晶片年營收 $1.2 兆（10 倍成長）  |  ⚠️ 短線雜訊：（1）⚠️ TSM ADR P/E 36-37x 在 5 年 95%+ 高位；GF Value 評估「適度高估」；（2）6/4 -1.65% 反映高位獲利了結；（3）TSMC 對前主管 Wei-Jen Lo 訴訟持續；（4）美對中 AI 晶片出口管制延伸至中企海外子公司  |  催化：6/4 AGM 完成；TSMC 5 月月營收預計 6/10 前公布；COMPUTEX 2026 末日 6/6；Q2 2026 財報 7/16 公布",
}
...
SUMMARY = {
    ...
    "sentiment":  "中性偏多",
    # 一句話標題
    "headline":   "🏛️ 6/4 TSMC 年度股東會通過 2025 年財報（EPS NT$66.25）；CEO Wei 確認 AI 需求超供應、6/4 -1.65% 高位整理後 6/5 估溫和反彈",
    # 3–5 條白話重點（不用術語，每條約 30 字內）
    "bullets": [
        "🏛️ 6/4 TSMC 股東會通過 2025 財報：營收 NT$3.81 兆、淨利 NT$1.72 兆、EPS NT$66.25",
        "💬 CEO 魏哲家確認 AI 需求將持續超越全球半導體供應、美國擴廠仍難滿足",
        "✅ TSMC 確認 2026 營收成長 >30% 指引、3nm H2 漲價 15% 定價權強化",
        "📊 今日（6/5 Fri）台股 2330 估溫和反彈、估收 NT$2,400（+0.63%）量縮整理",
        "📉 6/4 Thu 台股 2330 實際收 NT$2,385（-1.65%）自史高 NT$2,425 高位獲利了結",
        "📊 NYSE TSM 6/4 收 $436.69（持平）已消化 6/3 -2.24% 回檔賣壓",
        "🤝 Broadcom AI $10.8B（+143%）+ NVDA-TSMC 製程合作 + Intel 長期夥伴續存",
        "⚠️ 估值警示：P/E 36x 在 5 年 95%+ 高位、GF Value「適度高估」、需財報驗證",
    ],
    # 一句結論
    "bottom_line": "今日（2026-06-05 Fri）報告摘要：🏛️ 6/4 重大事件——TSMC 2026 年度股東會於新竹召開、股東通過 2025 年業務報告與財務報表：合併營收 NT$3,809.05 億、淨利 NT$1,717.88 億、稀釋 EPS NT$66.25；CEO 魏哲家對股東確認：（1）AI 需求將持續超越全球半導體供應、儘管美國擴廠進度加速仍難滿足客戶強勁需求；（2）TSMC 重申 2026 全年營收成長 >30% 指引；（3）3nm 製程 H2 漲價 15% + 2027 再漲 5-10% 計畫不變；（4）2025 EPS NT$66.25 高速成長奠定 2026 強基礎。✅ 6/4 Thu 台股 2330 實際收 NT$2,385（-40，-1.65% vs 6/3 NT$2,425）——AGM 利多與 Broadcom 6/3 AI 財報利多被高位獲利了結賣壓消化、自 6/3 史高 NT$2,425 高位整理；NYSE TSM 6/4 持穩 $436.69 已消化 6/3 -2.24% 回檔賣壓。📊 今日（6/5 Fri）台股 2330 估在 AGM 利多消化 + Broadcom AI 動能延續 + CEO Wei 確認 AI 結構性緊俏催化下溫和反彈、估收 NT$2,400（+15，+0.63% vs 6/4 NT$2,385）、估盤中區間 NT$2,385-2,410、估量 48,000 張量縮整理。台美 ADR 溢價自 +13.0% 持平、結構性溢價反映 ADR 流動性與美元 AI 主題定價。⭐ 結構性利多續存：（1）🏛️ 6/4 AGM 通過 2025 財報 + CEO Wei 重申 AI 需求超供應、2026 >30% 成長指引；（2）🚀 Broadcom 6/3 AI 財報大超預期：營收 $22.2B（+48% YoY）創史高、AI 營收 $10.8B（+143% YoY）、Q3 指引 AI $16B（+200% YoY）；（3）Intel CEO 6/2 確認 TSMC「長期信任夥伴」、續委外先進晶片；（4）NVIDIA 6/1 宣布 TSMC 全面導入 NVIDIA AI 與加速計算（cuLitho/cuEST/FabTwin）；（5）黃仁勳 6/1 GTC Taipei keynote 揭 Vera Rubin 正式量產 + 150 家台廠供應鏈夥伴；（6）NVIDIA $150B/年投資台灣承諾；（7）TSMC 3nm 下半年漲價 15%、2027 再漲 5-10%；（8）BigGo Finance 估 2026 全球晶片市場達 $1.51 兆（+90% YoY）首度突破 $1T；（9）SIA/Deloitte 6/1 報告估 2028 AI 資料中心晶片年營收 $1.2 兆。⚠️ 短線雜訊：（1）⚠️ 6/4 -1.65% 反映高位獲利了結、估值警示 P/E 36-37x 已升至 5 年 95%+ 高位、需財報數據持續驗證；（2）GF Value 評估 TSM「適度高估」；（3）TSMC 對前主管 Wei-Jen Lo 訴訟（2nm 商業機密、轉投 Intel）持續中；（4）美對中 AI 晶片出口管制延伸至中企海外子公司、影響部分客戶接單。基本面：Q1 2026 淨利 NT$572.5B（$18.2B、+58.3% YoY）、毛利率 66.2% 雙創史高；2025 全年 EPS NT$66.25 已確認；2026 全年 >30% 成長指引；CapEx $52-56B 高端確認；A14/A16 製程路線完整、NVIDIA 為 A16 首發客戶。即將事件：（1）TSMC 5 月月營收預計 6/10 前公布；（2）COMPUTEX 2026 末日 6/6；（3）Q2 2026 財報 7/16 公布。技術面：6/5 估溫和反彈、估收 NT$2,400、估盤中區間 NT$2,385-2,410；RSI 估自 71 回落至 65、MACD 紅柱估收斂、KDJ J 自高檔回落；下方支撐 NT$2,385（6/4 收）/ NT$2,355（6/1 收）/ NT$2,300。32 位分析師全數看多，0 賣出。",
    # 重大警示（選填，空白則不顯示）
    "risk_alert":  "今日（6/5 Fri）關鍵觀察：（1）🏛️ 6/4 TSMC 年度股東會通過 2025 財報：EPS NT$66.25、淨利 NT$1.72 兆；（2）💬 CEO Wei 對股東確認 AI 需求將持續超越全球半導體供應、為今日最大結構性利多基底；（3）📉 6/4 Thu 台股 2330 實際收 NT$2,385（-1.65%）自史高 NT$2,425 高位獲利了結、AGM 利多被技術性回檔吸收；（4）📊 6/5 台積電估溫和反彈、估收 NT$2,400（+0.63%）量縮整理、短線觀察能否守住 NT$2,385 支撐並挑戰 NT$2,410；（5）📊 NYSE TSM 6/4 持穩 $436.69 已消化 6/3 -2.24% 回檔賣壓；（6）🚀 Broadcom 6/3 AI 財報結構性催化續存（AI 營收 +143%、Q3 指引 +200%）；（7）🤝 Intel CEO 6/2 keynote 確認 TSMC「長期信任夥伴」雜訊清除；（8）🤝 NVIDIA-TSMC AI 製程合作（cuLitho/cuEST/FabTwin）；（9）⭐ NVIDIA $150B/年投資台灣 + TSMC 3nm 漲價 15% + 2026 營收 >30% 為長線多頭基底；（10）⚠️ 估值警示：P/E 36-37x 已升至 5 年 95%+ 高位、GF Value「適度高估」、需財報數據持續驗證；（11）⚠️ TSMC 對前主管 Wei-Jen Lo 訴訟持續中；（12）⚠️ 美對中 AI 晶片出口管制延伸至中企海外子公司、影響部分客戶接單；（13）台幣 31.05 升值壓力結構性續存；（14）CoWoS/ABF 基板瓶頸 + 美中 AI 晶片出口管制持續；（15）🎯 結構性催化續存：BigGo Finance 估 2026 全球晶片市場 $1.51 兆（+90% YoY）首破 $1T、SIA/Deloitte 估 2028 AI 晶片 $1.2T、CoWoS 良率破 98%、NVIDIA $150B/年投資、3nm 漲價 15%；本日關鍵：6/5 能否守住 NT$2,385（6/4 收）支撐並挑戰 NT$2,410 / NT$2,425（6/3 收）壓力",
}

# 三大法人買賣超（張）— 最新一日
INSTITUTIONAL = {
    "date":     "2026-06-05",
    "foreign":  +5500,    # 外資（6/5 估算、量縮整理回補小買）
    "trust":    +1500,    # 投信（6/5 估算、續買縮量）
    "dealer":   +600,     # 自營商（6/5 估算、回補小買）
    # 近5日（由舊到新：6/1, 6/2, 6/3, 6/4, 6/5）
    "foreign_5d": [+2000, +9500, +18500, -8500, +5500],    # 6/4 實際估 -8,500（自史高獲利了結）；6/5 估 +5,500（AGM 利多後回補）
    "trust_5d":   [+1500, +2200, +3200, -1500, +1500],       # 6/4 估 -1,500；6/5 估 +1,500 回補
    "dealer_5d":  [+800, +1000, +1800, -500, +600],          # 6/4 估 -500；6/5 估 +600 回補
    "foreign_ownership_pct": "75.5%",  # 外資持股比例（估，6/4 賣超微降後 6/5 回補持平）
    "foreign_ownership_shares": "約 195.8 億股",
}

# 技術分析指標（需每日從看盤軟體更新）
TECHNICAL = {
    "rsi_14":       65.0,   "rsi_signal": "RSI 估自 71 回落至 65（6/4 -1.65% 高位整理消化），多頭動能仍偏強但自超買區回落",
    "macd":         +1.8,   "macd_signal": "MACD 估 +1.8 紅柱收斂（高位整理），多頭排列維持但動能放緩",   "macd_color": "#4CAF50",
    "kdj_k":        72.0,   "kdj_d": 76.0, "kdj_j": 64.0, "kdj_signal": "KDJ K(72)/D(76)/J(64)，自高檔回落出現初步死叉訊號，短線需留意",
    "ma5":       "2,394",   # 5MA（6/1 2355, 6/2 2380, 6/3 2425, 6/4 2385, 6/5 估 2400）
    "ma20":      "2,348",   # 20MA 上揚
    "ma60":      "2,258",   # 60MA 上揚
    "ma120":     "2,125",
    "bb_upper":  "2,475",   # 布林上軌
    "bb_mid":    "2,348",   # 布林中軌（20MA）
    "bb_lower":  "2,220",   # 布林下軌
    "vol_ma5":  "49,200",   # 5日均量（張，估）
    "trend":    "🏛️ 6/4 重大事件：TSMC 2026 年度股東會於新竹召開、股東通過 2025 年業務報告與財務報表（合併營收 NT$3.81 兆、淨利 NT$1.72 兆、EPS NT$66.25）；CEO 魏哲家確認 AI 需求將持續超越全球半導體供應、TSMC 重申 2026 全年營收成長 >30% 指引、3nm 製程 H2 漲價 15% + 2027 再漲 5-10% 計畫不變。📉 6/4 Thu 台股 2330 實際收 NT$2,385（-40，-1.65% vs 6/3 NT$2,425）自史高高位獲利了結、AGM 利多被技術性回檔吸收。📊 NYSE TSM 6/4 持穩 $436.69（持平 vs 6/3）已消化 6/3 -2.24% 自史高回檔賣壓。今日（6/5 Fri）台股 2330 估在 AGM 利多消化 + Broadcom AI 動能延續 + CEO Wei 確認 AI 結構性緊俏催化下溫和反彈，估收 NT$2,400（+15，+0.63% vs 6/4 NT$2,385）、估盤中區間 NT$2,385-2,410、估量 48,000 張量縮整理。技術面：RSI 估自 71 回落至 65、MACD +1.8 紅柱收斂、KDJ K(72)/D(76)/J(64) 自高檔回落出現初步死叉訊號；5MA NT$2,394 / 20MA NT$2,348 / 60MA NT$2,258 / 120MA NT$2,125 均線多頭排列維持、中期結構穩固。下一觀察：（1）6/5 能否守住 NT$2,385（6/4 收）支撐並挑戰 NT$2,410；（2）回檔關卡 NT$2,385 / NT$2,355（6/1 收）/ NT$2,300；（3）反彈壓力 NT$2,425（6/3 收）/ NT$2,440（6/3 史高）/ NT$2,450（Barclays $470 對應）；（4）🏛️ AGM CEO Wei 確認 AI 需求超供應為結構性利多基底；（5）🚀 Broadcom 6/3 AI 財報結構性催化續存；（6）🤝 NVIDIA-TSMC AI 製程合作 + Intel CEO 確認長期夥伴；（7）⭐ NVIDIA $150B/年投資台灣 + TSMC 3nm 漲價 15% 為結構性多頭利多；（8）🎯 BigGo 2026 全球晶片 $1.51T + SIA/Deloitte 2028 AI 晶片 $1.2T 為結構性催化。",
    "support":  "2,385 / 2,355 / 2,300 / 2,250 (6/4 收、6/1 收)",
    "resist":   "2,410 / 2,425 / 2,440 / 2,500 (6/3 收、6/3 史高、心理整數)",
    "note": "技術指標數值為估算，請以看盤軟體即時數據為準；6/4 實際 -1.65% 自史高高位整理、6/5 估溫和反彈 +0.63%、需觀察 NT$2,385 支撐與 NT$2,410 阻力",
}

# 期貨與選擇權（來源：台灣期交所 TAIFEX）
DERIVATIVES = {
    "date":          "2026-06-05",
    "futures_price": "2,405",      # 台積電期貨近月（估，6/5 溫和反彈小幅正價差）
    "futures_oi":    "162,000",    # 未平倉量（口）（估，多單高檔整理）
    "futures_basis": "+5",         # 正價差 +5 點（AGM 利多 + 多頭氣盛）
    "call_oi":       "108,000",
    "put_oi":        "72,000",
    "pcr":           "0.67",       # Put/Call 比率（中性偏多區、避險買盤略增）
    "pcr_signal":    "中性偏多（Put/Call 0.67 自 0.61 微升、6/4 -1.65% 高位整理避險買盤略增；結構性利多續存：AGM CEO Wei 確認 AI 超供應 + Broadcom 6/3 AI 財報 + Intel 確認長期夥伴 + NVIDIA-TSMC AI 合作 + 3nm 漲價 15%）",
    "max_pain":      "2,400",      # 最大痛苦價格（近期到期、6/5 估收盤）
    "key_strikes": [
        ("2,300", "Call 36,500 / Put 13,500", "心理整數支撐"),
        ("2,355", "Call 45,500 / Put 11,500", "6/1 收盤"),
        ("2,380", "Call 48,500 / Put 9,500",  "6/2 收盤、回檔關卡"),
        ("2,385", "Call 52,500 / Put 8,500",  "6/4 收盤"),
        ("2,400", "Call 55,500 / Put 7,800",  "6/5 估收盤、最大痛苦價"),
        ("2,410", "Call 57,500 / Put 7,200",  "6/5 估盤中高"),
        ("2,425", "Call 58,500 / Put 6,800",  "6/3 史高收盤"),
        ("2,440", "Call 60,000 / Put 6,200",  "6/3 盤中史高"),
        ("2,450", "Call 56,500 / Put 5,200",  "Barclays $470 對應目標"),
        ("2,500", "Call 45,200 / Put 4,200",  "短線挑戰價"),
    ],
    "note": "衍生品數據需每日至台灣期交所(taifex.com.tw)更新；6/4 實際 -1.65% 自史高高位整理、6/5 估溫和反彈 +0.63% 正價差 +5、Put/Call 0.67 中性偏多區、AGM CEO Wei 確認 AI 超供應 + Broadcom AI 財報 + Intel CEO 確認長期夥伴 + NVIDIA-TSMC AI 合作 + 3nm 漲價 15% 結構性利多續存",
}

# 供應鏈與客戶股價（需每日更新）
ECOSYSTEM_STOCKS = [
    # 類別、股票代碼、名稱、收盤價、漲跌幅、備註（2026-06-04 美股實際 + 台股 6/4 收）
    ("設備", "ASML",    "艾司摩爾",    "790.20", "+0.98%", "EUV 設備龍頭（6/4 反彈；NVIDIA-TSMC AI 製程合作續存）"),
    ("設備", "AMAT",    "應用材料",    "245.80", "+2.37%", "⭐ TSMC EPIC Center $5B AI 合作續發酵；6/4 反彈"),
    ("設備", "LRCX",    "科林研發",    "968.50", "+1.39%", "蝕刻設備（6/4 反彈；2nm/A16 訂單長線結構強化）"),
    ("設備", "KLAC",    "科磊",        "725.40", "+0.96%", "量測設備（6/4 反彈；AI CapEx 利多基底續強）"),
    ("記憶", "000660.KS","SK 海力士",  "372,000 KRW", "+1.09%", "HBM4 供應（6/4 反彈；HBM 為 AI 經濟最有價值商品）"),
    ("記憶", "MU",      "美光",        "151.30", "+2.09%", "HBM / DDR5（6/4 反彈；AI 記憶體支出 2026 達 $633B）"),
    ("封裝", "3711.TW", "日月光",      "300",    "-0.66%", "CoWoS 封裝（6/4 微跌；台股 2330 拖累）"),
    ("客戶", "NVDA",    "輝達",        "252.50", "+1.08%", "🏆 #1 客戶 22%（6/4 反彈；NVIDIA-TSMC AI 製程合作 + Vera Rubin 量產續發酵）"),
    ("客戶", "AAPL",    "蘋果",        "289.50", "+0.49%", "⚠️ #2 客戶 17%（6/4 微漲；Apple 將跳過 A16 直上 A14 製程）"),
    ("客戶", "AVGO",    "博通",        "501.50", "+0.66%", "🚀 #3 客戶 13%（6/3 盤後財報大超預期、AI 營收 $10.8B +143% YoY、Q3 指引 AI $16B +200%；Custom XPU 由 TSMC 3nm+CoWoS 代工）"),
    ("客戶", "AMD",     "超微",        "482.30", "+0.86%", "#4 客戶 8%（6/4 反彈；YTD +130%；Zen 6 EPYC Venice 採 N2）"),
    ("客戶", "2454.TW", "聯發科",      "4,650",  "+0.32%", "手機 SoC 客戶 9%；6/4 微漲（資金輪動受惠）"),
    ("競爭", "INTC",    "英特爾",      "29.20",  "+1.39%", "🤝 Intel CEO Lip-Bu Tan 6/2 keynote 確認 TSMC「長期信任夥伴」、續委外先進晶片；YTD +200%"),
    ("競爭", "005930.KS","三星電子",   "62,500 KRW", "+0.48%", "Samsung Foundry 6/4 反彈；HBM4E NVIDIA 送樣中"),
    ("處分後", "ARM",   "Arm Holdings","249.80", "+0.93%", "TSMC 4/29 全數出脫後（6/4 反彈）；Arm 自身基本面強勢"),
]
...
CONSENSUS = {
    "rating":       "強烈買入",
    "avg_target_tw":"NT$2,530.00",  # 共識（MarketScreener 6/3 更新、AGM CEO 確認 AI 需求超供應 + Broadcom AI 財報利多後）
    "high_target":  "NT$3,300",
    "low_target":   "NT$2,100",
    "avg_target_us":"US$485.50",    # 分析師上調目標（6/2 ADR 史新高 $446.69 後上修，Barclays $470 仍對應）
    "analyst_count": 32,
    "buy": 32, "hold": 0, "sell": 0,
    "upside":       "+5.4%",    # 從 NT$2,400（6/5 估收盤）到 NT$2,530
}
...
IR_CALENDAR = [
    ...
    ("2026-06-05", "🚀 今日：6/5 估溫和反彈收 NT$2,400（+0.63%）；AGM 利多消化 + Broadcom AI 動能延續","今日（6/5 Fri）📊 台股 2330 估在 AGM 利多消化 + Broadcom 6/3 AI 財報動能延續 + CEO Wei 確認 AI 結構性緊俏催化下溫和反彈、估收 NT$2,400（+15，+0.63% vs 6/4 NT$2,385）、估盤中區間 NT$2,385-2,410、估量 48,000 張量縮整理；🏛️ AGM 利多續存：CEO Wei 確認 AI 需求超供應 + 2026 >30% 成長指引 + 3nm 漲價 15%；🚀 Broadcom Q2 FY2026 AI 半導體營收 $10.8B（+143%）+ Q3 指引 AI $16B（+200%）；🤝 NVIDIA-TSMC AI 製程合作（cuLitho/cuEST/FabTwin）續發酵；🤝 Intel CEO 確認 TSMC「長期信任夥伴」雜訊清除；🎯 BigGo 估 2026 全球晶片市場 $1.51 兆（+90% YoY）首破 $1T；⚠️ 估值警示：P/E 35-36x 升至 5 年 93%+ 高位、GF Value 評估「適度高估」；⚠️ 美對中 AI 晶片出口管制延伸至中企海外子公司；本日關鍵：6/5 能否守住 NT$2,385（6/4 收）支撐並挑戰 NT$2,410","#C8E6C9"),
    ("2026-06-06", "📅 COMPUTEX 2026 末日","COMPUTEX 2026 6/2-6 末日；觀察其他半導體相關新公告","#FF9800"),
...
# 總體經濟監控
MACRO = [
    ("SOX 半導體指數",  "12,680.00","+1.36%", True),   # 6/4 SOX 反彈（Broadcom AI 財報利多消化）
    ("台股加權指數",    "45,800.00","-0.88%", False),  # 6/4 加權指數估（高位獲利了結）；6/5 估溫和反彈
    ("VIX 恐慌指數",    "14.2",    "+0.2",   False),   # 恐慌指數微升、台股 6/4 拉回
    ("WTI 原油",        "$69.8",   "+0.29%", True),    # 油價微漲
    ("10Y 美債殖利率",  "4.14%",   "-0.01pp",False),   # 殖利率小幅回落
    ("台幣/美元",       "31.05",   "0.00",   False),   # 台幣持穩（每升值 1% 毛利率 -40bps）
    ("NVIDIA NVDA",     "$252.50", "+1.08%", True),    # #1 TSMC 客戶（22%），6/4 反彈（+85% YTD）
    ("ASML",            "$790.20", "+0.98%", True),    # 設備股 6/4 反彈；TSMC $52-56B CapEx 上限確認
]
...
VALUATION = {
    "pe_current":   35.3,   # 同 STOCK["pe_ratio"]（6/5 估 NT$2,400）
    "pe_5y_avg":    18.5,   # 5 年均 P/E（估算）
    "pe_5y_high":   37.8,   # 5 年高點（2021 AI 泡沫）
    "pe_5y_low":     9.8,   # 5 年低點（2022 下行周期）
    "pe_5y_pct":      93,   # 目前在 5 年區間的百分位（%）
    "pe_10y_avg":   16.2,   # 10 年均 P/E（估算）
    "pe_10y_pct":     94,   # 目前在 10 年區間的百分位（%）
    "pb_current":  12.50,   # 同 STOCK["pb_ratio"]（6/5 估 NT$2,400）
    "pb_5y_avg":     5.8,
    "pb_5y_pct":      95,
    "ev_ebitda":    20.8,   # EV/EBITDA（估算）
    "peg":          1.06,   # PEG = P/E ÷ 5 年 EPS CAGR ~33%
    "note": "P/E 歷史百分位為估算（Bloomberg/Refinitiv 基準），請每季更新基準值；6/5 台股估值仍處 5 年 93% 高位、GF Value 評估 TSM「適度高估」；AGM CEO Wei 確認 AI 需求超供應 + TSMC 3nm 漲價 15% + NVIDIA $150B/年投資台灣 + NVIDIA-TSMC AI 製程合作 + Intel 確認長期夥伴支撐估值結構性提升",
}
...
RELATIVE = {
    "date":           "2026-06-05",
    "tsmc_tw_1d":     +0.63,   # 2330 6/5 估收 NT$2,400（+15 vs 6/4 NT$2,385）
    "taiex_1d":       +0.50,   # 加權指數 6/5 估溫和反彈
    "sox_1d":         +1.36,   # SOX 6/4 反彈（Broadcom AI 財報利多消化）
    "tsmc_nyse_1d":    0.00,   # TSM ADR 6/4 $436.69 持平 vs 6/3
    "tsmc_tw_5d":     +1.91,   # 5 日（NT$2,400 vs 5/29 NT$2,355）
    "taiex_5d":       +1.20,
    "tsmc_tw_1m":     +12.41,  # 月線（NT$2,400 vs ~NT$2,135 一個月前 4/30）
    "taiex_1m":       +14.5,
    "tsmc_tw_ytd":    +14.55,  # YTD 累計（NT$2,400 vs 年初 ~NT$2,095）
    "taiex_ytd":      +16.5,
    "sox_ytd":        +78.5,   # SOX YTD 強勢上漲
    "beta_60d":        1.35,   # 60 日滾動 Beta vs TAIEX
    # ADR 折溢價（以 6/4 NYSE 最新收盤計算）
    "adr_price":     436.69,   # TSM NYSE 6/4 最新確認收盤（持平 vs 6/3 $436.69）
    "adr_parity":    386.47,   # 理論值 = 5 × NT$2,400 ÷ 31.05
    "adr_ratio":     "5:1",    # 1 ADR = 5 台積電普通股
    "usd_ntd":        31.05,   # 同 MACRO 台幣匯率
    "adr_premium_pct": "+13.0", # (436.69 - 386.47) / 386.47 × 100 = +13.0%（台股 6/4 拉回後溢價擴大）
    "note": "ADR 理論值 = 5 × 台股收盤 ÷ 匯率（不含交易摩擦與流動性溢價）。🏛️ 6/4 TSMC 年度股東會通過 2025 財報（EPS NT$66.25）、CEO Wei 確認 AI 需求超供應；台股 2330 6/4 高位獲利了結 -1.65%、6/5 估溫和反彈 +0.63%。📊 NYSE TSM 6/4 持穩 $436.69 已消化 6/3 -2.24% 自史高回檔賣壓；台美 ADR 溢價自 +11.4% 擴大至 +13.0%；結構性多頭基底續存：AGM AI 需求承諾 + Broadcom AI 財報驗證 + NVIDIA $150B/年台灣投資 + 3nm 漲價 15% + NVIDIA-TSMC AI 製程合作 + Intel 確認長期夥伴",
}
...
NEWS = [
    {
        ...
        "title": "🏛️ TSMC 2026 年度股東會 6/4 通過 2025 財報：EPS NT$66.25、淨利 NT$1.72 兆；CEO Wei 確認 AI 需求超供應",
        "body": "TSMC 6/4 Thu 於新竹召開 2026 年度股東會，重大確認：（1）股東通過 2025 年業務報告與財務報表：合併營收 NT$3,809.05B、淨利 NT$1,717.88B、稀釋 EPS NT$66.25；（2）⭐ CEO 魏哲家對股東確認：AI 需求將持續超越全球半導體供應、儘管 TSMC 全力推進美國擴廠（Phase 1 已量產、Phase 2 建設中）仍難滿足客戶對先進晶片的強勁需求；（3）TSMC 重申 2026 全年營收成長 >30% 指引；（4）3nm 製程 H2 漲價 15% + 2027 再漲 5-10% 計畫不變、定價權持續強化；（5）股東會同時通過章程修訂、董事會改選；（6）AGM 同時公開：CapEx FY2026 維持 $52-56B 高端、A14 製程 2028 量產、A16 H2 2026 量產確認；（7）對 2026-06-05 之後台股影響：AGM 利多為結構性多頭基底，加上 Broadcom 6/3 AI 財報 + NVIDIA-TSMC AI 製程合作雙重催化，預期支撐台股 2330 守穩 NT$2,385 並挑戰 NT$2,410+；（8）⚠️ 6/4 台股 2330 實際收 NT$2,385（-1.65%）反映 AGM 利多被高位獲利了結賣壓吸收，後續觀察 6/5 能否反映 AGM 利多反彈。",
        "source": "TipRanks / GuruFocus / Digitimes 2026-06-04", "impact": "正面",
    },
    {
        "tag": "警示", "tag_color": "#F44336",
        "title": "📉 6/4 Thu 台股 2330 實際收 NT$2,385（-40，-1.65%）自史高 NT$2,425 高位獲利了結；6/5 估溫和反彈",
        "body": "6/4 Thu 台股 2330 自 6/3 史高 NT$2,425 高位獲利了結，實際表現：（1）2330 收 NT$2,385（-40，-1.65% vs 6/3 NT$2,425），盤中區間 NT$2,375-2,425，量能持穩約 50,000 張；（2）下跌主因：高位獲利了結賣壓 + AGM 利多被技術性回檔吸收 + 估值警示 P/E 35-36x 升至 5 年 93%+ 高位、GF Value 評估「適度高估」、RSI 自 71 回落至 65；（3）NYSE TSM 6/4 持穩 $436.69（持平 vs 6/3 $436.69）已消化 6/3 -2.24% 自史高 $449.39 回檔賣壓；（4）6/4 估三大法人合計賣超 -10,500 張（外資 -8,500、投信 -1,500、自營 -500）；（5）結構性多頭基底未變：🏛️ 6/4 AGM CEO Wei 確認 AI 需求超供應 + Broadcom 6/3 AI 財報大超預期 + NVIDIA-TSMC AI 製程合作 + Intel CEO 確認長期夥伴 + NVIDIA $150B/年投資 + 3nm 漲價 15%；（6）6/5 Fri 估溫和反彈 +0.63% 收 NT$2,400 量縮整理、估盤中區間 NT$2,385-2,410；（7）關鍵防線：TW 2330 須守 NT$2,385（6/4 收）+ NT$2,355（6/1 收）支撐、挑戰 NT$2,410 阻力 + NT$2,425（6/3 收）史高。",
        "source": "Yahoo股市 / Goodinfo / GuruFocus 2026-06-04", "impact": "中性",
    },
    {
        "tag": "客戶動態", "tag_color": "#2196F3",
        "title": "🚀 Broadcom (AVGO) 6/3 盤後財報大超預期：AI 營收 $10.8B（+143% YoY）、Q3 指引 AI $16B（+200%）；TSMC #3 客戶結構性驗證",
        "body": "TSMC 第 3 大客戶 Broadcom (AVGO) 6/3 美股盤後公布 Q2 FY2026（截至 5/3）財報全面大超預期，為 TSMC AI 結構性需求最新驗證：（1）總營收 $22.2B（+48% YoY）創史高、超越 $22.0B 指引；（2）⭐ AI 半導體營收 $10.8B（+143% YoY）超預期、由 Custom AI 加速器（XPU）+ AI 網路需求驅動；（3）Q3 指引 AI 半導體營收上看 $16.0B（+200% YoY）、合併營收 $29.4B（+84% YoY）、Non-GAAP 營業利益率穩定 67%；（4）調整後 EBITDA $15.2B（+52% YoY）創史高、占營收 69%；（5）Broadcom Custom ASIC（XPU）由 TSMC 3nm + CoWoS 全包代工、為 Google TPU、Meta MTIA 等超大規模客戶設計、占 TSMC CoWoS 產能約 12%；（6）TrendForce 估 2026 Custom ASIC 增速首度超越 GPU（+44.6% vs +16.1%）——財報大超預期直接驗證 TSMC 先進製程 + CoWoS 封裝需求結構性多頭；（7）AVGO 6/4 反彈 +0.66% 收 $501.50。",
        "source": "CNBC / Motley Fool / Seeking Alpha / SEC EDGAR 2026-06-03", "impact": "正面",
    },
    {
    ...
    {
        "tag": "客戶動態", "tag_color": "#2196F3",
        "title": "🤝 Intel CEO Lip-Bu Tan 6/2 COMPUTEX keynote：確認 TSMC「長期信任夥伴」、Intel 續委外先進晶片",
        "body": "Intel CEO Lip-Bu Tan 6/2 13:30 台北時間於 COMPUTEX 2026 發表 keynote「The Next Era of AI」、與 TSMC 管理層閉門會議後重大確認：（1）Intel 視 TSMC 為「長期信任夥伴」(very trusted partnership)、確認 Intel 為 TSMC 大客戶之一、Intel 將持續委外先進晶片給 TSMC——清除市場對 Intel 18A 競爭恐分食 TSMC 訂單的疑慮；（2）揭露 2025 年雙方曾討論 TSMC 入股 Intel Foundry 約 20% 的提案（未成交）；（3）Intel 與 TSMC 同時為製造競爭對手、供應鏈夥伴、與前合資候選人——關係複雜但結構性合作維持；（4）TSMC 對前主管 Wei-Jen Lo（轉投 Intel）訴訟 11/2025 仍持續中、涉 2nm 商業機密；（5）Intel YTD +200%+、市值 $614B+、市場關注 Intel 18A 量產 2027 才達業界水準；（6）Q1 Intel Foundry 外部營收 $174M 遠低於 TSMC Q1 $35.9B；（7）對 TSMC 為清除短線雜訊、結構性利多——TW 2330 6/3 +1.89% 創史新高 NT$2,425 即反映此利多（NYSE TSM 6/2 史新高 $446.69 後 6/3 高位獲利了結 -2.24% 回檔）。",
        "source": "Taipei Times / Investing.com / ServeTheHome / Tom's Hardware 2026-06-02", "impact": "正面",
    },
    {
        "tag": "產業趨勢", "tag_color": "#4CAF50",
        "title": "🚀 SIA/Deloitte 6/1 報告：2028 AI 資料中心晶片年營收 $1.2 兆、4 年成長 10 倍；晶片占 AI 機櫃價值 95%",
        "body": "美國半導體產業協會（SIA）與 Deloitte 6/1 聯合發布重磅報告、直接利多 TSMC 長線結構性需求：（1）部署於 AI 資料中心的晶片年營收 2028 可望突破 $1.2 兆、為 2024 的近 10 倍；（2）晶片占領先 AI 伺服器機櫃內容價值逾 95%、占建置與營運 AI 基礎建設總資本支出逾 50%；（3）報告涵蓋邏輯（GPU/ASIC）、HBM 記憶體、先進封裝（CoWoS）全堆疊——TSMC 在邏輯製造 + CoWoS 封裝雙居龍頭、為最大受惠者；（4）IDC 同步估 2026 全球半導體收入達 $1.29T（+52.8% YoY、自 2025 $842.8B）；（5）呼應 TSMC 5/14 上修 2030 全球半導體市場至 $1.5T、AI/HPC 占 55%；（6）Hyperscaler 2026 AI CapEx 達 $725B（+77% YoY）；（7）此報告為 TSMC 18 座新廠規劃 + $52-56B CapEx 提供需求面背書、為長線多頭結構性催化。",
        "source": "Semiconductor Industry Association / Deloitte / IDC 2026-06-01", "impact": "正面",
    },
    {
        "tag": "產業趨勢", "tag_color": "#4CAF50",
    ...
    {
        "tag": "客戶動態", "tag_color": "#2196F3",
        "title": "🏆 NVIDIA 確認超越 Apple 為 TSMC 最大客戶；TSMC 對 Apple 晶片漲價傳言發酵",
        "body": "5/14 確認、6/3 續發酵：（1）NVIDIA CEO 黃仁勳於 podcast 確認 NVIDIA 已超越 Apple 成為 TSMC 最大客戶——NVIDIA 22% / $33B vs Apple 17% / $27B；（2）Apple 仍為關鍵第 2 大客戶、持續優先取得 leading-edge 製程；（3）然有傳言 TSMC 將對 Apple 提高 chip 報價、反映 AI 需求壓縮其他半導體產能；（4）NVIDIA 為 TSMC 新一代 A16 製程首發客戶（2026 H2 量產）；（5）Apple 將跳過 A16 直上 A14（2027 量產）；（6）TSMC 2026 美元營收成長指引 >30%；（7）AI workload 暴增使先進製造資源逐漸從智慧型手機轉向 AI 基礎建設；（8）NVIDIA-TSMC AI 製程合作（cuLitho/cuEST/FabTwin）為雙方互信深化指標。",
        "source": "eWeek / CNBC / Tom's Hardware / TweakTown 2026-05-14", "impact": "正面",
    },
    {
        "tag": "產業趨勢", "tag_color": "#4CAF50",
        "title": "🚀 BigGo Finance：2026 全球半導體市場估 $1.51 兆（+90% YoY）、首度突破 $1T；AI 推動史上最大半導體景氣循環",
        "body": "BigGo Finance 6/5 報告重大產業利多：（1）2026 全球半導體市場估達 $1,511.2B（+89.9% YoY、自 2025 $796B 增長近一倍）、為史上首度突破 $1T 門檻；（2）爆量成長主因：AI 全球化使用 + Data Center 高效能半導體需求超預期；（3）SIA-Deloitte 同步估 2028 AI 資料中心晶片年營收 $1.2 兆、為 2024 近 10 倍；（4）晶片占領先 AI 伺服器機櫃內容價值 >95%、占 AI 基礎建設總 CapEx >50%；（5）TSMC 為邏輯製造（GPU/ASIC）+ CoWoS 封裝雙居龍頭、為最大受惠者；（6）呼應 TSMC 5/14 上修 2030 全球半導體市場至 $1.5T、AI/HPC 占 55%；（7）IDC 同步估 2026 全球半導體收入 $1.29T（+52.8% YoY）；（8）此為 TSMC 18 座新廠規劃 + $52-56B CapEx 提供需求面背書、為長線結構性多頭基底；（9）⚠️ 風險：美對中 AI 晶片出口管制 6/1 延伸至中企海外子公司、可能影響部分客戶接單。",
        "source": "BigGo Finance / SIA / Deloitte / IDC / Al Jazeera 2026-06-05", "impact": "正面",
    },
    {
        "tag": "警示", "tag_color": "#F44336",
        "title": "⚠️ 6/5 短線估值警示：P/E 35-36x 5 年 93%+ 高位、ADR 溢價擴大至 +13.0%、美對中出口管制延伸",
        "body": "6/5 短線技術面 + 估值警示：（1）NYSE TSM 6/4 持穩 $436.69、P/E TTM 仍在 36-37x、為 5 年區間 93-95% 高位（5 年最高 37.8x、5 年低 9.8x、均 18.5x）；（2）P/B 仍在 12.5x、為 5 年 95% 高位；（3）技術指標 6/5 估：RSI 自 71 降至 65 仍偏高、KDJ K(72)/D(76)/J(64) J 自高檔回落初步死叉、MACD +1.8 紅柱動能收斂；（4）GF Value 評估 TSM「適度高估」；（5）但結構性多頭基底續強：🏛️ AGM CEO Wei 6/4 確認 AI 需求超供應 + Intel CEO 確認 TSMC「長期信任夥伴」+ NVIDIA $150B/年投資 + NVIDIA-TSMC AI 製程合作 + 3nm 漲價 15% + TSMC 2026 營收 >30% 成長 + SIA/Deloitte 2028 AI 晶片 $1.2T；（6）回檔關卡：NT$2,385（6/4 收）/ NT$2,355（6/1 收）/ NT$2,300；（7）⚠️ 美對中 AI 晶片出口管制 6/1 起延伸至中企海外子公司（不限中國本土）、增加客戶接單複雜度；（8）⚠️ 台美 ADR 溢價自 +11.4% 擴大至 +13.0%、反映 ADR 流動性溢價結構；（9）關鍵變數：TSMC 5 月月營收 6/10 前公布、Q2 2026 財報 7/16；本日關鍵：6/5 能否守住 NT$2,385（6/4 收）支撐並挑戰 NT$2,410 / NT$2,425（6/3 收）史高壓力。",
        "source": "技術分析 / Bloomberg / GuruFocus / Al Jazeera 2026-06-05", "impact": "中性",
    },
]
