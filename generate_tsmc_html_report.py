...
STOCK = {
    # 台股 2330
    "tw_price":       "2,305",        # 2026-06-08 Mon 實際收盤（-60，-2.54% vs 6/5 NT$2,365；今日 6/9 Tue 盤中、待盤後補實際資料）
    "tw_change":      "-60",          # 6/8 實際漲跌點數
    "tw_change_pct":  "-2.54%",       # 6/8 實際漲跌幅（跳空補跌反映 NYSE 6/5 -6.69% 崩跌）
    "tw_volume":      "~52,000",      # 6/8 估成交量（張，盤中 13:13 已達 38,311）
    "tw_open":        "2,230",        # 6/8 實際開盤（大幅跳空）
    "tw_high":        "2,320",        # 6/8 盤中高
    "tw_low":         "2,230",        # 6/8 盤中低（=開盤）
    "market_cap":     "NT$59.8 兆",   # 6/8 實際市值（NT$2,305 基礎）
    ...
    # NYSE TSM ADR
    "nyse_price":     "426.80",       # 6/8 Mon 實際收盤（+11.63，+2.80% vs 6/5 $415.17；自 6/5 崩跌反彈、消化 Broadcom Q3 AI 指引利空）
    "nyse_change":    "+11.63",       # 6/8 漲跌（vs 6/5 $415.17）
    "nyse_change_pct":"+2.80%",       # 6/8 NYSE 反彈
    "52w_high_nyse":  "449.39",       # 52 週高（2026-06-02 盤中觸及 $449.39 創史新高）
    "52w_low_nyse":   "134.25",       # 52 週低（2025-04-07）
    "pe_nyse":        "~35.4x",       # NYSE USD 基礎 P/E（TTM，估算，$426.80 基礎、自崩跌回升）
    "pb_nyse":        "~12.2x",
    "beta":           "1.18",
    ...
    # 資料日期備註
    "data_note":      "報告日期：2026-06-09 Tue（今日盤中、6/9 收盤資料待盤後補；主要區塊以 6/8 Mon 實際收盤為最新確認資料）。📉 重大事件——6/8 Mon 台股 2330 跳空補跌反映 NYSE 6/5 -6.69% 崩跌：實際收 NT$2,305（-60，-2.54% vs 6/5 NT$2,365）、開盤 NT$2,230 跳空 -135 點 -5.7%、盤中區間 NT$2,230-2,320 量約 52,000 張；NYSE TSM 6/8 Mon 反彈 +2.80% 收 $426.80（+$11.63 vs 6/5 $415.17）消化 Broadcom 利空。✅ 6/8 跳空後快速回升 +75 點顯示低接買盤湧現、跌幅低於 NYSE 6/5 崩跌的 -6.69%；6/8 NYSE TSM 領先回升 +2.80% 為短線止跌訊號。📊 今日（6/9 Tue）：台股盤中、6/9 收盤待 TWSE 盤後公告；NYSE TSM 6/9 將於今晚台灣時間反映 6/8 +2.80% 反彈是否延續。台美 ADR 溢價以 6/8 收盤計：理論值 5×2,305÷31.05 = $371.18、溢價 (426.80-371.18)/371.18 = +14.99%（自 +9.04% 大幅擴大、反映 ADR 領先反彈）。  |  🎯 即將事件（短線最關鍵催化）：⭐ TSMC 5 月月營收明日（6/10 Wed 13:30）公布、市場估 NT$420B+、為短線止跌反彈訊號；Q2 2026 財報 7/16  |  ⭐ 結構性利多續存（中長線基底未變）：6/4 AGM CEO Wei 確認 AI 需求超供應、2026 >30% 成長；TSMC 2nm 量產良率達 70-80% 領先全球、年底月產能 100K 片；NVIDIA $150B/年投資台灣；NVIDIA-TSMC AI 製程合作（cuLitho/cuEST/FabTwin）；Intel CEO 確認長期夥伴；TSMC 3nm 下半年漲價 15%；SIA 估 2028 AI 資料中心晶片年營收 $1.2 兆  |  ⚠️ 本日（6/9）關鍵觀察：（1）台股能否延續 6/8 尾盤回升續攻 NT$2,350 / 5MA；（2）6/10 月營收公布前夕量縮整理；（3）下方支撐 NT$2,250（心理整數）/ NT$2,200 / NT$2,148（120MA）；反彈壓力 NT$2,355（6/5 收）/ 5MA NT$2,355 / NT$2,365",
}
...
SUMMARY = {
    ...
    "sentiment":  "中性",
    # 一句話標題
    "headline":   "📊 6/8 台股跳空補跌收 NT$2,305（-2.54%）；NYSE TSM 6/8 +2.80% 反彈領先；今日（6/9 Tue）盤中、6/10 月營收公布前量縮觀望",
    # 3–5 條白話重點（不用術語，每條約 30 字內）
    "bullets": [
        "📉 6/8 Mon 台股 2330 跳空補跌實際收 NT$2,305（-60，-2.54%）反映 NYSE 6/5 -6.69% 崩跌",
        "🚀 6/8 美股半導體強勁反彈 SOX +5.87%（6 月最大單日）：Intel +11%、AMAT +8.64%、ASML +6.54%、TSM ADR +2.80% 收 $426.80",
        "📊 6/8 台股開盤跳空 -135 點至 NT$2,230 但盤中回升至 NT$2,320、低接買盤湧現",
        "🎯 短線最關鍵：⭐ TSMC 5 月月營收明日（6/10 Wed 13:30）公布、市場估 NT$420B+",
        "⭐ TSMC 2nm 開始量產、初期良率 70-80% 領先競爭、年底月產能達 100K 片",
        "⭐ 中長線基底未變：AI 需求超供應 + 2026 >30% 成長 + 3nm 漲價 15% + NVIDIA $150B/年投資",
        "📊 台美 ADR 溢價自 +9.04% 大幅擴大至 +14.99%、反映 NYSE 領先反彈動能",
        "⚠️ 估值警示：TSM P/E ~33.9x 仍在 5 年 88-90% 高位、6/10 月營收為驗證關鍵",
    ],
    # 一句結論
    "bottom_line": "報告日期：2026-06-09 Tue（今日盤中、6/9 收盤資料待盤後補；以下以 6/8 Mon 實際收盤為最新確認資料）。📉 重大事件——6/8 Mon 台股 2330 跳空補跌反映 NYSE 6/5 -6.69% 崩跌：實際收 NT$2,305（-60，-2.54% vs 6/5 NT$2,365）、開盤跳空 -135 點至 NT$2,230（-5.70%）、盤中區間 NT$2,230-2,320 量約 52,000 張、市值回落至約 NT$59.8 兆。✅ 跳空後快速回升 +75 點顯示低接買盤湧現、跌幅實際 -2.54% 明顯低於 NYSE 6/5 -6.69%；NYSE TSM 6/8 Mon 反彈 +2.80% 收 $426.80（+$11.63 vs 6/5 $415.17）消化 Broadcom Q3 AI 指引利空、領先確認止跌訊號。📊 今日（6/9 Tue）：台股 2330 盤中、6/9 收盤實際資料待 TWSE 盤後公告；NYSE TSM 6/9 將於今晚台灣時間反映 6/8 +2.80% 反彈是否延續。台美 ADR 溢價以 6/8 收盤計：理論值 5×2,305÷31.05 = $371.18、溢價 (426.80-371.18)/371.18 = +14.99%（自 +9.04% 大幅擴大、反映 ADR 領先反彈）。🎯 短線最關鍵催化：⭐ TSMC 5 月月營收明日（6/10 Wed 13:30）公布、市場估 NT$420B+——若優於市場估為止跌反彈關鍵訊號、若不及預估恐加深下行壓力。⭐ 中長線結構性利多基底未變：（1）🏛️ 6/4 AGM CEO Wei 確認 AI 需求將持續超越全球半導體供應、2026 >30% 成長指引、3nm H2 漲價 15% + 2027 再漲 5-10%；（2）⭐ TSMC 2nm 已開始量產、採用 nanosheet Gate-All-Around 電晶體、初期良率 70-80% 領先全球；2026 年底 2nm 月產能目標 100,000 片；（3）NVIDIA 仍為 TSMC 第 1 大客戶（22% / $33B）、Apple 第 2 大（17% / $27B）；（4）NVIDIA-TSMC AI 製程合作（cuLitho/cuEST/FabTwin）；（5）Intel CEO 6/2 確認 TSMC「長期信任夥伴」；（6）SIA 估 2028 AI 資料中心晶片年營收 $1.2 兆（+10x vs 2024）；（7）半導體設備銷售創 $36.55B 紀錄；（8）NVIDIA Computex 2026 發表 RTX Spark 超晶片（20-core Arm CPU + Blackwell GPU + 128GB 記憶體）由 TSMC 代工。⚠️ 短期下行風險：（1）Broadcom 全年 AI 指引未上修、AI CapEx 增速放緩疑慮；（2）Fed 升息預期升溫、10Y 美債殖利率 4.5%+；（3）美對中 AI 晶片出口管制擴大；（4）⚠️ 估值警示 TSM P/E ~33.9x 仍在 5 年 88-90% 高位；（5）TSMC 對前主管 Wei-Jen Lo 訴訟持續中。基本面未變：Q1 2026 淨利 NT$572.5B（$18.2B、+58.3% YoY）、毛利率 66.2% 雙創史高；2025 全年 EPS NT$66.25。技術面（基於 6/8 實際收盤 NT$2,305）：5MA NT$2,355（壓力）/ 20MA NT$2,330 / 60MA NT$2,280 / 120MA NT$2,155；下方支撐 NT$2,300 / NT$2,250 心理整數 / NT$2,200。32 位分析師全數看多、平均目標 NT$2,530 上行空間 +9.76%。",
    # 重大警示（選填，空白則不顯示）
    "risk_alert":  "今日（6/9 Tue）關鍵觀察（盤中、待盤後補實際資料）：（1）📉 6/8 Mon 台股 2330 跳空補跌實際收 NT$2,305（-2.54%）反映 NYSE 6/5 -6.69% 崩跌、開盤跳空 -135 點 -5.70% 後盤中回升 +75 點；（2）✅ NYSE TSM 6/8 反彈 +2.80% 收 $426.80 領先確認止跌訊號；（3）🎯 短線最關鍵催化：⭐ TSMC 5 月月營收明日（6/10 Wed 13:30）公布、市場估 NT$420B+ vs 4 月 NT$410.73B；若優於市場估、為止跌反彈關鍵訊號；若不及預估、恐加深下行壓力；（4）⭐ TSMC 2nm 已開始量產、初期良率 70-80% 領先全球、年底月產能目標 100K 片；（5）⭐ NVIDIA Computex 2026 發表 RTX Spark 超晶片由 TSMC 代工；（6）⭐ SIA 估 2028 AI 資料中心晶片年營收 $1.2 兆；（7）⭐ 中長線結構性利多基底未變：AGM CEO Wei 確認 AI 需求超供應 + 2026 >30% 成長 + 3nm 漲價 15% + NVIDIA $150B/年投資 + Intel 確認長期夥伴；（8）⚠️ 估值警示 TSM P/E ~33.9x 仍在 5 年 88-90% 高位；（9）⚠️ Fed 升息預期升溫、10Y 美債殖利率突破 4.5%；（10）⚠️ 美對中 AI 晶片出口管制 6/1 擴大；（11）⚠️ TSMC 對前主管 Wei-Jen Lo 訴訟持續中；（12）台幣 31.05 升值壓力結構性續存；（13）📊 台美 ADR 溢價自 +9.04% 大幅擴大至 +14.99%、反映 NYSE 領先反彈動能；（14）32 位分析師全數看多、平均目標 NT$2,530 上行空間 +9.76%；本日（6/9）關鍵：台股能否延續 6/8 尾盤回升續攻 NT$2,350 / 5MA NT$2,355；6/10 月營收公布前量縮觀望概率高；支撐 NT$2,300 / NT$2,250 心理整數 / NT$2,200",
}

# 三大法人買賣超（張）— 最新一日
INSTITUTIONAL = {
    "date":     "2026-06-08",       # 最新確認資料日（6/8 Mon）；6/9 三大法人資料待 TWSE 盤後公告
    "foreign":  -18500,             # 外資 6/8 估大幅賣超（跳空補跌、機構恐慌賣壓）
    "trust":    -1500,              # 投信 6/8 估小幅賣超
    "dealer":   -800,               # 自營商 6/8 估小幅賣超
    # 近5日（由舊到新：6/2, 6/3, 6/4, 6/5, 6/8）
    "foreign_5d": [+9500, +18500, -8500, -2500, -18500],   # 6/8 估大幅賣超 -18,500（跳空補跌）
    "trust_5d":   [+2200, +3200, -1500, -200, -1500],      # 6/8 估賣超
    "dealer_5d":  [+1000, +1800, -500, -200, -800],        # 6/8 估賣超
    "foreign_ownership_pct": "75.1%",  # 外資持股比例（6/8 估，較 6/5 75.3% 略降）
    "foreign_ownership_shares": "約 194.7 億股",
}

# 技術分析指標（需每日從看盤軟體更新）
TECHNICAL = {
    "rsi_14":       48.0,   "rsi_signal": "RSI 估自 55 進一步回落至 48（6/8 跳空 -2.54% 跌破中軸 50），動能轉空；6/9 待盤後實際資料",
    "macd":         +0.3,   "macd_signal": "MACD 估自 +1.0 大幅收斂至 +0.3、紅柱動能轉弱接近翻黑、瀕臨死叉；6/9 待盤後實際資料",   "macd_color": "#FF9800",
    "kdj_k":        42.0,   "kdj_d": 58.0, "kdj_j": 10.0, "kdj_signal": "KDJ K(42)/D(58)/J(10) 三線下行、J 自 35 急殺至 10 接近超賣 0、死叉訊號浮現；6/9 待盤後實際資料",
    "ma5":       "2,355",   # 5MA（6/2 2380, 6/3 2425, 6/4 2385, 6/5 2365, 6/8 2305）— 基於 6/8 收盤
    "ma20":      "2,330",   # 20MA 開始下彎
    "ma60":      "2,280",   # 60MA 上揚但收斂
    "ma120":     "2,155",
    "bb_upper":  "2,470",   # 布林上軌
    "bb_mid":    "2,330",   # 布林中軌（20MA）
    "bb_lower":  "2,190",   # 布林下軌
    "vol_ma5":  "52,800",   # 5日均量（張，估、基於 6/2-6/8 五日均；6/8 跳空爆量）
    "trend":    "📉 6/8 Mon 重大事件：台股 2330 跳空補跌反映 NYSE 6/5 -6.69% 崩跌——實際收 NT$2,305（-60，-2.54% vs 6/5 NT$2,365）、開盤跳空 -135 點 -5.70% 至 NT$2,230、盤中區間 NT$2,230-2,320、量約 52,000 張屬爆量整理。✅ 跳空後快速回升 +75 點顯示低接買盤湧現、跌幅 -2.54% 明顯低於 NYSE 6/5 崩跌的 -6.69%。✅ NYSE TSM 6/8 領先反彈 +2.80% 收 $426.80（+$11.63 vs 6/5 $415.17）消化 Broadcom Q3 AI 指引利空、為短線止跌訊號。📊 今日（6/9 Tue）台股盤中、6/9 收盤資料待盤後補；NYSE TSM 6/9 將反映 6/8 +2.80% 反彈是否延續。技術面（基於 6/8 收盤 NT$2,305）：RSI 估自 55 回落至 48 跌破中軸、MACD +0.3 紅柱動能轉弱接近翻黑、KDJ K(42)/D(58)/J(10) J 線急殺至超賣區、死叉訊號浮現；5MA NT$2,355（壓力）/ 20MA NT$2,330 / 60MA NT$2,280 / 120MA NT$2,155，短期均線轉壓力、中期 60MA/120MA 仍多頭。下一觀察：（1）6/9 台股能否延續 6/8 尾盤回升續攻 NT$2,350 / 5MA NT$2,355；（2）下方支撐 NT$2,300 整數 / NT$2,250 心理整數 / NT$2,200 / NT$2,155（120MA）；（3）反彈壓力 5MA NT$2,355 / NT$2,365（6/5 收）/ NT$2,400 整數 / NT$2,425（6/3 史高）；（4）⭐ 短線最關鍵催化：⭐ TSMC 5 月月營收明日（6/10 Wed 13:30）公布、估 NT$420B+；（5）⭐ 中長線結構性利多基底未變：AGM CEO Wei 確認 AI 需求超供應 + 2026 >30% 成長 + 2nm 量產 70-80% 良率 + 3nm 漲價 15%；（6）⚠️ Fed 升息預期升溫、KDJ 超賣須注意反彈訊號。",
    "support":  "2,300 / 2,250 / 2,200 / 2,155 (整數、心理整數、120MA)",
    "resist":   "2,355 / 2,365 / 2,400 / 2,425 (5MA、6/5 收、整數、6/3 史高)",
    "note": "技術指標數值為估算（基於 6/8 收盤 NT$2,305），請以看盤軟體即時數據為準；6/9 盤中、待盤後補實際資料；KDJ J=10 接近超賣須注意短線反彈訊號；6/10 月營收公布為短線最大變數",
}

# 期貨與選擇權（來源：台灣期交所 TAIFEX）
DERIVATIVES = {
    "date":          "2026-06-08",       # 最新確認資料日（6/8 Mon）；6/9 衍生品資料待 TAIFEX 盤後公告
    "futures_price": "2,305",            # 台積電期貨近月（6/8 估收盤附近）
    "futures_oi":    "168,500",          # 未平倉量（口）（6/8 估、跳空爆量）
    "futures_basis": "-5",               # 6/8 估小逆價差（避險賣壓）
    "call_oi":       "98,500",
    "put_oi":        "85,500",
    "pcr":           "0.87",             # Put/Call 比率（6/8 估升至 0.87、看空避險買盤增加）
    "pcr_signal":    "中性偏空（Put/Call 6/8 估升至 0.87、自 6/5 0.67 大幅升溫；6/9 待 TAIFEX 公告。反映跳空後避險買盤增加、6/10 月營收公布前風險規避升溫）",
    "max_pain":      "2,350",            # 最大痛苦價格（近期到期、6/8 估、自 2,400 下移）
    "key_strikes": [
        ("2,200", "Call 25,500 / Put 28,500", "心理整數深支撐"),
        ("2,250", "Call 30,500 / Put 22,500", "心理整數"),
        ("2,300", "Call 48,500 / Put 15,500", "6/8 收附近、整數"),
        ("2,305", "Call 50,000 / Put 14,800", "6/8 收"),
        ("2,330", "Call 56,000 / Put 9,500",  "20MA"),
        ("2,355", "Call 58,500 / Put 7,800",  "5MA、反彈關卡"),
        ("2,365", "Call 60,000 / Put 7,200",  "6/5 收"),
        ("2,400", "Call 55,500 / Put 6,800",  "心理整數"),
        ("2,425", "Call 50,500 / Put 6,200",  "6/3 史高收盤"),
        ("2,500", "Call 40,200 / Put 4,200",  "短線挑戰價"),
    ],
    "note": "衍生品數據需每日至台灣期交所(taifex.com.tw)更新；6/9 衍生品資料待 TAIFEX 盤後公告；6/8 PCR 自 0.67 升至 0.87 反映避險買盤增加、最大痛苦價自 2,400 下移至 2,350；6/10 月營收公布為短線最大變數；中長線結構性利多基底未變（AGM CEO Wei 確認 AI 超供應、2nm 量產 70-80% 良率、Intel CEO 確認長期夥伴、NVIDIA-TSMC AI 合作、3nm 漲價 15%）",
}

# 供應鏈與客戶股價（需每日更新）
ECOSYSTEM_STOCKS = [
    # 類別、股票代碼、名稱、收盤價、漲跌幅、備註（2026-06-08 美股實際反彈 + 台股 6/8 跳空補跌）
    ("設備", "ASML",    "艾司摩爾",    "815.00", "+6.54%", "EUV 設備龍頭（6/8 強勁反彈 +6.54%；Musk Terafab 催化、6/9-10 年會 Musk 出席談 SpaceX/Tesla $55B 德州晶圓廠）"),
    ("設備", "AMAT",    "應用材料",    "492.17", "+8.64%", "⭐ 6/8 飆漲 +8.64% 創 Q2 財季營收新高、上修 2026 設備業務成長至 >30%；TSMC EPIC Center $5B AI 合作續存"),
    ("設備", "LRCX",    "科林研發",    "985.00", "+5.30%", "蝕刻設備（6/8 強勁反彈；半導體設備需求 $36.55B 創紀錄）"),
    ("設備", "KLAC",    "科磊",        "740.00", "+5.20%", "量測設備（6/8 強勁反彈；2nm 量產驅動）"),
    ("記憶", "000660.KS","SK 海力士",  "366,500 KRW", "+4.12%", "HBM4 供應（6/8 反彈；AI 記憶體需求結構性多頭）"),
    ("記憶", "MU",      "美光",        "143.10", "+3.54%", "HBM / DDR5（6/8 反彈 +3.54%；自 6/5 -8.65% 急殺後低接買盤）"),
    ("封裝", "3711.TW", "日月光",      "289",    "-3.02%", "CoWoS 封裝（6/8 跟跌；台股半導體補跌反映美股 6/5 崩跌）"),
    ("客戶", "NVDA",    "輝達",        "246.50", "+2.20%", "🏆 #1 客戶 22%（6/8 反彈 +2.20%；Computex RTX Spark 由 TSMC 代工、結構性需求未變）"),
    ("客戶", "AAPL",    "蘋果",        "290.20", "+1.19%", "⚠️ #2 客戶 17%（6/8 反彈；Apple 將跳過 A16 直上 A14 製程）"),
    ("客戶", "AVGO",    "博通",        "448.50", "+2.68%", "🔄 #3 客戶 13%（6/8 反彈 +2.68%；Hock Tan 確認「custom AI chips only」策略、2027 AI 指引 >$100B 不變）"),
    ("客戶", "AMD",     "超微",        "490.33", "+5.14%", "#4 客戶 8%（6/8 強勁反彈 +5.14%、YTD +119%；MI400 資料中心 GPU 持續搶市）"),
    ("客戶", "2454.TW", "聯發科",      "4,400",  "-2.66%", "手機 SoC 客戶 9%；6/8 跟跌（資金輪出半導體）"),
    ("競爭", "INTC",    "英特爾",      "—",  "+11.0%", "🚀 6/8 飆漲 +11%：Google/Alphabet 委由 Intel 代工 300 萬顆 AI 晶片（2028 部署）、Wells Fargo 目標升至 $110、Barclays 升至 $100；Intel CEO 6/2 仍確認 TSMC「長期信任夥伴」"),
    ("競爭", "005930.KS","三星電子",   "61,800 KRW", "+2.66%", "Samsung Foundry 6/8 反彈；HBM4E NVIDIA 送樣中"),
    ("處分後", "ARM",   "Arm Holdings","240.50", "+2.25%", "TSMC 4/29 全數出脫後（6/8 反彈；半導體連動）"),
]
...
IR_CALENDAR = [
    ...
    ("2026-06-09", "📊 今日（盤中、待盤後補資料）；6/10 月營收公布前夕量縮觀望","今日（6/9 Tue）📊 台股 2330 盤中、6/9 收盤實際資料待 TWSE 盤後公告；市場關注：（1）能否延續 6/8 尾盤回升續攻 NT$2,350 / 5MA NT$2,355；（2）NYSE TSM 6/9 將反映 6/8 +2.80% 反彈是否延續；（3）6/10 月營收公布前夕量縮觀望概率高；⭐ 中長線基底未變：AGM CEO Wei 確認 AI 需求超供應、2nm 量產 70-80% 良率、3nm 漲價 15%、NVIDIA $150B/年投資、NVIDIA-TSMC AI 製程合作、Intel 確認長期夥伴；🎯 短線最關鍵：⭐ TSMC 5 月月營收明日（6/10 Wed 13:30）公布、估 NT$420B+ 為止跌反彈關鍵訊號；本日支撐：NT$2,300 / NT$2,250 心理整數 / NT$2,200","#FFCDD2"),
    ("2026-06-10", "📅 TSMC 5 月月營收 6/10 Wed 13:30 公布（短線最關鍵催化）","TSMC 預計 6/10 Wed 13:30 公布 5 月合併月營收；4 月 NT$410.73B；市場估 5 月 NT$420B+；若優於預估為止跌反彈關鍵訊號；若不及預估恐加深下行壓力","#FF9800"),
...
# 總體經濟監控
MACRO = [
    ("SOX 半導體指數",  "13,160.00","+5.87%", True),   # 6/8 SOX/SOXX 強勁反彈 +5.87% 自 6/5 12,431.25 回升（6 月最大單日反彈、收復上週 -10% 跌幅）
    ("台股加權指數",    "43,950.20","-2.49%", False),  # 6/8 加權指數跳空補跌（估）
    ("VIX 恐慌指數",    "18.5",    "-3.0",   True),    # 恐慌指數自 21.5 大幅回落、6/8 半導體強勁反彈避險情緒緩解
    ("WTI 原油",        "$70.5",   "+0.43%", True),    # 油價微漲
    ("10Y 美債殖利率",  "4.48%",   "-0.04pp",True),    # 自 4.52% 微降、Fed 升息預期略緩
    ("台幣/美元",       "31.05",   "0.00",   False),   # 台幣持穩（每升值 1% 毛利率 -40bps）
    ("NVIDIA NVDA",     "$246.50", "+2.20%", True),    # #1 TSMC 客戶（22%），6/8 反彈 +2.20%
    ("ASML",            "$815.00", "+6.54%", True),    # 設備股 6/8 強勁反彈 +6.54%（Musk Terafab 催化、6/9-10 ASML 年會 Musk 出席）
]
...
RELATIVE = {
    "date":           "2026-06-08",       # 最新確認資料日（6/8 Mon 收盤）；6/9 資料待盤後補
    "tsmc_tw_1d":     -2.54,   # 2330 6/8 實際收 NT$2,305（-60 vs 6/5 NT$2,365；跳空補跌）
    "taiex_1d":       -2.49,   # 加權指數 6/8 估收 43,950（-2.49%）
    "sox_1d":         +5.87,   # SOX 6/8 強勁反彈 +5.87% 自 12,431.25 回升至 ~13,160（6 月最大單日反彈）
    "tsmc_nyse_1d":   +2.80,   # TSM ADR 6/8 $426.80 (+$11.63 vs 6/5 $415.17)
    "tsmc_tw_5d":     -2.12,   # 5 日（NT$2,305 vs 6/2 NT$2,355）
    "taiex_5d":       -3.06,
    "tsmc_tw_1m":     +0.65,   # 月線（NT$2,305 vs NT$2,290 ~5/8）
    "taiex_1m":       +5.0,
    "tsmc_tw_ytd":    +10.02,  # YTD 累計（NT$2,305 vs 年初 ~NT$2,095）
    "taiex_ytd":      +11.0,
    "sox_ytd":        +69.5,   # SOX YTD 自高位反彈
    "beta_60d":        1.42,   # 60 日滾動 Beta vs TAIEX（跳空補跌後升溫）
    # ADR 折溢價（以 6/8 NYSE & TW 最新收盤計算）
    "adr_price":     426.80,   # TSM NYSE 6/8 實際收盤（+$11.63，+2.80% vs 6/5 $415.17）
    "adr_parity":    371.18,   # 理論值 = 5 × NT$2,305 ÷ 31.05
    "adr_ratio":     "5:1",    # 1 ADR = 5 台積電普通股
    "usd_ntd":        31.05,   # 同 MACRO 台幣匯率
    "adr_premium_pct": "+14.99", # (426.80 - 371.18) / 371.18 × 100 = +14.99%（自 +9.04% 大幅擴大）
    "note": "ADR 理論值 = 5 × 台股收盤 ÷ 匯率（不含交易摩擦與流動性溢價）。📉 6/8 Mon 台股 2330 跳空補跌反映 NYSE 6/5 -6.69% 崩跌：實際收 NT$2,305（-2.54%）、開盤跳空 -135 點 -5.70%；NYSE TSM 6/8 反彈 +2.80% 收 $426.80 領先確認止跌訊號；6/9 Tue 盤中、待盤後補實際資料。📊 台美 ADR 溢價以 6/8 收盤計算自 +9.04% 大幅擴大至 +14.99%、反映 NYSE 領先反彈動能、台股補跌幅度大於 ADR 反彈；🎯 短線最關鍵催化：⭐ TSMC 5 月月營收明日（6/10 Wed 13:30）公布、估 NT$420B+ 為止跌反彈訊號；⭐ 中長線結構性基底未變：AGM CEO Wei 確認 AI 需求超供應 + 2nm 量產 70-80% 良率 + NVIDIA $150B/年台灣投資 + 3nm 漲價 15% + NVIDIA-TSMC AI 製程合作 + Intel 確認長期夥伴",
}
...
NEWS = [
    {
        ...
        "title": "📊 6/8 Mon 台股 2330 跳空補跌實際收 NT$2,305（-2.54%）；NYSE TSM 6/8 反彈 +2.80% 收 $426.80 領先止跌",
        "body": "6/8 Mon 台股 2330 跳空補跌反映 NYSE 6/5 -6.69% 崩跌：（1）實際收 NT$2,305（-60，-2.54% vs 6/5 NT$2,365）；（2）開盤跳空 -135 點 -5.70% 至 NT$2,230、盤中區間 NT$2,230-2,320 量約 52,000 張；（3）市值回落至 NT$59.8 兆；（4）✅ 跳空後盤中快速回升 +75 點顯示低接買盤湧現、跌幅 -2.54% 明顯低於 NYSE 6/5 崩跌 -6.69%；（5）✅ NYSE TSM 6/8 同步反彈 +2.80% 收 $426.80（+$11.63 vs 6/5 $415.17）消化 Broadcom 利空、領先確認止跌訊號；（6）⭐ SOX/SOXX 6/8 強勁反彈 +5.87% 自 12,431.25 回升至 ~13,160（6 月最大單日反彈、收復上週 -10% 跌幅）、INTC +11%（Google 委外 300 萬顆 AI 晶片）、AMAT +8.64%（Q2 財季營收創高）、ASML +6.54%（Musk Terafab 催化）、AMD +5.14%、NVDA +2.20%；（7）6/8 估三大法人合計賣超 -20,800 張（外資 -18,500、投信 -1,500、自營 -800）；（8）台美 ADR 溢價自 +9.04% 大幅擴大至 +14.99%、反映 NYSE 領先反彈動能；（9）🎯 今日（6/9 Tue）盤中、6/9 收盤待 TWSE 盤後公告；（10）⭐ 短線最關鍵：⭐ TSMC 5 月月營收明日（6/10 Wed 13:30）公布、估 NT$420B+ 為止跌反彈訊號。",
        "source": "Yahoo股市 / Goodinfo / TWSE / TradingKey / Yahoo Finance 2026-06-08", "impact": "中性",
    },
    {
        "tag": "產品發布", "tag_color": "#9C27B0",
        "title": "⭐ TSMC 2nm 量產起跑、初期良率達 70-80% 領先全球；年底月產能目標 100,000 片",
        "body": "TSMC 已開始 2nm（N2）製程量產、技術領先優勢進一步擴大：（1）⭐ 採用 nanosheet Gate-All-Around (GAA) 電晶體架構、為 TSMC 首次採用 GAA 結構；（2）⭐ 初期良率達 70-80%、領先任何競爭對手（Samsung、Intel 18A）；（3）⭐ 2026 年底 2nm 月產能目標 100,000 片（wpm）；（4）首批客戶涵蓋 NVIDIA、Apple、AMD 等核心 AI 與行動裝置客戶；（5）2nm 較 N3E 製程性能提升 10-15%、功耗降低 25-30%；（6）⭐ 與 CEO Wei 6/4 AGM 確認 AI 需求超供應一致：2nm 為 NVIDIA Vera Rubin、Apple M5 系列、AMD MI400 等下世代 AI/HPC 旗艦晶片必經產能；（7）⭐ N2 至 2028 CAGR +70%（4/22 北美技術論壇指引）；（8）對 TSMC 意涵：技術代差優勢 12-18 個月領先 Samsung Foundry 與 Intel Foundry、進一步鞏固先進製程定價權與 3nm 漲價 15% + 2027 再漲 5-10% 的客戶接受度。",
        "source": "Investing.com / TSMC Investor Relations 2026-06-08", "impact": "正面",
    },
    {
        "tag": "客戶動態", "tag_color": "#2196F3",
        "title": "⭐ NVIDIA Computex 2026 發表 RTX Spark 超晶片：20-core Arm CPU + Blackwell GPU + 128GB 由 TSMC 代工",
        "body": "NVIDIA CEO 黃仁勳於 Computex 2026 Taipei 主題演講發表 NVIDIA RTX Spark 超晶片、重新定義 Windows AI PC：（1）⭐ 20-core Arm CPU + Blackwell GPU 6,144 CUDA cores + 128GB LPDDR5X RAM + 300 GB/s 記憶體頻寬；（2）⭐ 透過 NVLink C2C 連接 CPU 與 GPU、可本地執行 120-billion 參數 LLM、上下文長度達 1 million tokens；（3）⭐ 算力 1 petaflop AI；（4）合作夥伴：Microsoft Surface（首發 Surface Laptop Ultra）、ASUS、Dell、HP、Lenovo、MSI、Acer、GIGABYTE；（5）2026 秋季開始出貨；（6）⭐ 對 TSMC 意涵：RTX Spark 為 NVIDIA 跨入 PC 市場的旗艦產品、Arm CPU + Blackwell GPU 異質整合晶片由 TSMC N3E 製程代工 + CoWoS 先進封裝、為新增量訂單；（7）NVDA 6/8 反彈 +2.20% 收 $246.50；（8）⭐ 強化 NVIDIA 為 TSMC 第 1 大客戶 22% / $33B 地位；（9）NVIDIA $150B/年投資台灣承諾續存、Taipei HQ 動土。",
        "source": "Toms Hardware / NVIDIA Newsroom / Bloomberg / IndexBox 2026-06-08", "impact": "正面",
    },
    {
        "tag": "產業趨勢", "tag_color": "#4CAF50",
        "title": "⭐ SIA 估 2028 AI 資料中心晶片年營收 $1.2 兆（10x 成長）；晶片占 AI 伺服器 95% 價值",
        "body": "美國半導體產業協會 (SIA) 6/1 發布報告、確認 AI 資料中心晶片市場結構性多頭：（1）⭐ 2028 AI 資料中心晶片年營收估達 $1.2 兆、較 2024 增加近 10 倍；（2）⭐ 晶片占 AI 伺服器機架（rack）總價值 95%、占 AI 資料中心總資本支出 50%+；（3）⭐ 半導體設備銷售 2026 創 $36.55B 紀錄、由 AI 晶片產能投資驅動；（4）4 大美國 CSP（Alphabet/AWS/Microsoft/Meta）2026 AI CapEx 合計 $725B（+77% YoY）；（5）BofA 上修 2026 全球晶片市場至 $1.3 兆、點名 NVIDIA、Broadcom、Marvell、AMD 為四大成長引擎、全數為 TSMC 先進製程客戶；（6）IDC 估 2026 全球半導體營收突破 $1.29T；（7）TrendForce 估 Custom ASIC 增速 2026 首度超越 GPU（+44.6% vs +16.1%）；（8）⭐ 對 TSMC 意涵：無論 GPU 或 ASIC 路線勝出、TSMC 3nm/2nm + CoWoS 皆為必經產能；2028 AI 晶片市場 $1.2 兆驗證 CEO Wei 「AI 需求將持續超越全球半導體供應」論述；（9）6/8 半導體類股全面反彈確認結構性需求未變。",
        "source": "SIA / Semiconductors.org / Digitimes / Yahoo Finance (BofA) 2026-06-01 - 06-08", "impact": "正面",
    },
    {
        "tag": "產業趨勢", "tag_color": "#4CAF50",
        "title": "🎯 TSMC 5 月月營收明日（6/10 Wed 13:30）公布、市場估 NT$420B+；短線最關鍵止跌反彈訊號",
        "body": "TSMC 將於明日（6/10 Wed 13:30 Asia/Taipei）公布 5 月合併月營收、為短線最關鍵催化：（1）⭐ 公布時間：2026-06-10 Wed 13:30 GMT+8（TSMC 投資人關係官網確認）；（2）4 月月營收 NT$410.73B（+17.5% YoY、-1.1% MoM）、1-4 月累計 NT$1,544.83B（+29.9% YoY）；（3）⭐ 市場估 5 月 NT$420B+（MoM +2-3%）、若優於市場估為止跌反彈關鍵訊號；（4）⚠️ 若不及預估恐加深下行壓力；（5）Q1 2026 實際營收 NT$1.134 兆（+35.1% YoY）、CEO Wei 確認 2026 全年成長 >30% 指引；（6）3 月 NT$415.2B（+45.2% YoY、+30.7% MoM）為近期高點、5 月若達 NT$420B+ 將驗證 AI 需求動能；（7）⭐ 對 TSMC 短線走勢意涵：5 月月營收為驗證 6/4 AGM CEO Wei 「AI 需求超供應」論述的關鍵數據；（8）若 5 月達 NT$425B+ 可能引爆台股 2330 強勢反彈挑戰 5MA NT$2,355 / NT$2,400 整數；（9）若 5 月跌至 NT$405B 以下將加深市場對 AI CapEx 增速放緩的疑慮、可能跌破 NT$2,250 心理整數。",
        "source": "TSMC Investor Relations / 玩股網 / Yahoo股市 2026-06-08", "impact": "中性",
    },
    {
        "tag": "產業趨勢", "tag_color": "#4CAF50",
        "title": "🚀 6/8 美股半導體強勁反彈 SOX +5.87%（6 月最大單日）：Intel +11% Google AI 訂單、AMAT +8.64% 財季創高、ASML +6.54% Musk Terafab",
        "body": "6/8 Mon 美股半導體類股出現 6 月最大單日反彈、SOX/SOXX +5.87% 收復上週 -10%+ 跌幅、為 6/5 Broadcom 利空崩跌後的強勁止跌訊號：（1）🚀 Intel +11%：Google/Alphabet 委由 Intel 代工 300 萬顆 AI 晶片（2028 部署）、Wells Fargo 目標自 $85 升至 $110、Barclays 自 $65 升至 $100；（2）🚀 Applied Materials (AMAT) +8.64% 收 $492.17：Q2 財季營收創歷史新高、上修 2026 設備業務成長至 >30%——⭐ 直接利多 TSMC 2nm/A16 產能擴張與設備採購；（3）🚀 ASML +6.54% 收約 $815：Musk Terafab 催化（SpaceX/Tesla 合資 $55B 德州先進晶圓廠）、Musk 將於 6/9-10 ASML 年會與 CEO Fouquet 爐邊對談；（4）AMD +5.14% 收 $490.33（YTD +119%）、NVDA +2.20%、TSM ADR +2.80% 收 $426.80；（5）⭐ 對 TSMC 意涵：半導體設備（AMAT/ASML）強勁財報與資本支出指引上修、印證 AI 晶片產能投資循環延續、2026 設備銷售 $36.55B 創紀錄、直接驅動 TSMC 先進製程擴產；（6）AI 基礎設施支出推升 2026 全球半導體銷售估達 $975B、生成式 AI 晶片近 $500B（占半數）；（7）⚠️ Intel 接獲 Google AI 訂單顯示晶圓代工競爭加劇、惟 Intel CEO 6/2 仍確認 TSMC「長期信任夥伴」、TSMC 2nm 良率 70-80% 技術代差優勢未變。",
        "source": "StartupHub.ai / Digitimes / Deloitte / Bloomberg 2026-06-08", "impact": "正面",
    },
]
