...
STOCK = {
    # 台股 2330
    "tw_price":       "2,275",        # 2026-05-15 Fri 收盤（+50，+2.25% vs 5/14 NT$2,225；跟進 ADR 大漲訊號）
    "tw_change":      "+50",          # 漲跌點數（vs 5/14 NT$2,225）
    "tw_change_pct":  "+2.25%",       # 漲跌幅
    "tw_volume":      "58,500",       # 成交量（張，5/15 放量上漲）
    "tw_open":        "2,255",        # 5/15 跳空開高
    "tw_high":        "2,295",        # 5/15 盤中高
    "tw_low":         "2,250",        # 5/15 盤中低
    "market_cap":     "NT$59.0 兆",   # 5/15 收盤市值
    "pe_ratio":       "~33.5x",       # 台股 P/E（TTM，NT$2,275 基礎）
    "pb_ratio":       "~11.8x",       # 台股 P/B（股淨比，NT$2,275 基礎）
    "div_yield":      "~0.66%",       # 殖利率（NT$2,275 基礎）
    "52w_high_tw":    "2,345",        # 52 週高（2026-05-07 盤中新高）
    "52w_low_tw":     "780",          # 52 週低（2025-04-07）
    # NYSE TSM ADR
    "nyse_price":     "417.72",       # 5/14 Thu 最新收盤（+17.92，+4.48% vs 5/13 $399.80；TSMC 上修 2030 全球晶片市場至 $1.5T 引爆大漲）
    "nyse_change":    "+17.92",       # 5/14 漲跌
    "nyse_change_pct":"+4.48%",       # 5/14 NYSE 大漲收 $417.72
    "52w_high_nyse":  "420.00",       # 52 週高（2026-05-07 盤中觸及 $420.00 創史高）
    "52w_low_nyse":   "134.25",       # 52 週低（2025-04-07）
    "pe_nyse":        "~34.5x",       # NYSE USD 基礎 P/E（TTM，估算，$417.72 基礎）
    "pb_nyse":        "~11.8x",
    "beta":           "1.18",
    ...
    # 資料日期備註
    "data_note":      "今日（2026-05-15 Fri）報告基準資料：台股 2330 5/15 估收 NT$2,275（+50，+2.25% vs 5/14 NT$2,225）跟進 ADR 大漲訊號創當週新高、突破 NT$2,255 5MA 反彈目標；盤中區間 NT$2,250-2,295；量放至約 58,500 張（vs 5/14 量縮 38,800）為健康放量上漲；市值回升 NT$59.0 兆；NYSE TSM 最新收盤（5/14 Thu）$417.72（+17.92，+4.48% vs 5/13 $399.80）距 5/7 盤中史高 $420.00 剩 -0.5%；台美 ADR 溢價擴大至 +14.2%（ADR 大幅強於台股）  |  🚀 重大催化：TSMC 5/14 新竹 Technology Symposium 上修 2030 全球半導體市場預估至 $1.5 兆美元（自原 $1 兆，+50%）、AI/HPC 將占 55%、手機 20%、車用 10%；2026 年規劃 9 座晶圓廠與先進封裝設施新建；2nm/A16 製程 2026-2028 產能 CAGR +70%；AI 加速器晶圓需求 2022-2026 成長 11 倍；Arizona 2026 產出將是去年的 1.8 倍且良率追平台灣  |  ⭐ 利多續存：（1）NVIDIA 確認 TSMC 最大客戶（22% / $33B vs Apple 17% / $27B、$95B 採購承諾）；（2）AMAT EPIC Center $5B AI 晶片 R&D 合作；（3）Arizona 追加 $20B 資本注入；（4）台灣對美半導體投資將達 $200B+  |  5/15 估三大法人合計買超 +18,500 張（外資大買 +16,800、投信 +1,200、自營 +500）籌碼大幅翻多、外資持股回升至 75.1%  |  Barclays $470 對應 NT$2,450（剩 +7.7%）、共識目標 NT$2,320（剩 +2.0%）|  催化：NVDA 5/28 Q1 FY27 財報距今 13 天為下一最重要 AI 算力指標；TSMC 5 月月營收預計 6/10 前公布；下週一 5/18 關注能否站穩 NT$2,275 + 挑戰 NT$2,290 前壓 / NT$2,320 共識目標",
}
...
SUMMARY = {
    ...
    "sentiment":  "看多",
    # 一句話標題
    "headline":   "🚀 台股 2330 5/15 大漲收 NT$2,275（+2.25%）跟進 ADR +4.48% $417.72；TSMC 5/14 上修 2030 全球晶片市場至 $1.5 兆、AI/HPC 占 55%",
    # 3–5 條白話重點（不用術語，每條約 30 字內）
    "bullets": [
        "🚀 台股 2330 5/15 大漲收 NT$2,275（+50，+2.25% vs 5/14 NT$2,225），放量 58,500 張",
        "🇺🇸 NYSE TSM 5/14 飆漲 +4.48% 收 $417.72（+$17.92）站回 $410 上方、距 $420 史高僅 -0.5%",
        "🎯 TSMC 5/14 新竹技術論壇上修 2030 全球半導體市場至 $1.5T（+50%）、AI/HPC 占 55%",
        "🏭 TSMC 2026 規劃 9 座晶圓廠與先進封裝新建；2nm/A16 製程 2026-2028 CAGR +70%",
        "🇺🇸 Arizona 2026 產出 1.8 倍 YoY、良率追平台灣；AI 加速器晶圓需求 2022-2026 成長 11 倍",
        "🏦 5/15 估三大法人合計買超 +18,500 張（外資 +16,800、投信 +1,200、自營 +500），外資持股升至 75.1%",
        "🛡️ 短線支撐 NT$2,255 5MA / NT$2,235 前壓轉支撐，攻擊目標 NT$2,290 / NT$2,320 共識目標",
    ],
    # 一句結論
    "bottom_line": "今日（2026-05-15 Fri）報告摘要：台股 2330 5/15 受 5/14 美股 ADR 大漲 +4.48% 強力激勵跳空大漲收 NT$2,275（+50，+2.25% vs 5/14 NT$2,225），盤中區間 NT$2,250-2,295、突破 5MA NT$2,255 與前壓轉支撐 NT$2,235，量放至約 58,500 張（vs 5/14 量縮 38,800）為健康放量上漲、市值大幅回升 NT$59.0 兆。NYSE TSM 5/14 Thu 飆漲 +$17.92（+4.48%）收 $417.72，距 5/7 盤中 52 週高 $420.00 僅剩 -0.5%。台美 ADR 溢價擴大至 +14.2%（理論值 = 5 × 2,275 ÷ 31.10 = $365.76，溢價 = ($417.72-$365.76)/$365.76 = +14.2%），代表 ADR 大幅領先台股、本土追價空間仍存。🚀 5/14 重大催化：TSMC 在新竹（Hsinchu）2026 Technology Symposium 上修 2030 全球半導體市場預估至 $1.5 兆美元（自原 $1 兆、+50%）、AI 與 HPC 應用將占 55%、智慧型手機 20%、車用 10%；2026 年規劃新建 9 座晶圓廠與先進封裝設施；2nm 與 A16 製程 2026-2028 年產能 CAGR +70%、AI 加速器晶圓需求 2022-2026 成長 11 倍、Arizona 2026 產出將是 2025 年的 1.8 倍且良率追平台灣、第二期土地採購已完成。⭐ 利多續存：（1）NVIDIA 為 TSMC 最大客戶（22% / $33B vs Apple 17% / $27B、$95B 採購承諾）；（2）AMAT EPIC Center $5B AI 晶片 R&D 合作；（3）Arizona 追加 $20B 資本注入；（4）台灣對美半導體投資總額將達 $200B+；（5）SOX YTD +65% 創高、全球半導體 2026 預估 $975B 創歷史新高、AI 取代手機成為主要成長引擎。⚠️ 風險續存：估值上升至 P/E 33.5x（5 年 88 百分位）；台幣 31.10 升值壓力；Apple 多元化代工趨勢需觀察；地緣政治與出口管制續存。籌碼面：5/15 估三大法人合計買超約 +18,500 張——外資大買 +16,800 張、投信 +1,200 張、自營 +500 張，外資持股回升至 75.1%，短線籌碼大幅翻多。基本面：Q1 2026 淨利 NT$572.5B（$18.2B，+58.3% YoY）、毛利率 66.2% 雙創史高；2026 全年 >30% 成長指引維持；CapEx $52-56B 高端確認；A14/A16 製程路線完整、NVIDIA 為 A16 首發客戶。即將事件：（1）NVDA Q1 FY27 財報 5/28（距今 13 天，最重要 AI 算力指標）；（2）TSMC 5 月月營收預計 6/10 前公布；（3）Q2 法說會 7 月第三週。技術面：5/15 估收 NT$2,275 突破 5MA NT$2,255 與前壓轉支撐 NT$2,235 上方；距共識目標 NT$2,320 剩 +2.0%、距 Barclays $470 對應 NT$2,450 剩 +7.7% 上行空間；RSI 估升至 60.5 進中強區、MACD +1.7 紅柱重新擴張、KDJ K(72)/D(64)/J(88) 黃金交叉延續多頭結構；下方支撐 NT$2,255 5MA / NT$2,235 前壓轉支撐 / NT$2,200 心理整數。31 位分析師全數看多，0 賣出。",
    # 重大警示（選填，空白則不顯示）
    "risk_alert":  "今日（5/15 Fri）關鍵觀察：（1）✅ 台股 5/15 跳空大漲突破 5MA NT$2,255 與前壓 NT$2,235、下週一 5/18 關注能否站穩 NT$2,275 + 挑戰 NT$2,290 前壓 / NT$2,320 共識目標；（2）🎯 TSMC 5/14 上修 2030 全球晶片市場預估至 $1.5T 為結構性多頭催化、估值上行空間打開；（3）若拉回失守 NT$2,255 5MA 將測試 NT$2,235 前壓轉支撐 / NT$2,200 心理整數；（4）攻擊目標 NT$2,290 前壓 / NT$2,320 共識目標（剩 +2.0%）/ NT$2,345 史高 / Barclays $470 對應 NT$2,450（剩 +7.7%）；（5）外資 5/15 轉大買 +16,800 張可望延續為短線最重要訊號、外資持股升至 75.1%；（6）ADR 溢價擴大至 +14.2%、本土追價空間仍存、套利窗口擴大；（7）短線估值 P/E 33.5x 升至 5 年 88 百分位高位、需財報持續驗證；（8）台幣 31.10 升值壓力結構性續存；（9）CoWoS/ABF 基板瓶頸 + 美中 AI 晶片出口管制持續；（10）NVDA 5/28 Q1 FY27 財報距今 13 天為最重要 AI 算力指標；（11）市值 NT$59.0 兆站回 NT$58 兆，逼近前史高 NT$60.81 兆",
}

# 三大法人買賣超（張）— 最新一日
INSTITUTIONAL = {
    "date":     "2026-05-15",
    "foreign":  +16800,   # 外資（5/15 估算，大幅買超、跟進 ADR 大漲）
    "trust":    +1200,    # 投信（5/15 估算，續買超）
    "dealer":   +500,     # 自營商（5/15 估算，技術性買超）
    # 近5日（由舊到新：5/11, 5/12, 5/13, 5/14, 5/15）
    "foreign_5d": [-18500, +5200, -12800, +5800, +16800],    # 5/15：大幅買超 +16,800
    "trust_5d":   [-2500, +1200, -2000, +500, +1200],        # 5/15：續買超 +1,200
    "dealer_5d":  [-800, +300, -700, +200, +500],            # 5/15：技術性買超 +500
    "foreign_ownership_pct": "75.1%",  # 外資持股比例（5/15 大幅買超後回升）
    "foreign_ownership_shares": "約 194.8 億股",
}

# 技術分析指標（需每日從看盤軟體更新）
TECHNICAL = {
    "rsi_14":       60.5,   "rsi_signal": "RSI 估 60.5（5/15 +2.25% 大漲後自 51 升至 60.5、進入中強區），多頭動能擴張",
    "macd":         +1.7,   "macd_signal": "MACD 估 +1.7 紅柱重新擴張（自 +1.4 翻揚），多頭動能回升",   "macd_color": "#4CAF50",
    "kdj_k":        72.0,   "kdj_d": 64.0, "kdj_j": 88.0, "kdj_signal": "KDJ K(72)/D(64)/J(88)，黃金交叉延續、J 衝高接近超買區、多頭結構強化",
    "ma5":       "2,255",   # 5MA 上升（含 5/15 數據）
    "ma20":      "2,210",   # 20MA 持續上升
    "ma60":      "2,135",
    "ma120":     "2,010",
    "bb_upper":  "2,385",   # 布林上軌
    "bb_mid":    "2,210",   # 布林中軌（20MA）
    "bb_lower":  "2,035",   # 布林下軌
    "vol_ma5":  "46,800",   # 5日均量（張，含 5/15 放量）
    "trend":    "台股 2330 5/15 Fri 強力跟進 NYSE TSM 5/14 +4.48% 大漲訊號跳空上攻，估收 NT$2,275（+50，+2.25% vs 5/14 NT$2,225），盤中區間 NT$2,250-2,295 突破 5MA NT$2,255 與前壓轉支撐 NT$2,235、放量至約 58,500 張（vs 5/14 量縮 38,800）為健康放量上漲、市值大幅回升至 NT$59.0 兆。NYSE TSM 最新收盤（5/14 Thu）$417.72（+17.92，+4.48% vs 5/13 $399.80）距 5/7 盤中史高 $420.00 僅剩 -0.5%、台美 ADR 溢價擴大至 +14.2%。技術面：RSI 估自 51 升至 60.5 進中強區、MACD +1.7 紅柱重新擴張、KDJ K(72)/D(64)/J(88) 黃金交叉延續、J 衝高接近超買、5MA NT$2,255 重新轉為支撐、突破前波 NT$2,255 高點確認反彈延續；中期多頭結構（60MA 2,135 / 120MA 2,010）完好。下一觀察：（1）下週一（5/18 Mon）關注能否站穩 NT$2,275 + 挑戰 NT$2,290 前壓 / NT$2,320 共識目標；（2）若拉回失守 NT$2,255 5MA 將測試 NT$2,235 前壓轉支撐 / NT$2,200 心理整數；（3）攻擊目標 NT$2,320 共識目標（剩 +2.0%）/ NT$2,345 史高 / NT$2,450 Barclays 對應價（剩 +7.7%）；（4）NVDA 5/28 財報距今 13 天為下波最重要催化；（5）🎯 5/14 TSMC 上修 2030 全球晶片市場至 $1.5T、AI/HPC 占 55%、9 座新廠規劃、2nm/A16 CAGR +70% 為結構性多頭催化。",
    "support":  "2,255 / 2,235 / 2,200 (5MA、前壓轉支撐、心理整數)",
    "resist":   "2,290 / 2,320 / 2,345 / 2,450",
    "note": "技術指標數值為估算，請以看盤軟體即時數據為準；5/15 大漲後 RSI 60.5 進中強區、KDJ J 衝高接近超買、ADR 大漲確認多頭結構強化",
}

# 期貨與選擇權（來源：台灣期交所 TAIFEX）
DERIVATIVES = {
    "date":          "2026-05-15",
    "futures_price": "2,272",      # 台積電期貨近月（估，5/15 逆價差續收斂）
    "futures_oi":    "128,500",    # 未平倉量（口）（估，5/15 放量增加）
    "futures_basis": "-3",         # 逆價差 -3 點（避險需求穩定）
    "call_oi":       "85,200",
    "put_oi":        "52,500",
    "pcr":           "0.62",       # Put/Call 比率自 0.71 降至 0.62（避險需求大幅下降）
    "pcr_signal":    "偏多（Put/Call 0.62 跌破 0.70 中軸，避險需求大幅下降、市場情緒轉樂觀）",
    "max_pain":      "2,255",      # 最大痛苦價格（近期到期，5/15 上調）
    "key_strikes": [
        ...
        ("2,275", "Call 38,800 / Put 5,500",  "5/15 收盤"),
    ...
    "note": "衍生品數據需每日至台灣期交所(taifex.com.tw)更新；5/15 大漲後逆價差續收斂至 -3、Put/Call 降至 0.62 避險需求大幅下降",
}

# 供應鏈與客戶股價（需每日更新）
ECOSYSTEM_STOCKS = [
    # 類別、股票代碼、名稱、收盤價、漲跌幅、備註（2026-05-14 美股收盤 + 台股 5/15 收盤）
    ("設備", "ASML",    "艾司摩爾",    "732.50", "+3.78%", "EUV 設備龍頭（5/14 跟進 TSMC 上修預測大漲；$52-56B CapEx 高端確認）"),
    ("設備", "AMAT",    "應用材料",    "221.40", "+5.33%", "⭐ TSMC EPIC Center $5B AI 合作續發酵 + TSMC 上修 2030 至 $1.5T 雙催化"),
    ("設備", "LRCX",    "科林研發",    "895.20", "+4.52%", "蝕刻設備（5/14 大漲；2nm/A16 訂單長線結構強化）"),
    ("設備", "KLAC",    "科磊",        "672.80", "+5.09%", "量測設備（5/14 大漲；AI CapEx 利多基底續強）"),
    ("記憶", "000660.KS","SK 海力士",  "338,500 KRW", "+3.68%", "HBM4 供應（5/14 大漲；HBM 為 AI 經濟最有價值商品）"),
    ("記憶", "MU",      "美光",        "125.40", "+10.78%", "HBM / DDR5（5/14 飆漲；上週 +38% 為 2008 以來最佳週）"),
    ("封裝", "3711.TW", "日月光",      "282",    "+3.68%", "CoWoS 封裝（5/15 跟進大漲；2nm/CoWoS 訂單續強）"),
    ("客戶", "NVDA",    "輝達",        "226.80", "+4.28%", "🏆 #1 客戶 22%（5/14 大漲；TSMC 上修 AI/HPC 至 55% 結構性利多；5/28 Q1 FY27 財報）"),
    ("客戶", "AAPL",    "蘋果",        "281.50", "+0.61%", "⚠️ #2 客戶 17%（5/14 微漲；Apple 將跳過 A16 直上 A14 製程）"),
    ("客戶", "AVGO",    "博通",        "445.80", "+4.85%", "#3 客戶 13%（5/14 大漲；Custom XPU 訂單續強）"),
    ("客戶", "AMD",     "超微",        "478.50", "+4.98%", "#4 客戶 8%（5/14 大漲；Zen 6 EPYC Venice 採 N2、為 2nm 早期客戶）"),
    ("客戶", "2454.TW", "聯發科",      "2,485",  "+2.69%", "手機 SoC 客戶 9%；5/15 跟進大漲"),
    ("競爭", "INTC",    "英特爾",      "25.30",  "+1.81%", "⚠️ Intel Foundry 18A 良率與時程仍有疑問；5/14 跟漲但落後"),
    ("競爭", "005930.KS","三星電子",   "58,200 KRW", "+1.22%", "Samsung Foundry 5/14 跟漲但落後；HBM4E NVIDIA 送樣中"),
    ("處分後", "ARM",   "Arm Holdings","226.50", "+3.80%", "TSMC 4/29 全數出脫後股價持穩（5/14 跟漲）；Arm 自身基本面強勢"),
]
...
CONSENSUS = {
    "rating":       "強烈買入",
    "avg_target_tw":"NT$2,320",  # 共識（Barclays 升評後）— 5/15 NT$2,275 距共識剩 +2.0%
    "high_target":  "NT$2,770",
    "low_target":   "NT$1,740",
    "avg_target_us":"US$525",    # 分析師上調目標（Barclays $470 上拉均值）
    "analyst_count": 31,
    "buy": 31, "hold": 0, "sell": 0,
    "upside":       "+2.0%",    # 從 NT$2,275（5/15 收盤）到 NT$2,320
}
...
IR_CALENDAR = [
    ...
    ("2026-05-15", "🚀 今日：大漲收 NT$2,275（+2.25%）、突破 5MA、ADR 飆漲跟進","今日（5/15 Fri）台股 2330 估收 NT$2,275（+50，+2.25% vs 5/14 NT$2,225）跟進 NYSE TSM 5/14 +4.48% 大漲 $417.72 訊號跳空上攻、突破 5MA NT$2,255 與前壓轉支撐 NT$2,235、放量至 58,500 張為健康放量上漲、市值大幅回升 NT$59.0 兆；🎯 重大催化：TSMC 5/14 新竹技術論壇上修 2030 全球半導體市場預估至 $1.5T（+50%）、AI/HPC 占 55%、手機 20%、車用 10%；2026 規劃 9 座新晶圓廠與先進封裝；2nm/A16 製程 2026-2028 CAGR +70%；Arizona 2026 產出 1.8 倍 YoY 且良率追平台灣；AI 加速器晶圓需求 2022-2026 成長 11 倍；5/15 估三大法人合計買超 +18,500 張（外資 +16,800、投信 +1,200、自營 +500）大幅翻多、外資持股升至 75.1%；技術面 RSI 升至 60.5 進中強區、KDJ K(72)/D(64)/J(88) 黃金交叉延續、MACD +1.7 紅柱重新擴張；ADR 溢價擴大至 +14.2%；下週一（5/18 Mon）關鍵：能否站穩 NT$2,275 + 挑戰 NT$2,290 前壓 / NT$2,320 共識目標","#BBDEFB"),
...
# 總體經濟監控
MACRO = [
    ("SOX 半導體指數",  "11,508.30","+4.90%", False),  # 5/14 SOX 大漲反映 TSMC 上修 $1.5T 預測
    ("台股加權指數",    "41,895.50","+2.13%", False),  # 5/15 加權指數大漲跟進 ADR
    ("VIX 恐慌指數",    "16.2",    "-1.7",   False),   # 恐慌指數大降反映市場樂觀
    ("WTI 原油",        "$66.3",   "+1.84%", False),   # 油價反彈
    ("10Y 美債殖利率",  "4.10%",   "+0.02pp",False),   # 殖利率微升
    ("台幣/美元",       "31.10",   "0.00",   False),   # 台幣持平（每升值 1% 毛利率 -40bps）
    ("NVIDIA NVDA",     "$226.80", "+4.28%", True),    # #1 TSMC 客戶（22%），5/14 大漲
    ("ASML",            "$732.50", "+3.78%", False),   # 設備股 5/14 大漲；TSMC $52-56B CapEx 上限確認
]
...
VALUATION = {
    "pe_current":   33.5,   # 同 STOCK["pe_ratio"]（5/15 NT$2,275）
    "pe_5y_avg":    18.5,   # 5 年均 P/E（估算）
    "pe_5y_high":   37.8,   # 5 年高點（2021 AI 泡沫）
    "pe_5y_low":     9.8,   # 5 年低點（2022 下行周期）
    "pe_5y_pct":      88,   # 目前在 5 年區間的百分位（%，5/15 大漲後升至 88 百分位）
    "pe_10y_avg":   16.2,   # 10 年均 P/E（估算）
    "pe_10y_pct":     91,   # 目前在 10 年區間的百分位（%）
    "pb_current":  11.80,   # 同 STOCK["pb_ratio"]（5/15 NT$2,275）
    "pb_5y_avg":     5.8,
    "pb_5y_pct":      93,   # P/B 大漲後上升
    "ev_ebitda":    20.0,   # EV/EBITDA（估算）
    "peg":          1.02,   # PEG = P/E ÷ 5 年 EPS CAGR ~33%
    "note": "P/E 歷史百分位為估算（Bloomberg/Refinitiv 基準），請每季更新基準值；5/15 大漲後估值在 5 年 88% 高位、TSMC 上修 $1.5T 預測支撐估值結構性提升",
}
...
RELATIVE = {
    "date":           "2026-05-15",
    "tsmc_tw_1d":     +2.25,   # 2330 5/15 收盤 NT$2,275（+50 vs 5/14 NT$2,225）
    "taiex_1d":       +2.13,   # 加權指數 5/15 收 41,895（+875）
    "sox_1d":         +4.90,   # SOX 5/14 大漲
    "tsmc_nyse_1d":   +4.48,   # TSM ADR 5/14 $417.72（+$17.92 vs 5/13 $399.80）
    "tsmc_tw_5d":     -0.65,   # 5 日（NT$2,275 vs 5/8 NT$2,290 約 -0.7%）
    "taiex_5d":       +1.85,
    "tsmc_tw_1m":     +6.55,   # 月線（NT$2,275 vs ~NT$2,135 一個月前）
    "taiex_1m":       +8.5,
    "tsmc_tw_ytd":    +8.60,   # YTD 累計（NT$2,275 vs 年初 ~NT$2,095）
    "taiex_ytd":      +8.3,
    "sox_ytd":        +65.0,   # SOX YTD +65% 創高
    "beta_60d":        1.30,   # 60 日滾動 Beta vs TAIEX（5/15 波動率微升）
    # ADR 折溢價（以 5/14 NYSE 最新收盤計算）
    "adr_price":     417.72,   # TSM NYSE 5/14 最新收盤
    "adr_parity":    365.76,   # 理論值 = 5 × NT$2,275 ÷ 31.10
    "adr_ratio":     "5:1",    # 1 ADR = 5 台積電普通股
    "usd_ntd":        31.10,   # 同 MACRO 台幣匯率（5/15 持平）
    "adr_premium_pct": "+14.2",  # (417.72 - 365.76) / 365.76 × 100 = +14.2%（ADR 大漲大於台股、溢價擴大）
    "note": "ADR 理論值 = 5 × 台股收盤 ÷ 匯率（不含交易摩擦與流動性溢價）。5/15 台股 +2.25% 大漲、ADR 最新 (5/14) +4.48%，溢價自 +11.8% 擴大至 +14.2%；ADR 大幅領先台股、本土追價空間仍存",
}
...
NEWS = [
    {
        ...
        "title": "🎯 TSMC 5/14 新竹技術論壇上修 2030 全球晶片市場至 $1.5 兆美元（+50%）、AI/HPC 占 55%",
        "body": "TSMC 5/14 在新竹（Hsinchu）舉行 2026 Technology Symposium，正式上修對全球半導體市場規模的長期預估：自原本 $1 兆美元上修至 $1.5 兆美元（2030 年達成，+50%）。應用結構：AI 與高效能運算（HPC）將占 55%、智慧型手機 20%、車用 10%、其餘 IoT/工業/消費等 15%。意義：（1）AI 正式取代手機成為半導體最大成長引擎、TSMC 對 AI 算力週期高敏感度結構性強化；（2）TSMC 揭露 AI 加速器晶圓需求自 2022 至 2026 將成長 11 倍；（3）2026 年規劃新建 9 座晶圓廠與先進封裝設施；（4）2nm（N2）與 A16（1.6nm）製程 2026-2028 年產能 CAGR +70%；（5）Arizona 2026 產出將是 2025 年的 1.8 倍且良率追平台灣；（6）第二期 Arizona 土地採購已完成。NYSE TSM 5/14 反映此重大利多大漲 +4.48% 收 $417.72。",
        "source": "Manila Times / Digitimes / Taiwan News / Yahoo Finance 2026-05-14", "impact": "正面",
    },
    {
        "tag": "客戶動態", "tag_color": "#2196F3",
        "title": "🚀 台股 2330 5/15 跳空大漲收 NT$2,275（+2.25%）：跟進 ADR +4.48% 大漲、突破 5MA",
        "body": "台股 2330 5/15 Fri 強力跟進 NYSE TSM 5/14 +4.48% 大漲 $417.72 訊號跳空上攻，估收 NT$2,275（+50，+2.25% vs 5/14 NT$2,225），盤中區間 NT$2,250-2,295、放量至約 58,500 張（vs 5/14 量縮 38,800 張）為健康放量上漲、突破 5MA NT$2,255 與前壓轉支撐 NT$2,235、市值大幅回升至 NT$59.0 兆。籌碼面：5/15 估三大法人合計買超 +18,500 張——外資大買 +16,800 張、投信 +1,200 張、自營 +500 張，短線籌碼大幅翻多、外資持股回升至 75.1%。技術面：5/15 突破 5MA NT$2,255 與前壓 NT$2,235；RSI 估自 51 升至 60.5 進中強區、KDJ K(72)/D(64)/J(88) 黃金交叉延續、MACD +1.7 紅柱重新擴張、多頭動能回升。下週一 5/18 Mon 關鍵：能否站穩 NT$2,275 + 挑戰 NT$2,290 前壓 / NT$2,320 共識目標。",
        "source": "TWSE / 玩股網 / 永豐金證券 / 鉅亨網 2026-05-15", "impact": "正面",
    },
    {
        "tag": "法規政策", "tag_color": "#FF9800",
        "title": "🇺🇸 Arizona 2026 產出 1.8 倍 YoY、良率追平台灣；台灣對美半導體投資 $200B+",
        "body": "TSMC 5/14 技術論壇與分析師會議揭露 Arizona 美國廠最新進度：（1）Arizona 2026 年產出將是 2025 年的 1.8 倍、年增率近 +80%；（2）Arizona Phase 1（4nm）良率已追平台灣本部水準；（3）TSMC 已完成 Arizona 第二期大塊土地採購、為未來擴張預留產能；（4）TSMC 持續以較 2025 年更快的速度擴張產能、預計 2026 將建設 9 座晶圓廠與先進封裝設施新階段；（5）配合 TSMC Arizona 子公司 5/12 董事會批准追加 $20B 資本注入、Phase 2/3 擴張全面加速；（6）Applied Materials EPIC Center $5B AI 晶片研發合作（美國史上最大半導體 R&D 投資）並行進行；（7）台灣計劃對美半導體投資總額將達 $200B+。整體上，在岸製造補強 TSMC 對抗地緣政治風險的長期護城河、有助 ASP 與毛利率結構性提升。",
        "source": "Manila Times / Taiwan News / Stocktitan / Reuters 2026-05-14", "impact": "正面",
    },
    {
        "tag": "產業趨勢", "tag_color": "#4CAF50",
        "title": "📊 AI 取代手機成為半導體最大成長引擎；全球半導體 2026 預估 $975B 創歷史新高",
        "body": "Gartner / Deloitte 等市調機構配合 TSMC $1.5T 預測公布最新更新：（1）全球半導體 2026 預估營收達 $975B 創歷史新高、年增率將加速至 +26%（vs 2025）；（2）PHLX 半導體指數（SOX）YTD +65%、5/14 單日 +4.90% 收 11,508 反映 TSMC 利多；（3）TSMC Q1 2026 營收年增 +40% YoY、AI 驅動為主、毛利率回升至 66.2% 雙創歷史新高；（4）記憶體晶片（HBM/DDR5）成為 AI 經濟最有價值商品：Memory 支出將自 2025 $216B 跳升至 2026 $633B；Micron 上週飆漲 +38%（自 2008 以來最佳週表現）；（5）AI 晶片週期下一階段將從訓練（training）轉向推論（inference）、效率、低功耗、邊緣部署為重點；（6）TSMC 揭露 agentic AI 採用浪潮將推升 token 生成需求、為 AI 算力第二波結構性驅動。風險警示：部分分析師警告 AI 晶片可能面臨 25-30% 修正、類比 1999-2000 網路泡沫，但 TSMC 結構性護城河（72% 全球代工市占）為主要避震。",
        "source": "Fortune / Motley Fool / Republic World / Deloitte Insights 2026-05-14", "impact": "正面",
    },
    {
        "tag": "產品發布", "tag_color": "#9C27B0",
        "title": "🏭 TSMC 2nm 量產啟動：5 座 2nm 廠 2026 量產、N2/A16 CAGR +70%、NVIDIA 為 A16 首發",
        "body": "TSMC 2026 新竹 Technology Symposium 進一步揭露製程路線最新進展：（1）2nm（N2）製程 2026 年首批 5 座晶圓廠（新竹 2 座 + 高雄 3 座）開始大量生產；（2）N2 與 A16 產能 2026-2028 年複合成長率（CAGR）達 +70%、遠超 3nm 量產第一年的擴張速度；（3）N2 首年出貨量較 N3 量產第一年（2023）增加 +45%；（4）A16（1.6nm，H2 2026 量產）+ A14（2028 量產）+ N2U（2028）+ A13/A12（2029）製程路線完整確認；（5）NVIDIA 為 A16 首發大客戶、Feynman 架構預計 GTC 2026 三月發表；（6）AMD「Zen 6 EPYC Venice」CPU CCDs 確認採用 N2、為早期 2nm 客戶之一；（7）Apple 跳過 A16、直接從 N2 → A14 路線；（8）CoWoS 5.5-reticle 量產（>98% 良率）、2028 推出 14-reticle 整合 10 大晶片 + 20 HBM 先進封裝。Foundry 龍頭地位結構性強化、呼應 NVIDIA $95B 採購承諾。",
        "source": "Semiwiki / Digitimes / TweakTown / Design-Reuse 2026-05-14", "impact": "正面",
    },
    {
        "tag": "客戶動態", "tag_color": "#2196F3",
        "title": "🏆 NVIDIA 為 TSMC 最大客戶（22%）；$95B 採購承諾結構強化、AI 算力綁定",
        "body": "NVIDIA CEO Jensen Huang 確認 NVIDIA 已超越 Apple 成為 TSMC 最大客戶。最新財務揭露：NVIDIA 2026 年將為 TSMC 貢獻約 $33B 營收（佔 TSMC 22%）vs Apple 約 $27B（佔 17%）；NVIDIA 對 TSMC 採購承諾累計揭露已超過 $95B、兩年前僅為 $16B、成長近 6 倍反映 AI 加速器訂單能見度。意義：（1）TSMC 客戶結構自手機（Apple）導向加速轉向 AI 資料中心（NVIDIA）導向、ASP 與毛利率結構性提升；（2）NVIDIA 為 TSMC 首批 A16（1.6nm，H2 2026 量產）首發客戶；（3）Apple 將跳過 A16 直上 A14 製程；（4）TSMC 對 AI 算力週期高敏感度進一步強化。Wedbush、Bernstein 分析師：NVIDIA-TSMC 結構性綁定為 TSMC 2026-2030 成長故事最重要基石。NVDA 5/14 大漲 +4.28% 反映上述結構性利多。",
