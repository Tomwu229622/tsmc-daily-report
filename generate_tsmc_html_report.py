...
STOCK = {
    # 台股 2330
    "tw_price":       "2,400",        # 2026-06-04 Thu 估收（估算，-25，-1.03% vs 6/3 實際 NT$2,425；TW 6/4 反映 NYSE TSM 6/3 close $436.69 -2.24% 自史高 $446.69 回檔修正）
    "tw_change":      "-25",           # 漲跌點數（估算，vs 6/3 NT$2,425 實際收盤）
    "tw_change_pct":  "-1.03%",       # 漲跌幅（估算）
    "tw_volume":      "52,000",       # 成交量（張，6/4 估算、放量整理）
    "tw_open":        "2,395",        # 6/4 估跳空開低
    "tw_high":        "2,420",        # 6/4 估盤中高
    "tw_low":         "2,385",        # 6/4 估盤中低
    "market_cap":     "NT$62.2 兆",   # 6/4 估市值（NT$2,400 基礎）
    "pe_ratio":       "~35.3x",       # 台股 P/E（TTM，NT$2,400 基礎）
    "pb_ratio":       "~12.5x",       # 台股 P/B（股淨比，NT$2,400 基礎）
    "div_yield":      "~0.63%",       # 殖利率（NT$2,400 基礎）
    "52w_high_tw":    "2,430",        # 52 週/歷史高（2026-06-03 盤中觸 NT$2,430 後實際收 NT$2,425 創新高）
    "52w_low_tw":     "780",          # 52 週低（2025-04-07）
    # NYSE TSM ADR
    "nyse_price":     "436.69",       # 6/3 Wed 最新收盤（-2.24% vs 6/2 史新高 $446.69；自盤中 52w 高 $449.39 高位獲利了結回檔）
    "nyse_change":    "-10.00",        # 6/3 漲跌（vs 6/2 $446.69）
    "nyse_change_pct":"-2.24%",       # 6/3 NYSE 自史高回檔修正
    ...
    # 資料日期備註
    "data_note":      "今日（2026-06-04 Thu）報告基準資料：✅ 6/3 Wed 台股 2330 實際收 NT$2,425（+45，+1.89% vs 6/2 NT$2,380）創歷史新高、跟進 NYSE TSM 6/2 大漲訊號 + Intel CEO 6/2 keynote 確認 TSMC「長期信任夥伴」雜訊清除；台股加權指數 6/3 走高、續站穩 45,000+。📉 NYSE TSM 6/3 Wed 收 $436.69（-$10.00，-2.24% vs 6/2 史新高 $446.69）自盤中 52w 新高 $449.39 高位獲利了結、技術性回檔修正——多項估值警示：P/E 升至 5 年 95%+ 高位、GF Value 評估「適度高估」、RSI 進入超買區、自史高累計獲利空間大。今日（6/4 Thu）台股 2330 估跟進 NYSE 6/3 -2.24% 回檔，估收 NT$2,400（-25，-1.03% vs 6/3 NT$2,425）、估盤中區間 NT$2,385-2,420、估量 52,000 張放量整理。台美 ADR 溢價估自 +14.6% 收斂至 +13.1%（理論值 5×2,400÷31.05 = $386.47，溢價 (436.69-386.47)/386.47 = +13.0%）。  |  ⭐ 結構性利多續存：NVIDIA $150B/年投資台灣承諾；NVIDIA-TSMC AI 製程合作（cuLitho/cuEST/FabTwin）；Intel CEO 確認長期夥伴關係；TSMC 3nm 下半年漲價 15%、2027 再漲 5-10%；TSMC 2026 全年營收成長指引上修至 >30%；員工分紅年增 >30%  |  ⭐ NVDA Q1 FY27 財報 5/20 大超預期：營收 $81.6B（+85% YoY）、Q2 guidance $91.0B、$80B 回購  |  📊 Broadcom (AVGO) 6/3 盤後財報關注：TSMC #3 客戶（13%）、Custom XPU + AI 營收續爆發；前一季 AI 營收 +106% YoY  |  🎯 結構性催化續存：TSMC 上修 2030 全球半導體市場至 $1.5 兆、AI/HPC 占 55%；18 座新廠規劃；2nm/A16 CAGR +70%；CoWoS 良率 98%；SIA/Deloitte 估 2028 AI 資料中心晶片年營收 $1.2 兆（10 倍成長）  |  ⚠️ 短線雜訊：（1）⚠️ NYSE TSM 6/3 自史高 $449.39 高位回檔 -2.24%、估值警示 P/E 36-37x 在 5 年 95%+ 高位；（2）GF Value 評估「適度高估」；（3）TSMC 法律戰續：11/2025 對前主管 Wei-Jen Lo 訴訟（轉投 Intel、涉 2nm 商業機密）持續中；（4）Apple 部分晶片轉 Intel 18A 的 5/13 雜訊未完全消化  |  Barclays $470 對應 NT$2,450（剩約 +2.1%）|  催化：Broadcom AVGO 6/3 盤後財報；TSMC 5 月月營收預計 6/10 前公布；COMPUTEX 2026 6/2-6 末日 6/6；Q2 2026 財報 7/16 公布",
}
...
SUMMARY = {
    ...
    "sentiment":  "中性偏多",
    # 一句話標題
    "headline":   "📉 NYSE TSM 6/3 自史高 $449.39 回檔 -2.24% 收 $436.69；台股 2330 6/3 實際收 NT$2,425 創史新高；6/4 台股估跟進回檔 NT$2,400",
    # 3–5 條白話重點（不用術語，每條約 30 字內）
    "bullets": [
        "✅ 台股 2330 6/3 Wed 實際收 NT$2,425（+45，+1.89% vs 6/2）創歷史新高",
        "📉 NYSE TSM 6/3 收 $436.69（-2.24% vs 6/2 史新高 $446.69）自史高高位獲利了結",
        "📊 今日（6/4 Thu）台股 2330 估跟進 NYSE 回檔、估收 NT$2,400（-1.03%）量增整理",
        "📊 Broadcom 6/3 盤後財報關注：TSMC #3 客戶（13%）、Custom XPU + AI 營收續爆發",
        "🤝 Intel CEO 6/2 keynote 確認 TSMC「長期信任夥伴」雜訊清除（基底續強）",
        "🤝 NVIDIA-TSMC AI 製程合作（cuLitho +20-50%、cuEST 50x、FabTwin）續發酵",
        "🚀 SIA/Deloitte 報告：2028 AI 資料中心晶片年營收 $1.2 兆、4 年成長 10 倍",
        "⚠️ 估值警示：P/E 36-37x 升至 5 年 95%+ 高位、GF Value 評估「適度高估」",
    ],
    # 一句結論
    "bottom_line": "今日（2026-06-04 Thu）報告摘要：✅ 6/3 Wed 台股 2330 實際收 NT$2,425（+45，+1.89% vs 6/2 NT$2,380）創歷史新高、跟進 NYSE TSM 6/2 大漲訊號 + Intel CEO 6/2 keynote 確認 TSMC「長期信任夥伴」雜訊清除催化；台股加權指數續站穩 45,000+。📉 NYSE TSM 6/3 Wed 收 $436.69（-$10.00，-2.24% vs 6/2 史新高 $446.69）——自盤中 52w 新高 $449.39 高位獲利了結、技術性回檔修正，估值警示：P/E 升至 5 年 95%+ 高位、GF Value 評估 TSM「適度高估」、RSI 進入超買區、6 月 1 日至 6/3 已從 $439.78 → $446.69 → $436.69、自史高累計獲利空間大、短線多頭動能消化中。今日（6/4 Thu）台股 2330 估跟進 NYSE 回檔，估收 NT$2,400（-25，-1.03% vs 6/3 NT$2,425）、估盤中區間 NT$2,385-2,420、估量 52,000 張放量整理。台美 ADR 溢價估自 +14.6% 收斂至 +13.0%（理論值 = 5 × 2,400 ÷ 31.05 = $386.47，溢價 = ($436.69-$386.47)/$386.47 = +13.0%）。⭐ 結構性利多續存：（1）Intel CEO 確認 TSMC「長期信任夥伴」、續委外先進晶片——清除 Apple/Intel 客戶集中度雜訊；（2）NVIDIA 6/1 宣布 TSMC 全面導入 NVIDIA AI 與加速計算技術——cuLitho 運算光刻效率 +20-50%、cuEST 化學模擬加速 50 倍、Omniverse FabTwin 數位孿生；（3）黃仁勳 6/1 GTC Taipei keynote 揭 Vera Rubin 正式量產 + 150 家台廠供應鏈夥伴；（4）NVIDIA $150B/年投資台灣承諾；（5）TSMC 3nm 下半年漲價 15%、2027 再漲 5-10%；（6）TSMC 2026 營收成長指引上修至 >30%；員工分紅年增 >30%；（7）SIA/Deloitte 6/1 報告估 2028 AI 資料中心晶片年營收 $1.2 兆、4 年成長 10 倍、晶片占 AI 機櫃價值 95%。📊 Broadcom (AVGO) 6/3 盤後財報關鍵：TSMC #3 客戶 13%、Custom XPU + AI 營收續爆發、前一季 AI 營收 +106% YoY、6/4 台股反應財報結果。🏆 NVDA Q1 FY27 財報 5/20 大超預期：營收 $81.6B（+85% YoY）、Data Center $75.2B（+92% YoY）、Q2 guidance $91.0B、$80B 回購。⚠️ 短線雜訊：（1）⚠️ NYSE TSM 6/3 自史高 -2.24% 回檔、估值警示 P/E 36-37x 已升至 5 年 95%+ 高位、需財報數據持續驗證；（2）GF Value 評估 TSM「適度高估」；（3）TSMC 對前主管 Wei-Jen Lo 訴訟（2nm 商業機密、轉投 Intel）持續中；（4）Apple 部分晶片轉 Intel 18A 雜訊未完全消化。基本面：Q1 2026 淨利 NT$572.5B（$18.2B，+58.3% YoY）、毛利率 66.2% 雙創史高；2026 全年 >30% 成長指引；CapEx $52-56B 高端確認；A14/A16 製程路線完整、NVIDIA 為 A16 首發客戶。即將事件：（1）Broadcom AVGO 6/3 盤後財報；（2）TSMC 5 月月營收預計 6/10 前公布；（3）COMPUTEX 2026 6/2-6 末日 6/6；（4）Q2 2026 財報 7/16 公布。技術面：6/4 估回檔、估收 NT$2,400、估盤中區間 NT$2,385-2,420；RSI 估自 70 降至 65、MACD 紅柱估收斂、KDJ J 估自 96 高檔下行；下方支撐 NT$2,380（6/2 收）/ NT$2,355（6/1 收）/ NT$2,300 心理整數。32 位分析師全數看多，0 賣出。",
    # 重大警示（選填，空白則不顯示）
    "risk_alert":  "今日（6/4 Thu）關鍵觀察：（1）📉 NYSE TSM 6/3 自史高 $449.39 高位回檔 -2.24% 收 $436.69 為今日台股最大壓力源；（2）✅ 台股 2330 6/3 實際收 NT$2,425 創歷史新高、+1.89% 跟進 NYSE 6/2 大漲訊號；（3）📊 6/4 台積電估跟進 NYSE 回檔、估收 NT$2,400（-1.03%）量增整理；（4）📊 Broadcom 6/3 盤後財報為短線催化、6/4 台股反應、TSMC #3 客戶 AI 營收動能驗證；（5）🤝 Intel CEO 6/2 keynote 確認 TSMC「長期信任夥伴」雜訊清除為結構性利多基底；（6）🤝 NVIDIA-TSMC AI 製程合作（cuLitho/cuEST/FabTwin）續發酵；（7）⭐ NVIDIA $150B/年投資台灣 + TSMC 3nm 漲價 15% + 2026 營收 >30% 為長線多頭基底；（8）⚠️ 估值警示：P/E 36-37x 已升至 5 年 95%+ 高位、GF Value「適度高估」、RSI 進入超買區、需財報數據持續驗證；（9）⚠️ TSM ADR 自 6/2 史高 $449.39 回檔 -2.84%、6/3 收 $436.69 仍站穩 $430、技術觀察 $430 防線；（10）⚠️ TSMC 對前主管 Wei-Jen Lo 訴訟（2nm 商業機密、轉投 Intel）持續中；（11）⚠️ 台美 ADR 溢價估自 +14.6% 收斂至 +13.0%、ADR 領先回檔修正；（12）台幣 31.05 升值壓力結構性續存；（13）CoWoS/ABF 基板瓶頸 + 美中 AI 晶片出口管制持續；（14）🎯 結構性催化續存：TSMC 上修 2030 全球晶片市場至 $1.5T + SIA/Deloitte 估 2028 AI 晶片 $1.2T + CoWoS 良率破 98% + NVIDIA $150B/年投資 + 3nm 漲價 15% + Intel 確認長期夥伴為長線多頭基底；（15）短線觀察：6/4 估能否守住 NT$2,380（6/2 收）支撐 / 是否跌破 NT$2,400 心理整數",
}

# 三大法人買賣超（張）— 最新一日
INSTITUTIONAL = {
    "date":     "2026-06-04",
    "foreign":  -8500,    # 外資（6/4 估算，跟進 NYSE 6/3 -2.24% 回檔反手賣超）
    "trust":    +1800,    # 投信（6/4 估算，續買但動能收斂）
    "dealer":   -500,     # 自營商（6/4 估算，避險賣超）
    # 近5日（由舊到新：5/29, 6/1, 6/2, 6/3, 6/4）
    "foreign_5d": [+9500, +2000, +9500, +18500, -8500],     # 6/3 實際估 +18,500（跟進 NYSE 6/2 大漲 + Intel CEO 利多）；6/4 估 -8,500 回檔反手
    "trust_5d":   [+2000, +1500, +2200, +3200, +1800],       # 6/3 +3,200；6/4 估 +1,800 動能收斂
    "dealer_5d":  [+1000, +800, +1000, +1800, -500],         # 6/3 +1,800；6/4 估 -500 避險賣超
    "foreign_ownership_pct": "75.5%",  # 外資持股比例（估，6/3 大買後 6/4 微降）
    "foreign_ownership_shares": "約 195.8 億股",
}

# 技術分析指標（需每日從看盤軟體更新）
TECHNICAL = {
    "rsi_14":       65.0,   "rsi_signal": "RSI 估自 70 降至 65（6/3 +1.89% 創史高後，6/4 估回檔、超買壓力部分消化），多頭動能仍存但收斂",
    "macd":         +1.8,   "macd_signal": "MACD 估 +1.8 紅柱（6/4 回檔下動能收斂），多頭排列維持但短線轉弱",   "macd_color": "#FF9800",
    "kdj_k":        76.0,   "kdj_d": 78.0, "kdj_j": 72.0, "kdj_signal": "KDJ K(76)/D(78)/J(72)，J 自 96 高檔回落、初步死叉訊號浮現",
    "ma5":       "2,392",   # 5MA（6/1 2355, 6/2 2380, 6/3 2425, 6/4 估 2400）
    "ma20":      "2,325",   # 20MA 上揚
    "ma60":      "2,240",   # 60MA 上揚
    "ma120":     "2,110",
    "bb_upper":  "2,460",   # 布林上軌
    "bb_mid":    "2,325",   # 布林中軌（20MA）
    "bb_lower":  "2,190",   # 布林下軌
    "vol_ma5":  "48,500",   # 5日均量（張，估）
    "trend":    "✅ 6/3 Wed 台股 2330 實際收 NT$2,425（+45，+1.89% vs 6/2 NT$2,380）創歷史新高、跟進 NYSE TSM 6/2 大漲訊號 + Intel CEO 6/2 keynote 確認 TSMC「長期信任夥伴」雜訊清除催化；台股加權指數續站穩 45,000+。📉 NYSE TSM 6/3 Wed 收 $436.69（-$10.00，-2.24% vs 6/2 史新高 $446.69）自盤中 52w 新高 $449.39 高位獲利了結、技術性回檔修正——多項估值警示：P/E 升至 5 年 95%+ 高位、GF Value 評估「適度高估」、RSI 進入超買區。今日（6/4 Thu）台股 2330 估跟進 NYSE 回檔，估收 NT$2,400（-25，-1.03% vs 6/3 NT$2,425）、估盤中區間 NT$2,385-2,420、估量 52,000 張放量整理。技術面：RSI 估自 70 降至 65、MACD +1.8 紅柱動能收斂、KDJ K(76)/D(78)/J(72) J 自 96 高檔回落初步死叉；5MA NT$2,392 / 20MA NT$2,325 / 60MA NT$2,240 / 120MA NT$2,110 均線多頭排列維持、中期結構穩固但短線轉弱。下一觀察：（1）6/4 能否守住 NT$2,400 心理整數 + NT$2,380（6/2 收）支撐；（2）回檔關卡 NT$2,380 / NT$2,355（6/1 收）/ NT$2,300 心理整數；（3）反彈壓力 NT$2,425（6/3 史高）/ NT$2,430（6/3 盤中高）/ NT$2,450（Barclays $470 對應）；（4）📊 Broadcom 6/3 盤後財報結果為 6/4 開盤關鍵；（5）🤝 NVIDIA-TSMC AI 製程合作為結構性利多；（6）🤝 Intel CEO 確認 TSMC「長期信任夥伴」清除雜訊；（7）⭐ NVIDIA $150B/年投資台灣 + TSMC 3nm 漲價 15% 為結構性多頭利多；（8）🎯 SIA/Deloitte 2028 AI 晶片 $1.2T + TSMC 上修 2030 全球晶片市場至 $1.5T 為結構性催化。",
    "support":  "2,400 / 2,380 / 2,355 / 2,300 (心理整數、6/2 收、6/1 收)",
    "resist":   "2,425 / 2,430 / 2,450 / 2,500 (6/3 史高、Barclays對應)",
    "note": "技術指標數值為估算，請以看盤軟體即時數據為準；6/3 實際 +1.89% 創史高、6/4 估跟進 NYSE 回檔 -1.03%、需觀察 NT$2,400 心理整數與 NT$2,380 支撐",
}

# 期貨與選擇權（來源：台灣期交所 TAIFEX）
DERIVATIVES = {
    "date":          "2026-06-04",
    "futures_price": "2,395",      # 台積電期貨近月（估，6/4 回檔貼水）
    "futures_oi":    "162,000",    # 未平倉量（口）（估，回檔下未平倉增加）
    "futures_basis": "-5",         # 逆價差 -5 點（ADR 回檔 + 短線避險）
    "call_oi":       "108,000",
    "put_oi":        "72,000",
    "pcr":           "0.67",       # Put/Call 比率（中性偏多區、自看多區上移）
    "pcr_signal":    "中性偏多（Put/Call 0.67 自 0.57 上移至中軸 0.70 下方、ADR 回檔下避險買盤升溫；結構性利多續存：Intel 確認長期夥伴 + NVIDIA-TSMC AI 合作）",
    "max_pain":      "2,400",      # 最大痛苦價格（近期到期、6/4 心理整數）
    "key_strikes": [
    ...
    "note": "衍生品數據需每日至台灣期交所(taifex.com.tw)更新；6/3 實際 +1.89% 創史高、6/4 估回檔 -1.03% 逆價差 -5、Put/Call 0.67 中性偏多區、Intel CEO 確認長期夥伴 + NVIDIA-TSMC AI 合作 + 3nm 漲價 15% + Vera Rubin 量產結構性利多續存",
}
...
ECOSYSTEM_STOCKS = [
    ...
    ("客戶", "AVGO",    "博通",        "446.50", "-0.38%", "📊 #3 客戶 13%（6/3 盤後財報關注；Custom XPU 訂單續強、ASIC 增速 +44.6%）"),
...
CONSENSUS = {
    ...
    "upside":       "+5.4%",    # 從 NT$2,400（6/4 估收盤）到 NT$2,530
}
...
IR_CALENDAR = [
    ...
    ("2026-06-04", "📊 今日：估跟進 NYSE 回檔 NT$2,400（-1.03%）；Broadcom 6/3 盤後財報關注","今日（6/4 Thu）台股 2330 估跟進 NYSE 6/3 -2.24% 回檔，估收 NT$2,400（-25，-1.03% vs 6/3 NT$2,425）、估盤中區間 NT$2,385-2,420、估量 52,000 張放量整理；📊 Broadcom (AVGO) 6/3 美股盤後公布財報為 6/4 開盤關鍵（TSMC #3 客戶 13%、Custom XPU + AI 營收續爆發、前一季 AI 營收 +106% YoY）；🤝 NVIDIA-TSMC AI 製程合作（cuLitho/cuEST/FabTwin）續發酵；🤝 Intel CEO 確認 TSMC「長期信任夥伴」雜訊清除續存；🚀 SIA/Deloitte 6/1 報告：2028 AI 資料中心晶片年營收 $1.2 兆、4 年成長 10 倍、晶片占 AI 機櫃價值 95%；⚠️ 估值警示：P/E 36-37x 升至 5 年 95%+ 高位、GF Value 評估「適度高估」、RSI 進入超買區；本日關注：突破 NT$2,425 重返史高、回檔關卡 NT$2,400 心理整數/NT$2,380（6/2 收）/NT$2,355（6/1 收）","#FFE0B2"),
...
# 總體經濟監控
MACRO = [
    ("SOX 半導體指數",  "12,265.50","-1.76%", False),  # 6/3 SOX 自史高回檔（高位獲利了結）
    ("台股加權指數",    "45,920.00","+0.65%", False),  # 6/3 加權指數估（續站穩 45,000+，6/4 估略回檔）
    ("VIX 恐慌指數",    "14.5",    "+0.5",   False),   # 恐慌指數微升、回檔下風險溢價
    ("WTI 原油",        "$69.5",   "-0.43%", False),   # 油價微跌
    ("10Y 美債殖利率",  "4.16%",   "+0.02pp",False),   # 殖利率小幅回升
    ("台幣/美元",       "31.05",   "0.00",   False),   # 台幣持穩（每升值 1% 毛利率 -40bps）
    ("NVIDIA NVDA",     "$249.80", "-1.34%", True),    # #1 TSMC 客戶（22%），6/3 自高位回檔（仍 +85% YTD）
    ("ASML",            "$782.50", "-1.60%", False),   # 設備股 6/3 跌；TSMC $52-56B CapEx 上限確認
]
...
VALUATION = {
    "pe_current":   35.3,   # 同 STOCK["pe_ratio"]（6/4 估 NT$2,400）
    ...
    "pb_current":  12.50,   # 同 STOCK["pb_ratio"]（6/4 估 NT$2,400）
    "pb_5y_avg":     5.8,
    "pb_5y_pct":      96,
...
RELATIVE = {
    "date":           "2026-06-04",
    "tsmc_tw_1d":     -1.03,   # 2330 6/4 估收 NT$2,400（-25 vs 6/3 NT$2,425）
    "taiex_1d":       -0.30,   # 加權指數 6/4 估略回檔
    "sox_1d":         -1.76,   # SOX 6/3 自史高回檔
    "tsmc_nyse_1d":   -2.24,   # TSM ADR 6/3 $436.69（vs 6/2 史新高 $446.69）
    "tsmc_tw_5d":     +1.91,   # 5 日（NT$2,400 vs 5/28 NT$2,355）
    "taiex_5d":       +5.50,
    "tsmc_tw_1m":     +12.41,  # 月線（NT$2,400 vs ~NT$2,135 一個月前 4/30）
    "taiex_1m":       +14.5,
    "tsmc_tw_ytd":    +14.56,  # YTD 累計（NT$2,400 vs 年初 ~NT$2,095）
    "taiex_ytd":      +16.5,
    "sox_ytd":        +75.4,   # SOX YTD +75.4% 強勢上漲（6/3 回檔後）
    "beta_60d":        1.35,   # 60 日滾動 Beta vs TAIEX
    # ADR 折溢價（以 6/3 NYSE 最新收盤計算）
    "adr_price":     436.69,   # TSM NYSE 6/3 最新收盤（自 6/2 史高 $446.69 回檔 -2.24%）
    "adr_parity":    386.47,   # 理論值 = 5 × NT$2,400 ÷ 31.05
    "adr_ratio":     "5:1",    # 1 ADR = 5 台積電普通股
    "usd_ntd":        31.05,   # 同 MACRO 台幣匯率
    "adr_premium_pct": "+13.0", # (436.69 - 386.47) / 386.47 × 100 = +13.0%（ADR 領先回檔、溢價自 +14.6% 收斂）
    "note": "ADR 理論值 = 5 × 台股收盤 ÷ 匯率（不含交易摩擦與流動性溢價）。📉 6/3 NYSE TSM 自史新高 $446.69 回檔 -2.24% 收 $436.69、自盤中 52w 高 $449.39 高位獲利了結（多項估值警示：P/E 升至 5 年 95%+ 高位、GF Value 評估「適度高估」、RSI 超買）；台美 ADR 溢價自 +14.6% 收斂至 +13.0%；結構性多頭基底續存：NVIDIA $150B/年台灣投資 + 3nm 漲價 15% + NVIDIA-TSMC AI 製程合作 + Vera Rubin 量產 + Intel 確認長期夥伴",
}
...
NEWS = [
    {
        ...
        "title": "📊 Broadcom (AVGO) 6/3 盤後財報；TSMC #3 客戶（13%）、Custom XPU + AI 營收續爆發；6/4 台股開盤關鍵",
        "body": "TSMC 第 3 大客戶 Broadcom (AVGO) 6/3 美股盤後公布最新季度財報、為今日（6/4 Thu）台股半導體族群最關鍵催化：（1）前一季（FY Q1 2026）營收年增 29% 至史高 $19.3B、半導體解決方案部門 +52% 至 $12.5B、AI 相關營收倍增 +106% 至 $8.4B——市場高度關注本季 AI / Custom XPU 動能能否延續；（2）Broadcom Custom ASIC（XPU）由 TSMC 3nm + CoWoS 代工、為 Google TPU、Meta MTIA 等超大規模客戶設計；（3）TrendForce 估 2026 Custom ASIC 增速首度超越 GPU（+44.6% vs +16.1%）、利於 Broadcom 訂單成長；（4）AVGO 財報若超預期將直接驗證 TSMC 先進製程 + CoWoS 封裝需求結構性多頭、或舒緩 TSM 6/3 -2.24% 自史高回檔的修正壓力；（5）AVGO 6/3 收 $446.50（-0.38%）、TSMC CoWoS 產能 Broadcom 占約 12%；（6）財報結果將直接決定 6/4 台股 2330 開盤方向與 SOX 短線走勢。",
