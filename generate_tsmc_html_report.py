...
SUMMARY = {
    ...
    # 一句結論
    "bottom_line": "報告日期：2026-07-29 Wed（最新確認收盤：台股 2330 7/28 Tue 官方收 NT$2,280（-70、-2.98% vs 7/27 NT$2,350、開 2,270／高 2,305／低 2,270、量 45,333 張 TWSE 口徑、成交額 NT$1,036.24 億、成交 463,044 筆、TWSE 確認）；NYSE TSM 7/28 收 $392.31（-$6.78、-1.70%、Yahoo API 確認））。📊 核心判讀：韓股槓桿斷頭引爆亞股系統性股災、2330 相對抗跌但中期支撐全數失守——（1）韓股 7/28 熔斷為風暴中心：KOSPI -10.8% 創近 20 年最大單日跌幅、三星 -13.39%、SK 海力士 -14.65%（盤中一度 -30%）——AI 基建融資疑慮＋中國記憶體產能競爭＋雙倍槓桿 ETF 斷頭賣壓三重共振；（2）台股 7/28 暴跌 -2,030.83 點（-4.65%）收 41,603.36 為史上第 3 大跌點——電子 -5.11%、半導體類指 -4.42%；2330 收 2,280（-2.98%）跌幅明顯小於大盤與供應鏈（聯發科/聯電 -9.9%、華邦電跌停）、續居抗跌角色，惟 60MA 2,347（季線）、7/17 低 2,290、布林下軌 2,289 一次全數失守——中期多空架構正式轉空；（3）籌碼再轉空：外資對 2330 賣超擴大至 -14,659 張（連 5 賣）、全市場 BFI82U 三大法人大賣 -1,176.0 億（外資 -874.8 億）——上日「籌碼改善」一日翻覆；惟自營 +5,123 連 4 買且大幅擴大、投信 +284 連 3 買，本土資金逢低承接；（4）📊 美股同日僅溫和下跌且結構分化：TSM -1.70%（相對抗跌）、SOX -4.49% 自史高 -24.6%——跌勢集中記憶體/設備（MU -8.85%、AMAT -7.82%、AMKR -24.74%），NVDA +0.25%／AAPL +0.94% 翻紅、VIX 不升反降至 18.21——顯示賣壓屬亞洲槓桿去化外溢、非美股本土恐慌，系統性風險層級低於 7/17；（5）⭐ 今晨韓股初步止穩（三星盤中 +3.6%、SK 持平）＋SK 海力士今日 Q2 財報（估營益 ~64 兆韓元創史高）——若電話會確認 HBM 供需健康、有望成為反彈催化。技術面：RSI 40.8、MACD 綠柱 -33.9 急擴、DIF -9.3 深陷零軸下（中期空方動能確立）、KDJ J 9.5 超賣——短線嚴重超跌、技術性反彈條件累積中；收復布林下軌 2,289 → 7/28 高 2,305 → 2,320 為修復三關卡、失守 2,270 下看 2,230／2,200。📊 ADR 溢價回擴至 +11.2%（匯率 32.30）——台股補跌壓力獲緩衝。✅ 基本面錨完全未變：Q2 營收 $40.20B（+33.7% YoY）、EPS $4.31/ADR（+77.4%、連 11 季超預期）、毛利率 67.7%、全年上修 >40%、CapEx $60-64B、2nm Q3 放量＋2027 漲價傳聞；本輪為韓股槓桿去化引發之系統性風險、非台積電個別利空。⭐ 今日（7/29）觀察：（1）韓股止穩延續性＋SK 財報電話會 HBM 定調；（2）2330 守 2,270／收復 2,289；（3）外資賣超能否自 -14,659 收斂；（4）今晚 MSFT/META 財報前美股風向。⚠️ 風險：KOSPI 槓桿去化未止、SOX 熊市加深、AI CapEx 指引不及預期、美 232 條款調查 7 月底出爐、台幣 ~32.30（每升值 1% 毛利率 -40bps）。",
    # 重大警示（選填，空白則不顯示）
    "risk_alert":  "今日（7/29 Wed）關鍵觀察：（1）⚠️ 韓股股災延續性為最大變數：KOSPI 7/28 熔斷 -10.8%（近 20 年最大跌幅、今年第 8 次熔斷）——導火線為 AI 基建融資疑慮＋中國記憶體產能競爭＋5 月以來雙倍槓桿 ETF 堆積的投機部位斷頭；今晨三星盤中反彈 ~+3.6%、SK 海力士持平——初步止穩但槓桿去化是否結束未知；（2）📅 SK 海力士今日公布 Q2 財報：市場一致預期營益 ~64 兆韓元（年增近 6 倍、創史上新高）——「基本面創高、股價暴跌 -14.7%」的極端背離下，電話會對 HBM 供需持續性與資本支出的定調將直接決定 AI 記憶體敘事走向、外溢台股半導體；（3）📊 2330 多空檢核：收 2,280 已跌破 60MA 2,347（季線）、7/17 低 2,290 與布林下軌 2,289——中期架構轉空；守 2,270（7/28 低）則超賣反彈可期（KDJ J 9.5、量 45,333 張未達 7/17 恐慌量 97,362 的一半）、失守下看 2,230／2,200；收復 2,289 → 2,305 → 2,320 為修復三關卡；（4）✅ 相對正面訊號：美股未跟進恐慌（VIX 反降 18.21、NVDA/AAPL 翻紅）、自營連 4 買大幅擴大 +5,123 張低接、ADR 溢價 +11.2% 提供緩衝、油價續穩 WTI ~$82.6；（5）📅 今晚（美東 7/29）MSFT/META、明晚 AAPL/AMZN 財報——AI CapEx 指引為 TSMC 訂單能見度直接風向球；💱 美 232 條款半導體調查 7 月底出爐（台美談判傳關稅 20%→~15%）、台幣 ~32.30 續為背景風險",
}
...
ECOSYSTEM_STOCKS = [
    ...
    ("記憶", "000660.KS","SK 海力士",  "1,550,000 KRW", "-14.65%", "⚠️ 7/28 熔斷日暴跌 -14.65% 收 155.0 萬韓元（盤中一度 -30%、Yahoo API）——雙倍槓桿 ETF 斷頭賣壓；7/29 盤中 ~155.1 萬持平初步止穩；今日公布 Q2 財報（市場估營益 ~64 兆韓元創史高）"),
    ...
    ("客戶", "2454.TW", "聯發科",      "3,315",  "-9.92%", "⚠️ 手機 SoC 客戶 9%（7/28 重挫 -9.92% 收 3,315、TWSE 官方——貼近跌停、台股權值殺戮）"),
...
NEWS = [
    {
        ...
        "title": "⚠️⚠️ 韓股熔斷：KOSPI 暴跌 -10.8%、記憶體雙雄重挫 13-15%",
        "body": "7/28 韓國 KOSPI 暴跌 -10.8%、創近 20 年最大單日跌幅、觸發今年第 8 次熔斷：（1）⚠️ 三星電子 -13.39% 收 22.0 萬韓元、SK 海力士 -14.65% 收 155.0 萬韓元（盤中一度跌逾 -30%）、鎧俠 -18%；（2）📊 導火線三重共振：AI 基礎建設融資過度槓桿化疑慮＋中國記憶體產能競爭加劇＋5 月以來雙倍槓桿 ETF 堆積的投機部位斷頭賣壓；（3）⭐ 今晨（7/29）初步止穩：三星盤中反彈至 ~22.8 萬（約 +3.6%）、SK 盤中持平；（4）🎯 屬槓桿去化的機械性賣壓、非基本面轉向——去化是否結束為本週亞股最大變數。",
        "source": "CNBC / Bloomberg / US News 2026-07-28", "impact": "負面",
    },
    {
        "tag": "產業趨勢", "tag_color": "#4CAF50",
        "title": "⚠️ 台股史上第 3 大跌點 -2,030 點、2330 收 2,280 失守季線",
        "body": "韓股股災情緒傳染、台股 7/28 全面重挫：（1）⚠️ 加權指數暴跌 -2,030.83 點（-4.65%）收 41,603.36、史上第 3 大單日跌點——電子 -5.11%、半導體類指 -4.42%、成交額 8,094.82 億；（2）📊 2330 收 NT$2,280（-70、-2.98%、量 45,333 張）——跌幅小於大盤與供應鏈（聯發科 -9.92%、聯電 -9.92%、日月光 -8.88%、華邦電跌停）、續為抗跌權值，惟 60MA 2,347（季線）與布林下軌 2,289 雙雙失守；（3）⚠️ 外資賣超擴大至 -14,659 張（連 5 賣）、全市場三大法人大賣 -1,176 億；（4）✅ 自營 +5,123 張連 4 買大幅低接、投信連 3 買——本土資金逢低承接。",
    ...
    },
    {
        ...
        "title": "📅 SK 海力士今日 Q2 財報：市場估獲利創史高、與股價暴跌極端背離",
        "body": "AI 記憶體敘事的關鍵驗證日：（1）📅 SK 海力士 7/29（今日）公布 Q2 財報——14 家券商一致預期營收 ~84 兆韓元、營業利益 ~64 兆韓元（年增近 6 倍、創史上新高）、主要受惠 HBM 需求；（2）📊 三星 7/7 已公布 Q2 初值：營益暴增至 89.4 兆韓元；（3）⚠️ 「基本面創史高、股價暴跌 -14.7%」的極端背離——市場賣的是槓桿與融資疑慮、不是獲利；（4）🎯 電話會對 HBM 供需持續性、資本支出與 AI 基建融資結構的定調，將直接決定記憶體股災是否止血、外溢台股半導體。",
        "source": "華爾街見聞 / 新浪財經 2026-07-26~28", "impact": "中性",
    },
    {
        "tag": "產品發布", "tag_color": "#9C27B0",
        "title": "✅ NVIDIA/Broadcom CPO 交換器小量出貨——台積電 COUPE 封裝迎量產",
        "body": "共同封裝光學（CPO）邁入量產里程碑：（1）✅ NVIDIA Spectrum-X CPO 交換器（與台積電合作開發、採 COUPE 先進封裝製程）與 Broadcom 51.2T Bailly CPO 交換器已進入小量出貨階段；（2）📊 光引擎良率與先進封裝產能為擴產最大瓶頸、預計 2026 下半年進一步擴產；（3）🎯 CPO 為 AI 資料中心互連的下一代方案——台積電 COUPE 平台卡位光電整合、先進封裝訂單能見度再添一柱；（4）💡 在記憶體股災的恐慌情緒中、屬被市場忽略的結構性正面進展。",
        "source": "TechNews 科技新報 2026-07-27", "impact": "正面",
    },
    {
