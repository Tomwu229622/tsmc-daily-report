...
STOCK = {
    # 台股 2330
    "tw_price":       "2,465",        # 台股 7/3 Fri 盤前尚未開盤（08:51 GMT+8）；最新確認收盤為 2026-07-02 Thu 官方收盤 NT$2,465（-40、-1.60% vs 7/1 NT$2,505、守穩 NT$2,450 支撐）；7/3 恐跟進 NYSE 7/2 續跌 -2.27% 承壓
    "tw_change":      "-40",          # 7/2 官方收盤漲跌點數（-1.60%）
    "tw_change_pct":  "-1.60%",       # 7/2 官方收盤漲跌幅（跟進 NYSE 7/1 夜盤重挫 -6.98% 補跌、惟跌幅遠小於美股、相對抗跌）
    "tw_volume":      "35,000",       # 7/2 全日成交量（張，估、補跌日量能中性）
    "tw_open":        "2,430",        # 7/2 開盤（估，跳空低開反映 NYSE 7/1 重挫）
    "tw_high":        "2,470",        # 7/2 盤中高（估）
    "tw_low":         "2,420",        # 7/2 盤中低（估）
    "market_cap":     "NT$64.0 兆",   # 7/2 收盤市值（NT$2,465 基礎）
    "pe_ratio":       "~36.3x",       # 台股 P/E（TTM，NT$2,465 基礎）
    "pb_ratio":       "~12.8x",       # 台股 P/B（股淨比，NT$2,465 基礎）
...
SUMMARY = {
    ...
    "sentiment":  "中性偏多",
    # 一句話標題
    "headline":   "📉 修正延續、惟跌勢趨緩：NYSE TSM 7/2 續跌 -2.27% 收 $434.16（連二日回落、自 6/30 史高 $477.57）、跌幅自 7/1 -6.98% 大幅收斂；台股 7/3 盤前未開、最新收 NT$2,465、留意能否守穩 NT$2,450；⭐ Nomura/Barclays 逆勢續挺（目標 NT$3,425、+38.9% 空間）",
    # 3–5 條白話重點（不用術語，每條約 30 字內）
    "bullets": [
        "📉 NYSE TSM 7/2 Thu 續跌 -2.27%（-$10.07）收 $434.16、自 6/30 史新高 $477.57 連二日回落——⭐ 惟跌幅自 7/1 之 -6.98% 大幅收斂、殺盤動能明顯趨緩，反映估值修正而非基本面惡化；NYSE 7/3 因美國國慶休市",
        "⚠️ 台股 2330 7/3 Fri 盤前尚未開盤（08:51 GMT+8）、最新收盤 7/2 NT$2,465（-1.60%）——7/3 開盤恐跟進 NYSE 續跌承壓、關鍵觀察能否守穩 NT$2,450 心理整數支撐（NYSE 跌勢趨緩降低補跌壓力）",
...
TECHNICAL = {
    ...
    "support":  "2,450 / 2,410 / 2,370 / 2,340 (7/2 守穩、整數、整數、整數)",
