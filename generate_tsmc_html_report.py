...
STOCK = {
    ...
    # NYSE TSM ADR
    "nyse_price":     "434.71",       # 7/2 Thu 官方收盤 $434.71（+$0.55、+0.13%；4:00 PM EDT、marketbeat 確認；盤後 $437.44 +0.63%；為最新確認收盤）；NYSE 7/3 Fri 因美國國慶（7/4 週六順延至 7/3）休市、7/6 Mon 重新開盤（美股 7/6 盤待今晚 GMT+8）
    "nyse_change":    "+0.55",        # 7/2 漲跌（最新確認收盤、4:00 PM EDT；7/1 重挫後止穩收紅）
    "nyse_change_pct":"+0.13%",       # 7/2 NYSE 小幅收紅（7/1 重挫後低檔止穩、盤後續揚 +0.63%）
    "52w_high_nyse":  "479.00",       # 52 週/歷史高（區間，6/30 收 $477.57）
    "52w_low_nyse":   "223.70",       # 52 週低（區間）
    "pe_nyse":        "~37.8x",       # NYSE USD 基礎 P/E（TTM，$434.71 基礎）
    "pb_nyse":        "~12.9x",
    "beta":           "1.18",
...
SUMMARY = {
    ...
    "sentiment":  "中性偏多",
    # 一句話標題
    "headline":   "⚖️ 修正後止穩、分析師大幅續挺：台股 2330 7/3 收 NT$2,445（-0.81%、跌幅收斂）、NYSE TSM 7/2 於 7/1 重挫後止穩收紅 +0.13%（$434.71、盤後 +0.63%）；🚀 Barclays 上調目標至 $625（+43.8% 空間）、Nomura NT$3,425；NYSE 7/6 重新開盤",
    ...
    "bullets": [
        ...
        "⭐ NYSE TSM 7/2 Thu 於 7/1 重挫後低檔止穩、小幅收紅 +0.13%（+$0.55）收 $434.71、盤後續揚 +0.63% 至 $437.44——反映估值修正而非基本面惡化；NYSE 7/3 因美國國慶休市、7/6 重新開盤",
        "🚀 分析師逆勢大幅續挺：Barclays 將 TSM 目標價自 $470 大幅上調至 $625（維持 Overweight、自 $434.71 具 +43.8% 空間）；Nomura 上調台股目標至 NT$3,425（自 NT$2,445 具 +40.1% 空間）",
...
TECHNICAL = {
    ...
    "trend":    "⚖️ 修正後止穩：NYSE TSM 7/2 於 7/1 重挫後低檔止穩、小幅收紅 +0.13% 收 $434.71、盤後續揚 +0.63% 至 $437.44、殺盤動能衰竭；台股 2330 7/3 官方收 NT$2,445（-0.81%）跌幅較 7/2 之 -1.60% 收斂、守穩 NT$2,410 支撐、站穩 20MA NT$2,415。📊 技術面（基於 7/3 官方收盤 NT$2,445）：RSI 自 60 回落至 55 退出超買區、MACD +0.40 紅柱續縮但仍為正、KDJ J 值遠離超買、短線過熱壓力已緩解，中期 60MA/120MA 趨勢仍偏多。下一觀察：（1）NYSE 7/6 Mon 重新開盤後方向、美股半導體假期後表現；（2）台股 7/6 能否守穩 NT$2,410 / NT$2,370 支撐；（3）上方壓力 NT$2,465 / NT$2,505 / NT$2,535 史高；（4）🚀 Barclays 上調目標至 $625 + Nomura NT$3,425 + 共識強力買入為中長線支撐、惟須留意 6 月營收（7 月上旬）與 7/16 財報、Goldman 移出 APAC Conviction List；（5）⭐ 中長線基底未變：NVIDIA #1 客戶/A16 首發 + Vera Rubin 6 顆晶片全 TSMC 代工 + 2nm 70-80% 良率。",
    "support":  "2,410 / 2,370 / 2,340 (7/3 守穩 2,410)",
    "resist":   "2,465 / 2,505 / 2,535 (7/2 收、7/1 收、史高)",
    "note": "技術指標數值為估算（基於 7/3 官方收盤 NT$2,445），請以看盤軟體即時數據為準；NYSE TSM 7/2 於 7/1 重挫後止穩收紅 +0.13% 收 $434.71、盤後 +0.63% 至 $437.44、殺盤動能衰竭；台股守穩 NT$2,410 支撐、RSI 自 60 回落至 55 退出超買、KDJ J 值遠離超買、MACD 紅柱續縮仍為正；上方壓力 NT$2,465 / NT$2,505 / NT$2,535 史高、下方支撐 NT$2,410 / NT$2,370；🚀 Barclays/Nomura 上調目標 + 漲價定價力+共識偏多 vs ⚠️ 6 月營收與下游需求雜訊拉鋸；NYSE 7/6 重新開盤、台股 7/6 盤中待 TWSE",
}
...
DERIVATIVES = {
    ...
    "pcr_signal":    "中性（Put/Call 7/3 估 0.70；台股 7/3 收 NT$2,445（-0.81%）跌幅收斂、NYSE TSM 7/2 止穩收紅 +0.13%、避險買盤趨緩、逆價差收斂至 -5；⭐ 台股守穩 NT$2,410、Barclays 上調目標 $625 + Nomura NT$3,425 + 共識偏多為中長線支撐；NYSE 7/6 重新開盤）",
...
ANALYST_RATINGS = [
    ...
    ("Barclays",       "增持",     "US$625",   "2026-07-02", "🚀 7/2 大幅上調目標價自 $470 至 $625（維持 Overweight、自 7/2 收 $434.71 具 +43.8% 空間）；AI 需求結構性 + A14/A16 領先、TSMC 為 AI CapEx 循環終極受惠者"),
...
CONSENSUS = {
    ...
    "low_target":   "NT$2,100",
    "avg_target_us":"US$490.34",    # 分析師 12 個月平均目標（高 $625 Barclays / 低 $351；自 7/2 收 $434.71 具 +12.8% 上行空間；Barclays 7/2 上調至 $625、Nomura 上調台股目標至 NT$3,425；Goldman 7/1 移出 APAC Conviction List）
    "analyst_count": 32,
    "buy": 32, "hold": 0, "sell": 0,
    "upside":       "+12.80%",  # 從 NYSE 7/2 收 $434.71 至平均目標 $490.34（拉回視為估值修正、共識強力買入；待 7/16 法說會後重估）
}
...
IR_CALENDAR = [
    ...
    ("2026-07-03", "⚖️ 台股止穩、NYSE 國慶休市", "7/3 Fri 台股 2330 官方收 NT$2,445（-20、-0.81% vs 7/2 NT$2,465、量 26,455 張、開 2,415/高 2,465/低 2,415）跌幅較 7/2 收斂、守穩 NT$2,410；NYSE TSM 7/3 因美國國慶（7/4 週六順延）休市，最新確認收盤為 7/2 $434.71（+0.13%、盤後 $437.44）；🚀 Barclays 上調目標至 $625",  "#C8E6C9"),
...
RELATIVE = {
    ...
    "tsmc_nyse_1d":   +0.13,   # TSM ADR 7/2 $434.71 (+$0.55 vs 7/1 $444.23... 7/1 重挫後止穩收紅、盤後 +0.63%)
    ...
    "adr_price":     434.71,   # TSM NYSE 7/2 收盤（+0.13%、最新確認、盤後 $437.44）
    "adr_parity":    393.72,   # 理論值 = 5 × NT$2,445 ÷ 31.05
    "adr_ratio":     "5:1",    # 1 ADR = 5 台積電普通股
    "usd_ntd":        31.05,   # 同 MACRO 台幣匯率
    "adr_premium_pct": "+10.41", # (434.71 - 393.72) / 393.72 × 100 = +10.41%
    "note": "ADR 理論值 = 5 × 台股收盤 ÷ 匯率（不含交易摩擦與流動性溢價）。⭐ NYSE TSM 7/2 Thu 於 7/1 重挫 -6.98% 後低檔止穩、小幅收紅 +0.13% 收 $434.71（+$0.55、市值約 $2.16 兆、P/E ~37.8）、盤後續揚 +0.63% 至 $437.44——殺盤動能衰竭、屬技術面過熱獲利了結後的估值修正而非基本面惡化；NYSE 7/3 Fri 逢美國國慶休市、7/6 Mon 重新開盤。台股 2330 7/3 Fri 官方收 NT$2,445（-20、-0.81% vs 7/2 NT$2,465、量 26,455 張、市值 NT$63.4 兆）跌幅較 7/2 之 -1.60% 收斂、守穩 NT$2,410 支撐。⚠️ 籌碼面：7/3 估外資賣超 -3,000 張（賣壓收斂）、投信小買 +800、自營小買 +200（待官方確認）。📊 台美 ADR 溢價自 +11.91% 收斂至 +10.41%（台股相對抗跌、NYSE 止穩）；🎯 今日（7/6 Mon）關鍵：NYSE 7/6 重新開盤後方向、台股 7/6 能否守穩 NT$2,410 / NT$2,370 支撐；⚠️ TSMC 4-5 月營收 +24% YoY 落後 ~35% 預期、6 月營收（7 月上旬）為關鍵 catalyst；🚀 重大利多：Barclays 將 TSM 目標價自 $470 大幅上調至 $625、Nomura NT$3,425；⭐ 中長線結構性基底未變：TSMC-Amkor 美國封裝長約 + NVIDIA 確認第 1 大客戶/A16 首發 + Vera Rubin 6 顆晶片全 TSMC 代工 + 2nm 量產 70-80% 良率 + CoWoS 擴產 + 4 大 CSP CapEx $725B",
}
...
NEWS = [
    {
        ...
        "title": "⚖️ 修正後止穩：NYSE TSM 7/2 於 7/1 重挫後低檔止穩、小幅收紅 +0.13% 收 $434.71（盤後 +0.63% 至 $437.44）；台股 2330 7/3 收 NT$2,445（-0.81%）跌幅收斂",
        "body": "半導體 6/30-7/1 修正後殺盤動能衰竭、雙市止穩：（1）⭐ NYSE TSM 7/2 Thu 官方收 $434.71（+$0.55、+0.13%、marketbeat 確認），於 7/1 重挫後低檔止穩、小幅收紅，盤後續揚 +0.63% 至 $437.44、市值約 $2.16 兆（P/E ~37.8）；（2）⚖️ 台股 2330 7/3 Fri 官方收 NT$2,445（-20、-0.81% vs 7/2 NT$2,465、量 26,455 張），跌幅較 7/2 之 -1.60% 明顯收斂、守穩 NT$2,410 支撐；（3）🗓️ NYSE 7/3 Fri 因美國國慶（7/4 週六、聯邦假期順延至 7/3）休市、7/6 Mon 重新開盤；台股 7/6 盤中官方收盤待 TWSE；（4）📊 台美 ADR 溢價自 +11.91% 收斂至 +10.41%（以 7/2 ADR $434.71 + 台股 7/3 NT$2,445、匯率 ~31.05 計、理論值 $393.7）；（5）📌【更正】前報將 NYSE 7/2 誤植為 -2.27% 收 $434.16，經官方收盤確認應為 +0.13% 收 $434.71。",
        "source": "marketbeat / CNBC / Yahoo Finance / Yahoo 奇摩股市 / wantgoo 2026-07-02 - 07-03", "impact": "正面",
    },
    {
        "tag": "產業趨勢", "tag_color": "#4CAF50",
        "title": "🚀 分析師大幅續挺：Barclays 將 TSM 目標價自 $470 大幅上調至 $625（維持 Overweight、+43.8% 空間）；Nomura NT$3,425；惟 Goldman 7/1 移出 APAC Conviction List",
        "body": "拉回中分析師逆勢大幅上調、主流強力看多：（1）🚀 Barclays 將 TSMC 目標價自 $470 大幅上調至 $625（維持 Overweight），自 7/2 收 $434.71 隱含約 +43.8% 上行空間，強調 TSMC 為 AI 資本支出循環的終極受惠者、A14/A16 製程領先；（2）📈 Nomura（野村）7/1 大幅上調台股目標至 NT$3,425（自 NT$2,820、+21.5%），自 7/3 收 NT$2,445 隱含約 +40.1% 空間，指 AI 基礎設施投資循環尚未見頂、預期資料中心新增產能 2027 年升至約 32GW；（3）📊 分析師 12 個月平均目標約 $490（強力買入、17-32 位分析師 0 賣出），多數視拉回為估值修正而非基本面惡化；（4）⚠️ 惟 Goldman Sachs 7/1 將 TSM 移出「APAC Conviction List」，屬對近期上檔空間的戰術性調整、並非降評。",
