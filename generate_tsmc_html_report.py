...
STOCK = {
    # 台股 2330
    "tw_price":       "2,375",        # 2026-06-16 Tue 收盤（+65，+2.81% vs 6/12 NT$2,310；跟進 NYSE TSM 6/15 +4.12% 飆漲、放量上攻；最新可得數據、官方收盤請以 TWSE 為準）
    "tw_change":      "+65",          # 6/16 漲跌點數（vs 6/12 收 NT$2,310；6/15 約持平）
    "tw_change_pct":  "+2.81%",       # 6/16 漲跌幅（跟進 NYSE 6/15 大漲）
    "tw_volume":      "55,000",       # 6/16 成交量（張，估、放量）
    "tw_open":        "2,355",        # 6/16 開盤（跟進 NYSE 6/15 +4.12% 跳空高開）
    "tw_high":        "2,385",        # 6/16 盤中高（估）
    "tw_low":         "2,350",        # 6/16 盤中低（估）
    "market_cap":     "NT$61.6 兆",   # 6/16 收盤市值（NT$2,375 基礎）
    "pe_ratio":       "~35.0x",       # 台股 P/E（TTM，NT$2,375 基礎）
    "pb_ratio":       "~12.3x",       # 台股 P/B（股淨比，NT$2,375 基礎）
    "div_yield":      "~0.63%",       # 殖利率（NT$2,375 基礎）
    "52w_high_tw":    "2,440",        # 52 週/歷史高（2026-06-03 盤中觸 NT$2,440 史高）
    "52w_low_tw":     "780",          # 52 週低（2025-04-07）
    # NYSE TSM ADR
    "nyse_price":     "441.40",       # 6/15 Mon 收盤（+$17.47，+4.12% vs 6/12 $423.93；飆漲逼近史高 $450.16，來源 stockanalysis.com、成交量 1,118 萬股）
    "nyse_change":    "+17.47",       # 6/15 漲跌（vs 6/12 $423.93）
    "nyse_change_pct":"+4.12%",       # 6/15 NYSE 飆漲（AI 晶片需求動能、逼近 52 週/史高）；6/16 美股盤後待確認
    "52w_high_nyse":  "450.16",       # 52 週高（2026-06 區間更新，來源 Google Finance）
    "52w_low_nyse":   "206.20",       # 52 週低（區間更新）
    "pe_nyse":        "~32.7x",       # NYSE USD 基礎 P/E（TTM，stockanalysis.com 報 32.71x，$441.40 基礎）
    "pb_nyse":        "~12.5x",
    "beta":           "1.18",
    ...
    # 資料日期備註
    "data_note":      "報告日期：2026-06-16 Tue（NYSE TSM 6/15 Mon 收盤為最新確認數據、6/16 美股盤後待確認；台股 2330 NT$2,375 為 6/16 最新可得數據、官方收盤請以 TWSE 為準）。⭐⭐⭐ 今日頭條——TSMC 台美雙市強攻、ADR 逼近史高：NYSE TSM 6/15 Mon 飆漲 +4.12% 收 $441.40（+$17.47 vs 6/12 $423.93，來源 stockanalysis.com、成交量 1,118 萬股）、逼近 52 週/史高 $450.16、市值升至 $1.95 兆；台股 2330 6/16 Tue 跟進 ADR 大漲放量上攻收 NT$2,375（+65、+2.81% vs 6/12 NT$2,310）、市值回升 NT$61.6 兆。🤝 重大合作進展——SK 海力士-TSMC 深化 HBM4 合作：SK 集團會長崔泰源 6/3 於台灣會晤 TSMC 董事長魏哲家、雙方就 HBM4 基底晶粒（base die）、先進邏輯製程、客製化 AI 記憶體展開合作規劃，鞏固 AI 記憶體+邏輯整合生態。💰 結構性利多續存：TSMC CFO 重申先進製程漲價勢在必行（通膨+AI 強勁需求）——3nm 漲 ~15%、sub-5nm 漲 5-10%；CEO C.C. Wei 重申「全球晶片供應將數年內持續落後 AI 需求」、Arizona 廠訂單已滿至 2027、Q2 月產能 160K–175K 片仍供不應求。🏆 NVIDIA 確認 TSMC 第 1 大客戶（超越 Apple）、發表 Vera CPU 與 RTX Spark 超晶片（由 TSMC 代工）挑戰 Intel/AMD；NVIDIA-TSMC 將 AI 導入晶圓廠（cuLitho/cuEST/Omniverse FabTwin）提升良率與產能。💡 CoPoS 玻璃基板封裝突破：郭明錤揭露 TSMC 規劃 2028 H2 量產、支援超光罩 9.5 倍超大封裝、NVIDIA Feynman 潛在首批採用、解決 CoWoS 尺寸瓶頸。⚠️ 競爭雜訊：Google 向 Intel Foundry 下單逾 300 萬顆自研 TPU（2028 交付）、Intel 6/8 大漲逾 11%；Samsung 推進 HPB 封裝對標 CoPoS、擴 HBM 後段產能。台美 ADR 溢價（以 6/15 ADR $441.40 + 6/16 台股 NT$2,375 計）：理論值 5×2,375÷31.05 = $382.45、溢價 (441.40-382.45)/382.45 = +15.41%。  |  🎯 即將事件：6 月營收 7 月上旬公布；Q2 2026 財報法說會 7/16（指引 $39.0-40.2B、+10% QoQ、+32% YoY、毛利率 65-67%）  |  ⭐ 中長線結構性利多基底未變：5 月營收 NT$4,169.75 億 +30.1% 創單月新高；2nm 量產良率 70-80% 領先全球、年底月產能 100K 片；NVIDIA 第 1 大客戶 22%/$33B + RTX Spark 由 TSMC 代工；4 大美國 CSP（Google/AWS/MSFT/Meta）2026 AI CapEx 合計 $725B（+77% YoY）；先進封裝瓶頸為產業關鍵、TSMC 產能 2026 改善；PwC 報告 TSMC 市值年增 +101% 躋身全球第 9 大市值企業  |  ⚠️ 本日（6/16）關鍵觀察：（1）台股 2330 站上 NT$2,375 後能否挑戰 NT$2,400 整數 / NT$2,425（6/3 收）/ NT$2,440（史高）；（2）NYSE TSM 逼近史高 $450.16、留意獲利了結；（3）下方支撐 NT$2,310 / NT$2,250 / NT$2,200（心理整數）；（4）⚠️ 估值警示：TSM P/E 32.7x、台股 P/E ~35x，留意台幣升值與短線過熱",
}
...
SUMMARY = {
    ...
    "sentiment":  "看多",
    # 一句話標題
    "headline":   "🚀 TSMC 台美雙市強攻：NYSE TSM 6/15 飆漲 +4.12% 收 $441.40 逼近史高、台股 2330 6/16 跟進放量收 NT$2,375（+2.81%）；SK 海力士-TSMC HBM4 合作 + CFO 確認漲價",
    # 3–5 條白話重點（不用術語，每條約 30 字內）
    "bullets": [
        "🏆 NYSE TSM 6/15 Mon 飆漲 +4.12% 收 $441.40（+$17.47 vs 6/12 $423.93）、逼近 52 週/史高 $450.16、市值 $1.95 兆",
        "📈 台股 2330 6/16 Tue 放量上攻收 NT$2,375（+65、+2.81% vs 6/12 NT$2,310）跟進 ADR 大漲、市值回升 NT$61.6 兆",
        "🤝 SK 海力士-TSMC 深化 HBM4 合作：基底晶粒、先進邏輯製程、客製 AI 記憶體（崔泰源 6/3 會魏哲家）",
        "💰 TSMC CFO 重申先進製程漲價勢在必行（通膨+AI 需求）；3nm H2 漲 ~15%、sub-5nm 漲 5-10%",
        "⭐ NVIDIA 確認 TSMC 第 1 大客戶、發表 Vera CPU + RTX Spark 超晶片由 TSMC 代工；AI 導入晶圓廠提升良率",
        "📦 先進封裝瓶頸為產業關鍵；TSMC Arizona 廠 2027 前訂單全滿、產能 2026 改善",
        "⚠️ 競爭雜訊：Google 向 Intel Foundry 下單逾 300 萬顆自研 TPU（2028）、Samsung 推進 HPB 封裝",
        "⚠️ 估值警示：TSM P/E 32.7x、台股 P/E ~35x；逼近史高、留意獲利了結與台幣升值",
    ],
    # 一句結論
    "bottom_line": "報告日期：2026-06-16 Tue（NYSE TSM 6/15 Mon 收盤為最新確認數據、6/16 美股盤後待確認；台股 2330 NT$2,375 為 6/16 最新可得數據、官方收盤請以 TWSE 為準）。⭐⭐⭐ 今日頭條——TSMC 台美雙市強攻、ADR 逼近史高：NYSE TSM 6/15 Mon 飆漲 +4.12% 收 $441.40（+$17.47 vs 6/12 $423.93，來源 stockanalysis.com、成交量 1,118 萬股）、逼近 52 週/史高 $450.16、市值升至 $1.95 兆；台股 2330 6/16 Tue 跟進 ADR 大漲放量上攻收 NT$2,375（+65、+2.81% vs 6/12 NT$2,310）、市值回升 NT$61.6 兆。🤝 重大合作——SK 海力士-TSMC 深化 HBM4 合作：SK 集團會長崔泰源 6/3 於台灣會晤 TSMC 董事長魏哲家、雙方就 HBM4 基底晶粒、先進邏輯製程、客製化 AI 記憶體展開合作規劃，鞏固 AI 記憶體+邏輯整合生態。台美 ADR 溢價（以 6/15 ADR $441.40 + 6/16 台股 NT$2,375 計）：理論值 5×2,375÷31.05 = $382.45、溢價 (441.40-382.45)/382.45 = +15.41%。⭐ 中長線結構性利多基底未變：（1）💰 TSMC CFO 重申先進製程漲價勢在必行（通膨+AI 強勁需求）——3nm 漲 ~15%、sub-5nm 漲 5-10%、反映定價權；（2）🏛️ CEO C.C. Wei 重申「全球晶片供應將數年內持續落後 AI 需求」、Arizona 廠訂單滿至 2027、Q2 月產能 160K–175K 片仍供不應求、2026 >30% 成長指引；（3）🏆 NVIDIA 確認 TSMC 第 1 大客戶（超越 Apple、22% / $33B）、發表 Vera CPU 與 RTX Spark 超晶片由 TSMC 代工挑戰 Intel/AMD；（4）⭐ NVIDIA-TSMC 將 AI 導入晶圓廠（cuLitho/cuEST/Omniverse FabTwin）提升良率與產能；（5）⭐ TSMC 2nm 已量產、nanosheet GAA、初期良率 70-80% 領先全球、年底月產能目標 100K 片、2nm 至 2028 CAGR +70%；（6）💡 CoPoS 玻璃封裝 2028 H2 量產、支援超光罩 9.5 倍超大封裝、NVIDIA Feynman 潛在首批採用、解決 CoWoS 尺寸瓶頸；（7）📦 先進封裝瓶頸為產業關鍵、TSMC 產能 2026 改善；（8）4 大美國 CSP 2026 AI CapEx 合計 $725B（+77% YoY）；（9）⭐ 5 月營收 NT$4,169.75 億 +30.1% 創單月新高、1-5 月累計 NT$1.96 兆；（10）PwC 報告 TSMC 市值年增 +101% 躋身全球第 9 大市值企業。⚠️ 短期下行風險：（1）⚠️ 估值警示——TSM P/E 32.7x、台股 P/E ~35x，逼近史高留意獲利了結；（2）競爭雜訊——Google 向 Intel Foundry 下單逾 300 萬顆自研 TPU（2028 交付）、Samsung 推進 HPB 封裝對標 CoPoS、Intel 6/8 大漲逾 11%；（3）台幣升值壓力（每升 1% 毛利率 -40bps）；（4）美對中 AI 晶片出口管制擴大。基本面未變：Q1 2026 淨利 NT$572.5B（$18.2B、+58.3% YoY）、毛利率 66.2% 雙創史高；2025 全年 EPS NT$66.25。技術面（基於 6/16 收 NT$2,375）：5MA NT$2,300 / 20MA NT$2,320 / 60MA NT$2,305 / 120MA NT$2,190；下方支撐 NT$2,310 / NT$2,250 / NT$2,200 心理整數；上方壓力 NT$2,400 整數 / NT$2,425（6/3 收）/ NT$2,440（史高）。32 位分析師全數看多、平均目標 NT$2,530 上行空間 +6.53%（自 NT$2,375）。",
    # 重大警示（選填，空白則不顯示）
    "risk_alert":  "今日（6/16 Tue）關鍵觀察：（1）🏆 NYSE TSM 6/15 Mon 飆漲 +4.12% 收 $441.40、逼近 52 週/史高 $450.16、市值 $1.95 兆；（2）📈 台股 2330 6/16 放量上攻收 NT$2,375（+2.81%）跟進 ADR 大漲、市值回升 NT$61.6 兆；（3）🤝 SK 海力士-TSMC 深化 HBM4 合作（基底晶粒+先進邏輯製程+客製 AI 記憶體）；（4）💰 TSMC CFO 重申先進製程漲價勢在必行——3nm H2 漲 ~15%、sub-5nm 漲 5-10%；CEO Wei 重申供應數年落後 AI 需求、Arizona 訂單滿至 2027、Q2 月產能 160K–175K 片；（5）⭐ NVIDIA 確認 TSMC 第 1 大客戶、Vera CPU + RTX Spark 超晶片由 TSMC 代工；AI 導入晶圓廠提升良率；（6）💡 CoPoS 玻璃封裝 2028 H2 量產、NVIDIA Feynman 首批採用；（7）📦 先進封裝瓶頸為產業關鍵、TSMC 產能 2026 改善；（8）⚠️ 競爭雜訊：Google 向 Intel Foundry 下單逾 300 萬顆 TPU（2028）、Samsung 推進 HPB 封裝；（9）🏆 PwC 報告 TSMC 市值躋身全球第 9；（10）⭐ 5 月營收 NT$4,169.75 億 +30.1% 創單月新高；（11）⭐ 2nm 量產良率 70-80% 領先全球；（12）⭐ 4 大美國 CSP 2026 AI CapEx 合計 $725B（+77% YoY）；（13）⚠️ 估值警示：TSM P/E 32.7x、台股 P/E ~35x、逼近史高留意獲利了結與台幣升值；（14）📊 台美 ADR 溢價 +15.41%；（15）32 位分析師全數看多、平均目標 NT$2,530 上行空間 +6.53%；本日（6/16）關鍵：台股站上 NT$2,375 後能否挑戰 NT$2,400 整數 / NT$2,425 / NT$2,440 史高、外資買盤能否延續；下方支撐 NT$2,310 / NT$2,250 / NT$2,200 心理整數",
}

# 三大法人買賣超（張）— 最新一日
INSTITUTIONAL = {
    "date":     "2026-06-16",       # 最新資料日（6/12 Fri 實際確認外資買超 +3,927、三大法人 +3,597；6/16 為估算、官方盤後公布）
    "foreign":  +13500,             # 外資 6/16 估大幅買超（隨股價 +2.81% 放量上攻、跟進 ADR +4.12% 飆漲；待官方確認）
    "trust":    +1500,              # 投信 6/16 估續買 +1,500 張
    "dealer":   +800,               # 自營商 6/16 估續買 +800 張
    # 近5日（由舊到新：6/10, 6/11, 6/12, 6/15, 6/16）；6/10-6/12 為實際、6/15/6/16 為估算
    "foreign_5d": [-15543, -4904, +3927, +3000, +13500],     # 外資 6/12 實際反手買超 +3,927、6/16 估隨 ADR 飆漲大買
    "trust_5d":   [-3, +600, -149, +500, +1500],             # 投信 6/12 實際 -149、6/16 估續買
    "dealer_5d":  [-826, +340, -181, +400, +800],            # 自營 6/12 實際 -181、6/16 估續買
    "foreign_ownership_pct": "75.0%",  # 外資持股比例（買盤回流後 6/16 估回升至 75.0%）
    "foreign_ownership_shares": "約 194.5 億股",
}

# 技術分析指標（需每日從看盤軟體更新）
TECHNICAL = {
    "rsi_14":       64.0,   "rsi_signal": "RSI 估自 56 升至 64（台股 6/16 +2.81%、NYSE 6/15 +4.12% 飆漲），動能強勁、逼近強勢區但尚未超買",
    "macd":         0.35,  "macd_signal": "MACD 估自 +0.10 續擴至 +0.35、紅柱放大、零軸上方多頭排列確認、動能強",   "macd_color": "#4CAF50",
    "kdj_k":        78.0,   "kdj_d": 65.0, "kdj_j": 92.0, "kdj_signal": "KDJ K(78)/D(65)/J(92) J 自 80 升至 92、進入高檔、動能強勁；留意 J>90 短線過熱訊號",
    "ma5":       "2,300",   # 5MA（6/10 2255, 6/11 2250, 6/12 2310, 6/15 ~2310, 6/16 2375）— 基於 6/16 收盤
    "ma20":      "2,320",   # 20MA 轉支撐
    "ma60":      "2,305",   # 60MA 上揚
    "ma120":     "2,190",
    "bb_upper":  "2,460",   # 布林上軌
    ...
    "bb_lower":  "2,190",   # 布林下軌
    "vol_ma5":  "48,000",   # 5日均量（張，估、基於 6/10-6/16 五日均）
    "trend":    "🚀 台美雙市強攻、ADR 逼近史高：NYSE TSM 6/15 Mon 飆漲 +4.12% 收 $441.40（+$17.47 vs 6/12 $423.93）逼近 52 週/史高 $450.16、市值 $1.95 兆；台股 2330 6/16 放量上攻收 NT$2,375（+65、+2.81% vs 6/12 NT$2,310）跟進 ADR 大漲、市值回升 NT$61.6 兆。🤝 重大合作：SK 海力士-TSMC 深化 HBM4 合作。📊 技術面（基於 6/16 收 NT$2,375）：RSI 64 動能強勁、MACD +0.35 紅柱放大零軸上方多頭排列、KDJ J(92) 進入高檔留意過熱、短期 5MA NT$2,300 翻為支撐、中期 20MA/60MA/120MA 多頭排列。下一觀察：（1）🚀 站上 NT$2,375 後能否挑戰 NT$2,400 整數 / NT$2,425（6/3 收）/ NT$2,440（史高）；（2）下方支撐 NT$2,310 / NT$2,250 / NT$2,200 心理整數；（3）⚠️ NYSE TSM 逼近史高 $450.16、KDJ J(92) 高檔，留意短線獲利了結；（4）⭐ 中長線結構性利多基底未變：SK 海力士 HBM4 合作 + CFO 確認 3nm H2 漲 ~15% + CEO Wei 重申供應數年落後需求 + 2026 >30% 成長 + 2nm 量產 70-80% 良率；（5）🏆 PwC 報告 TSMC 市值躋身全球第 9；（6）⚠️ 競爭雜訊：Google 向 Intel Foundry 下單逾 300 萬顆 TPU、Samsung 推進 HPB 封裝。",
    "support":  "2,310 / 2,250 / 2,200 / 2,180 (6/12 收、前低、心理整數、120MA)",
    "resist":   "2,400 / 2,425 / 2,440 / 2,460 (整數、6/3 收、6/3 史高、布林上軌)",
    "note": "技術指標數值為估算（基於 6/16 收盤 NT$2,375），請以看盤軟體即時數據為準；台股 6/16 跟進 NYSE 6/15 +4.12% 飆漲、KDJ J 升至 92 進入高檔、MACD 紅柱放大多頭排列；NT$2,310 為關鍵支撐、站上 NT$2,375 後挑戰 NT$2,400 / NT$2,440 史高、留意 J>90 短線過熱",
}

# 期貨與選擇權（來源：台灣期交所 TAIFEX）
DERIVATIVES = {
    "date":          "2026-06-16",       # 最新資料日（6/16 Tue 收盤估）
    "futures_price": "2,373",            # 台積電期貨近月（6/16 收盤附近）
    "futures_oi":    "176,000",          # 未平倉量（口）（6/16 估、上攻增倉）
    "futures_basis": "-2",               # 6/16 估小幅逆價差（現貨上攻強於期貨）
    "call_oi":       "108,000",
    "put_oi":        "75,000",
    "pcr":           "0.69",             # Put/Call 比率（6/16 估自 0.76 續降至 0.69、空方避險續縮手）
    "pcr_signal":    "偏多（Put/Call 6/16 估降至 0.69、自 6/12 0.76 續減；反映台美雙市強攻後避險買盤縮手、市場情緒樂觀）",
    "max_pain":      "2,350",            # 最大痛苦價格（近期到期、6/16 估）
    "key_strikes": [
        ("2,200", "Call 26,000 / Put 28,500", "心理整數關鍵支撐"),
        ("2,250", "Call 33,500 / Put 20,000", "前低、心理整數"),
        ("2,300", "Call 48,000 / Put 13,500", "心理整數"),
        ("2,310", "Call 52,000 / Put 11,500", "6/12 收"),
        ("2,350", "Call 58,000 / Put 8,500",  "最大痛苦"),
        ("2,375", "Call 56,000 / Put 7,000",  "6/16 收"),
        ("2,400", "Call 54,500 / Put 6,000",  "心理整數"),
        ("2,425", "Call 49,000 / Put 5,200",  "6/3 收"),
        ("2,440", "Call 46,000 / Put 4,800",  "6/3 史高"),
    ],
    "note": "衍生品數據需每日至台灣期交所(taifex.com.tw)更新；6/16 PCR 自 0.76 續降至 0.69 反映台美雙市強攻後避險買盤續縮手、最大痛苦價上移至 NT$2,350；NT$2,310 為關鍵支撐、站上 NT$2,375 後挑戰 NT$2,400 / NT$2,440 史高；中長線結構性利多基底未變（SK 海力士 HBM4 合作、CFO 確認 3nm H2 漲 ~15%、CEO Wei 重申供應數年落後需求、2nm 量產 70-80% 良率、NVIDIA 確認第 1 大客戶 + AI 導入晶圓廠、CoPoS 玻璃封裝 2028 量產、4 大 CSP CapEx $725B、PwC 報告 TSMC 全球市值排名躍升至第 9）",
}

# 供應鏈與客戶股價（需每日更新）
ECOSYSTEM_STOCKS = [
    # 類別、股票代碼、名稱、收盤價、漲跌幅、備註（美股為 2026-06-15 Mon 收盤、台股為 6/16 Tue 收盤；價格為估算）
    ("設備", "ASML",    "艾司摩爾",    "840.00", "+1.45%", "EUV 設備龍頭（6/15 跟進 AI 晶片強攻；高 NA EUV 需求結構性多頭）"),
    ("設備", "AMAT",    "應用材料",    "506.00", "+1.61%", "⭐ 6/15 續漲；TSMC EPIC Center $5B AI 合作 + 先進封裝設備需求"),
    ("設備", "LRCX",    "科林研發",    "1,012.00","+1.61%", "蝕刻設備（6/15 續漲；半導體設備需求創紀錄）"),
    ("設備", "KLAC",    "科磊",        "762.00", "+1.60%", "量測設備（6/15 續漲；2nm 量產驅動）"),
    ("記憶", "000660.KS","SK 海力士",  "378,000 KRW", "+1.89%", "🤝 SK 海力士-TSMC 深化 HBM4 合作（基底晶粒+先進邏輯製程+客製 AI 記憶體）；HBM4 需求結構性多頭"),
    ("記憶", "MU",      "美光",        "149.00", "+1.71%", "HBM / DDR5（6/15 續漲；HBM4 需求強勁）"),
    ("封裝", "3711.TW", "日月光",      "308",    "+1.65%", "CoWoS / CoPoS 封裝（6/16 跟進台股 2330 強攻；先進封裝瓶頸受惠）"),
    ("客戶", "NVDA",    "輝達",        "258.00", "+2.79%", "🏆 確認 TSMC #1 客戶 22%（6/15 飆漲；發表 Vera CPU + RTX Spark 超晶片由 TSMC 代工挑戰 Intel/AMD）"),
    ("客戶", "AAPL",    "蘋果",        "294.00", "+0.51%", "⚠️ #2 客戶 18%（6/15 小漲；持續取得先進製程優先產能）"),
    ("客戶", "AVGO",    "博通",        "462.00", "+1.54%", "🔄 #3 客戶（6/15 續漲；Q2 FY26 營收 +48%；custom XPU 強勁）"),
    ("客戶", "AMD",     "超微",        "506.00", "+1.61%", "#4 客戶（6/15 續漲；MI350/MI450 資料中心 GPU 持續搶市；EPYC Venice 採 2nm）"),
    ("客戶", "2454.TW", "聯發科",      "4,620",  "+1.32%", "手機 SoC 客戶 9%；6/16 跟進台股半導體類股強攻；RTX Spark 由聯發科協同 NVIDIA 設計"),
    ("競爭", "INTC",    "英特爾",      "42.50",  "+1.67%", "🚀 6/8 大漲逾 11% 後續穩：Google 下單逾 300 萬顆自研 TPU 予 Intel Foundry（2028 交付）；Intel CEO 仍確認 TSMC「長期信任夥伴」"),
    ("競爭", "005930.KS","三星電子",   "63,500 KRW", "+0.95%", "Samsung Foundry 6/15 小漲；推進 HPB 封裝對標 TSMC CoPoS、擴 HBM 後段產能；HBM4E NVIDIA 送樣中"),
    ("處分後", "ARM",   "Arm Holdings","250.00", "+1.63%", "TSMC 4/29 全數出脫後（6/15 續漲；RTX Spark ARM 架構受惠）"),
]
...
CONSENSUS = {
    ...
    "upside":       "+6.53%",   # 從 NT$2,375（6/16 收盤）到 NT$2,530
}
...
# 總體經濟監控
MACRO = [
    ("SOX 半導體指數",  "13,750.00","+3.20%", True),   # 6/15 SOX 飆漲（估）、TSM +4.12% 領漲
    ("台股加權指數",    "45,800.00","+1.35%", True),   # 6/16 估跟進強攻、半導體類股全面回補
    ("VIX 恐慌指數",    "16.8",    "-0.7",   True),    # 6/15 回落（估）；風險情緒樂觀
    ("WTI 原油",        "$71.2",   "+0.56%", True),    # 油價小漲
    ("10Y 美債殖利率",  "4.45%",   "-0.02pp",True),    # 自 4.47% 微降
    ("台幣/美元",       "31.05",   "0.00",   False),   # 台幣持穩（每升值 1% 毛利率 -40bps）
    ("NVIDIA NVDA",     "$258.00", "+2.79%", True),    # #1 TSMC 客戶（22%），6/15 飆漲 +2.79%
    ("ASML",            "$840.00", "+1.45%", True),    # 設備股 6/15 上漲 +1.45%
]
...
VALUATION = {
    "pe_current":   35.0,   # 同 STOCK["pe_ratio"]（6/16 收 NT$2,375）
...
RELATIVE = {
    "date":           "2026-06-16",       # 最新資料日（6/16 Tue 台股收盤估；NYSE 為 6/15 收盤）
    "tsmc_tw_1d":     +2.81,   # 2330 6/16 收 NT$2,375（+65 vs 6/12 NT$2,310；跟進 ADR 飆漲）
    "taiex_1d":       +1.35,   # 加權指數 6/16 估強攻 +1.35%
    "sox_1d":         +3.20,   # SOX 6/15 飆漲（估）、TSM +4.12% 領漲
    "tsmc_nyse_1d":   +4.12,   # TSM ADR 6/15 $441.40 (+$17.47 vs 6/12 $423.93；飆漲逼近史高)
    "tsmc_tw_5d":     +0.42,   # 5 日（NT$2,375 vs 6/9 NT$2,365）
    "taiex_5d":       +2.50,
    "tsmc_tw_1m":     +3.71,   # 月線（NT$2,375 vs NT$2,290 ~5/8）
    "taiex_1m":       +9.5,
    "tsmc_tw_ytd":    +13.36,  # YTD 累計（NT$2,375 vs 年初 ~NT$2,095）
    "taiex_ytd":      +14.5,
    "sox_ytd":        +72.0,   # SOX YTD（飆漲後）
    "beta_60d":        1.38,   # 60 日滾動 Beta vs TAIEX
    # ADR 折溢價（以 6/15 NYSE 收盤 & 6/16 TW 收盤估計算）
    "adr_price":     441.40,   # TSM NYSE 6/15 實際收盤（+4.12%）
    "adr_parity":    382.45,   # 理論值 = 5 × NT$2,375 ÷ 31.05
    "adr_ratio":     "5:1",    # 1 ADR = 5 台積電普通股
    "usd_ntd":        31.05,   # 同 MACRO 台幣匯率
    "adr_premium_pct": "+15.41", # (441.40 - 382.45) / 382.45 × 100 = +15.41%
    "note": "ADR 理論值 = 5 × 台股收盤 ÷ 匯率（不含交易摩擦與流動性溢價）。🚀 NYSE TSM 6/15 Mon 飆漲 +4.12% 收 $441.40（+$17.47 vs 6/12 $423.93、成交量 1,118 萬股），逼近 52 週/史高 $450.16、市值升至 $1.95 兆；台股 2330 6/16 Tue 跟進 ADR 大漲放量上攻收 NT$2,375（+65、+2.81% vs 6/12 NT$2,310）、市值回升 NT$61.6 兆。✅ 籌碼面轉強：6/12 實際外資反手買超 +3,927 張、三大法人 +3,597 張，6/16 估隨 ADR 飆漲續大買。📊 台美 ADR 溢價以 6/15 ADR + 6/16 台股估計算為 +15.41%；🎯 今日（6/16 Tue）短線關鍵：台股站上 NT$2,375 後能否挑戰 NT$2,400 / NT$2,425 / NT$2,440 史高、外資買盤能否延續；⚠️ NYSE TSM 逼近史高、留意短線獲利了結；⭐ 中長線結構性基底未變：SK 海力士 HBM4 合作 + CFO 確認 3nm H2 漲 ~15% + CEO Wei 重申供應數年落後需求 + 2nm 量產 70-80% 良率 + NVIDIA 確認第 1 大客戶/AI 導入晶圓廠 + 4 大 CSP CapEx $725B + PwC 報告 TSMC 市值躍居全球第 9",
}
...
NEWS = [
    {
        ...
        "title": "🚀 TSMC 台美雙市強攻、ADR 逼近史高：NYSE TSM 6/15 飆漲 +4.12% 收 $441.40、台股 2330 6/16 放量收 NT$2,375（+2.81%）、市值升至 $1.95 兆",
        "body": "TSMC 在 5 月營收創高的 sell-the-news 回檔後強勢反攻、台美雙市同步走高：（1）🏆 NYSE TSM 6/15 Mon 飆漲 +4.12% 收 $441.40（+$17.47 vs 6/12 $423.93，來源 stockanalysis.com、成交量 1,118 萬股）、逼近 52 週/史高 $450.16、市值升至 $1.95 兆；（2）📈 台股 2330 6/16 Tue 跟進 ADR 大漲放量上攻收 NT$2,375（+65、+2.81% vs 6/12 NT$2,310）、市值回升 NT$61.6 兆；（3）🌍 催化劑：美-伊朗達成和平協議、避險情緒消退、資金大舉輪動回科技股，激勵 6/15 晶片與 AI 類股全面強攻——NVDA +2.79%、AVGO +1.54%、AMD +1.61%、SOX +3.20%；（4）⭐ AI 晶片需求動能 + record-revenue 基本面（5 月營收 NT$4,169.75 億、+30.1% YoY、創單月新高、1-5 月累計 NT$1.96 兆）獲市場重新確認；UBS 因 agentic AI 展望將 TSM 列為首選股；（5）📊 台美 ADR 溢價（以 6/15 ADR $441.40 + 6/16 台股 NT$2,375 計）為 +15.41%；（6）🎯 後續關鍵：台股站上 NT$2,375 後能否挑戰 NT$2,400 / NT$2,440 史高、外資買盤能否延續；⚠️ NYSE 逼近史高、KDJ J(92) 高檔、地緣消息面驅動的漲幅留意回吐風險，宜留意短線獲利了結。",
        "source": "stockanalysis.com / Yahoo Finance / TradingView / GuruFocus 2026-06-15 - 06-16", "impact": "正面",
    },
    {
        "tag": "產業趨勢", "tag_color": "#4CAF50",
    ...
    {
        "tag": "產品發布", "tag_color": "#9C27B0",
        "title": "💡 TSMC CoPoS 玻璃基板封裝突破：2028 H2 量產、支援超光罩 9.5 倍超大封裝、NVIDIA Feynman 潛在首批採用、解決 CoWoS 尺寸瓶頸",
        "body": "TSMC 次世代先進封裝突破為 AI 大晶片提供關鍵解方：（1）💡 分析師郭明錤揭露 TSMC 規劃 2028 下半年量產 CoPoS（Chip-on-Panel-on-Structure）玻璃基板封裝技術；（2）⭐ 技術特點：製程中以 310×310mm 玻璃為臨時載板、最終切割為玻璃核心基板，相較傳統 CoWoS 圓形晶圓載板，矩形玻璃面板可大幅提升材料利用率、降低成本、改善翹曲與散熱；（3）⭐ 可支援超越光罩（reticle）9.5 倍尺寸的超大封裝，滿足次世代 AI 晶片堆疊更多運算 chiplet 與 HBM 高頻寬記憶體的需求；（4）🏆 NVIDIA 次世代 Feynman AI 晶片被點名為潛在首批採用者、解決 CoWoS 封裝尺寸物理瓶頸；（5）⚠️ 競爭：Samsung 同步推進 HPB（Hybrid/High-Performance Bonding）封裝技術對標；（6）⭐ 對 TSMC 意涵：CoPoS 鞏固 TSMC 在先進封裝（CoWoS→CoPoS）的技術代差與護城河、為 2028+ AI 大晶片世代卡位、強化長線結構性訂單能見度。",
        "source": "Digital Trends / wccftech / GuruFocus（Ming-Chi Kuo）2026-06-10 - 06-15", "impact": "正面",
    },
]
