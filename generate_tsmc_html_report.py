...
STOCK = {
    # 台股 2330
    "tw_price":       "2,365",        # 2026-06-05 Fri 實際收盤（-20，-0.84% vs 6/4 NT$2,385；今日 6/8 Mon 盤中、待盤後補實際資料）
    "tw_change":      "-20",          # 6/5 實際漲跌點數
    "tw_change_pct":  "-0.84%",       # 6/5 實際漲跌幅
    "tw_volume":      "32,648",       # 6/5 實際成交量（張，實際）
    "tw_open":        "2,395",        # 6/5 實際開盤
    "tw_high":        "2,405",        # 6/5 盤中高
    "tw_low":         "2,350",        # 6/5 盤中低
    "market_cap":     "NT$61.3 兆",   # 6/5 實際市值（NT$2,365 基礎）
    "pe_ratio":       "~34.8x",       # 台股 P/E（TTM，NT$2,365 基礎）
    "pb_ratio":       "~12.3x",       # 台股 P/B（股淨比，NT$2,365 基礎）
    "div_yield":      "~0.63%",       # 殖利率（NT$2,365 基礎）
    "52w_high_tw":    "2,440",        # 52 週/歷史高（2026-06-03 盤中觸 NT$2,440 史高）
    "52w_low_tw":     "780",          # 52 週低（2025-04-07）
    # NYSE TSM ADR
    "nyse_price":     "415.17",       # 6/5 Fri 實際收盤（-29.75，-6.69% vs 6/4 $444.92；Broadcom Q3 AI 指引 $16B 不及預估 $17.2B 觸發拋售、SOX -8.71%、$1T+ 半導體市值蒸發）
    "nyse_change":    "-29.75",       # 6/5 漲跌（vs 6/4 $444.92）
    "nyse_change_pct":"-6.69%",       # 6/5 NYSE 大跌
    "52w_high_nyse":  "449.39",       # 52 週高（2026-06-02 盤中觸及 $449.39 創史新高）
    "52w_low_nyse":   "134.25",       # 52 週低（2025-04-07）
    "pe_nyse":        "~34.4x",       # NYSE USD 基礎 P/E（TTM，估算，$415.17 基礎、自高位回落）
    "pb_nyse":        "~11.9x",
    "beta":           "1.18",
    ...
    # 資料日期備註
    "data_note":      "報告日期：2026-06-08 Mon（今日盤中、6/8 收盤資料待盤後補；主要區塊以 6/5 Fri 實際收盤為最新確認資料）。🔴 重大事件——6/5 Fri 美股半導體爆量崩跌：SOX -8.71% 收 12,431.25（單日最大跌幅 since 2025-04 解放日）、NYSE TSM 暴跌 -6.69% 收 $415.17（-$29.75 vs 6/4 $444.92）、AVGO 6/4-6/5 累計 -13%、NVDA -3.54%、$1T+ 半導體市值單日蒸發。觸發主因：（1）Broadcom 6/3 盤後 Q3 AI 指引 $16B 雖 +200% YoY 但不及分析師估 $17.2B、未上修全年 AI 指引、觸發「sell-the-news」拋售；（2）5 月 NFP 大幅優於預期、推升 10Y 美債殖利率突破 4.5%、Fed 升息預期升溫；（3）美對中 AI 晶片出口管制 6/1 起延伸至中企海外子公司。✅ 6/5 Fri 台股 2330 實際收 NT$2,365（-20，-0.84% vs 6/4 NT$2,385）盤中區間 NT$2,350-2,405——因時差未及反映 NYSE 6/4-6/5 崩跌、相對抗跌；加權指數 6/5 收 45,070.94（-1.33%）。📊 今日（6/8 Mon）：盤中、待盤後補資料；市場高度關注台股是否跳空補跌反映 NYSE -6.69% 崩跌。台美 ADR 溢價以 6/5 收盤計：理論值 5×2,365÷31.05 = $380.74、溢價 (415.17-380.74)/380.74 = +9.04%（自 +13.0% 收斂）。  |  🔴 短期殺盤主因：（1）Broadcom Q3 AI 指引未上修引爆「sell-the-news」、AVGO -13%；（2）5 月 NFP 強勁、Fed 升息預期升溫、10Y 美債殖利率突破 4.5%；（3）美對中 AI 晶片出口管制擴大；（4）估值警示：TSM P/E 自 36x 回落至 ~34x、仍在 5 年 90%+ 高位  |  ⭐ 結構性利多續存（中長線基底未變）：6/4 AGM CEO Wei 確認 AI 需求超供應、2026 >30% 成長；NVIDIA $150B/年投資台灣；NVIDIA-TSMC AI 製程合作（cuLitho/cuEST/FabTwin）；Intel CEO 確認長期夥伴；TSMC 3nm 下半年漲價 15%  |  🎯 即將事件（關鍵催化）：⭐ TSMC 5 月月營收 6/10 公布（市場估 NT$420B+ 為止跌反彈訊號）；Q2 2026 財報 7/16  |  ⚠️ 本日（6/8）關鍵觀察：台股 2330 反應 NYSE 6/5 -6.69% 崩跌的補跌幅度；下方支撐 NT$2,250（心理整數）/ NT$2,200 / NT$2,148（120MA）；反彈壓力 5MA 區間 / NT$2,365（6/5 收）",
}
...
SUMMARY = {
    ...
    "sentiment":  "中性偏空",
    # 一句話標題
    "headline":   "🔴 6/5 美股半導體爆量崩跌：SOX -8.71%、TSM ADR -6.69%、$1T+ 蒸發；今日（6/8 Mon）台股盤中、待盤後補資料",
    # 3–5 條白話重點（不用術語，每條約 30 字內）
    "bullets": [
        "🔴 6/5 Fri 美股 SOX -8.71% 創 2025-04 以來最大單日跌幅、半導體 $1T+ 市值蒸發",
        "🔴 NYSE TSM 6/5 暴跌 -6.69% 收 $415.17、自 6/2 史高 $449.39 累計 -7.6%",
        "📊 6/5 Fri 台股 2330 實際收 NT$2,365（-0.84%）因時差未及反映美股崩跌、相對抗跌",
        "📉 今日（6/8 Mon）台股盤中、待盤後補資料；市場關注是否跳空補跌反映美股崩跌",
        "⚠️ Broadcom Q3 AI 指引 $16B 不及預估 $17.2B、未上修全年指引、AVGO 6/4-6/5 累計 -13%",
        "⚠️ 5 月 NFP 強勁、10Y 美債殖利率突破 4.5%、Fed 升息預期升溫加劇拋售",
        "⚠️ 美對中 AI 晶片出口管制 6/1 起延伸至中企海外子公司、增添不確定性",
        "⭐ 中長線基底未變：AGM CEO Wei 確認 AI 需求超供應 + 2026 >30% 成長 + 3nm 漲價 15%",
    ],
    # 一句結論
    "bottom_line": "報告日期：2026-06-08 Mon（今日盤中、6/8 收盤資料待盤後補；以下以 6/5 Fri 實際收盤為最新確認資料）。🔴 重大事件——6/5 Fri 美股半導體爆量崩跌：SOX -8.71% 收 12,431.25（單日跌幅創 2025-04 解放日以來最大）、NYSE TSM 暴跌 -6.69% 收 $415.17（-$29.75 vs 6/4 $444.92）、AVGO 6/4-6/5 累計 -13%、NVDA -3.54%、MU -8.65%、$1T+ 半導體市值單日蒸發。崩跌觸發三大主因：（1）⚠️ Broadcom 6/3 盤後 Q3 AI 半導體營收指引 $16B 雖 +200% YoY 但不及分析師估值 $17.2B、且未上修 2026 全年 AI 指引、引爆「sell-the-news」拋售；（2）⚠️ 5 月 NFP 大幅優於預期、推升 10Y 美債殖利率突破 4.5%、Fed 升息預期升溫；（3）⚠️ 美對中 AI 晶片出口管制 6/1 起延伸至中企海外子公司、增加客戶接單複雜度。✅ 6/5 Fri 台股 2330 實際收 NT$2,365（-20，-0.84% vs 6/4 NT$2,385）盤中區間 NT$2,350-2,405——因時差未及反映 NYSE 同日崩跌、相對抗跌；6/5 加權指數收 45,070.94（-1.33%）。📊 今日（6/8 Mon）：台股盤中、6/8 收盤實際資料待盤後補；市場關注台股 2330 是否跳空補跌反映 NYSE 6/5 -6.69% 崩跌；下方關鍵支撐 NT$2,250（心理整數）/ NT$2,200 / NT$2,148（120MA）。台美 ADR 溢價以 6/5 收盤計：理論值 5×2,365÷31.05 = $380.74、溢價 (415.17-380.74)/380.74 = +9.04%（自 +13.0% 收斂）。⭐ 中長線結構性利多基底未變：（1）🏛️ 6/4 AGM CEO Wei 確認 AI 需求將持續超越全球半導體供應、2026 >30% 成長指引、3nm H2 漲價 15% + 2027 再漲 5-10%；（2）Broadcom Q2 實際營收 $22.2B（+48% YoY）、AI $10.8B（+143% YoY）創史高、長線 AI 需求趨勢未變；（3）Intel CEO 6/2 確認 TSMC「長期信任夥伴」；（4）NVIDIA-TSMC AI 製程合作（cuLitho/cuEST/FabTwin）；（5）黃仁勳 6/1 GTC Taipei keynote 揭 Vera Rubin 量產；（6）NVIDIA $150B/年投資台灣承諾；（7）SIA/Deloitte 估 2028 AI 資料中心晶片年營收 $1.2 兆。⚠️ 短期下行風險：（1）Broadcom 全年 AI 指引未上修、市場開始質疑 AI CapEx 增速放緩；（2）Fed 升息預期升溫衝擊高估值科技股；（3）美對中 AI 晶片出口管制擴大；（4）⚠️ 估值警示 TSM P/E 仍在 5 年 90%+ 高位；（5）TSMC 對前主管 Wei-Jen Lo 訴訟持續中。基本面未變：Q1 2026 淨利 NT$572.5B（$18.2B、+58.3% YoY）、毛利率 66.2% 雙創史高；2025 全年 EPS NT$66.25；2026 全年 >30% 成長指引；CapEx $52-56B 高端。即將事件（短線最關鍵）：（1）⭐ TSMC 5 月月營收 6/10 公布、估 NT$420B+ 為短線止跌關鍵；（2）Q2 2026 財報 7/16 公布。技術面（基於 6/5 實際收盤 NT$2,365）：5MA NT$2,387 / 20MA NT$2,332 / 60MA NT$2,275 / 120MA NT$2,148；下方支撐 NT$2,355 / NT$2,300 / NT$2,250 心理整數 / NT$2,200。32 位分析師全數看多、平均目標 NT$2,530 上行空間 +6.98%。",
    # 重大警示（選填，空白則不顯示）
    "risk_alert":  "今日（6/8 Mon）關鍵觀察（盤中、待盤後補實際資料）：（1）🔴 6/5 Fri 美股半導體爆量崩跌：SOX -8.71%、TSM ADR -6.69% 收 $415.17、$1T+ 半導體市值蒸發、為今日最大利空；（2）⚠️ Broadcom Q3 AI 指引 $16B 不及分析師估 $17.2B、未上修全年指引、AVGO -13% 引爆連動拋售；（3）⚠️ 5 月 NFP 強勁、10Y 美債殖利率突破 4.5%、Fed 升息預期升溫衝擊高估值科技股；（4）⚠️ 美對中 AI 晶片出口管制 6/1 起延伸至中企海外子公司；（5）📉 台股 2330 6/8 開盤是否跳空補跌反映 NYSE 6/5 -6.69% 崩跌；下方關鍵支撐 NT$2,355 / NT$2,300 / NT$2,250 心理整數 / NT$2,200；（6）📊 台美 ADR 溢價以 6/5 收盤計算自 +13.0% 收斂至 +9.04%、結構性反映 ADR 流動性；（7）⭐ 中長線結構性利多基底未變：6/4 AGM CEO Wei 確認 AI 需求超供應 + 2026 >30% 成長 + 3nm 漲價 15% + NVIDIA $150B/年投資 + NVIDIA-TSMC AI 製程合作 + Intel 確認長期夥伴；（8）🎯 短線最關鍵催化：⭐ TSMC 5 月月營收 6/10 公布、估 NT$420B+；若優於市場估、為短線止跌反彈訊號；（9）⚠️ TSMC 對前主管 Wei-Jen Lo 訴訟持續中；（10）台幣 31.05 升值壓力結構性續存；（11）32 位分析師全數看多、平均目標 NT$2,530 上行空間 +6.98%、Barclays $470 對應 NT$2,450；本日關鍵：6/8 台股是否跳空反映 NYSE -6.69% 崩跌、支撐 NT$2,355 / NT$2,300 / NT$2,250 心理整數",
}

# 三大法人買賣超（張）— 最新一日
INSTITUTIONAL = {
    "date":     "2026-06-05",       # 最新確認資料日（6/5 Fri）；6/8 三大法人資料待 TWSE 盤後公告
    "foreign":  -2500,              # 外資 6/5 估賣超（台股相對抗跌但 NYSE 同日崩跌、機構觀望）
    "trust":    -200,               # 投信 6/5 估持平
    "dealer":   -200,               # 自營商 6/5 估持平
    # 近5日（由舊到新：6/1, 6/2, 6/3, 6/4, 6/5）
    "foreign_5d": [+2000, +9500, +18500, -8500, -2500],   # 6/4 估 -8,500；6/5 估 -2,500（小幅賣超）
    "trust_5d":   [+1500, +2200, +3200, -1500, -200],      # 6/5 估持平
    "dealer_5d":  [+800, +1000, +1800, -500, -200],        # 6/5 估持平
    "foreign_ownership_pct": "75.3%",  # 外資持股比例（6/5 估）
    "foreign_ownership_shares": "約 195.2 億股",
}

# 技術分析指標（需每日從看盤軟體更新）
TECHNICAL = {
    "rsi_14":       55.0,   "rsi_signal": "RSI 估自 65 回落至 55（6/5 -0.84%），仍在中軸上方但動能明顯放緩；6/8 待盤後實際資料",
    "macd":         +1.0,   "macd_signal": "MACD 估自 +1.8 收斂至 +1.0、紅柱動能放緩、未死叉；6/8 待盤後實際資料",   "macd_color": "#4CAF50",
    "kdj_k":        58.0,   "kdj_d": 70.0, "kdj_j": 35.0, "kdj_signal": "KDJ K(58)/D(70)/J(35) 自高檔回落、J 自 64 跌至 35 動能轉弱；6/8 待盤後實際資料",
    "ma5":       "2,387",   # 5MA（6/1 2355, 6/2 2380, 6/3 2425, 6/4 2385, 6/5 2365）— 基於 6/5 收盤
    "ma20":      "2,332",   # 20MA 開始下彎
    "ma60":      "2,275",   # 60MA 上揚但收斂
    "ma120":     "2,148",
    "bb_upper":  "2,475",   # 布林上軌
    "bb_mid":    "2,332",   # 布林中軌（20MA）
    "bb_lower":  "2,188",   # 布林下軌
    "vol_ma5":  "51,500",   # 5日均量（張，估、基於 6/1-6/5 五日均）
    "trend":    "🔴 6/5 重大事件：美股半導體爆量崩跌——SOX -8.71% 收 12,431.25（單日跌幅 since 2025-04-07）、NYSE TSM 暴跌 -6.69% 收 $415.17（-$29.75 vs 6/4 $444.92）、AVGO 6/4-6/5 累計 -13%、NVDA -3.54%、$1T+ 半導體市值單日蒸發。崩跌觸發：（1）Broadcom Q3 AI 指引 $16B 不及分析師估值 $17.2B、未上修全年指引、引爆「sell-the-news」；（2）5 月 NFP 強勁、10Y 美債殖利率突破 4.5%；（3）美對中 AI 晶片出口管制 6/1 起延伸至中企海外子公司。✅ 6/5 Fri 台股 2330 實際收 NT$2,365（-20，-0.84% vs 6/4 NT$2,385）盤中區間 NT$2,350-2,405、量約 53,000 張，因時差未及反映 NYSE 同日崩跌、相對抗跌；6/5 加權指數收 45,070.94（-1.33%）。📊 今日（6/8 Mon）台股盤中、6/8 收盤資料待盤後補；市場關注台股 2330 是否跳空補跌反映 NYSE 6/5 -6.69% 崩跌。技術面（基於 6/5 收盤 NT$2,365）：RSI 估自 65 回落至 55、MACD +1.0 紅柱動能放緩、KDJ K(58)/D(70)/J(35) 自高檔回落；5MA NT$2,387 / 20MA NT$2,332 / 60MA NT$2,275 / 120MA NT$2,148 短期均線壓力、中期 60MA/120MA 仍多頭。下一觀察：（1）6/8 台股是否跳空反映 NYSE -6.69% 崩跌；（2）下方支撐 NT$2,355 / NT$2,300 / NT$2,250 心理整數 / NT$2,200；（3）反彈壓力 5MA NT$2,387 / NT$2,400 整數 / NT$2,425（6/3 史高）；（4）⭐ 中長線結構性利多基底未變：AGM CEO Wei 確認 AI 需求超供應 + 2026 >30% 成長 + 3nm 漲價 15%；（5）🎯 短線最關鍵催化：TSMC 5 月月營收 6/10 公布、估 NT$420B+ 為止跌反彈訊號；（6）⚠️ Fed 升息預期升溫、美對中出口管制擴大為短期下行壓力。",
    "support":  "2,355 / 2,300 / 2,250 / 2,200 (5MA 下緣、心理整數、120MA)",
    "resist":   "2,387 / 2,400 / 2,425 / 2,440 (5MA、整數、6/3 史高收、6/3 盤中史高)",
    "note": "技術指標數值為估算（基於 6/5 收盤 NT$2,365），請以看盤軟體即時數據為準；6/8 盤中、待盤後補實際資料；6/5 美股崩跌將於 6/8 反映於台股",
}

# 期貨與選擇權（來源：台灣期交所 TAIFEX）
DERIVATIVES = {
    "date":          "2026-06-05",       # 最新確認資料日（6/5 Fri）；6/8 衍生品資料待 TAIFEX 盤後公告
    "futures_price": "2,365",            # 台積電期貨近月（6/5 估收盤附近）
    "futures_oi":    "162,000",          # 未平倉量（口）（6/5 估）
    "futures_basis": "0",                # 6/5 估持平
    "call_oi":       "108,000",
    "put_oi":        "72,000",
    "pcr":           "0.67",             # Put/Call 比率（6/5 估、6/8 待 TAIFEX 公告）
    "pcr_signal":    "中性偏多（Put/Call 6/5 估 0.67；6/8 待 TAIFEX 公告。預期 6/5 美股崩跌將使 6/8 PCR 升溫至看空區、避險買盤增加）",
    "max_pain":      "2,400",            # 最大痛苦價格（近期到期、6/5 估）
    "key_strikes": [
        ("2,200", "Call 28,500 / Put 22,500", "心理整數深支撐"),
        ("2,250", "Call 32,500 / Put 18,500", "5/19 收、心理整數"),
        ("2,300", "Call 52,500 / Put 10,500", "心理整數"),
        ("2,355", "Call 58,500 / Put 7,800",  "5MA、反彈關卡"),
        ("2,365", "Call 60,000 / Put 7,200",  "6/5 收"),
        ("2,385", "Call 56,500 / Put 6,500",  "6/4 收"),
        ("2,400", "Call 55,500 / Put 7,800",  "最大痛苦價、心理整數"),
        ("2,425", "Call 58,500 / Put 6,800",  "6/3 史高收盤"),
        ("2,440", "Call 60,000 / Put 6,200",  "6/3 盤中史高"),
        ("2,500", "Call 45,200 / Put 4,200",  "短線挑戰價"),
    ],
    "note": "衍生品數據需每日至台灣期交所(taifex.com.tw)更新；6/8 衍生品資料待 TAIFEX 盤後公告；6/5 美股 SOX -8.71% + TSM ADR -6.69% 引爆連動拋售、預期 6/8 PCR 升溫；中長線結構性利多基底未變（AGM CEO Wei 確認 AI 超供應、Intel CEO 確認長期夥伴、NVIDIA-TSMC AI 合作、3nm 漲價 15%）",
}

# 供應鏈與客戶股價（需每日更新）
ECOSYSTEM_STOCKS = [
    # 類別、股票代碼、名稱、收盤價、漲跌幅、備註（2026-06-05 美股實際崩跌 + 台股 6/5 收）
    ("設備", "ASML",    "艾司摩爾",    "740.50", "-6.29%", "EUV 設備龍頭（6/5 重挫；SOX -8.71% 連動下跌）"),
    ("設備", "AMAT",    "應用材料",    "229.30", "-6.71%", "⭐ TSMC EPIC Center $5B AI 合作續存（6/5 重挫；連動拋售）"),
    ("設備", "LRCX",    "科林研發",    "905.20", "-6.54%", "蝕刻設備（6/5 重挫；半導體連動拋售）"),
    ("設備", "KLAC",    "科磊",        "680.30", "-6.21%", "量測設備（6/5 重挫；AI CapEx 增速放緩疑慮）"),
    ("記憶", "000660.KS","SK 海力士",  "352,000 KRW", "-5.38%", "HBM4 供應（6/5 重挫；半導體連動拋售）"),
    ("記憶", "MU",      "美光",        "138.20", "-8.65%", "HBM / DDR5（6/5 重挫 -8.65%；半導體拋售最重）"),
    ("封裝", "3711.TW", "日月光",      "298",    "-0.67%", "CoWoS 封裝（6/5 微跌；台股相對抗跌）"),
    ("客戶", "NVDA",    "輝達",        "241.20", "-3.54%", "🏆 #1 客戶 22%（6/5 -3.54% 相對抗跌；Blackwell/Vera Rubin 結構性需求未變）"),
    ("客戶", "AAPL",    "蘋果",        "286.80", "-0.93%", "⚠️ #2 客戶 17%（6/5 微跌；Apple 將跳過 A16 直上 A14 製程）"),
    ("客戶", "AVGO",    "博通",        "436.80", "-12.91%", "🔴 #3 客戶 13%（6/4-6/5 累計 -13%；Q3 AI 指引 $16B 不及預估 $17.2B、未上修全年指引、引爆 sell-the-news）"),
    ("客戶", "AMD",     "超微",        "452.30", "-6.22%", "#4 客戶 8%（6/5 重挫；半導體連動拋售）"),
    ("客戶", "2454.TW", "聯發科",      "4,520",  "-2.80%", "手機 SoC 客戶 9%；6/5 跟跌（資金輪出半導體）"),
    ("競爭", "INTC",    "英特爾",      "27.40",  "-6.16%", "🤝 Intel CEO Lip-Bu Tan 6/2 確認 TSMC「長期信任夥伴」（6/5 重挫；半導體連動）"),
    ("競爭", "005930.KS","三星電子",   "60,200 KRW", "-3.68%", "Samsung Foundry 6/5 跟跌；HBM4E NVIDIA 送樣中"),
    ("處分後", "ARM",   "Arm Holdings","235.20", "-5.85%", "TSMC 4/29 全數出脫後（6/5 重挫；半導體連動）"),
]
...
CONSENSUS = {
    "rating":       "強烈買入",
    "avg_target_tw":"NT$2,530.00",  # 共識（MarketScreener 6/3 更新；6/5 美股崩跌但中長線目標未變）
    "high_target":  "NT$3,300",
    "low_target":   "NT$2,100",
    "avg_target_us":"US$485.50",    # 分析師目標（6/2 ADR 史新高 $446.69 後上修；6/5 崩跌後仍維持）
    "analyst_count": 32,
    "buy": 32, "hold": 0, "sell": 0,
    "upside":       "+6.98%",   # 從 NT$2,365（6/5 實際收盤）到 NT$2,530
}
...
IR_CALENDAR = [
    ...
    ("2026-06-08", "📊 今日（盤中、待盤後補資料）；市場關注台股是否跳空補跌反映 NYSE 6/5 -6.69% 崩跌","今日（6/8 Mon）📊 台股 2330 盤中、6/8 收盤實際資料待盤後 TWSE 公告；市場關注台股是否跳空補跌反映 NYSE 6/5 -6.69% 崩跌 + SOX -8.71%；🔴 短線殺盤主因：（1）Broadcom Q3 AI 指引未上修全年、「sell-the-news」連動；（2）Fed 升息預期升溫衝擊高估值科技股；（3）美對中 AI 晶片出口管制擴大；（4）估值警示 TSM P/E 仍在 5 年 90%+ 高位；⭐ 中長線結構性利多基底未變：AGM CEO Wei 確認 AI 需求超供應 + 2026 >30% 成長 + 3nm 漲價 15% + NVIDIA $150B/年投資 + NVIDIA-TSMC AI 製程合作 + Intel 確認長期夥伴；🎯 短線最關鍵：⭐ TSMC 5 月月營收 6/10 公布、估 NT$420B+ 為止跌反彈訊號；本日關鍵支撐：NT$2,355 / NT$2,300 / NT$2,250 心理整數","#FFCDD2"),
    ("2026-06-10", "📅 TSMC 5 月月營收公布（短線最關鍵催化）","TSMC 預計 6/10 前公布 5 月合併月營收；4 月 NT$410.73B；市場估 5 月 NT$420B+；若優於預估為止跌反彈關鍵訊號；若不及預估恐加深下行壓力","#FF9800"),
...
# 總體經濟監控
MACRO = [
    ("SOX 半導體指數",  "12,431.25","-8.71%", False),  # 6/5 SOX 爆量重挫（自 2025-04 解放日以來最大）
    ("台股加權指數",    "45,070.94","-1.33%", False),  # 6/5 加權指數實際收（相對抗跌）；6/8 估 -2.5%
    ("VIX 恐慌指數",    "21.5",    "+5.8",   False),   # 恐慌指數大跳升、半導體崩跌
    ("WTI 原油",        "$70.2",   "+0.58%", True),    # 油價微漲
    ("10Y 美債殖利率",  "4.52%",   "+0.38pp",False),   # 5 月 NFP 強勁推升、突破 4.5%
    ("台幣/美元",       "31.05",   "0.00",   False),   # 台幣持穩（每升值 1% 毛利率 -40bps）
    ("NVIDIA NVDA",     "$241.20", "-3.54%", False),   # #1 TSMC 客戶（22%），6/5 -3.54% 相對抗跌
    ("ASML",            "$740.50", "-6.29%", False),   # 設備股 6/5 重挫；半導體連動拋售
]
...
RELATIVE = {
    "date":           "2026-06-05",       # 最新確認資料日（6/5 Fri 收盤）；6/8 資料待盤後補
    "tsmc_tw_1d":     -0.84,   # 2330 6/5 實際收 NT$2,365（-20 vs 6/4 NT$2,385）
    "taiex_1d":       -1.33,   # 加權指數 6/5 收 45,070.94（-1.33%）
    "sox_1d":         -8.71,   # SOX 6/5 爆量重挫 -8.71%
    "tsmc_nyse_1d":   -6.69,   # TSM ADR 6/5 $415.17 (-$29.75 vs 6/4 $444.92)
    "tsmc_tw_5d":     +0.42,   # 5 日（NT$2,365 vs 6/1 NT$2,355）
    "taiex_5d":       -0.60,
    "tsmc_tw_1m":     +9.74,   # 月線（NT$2,365 vs NT$2,155 ~5/8）
    "taiex_1m":       +10.5,
    "tsmc_tw_ytd":    +12.89,  # YTD 累計（NT$2,365 vs 年初 ~NT$2,095）
    "taiex_ytd":      +14.0,
    "sox_ytd":        +66.5,   # SOX YTD 自高位回落
    "beta_60d":        1.38,   # 60 日滾動 Beta vs TAIEX
    # ADR 折溢價（以 6/5 NYSE & TW 最新收盤計算）
    "adr_price":     415.17,   # TSM NYSE 6/5 實際收盤（-$29.75，-6.69% vs 6/4 $444.92）
    "adr_parity":    380.74,   # 理論值 = 5 × NT$2,365 ÷ 31.05
    "adr_ratio":     "5:1",    # 1 ADR = 5 台積電普通股
    "usd_ntd":        31.05,   # 同 MACRO 台幣匯率
    "adr_premium_pct": "+9.04", # (415.17 - 380.74) / 380.74 × 100 = +9.04%（自 +13.0% 大幅收斂）
    "note": "ADR 理論值 = 5 × 台股收盤 ÷ 匯率（不含交易摩擦與流動性溢價）。🔴 6/5 Fri 美股半導體爆量崩跌：SOX -8.71%、NYSE TSM -6.69% 收 $415.17、$1T+ 半導體市值蒸發；台股 2330 6/5 因時差未及反映、相對抗跌 -0.84%；6/8 Mon 盤中、待盤後補實際資料。📊 台美 ADR 溢價以 6/5 收盤計算自 +13.0% 大幅收斂至 +9.04%；崩跌觸發 Broadcom Q3 AI 指引未上修 + Fed 升息預期升溫 + 美對中出口管制擴大；⭐ 中長線結構性基底未變：AGM CEO Wei 確認 AI 需求超供應 + NVIDIA $150B/年台灣投資 + 3nm 漲價 15% + NVIDIA-TSMC AI 製程合作 + Intel 確認長期夥伴",
}
...
NEWS = [
    {
        ...
        "title": "🔴 6/5 Fri 美股半導體爆量崩跌：SOX -8.71%、TSM ADR -6.69% 收 $415.17、$1T+ 半導體市值蒸發",
        "body": "6/5 Fri 美股半導體爆量崩跌、創 2025-04 解放日以來最大單日跌幅：（1）SOX -8.71% 收 12,431.25（-1,186.24）、單日跌幅 since 2025-04-07；（2）NYSE TSM 暴跌 -6.69% 收 $415.17（-$29.75 vs 6/4 $444.92）；（3）AVGO 6/4-6/5 累計 -13%、MU -8.65%、AMD -6.22%、INTC -6.16%、ASML -6.29%、AMAT -6.71%、NVDA -3.54% 相對抗跌；（4）$1T+ 半導體市值單日蒸發；（5）⚠️ 崩跌觸發三大主因：（a）Broadcom 6/3 盤後 Q3 AI 半導體營收指引 $16B 雖 +200% YoY 但不及分析師估值 $17.2B、且未上修 2026 全年 AI 指引、引爆「sell-the-news」拋售；（b）5 月 NFP 大幅優於預期、推升 10Y 美債殖利率突破 4.5%、Fed 升息預期升溫；（c）美對中 AI 晶片出口管制 6/1 起延伸至中企海外子公司；（6）今日（6/8 Mon）台股盤中、待盤後 TWSE 公告；市場關注台股 2330 是否跳空補跌反映 NYSE -6.69% 崩跌；（7）⭐ 中長線結構性利多基底未變：AGM CEO Wei 確認 AI 需求超供應、2026 >30% 成長、3nm 漲價 15%、NVIDIA $150B/年投資。",
        "source": "Yahoo Finance / TechStory / TradingKey / Reuters 2026-06-05", "impact": "負面",
    },
    {
        "tag": "客戶動態", "tag_color": "#2196F3",
        "title": "⚠️ Broadcom Q3 AI 指引 $16B 不及預估 $17.2B、未上修全年指引、AVGO 6/4-6/5 累計 -13% 引爆連動",
        "body": "TSMC 第 3 大客戶 Broadcom (AVGO) 6/3 盤後 Q2 FY2026 財報亮眼但 Q3 AI 指引令市場失望：（1）Q2 實際營收 $22.2B（+48% YoY）創史高；（2）Q2 AI 半導體 $10.8B（+143% YoY）；（3）⚠️ Q3 AI 半導體指引 $16.0B（+200% YoY）但不及分析師估 $17.2B；（4）⚠️ 未上修 2026 全年 AI 指引（維持 $56B、+180%）；（5）市場開始質疑 AI CapEx 增速放緩、引爆「sell-the-news」拋售、AVGO 6/4 -13%、6/5 續跌、累計 -13%；（6）⚠️ 此為 TSMC 6/5 -6.69% 崩跌主因——Broadcom Custom ASIC（XPU）由 TSMC 3nm + CoWoS 全包代工、占 CoWoS 產能 12%、Broadcom AI 指引疲弱直接質疑 TSMC AI 需求結構性；（7）⭐ 然而 Q2 實際 AI $10.8B（+143%）+ Q3 指引仍 +200%、長線 AI 需求趨勢未變、僅市場對「再加速」失望；（8）AVGO 6/5 收 $436.80（-12.91% 累計）；TSMC 6/8 是否跳空補跌反映此利空、待盤後 TWSE 公告。",
        "source": "CNBC / Heygotrade / Kavout / Yahoo Finance 2026-06-03 - 06-05", "impact": "負面",
    },
    {
        "tag": "法規政策", "tag_color": "#FF9800",
        "title": "⚠️ 5 月 NFP 強勁、10Y 美債殖利率突破 4.5%、Fed 升息預期升溫；高估值科技股壓力升溫",
        "body": "6/5 美國 5 月非農就業 (NFP) 報告大幅優於市場預期、引爆高估值科技股下行壓力：（1）5 月 NFP 大幅優於預期、勞動市場仍緊俏；（2）⚠️ 推升 10Y 美債殖利率突破 4.5% 關鍵心理整數；（3）Fed Funds 期貨重新定價、年內升息預期升溫；（4）高估值科技股首當其衝、SOX -8.71%、Nasdaq 6/5 大跌；（5）TSM 6/5 -6.69% 至 $415.17、P/E TTM 自 36.2x 回落至 ~34.4x；（6）⚠️ 估值警示：TSM ADR 雖回落但仍在 5 年區間 90%+ 高位（5 年高 37.8x、低 9.8x、均 18.5x）；（7）對 TSMC 影響：（a）高估值科技股估值收縮；（b）美元走強加劇台幣升值壓力、毛利率 -40bps/1%；（c）若 Fed 真升息將擴大全球 AI CapEx 融資成本；（8）⭐ 短線最關鍵催化：TSMC 5 月月營收 6/10 公布、估 NT$420B+ 為止跌反彈訊號。",
        "source": "Yahoo Finance / Reuters / eciks 2026-06-05", "impact": "負面",
    },
    {
        "tag": "地緣政治", "tag_color": "#607D8B",
        "title": "⚠️ 美對中 AI 晶片出口管制 6/1 起延伸至中企海外子公司、增加客戶接單複雜度",
        "body": "6/5 美股半導體拋售第三大主因——美對中 AI 晶片出口管制範圍擴大：（1）美國商務部 6/1 起擴大 AI 晶片出口管制範圍、由原中國本土延伸至中企海外子公司（涵蓋全球）；（2）目的：堵塞中國透過第三方司法管轄區（新加坡、馬來西亞、UAE 等）取得高效能半導體的漏洞；（3）⚠️ 對 TSMC 影響：（a）客戶端進階盡職調查要求增加；（b）部分中國海外子公司訂單接單複雜度上升；（c）TSMC 需強化客戶國籍認證機制；（4）⚠️ 對 NVDA / AMD / AVGO 等下游客戶影響更大——須過濾轉售至中企海外子公司的訂單；（5）此為 6/5 半導體連動拋售第三大觸發因素；（6）⭐ 然而對 TSMC 全球客戶結構（NVIDIA 22%、Apple 17%、AVGO 13%）影響有限、主要客戶皆為美企；（7）長線結構性影響不大、短線增加不確定性。",
        "source": "Kavout / Reuters / Bloomberg 2026-06-05", "impact": "負面",
    },
    {
        "tag": "客戶動態", "tag_color": "#2196F3",
        "title": "✅ 6/5 台股 2330 實際收 NT$2,365（-0.84%）相對抗跌；NYSE TSM 同日 -6.69% 因時差未及反映",
        "body": "6/5 Fri 台股 2330 因時差因素相對抗跌、未及反映 NYSE 同日崩跌：（1）2330 6/5 實際收 NT$2,365（-20，-0.84% vs 6/4 NT$2,385），盤中區間 NT$2,350-2,405、開 NT$2,395；（2）✅ 加權指數 6/5 收 45,070.94（-1.33%）；（3）⚠️ NYSE TSM 6/5 暴跌 -6.69% 收 $415.17 在台股收盤後才發生；（4）今日（6/8 Mon）台股盤中、待盤後 TWSE 公告 6/8 收盤實際資料；市場關注是否跳空補跌反映 NYSE -6.69% 崩跌；（5）6/8 三大法人買賣超待 TWSE 盤後公告；（6）⭐ 中長線結構性利多基底未變：🏛️ 6/4 AGM CEO Wei 確認 AI 需求超供應、2026 >30% 成長、3nm 漲價 15%；NVIDIA $150B/年投資；NVIDIA-TSMC AI 製程合作；Intel CEO 確認長期夥伴；（7）⚠️ 關鍵防線：6/8 下方支撐 NT$2,355 / NT$2,300 / NT$2,250 心理整數、反彈壓力 5MA / NT$2,400 整數；（8）🎯 短線最關鍵：⭐ TSMC 5 月月營收 6/10 公布、估 NT$420B+ 為止跌反彈關鍵訊號。",
        "source": "Yahoo股市 / Goodinfo / TWSE 2026-06-05", "impact": "中性",
    },
    {
        "tag": "法規政策", "tag_color": "#FF9800",
        "title": "🏛️ 6/4 AGM 通過 2025 財報：EPS NT$66.25、CEO Wei 確認 AI 需求超供應、2026 >30% 成長（中長線結構性利多）",
        "body": "TSMC 6/4 Thu 於新竹召開 2026 年度股東會、為中長線結構性利多基底：（1）股東通過 2025 年業務報告與財務報表：合併營收 NT$3,809.05B、淨利 NT$1,717.88B、稀釋 EPS NT$66.25；（2）⭐ CEO 魏哲家對股東確認：AI 需求將持續超越全球半導體供應、儘管 TSMC 全力推進美國擴廠仍難滿足客戶對先進晶片的強勁需求；（3）TSMC 重申 2026 全年營收成長 >30% 指引（自 1 月 25% 上修）；（4）3nm 製程 H2 漲價 15% + 2027 再漲 5-10% 計畫不變；（5）CapEx FY2026 維持 $52-56B 高端、A14 製程 2028 量產、A16 H2 2026 量產確認；（6）⚠️ 然 6/5 美股半導體爆量崩跌（SOX -8.71%、TSM -6.69%）使 AGM 利多被市場拋售壓制、短線情緒主導；（7）⭐ AGM 利多為中長線結構性基底、待短線崩跌情緒消化後重新評估；（8）關鍵驗證：⭐ TSMC 5 月月營收 6/10 公布、估 NT$420B+ 將驗證 CEO Wei「AI 需求超供應」承諾。",
        "source": "TipRanks / GuruFocus / Digitimes 2026-06-04", "impact": "正面",
    },
    {
        "tag": "產業趨勢", "tag_color": "#4CAF50",
        "title": "✅ BofA 上修 2026 全球晶片市場至 $1.3 兆；Broadcom「chips-only」轉型、2027 AI 指引維持 >$100B 不變（崩跌中的長線定錨）",
        "body": "6/8 在 6/5 半導體崩跌後、多項長線結構性利多訊號浮現、提供逢低定錨：（1）⭐ BofA 上修 2026 全球晶片市場規模至 $1.3 兆、點名 NVIDIA、Broadcom、Marvell、AMD 為四大成長引擎、全數為 TSMC 先進製程客戶；（2）⭐ Broadcom 雖 6/5 重挫 -13%、但 CEO Hock Tan 確認策略轉型為「custom AI chips only」（聚焦自研 ASIC、不再供整機系統）、2027 AI 半導體營收指引維持 >$100B 不變；（3）Broadcom 現有 6 大核心自研晶片客戶——Anthropic、OpenAI、Google、Meta 等、訂單鎖定至 2028、Anthropic 去年 12 月下單約 $100 億自研矽；（4）⭐ 產業趨勢：Custom ASIC 出貨增速 2026 首度超越 GPU、由現成晶片轉向客製加速器、TSMC 為兩者唯一先進製程代工；（5）⚠️ 6/5 崩跌反映的是「sell-the-news」與估值收縮、而非 AI 需求基本面逆轉——AI CapEx 多廠商化、訂單能見度延伸至 2028；（6）⭐ 對 TSMC 意涵：無論 GPU 或 ASIC 路線勝出、TSMC 3nm/2nm + CoWoS 皆為必經產能、結構性受惠不變；（7）短線觀察 6/10 TSMC 5 月月營收（估 NT$420B+）能否驗證需求韌性。",
        "source": "Yahoo Finance (BofA) / TechTimes / CNBC / Heygotrade 2026-06-05 - 06-08", "impact": "正面",
    },
]
