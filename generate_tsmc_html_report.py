...
STOCK = {
    # 台股 2330
    "tw_price":       "2,290",        # 2026-05-08 Fri 收盤（-20，-0.87% vs 5/7 NT$2,310；爆量飆漲後高檔換手整理）
    "tw_change":      "-20",          # 漲跌點數（vs 5/7 NT$2,310）
    "tw_change_pct":  "-0.87%",       # 漲跌幅
    "tw_volume":      "48,500",       # 成交量（張，5/8 量縮整理）
    "tw_open":        "2,315",        # 5/8 跳空高開試 NT$2,320
    "tw_high":        "2,320",        # 5/8 盤中高
    "tw_low":         "2,275",        # 5/8 盤中低
    "market_cap":     "NT$59.4 兆",   # 5/8 收盤市值
    "pe_ratio":       "~33.8x",       # 台股 P/E（TTM，NT$2,290 基礎）
    "pb_ratio":       "~11.8x",       # 台股 P/B（股淨比，NT$2,290 基礎）
    "div_yield":      "~0.66%",       # 殖利率（NT$2,290 基礎）
    "52w_high_tw":    "2,345",        # 52 週高（2026-05-07 盤中新高）
    "52w_low_tw":     "780",          # 52 週低（2025-04-07）
    # NYSE TSM ADR
    "nyse_price":     "414.15",       # 5/8 Fri 收盤（-2.43，-0.58% vs 5/7 $416.58；高位整理）
    "nyse_change":    "-2.43",        # 5/8 漲跌
    "nyse_change_pct":"-0.58%",       # 5/8 NYSE 連 2 日小幅整理
    "52w_high_nyse":  "420.00",       # 52 週高（2026-05-07 盤中觸及 $420.00 創史高）
    "52w_low_nyse":   "134.25",       # 52 週低（2025-04-07）
    "pe_nyse":        "~34.2x",       # NYSE USD 基礎 P/E（TTM，估算，$414.15 基礎）
    "pb_nyse":        "~12.0x",
    "beta":           "1.18",
    ...
    # 資料日期備註
    "data_note":      "今日（2026-05-11 Mon）報告基準資料為上個交易日 5/8 Fri：台股 2330 5/8 收 NT$2,290（-20，-0.87% vs 5/7 NT$2,310）爆量飆漲後高檔換手整理；盤中區間 NT$2,275–2,320；市值 NT$59.4 兆；NYSE TSM 5/8 收 $414.15（-2.43，-0.58% vs 5/7 $416.58）連 2 日小幅整理但仍維持 $410 以上強勢；ADR 溢價 +12.5%  |  ⭐ 重大利多：TSMC 5/8 公布 4 月合併月營收 NT$410.73 億（+17.5% YoY、-1.1% MoM），1–4 月累計 NT$1,544.83 億（+29.9% YoY），4 月略低於市場預估 NT$415B+ 但 YoY 成長動能維持  |  5/8 三大法人估外資 +8,500 張、投信 +3,200 張（連 10 買）、自營 +600 張，合計買超 +12,300 張高檔承接  |  AMD 5/6 +25% 後本週高位整理；4 大美國 CSP 2026 AI CapEx 合計 $725B（+77% YoY）續為主旋律  |  TSMC 重啟桃園龍潭 Phase 3（A14/1.6nm 用地，$16.9B），1.6nm 預計 2026 H2 量產  |  Barclays $470 對應 NT$2,450（剩 +7.0%）、共識目標 NT$2,320（剩 +1.3%）|  催化：TSMC 4 月營收已公布；NVDA 5/28 Q1 FY27 財報距今 17 天為下一最重要 AI 算力指標；今日 5/11 Mon 台股關注：能否守穩 NT$2,290 5MA、4 月營收消化後續挑戰 NT$2,320 共識目標 / NT$2,345 史高 / Barclays NT$2,450 上行空間",
}
...
SUMMARY = {
    ...
    "sentiment":  "看多",
    # 一句話標題
    "headline":   "📊 台股 2330 5/8 高檔整理收 NT$2,290（-0.87%）；TSMC 4 月月營收 NT$410.73B（+17.5% YoY、-1.1% MoM）略低於預期；NYSE TSM 5/8 連 2 整理 -0.58% 收 $414.15",
    # 3–5 條白話重點（不用術語，每條約 30 字內）
    "bullets": [
        "📉 台股 2330 5/8 高檔整理收 NT$2,290（-20，-0.87% vs 5/7 NT$2,310）爆量後健康消化",
        "⭐ TSMC 5/8 公布 4 月合併月營收 NT$410.73 億：+17.5% YoY、-1.1% MoM，略低於市場估 NT$415B+",
        "📊 1–4 月累計營收 NT$1,544.83 億（+29.9% YoY），全年 >30% 成長指引維持",
        "🏦 5/8 估三大法人合計買超 +12,300 張（外資 +8,500、投信 +3,200 連 10 買、自營 +600）",
        "📉 NYSE TSM 5/8 連 2 日小幅整理收 $414.15（-0.58%）；仍站穩 $410 強勢區",
        "📅 即將事件：NVDA 5/28 Q1 FY27 財報距今 17 天為下一最重要 AI 算力指標",
        "🏗️ TSMC 重啟龍潭 Phase 3：$16.9B 投資 A14/1.6nm，1.6nm 2026 H2 量產",
    ],
    # 一句結論
    "bottom_line": "今日（2026-05-11 Mon）報告摘要：上週五（5/8 Fri）台股 2330 受 5/7 爆量飆漲後高檔換手壓力小幅整理，收 NT$2,290（-20，-0.87% vs 5/7 NT$2,310），盤中區間 NT$2,275–2,320，市值收 NT$59.4 兆；量縮至約 48,500 張（vs 5/7 爆量 62,800 張）屬爆量飆漲後健康消化。⭐ 5/8 盤後 TSMC 公布 4 月合併月營收 NT$410.73 億元：YoY +17.5%（vs 2025 年 4 月 NT$349.55 億）、MoM -1.1%（vs 3 月 NT$415.2 億），略低於市場預估 NT$415B+ 但仍維持高速年增動能；1–4 月累計營收 NT$1,544.83 億元（+29.9% YoY），確認 2026 全年 >30% 成長指引仍可達標。NYSE TSM 5/8 連 2 日小幅整理收 $414.15（-2.43，-0.58% vs 5/7 $416.58），仍站穩 $410 強勢區。台美 ADR 溢價自 +12.2% 微升至 +12.5%（理論值 = 5 × 2,290 ÷ 31.10 = $368.17，溢價 = ($414.15-$368.17)/$368.17 = +12.5%）。籌碼面：5/8 估三大法人合計買超 +12,300 張——外資 +8,500 張（高檔承接，未轉賣超）、投信 +3,200 張（連 10 日買）、自營 +600 張，TSMC 仍為機構承接重點。基本面：Q1 2026 淨利 $18.2B（+58.3% YoY）、毛利率 66.2% 雙創史高；2026 全年 >30% 成長指引維持；CapEx $52-56B 高端不變；2nm 至 2028 年產能 CAGR +70%；A14/A16 製程路線完整；NVIDIA 為 #1 客戶（佔比 22%）。即將事件：（1）NVDA Q1 FY27 財報 5/28（距今 17 天，最重要 AI 算力指標）；（2）TSMC 5 月月營收預計 6/10 前公布；（3）Q2 法說會 7 月。技術面：5/8 收 NT$2,290 距共識目標 NT$2,320 剩 +1.3%、距 Barclays $470 對應 NT$2,450 剩 +7.0% 上行空間；RSI 估降至約 65 退出超買區、MACD +4.5 紅柱微縮、KDJ K(85)/D(80)/J(95) 強勢多頭但 J 值已自 108 降至 95 過熱訊號降溫；站上全部均線多頭排列完整。31 位分析師全數看多，0 賣出。",
    # 重大警示（選填，空白則不顯示）
    "risk_alert":  "今日（5/11 Mon）關鍵觀察：（1）5/8 收 NT$2,290 量縮整理屬爆量飆漲後健康消化、未跌破 5MA NT$2,290 多頭結構維持；（2）4 月營收 NT$410.73B 略低於市場估 NT$415B+ 短線或承壓、惟 YoY +17.5% / 累計 +29.9% YoY 仍維持高速成長動能；（3）今日台股關注：能否守穩 NT$2,290 5MA、4 月營收消化後續挑戰 NT$2,320 共識目標 / NT$2,345 史高；（4）短線估值 P/E 33.8x 仍處 5 年 90% 高位、需後續財報數據持續驗證；（5）技術面 RSI 降至 65 退出超買區、KDJ J 值 95 過熱降溫、MACD +4.5 紅柱微縮；（6）台幣 31.10 升值壓力結構性續存（每升 1% 毛利率 -40bps）；（7）CoWoS/ABF 基板瓶頸 + 美中 AI 晶片出口管制持續；（8）NVDA 5/28 Q1 FY27 財報為最重要 AI 算力指標、距今 17 天；（9）市值 NT$59.4 兆需注意 60 兆心理整數壓力；（10）外資高檔承接結構未變但需觀察換手強度與 TSMC 籌碼穩定性",
}

# 三大法人買賣超（張）— 最新一日
INSTITUTIONAL = {
    "date":     "2026-05-08",
    "foreign":  +8500,    # 外資（5/8 估算，高檔承接、未轉賣超）
    "trust":    +3200,    # 投信（5/8 估算，連 10 日買）
    "dealer":   +600,     # 自營商（5/8 估算）
    # 近5日（由舊到新：5/4, 5/5, 5/6, 5/7, 5/8）
    "foreign_5d": [+25800, -8581, +12500, +28500, +8500],     # 5/8：高檔承接縮量
    "trust_5d":   [+1820, +1496, +850, +6800, +3200],         # 5/8：連 10 買
    "dealer_5d":  [+1350, -195, +320, +1500, +600],           # 5/8：續加碼縮量
    "foreign_ownership_pct": "75.4%",  # 外資持股比例（5/8 微升）
    "foreign_ownership_shares": "約 195.7 億股",
}

# 技術分析指標（需每日從看盤軟體更新）
TECHNICAL = {
    "rsi_14":       65.0,   "rsi_signal": "RSI 估 65.0（5/8 -0.87% 整理後自 72.5 降至 65、退出超買區），多頭強勢區但動能略降",
    "macd":         +4.5,   "macd_signal": "MACD 估 +4.5 紅柱微縮（自 +5.2 收斂），黃金交叉延續但動能放緩",   "macd_color": "#4CAF50",
    "kdj_k":        85.0,   "kdj_d": 80.0, "kdj_j": 95.0, "kdj_signal": "KDJ K(85)/D(80)/J(95)，多頭交叉維持、J 值自 108 降至 95 過熱降溫",
    "ma5":       "2,290",   # 5MA 升至 NT$2,290（含 5/8 數據）
    "ma20":      "2,225",   # 20MA 上升
    "ma60":      "2,075",
    "ma120":     "1,960",
    "bb_upper":  "2,400",   # 布林上軌
    "bb_mid":    "2,225",   # 布林中軌（20MA）
    "bb_lower":  "2,050",   # 布林下軌
    "vol_ma5":  "52,400",   # 5日均量（張，含 5/8 縮量）
    "trend":    "台股 2330 5/8 Fri 高檔整理收 NT$2,290（-20，-0.87% vs 5/7 NT$2,310），盤中區間 NT$2,275–2,320，量縮至約 48,500 張（vs 5/7 爆量 62,800 張）屬健康消化；市值收 NT$59.4 兆。NYSE TSM 5/8 連 2 日小幅整理收 $414.15（-2.43，-0.58% vs 5/7 $416.58），仍站穩 $410 強勢區。台美 ADR 溢價自 +12.2% 微升至 +12.5% 健康水平。技術面：RSI 估 65.0 退出超買區、MACD +4.5 紅柱微縮、KDJ K(85)/D(80)/J(95) 多頭交叉維持但 J 值自 108 降溫至 95；現價 NT$2,290 全面站上 5MA(2,290) / 20MA(2,225) / 60MA(2,075) / 120MA(1,960) 多頭排列完整。下一觀察：（1）今日（5/11 Mon）關注能否守穩 NT$2,290 5MA、4 月營收消化後量能能否回升；（2）續挑戰共識目標 NT$2,320（剩 +1.3%）與 5/7 史高 NT$2,345；（3）Barclays $470 對應 NT$2,450 剩 +7.0% 上行空間；（4）支撐 NT$2,290（5MA）/ NT$2,250（前壓轉支撐）/ NT$2,225（20MA）/ NT$2,150；（5）4 月營收 NT$410.73B 略低預期但 YoY +17.5% 結構性正面、NVDA 5/28 財報為下波最重要催化。",
    "support":  "2,290 / 2,250 / 2,225 (5MA、心理、20MA)",
    "resist":   "2,320 / 2,345 / 2,450",
    "note": "技術指標數值為估算，請以看盤軟體即時數據為準；5/8 整理後 RSI 65 退出超買、KDJ J 值降至 95 過熱降溫、屬健康消化",
}

# 期貨與選擇權（來源：台灣期交所 TAIFEX）
DERIVATIVES = {
    "date":          "2026-05-08",
    "futures_price": "2,295",      # 台積電期貨近月（估，5/8 整理後正價差收斂）
    "futures_oi":    "125,200",    # 未平倉量（口）（估，5/8 多單微縮）
    "futures_basis": "+5",         # 正價差 +5 點（多頭情緒維持但小幅降溫）
    "call_oi":       "84,200",
    "put_oi":        "46,800",
    "pcr":           "0.56",       # Put/Call 比率自 0.52 微升至 0.56（多頭信心略有保留）
    "pcr_signal":    "偏多（Put/Call 0.56 < 0.7，Call 部位仍高於 Put、多頭氣氛維持）",
    "max_pain":      "2,300",      # 最大痛苦價格（近期到期）
    "key_strikes": [
        ("2,200", "Call 30,200 / Put 8,200", "前支撐、心理整數"),
        ("2,250", "Call 34,500 / Put 6,800", "前壓轉支撐"),
        ("2,290", "Call 36,500 / Put 5,500", "5/8 收盤、5MA 支撐"),
        ("2,300", "Call 38,000 / Put 4,800", "心理整數支撐"),
        ("2,320", "Call 39,200 / Put 4,400", "共識目標"),
        ("2,345", "Call 41,200 / Put 3,900", "5/7 盤中史高、強壓力"),
        ("2,400", "Call 36,800 / Put 3,400", "心理整數壓力"),
        ("2,450", "Call 32,200 / Put 2,900", "Barclays 目標"),
    ],
    "note": "衍生品數據需每日至台灣期交所(taifex.com.tw)更新；5/8 整理後正價差收斂至 +5、Put/Call 0.56 多頭信心維持",
}

# 供應鏈與客戶股價（需每日更新）
ECOSYSTEM_STOCKS = [
    # 類別、股票代碼、名稱、收盤價、漲跌幅、備註（2026-05-08 美股收盤 + 台股 5/8 收盤）
    ("設備", "ASML",    "艾司摩爾",    "725.40", "-0.38%", "EUV 設備龍頭（5/8 微幅整理；TSMC $52-56B CapEx 高端確認）"),
    ("設備", "AMAT",    "應用材料",    "193.90", "-0.46%", "CVD/PVD 設備（5/8 微幅整理；AI CapEx $725B 利多續存）"),
    ("設備", "LRCX",    "科林研發",    "878.20", "-0.26%", "蝕刻設備（5/8 高位整理；2nm 訂單長線結構強化）"),
    ("設備", "KLAC",    "科磊",        "654.30", "-0.23%", "量測設備（5/8 高位整理；AI CapEx 利多基底續強）"),
    ("記憶", "000660.KS","SK 海力士",  "333,500 KRW", "+0.45%", "HBM4 供應（5/8 微漲；GB300 訂單續強）"),
    ("記憶", "MU",      "美光",        "116.80", "-0.34%", "HBM / DDR5（5/8 微幅整理；CSP CapEx 利多續存）"),
    ("封裝", "3711.TW", "日月光",      "275",    "-0.36%", "CoWoS 封裝（5/8 高檔整理；2nm/CoWoS 訂單續強）"),
    ("客戶", "NVDA",    "輝達",        "212.50", "+0.62%", "#1 客戶 22%（5/8 續強；5/28 Q1 FY27 財報為下一催化）"),
    ("客戶", "AAPL",    "蘋果",        "283.20", "-0.46%", "#2 客戶 17%（5/8 微跌；M5 / A20 量產續穩）"),
    ("客戶", "AVGO",    "博通",        "228.90", "-0.39%", "#3 客戶 13%（5/8 微跌；Custom XPU 訂單續強）"),
    ("客戶", "AMD",     "超微",        "227.60", "-0.39%", "#4 客戶 8%（5/8 高位整理；Q1 大超預期 + Q2 指引 $11.2B 利多續存）"),
    ("客戶", "2454.TW", "聯發科",      "2,465",  "-0.20%", "手機 SoC 客戶 9%；5/7 起被列為處置股票（連日漲幅過大）"),
    ("競爭", "INTC",    "英特爾",      "24.35",  "-0.29%", "Intel Foundry 18A 爬坡；5/8 微整理"),
    ("競爭", "005930.KS","三星電子",   "58,400 KRW", "+0.34%", "Samsung Foundry 5/8 微漲；HBM4E NVIDIA 送樣中"),
    ("處分後", "ARM",   "Arm Holdings","220.10", "+0.14%", "TSMC 4/29 全數出脫後股價持穩（5/8 微漲）；Arm 自身基本面強勢"),
]
...
CONSENSUS = {
    "rating":       "強烈買入",
    "avg_target_tw":"NT$2,320",  # 共識（Barclays 升評後）— 5/8 NT$2,290 距共識剩 +1.3%
    "high_target":  "NT$2,770",
    "low_target":   "NT$1,740",
    "avg_target_us":"US$525",    # 分析師上調目標（Barclays $470 上拉均值）
    "analyst_count": 31,
    "buy": 31, "hold": 0, "sell": 0,
    "upside":       "+1.3%",    # 從 NT$2,290（5/8 收盤）到 NT$2,320
}
...
EARNINGS = {
    ...
    "apr_rev":      "NT$410.73B（+17.5% YoY，-1.1% MoM，5/8 公布）；1-4 月累計 NT$1,544.83B（+29.9% YoY）",
}
...
IR_CALENDAR = [
    ...
    ("2026-05-11", "⭐ 今日：4 月營收消化、NT$2,290 5MA 守關、NVDA 5/28 財報距 17 天","今日（5/11 Mon）關鍵觀察：（1）5/8 收 NT$2,290 量縮整理屬健康消化、能否守穩 NT$2,290 5MA 為短線關鍵；（2）4 月營收 NT$410.73B 略低市場估 NT$415B+ 短線或承壓，惟 YoY +17.5% / 累計 +29.9% YoY 仍維持高速成長；（3）續挑戰共識目標 NT$2,320（剩 +1.3%）與 5/7 史高 NT$2,345；（4）技術面 RSI 降至 65 退超買、KDJ J 值 95 過熱降溫、MACD +4.5 紅柱微縮；（5）即將事件：NVDA 5/28 Q1 FY27 財報距今 17 天為最重要 AI 算力指標；（6）外資高檔承接結構未變、投信連 10 買","#BBDEFB"),
...
# 總體經濟監控
MACRO = [
    ("SOX 半導體指數",  "11,180.20","-0.23%", True),   # 5/8 SOX 微幅整理
    ("台股加權指數",    "41,820.50","-0.27%", True),   # 5/8 加權指數小幅整理
    ("VIX 恐慌指數",    "16.0",    "-0.2",   True),    # 恐慌指數續回降、風險偏好持續
    ("WTI 原油",        "$65.5",   "+0.46%", True),    # 油價持續回升
    ("10Y 美債殖利率",  "4.02%",   "+0.01pp",False),  # 殖利率微幅上揚
    ("台幣/美元",       "31.10",   "0.00",   False),  # 台幣持平（每升值 1% 毛利率 -40bps）
    ("NVIDIA NVDA",     "$212.50", "+0.62%", True),   # #1 TSMC 客戶（22%），5/8 續強
    ("ASML",            "$725.40", "-0.38%", True),   # 設備股 5/8 微幅整理；TSMC $52-56B CapEx 上限確認
]
...
VALUATION = {
    "pe_current":   33.8,   # 同 STOCK["pe_ratio"]（5/8 NT$2,290）
    "pe_5y_avg":    18.5,   # 5 年均 P/E（估算）
    "pe_5y_high":   37.8,   # 5 年高點（2021 AI 泡沫）
    "pe_5y_low":     9.8,   # 5 年低點（2022 下行周期）
    "pe_5y_pct":      89,   # 目前在 5 年區間的百分位（%，5/8 整理後微降至 89 百分位）
    "pe_10y_avg":   16.2,   # 10 年均 P/E（估算）
    "pe_10y_pct":     93,   # 目前在 10 年區間的百分位（%）
    "pb_current":  11.80,   # 同 STOCK["pb_ratio"]（5/8 NT$2,290）
    "pb_5y_avg":     5.8,
    "pb_5y_pct":      94,   # P/B 微降
    "ev_ebitda":    20.1,   # EV/EBITDA（估算）
    "peg":          1.02,   # PEG = P/E ÷ 5 年 EPS CAGR ~33%
    "note": "P/E 歷史百分位為估算（Bloomberg/Refinitiv 基準），請每季更新基準值；5/8 整理後估值微降至 5 年 89% 高位、需財報持續驗證",
}
...
RELATIVE = {
    "date":           "2026-05-08",
    "tsmc_tw_1d":     -0.87,   # 2330 5/8 收盤 NT$2,290（-20 vs 5/7 NT$2,310）
    "taiex_1d":       -0.27,   # 加權指數 5/8 收 41,820.50（-113.28）
    "sox_1d":         -0.23,   # SOX 5/8 微幅整理
    "tsmc_nyse_1d":   -0.58,   # TSM ADR 5/8 $414.15（-2.43 vs 5/7 $416.58）連 2 日整理
    "tsmc_tw_5d":     +7.26,   # 5 日（NT$2,290 vs 5/1 ~NT$2,135）
    "taiex_5d":       +6.65,
    "tsmc_tw_1m":     +11.71,  # 月線（NT$2,290 vs ~NT$2,050 一個月前）
    "taiex_1m":       +10.3,
    "tsmc_tw_ytd":    +9.31,   # YTD 累計（NT$2,290 vs 年初 ~NT$2,095）
    "taiex_ytd":      +8.2,
    "sox_ytd":        -2.1,    # SOX 5/8 微幅整理
    "beta_60d":        1.25,   # 60 日滾動 Beta vs TAIEX
    # ADR 折溢價（以 5/8 實際 NYSE 收盤計算）
    "adr_price":     414.15,   # TSM NYSE 5/8 實際收盤
    "adr_parity":    368.17,   # 理論值 = 5 × NT$2,290 ÷ 31.10
    "adr_ratio":     "5:1",    # 1 ADR = 5 台積電普通股
    "usd_ntd":        31.10,   # 同 MACRO 台幣匯率（5/8）
    "adr_premium_pct": "+12.5", # (414.15 - 368.17) / 368.17 × 100 = +12.5%（台股微跌後溢價微升）
    "note": "ADR 理論值 = 5 × 台股收盤 ÷ 匯率（不含交易摩擦與流動性溢價）。5/8 台股 -0.87% 整理、ADR -0.58% 連 2 整理，溢價自 +12.2% 微升至 +12.5%；台美再度共振、屬健康消化",
}
...
NEWS = [
    {
        ...
        "title": "⭐ TSMC 5/8 公布 4 月合併月營收 NT$410.73 億：YoY +17.5%、MoM -1.1%，略低於市場估 NT$415B+",
        "body": "TSMC 5/8 盤後公布 4 月合併月營收 NT$410.73 億元：年增（YoY）+17.5%（vs 2025 年 4 月 NT$349.55 億）、月減（MoM）-1.1%（vs 3 月 NT$415.2 億）；1–4 月累計營收 NT$1,544.83 億元、年增 +29.9%。4 月數據略低於市場預估 NT$415B+ 但仍維持高速年增動能，主要受台幣升值（5/8 收 31.10）對美元計價收入折算負面影響、以及季節性回落（智慧型手機與消費電子拉貨力道略弱）。重點觀察：（1）AI 高階先進製程（N3/N5/2nm）續滿載未鬆動；（2）累計 +29.9% YoY 確認 2026 全年 >30% 成長指引仍可達標；（3）法說會 Q2 指引 $39.0-40.2B 仍具達成可能（4 月為 Q2 第一個月）；（4）下次 5 月月營收預計 6/10 前公布、市場預估回升至 NT$420B+ 進入 Q2 旺季。",
        "source": "TSMC IR / 公開資訊觀測站 / Anue 鉅亨 2026-05-08", "impact": "中性",
    },
    {
        "tag": "客戶動態", "tag_color": "#2196F3",
        "title": "📉 台股 2330 5/8 高檔整理收 NT$2,290（-0.87%）量縮屬健康消化；市值 NT$59.4 兆",
        "body": "台股 2330 5/8 Fri 受 5/7 爆量飆漲後高檔換手壓力小幅整理，收 NT$2,290（-20，-0.87% vs 5/7 NT$2,310）；盤中區間 NT$2,275–2,320，量縮至約 48,500 張（vs 5/7 爆量 62,800 張，量縮約 22.8%）屬爆量飆漲後健康消化；市值收 NT$59.4 兆。籌碼面：5/8 估三大法人合計買超 +12,300 張——外資 +8,500 張（高檔承接、未轉賣超）、投信 +3,200 張（連 10 日買進）、自營 +600 張，TSMC 仍為機構承接重點。技術面：5MA 升至 NT$2,290 守關鍵、RSI 自 72.5 降至 65 退出超買區、KDJ J 值自 108 降至 95 過熱訊號降溫，多頭結構維持。今日 5/11 Mon 關鍵：能否守穩 NT$2,290 5MA、4 月營收消化後續挑戰共識目標 NT$2,320（剩 +1.3%）與 5/7 史高 NT$2,345。",
        "source": "TWSE / 玩股網 / 永豐金證券 2026-05-08", "impact": "中性",
    },
    {
        "tag": "客戶動態", "tag_color": "#2196F3",
        "title": "📊 NYSE TSM 5/8 連 2 日小幅整理收 $414.15（-0.58%）；ADR 溢價 +12.5% 維持健康",
        "body": "NYSE TSM 5/8 Fri 連 2 日小幅整理收 $414.15（-2.43，-0.58% vs 5/7 $416.58），仍站穩 $410 強勢區、距 5/7 盤中 52 週新高 $420.00 僅 -1.39%；爆量飆漲後屬健康消化。AI 半導體類股同步整理：NVDA $212.50（+0.62%）續創新高、AMD $227.60（-0.39%）、AVGO $228.90（-0.39%）、ASML $725.40（-0.38%）、SOX 11,180（-0.23%）；NVDA 5/28 Q1 FY27 財報為下波最重要催化。台美 ADR 溢價自 +12.2% 微升至 +12.5%（ADR $414.15 vs 理論值 $368.17），台美再度共振屬健康。下一催化：（1）NVDA Q1 FY27 財報 5/28（距今 17 天）為最重要 AI 算力指標；（2）TSMC 5 月月營收預計 6/10 前公布。",
        "source": "Benzinga / Yahoo Finance / Investing.com 2026-05-08", "impact": "中性",
    },
    {
    ...
    {
        "tag": "客戶動態", "tag_color": "#2196F3",
        "title": "🍎 TSMC 仍為 Apple #1 晶片代工夥伴；Intel 18A 訂單傳聞無實質衝擊",
        "body": "Taipei Times 5/11 報導：產業專家評估 TSMC 將維持 Apple #1 晶片代工夥伴地位，儘管市場曾傳 Apple 有意分散訂單至 Intel 18A——理由：（1）TSMC 先進封裝（CoWoS-L、SoIC）技術為 Apple M5/A20/A21 系列關鍵差異化要素；（2）Intel 18A 與 Samsung Foundry 在良率與功耗效率仍落後 TSMC N3/N2 製程世代；（3）Apple 2026 年內仍佔 TSMC 營收約 17%（次於 NVIDIA 22%）；（4）2027 年 Apple 將直接導入 TSMC A14 製程（angstrom-class 1.4nm，跳過 A16）；（5）TSMC 雖傳對 Apple 漲價（AI 產能優先排程影響），但 Apple 短期無替代選項。",
        "source": "Taipei Times / 業界專家評論 2026-05-11", "impact": "正面",
    },
    {
        "tag": "產業趨勢", "tag_color": "#4CAF50",
        "title": "📈 全球半導體 2026 預期破 $975B、AI 推動 SOX 年初至今 +65%；TSMC 維持 72% 代工龍頭",
        "body": "Semiconductor Industry Association 5 月最新預估：全球半導體 2026 年銷售額將達 $975B（+26% YoY），AI 晶片為最強動能；其中 TSMC Q1 2026 營收 +40% YoY 主由 AI 拉動（手機 / 車用相對疲弱）；TSMC 佔晶圓代工市場 72%（Counterpoint Research 數據）、N3+N2 雙引擎結構穩固。SOX 半導體指數年初至今 +65%（vs S&P 500 +15%）大幅領先大盤；CC Wei（C.C. 魏哲家）法說會表態：AI 需求「極為強勁」（extremely robust），2026 CapEx 確認 $52-56B 上緣靠齊；2nm 至 2028 年產能 CAGR +70%、5 座 2nm 廠 2026 年量產啟動。Agentic AI（智能代理）為下波結構性需求催化、token 生成量大幅倍增需求。",
        "source": "Semiconductor Industry Association / Counterpoint Research / Motley Fool 2026-05-08", "impact": "正面",
    },
]
