...
SUMMARY = {
    ...
    "sentiment":  "中性偏多",
    # 一句話標題
    "headline":   "⭐ 台美短線背離、今日補漲條件齊備：2330 8/4 續拉回 -2.11% 收 NT$2,320 跌破季線 2,350、外資連 2 賣 -12,430 張；美股 8/4 半導體史詩級大漲——SOX +6.55%、ARM +17.4%、INTC +10.8%、TSM +2.72% 收 $417.17 連 4 高、S&P 500 創收盤新高；AMD Q2 全面超標（營收 $11.53B +50%、資料中心 +107%）惟盤後重挫約 -7%；今晨韓股暴漲（SK +7.7%）、ADR 溢價暴衝 +16.4% 為近期最大——今日觀察能否跳空收復 2,350／2,371",
    ...
    "bullets": [
        ...
        "📊 AMD Q2 財報全面超標惟盤後重挫：營收 $11.53B（+50% YoY、超共識 ~$11.3B）創新高、EPS $1.66 超 $1.62、資料中心 $6.7B（+107% YoY）、Q3 指引 $13B 遠超共識 $12.52B——盤後仍跌約 -7~-9%（媒體報導、高「耳語數字」預期回吐）；AI 需求本身獲數字驗證、對 TSMC 先進製程／CoWoS 為實質正面",
...
ECOSYSTEM_STOCKS = [
    ...
    ("客戶", "AMD",     "超微",        "518.58", "+7.00%", "📊 #4 客戶；8/4 財報前大漲 +7.00% 收 $518.58；⭐ 盤後 Q2 財報全面超標：營收 $11.53B（+50%）、資料中心 $6.7B（+107%）、Q3 指引 $13B 遠超共識——惟盤後重挫約 -7~-9%（高「耳語數字」回吐、媒體報導）；MI350 放量對 TSMC 為實質正面"),
