...
STOCK = {
    ...
    # 資料日期備註
    "data_note":      "台股數據：2026-03-11 收盤（估）  |  NYSE 數據：2026-03-11 收盤  |  2 月月營收 3/10 公告（YoY +22.2%）",
}
...
NEWS = [
    ...
    },
    {
        ...
        "title": "美伊戰爭風險升溫，NYSE TSM 今日下跌 2.22% 至 $349.49",
        "body": "美伊衝突風險令中東數據中心供應鏈前景蒙陰，加上市場擔憂全球 AI 晶片出口管制收緊，NYSE TSM 今日盤中下跌 $7.95（-2.22%）至 $349.49，較 2/25 高點 $390.21 回落逾 10%。相比之下，台灣本地 2330 受惠 2 月月營收年增 22.2% 利多，逆勢上漲 1.86%。川普總統表示伊戰「接近尾聲」，短期波動或趨緩，惟需持續追蹤中東局勢發展。",
        "source": "StockTwits / Yahoo Finance 2026-03-11", "impact": "負面",
    },
]
