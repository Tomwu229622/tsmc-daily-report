...
STOCK = {
    # 台股 2330
    "tw_price":       "2,065",        # 收盤價（數字加逗號，不含 NT$）（2026-04-22 早盤 09:14，vs 4/21 收 NT$2,050）
    "tw_change":      "+15",          # 漲跌點數（含+/-號，vs 4/21 收盤 NT$2,050）
    "tw_change_pct":  "+0.73%",       # 漲跌幅（含+/-號）
    "tw_volume":      "~12,000",      # 成交量（張，估算全日，早盤 09:14 約 4,009 張）
    "tw_open":        "2,045",
    "tw_high":        "2,065",
    "tw_low":         "2,040",
    "market_cap":     "NT$53.6 兆",
    "pe_ratio":       "~30.5x",       # 台股 P/E（TTM，NT$2,065 基礎，EPS FY25 實績 NT$67.8）
    ...
    # NYSE TSM ADR
    "nyse_price":     "374.00",       # 估算 4/21 收盤（+1.0% 估，vs 4/17 $370.50；美市 Good Friday 4/18 休市後首日）
    "nyse_change":    "+3.50",        # 4/21 估算
    "nyse_change_pct":"+0.94%",       # 4/21 估算
    "52w_high_nyse":  "392.00",       # 52 週高（2026-04-16 after-hours）
    "52w_low_nyse":   "134.25",       # 52 週低（2025-04-07）
    "pe_nyse":        "~30.9x",       # NYSE USD 基礎 P/E（TTM，估算）
    "pb_nyse":        "~10.9x",
    "beta":           "1.16",
    ...
    # 資料日期備註
    "data_note":      "⭐ 今日重大事件：TSMC 2026 北美技術論壇（4/22）宣布 A14 製程（2028 量產，vs N2 速度+15%/功耗-30%/密度+20%）與 A16（H2 2026 量產，Nanosheet+背面供電）  |  台股 2330 早盤 NT$2,065（+0.73%，vs 4/21 收 NT$2,050），技術論壇催化正面情緒  |  NYSE TSM 估算 4/21 收盤 $374（+0.94%；實際數據待確認）  |  Q1 2026 淨利 $18.2B（+58.3% YoY）、毛利率 66.2%（+740bps）雙創歷史新高  |  NVIDIA 確認 #1 客戶（22%），A16 首批量產客戶  |  三大法人 4/21 淨買超 2,829 張（外資+2,210、投信+696）",
}
...
SUMMARY = {
    ...
    "sentiment":  "強烈看多",
    # 一句話標題
    "headline":   "⭐ TSMC 2026 北美技術論壇今日舉辦！A14 製程宣布（2028 量產，速度+15%/功耗-30%）、A16 H2 2026 量產確認；台股 2330 早盤 NT$2,065（+0.73%）",
    # 3–5 條白話重點（不用術語，每條約 30 字內）
    "bullets": [
        "📡 今日（4/22）TSMC 北美技術論壇：A14 製程宣布——vs N2 速度提升 15%/功耗降 30%/密度增 20%，預計 2028 量產",
        "⚡ A16 製程（Nanosheet 電晶體 + 背面供電 BSPDN）確認 H2 2026 量產；N2P 同步 H2 2026，NVIDIA 為 A16 首批客戶",
        "📈 台股 2330 早盤 NT$2,065（+0.73%，vs 4/21 收 NT$2,050），技術論壇催化多頭情緒，三大法人 4/21 淨買超 2,829 張",
        "⭐ Q1 2026 淨利 $18.2B（+58.3% YoY）、毛利率 66.2% 歷史新高，Q2 指引 $39.0-40.2B 遠超共識，全年 >30% 確認",
        "🤖 AI 晶片 Q1 收入 ~$111B（+84.9% YoY），佔 HPC 部門 50%+；Goldman Sachs 上調目標至 NT$2,330（Conviction Buy）",
    ],
    # 一句結論
    "bottom_line": "今日（4/22）TSMC 2026 北美技術論壇舉辦，宣布 A14 製程（2028 量產，vs N2 速度+15%/功耗-30%/密度+20%）與 A16（H2 2026 量產，Nanosheet+背面供電 BSPDN），確立技術領先地位至 2028 年以上。台股 2330 早盤 NT$2,065（+0.73%），技術論壇為中線關鍵催化劑。TSMC Q1 2026 財報創歷史新高：淨利 $18.2B（+58.3% YoY）、毛利率 66.2%（+740bps）。Q2 指引 $39.0-40.2B 遠超共識，全年 >30% 成長確認。AI 晶片 Q1 收入 $111B（+84.9% YoY），佔 HPC 部門 50%+。三大法人 4/21 淨買超 2,829 張（外資主導+2,210張），外資持股比例 74.9%。NYSE TSM 估算 4/21 收 $374（+0.94%；實際待確認）。Goldman Sachs 目標 NT$2,330（Conviction Buy）；31 位分析師全數看多，共識目標 NT$2,290（上行空間 +10.9%）。",
    # 重大警示（選填，空白則不顯示）
    "risk_alert":  "⚠️ 台股 2330 為早盤（09:14）數據，非終值；NYSE TSM 4/21 收盤為估算（待官方數據確認）；台幣升值壓力持續（每升值 1%，毛利率 -40bps）；A14 量產時程 2028 較市場預期偏晚；CoWoS ABF 基板供應瓶頸；亞利桑那廠爬坡成本拖累 Q2-Q3 毛利率",
}

# 三大法人買賣超（張）— 最新一日
INSTITUTIONAL = {
    "date":     "2026-04-21",
    "foreign":  +2210,    # 外資（正=買超）— 4/21 實際數據
    "trust":    +696,     # 投信（4/21 實際數據）
    "dealer":   -77,      # 自營商（4/21 實際：自買 -1 + 避險 -76）
    # 近5日（由舊到新，最後一筆為 4/21）
    "foreign_5d": [+4800, +6200, -3200, +1200, +2210],  # 4/21 實際數據：外資買超 2,210 張
    "trust_5d":   [+720,  +850,  +250,  +300,  +696],   # 4/21 實際：投信買超 696 張
    "dealer_5d":  [+450,  +380,  -180,  +80,   -77],    # 4/21 實際：自營商賣超 77 張
    "foreign_ownership_pct": "74.9%",  # 外資持股比例（4/21 實際）
    "foreign_ownership_shares": "約 194.3 億股",
}

# 技術分析指標（需每日從看盤軟體更新）
TECHNICAL = {
    "rsi_14":       61.2,   "rsi_signal": "RSI 回升至 61.2，站穩 60 多頭區，4/22 技術論壇催化劑進一步推升短線動能，短線偏強",
    "macd":         +2.5,   "macd_signal": "MACD 正值持續擴張（+1.8→+2.5），多頭趨勢強化，技術論壇為額外催化劑",   "macd_color": "#4CAF50",
    "kdj_k":        65.8,   "kdj_d": 61.5, "kdj_j": 74.4, "kdj_signal": "KDJ J 值持續上行至 74.4，K>D 金叉維持，短線偏多；接近超買區（80），注意短線獲利回吐",
    "ma5":       "2,050",
    "ma20":      "1,985",
    "ma60":      "1,912",
    "ma120":     "1,815",
    "bb_upper":  "2,120",   # 布林上軌（4/22 早盤接近壓力區）
    "bb_mid":    "1,985",   # 布林中軌（20MA）
    "bb_lower":  "1,850",   # 布林下軌
    "vol_ma5":  "20,000",   # 5日均量（張，估算，4/22 早盤量能待確認）
    "trend":    "台股 2330（4/22 早盤 NT$2,065，+0.73%），TSMC 北美技術論壇今日舉辦（A14 宣布 2028 量產、A16 H2 2026 確認），為中線關鍵催化劑。NYSE TSM 估算 4/21 收 $374（+0.94%；實際待確認）。技術面：RSI 61.2 站穩多頭區、MACD 持續擴張、KDJ 金叉維持——短線動能偏強，守穩 NT$2,040–2,050 支撐，中線目標 NT$2,200–2,330 維持。",
    "support":  "2,040–2,050",
    "resist":   "2,080–2,110",
...
DERIVATIVES = {
    "date":          "2026-04-22",
    "futures_price": "2,068",      # 台積電期貨近月（估，4/22 早盤，技術論壇催化）
    "futures_oi":    "89,500",     # 未平倉量（口）（估，4/22，多方部位持續增加）
    "futures_basis": "+3",         # 正價差（多頭情緒持續）
    "call_oi":       "49,000",
    "put_oi":        "40,500",
    "pcr":           "0.83",       # Put/Call 比率降至 0.83（技術論壇後市場情緒更偏多，Call 需求增加）
    "pcr_signal":    "偏多（Put/Call 0.83，技術論壇催化後 Call 需求明顯增加，市場對中線看漲）",
    "max_pain":      "2,050",      # 最大痛苦價格（近期到期，估）
    "key_strikes": [
        ("2,000", "Call 24,000 / Put 8,500", "心理整數關口，強支撐區"),
        ("2,050", "Call 22,000 / Put 5,800", "4/22 早盤支撐確認，5MA 附近"),
        ("2,080", "Call 19,500 / Put 3,200", "短線壓力（52 週高 NT$2,110 前一關）"),
        ("2,150", "Call 13,500 / Put 1,800", "中線目標區"),
        ("2,200", "Call 8,000 / Put 950",    "中線樂觀目標（共識 NT$2,290 之前關）"),
    ],
...
# 供應鏈與客戶股價（需每日更新）
ECOSYSTEM_STOCKS = [
    # 類別、股票代碼、名稱、收盤價、漲跌幅、備註（2026-04-21 盤中估算）
    ("設備", "ASML",    "艾司摩爾",    "675.40", "+0.7%", "EUV 設備龍頭（Q1 超預期，上調 2026 指引 €36-40B，4/21 反彈）"),
    ("設備", "AMAT",    "應用材料",    "172.50", "+1.0%", "CVD/PVD 設備（TSMC 2nm 擴產受惠，4/21 跟漲）"),
    ("設備", "LRCX",    "科林研發",    "788.50", "+0.8%", "蝕刻設備（2nm 良率爬坡帶動訂單，4/21 回升）"),
    ("設備", "KLAC",    "科磊",        "578.90", "+0.6%", "量測設備（2nm/A16 驗證需求強勁，4/21 估）"),
    ("記憶", "000660.KS","SK 海力士",  "295,000 KRW", "+0.5%", "HBM4 供應（NVIDIA GB300 主力，4/21 盤中）"),
    ("記憶", "MU",      "美光",        "96.80",  "+1.0%", "HBM / DDR5（AI 資料中心需求持續，4/21 估）"),
    ("封裝", "3711.TW", "日月光",      "226",    "+1.8%", "CoWoS 封裝（4/21 跟隨 TSMC 強彈）"),
    ("客戶", "NVDA",    "輝達",        "851.00", "+1.0%", "#1 客戶 22%（超越 Apple，CoWoS 鎖定至 2028，A16 首批客戶）"),
    ("客戶", "AAPL",    "蘋果",        "209.80", "+1.1%", "#2 客戶 17%（A20 採 2nm，iPhone 18，4/21 盤中估）"),
    ("客戶", "AVGO",    "博通",        "196.50", "+1.2%", "#3 客戶 13%（Custom XPU，AI ASIC，4/21 估）"),
    ("客戶", "AMD",     "超微",        "162.80", "+1.4%", "#4 客戶 8%（MI400 H2/2026，2nm EPYC Venice）"),
    ("客戶", "2454.TW", "聯發科",      "1,355",  "+1.9%", "手機 SoC 客戶 9%，2nm 首批量產，4/21 強彈"),
    ("競爭", "INTC",    "英特爾",      "21.25",  "+1.0%", "Intel Foundry 18A 爬坡，仍落後 TSMC 2nm，4/21 估"),
    ("競爭", "005930.KS","三星電子",   "53,200 KRW", "+0.8%", "Samsung Foundry 良率改善，但差距仍大，4/21 盤中"),
]
...
CONSENSUS = {
    ...
    "low_target":   "NT$1,740",
    "avg_target_us":"US$515",    # 部分分析師（GuruFocus）已上調至 $515
    "analyst_count": 31,
    "buy": 31, "hold": 0, "sell": 0,
    "upside":       "+12.8%",   # 從 NT$2,030（4/17 實際）到 NT$2,290
}
...
IR_CALENDAR = [
    ...
    ("2026-04-21", "✅ 三大法人淨買超 2,829 張","台股 2330 收 NT$2,050（vs 盤中 NT$2,055）；外資實際買超 +2,210 張、投信 +696 張、自營 -77 張，合計淨買超 2,829 張；外資持股比例 74.9%；NYSE TSM 估算 4/21 收 $374（+0.94%；美市 Good Friday 4/18 休市後首個交易日，實際數據待確認）","#9E9E9E"),
    ("2026-04-22", "📅 今日：北美技術論壇","TSMC 2026 North America Technology Symposium 今日舉辦：A14 製程宣布（vs N2 速度+15%/功耗-30%/密度+20%，2028 量產）；A16（Nanosheet+BSPDN 背面供電）確認 H2 2026 量產；N2P H2 2026，N2X 2027；台股 2330 早盤 NT$2,065（+0.73%）","#BBDEFB"),
...
# 總體經濟監控
MACRO = [
    ("SOX 半導體指數",  "歷史高位區","~+0.9%", False),  # 4/22 TSMC 技術論壇催化半導體族群
    ("美元指數 DXY",    "98.8",    "-0.6%",  False),  # 美元持續走弱，利好 TSMC ADR 估值
    ("VIX 恐慌指數",    "21.5",    "-1.3",   False),  # 恐慌指數下降，市場情緒改善（技術論壇正面催化）
    ("WTI 原油",        "$62.5",   "-0.5%",  False),  # 油價微降（TSMC 化學品成本壓力略減）
    ("10Y 美債殖利率",  "4.00%",   "-0.02pp",False),  # 小降，風險情緒持續好轉
    ("台幣/美元",       "31.35",   "-0.03",  False),  # 台幣走強（每升值 1% 毛利率 -40bps，需追蹤）
    ("NVIDIA NVDA",     "$851.00", "+1.0%",  False),  # #1 TSMC 客戶（22%），A16 首批量產客戶
    ("ASML",            "$675.40", "+0.7%",  False),  # 設備股，Q1 超預期後上調 2026 全年指引 €36-40B
]
...
VALUATION = {
    "pe_current":   30.3,   # 同 STOCK["pe_ratio"]（4/21 盤中 NT$2,055）
    ...
    "pb_current":   9.60,   # 同 STOCK["pb_ratio"]（4/16 NT$2,100）
    "pb_5y_avg":     5.8,
    "pb_5y_pct":      79,
    "ev_ebitda":    18.2,   # EV/EBITDA（估算）
    "peg":          0.90,   # PEG = P/E ÷ 5 年 EPS CAGR ~33%
...
RELATIVE = {
    "date":           "2026-04-22",
    "tsmc_tw_1d":     +0.73,   # 2330 4/22 早盤 NT$2,065（+0.73%，vs 4/21 收 NT$2,050）
    "taiex_1d":       +0.50,   # 加權指數（4/22 早盤估算）
    "sox_1d":         +0.94,   # SOX（4/21 收盤估算，TSMC 技術論壇後半導體族群跟進）
    "tsmc_nyse_1d":   +0.94,   # TSM ADR 估算 4/21 收盤 $374（+0.94%；實際數據待確認）
    "tsmc_tw_5d":     +1.97,   # 本週至今（4/22 早盤，vs 4/17 收 NT$2,030 整週基準）
    "taiex_5d":       +1.20,
    "tsmc_tw_1m":     +6.4,    # 月線（NT$2,065 vs ~NT$1,940 一個月前）
    "taiex_1m":       +3.7,
    "tsmc_tw_ytd":    -1.4,    # Q1+4/1–4/22 累計（NT$2,065 vs 年初 ~NT$2,095）
    "taiex_ytd":      -3.5,
    "sox_ytd":        -20.0,
    "beta_60d":        1.16,   # 60 日滾動 Beta vs TAIEX（估算）
    # ADR 折溢價
    "adr_price":     374.00,   # TSM NYSE 估算 4/21 收盤（實際待確認）
    "adr_parity":    329.52,   # 理論值 = 5 × NT$2,065 ÷ 31.35（4/22 早盤）
    "adr_ratio":     "5:1",    # 1 ADR = 5 台積電普通股
    "usd_ntd":        31.35,   # 同 MACRO 台幣匯率（估算）
    "adr_premium_pct": "+13.5",# (374.00 - 329.52) / 329.52 × 100（估算）
...
EPS_REVISION = {
    ...
    "analyst_view": "Q1 2026 財報確認：淨利 NT$572.5B（$18.1B，+58% YoY）、毛利率 66.2%（+740bps YoY）雙創歷史新高，連續第 10 季超越市場預期（平均超預期幅度 +6.2%）。Q2 指引收入 $39.0-40.2B（遠超共識 $37.5-39.0B），全年 2026 收入 >30% 確認，CapEx 向 $52-56B 高端靠齊。財報後 4/17 台股 2330 實際收 NT$2,030（-2.64%，深度獲利了結），NYSE TSM 實際 $370.50（+1.97%，美股財報後反彈）——台美分歧充分消化，整體格局中性偏多。NVIDIA #1 客戶 22% 確認，Amazon/Meta/Anthropic 自研 AI 芯片趨勢長期利好 TSMC。31 位分析師全數看多，共識目標 NT$2,290（自 NT$2,030 有 +12.8% 上行空間），部分分析師已上調至 US$515。",
...
NEWS = [
    {
        ...
        "title": "TSMC 2026 北美技術論壇：A14 製程宣布，2028 量產，速度+15%/功耗-30%",
        "body": "TSMC 2026 北美技術論壇（4/22 今日，北美）宣布 A14 製程節點：相較 N2 節點，速度提升最高 15%（同功耗）或功耗降低最高 30%（同速度），邏輯密度提升逾 20%，預計 2028 年大量量產。A14 採用下一代 Nanosheet 電晶體架構，為 TSMC 技術領先藍圖延伸至 2028 年以後的關鍵節點。Apple 確認跳過 A16 直接鎖定 A14，表明頂級客戶對 TSMC 技術路線的高度信任。A14 量產時程（2028）較部分市場預期保守，但顯示 TSMC 對品質與良率的嚴格把控。",
        "source": "TSMC PR / SemiWiki 2026-04-22", "impact": "正面",
    },
    {
        "tag": "產品發布", "tag_color": "#9C27B0",
        "title": "A16 製程 H2 2026 量產確認，背面供電 BSPDN 技術突破；N2P/N2X 同步推進",
        "body": "TSMC 技術論壇確認 A16（1.6nm）製程將於 2026 年下半年（H2 2026）開始大量量產，採用 Nanosheet 電晶體 + Super Power Rail（背面供電 BSPDN）技術，相較 N2 速度提升 8-10% 或功耗降低 15-20%，為業界首個量產級背面電源供應製程。NVIDIA 確認為 A16 首批量產客戶。同步公布：N2P 強化版預計 H2 2026 量產（較 N2 速度+10%），N2X 超高性能版本預計 2027 年推出（額外提供 ~10% Fmax），涵蓋從手機到 AI HPC 的完整需求。",
        "source": "TSMC PR / SemiWiki / Tweaktown 2026-04-22", "impact": "正面",
    },
    {
        "tag": "財報結果", "tag_color": "#4CAF50",
        "title": "TSMC Q1 2026 淨利 $18.2B（+58.3%）、毛利率 66.2% 雙創歷史新高",
        "body": "TSMC Q1 2026 財報（4/16 法說會）：淨利 NT$572.48B（$18.2B，+58.3% YoY）、毛利率 66.2%（+740bps YoY）雙創歷史新高，連續第 10 季超越市場預期。Q1 收入 $35.9B（+40.6% YoY，USD）。Q2 指引 $39.0-40.2B（遠超共識 $37.5-39.0B），毛利率 65-67%。AI 晶片 Q1 收入約 $111B（+84.9% YoY），佔 HPC 部門 50%+，HPC 佔總收入 61%。全年 2026 >30% 成長確認，CapEx 向 $52-56B 高端靠齊。Goldman Sachs 上調台股目標至 NT$2,330（Conviction Buy，目標上調 35%）。",
        "source": "TSMC IR / CNBC / Bloomberg 2026-04-16", "impact": "正面",
    },
    {
        "tag": "客戶動態", "tag_color": "#2196F3",
        "title": "NVIDIA 超越 Apple 成 TSMC 最大客戶（22%）；AMD 確認 2nm 首批客戶",
        "body": "NVIDIA 已超越 Apple 成為 TSMC 最大客戶，2026 年預計貢獻約 $330 億收入（佔 TSMC 總收入約 22%）。NVIDIA 鎖定 TSMC 大部分 CoWoS 先進封裝產能至 2028 年，GB200/GB300 NVL72 均使用 CoWoS-S。NVIDIA 確認為 A16 首批量產客戶；Apple（#2 客戶，18%）跳過 A16，直接鎖定 A14 節點（A20 晶片 iPhone 18，2028）。AMD 確認為 TSMC 2nm 首批量產客戶（與 Apple、NVIDIA、MediaTek 同列），Instinct MI450 獲重大新訂單。",
        "source": "CNBC / Tweaktown 2026-04-16/22", "impact": "正面",
    },
    {
        "tag": "產業趨勢", "tag_color": "#4CAF50",
        "title": "AI 業務即將達 TSMC 三分之一，全球半導體 2026 銷售額 $1 兆創歷史紀錄",
        "body": "TSMC 預估 AI 晶片業務很快將佔其總營收三分之一以上（Q1 2026 已佔 HPC 部門 50%+）。全球半導體銷售 2026 年 2 月達 $888 億（+61.8% YoY），全年有望首度突破 $1 兆。ASML Q1 超預期並上調 2026 全年指引至 €36-40B（原 €34-39B），EUV 需求持續強勁，確認 AI 資本支出週期延續。OpenAI 與 Cerebras 簽署 $200 億多年協議，Agentic AI 轉型驅動算力需求持續爆炸，利好 TSMC 先進製程稼動率。",
        "source": "Next Platform / Modern Diplomacy 2026-04-20/15", "impact": "正面",
    },
    {
        "tag": "警示", "tag_color": "#F44336",
        "title": "台幣升值壓毛利率；A14 量產 2028 略晚預期；ABF 基板仍是 CoWoS 瓶頸",
        "body": "台幣持續走強（31.35 附近），每升值 1% 毛利率下降 40bps，為 Q2-Q3 毛利率主要下行風險。A14 製程量產時程定於 2028 年，較部分市場預期（2027）保守，短期不會帶來新收入。TSMC CoWoS 先進封裝產能仍全數滿載（>95%），ABF 基板供應受限導致擴產速度落後預期，美國 AI 芯片製造仍需回台進行先進封裝。亞利桑那廠爬坡攤提成本、台灣電費調漲對 Q2-Q3 毛利率造成結構性壓力。美國 301 關稅調查後續動向持續追蹤中。",
        "source": "CNBC / TrendForce / Wall Street 2026-04-22", "impact": "負面",
    },
]
