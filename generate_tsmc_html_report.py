...
STOCK = {
    # 台股 2330
    "tw_price":       "1,855",        # 收盤價（數字加逗號，不含 NT$）（2026-04-02 收盤）
    "tw_change":      "+35",          # 漲跌點數（含+/-號）
    "tw_change_pct":  "+1.92%",       # 漲跌幅（含+/-號）
    "tw_volume":      "25,000",       # 成交量（張，估）
    "tw_open":        "1,830",
    "tw_high":        "1,860",
    "tw_low":         "1,825",
    "market_cap":     "NT$48.2 兆",
    "pe_ratio":       "~27.8x",       # 台股 P/E（TTM，2026-04-02）
    "pb_ratio":       "~10.1x",       # 台股 P/B（股淨比）
    "div_yield":      "~1.06%",       # 殖利率（USD $2.65/ADR 年息）
    "52w_high_tw":    "2,025",        # 52 週高（2026-02-25）
    "52w_low_tw":     "780",          # 52 週低（2025-04-07）
    # NYSE TSM ADR
    "nyse_price":     "339.80",       # 收盤價（2026-04-02）
    "nyse_change":    "+1.85",        # 與前日相比
    "nyse_change_pct":"+0.55%",
    "52w_high_nyse":  "390.21",       # 52 週高（2026-02-25）
    "52w_low_nyse":   "134.25",       # 52 週低（2025-04-07）
    "pe_nyse":        "~31.5x",       # NYSE USD 基礎 P/E（TTM）
    "pb_nyse":        "~10.1x",
    "beta":           "1.16",
    ...
    # 資料日期備註
    "data_note":      "台股數據：2026-04-02（NT$1,855，+1.92%）  |  NYSE 數據：2026-04-02 $339.80（+0.55%）  |  台股技術面超賣後現反彈，4/2 上漲 35 元，量能估 2.5 萬張  |  NVIDIA 超越 Apple 成 TSMC 最大客戶（22%）  |  4/16 Q1 財報倒計時 14 天",
}
...
SUMMARY = {
    ...
    "sentiment":  "中性偏多",
    # 一句話標題
    "headline":   "台股 2330 收 NT$1,855（+1.92%）技術面超賣後反彈，NYSE TSM $339.80，日本熊本二廠升級 3nm，4/16 Q1 財報倒計時 14 天",
    # 3–5 條白話重點（不用術語，每條約 30 字內）
    "bullets": [
        "台股 2330 收 NT$1,855（+35，+1.92%），成交量估 2.5 萬張，技術面超賣後出現反彈",
        "NYSE TSM $339.80（+$1.85，+0.55%），美股同步回升，Q1 財報（4/16）倒計時 14 天",
        "TSMC 日本熊本二廠升級至 3nm 獲批，預計 2028 年量產，月產能 1.5 萬片，投資逾 170 億美元",
        "NVIDIA 正式超越 Apple 成 TSMC 最大客戶（22%，年收入估 $330 億），A16 製程首發合作確認",
        "全球 AI 晶片市場 2035 年將超 $1.35 兆美元，CAGR 29.4%；TSMC 受益最深，2nm 量產加速",
    ],
    # 一句結論
    "bottom_line": "台積電（4/2）台股 2330 收 NT$1,855（+1.92%，+35），技術面超賣後出現強勁反彈，量能估 2.5 萬張。NYSE TSM $339.80（+0.55%）同步回升。基本面強勁催化劑持續浮現：日本熊本二廠升級 3nm 獲批、NVIDIA 超越 Apple 成最大客戶（22%）、TSMC 2nm 量產帶動 NVIDIA/AMD/Apple 訂單全數落定至 2028。4/16 Q1 財報（EPS 共識 NT$20.38）為最近關鍵催化劑，近 8 季全部超預期。分析師 31 人全數買入，目標 NT$2,290（+23.5%），技術反彈結合基本面支撐，中線偏多。",
    # 重大警示（選填，空白則不顯示）
    "risk_alert":  "⚠️ 台股 2330（4/2）收 NT$1,855（+1.92%）；NYSE TSM $339.80（+0.55%）；Q1 財報 4/16 倒計時 14 天；AGM 提案期間 4/1–4/7；中國 AI 晶片自給自足推進，地緣政治風險持續；美元出口管制政策動向需密切追蹤",
}

# 三大法人買賣超（張）— 最新一日
INSTITUTIONAL = {
    "date":     "2026-04-02",
    "foreign":  +1500,    # 外資（正=買超）— 4/2 反彈日回補（估）
    "trust":    +350,     # 投信（持續逢低承接，估）
    "dealer":   +200,     # 自營商（估，反彈日轉買）
    # 近5日（由舊到新，最後一筆為今日估算）
    "foreign_5d": [-2000, -1800, -20438, -3200, +1500],  # 4/2 反彈日轉正（估）
    "trust_5d":   [+260,  +270,  +1415,  +300,  +350],
    "dealer_5d":  [-150,  -160,  +2732,  -150,  +200],
    "foreign_ownership_pct": "74.4%",  # 外資持股比例（估，回補中）
    "foreign_ownership_shares": "約 193.1 億股",
}

# 技術分析指標（需每日從看盤軟體更新）
TECHNICAL = {
    "rsi_14":       38.5,   "rsi_signal": "RSI 從超賣區間（32.5）回升至 38.5，技術反彈確認，但尚未進入中性區間",
    "macd":         -8.5,   "macd_signal": "MACD 死叉收窄，空頭動能減弱，若量能持續放大可期待金叉轉訊",   "macd_color": "#FF9800",
    "kdj_k":        32.5,   "kdj_d": 28.5, "kdj_j": 40.5, "kdj_signal": "KDJ 金叉形成，J 值從深超賣回升至 40.5，短線偏多",
    "ma5":       "1,810",
    "ma20":      "1,850",
    "ma60":      "1,828",
    "ma120":     "1,742",
    "bb_upper":  "1,975",   # 布林上軌
    "bb_mid":    "1,850",   # 布林中軌（20MA）
    "bb_lower":  "1,725",   # 布林下軌
    "vol_ma5":  "28,000",   # 5日均量（張，估）
    "trend":    "台股 2330（4/2 收 NT$1,855，+1.92%）技術面超賣後反彈，NYSE TSM $339.80（+0.55%）。RSI 從 32.5 回升至 38.5，MACD 死叉收窄，KDJ 出現金叉信號，技術面轉為短線偏多。收盤站回 MA20（1,850）附近為關鍵。4/16 Q1 財報（倒計時 14 天）為主要催化劑。",
    "support":  "1,820–1,830",
    "resist":   "1,870–1,900",
...
DERIVATIVES = {
    "date":          "2026-04-02",
    "futures_price": "1,858",      # 台積電期貨近月（估，略高現貨 1,855，正價差確立）
    "futures_oi":    "78,500",     # 未平倉量（口）（估，空單部分回補）
    "futures_basis": "+3",         # 正價差（多頭氣氛轉強）
    "call_oi":       "30,500",
    "put_oi":        "58,200",
    "pcr":           "1.91",       # Put/Call 比率下降（空頭情緒收斂）
    "pcr_signal":    "中性偏多",
    "max_pain":      "1,820",      # 最大痛苦價格
    "key_strikes": [
        ("1,800", "Call 3,500 / Put 11,500", "重要支撐"),
        ("1,820", "Call 5,200 / Put 8,800",  "最大痛苦點/支撐"),
        ("1,855", "Call 8,500 / Put 6,200",  "現貨所在"),
        ("1,870", "Call 12,000 / Put 4,500", "短線壓力"),
        ("1,900", "Call 15,500 / Put 2,800", "強壓力區"),
    ],
...
CONSENSUS = {
    ...
    "upside":       "+23.5%",   # 從 NT$1,855 到 NT$2,290
}
...
# 總體經濟監控
MACRO = [
    ("SOX 半導體指數",  "3,920",   "+0.9%",  False),  # 4/2 估，技術反彈
    ("美元指數 DXY",    "104.2",   "-0.3%",  False),  # 美元小幅回落，台幣稍緩
    ("VIX 恐慌指數",    "27.2",    "-1.3",   True),   # 恐慌指數略降（仍偏高）
    ("WTI 原油",        "$71.8",   "+0.4%",  False),
    ("10Y 美債殖利率",  "4.24%",   "-0.02pp",False),  # 避險需求，殖利率微降
    ("台幣/美元",       "31.80",   "+0.05",  False),  # 台幣小幅回升
    ("NVIDIA NVDA",     "$855",    "+0.8%",  False),  # AI 大廠技術反彈
    ("ASML",            "$681",    "+0.4%",  False),  # 設備股隨市回升
]
...
VALUATION = {
    "pe_current":   27.8,   # 同 STOCK["pe_ratio"]
...
RELATIVE = {
    "date":           "2026-04-02",
    "tsmc_tw_1d":     +1.92,   # 2330 4/2 收盤 1,855（+1.92%）
    "taiex_1d":       +1.10,   # 加權指數（4/2 估算，跟漲）
    "sox_1d":         +0.90,   # SOX（4/2 估，技術反彈）
    "tsmc_nyse_1d":   +0.55,   # TSM ADR 4/2 $339.80（+0.55%）
    "tsmc_tw_5d":     -3.2,    # 本週累計（估，週初跌後今日反彈）
    "taiex_5d":       -1.5,
    "tsmc_tw_1m":     -9.5,
    "taiex_1m":       -4.8,
    "tsmc_tw_ytd":    -10.3,   # Q1+4/1–4/2 累計
    "taiex_ytd":      -6.5,
    "sox_ytd":        -21.5,
    "beta_60d":        1.16,   # 60 日滾動 Beta vs TAIEX
    # ADR 折溢價
    "adr_price":     339.80,   # TSM NYSE（2026-04-02）
    "adr_parity":    291.82,   # 理論值 = 5 × NT$1,855 ÷ 31.80（台股 4/2 收盤）
    "adr_ratio":     "5:1",    # 1 ADR = 5 台積電普通股
    "usd_ntd":        31.80,   # 同 MACRO 台幣匯率
    "adr_premium_pct": "+16.4",# (339.80 - 291.82) / 291.82 × 100
...
EPS_REVISION = {
    ...
    "analyst_view": "Q1 EPS 共識 NT$20.38，前 2 月累計營收年增 30%（NT$7,189 億）。4/2 台股 2330 收 NT$1,855（+1.92%），NYSE TSM $339.80（+0.55%），技術面超賣後出現反彈。日本熊本二廠升級 3nm 獲批、NVIDIA 確認首採 A16 製程利多推動，基本面催化劑持續強化。31 位分析師無一賣出，共識目標 NT$2,290（+23.5%），分析師共識目標 $430.65 USD（強烈買進）。4/16 Q1 財報（倒計時 14 天）為關鍵催化劑，若毛利率超指引（63–65%）可望確認上行走勢。",
    "note": "資料來源：Bloomberg / MarketScreener（估算），請每日核實更新",
}

NEWS = [
    {
        "tag": "海外擴廠", "tag_color": "#9C27B0",
        "title": "TSMC 日本熊本二廠升級 3nm 獲批，2028 年量產 AI 晶片",
        "body": "台灣政府批准 TSMC 將日本熊本第二晶圓廠（Fab 2）製程升級至 3nm，計劃 2028 年開始設備安裝，目標月產能 15,000 片 12 吋晶圓。總投資額估逾 170 億美元，日本政府提供大規模補貼。此舉不僅強化 TSMC 在東北亞製造布局，也分散地緣政治風險，進一步鞏固全球代工龍頭地位。",
        "source": "Taipei Times / Evertiq 2026-04-01", "impact": "正面",
    },
    {
        "tag": "客戶動態", "tag_color": "#2196F3",
        "title": "NVIDIA 超越 Apple 成 TSMC 最大客戶，首採 A16 製程確認",
        "body": "NVIDIA CEO Jensen Huang 確認，NVIDIA 已超越 Apple 成為台積電最大單一客戶，2026 年預計貢獻約 $330 億 USD（22%）。NVIDIA 亦確認為 TSMC A16（1.6nm 背面供電）製程首發客戶，Apple 跳過 A16 直升 A14。AMD EPYC Venice（Zen 6）也已在 TSMC 2nm 節點進入量產，三大 AI/HPC 客戶製程路徑全數明朗。",
        "source": "CNBC / TweakTown 2026-04-02", "impact": "正面",
    },
    {
        "tag": "產業趨勢", "tag_color": "#4CAF50",
        "title": "AI 晶片市場 2035 年將超 $1.35 兆美元，CAGR 達 29.4%",
        "body": "SNS Insider 最新報告（2026-04-01）顯示，全球 AI 晶片市場 2025 年為 $1,028.9 億，預計 2035 年突破 $1.354 兆，年複合成長率 29.4%。全球半導體 2026 年銷售額預估達 $9,750 億（年增 26%）。台積電作為全球最大先進製程代工廠，為 AI 超級周期最直接受益者，N2/N3 訂單已售罄至 2028 年。",
        "source": "SNS Insider / GlobeNewswire 2026-04-01", "impact": "正面",
    },
    {
        "tag": "產能供給", "tag_color": "#4CAF50",
        "title": "TSMC 2nm 量產啟動，Apple/AMD/NVIDIA/MediaTek 首批客戶",
        "body": "TSMC 確認已於 2025 年 Q4 開始 2nm 節點量產，Apple、AMD、NVIDIA 及聯發科為首批客戶，Intel 目前缺席 2nm 客戶名單。2nm 製程相較 3nm 效能提升約 15%、功耗降低 25%，為 AI 推論與行動晶片帶來重大進展。訂單已完全售罄至 2028 年，定價能力持續強化。",
        "source": "Design-Reuse / Tweaktown 2026-04-02", "impact": "正面",
    },
    {
        "tag": "地緣政治", "tag_color": "#607D8B",
        "title": "美國延長 TSMC 中國廠設備進口年度許可，供應鏈顧慮緩解",
        "body": "美國政府再度延長 TSMC 中國廠區進口美國製晶片設備的年度許可，暫時緩解供應鏈斷鏈風險。與此同時，中國持續推動 AI 晶片自給自足，正擴大國產晶片設備及供應鏈建設。此消息對 TSMC 中國業務短期影響正面，但中長期地緣政治風險仍需密切追蹤。",
        "source": "CNBC / Digitimes 2026-04-02", "impact": "中性",
    },
    {
        "tag": "警示", "tag_color": "#F44336",
        "title": "HBM「記憶體危機」：AI 資料中心消耗 70% 高階記憶體，供應鏈重組",
        "body": "IndexBox 報告指出，AI 資料中心對 HBM 高頻寬記憶體需求已消耗全球高階記憶體產能的 70%，導致非 AI 應用嚴重缺貨。此「RAMageddon」現象正重塑全球晶片採購格局，HBM 供應商（SK 海力士、三星）與封裝廠（CoWoS、ABF 基板）面臨產能瓶頸，短期內供需失衡難以緩解，成本上升壓力值得關注。",
        "source": "IndexBox 2026-04-02", "impact": "負面",
    },
]
