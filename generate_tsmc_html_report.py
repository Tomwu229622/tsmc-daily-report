...
STOCK = {
    # 台股 2330
    "tw_price":       "2,255",        # 2026-06-10 Wed 實際收盤（-50，-2.17% vs 6/9 NT$2,305；5 月營收創高但利多出盡 + 半導體類股賣壓）
    "tw_change":      "-50",          # 6/10 實際漲跌點數
    "tw_change_pct":  "-2.17%",       # 6/10 實際漲跌幅
    "tw_volume":      "42,439",       # 6/10 實際成交量（張，放量下跌 vs 6/9 33,206）
    "tw_open":        "2,295",        # 6/10 估開盤（小幅低開後走弱）
    "tw_high":        "2,300",        # 6/10 盤中高（估）
    "tw_low":         "2,250",        # 6/10 盤中低（估）
    "market_cap":     "NT$58.5 兆",   # 6/10 實際市值（NT$2,255 基礎）
    "pe_ratio":       "~33.2x",       # 台股 P/E（TTM，NT$2,255 基礎）
    "pb_ratio":       "~11.8x",       # 台股 P/B（股淨比，NT$2,255 基礎）
    "div_yield":      "~0.67%",       # 殖利率（NT$2,255 基礎）
    "52w_high_tw":    "2,440",        # 52 週/歷史高（2026-06-03 盤中觸 NT$2,440 史高）
    "52w_low_tw":     "780",          # 52 週低（2025-04-07）
    # NYSE TSM ADR
    "nyse_price":     "408.75",       # 6/10 Wed 實際收盤（-$19.14，-4.47% vs 6/9 $427.89；5 月營收創高但利多出盡重挫）
    "nyse_change":    "-19.14",       # 6/10 漲跌（vs 6/9 $427.89）
    "nyse_change_pct":"-4.47%",       # 6/10 NYSE 重挫
    ...
    # 資料日期備註
    "data_note":      "報告日期：2026-06-11 Thu（今日台股盤中；股價以 6/10 Wed 實際收盤為最新確認資料）。⭐⭐⭐ 今日頭條——TSMC 5 月合併月營收正式公布 NT$4,169.75 億（NT$416.975 億元、US$13.17B）：年增 +30.1%、月增 +1.5%、創史上單月新高（超越 3 月與 4 月前高）；1–5 月累計 NT$1.96 兆、年增 +30%；公司可望挑戰單季營收新高（超越前高 NT$1.23 兆）。【更正】前一份 6/10 報告所載 5 月營收 NT$320.52B（NT$3,205 億）為公布前誤植，正式官方數字為 NT$416.975 億元。⚠️ 然而利多出盡：6/10 Wed 台股 2330 實際收 NT$2,255（-50，-2.17% vs 6/9 NT$2,305）、放量至 42,439 張、市值回落 NT$58.5 兆；NYSE TSM 6/10 重挫 -4.47% 收 $408.75（-$19.14 vs 6/9 $427.89）、盤中區間 $407.70-$426.32——record-revenue-yet-shares-decline 的「sell the news」+ 半導體類股回檔共振。台美 ADR 溢價以 6/10 收盤計：理論值 5×2,255÷31.05 = $363.12、溢價 (408.75-363.12)/363.12 = +12.57%（自 +14.98% 收斂、ADR 跌幅大於台股）。  |  🎯 即將事件：Q2 2026 財報法說會 7/16（指引 $39.0-40.2B、+10% QoQ、+32% YoY、毛利率 65-67%）；下次月營收 7 月上旬公布 6 月數據  |  ⭐ 結構性利多續存（中長線基底未變）：TSMC CFO 6/10 暗示先進製程續漲價（3nm H2 漲 15%、sub-5nm 漲 5-10%）；6/4 AGM CEO Wei 確認 AI 需求超供應、2026 >30% 成長；TSMC 2nm 量產良率達 70-80% 領先全球、年底月產能 100K 片；NVIDIA $150B/年投資台灣；NVIDIA-TSMC AI 製程合作（cuLitho/cuEST/FabTwin）；Intel CEO 確認長期夥伴；SIA 估 2028 AI 資料中心晶片年營收 $1.2 兆；PwC 報告 TSMC 市值年增 +101% 躋身全球第 9 大市值企業  |  ⚠️ 本日（6/11）關鍵觀察：（1）台股 2330 預料跟進 NYSE 6/10 -4.47% 開低、是否守住 NT$2,200 心理整數為關鍵；（2）下方支撐 NT$2,250 / NT$2,200 / NT$2,165（120MA）/ NT$2,155；反彈壓力 NT$2,295 / NT$2,305 / NT$2,320（5MA）/ NT$2,365",
}
...
SUMMARY = {
    ...
    "sentiment":  "中性",
    # 一句話標題
    "headline":   "⚠️ 利多出盡：TSMC 5 月營收創高 NT$4,169.75 億（+30.1% YoY）但 6/10 台股 2330 收 NT$2,255（-2.17%）、NYSE TSM 重挫 -4.47% 收 $408.75",
    ...
    "bullets": [
        ...
        "⚠️ 利多出盡：6/10 台股 2330 收 NT$2,255（-50，-2.17%）放量 42,439 張、市值回落 NT$58.5 兆",
        "📉 NYSE TSM 6/10 重挫 -4.47% 收 $408.75（-$19.14）、盤中 $407.70-$426.32、半導體類股回檔共振",
        "🚀 公司可望挑戰單季營收新高（超越前高 NT$1.23 兆）、Q2 指引 $39.0-40.2B（+32% YoY）",
        "💰 TSMC CFO 6/10 暗示先進製程續漲價（3nm H2 漲 15%、sub-5nm 漲 5-10%）支撐毛利率",
        "⭐ 中長線基底未變：AI 需求超供應 + 2026 >30% 成長 + 2nm 量產 70-80% 良率 + PwC 市值全球第 9",
        "⚠️ 估值警示：TSM P/E ~33.8x 仍在 5 年 88-90% 高位、短線回檔測試 NT$2,200 心理整數",
    ],
    # 一句結論
    "bottom_line": "報告日期：2026-06-11 Thu（今日台股盤中；股價以 6/10 Wed 實際收盤為最新確認資料）。⭐⭐⭐ 今日頭條——TSMC 5 月合併月營收正式公布 NT$4,169.75 億（NT$416.975 億元、US$13.17B）：年增 +30.1%、月增 +1.5%、創史上單月新高（超越 3 月與 4 月前高）；1–5 月累計營收 NT$1.96 兆、年增 +30%；分析師認為公司 well-positioned 達成 Q2 指引、並可望挑戰單季營收新高（超越前高 NT$1.23 兆）。【更正聲明】前一份 6/10 報告所載 5 月營收 NT$320.52B（NT$3,205 億、-8.3% MoM）為月營收公布前誤植之估值，TSMC 官方正式數字為 NT$416.975 億元（+30.1% YoY、+1.5% MoM、創單月新高），本份報告以官方數字為準。⚠️ 然而股價利多出盡：6/10 Wed 台股 2330 實際收 NT$2,255（-50，-2.17% vs 6/9 NT$2,305）、放量至 42,439 張、市值回落 NT$58.5 兆；NYSE TSM 6/10 重挫 -4.47% 收 $408.75（-$19.14 vs 6/9 $427.89）、盤中區間 $407.70-$426.32——record-revenue-yet-shares-decline 的典型 sell-the-news 反應 + 半導體類股回檔共振、且前波 6/3 史高 NT$2,440 後的高位獲利了結賣壓延續。台美 ADR 溢價以 6/10 收盤計：理論值 5×2,255÷31.05 = $363.12、溢價 (408.75-363.12)/363.12 = +12.57%（自 +14.98% 收斂、ADR 跌幅大於台股反映美股情緒較弱）。⭐ 中長線結構性利多基底未變：（1）💰 TSMC CFO 6/10 暗示先進製程續漲價——3nm H2 漲 15%、sub-5nm 漲 5-10%、反映 AI 強勁需求下的定價權；（2）🏛️ 6/4 AGM CEO Wei 確認 AI 需求將持續超越全球半導體供應、2026 >30% 成長指引；（3）⭐ TSMC 2nm 已開始量產、採用 nanosheet GAA 電晶體、初期良率 70-80% 領先全球；2026 年底 2nm 月產能目標 100,000 片；2nm 至 2028 CAGR +70%；（4）NVIDIA 仍為 TSMC 第 1 大客戶（22% / $33B）、Apple 第 2 大（18% / $27B）；（5）NVIDIA-TSMC AI 製程合作（cuLitho/cuEST/FabTwin）；（6）Intel CEO 6/2 確認 TSMC「長期信任夥伴」；（7）SIA 估 2028 AI 資料中心晶片年營收 $1.2 兆（+10x vs 2024）；（8）PwC 報告 TSMC 市值年增 +101% 躋身全球第 9 大市值企業。⚠️ 短期下行風險：（1）利多出盡 sell-the-news、6/3 史高後高位獲利了結延續；（2）Fed 升息預期升溫、10Y 美債殖利率 4.5%+；（3）美對中 AI 晶片出口管制擴大；（4）⚠️ 估值警示 TSM P/E ~33.8x 仍在 5 年 88-90% 高位；（5）半導體類股 6/5 以來波動加劇。基本面未變：Q1 2026 淨利 NT$572.5B（$18.2B、+58.3% YoY）、毛利率 66.2% 雙創史高；2025 全年 EPS NT$66.25。技術面（基於 6/10 實際收盤 NT$2,255）：5MA NT$2,320（轉壓力）/ 20MA NT$2,320 / 60MA NT$2,295 / 120MA NT$2,165；下方支撐 NT$2,250 / NT$2,200 心理整數 / NT$2,165（120MA）。32 位分析師全數看多、平均目標 NT$2,530 上行空間 +12.20%。",
    # 重大警示（選填，空白則不顯示）
    "risk_alert":  "今日（6/11 Thu）關鍵觀察：（1）⚠️⚠️ 台股 2330 預料跟進 NYSE TSM 6/10 -4.47% 重挫開低、是否守住 NT$2,200 心理整數為今日關鍵；（2）⭐⭐⭐ TSMC 5 月營收正式公布 NT$4,169.75 億（NT$416.975 億元）——年增 +30.1%、月增 +1.5%、創史上單月新高、1-5 月累計 NT$1.96 兆 +30%（已更正前報誤植的 NT$320.52B）；基本面強勁但股價利多出盡；（3）📉 6/10 台股 2330 收 NT$2,255（-2.17%）放量 42,439 張、NYSE TSM 重挫 -4.47% 收 $408.75；（4）💰 TSMC CFO 6/10 暗示 3nm H2 漲 15%、sub-5nm 漲 5-10% 續存利多；（5）🏆 PwC 報告 TSMC 市值年增 +101% 躋身全球第 9 大市值企業；（6）⭐ TSMC 2nm 量產初期良率 70-80% 領先全球、年底月產能目標 100K 片；（7）⭐ SIA 估 2028 AI 資料中心晶片年營收 $1.2 兆；（8）⭐ 中長線結構性利多基底未變：AGM CEO Wei 確認 AI 需求超供應 + 2026 >30% 成長 + NVIDIA $150B/年投資 + Intel 確認長期夥伴；（9）⚠️ 估值警示 TSM P/E ~33.8x 仍在 5 年 88-90% 高位；（10）⚠️ Fed 升息預期升溫、10Y 美債殖利率突破 4.5%；（11）⚠️ 美對中 AI 晶片出口管制擴大；（12）台幣 31.05 升值壓力結構性續存；（13）📊 台美 ADR 溢價收斂至 +12.57%；（14）32 位分析師全數看多、平均目標 NT$2,530 上行空間 +12.20%；本日（6/11）關鍵：能否守住 NT$2,200 心理整數、避免回測 NT$2,165（120MA）；反彈壓力 NT$2,295 / NT$2,320（5MA）/ NT$2,365",
}

# 三大法人買賣超（張）— 最新一日
INSTITUTIONAL = {
    "date":     "2026-06-10",       # 最新確認資料日（6/10 Wed）
    "foreign":  -12000,             # 外資 6/10 估轉賣超（利多出盡、放量下跌）
    "trust":    -1500,              # 投信 6/10 估賣超
    "dealer":   -500,               # 自營商 6/10 估小幅賣超
    # 近5日（由舊到新：6/4, 6/5, 6/8, 6/9, 6/10）
    "foreign_5d": [-8500, -2500, -18500, +5500, -12000],   # 6/10 估轉賣超 -12,000
    "trust_5d":   [-1500, -200, -1500, +800, -1500],        # 6/10 估賣超
    "dealer_5d":  [-500, -200, -800, +200, -500],           # 6/10 估小幅賣超
    "foreign_ownership_pct": "75.0%",  # 外資持股比例（6/10 估，較 6/9 75.2% 略降）
    "foreign_ownership_shares": "約 194.4 億股",
}

# 技術分析指標（需每日從看盤軟體更新）
TECHNICAL = {
    "rsi_14":       42.0,   "rsi_signal": "RSI 估自 50.5 回落至 42（6/10 -2.17% 跌破中軸 50），動能轉弱、短線偏空",
    "macd":         -0.2,   "macd_signal": "MACD 估自 +0.5 翻黑至 -0.2、綠柱浮現、死叉確認；利多出盡賣壓下動能轉空",   "macd_color": "#F44336",
    "kdj_k":        35.0,   "kdj_d": 45.0, "kdj_j": 15.0, "kdj_signal": "KDJ K(35)/D(45)/J(15) J 自 31 再殺至 15 接近超賣區、死叉延續；需 NYSE 領先止跌確認",
    "ma5":       "2,320",   # 5MA（6/4 2385, 6/5 2365, 6/8 2305, 6/9 2305, 6/10 2255）— 基於 6/10 收盤
    "ma20":      "2,320",   # 20MA 轉壓力
    "ma60":      "2,295",   # 60MA 上揚但收斂
    "ma120":     "2,165",
    "bb_upper":  "2,455",   # 布林上軌
    "bb_mid":    "2,320",   # 布林中軌（20MA）
    "bb_lower":  "2,185",   # 布林下軌
    "vol_ma5":  "44,000",   # 5日均量（張，估、基於 6/4-6/10 五日均；6/10 放量至 42,439）
    "trend":    "⚠️ 6/10 Wed 利多出盡：台股 2330 實際收 NT$2,255（-50，-2.17% vs 6/9 NT$2,305）、放量至 42,439 張、市值回落 NT$58.5 兆——TSMC 5 月營收創高 NT$4,169.75 億（+30.1% YoY、+1.5% MoM）但市場 sell-the-news、且 6/3 史高 NT$2,440 後高位獲利了結賣壓延續。NYSE TSM 6/10 重挫 -4.47% 收 $408.75（-$19.14 vs 6/9 $427.89）、盤中區間 $407.70-$426.32、半導體類股回檔共振。📊 今日（6/11 Thu）：台股 2330 預料跟進 NYSE 6/10 重挫開低、能否守住 NT$2,200 心理整數為關鍵。技術面（基於 6/10 收盤 NT$2,255）：RSI 42 跌破中軸、MACD -0.2 翻黑死叉確認、KDJ J(15) 接近超賣、短期均線轉壓、中期 60MA/120MA 仍多頭但收斂。下一觀察：（1）⚠️ NT$2,200 心理整數能否守住、跌破則回測 NT$2,165（120MA）；（2）下方支撐 NT$2,250（6/10 低）/ NT$2,200 心理整數 / NT$2,165（120MA）/ NT$2,155；（3）反彈壓力 NT$2,295 / NT$2,305（6/9 收）/ 5MA NT$2,320 / NT$2,365 / NT$2,400 整數；（4）⭐ 中長線結構性利多基底未變：CFO 6/10 暗示 3nm 漲 15% + AGM CEO Wei 確認 AI 需求超供應 + 2026 >30% 成長 + 2nm 量產 70-80% 良率；（5）🏆 PwC 報告 TSMC 市值年增 +101% 躋身全球第 9；（6）⚠️ 美股情緒較弱、需 NYSE TSM 領先止跌確認。",
    "support":  "2,250 / 2,200 / 2,165 / 2,155 (6/10 低、心理整數、120MA、心理整數)",
    "resist":   "2,295 / 2,305 / 2,320 / 2,365 / 2,400 (反彈關卡、6/9 收、5MA、6/5 收、整數)",
    "note": "技術指標數值為估算（基於 6/10 收盤 NT$2,255），請以看盤軟體即時數據為準；6/10 利多出盡放量下跌、MACD 翻黑死叉確認、KDJ J 殺至 15 接近超賣；NT$2,200 心理整數為今日關鍵支撐",
}

# 期貨與選擇權（來源：台灣期交所 TAIFEX）
DERIVATIVES = {
    "date":          "2026-06-10",       # 最新確認資料日（6/10 Wed）
    "futures_price": "2,255",            # 台積電期貨近月（6/10 估收盤附近）
    "futures_oi":    "166,000",          # 未平倉量（口）（6/10 估、放量下跌）
    "futures_basis": "-8",               # 6/10 估逆價差擴大（避險情緒升溫）
    "call_oi":       "92,000",
    "put_oi":        "87,400",
    "pcr":           "0.95",             # Put/Call 比率（6/10 估自 0.81 升至 0.95、避險買盤回升）
    "pcr_signal":    "中性偏空（Put/Call 6/10 估升至 0.95、自 6/9 0.81 回升；反映 6/10 利多出盡下跌後避險買盤回升、市場轉趨保守）",
    "max_pain":      "2,300",            # 最大痛苦價格（近期到期、6/10 估、自 2,330 下修）
    "key_strikes": [
    ...
    "note": "衍生品數據需每日至台灣期交所(taifex.com.tw)更新；6/10 PCR 自 0.81 升至 0.95 反映利多出盡下跌後避險買盤回升、最大痛苦價自 NT$2,330 下修至 NT$2,300；NT$2,200 心理整數為今日關鍵支撐；中長線結構性利多基底未變（CFO 暗示 3nm 漲 15%、AGM CEO Wei 確認 AI 超供應、2nm 量產 70-80% 良率、Intel CEO 確認長期夥伴、NVIDIA-TSMC AI 合作、PwC 報告 TSMC 全球市值排名躍升至第 9）",
}

# 供應鏈與客戶股價（需每日更新）
ECOSYSTEM_STOCKS = [
    # 類別、股票代碼、名稱、收盤價、漲跌幅、備註（2026-06-10 美股半導體回檔 + 台股 6/10 利多出盡下跌；價格為估算）
    ...
    ("封裝", "3711.TW", "日月光",      "289",    "-2.03%", "CoWoS 封裝（6/10 跟進台股 2330 -2.17% 下跌）"),
    ...
    ("客戶", "2454.TW", "聯發科",      "4,395",  "-2.12%", "手機 SoC 客戶 9%；6/10 跟進台股半導體類股回檔 -2.12%"),
...
CONSENSUS = {
    ...
    "upside":       "+12.20%",   # 從 NT$2,255（6/10 實際收盤）到 NT$2,530
}
...
# 總體經濟監控
MACRO = [
    ("SOX 半導體指數",  "12,920.00","-2.31%", False),  # 6/10 SOX/SOXX 回檔 -2.31% 自高位整理、TSM -4.47% 領跌
    ("台股加權指數",    "44,180.00","-1.17%", False),  # 6/10 加權指數回檔（估）、半導體類股利多出盡
    ("VIX 恐慌指數",    "18.6",    "+0.8",   False),   # 恐慌指數自 17.8 回升、半導體回檔避險升溫
...
VALUATION = {
    "pe_current":   33.2,   # 同 STOCK["pe_ratio"]（6/10 實際 NT$2,255）
...
RELATIVE = {
    "date":           "2026-06-10",       # 最新確認資料日（6/10 Wed 收盤）
    "tsmc_tw_1d":     -2.17,   # 2330 6/10 實際收 NT$2,255（-50 vs 6/9 NT$2,305；利多出盡）
    "taiex_1d":       -1.17,   # 加權指數 6/10 估回檔 -1.17%
    "sox_1d":         -2.31,   # SOX 6/10 回檔 -2.31%、TSM -4.47% 領跌
    "tsmc_nyse_1d":   -4.47,   # TSM ADR 6/10 $408.75 (-$19.14 vs 6/9 $427.89)
    "tsmc_tw_5d":     -5.46,   # 5 日（NT$2,255 vs 6/3 NT$2,385）
    "taiex_5d":       -1.97,
    "tsmc_tw_1m":     -1.53,   # 月線（NT$2,255 vs NT$2,290 ~5/8）
    "taiex_1m":       +7.5,
    "tsmc_tw_ytd":    +7.64,   # YTD 累計（NT$2,255 vs 年初 ~NT$2,095）
    "taiex_ytd":      +12.0,
    "sox_ytd":        +66.5,   # SOX YTD 自高位回檔
    "beta_60d":        1.40,   # 60 日滾動 Beta vs TAIEX（利多出盡放量下跌後微升）
    # ADR 折溢價（以 6/10 NYSE & TW 最新收盤計算）
    "adr_price":     408.75,   # TSM NYSE 6/10 實際收盤（-$19.14，-4.47% vs 6/9 $427.89）
    "adr_parity":    363.12,   # 理論值 = 5 × NT$2,255 ÷ 31.05
    "adr_ratio":     "5:1",    # 1 ADR = 5 台積電普通股
    "usd_ntd":        31.05,   # 同 MACRO 台幣匯率
    "adr_premium_pct": "+12.57", # (408.75 - 363.12) / 363.12 × 100 = +12.57%（自 +14.98% 收斂、ADR 跌幅較大）
    "note": "ADR 理論值 = 5 × 台股收盤 ÷ 匯率（不含交易摩擦與流動性溢價）。⚠️ 6/10 Wed 台股 2330 利多出盡實際收 NT$2,255（-2.17% vs 6/9 NT$2,305）、放量至 42,439 張；NYSE TSM 6/10 重挫 -4.47% 收 $408.75（-$19.14 vs 6/9 $427.89）、盤中 $407.70-$426.32——TSMC 5 月營收創高 NT$4,169.75 億（+30.1% YoY）但市場 sell-the-news + 半導體類股回檔共振。📊 台美 ADR 溢價以 6/10 收盤計算收斂至 +12.57%（ADR 跌幅大於台股反映美股情緒較弱）；🎯 今日（6/11 Thu）短線最關鍵：台股跟進 NYSE 重挫開低、能否守住 NT$2,200 心理整數；⭐ 中長線結構性基底未變：CFO 暗示 3nm 漲 15% + AGM CEO Wei 確認 AI 需求超供應 + 2nm 量產 70-80% 良率 + NVIDIA $150B/年台灣投資 + Intel 確認長期夥伴 + PwC 報告 TSMC 市值躍居全球第 9",
}
...
NEWS = [
    ...
    },
    {
        ...
        "title": "⚠️ 利多出盡：6/10 台股 2330 收 NT$2,255（-2.17%）放量下跌、NYSE TSM 重挫 -4.47% 收 $408.75",
        "body": "TSMC 5 月營收創高但股價「利多出盡」、record-revenue-yet-shares-decline：（1）⚠️ 台股 2330 6/10 實際收 NT$2,255（-50，-2.17% vs 6/9 NT$2,305）、放量至 42,439 張（vs 6/9 33,206）、市值回落 NT$58.5 兆；（2）📉 NYSE TSM 6/10 重挫 -4.47% 收 $408.75（-$19.14 vs 6/9 $427.89）、盤中區間 $407.70-$426.32；（3）下跌主因：sell-the-news（營收創高已被市場預期）+ 6/3 史高 NT$2,440 後高位獲利了結賣壓延續 + 半導體類股回檔共振（SOX 6/10 估 -2.31%）；（4）6/10 美股半導體普遍回檔：NVDA -1.86%、AMD -1.72%、AVGO -1.38%、ASML -1.52%、AMAT -1.76%、MU -1.73%；（5）6/10 估三大法人合計轉賣超約 -14,000 張（外資 -12,000、投信 -1,500、自營 -500）、外資持股比例降至 75.0%；（6）台美 ADR 溢價自 +14.98% 收斂至 +12.57%（ADR 跌幅大於台股反映美股情緒較弱）；（7）⚠️ 技術面轉弱：RSI 估回落至 42 跌破中軸、MACD 翻黑死叉確認、KDJ J 殺至 15 接近超賣；（8）🎯 今日（6/11）關鍵：台股預料跟進 NYSE 重挫開低、能否守住 NT$2,200 心理整數。",
        "source": "Yahoo Finance / gurufocus / cnyes 鉅亨 / TWSE / Goodinfo 2026-06-10 - 06-11", "impact": "負面",
    },
    {
