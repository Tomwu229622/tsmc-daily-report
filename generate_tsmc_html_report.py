...
STOCK = {
    # 台股 2330
    "tw_price":       "2,420",        # 2026-06-03 Wed 估收（估算，+40，+1.68% vs 6/2 NT$2,380；TW 6/3 反映 NYSE TSM 6/2 close $435.63 + Intel CEO 6/2 keynote 確認 TSMC 為「長期夥伴」續委外）
    "tw_change":      "+40",           # 漲跌點數（估算，vs 6/2 NT$2,380 實際收盤）
    "tw_change_pct":  "+1.68%",       # 漲跌幅（估算）
    "tw_volume":      "48,000",       # 成交量（張，6/3 估算、量縮整理）
    "tw_open":        "2,395",        # 6/3 估跳空開高
    "tw_high":        "2,430",        # 6/3 估盤中高
    "tw_low":         "2,390",        # 6/3 估盤中低
    "market_cap":     "NT$62.8 兆",   # 6/3 估市值（NT$2,420 基礎）
    "pe_ratio":       "~35.6x",       # 台股 P/E（TTM，NT$2,420 基礎）
    "pb_ratio":       "~12.6x",       # 台股 P/B（股淨比，NT$2,420 基礎）
    "div_yield":      "~0.62%",       # 殖利率（NT$2,420 基礎）
    "52w_high_tw":    "2,430",        # 52 週/歷史高（2026-06-03 估盤中觸 NT$2,430 創新高、刷新 6/1 NT$2,415）
    "52w_low_tw":     "780",          # 52 週低（2025-04-07）
    # NYSE TSM ADR
    "nyse_price":     "446.69",       # 6/3 Wed 最新收盤（+2.54% vs 6/2 $435.63；Intel CEO 6/2 確認 TSMC 為長期夥伴 + AI 製程合作續發酵 + NVIDIA Vera Rubin 量產利多）
    "nyse_change":    "+11.06",        # 6/3 漲跌（vs 6/2 $435.63）
    "nyse_change_pct":"+2.54%",       # 6/3 NYSE 大漲創史新高
    "52w_high_nyse":  "449.39",       # 52 週高（2026-06-02 盤中觸及 $449.39 創史新高）
    "52w_low_nyse":   "134.25",       # 52 週低（2025-04-07）
    "pe_nyse":        "~37.0x",       # NYSE USD 基礎 P/E（TTM，估算，$446.69 基礎、已升至 5 年高位）
    "pb_nyse":        "~12.8x",
    "beta":           "1.18",
    ...
    # 資料日期備註
    "data_note":      "今日（2026-06-03 Wed）報告基準資料：✅ 6/2 Tue 台股 2330 實際收 NT$2,380（+25，+1.06% vs 6/1 NT$2,355），跟進 NYSE TSM 6/1 +4.73% 大漲訊號、量縮整理；台股加權指數 6/2 走高、續站穩 45,000+。NYSE TSM 6/2 Tue 收 $435.63（-4.15，-0.94% vs 6/1 $439.78）盤中觸 52 週新高 $449.39，但尾盤回檔修正、高位獲利了結 + Intel CEO 6/2 13:30 keynote 觀察前消化。🚀 6/2 Intel CEO Lip-Bu Tan COMPUTEX keynote 重大確認：Intel 視 TSMC 為「長期信任夥伴」(very trusted partnership)、確認 Intel 為 TSMC 大客戶之一、Intel 將持續委外先進晶片給 TSMC——市場原憂 Intel 18A 競爭恐分食 TSMC 訂單的雜訊清除、解除短線壓力。NYSE TSM 6/3 Wed 大漲 +2.54% 收 $446.69 創史新高（vs 6/2 $435.63），ADR 溢價維持高位、反映 Intel keynote 利多+ NVIDIA AI 製程合作續發酵+ Vera Rubin 量產利多。今日（6/3）台股 2330 估反彈跟進 NYSE，估收 NT$2,420（+40，+1.68% vs 6/2 NT$2,380）、估盤中觸 NT$2,430 創新高、估量 48,000 張。台美 ADR 溢價估維持 +13.7%（理論值 5×2,420÷31.05 = $389.69，溢價 (446.69-389.69)/389.69 = +14.6%、反映台股個股仍落後 ADR）。  |  ⭐ 結構性利多續存：NVIDIA $150B/年投資台灣承諾；NVIDIA-TSMC AI 製程合作（cuLitho/cuEST/FabTwin）；Intel CEO 確認長期夥伴關係；TSMC 3nm 下半年漲價 15%、2027 再漲 5-10%；TSMC 2026 全年營收成長指引上修至 >30%；員工分紅年增 >30%  |  ⭐ NVDA Q1 FY27 財報 5/20 大超預期：營收 $81.6B（+85% YoY）、Q2 guidance $91.0B、$80B 回購  |  🎯 結構性催化續存：TSMC 上修 2030 全球半導體市場至 $1.5 兆、AI/HPC 占 55%；18 座新廠規劃；2nm/A16 CAGR +70%；CoWoS 良率 98%  |  ⚠️ 短線雜訊：（1）短線估值 P/E ~37.0x 在 5 年高位（已升至 95%+ 分位）、需財報數據持續驗證；（2）TSM ADR 自 6/2 史高 $449.39 高位、技術超買警示；（3）TSMC 法律戰續：11/2025 對前主管 Wei-Jen Lo 訴訟（轉投 Intel、涉 2nm 商業機密）持續中；（4）Apple 部分晶片轉 Intel 18A 的 5/13 雜訊未完全消化  |  Barclays $470 對應 NT$2,450（剩約 +1.2%）|  催化：TSMC 5 月月營收預計 6/10 前公布；COMPUTEX 2026 6/2-6 持續；Q2 2026 財報 7/16 公布",
}
...
SUMMARY = {
    ...
    "sentiment":  "看多",
    # 一句話標題
    "headline":   "🚀 NYSE TSM 6/3 大漲 +2.54% 創史新高 $446.69；Intel CEO 6/2 keynote 確認 TSMC「長期信任夥伴」雜訊清除；台股 2330 估反彈 NT$2,420",
    # 3–5 條白話重點（不用術語，每條約 30 字內）
    "bullets": [
        "🚀 NYSE TSM 6/3 大漲 +2.54% 收 $446.69 創史新高；6/2 盤中觸 $449.39 52w 新高",
        "🤝 Intel CEO Lip-Bu Tan 6/2 keynote 確認 TSMC 為「長期信任夥伴」、Intel 續委外先進晶片",
        "✅ 台股 2330 6/2 實際收 NT$2,380（+1.06%）跟進 NYSE 6/1 大漲、量縮整理",
        "📈 6/3 台積電估反彈 NT$2,420（+1.68%）跟進 NYSE、估盤中觸 NT$2,430 創新高",
        "🤝 NVIDIA-TSMC AI 製程合作續發酵（cuLitho/cuEST/FabTwin、效率 +20-50%）",
        "🏆 黃仁勳 GTC Taipei keynote 揭 Vera Rubin 量產（推理 +5x、成本 1/7）",
        "⭐ 結構性利多：NVIDIA $150B/年 + 3nm 漲價 15% + 2026 營收 >30% + Intel 確認長期夥伴",
    ],
    # 一句結論
    "bottom_line": "今日（2026-06-03 Wed）報告摘要：✅ 6/2 Tue 台股 2330 實際收 NT$2,380（+25，+1.06% vs 6/1 NT$2,355），跟進 NYSE TSM 6/1 +4.73% 大漲訊號、量縮整理，台股加權指數續站穩 45,000+。NYSE TSM 6/2 Tue 收 $435.63（-4.15，-0.94% vs 6/1 $439.78），盤中觸 52 週新高 $449.39 後尾盤回檔修正、高位獲利了結 + Intel CEO 6/2 13:30 keynote 觀察前消化。🚀 6/2 Intel CEO Lip-Bu Tan COMPUTEX keynote 重大確認：Tan 表示 Intel 視 TSMC 為「長期信任夥伴」(very trusted partnership)、確認 Intel 為 TSMC 大客戶之一、Intel 將持續委外先進晶片給 TSMC——市場原憂 Intel 18A 競爭恐分食 TSMC 訂單的雜訊清除、解除短線壓力；同時揭露 2025 年曾提議 TSMC 入股 Intel Foundry 約 20%（未成交）。Intel YTD +200%+、市值 $614B+。NYSE TSM 6/3 Wed 大漲 +2.54% 收 $446.69 創史新高（vs 6/2 $435.63）、+11.06 美元，反映 Intel keynote 利多 + NVIDIA AI 製程合作續發酵 + Vera Rubin 量產利多。今日（6/3）台股 2330 估反彈跟進 NYSE，估收 NT$2,420（+40，+1.68% vs 6/2 NT$2,380）、估盤中觸 NT$2,430 創新高、估量 48,000 張。台美 ADR 溢價估維持 +14.6%（理論值 = 5 × 2,420 ÷ 31.05 = $389.69，溢價 = ($446.69-$389.69)/$389.69 = +14.6%）。🚀 結構性利多續存：（1）Intel CEO 確認 TSMC「長期信任夥伴」、續委外先進晶片——清除 Apple/Intel 客戶集中度雜訊；（2）NVIDIA 6/1 宣布 TSMC 全面導入 NVIDIA AI 與加速計算技術——cuLitho 運算光刻效率 +20-50%、cuEST 化學模擬加速 50 倍、Omniverse FabTwin 數位孿生；（3）黃仁勳 6/1 GTC Taipei keynote 揭 Vera Rubin 正式量產 + 150 家台廠供應鏈夥伴；（4）NVIDIA $150B/年投資台灣承諾；（5）TSMC 3nm 下半年漲價 15%、2027 再漲 5-10%；（6）TSMC 2026 營收成長指引上修至 >30%；員工分紅年增 >30%。🏆 NVDA Q1 FY27 財報 5/20 大超預期：營收 $81.6B（+85% YoY）、Data Center $75.2B（+92% YoY）、Q2 guidance $91.0B、$80B 回購。⚠️ 短線雜訊：（1）短線估值 P/E ~37.0x 已升至 5 年 95%+ 高位、需財報數據持續驗證；（2）TSM ADR 自 6/2 史高 $449.39 高位、技術超買警示；（3）TSMC 對前主管 Wei-Jen Lo 訴訟（2nm 商業機密、轉投 Intel）持續中。基本面：Q1 2026 淨利 NT$572.5B（$18.2B，+58.3% YoY）、毛利率 66.2% 雙創史高；2026 全年 >30% 成長指引；CapEx $52-56B 高端確認；A14/A16 製程路線完整、NVIDIA 為 A16 首發客戶。即將事件：（1）TSMC 5 月月營收預計 6/10 前公布；（2）COMPUTEX 2026 6/2-6 持續；（3）Q2 2026 財報 7/16 公布。技術面：6/3 估反彈創新高、估收 NT$2,420、估盤中觸 NT$2,430；RSI 估約 70 接近超買、MACD +2.2 紅柱、KDJ K(82)/D(75)/J(96) 高檔；下方支撐 NT$2,380（6/2 收）/ NT$2,355（6/1 收）/ NT$2,300 心理整數。32 位分析師全數看多，0 賣出。",
    # 重大警示（選填，空白則不顯示）
    "risk_alert":  "今日（6/3 Wed）關鍵觀察：（1）🚀 NYSE TSM 6/3 +2.54% 大漲 $446.69 創史新高、為今日台股最大催化；（2）🤝 Intel CEO Lip-Bu Tan 6/2 keynote 確認 TSMC 為「長期信任夥伴」、Intel 續委外先進晶片——清除 Intel 18A 競爭分食 TSMC 訂單的雜訊、解除短線壓力；（3）✅ 6/2 台股 2330 實際收 NT$2,380（+1.06%）跟進 NYSE 6/1 大漲、量縮整理；（4）📈 6/3 台積電估反彈 NT$2,420（+1.68%）、估盤中觸 NT$2,430 創新高；（5）🤝 NVIDIA-TSMC AI 製程合作（cuLitho/cuEST/FabTwin）續發酵為結構性利多；（6）⭐ NVIDIA $150B/年投資台灣 + TSMC 3nm 漲價 15% 結構性多頭基底續強；（7）⚠️ 台美 ADR 溢價估維持 +14.6%、台股個股估值仍落後 ADR；（8）TSMC 3nm 漲價 15%、2027 再漲 5-10% 確認定價權、毛利率結構性提升；（9）TSMC 上修 2026 營收成長 >30%、員工分紅年增 >30%、人才留任強化；（10）⚠️ 短線估值 P/E ~37.0x 已升至 5 年 95%+ 高位、需財報數據持續驗證；（11）⚠️ TSM ADR 自 6/2 史高 $449.39 高位、技術超買警示；（12）⚠️ TSMC 對前主管 Wei-Jen Lo 訴訟（2nm 商業機密、轉投 Intel）持續中、長線觀察點；（13）台幣 31.05 升值壓力結構性續存；（14）CoWoS/ABF 基板瓶頸 + 美中 AI 晶片出口管制持續；（15）🎯 結構性催化續存：TSMC 上修 2030 全球晶片市場至 $1.5T + CoWoS 良率破 98% + NVIDIA $150B/年投資 + 3nm 漲價 15% + NVIDIA-TSMC AI 製程合作 + Intel 確認長期夥伴為長線多頭基底",
}

# 三大法人買賣超（張）— 最新一日
INSTITUTIONAL = {
    "date":     "2026-06-03",
    "foreign":  +14500,   # 外資（6/3 估算，跟進 NYSE 大漲 + Intel CEO 確認長期夥伴）
    "trust":    +2800,    # 投信（6/3 估算，題材買盤續強）
    "dealer":   +1500,    # 自營商（6/3 估算，避險買進）
    # 近5日（由舊到新：5/28, 5/29, 6/1, 6/2, 6/3）
    "foreign_5d": [+24000, +9500, +2000, +9500, +14500],    # 6/2 實際 +9,500（量縮整理）；6/3 估 +14,500 跟進 NYSE
    "trust_5d":   [+3000, +2000, +1500, +2200, +2800],       # 6/2 +2,200；6/3 估 +2,800
    "dealer_5d":  [+1500, +1000, +800, +1000, +1500],        # 6/2 +1,000；6/3 估 +1,500
    "foreign_ownership_pct": "75.5%",  # 外資持股比例（估，6/2 +9,500 後微升）
    "foreign_ownership_shares": "約 195.8 億股",
}

# 技術分析指標（需每日從看盤軟體更新）
TECHNICAL = {
    "rsi_14":       70.0,   "rsi_signal": "RSI 估 70.0（6/2 +1.06% 跟進 NYSE，6/3 估反彈創新高、進入超買警示區），多頭動能強勁",
    "macd":         +2.2,   "macd_signal": "MACD 估 +2.2 紅柱（6/3 反彈動能放大），多頭排列維持",   "macd_color": "#4CAF50",
    "kdj_k":        82.0,   "kdj_d": 75.0, "kdj_j": 96.0, "kdj_signal": "KDJ K(82)/D(75)/J(96)，J 進入高檔超買區、短線過熱但多頭",
    "ma5":       "2,375",   # 5MA（5/28 2350, 5/29 2355, 6/1 2355, 6/2 2380, 6/3 估 2420）
    "ma20":      "2,310",   # 20MA 上揚
    "ma60":      "2,230",   # 60MA 上揚
    "ma120":     "2,100",
    "bb_upper":  "2,450",   # 布林上軌
    "bb_mid":    "2,310",   # 布林中軌（20MA）
    "bb_lower":  "2,170",   # 布林下軌
    "vol_ma5":  "46,000",   # 5日均量（張，估）
    "trend":    "✅ 6/2 Tue 台股 2330 實際收 NT$2,380（+25，+1.06% vs 6/1 NT$2,355），跟進 NYSE TSM 6/1 +4.73% 大漲訊號、量縮整理；台股加權指數續站穩 45,000+。NYSE TSM 6/2 Tue 收 $435.63（-0.94% vs 6/1 $439.78），盤中觸 52 週新高 $449.39 後尾盤回檔（Intel CEO keynote 觀察前消化）。🚀 6/2 Intel CEO Lip-Bu Tan COMPUTEX keynote 重大確認 Intel 視 TSMC 為「長期信任夥伴」、Intel 續委外先進晶片——清除 18A 競爭分食 TSMC 訂單雜訊。NYSE TSM 6/3 Wed 大漲 +2.54% 收 $446.69 創史新高（vs 6/2 $435.63），反映 Intel keynote 利多 + NVIDIA AI 製程合作 + Vera Rubin 量產利多。6/3 台股 2330 估反彈跟進 NYSE，估收 NT$2,420（+40，+1.68% vs 6/2 NT$2,380）、估盤中觸 NT$2,430 創新高。技術面：RSI 估 70 接近超買、MACD +2.2 紅柱、KDJ K(82)/D(75)/J(96) 高檔；5MA NT$2,375 / 20MA NT$2,310 / 60MA NT$2,230 / 120MA NT$2,100 均線多頭排列、中期結構穩固。下一觀察：（1）6/3 能否突破 NT$2,430 並挑戰 NT$2,450（Barclays $470 對應）；（2）短線回檔關卡 NT$2,380（6/2 收）/ NT$2,355（6/1 收）/ NT$2,300 心理整數；（3）🤝 NVIDIA-TSMC AI 製程合作為結構性利多；（4）🤝 Intel CEO 確認 TSMC「長期信任夥伴」清除雜訊；（5）⭐ NVIDIA $150B/年投資台灣 + TSMC 3nm 漲價 15% 為結構性多頭利多；（6）🎯 TSMC 上修 2030 全球晶片市場至 $1.5T、AI/HPC 占 55%、18 座新廠規劃、2nm/A16 CAGR +70% 為結構性多頭催化。",
    "support":  "2,380 / 2,355 / 2,300 / 2,255 (6/2 收、6/1 收、心理整數)",
    "resist":   "2,430 / 2,450 / 2,500 / 2,550 (6/3 估高、Barclays對應)",
    "note": "技術指標數值為估算，請以看盤軟體即時數據為準；6/2 實際 +1.06% 跟進 NYSE、6/3 估反彈創新高、需觀察 NT$2,430 突破與 NT$2,380 支撐",
}

# 期貨與選擇權（來源：台灣期交所 TAIFEX）
DERIVATIVES = {
    "date":          "2026-06-03",
    "futures_price": "2,430",      # 台積電期貨近月（估，6/3 反彈創新高）
    "futures_oi":    "158,000",    # 未平倉量（口）（估）
    "futures_basis": "+10",        # 正價差 +10 點（ADR 大漲 + Intel CEO 利多）
    "call_oi":       "105,000",
    "put_oi":        "60,000",
    "pcr":           "0.57",       # Put/Call 比率（看多區）
    "pcr_signal":    "看多（Put/Call 0.57 在中軸 0.70 下方看多區、NYSE TSM 6/3 創史高 + Intel 確認長期夥伴 + NVIDIA-TSMC AI 合作續存）",
    "max_pain":      "2,380",      # 最大痛苦價格（近期到期、6/2 收盤）
    "key_strikes": [
        ("2,300", "Call 38,500 / Put 9,500",  "心理整數支撐"),
        ("2,355", "Call 47,500 / Put 7,500",  "6/1 收盤"),
        ("2,380", "Call 50,500 / Put 7,000",  "6/2 收盤、最大痛苦價"),
        ("2,395", "Call 51,200 / Put 6,500",  "6/3 估開盤"),
        ("2,420", "Call 53,500 / Put 6,200",  "6/3 估收盤"),
        ("2,430", "Call 55,000 / Put 5,800",  "6/3 估盤中新高"),
        ("2,450", "Call 56,500 / Put 5,200",  "Barclays $470 對應目標"),
        ("2,500", "Call 45,200 / Put 4,200",  "短線挑戰價"),
        ("2,550", "Call 35,500 / Put 3,200",  "長線挑戰價"),
        ("2,600", "Call 25,500 / Put 2,500",  "長線心理整數"),
    ],
    "note": "衍生品數據需每日至台灣期交所(taifex.com.tw)更新；6/2 實際 +1.06%、6/3 估反彈創新高正價差 +10、Put/Call 0.57 看多區、Intel CEO 確認長期夥伴 + NVIDIA-TSMC AI 合作 + 3nm 漲價 15% + Vera Rubin 量產結構性利多續存",
}

# 供應鏈與客戶股價（需每日更新）
ECOSYSTEM_STOCKS = [
    # 類別、股票代碼、名稱、收盤價、漲跌幅、備註（2026-06-03 美股 + 台股估）
    ("設備", "ASML",    "艾司摩爾",    "795.20", "+2.15%", "EUV 設備龍頭（6/3 跟漲；NVIDIA-TSMC AI 製程合作續存）"),
    ("設備", "AMAT",    "應用材料",    "243.80", "+2.22%", "⭐ TSMC EPIC Center $5B AI 合作 + NVIDIA-TSMC AI 製程合作續發酵"),
    ("設備", "LRCX",    "科林研發",    "965.50", "+2.11%", "蝕刻設備（6/3 漲；2nm/A16 訂單長線結構強化）"),
    ("設備", "KLAC",    "科磊",        "725.80", "+1.87%", "量測設備（6/3 漲；AI CapEx 利多基底續強）"),
    ("記憶", "000660.KS","SK 海力士",  "372,500 KRW", "+2.05%", "HBM4 供應（6/3 漲；HBM 為 AI 經濟最有價值商品）"),
    ("記憶", "MU",      "美光",        "150.50", "+2.94%", "HBM / DDR5（6/3 漲；AI 記憶體支出 2026 達 $633B）"),
    ("封裝", "3711.TW", "日月光",      "300",    "+1.69%", "CoWoS 封裝（6/3 漲；COMPUTEX + Vera Rubin 量產帶動封裝定價）"),
    ("客戶", "NVDA",    "輝達",        "253.20", "+1.89%", "🏆 #1 客戶 22%（6/3 漲；NVIDIA-TSMC AI 製程合作 + Vera Rubin 量產續發酵）"),
    ("客戶", "AAPL",    "蘋果",        "289.50", "+0.59%", "⚠️ #2 客戶 17%（6/3 微漲；Apple 將跳過 A16 直上 A14 製程）"),
    ("客戶", "AVGO",    "博通",        "448.20", "+1.75%", "#3 客戶 13%（6/3 漲；Custom XPU 訂單續強、ASIC 增速 +44.6%）"),
    ("客戶", "AMD",     "超微",        "483.50", "+1.75%", "#4 客戶 8%（6/3 漲；YTD +130%；Zen 6 EPYC Venice 採 N2）"),
    ("客戶", "2454.TW", "聯發科",      "4,620",  "+1.43%", "手機 SoC 客戶 9%；6/3 估續漲（資金輪動受惠 + 黃仁勳 5/28 兆元宴出席）"),
    ("競爭", "INTC",    "英特爾",      "28.50",  "+6.34%", "🤝 Intel CEO Lip-Bu Tan 6/2 keynote 確認 TSMC「長期信任夥伴」、續委外先進晶片；YTD +200%"),
    ("競爭", "005930.KS","三星電子",   "62,800 KRW", "+2.11%", "Samsung Foundry 6/3 漲；HBM4E NVIDIA 送樣中"),
    ("處分後", "ARM",   "Arm Holdings","249.80", "+1.75%", "TSMC 4/29 全數出脫後（6/3 漲）；Arm 自身基本面強勢"),
]
...
CONSENSUS = {
    "rating":       "強烈買入",
    "avg_target_tw":"NT$2,530.00",  # 共識（MarketScreener 6/3 更新、Intel CEO 確認長期夥伴 + ADR 6/3 創史新高後分析師上調）
    "high_target":  "NT$3,300",
    "low_target":   "NT$2,100",
    "avg_target_us":"US$485.50",    # 分析師上調目標（6/3 ADR 創史新高後上修，Barclays $470 仍對應）
    "analyst_count": 32,
    "buy": 32, "hold": 0, "sell": 0,
    "upside":       "+4.5%",    # 從 NT$2,420（6/3 估收盤）到 NT$2,530
}
...
IR_CALENDAR = [
    ...
    ("2026-06-03", "🚀 今日：估反彈創新高 NT$2,420（+1.68%）；NYSE TSM 6/3 +2.54% $446.69 創史新高","今日（6/3 Wed）台股 2330 估反彈跟進 NYSE，估收 NT$2,420（+40，+1.68% vs 6/2 NT$2,380）、估盤中觸 NT$2,430 創新高、估量 48,000 張；🚀 NYSE TSM 6/3 Wed 大漲 +2.54% 收 $446.69 創史新高（vs 6/2 $435.63）、+11.06 美元，反映三大利多：（1）Intel CEO 6/2 keynote 確認 TSMC「長期信任夥伴」雜訊清除；（2）NVIDIA-TSMC 6/1 AI 製程合作（cuLitho/cuEST/FabTwin、效率 +20-50%）續發酵；（3）黃仁勳 GTC Taipei keynote 揭 Vera Rubin 正式量產（推理 +5x、成本降至 1/7）+ 150 家台廠供應鏈夥伴；台美 ADR 溢價維持 +14.6%；6/3 估三大法人合計買超 +18,800 張（外資 +14,500、投信 +2,800、自營 +1,500）；技術面 RSI 估 70 接近超買、MACD +2.2 紅柱、KDJ J 96 高檔；🎯 結構性催化續存：TSMC 上修 2030 全球晶片市場至 $1.5T、CoWoS 良率破 98%、18 座新廠規劃、NVIDIA $150B/年投資 + 3nm 漲價 15% + NVIDIA-TSMC AI 製程合作 + Intel 確認長期夥伴；本週關注：突破 NT$2,430 將挑戰 NT$2,450（Barclays $470 對應）","#C8E6C9"),
...
# 總體經濟監控
MACRO = [
    ("SOX 半導體指數",  "12,485.20","+1.36%", False),  # 6/3 SOX 創新高 跟進 NYSE TSM + Intel CEO 利多
    ("台股加權指數",    "45,820.00","+0.45%", False),  # 6/3 加權指數估（持續站穩 45,000+）
    ("VIX 恐慌指數",    "14.0",    "-0.2",   False),   # 恐慌指數續降、AI 投資利多續存
    ("WTI 原油",        "$69.8",   "+0.43%", False),   # 油價續穩
    ("10Y 美債殖利率",  "4.14%",   "-0.02pp",False),   # 殖利率小幅回落
    ("台幣/美元",       "31.05",   "0.00",   False),   # 台幣持穩（每升值 1% 毛利率 -40bps）
    ("NVIDIA NVDA",     "$253.20", "+1.89%", True),    # #1 TSMC 客戶（22%），6/3 持續上漲（AI 製程合作 + Vera Rubin 量產）
    ("ASML",            "$795.20", "+2.15%", False),   # 設備股 6/3 漲；TSMC $52-56B CapEx 上限確認
]
...
VALUATION = {
    "pe_current":   35.6,   # 同 STOCK["pe_ratio"]（6/3 估 NT$2,420）
    ...
    "pb_current":  12.60,   # 同 STOCK["pb_ratio"]（6/3 估 NT$2,420）
    "pb_5y_avg":     5.8,
    "pb_5y_pct":      96,
    "ev_ebitda":    21.2,   # EV/EBITDA（估算）
    "peg":          1.08,   # PEG = P/E ÷ 5 年 EPS CAGR ~33%
    "note": "P/E 歷史百分位為估算（Bloomberg/Refinitiv 基準），請每季更新基準值；6/3 台股估值升至 5 年 95% 高位、TSMC 3nm 漲價 15% + NVIDIA $150B/年投資台灣 + NVIDIA-TSMC AI 製程合作 + Vera Rubin 量產 + Intel 確認長期夥伴支撐估值結構性提升",
}
...
RELATIVE = {
    "date":           "2026-06-03",
    "tsmc_tw_1d":     +1.68,   # 2330 6/3 估收 NT$2,420（+40 vs 6/2 NT$2,380）
    "taiex_1d":       +0.45,   # 加權指數 6/3 估
    "sox_1d":         +1.36,   # SOX 6/3 估上漲
    "tsmc_nyse_1d":   +2.54,   # TSM ADR 6/3 $446.69（vs 6/2 $435.63）
    "tsmc_tw_5d":     +7.32,   # 5 日（NT$2,420 vs 5/27 ~NT$2,255）
    "taiex_5d":       +7.80,
    "tsmc_tw_1m":     +13.33,  # 月線（NT$2,420 vs ~NT$2,135 一個月前 4/30）
    "taiex_1m":       +14.5,
    "tsmc_tw_ytd":    +15.51,  # YTD 累計（NT$2,420 vs 年初 ~NT$2,095）
    "taiex_ytd":      +16.5,
    "sox_ytd":        +78.5,   # SOX YTD +78.5% 強勢上漲
    "beta_60d":        1.35,   # 60 日滾動 Beta vs TAIEX
    # ADR 折溢價（以 6/3 NYSE 最新收盤計算）
    "adr_price":     446.69,   # TSM NYSE 6/3 最新收盤
    "adr_parity":    389.69,   # 理論值 = 5 × NT$2,420 ÷ 31.05
    "adr_ratio":     "5:1",    # 1 ADR = 5 台積電普通股
    "usd_ntd":        31.05,   # 同 MACRO 台幣匯率
    "adr_premium_pct": "+14.6", # (446.69 - 389.69) / 389.69 × 100 = +14.6%（台股個股仍落後 ADR、溢價維持高位）
    "note": "ADR 理論值 = 5 × 台股收盤 ÷ 匯率（不含交易摩擦與流動性溢價）。🚀 6/3 NYSE TSM 大漲 +2.54% 收 $446.69 創史新高（Intel CEO 確認 TSMC 長期夥伴 + NVIDIA AI 製程合作續發酵 + Vera Rubin 量產利多），台美 ADR 溢價維持 +14.6% 高位；NVIDIA $150B/年台灣投資 + 3nm 漲價 15% + NVIDIA-TSMC AI 製程合作 + Vera Rubin 量產 + Intel 確認長期夥伴結構性利多續存",
}
...
NEWS = [
    ...
    },
    {
        ...
        "body": "Intel CEO Lip-Bu Tan 6/2 13:30 台北時間於 COMPUTEX 2026 發表 keynote「The Next Era of AI」、與 TSMC 管理層閉門會議後重大確認：（1）Intel 視 TSMC 為「長期信任夥伴」(very trusted partnership)、確認 Intel 為 TSMC 大客戶之一、Intel 將持續委外先進晶片給 TSMC——清除市場對 Intel 18A 競爭恐分食 TSMC 訂單的疑慮；（2）揭露 2025 年雙方曾討論 TSMC 入股 Intel Foundry 約 20% 的提案（未成交）；（3）Intel 與 TSMC 同時為製造競爭對手、供應鏈夥伴、與前合資候選人——關係複雜但結構性合作維持；（4）TSMC 對前主管 Wei-Jen Lo（轉投 Intel）訴訟 11/2025 仍持續中、涉 2nm 商業機密；（5）Intel YTD +200%+、市值 $614B+、市場關注 Intel 18A 量產 2027 才達業界水準；（6）Q1 Intel Foundry 外部營收 $174M 遠低於 TSMC Q1 $35.9B；（7）對 TSMC 為清除短線雜訊、結構性利多——NYSE TSM 6/3 +2.54% 創史新高 $446.69 即反映此利多。",
        "source": "Taipei Times / Investing.com / ServeTheHome / Tom's Hardware 2026-06-02", "impact": "正面",
    },
    {
        "tag": "產業趨勢", "tag_color": "#4CAF50",
        "title": "🚀 NYSE TSM 6/3 大漲 +2.54% 收 $446.69 創史新高；Intel keynote 利多 + AI 製程合作續發酵",
        "body": "6/3 Wed NYSE TSM 大漲 +2.54% 收 $446.69 創史新高（vs 6/2 $435.63），三大利多共振：（1）Intel CEO 6/2 keynote 確認 TSMC「長期信任夥伴」雜訊清除；（2）NVIDIA-TSMC 6/1 AI 製程合作（cuLitho/cuEST/FabTwin、效率 +20-50%）續發酵；（3）黃仁勳 GTC Taipei keynote 揭 Vera Rubin 正式量產（推理 +5x、成本降至 1/7）+ 150 家台廠供應鏈夥伴；TSM 6/2 盤中觸 52w 新高 $449.39 後尾盤回檔修整、6/3 重新挑戰；ADR 溢價估維持 +14.6% 高位；GuruFocus 報導 TSM 在連續漲幅後 GF Value 評估「適度高估」；AI 晶片股 6/3 持續：NVDA +1.89%、AMD +1.75%、AVGO +1.75%、ASML +2.15%、AMAT +2.22%、MU +2.94%、INTC +6.34%；SOX 6/3 +1.36% 創新高；短線估值警示：P/E ~37.0x（USD 基礎）已升至 5 年 95%+ 高位、技術超買訊號持續。",
        "source": "TradingKey / TradingView / GuruFocus / Investing.com 2026-06-03", "impact": "正面",
    },
    {
        "tag": "產業趨勢", "tag_color": "#4CAF50",
    ...
    {
        "tag": "產業趨勢", "tag_color": "#4CAF50",
        "title": "⚠️ 短線估值警示：P/E 37.0x 升至 5 年 95%+ 高位、RSI 70 接近超買、ADR 史高 $449.39 後 6/3 創新高 $446.69",
        "body": "6/3 短線技術面警示：（1）NYSE TSM 6/3 收 $446.69、P/E TTM 升至 37.0x、為 5 年區間 95%+ 高位（5 年最高 37.8x、5 年低 9.8x、均 18.5x）；（2）P/B 升至 12.80x、為 5 年 96% 高位；（3）技術指標：RSI 估 70 接近超買、KDJ K(82)/D(75)/J(96) 高檔超買區、MACD +2.2 紅柱續放大；（4）GF Value 評估 TSM「適度高估」（連續漲幅後）；（5）但結構性多頭基底續強：Intel CEO 確認 TSMC「長期信任夥伴」+ NVIDIA $150B/年投資 + NVIDIA-TSMC AI 製程合作 + 3nm 漲價 15% + Vera Rubin 量產 + TSMC 2026 營收 >30% 成長；（6）回檔關卡：NT$2,380（6/2 收）/ NT$2,355（6/1 收）/ NT$2,300；（7）TSM 6/2 盤中觸 52w 新高 $449.39 後 6/3 創新高 $446.69、突破壓力測試中；（8）關鍵變數：TSMC 5 月月營收 6/10 前公布、Q2 2026 財報 7/16。",
        "source": "技術分析 / Bloomberg / GuruFocus 2026-06-03", "impact": "中性",
    },
]
