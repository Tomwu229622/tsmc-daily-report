...
STOCK = {
    # 台股 2330
    "tw_price":       "2,385",        # 2026-06-18 Thu 收盤（+25，+1.06% vs 6/17 NT$2,360；跟進 NYSE TSM 6/17 +1.48% 反彈；估算、官方收盤請以 TWSE 為準。6/19 Fri 端午節 TWSE 休市）
    "tw_change":      "+25",          # 6/18 漲跌點數（vs 6/17 收 NT$2,360）
    "tw_change_pct":  "+1.06%",       # 6/18 漲跌幅（跟進 NYSE 6/17 +1.48% 反彈）
...
SUMMARY = {
    ...
    "sentiment":  "中性偏多",
    # 一句話標題
    "headline":   "📈 TSMC 台美雙市反彈：NYSE TSM 6/17 收 $432.15（+1.48%）自回檔後低接回補、台股 2330 6/18 跟進估收 NT$2,385（+1.06%）；SpaceX 創紀錄 IPO 將 TSMC 擠至全球市值第 7 + TSMC-Amkor 10 年美國封裝長約確認",
    # 3–5 條白話重點（不用術語，每條約 30 字內）
    "bullets": [
        "📈 NYSE TSM 6/17 Wed 收 $432.15（+$6.32、+1.48% vs 6/16 $425.83）、自 6/16 -3.53% 回檔後低接回補、市值 $1.96 兆",
        "📈 台股 2330 6/18 Thu 跟進 ADR 反彈估收 NT$2,385（+25、+1.06% vs 6/17 NT$2,360）、市值回升 NT$61.9 兆（官方以 TWSE 為準）",
...
# 技術分析指標（需每日從看盤軟體更新）
TECHNICAL = {
    "rsi_14":       58.0,   "rsi_signal": "RSI 估自 55 回升至 58（台股 6/18 +1.06%、NYSE 6/17 +1.48% 反彈），自中性區回升、多方動能回溫、未過熱",
...
IR_CALENDAR = [
    ...
    ("2026-06-18", "📈 台美雙市反彈、SpaceX IPO 將 TSMC 擠至全球市值第 7；台股 2330 6/18 估收 NT$2,385（+1.06%）", "6/18 Thu NYSE TSM 6/17 Wed 收 $432.15（+$6.32、+1.48% vs 6/16 $425.83、成交量 1,096 萬股、P/E 32.79、市值 $1.96 兆）自 6/16 -3.53% 回檔後低接買盤回補、盤中觸 $439.60；台股 2330 6/18 跟進 ADR 反彈估收 NT$2,385（+25、+1.06% vs 6/17 NT$2,360）、市值回升 NT$61.9 兆；🛰️ SpaceX 創紀錄 IPO（估值 $2.519 兆、募資 ~$750 億、+19.6%）市值超越 TSMC（$2.289 兆）、將台積電擠至全球市值第 7（屬外部排名變動、基本面未受影響）；🤝 TSMC-Amkor 簽 10 年美國先進封裝長約（6/16 公告、Peoria AZ $70 億、2028 投產、~2,000 就業、InFO/CoWoS）；🏆 NVIDIA Vera Rubin NVL72 採 TSMC N3+CoWoS-L、首搭 8 層 HBM4；6/18 估三大法人合計買超（外資估 +6,000 張）；⚠️ 6/19 Fri 端午節 TWSE 休市、6/18 為連假前最後交易日；技術面 RSI 自 55 回升至 58、KDJ J 自 50 回升至 70 低檔金叉浮現、MACD 紅柱止縮微張；下方支撐 NT$2,360 / NT$2,310、上方壓力 NT$2,400 / NT$2,425 / NT$2,440 史高", "#C8E6C9"),
...
MACRO = [
    ...
    ("台股加權指數",    "45,650.00","+1.11%", True),   # 6/18 估跟進反彈、半導體類股回溫
...
RELATIVE = {
    ...
    "tsmc_tw_1d":     +1.06,   # 2330 6/18 估收 NT$2,385（+25 vs 6/17 NT$2,360；跟進 ADR 反彈）
    "taiex_1d":       +1.11,   # 加權指數 6/18 估反彈 +1.11%
