...
STOCK = {
    # 台股 2330
    "tw_price":       "2,300",        # 2026-06-12 Fri 盤中估（+50，+2.22% vs 6/11 收 NT$2,250；跟進 NYSE TSM 6/11 +3.20% 反彈；官方收盤待確認）
    "tw_change":      "+50",          # 6/12 盤中估漲跌點數（vs 6/11 收 NT$2,250）
    "tw_change_pct":  "+2.22%",       # 6/12 盤中估漲跌幅
    "tw_volume":      "38,000",       # 6/12 盤中估成交量（張，估）
    "tw_open":        "2,290",        # 6/12 估開盤（跟進 NYSE 6/11 +3.20% 跳空高開）
    "tw_high":        "2,315",        # 6/12 盤中高（估）
    "tw_low":         "2,280",        # 6/12 盤中低（估）
    "market_cap":     "NT$59.6 兆",   # 6/12 盤中估市值（NT$2,300 基礎）
    "pe_ratio":       "~33.9x",       # 台股 P/E（TTM，NT$2,300 基礎）
    "pb_ratio":       "~12.0x",       # 台股 P/B（股淨比，NT$2,300 基礎）
    "div_yield":      "~0.65%",       # 殖利率（NT$2,300 基礎）
    "52w_high_tw":    "2,440",        # 52 週/歷史高（2026-06-03 盤中觸 NT$2,440 史高）
    "52w_low_tw":     "780",          # 52 週低（2025-04-07）
    # NYSE TSM ADR
    "nyse_price":     "421.07",       # 6/11 Thu 實際收盤（+$12.32，+3.20% vs 6/10 $408.75；強勢反彈，來源 stockanalysis.com）
    "nyse_change":    "+12.32",       # 6/11 漲跌（vs 6/10 $408.75）
    "nyse_change_pct":"+3.20%",       # 6/11 NYSE 強勢反彈（消化 6/10 -4.48% sell-the-news）
    "52w_high_nyse":  "449.39",       # 52 週高（2026-06-02 盤中觸及 $449.39 創史新高）
    "52w_low_nyse":   "134.25",       # 52 週低（2025-04-07）
    "pe_nyse":        "~34.8x",       # NYSE USD 基礎 P/E（TTM，估算，$421.07 基礎）
    "pb_nyse":        "~12.1x",
    "beta":           "1.18",
    ...
    # 資料日期備註
    "data_note":      "報告日期：2026-06-12 Fri（NYSE TSM 6/11 Thu 收盤為最新確認數據；台股 2330 6/12 為盤中估、官方收盤待確認）。⭐⭐⭐ 今日頭條——NYSE TSM 6/11 強勢反彈 +3.20% 收 $421.07（+$12.32 vs 6/10 $408.75），消化 6/10 -4.48% sell-the-news 賣壓、record-revenue 基本面（5 月營收 NT$4,169.75 億、+30.1% YoY、創單月新高）獲市場重新確認；台股 2330 6/11 收 NT$2,250（持平），6/12 預期跟進 ADR 反彈、盤中估 ~NT$2,300（+2.22%）、市值回升 NT$59.6 兆。⚠️ 籌碼面警訊（真實數據修正）：三大法人實際資料顯示外資 6/9–6/11 連續賣超（6/9 -15,008、6/10 -15,543、6/11 -4,904 張，三日累計逾 -3.5 萬張）；惟 6/11 外資賣壓大幅縮減（自 -15,543 收斂至 -4,904）顯示拋售動能趨緩、投信轉買 +600、自營轉買 +340，外資尚未轉買、需觀察 ADR 反彈能否帶動回補。💰 結構性利多續存：TSMC CFO 6/11 確認先進製程 H2 漲價——3nm 漲 ~15%、sub-5nm 漲 5-10%（AI 需求 + 3nm 產能短缺驅動）；CEO C.C. Wei 重申「全球晶片供應將數年內持續落後 AI 需求」、Q2 月產能 160K–175K 片仍供不應求。⚠️ 競爭雜訊：Google 向 Intel Foundry 下單逾 300 萬顆自研 TPU（2028 交付）、Intel 6/8 大漲逾 11%——市場解讀部分客戶在 TSMC 產能緊俏下尋求分散。台美 ADR 溢價（以 6/11 ADR $421.07 + 6/12 台股盤中估 NT$2,300 計）：理論值 5×2,300÷31.05 = $370.37、溢價 (421.07-370.37)/370.37 = +13.69%。  |  🎯 即將事件：6 月營收 7 月上旬公布；Q2 2026 財報法說會 7/16（指引 $39.0-40.2B、+10% QoQ、+32% YoY、毛利率 65-67%）  |  ⭐ 中長線結構性利多基底未變：2nm 量產良率 70-80% 領先全球、年底月產能 100K 片；NVIDIA 第 1 大客戶 22%/$33B + RTX Spark 由 TSMC 代工；4 大美國 CSP（Google/AWS/MSFT/Meta）2026 AI CapEx 合計 $725B（+77% YoY）；NVIDIA-TSMC AI 製程合作（cuLitho/cuEST/FabTwin）；Intel CEO 確認長期夥伴；PwC 報告 TSMC 市值年增 +101% 躋身全球第 9 大市值企業  |  ⚠️ 本日（6/12）關鍵觀察：（1）台股 2330 能否跟進 ADR 反彈站回 NT$2,295 / 5MA；（2）外資是否止賣轉買為次階段關鍵；（3）下方支撐 NT$2,250 / NT$2,200（心理整數）/ NT$2,165（120MA）；上方壓力 NT$2,295 / NT$2,305 / NT$2,365",
}
...
SUMMARY = {
    ...
    "sentiment":  "中性偏多",
    # 一句話標題
    "headline":   "✅ NYSE TSM 6/11 強勢反彈 +3.20% 收 $421.07，消化 sell-the-news 賣壓；台股 2330 6/12 預期跟進反彈、盤中估 NT$2,300（+2.22%）；惟外資連 3 日賣超為觀察重點",
    # 3–5 條白話重點（不用術語，每條約 30 字內）
    "bullets": [
        "✅ NYSE TSM 6/11 強勢反彈 +3.20% 收 $421.07（+$12.32 vs 6/10 $408.75）、消化 6/10 -4.48% sell-the-news 賣壓",
        "📈 台股 2330 6/11 收 NT$2,250（持平）、6/12 預期跟進 ADR 反彈、盤中估 ~NT$2,300（+2.22%）、市值回升 NT$59.6 兆",
        "⚠️ 籌碼警訊：真實數據外資 6/9-6/11 連 3 日賣超（-15,008 / -15,543 / -4,904 張）、6/11 賣壓大幅縮減但尚未轉買",
        "✅ 投信、自營 6/11 同步轉買（+600 / +340 張）、外資賣壓自 -15,543 收斂至 -4,904 顯示拋售動能趨緩",
        "💰 TSMC CFO 6/11 確認先進製程 H2 漲價（3nm 漲 ~15%、sub-5nm 漲 5-10%）；CEO Wei 重申供應數年落後 AI 需求",
        "⚠️ 競爭雜訊：Google 向 Intel Foundry 下單逾 300 萬顆自研 TPU（2028 交付）、Intel 6/8 大漲逾 11%",
        "⭐ 中長線基底未變：5 月營收 NT$4,169.75 億 +30.1% 創單月新高 + 2nm 量產 70-80% 良率 + 4 大 CSP CapEx $725B",
        "⚠️ 估值警示：TSM P/E ~33.9x 仍在 5 年 90% 高位、關鍵守住 NT$2,250、6/12 站回 NT$2,295 / 5MA",
    ],
    # 一句結論
    "bottom_line": "報告日期：2026-06-12 Fri（NYSE TSM 6/11 Thu 收盤為最新確認數據；台股 2330 6/12 為盤中估、官方收盤待確認）。⭐⭐⭐ 今日頭條——NYSE TSM 6/11 Thu 強勢反彈 +3.20% 收 $421.07（+$12.32 vs 6/10 $408.75，來源 stockanalysis.com），消化 6/10 -4.48% sell-the-news 拋售賣壓、record-revenue 基本面（5 月合併月營收 NT$4,169.75 億、+30.1% YoY、月增 +1.5%、創史上單月新高；1–5 月累計 NT$1.96 兆 +30%）獲市場重新確認；台股 2330 6/11 收 NT$2,250（持平），6/12 預期跟進 ADR 反彈、盤中估 ~NT$2,300（+2.22%）、市值回升 NT$59.6 兆。⚠️ 籌碼面警訊（真實數據修正）：三大法人實際資料顯示外資在 6/9–6/11 為連續賣方——6/9 賣超 -15,008 張（投信 +2,661、自營 -1,031）、6/10 賣超 -15,543 張（投信 -3、自營 -826）、6/11 賣超 -4,904 張（投信 +600、自營 +340）；外資三日累計賣超逾 -3.5 萬張，惟 6/11 賣壓自 -15,543 大幅收斂至 -4,904、投信與自營同步轉買，顯示拋售動能趨緩、市場情緒回穩；外資尚未轉買，能否在 ADR 反彈後回補為次階段關鍵。台美 ADR 溢價（以 6/11 ADR $421.07 + 6/12 台股盤中估 NT$2,300 計）：理論值 5×2,300÷31.05 = $370.37、溢價 (421.07-370.37)/370.37 = +13.69%。⭐ 中長線結構性利多基底未變：（1）💰 TSMC CFO 6/11 確認先進製程 H2 漲價——3nm 漲 ~15%、sub-5nm 漲 5-10%、反映 AI 強勁需求 + 3nm 產能短缺下的定價權；（2）🏛️ CEO C.C. Wei 重申「全球晶片供應將數年內持續落後 AI 需求」、Q2 月產能 160K–175K 片仍供不應求、2026 >30% 成長指引；（3）⭐ TSMC 2nm 已量產、nanosheet GAA、初期良率 70-80% 領先全球、年底月產能目標 100K 片；2nm 至 2028 CAGR +70%；（4）NVIDIA 第 1 大客戶（22% / $33B）、Apple 第 2 大（18% / $27B）；（5）NVIDIA-TSMC AI 製程合作（cuLitho/cuEST/Omniverse FabTwin）導入晶圓廠提升良率；（6）NVIDIA RTX Spark 超晶片由 TSMC N3E + CoWoS 代工；（7）4 大美國 CSP 2026 AI CapEx 合計 $725B（+77% YoY）；（8）PwC 報告 TSMC 市值年增 +101% 躋身全球第 9 大市值企業。⚠️ 短期下行風險：（1）外資連 3 日賣超、籌碼面尚未轉多；（2）⚠️ 競爭雜訊——Google 向 Intel Foundry 下單逾 300 萬顆自研 TPU（2028 交付）、Intel 6/8 大漲逾 11%，市場憂部分客戶在 TSMC 產能緊俏下尋求分散；（3）Fed 升息預期升溫、10Y 美債殖利率 4.5%+；（4）美對中 AI 晶片出口管制擴大；（5）⚠️ 估值警示 TSM P/E ~33.9x 仍在 5 年 90% 高位。基本面未變：Q1 2026 淨利 NT$572.5B（$18.2B、+58.3% YoY）、毛利率 66.2% 雙創史高；2025 全年 EPS NT$66.25。技術面（基於 6/12 盤中估 NT$2,300）：5MA NT$2,295 / 20MA NT$2,315 / 60MA NT$2,300 / 120MA NT$2,175；下方支撐 NT$2,250 / NT$2,200 心理整數 / NT$2,165（120MA）；上方壓力 NT$2,295 / NT$2,305 / NT$2,365。32 位分析師全數看多、平均目標 NT$2,530 上行空間 +10.00%（自 NT$2,300）。",
    # 重大警示（選填，空白則不顯示）
    "risk_alert":  "今日（6/12 Fri）關鍵觀察：（1）✅ NYSE TSM 6/11 強勢反彈 +3.20% 收 $421.07（+$12.32 vs 6/10 $408.75）、消化 6/10 -4.48% sell-the-news 賣壓、record-revenue 基本面獲重新確認；（2）📈 台股 2330 6/11 收 NT$2,250（持平）、6/12 預期跟進 ADR 反彈、盤中估 ~NT$2,300（+2.22%）；（3）⚠️ 籌碼面警訊：真實數據外資 6/9–6/11 連 3 日賣超（-15,008 / -15,543 / -4,904 張、累計逾 -3.5 萬張），惟 6/11 賣壓大幅收斂、投信與自營轉買——外資能否轉買為次階段關鍵；（4）💰 TSMC CFO 6/11 確認 3nm H2 漲 ~15%、sub-5nm 漲 5-10% 續存利多；CEO Wei 重申供應數年落後 AI 需求、Q2 月產能 160K–175K 片；（5）⚠️ 競爭雜訊：Google 向 Intel Foundry 下單逾 300 萬顆自研 TPU（2028 交付）、Intel 6/8 大漲逾 11%；（6）🏆 PwC 報告 TSMC 市值年增 +101% 躋身全球第 9 大市值企業；（7）⭐ 5 月營收 NT$4,169.75 億 +30.1% 創單月新高、1-5 月累計 NT$1.96 兆；（8）⭐ TSMC 2nm 量產良率 70-80% 領先全球、年底月產能 100K 片；（9）⭐ 4 大美國 CSP 2026 AI CapEx 合計 $725B（+77% YoY）；（10）⭐ NVIDIA-TSMC AI 製程合作 + RTX Spark 由 TSMC 代工；（11）⚠️ 估值警示 TSM P/E ~33.9x 仍在 5 年 90% 高位；（12）⚠️ Fed 升息預期升溫、10Y 美債殖利率 4.5%+；（13）📊 台美 ADR 溢價 +13.69%；（14）32 位分析師全數看多、平均目標 NT$2,530 上行空間 +10.00%；本日（6/12）關鍵：台股能否跟進 ADR 反彈站回 NT$2,295 / 5MA、外資是否止賣轉買；下方支撐 NT$2,250 / NT$2,200 心理整數 / NT$2,165（120MA）",
}

# 三大法人買賣超（張）— 最新一日
INSTITUTIONAL = {
    "date":     "2026-06-11",       # 最新確認資料日（6/11 Thu 實際；6/12 官方數據待公布）
    "foreign":  -4904,              # 外資 6/11 實際賣超 -4,904 張（賣壓自 6/10 -15,543 大幅收斂、來源 wantgoo）
    "trust":    +600,               # 投信 6/11 實際轉買 +600 張
    "dealer":   +340,               # 自營商 6/11 實際轉買 +340 張
    # 近5日（由舊到新：6/5, 6/8, 6/9, 6/10, 6/11）；6/9-6/11 為實際數據、6/5/6/8 為估算
    "foreign_5d": [-2500, -18500, -15008, -15543, -4904],   # 外資 6/9-6/11 連 3 日實際賣超、6/11 賣壓大幅收斂
    "trust_5d":   [-200, -1500, +2661, -3, +600],            # 投信 6/9 +2,661、6/10 -3、6/11 +600（實際）
    "dealer_5d":  [-200, -800, -1031, -826, +340],           # 自營 6/11 轉買 +340（實際）
    "foreign_ownership_pct": "74.8%",  # 外資持股比例（連 3 日賣超後估略降至 74.8%）
    "foreign_ownership_shares": "約 194.0 億股",
}

# 技術分析指標（需每日從看盤軟體更新）
TECHNICAL = {
    "rsi_14":       51.0,   "rsi_signal": "RSI 估自 47 回升至 51（NYSE TSM 6/11 +3.20%、台股 6/12 預期跟進），重回中軸上方、動能轉正",
    "macd":         -0.05,  "macd_signal": "MACD 估自 -0.15 收斂至 -0.05、綠柱大幅縮短、逼近零軸；若 6/12 收紅可望確認金叉翻多",   "macd_color": "#F44336",
    "kdj_k":        52.0,   "kdj_d": 45.0, "kdj_j": 62.0, "kdj_signal": "KDJ K(52)/D(45)/J(62) J 自 46 續升至 62、低檔黃金交叉確認、動能轉強；隨 ADR 反彈站回中軸上方",
    "ma5":       "2,295",   # 5MA（6/8 2305, 6/9 2305, 6/10 2255, 6/11 2250, 6/12est 2300）— 基於 6/12 盤中估
    "ma20":      "2,315",   # 20MA 轉壓力
    "ma60":      "2,300",   # 60MA 上揚但收斂
    "ma120":     "2,175",
    "bb_upper":  "2,445",   # 布林上軌
    "bb_mid":    "2,315",   # 布林中軌（20MA）
    "bb_lower":  "2,185",   # 布林下軌
    "vol_ma5":  "40,000",   # 5日均量（張，估、基於 6/8-6/12 五日均）
    "trend":    "✅ 6/12 Fri 跟進 ADR 反彈：NYSE TSM 6/11 強勢反彈 +3.20% 收 $421.07（+$12.32 vs 6/10 $408.75）消化 6/10 -4.48% sell-the-news 賣壓、record-revenue 基本面（5 月營收 NT$4,169.75 億、+30.1% YoY）獲市場重新確認；台股 2330 6/11 收 NT$2,250（持平）、6/12 預期跟進反彈、盤中估 ~NT$2,300（+2.22%）、市值回升 NT$59.6 兆。⚠️ 籌碼面警訊：真實數據外資 6/9-6/11 連 3 日賣超（-15,008 / -15,543 / -4,904 張），惟 6/11 賣壓大幅收斂、投信與自營轉買，外資能否轉買為次階段關鍵。📊 技術面（基於 6/12 盤中估 NT$2,300）：RSI 51 重回中軸上方、MACD -0.05 綠柱大幅縮短逼近零軸、KDJ J(62) 低檔金叉確認動能轉強、短期 5MA NT$2,295 翻為支撐、中期 60MA/120MA 仍多頭。下一觀察：（1）✅ 能否跟進 ADR 站回 NT$2,295 / 5MA 並挑戰 NT$2,305；（2）下方支撐 NT$2,250 / NT$2,200 心理整數 / NT$2,165（120MA）；（3）上方壓力 NT$2,295 / NT$2,305 / NT$2,365 / NT$2,400 整數；（4）⭐ 中長線結構性利多基底未變：CFO 確認 3nm H2 漲 ~15% + CEO Wei 重申供應數年落後需求 + 2026 >30% 成長 + 2nm 量產 70-80% 良率；（5）🏆 PwC 報告 TSMC 市值躋身全球第 9；（6）⚠️ 競爭雜訊：Google 向 Intel Foundry 下單逾 300 萬顆 TPU。",
    "support":  "2,250 / 2,200 / 2,165 / 2,155 (6/11 收、心理整數、120MA、心理整數)",
    "resist":   "2,295 / 2,305 / 2,365 / 2,400 / 2,440 (5MA、反彈關卡、前高、整數、6/3 史高)",
    "note": "技術指標數值為估算（基於 6/12 盤中估 NT$2,300），請以看盤軟體即時數據為準；NYSE TSM 6/11 反彈 +3.20% 帶動 6/12 台股預期跟進、KDJ J 自 46 續升至 62 低檔金叉確認、MACD 綠柱大幅縮短逼近零軸；NT$2,250 為關鍵支撐、6/12 站回 NT$2,295 / 5MA 確認反彈",
}

# 期貨與選擇權（來源：台灣期交所 TAIFEX）
DERIVATIVES = {
    "date":          "2026-06-12",       # 最新資料日（6/12 Fri 盤中估）
    "futures_price": "2,300",            # 台積電期貨近月（6/12 盤中估附近）
    "futures_oi":    "165,000",          # 未平倉量（口）（6/12 估、反彈增倉）
    "futures_basis": "+2",               # 6/12 估逆價差轉正價差（跟進 ADR 反彈、避險情緒緩和）
    "call_oi":       "98,500",
    "put_oi":        "80,000",
    "pcr":           "0.81",             # Put/Call 比率（6/12 估自 0.88 回落至 0.81、空方避險續縮手）
    "pcr_signal":    "偏多（Put/Call 6/12 估回落至 0.81、自 6/11 0.88 續減；反映跟進 ADR 反彈後避險買盤縮手、市場情緒轉樂觀）",
    "max_pain":      "2,300",            # 最大痛苦價格（近期到期、6/12 估）
    "key_strikes": [
        ("2,150", "Call 22,500 / Put 30,500", "深支撐"),
        ("2,200", "Call 28,500 / Put 27,500", "心理整數關鍵支撐"),
        ("2,250", "Call 35,500 / Put 18,500", "6/10 低、心理整數"),
        ("2,255", "Call 38,000 / Put 16,800", "6/10 收"),
        ("2,295", "Call 50,500 / Put 12,200", "反彈關卡"),
        ("2,300", "Call 53,000 / Put 10,500", "最大痛苦 / 心理整數"),
        ("2,305", "Call 54,500 / Put 9,800",  "6/9 收"),
        ("2,365", "Call 58,000 / Put 7,200",  "6/5 收、反彈關卡"),
        ("2,400", "Call 52,500 / Put 6,800",  "心理整數"),
        ("2,440", "Call 45,500 / Put 5,200",  "6/3 史高"),
    ],
    "note": "衍生品數據需每日至台灣期交所(taifex.com.tw)更新；6/12 PCR 自 0.88 回落至 0.81 反映跟進 ADR 反彈後避險買盤續縮手、逆價差自 -4 轉正價差 +2、最大痛苦價維持 NT$2,300；NT$2,250 為關鍵支撐、6/12 站回 NT$2,295 確認反彈；中長線結構性利多基底未變（CFO 確認 3nm H2 漲 ~15%、CEO Wei 重申供應數年落後需求、2nm 量產 70-80% 良率、Intel CEO 確認長期夥伴、NVIDIA-TSMC AI 合作、4 大 CSP CapEx $725B、PwC 報告 TSMC 全球市值排名躍升至第 9）",
}

# 供應鏈與客戶股價（需每日更新）
ECOSYSTEM_STOCKS = [
    # 類別、股票代碼、名稱、收盤價、漲跌幅、備註（美股為 2026-06-11 收盤反彈、台股為 6/12 盤中估跟進；價格為估算）
    ("設備", "ASML",    "艾司摩爾",    "822.00", "+1.73%", "EUV 設備龍頭（6/11 跟進半導體反彈；6/10 年會 Musk 出席談 SpaceX/Tesla $55B 德州 Terafab 計畫）"),
    ("設備", "AMAT",    "應用材料",    "494.50", "+1.64%", "⭐ 6/11 反彈；Q2 財季營收創高、上修 2026 設備業務成長 >30%；TSMC EPIC Center $5B AI 合作續存"),
    ("設備", "LRCX",    "科林研發",    "990.00", "+1.54%", "蝕刻設備（6/11 反彈；半導體設備需求 $36.55B 創紀錄）"),
    ("設備", "KLAC",    "科磊",        "745.00", "+1.64%", "量測設備（6/11 反彈；2nm 量產驅動）"),
    ("記憶", "000660.KS","SK 海力士",  "369,000 KRW", "+0.82%", "HBM4 供應（AI 記憶體需求結構性多頭）"),
    ("記憶", "MU",      "美光",        "145.00", "+1.90%", "HBM / DDR5（6/11 反彈 +1.90%）"),
    ("封裝", "3711.TW", "日月光",      "298",    "+1.71%", "CoWoS 封裝（6/12 盤中估跟進台股 2330 反彈）"),
    ("客戶", "NVDA",    "輝達",        "248.50", "+2.18%", "🏆 #1 客戶 22%（6/11 反彈 +2.18%；NVIDIA-TSMC AI 製程合作、RTX Spark 由 TSMC 代工、結構性需求未變）"),
    ("客戶", "AAPL",    "蘋果",        "291.50", "+0.87%", "⚠️ #2 客戶 18%（6/11 小漲；Apple 將跳過 A16 直上 A14 製程）"),
    ("客戶", "AVGO",    "博通",        "451.00", "+1.58%", "🔄 #3 客戶 13%（6/11 反彈；Hock Tan 確認「custom AI chips only」策略、2027 AI 指引 >$100B 不變）"),
    ("客戶", "AMD",     "超微",        "493.00", "+1.65%", "#4 客戶 8%（6/11 反彈 +1.65%、YTD +130%；MI400 資料中心 GPU 持續搶市）"),
    ("客戶", "2454.TW", "聯發科",      "4,505",  "+1.24%", "手機 SoC 客戶 9%；6/12 盤中估跟進台股半導體類股反彈；RTX Spark 由聯發科協同 NVIDIA 設計"),
    ("競爭", "INTC",    "英特爾",      "41.20",  "+11.05%", "🚀 6/8 大漲逾 11%：Google 下單逾 300 萬顆自研 TPU 予 Intel Foundry（2028 交付）；Intel CEO 6/2 仍確認 TSMC「長期信任夥伴」"),
    ("競爭", "005930.KS","三星電子",   "62,400 KRW", "+0.97%", "Samsung Foundry 6/11 小漲；HBM4E NVIDIA 送樣中"),
    ("處分後", "ARM",   "Arm Holdings","244.00", "+2.09%", "TSMC 4/29 全數出脫後（6/11 反彈；RTX Spark ARM 架構受惠）"),
]
...
CONSENSUS = {
    ...
    "upside":       "+10.00%",   # 從 NT$2,300（6/12 盤中估）到 NT$2,530
}
...
IR_CALENDAR = [
    ...
    ("2026-06-12", "📈 台股預期跟進 ADR 反彈、盤中估 NT$2,300（+2.22%）；外資能否止賣轉買為關鍵","6/12 Fri 台股 2330 跟進 NYSE TSM 6/11 +3.20% 反彈訊號、盤中估開高至 ~NT$2,300（+50，+2.22% vs 6/11 NT$2,250）、市值回升 NT$59.6 兆（官方收盤待確認）；催化：NYSE TSM 6/11 強勢反彈消化 sell-the-news + record-revenue 基本面確認 + CFO 確認先進製程漲價；⚠️ 觀察重點：（1）外資連 3 日賣超後能否止賣轉買；（2）競爭雜訊 Google 向 Intel Foundry 下單逾 300 萬顆自研 TPU（2028 交付）、Intel 6/8 大漲逾 11%；技術面 RSI 估自 47 回升至 51 重回中軸上方、KDJ J 自 46 續升至 62 低檔金叉確認、MACD 綠柱大幅縮短逼近零軸；下方支撐 NT$2,250 / NT$2,200、上方壓力 NT$2,295 / NT$2,305","#FFF9C4"),
...
NEWS = [
    {
        ...
        "title": "🏆 NYSE TSM 6/11 強勢反彈 +3.20% 收 $421.07，消化 6/10 -4.48% sell-the-news 賣壓；record-revenue 基本面獲市場重新確認",
        "body": "TSMC ADR 在 5 月營收創高後的「sell-the-news」回檔隔日強勁反彈：（1）🏆 NYSE TSM 6/11 Thu 收 $421.07（+$12.32、+3.20% vs 6/10 $408.75，來源 stockanalysis.com）、成交量約 1,276 萬股；（2）✅ 反彈消化 6/10 -4.48% sell-the-news 拋售（6/10 收 $408.75、-$19.14）、市場重新確認 record-revenue 基本面——5 月合併月營收 NT$4,169.75 億（US$13.17B）、年增 +30.1%、月增 +1.5%、創史上單月新高；1-5 月累計 NT$1.96 兆、年增 +30%；（3）📈 台股 2330 6/11 收 NT$2,250（持平）、6/12 預期跟進 ADR 反彈、盤中估 ~NT$2,300（+2.22%）、市值回升 NT$59.6 兆；（4）⚠️ 籌碼面警訊：真實數據顯示外資 6/9-6/11 連 3 日賣超（-15,008 / -15,543 / -4,904 張、累計逾 -3.5 萬張），惟 6/11 賣壓自 -15,543 大幅收斂至 -4,904、投信轉買 +600、自營轉買 +340，拋售動能趨緩；（5）📊 台美 ADR 溢價（以 6/11 ADR + 6/12 台股盤中估計）為 +13.69%；（6）🎯 後續關鍵：台股能否跟進 ADR 反彈站回 NT$2,295 / 5MA、外資是否止賣轉買；下一里程碑：6 月營收 7 月上旬公布、Q2 2026 法說會 7/16。",
        "source": "stockanalysis.com / Yahoo Finance / cnyes 鉅亨 / wantgoo 玩股網 2026-06-11 - 06-12", "impact": "正面",
    },
    {
    ...
    {
        "tag": "客戶動態", "tag_color": "#2196F3",
        "title": "🚀 NVIDIA RTX Spark 超晶片秋季登場（Dell/Lenovo）、TSMC 代工；AMD 宣布逾 $10B 台灣投資擴大封裝生態",
        "body": "Computex 2026 後 AI PC 與供應鏈動能延續、TSMC 為核心受惠者：（1）🚀 NVIDIA RTX Spark「超晶片」結合最高 20 核 CPU + Blackwell 世代 GPU（6,144 核）、共享記憶體、AI 與高階遊戲兼顧、秋季於 Dell、Lenovo 等品牌筆電/桌機登場；（2）⭐ 由 TSMC 先進製程 + CoWoS 封裝代工、為新增量訂單；（3）NVIDIA FY2026 營收達 $215.9B（+65% YoY）、確認 AI 晶片需求極強；（4）⭐ AMD 宣布逾 $100 億美元台灣投資、聚焦先進封裝與生態系擴張、嘉惠日月光、力成、欣興等台廠；AMD 亦傳開發 ARM 架構 PC 晶片；（5）市場反應：RTX Spark 推升 ARM、Qualcomm（agentic AI PC 期待）；（6）⭐ 對 TSMC 意涵：無論 x86（Intel/AMD）或 ARM（NVIDIA/Qualcomm/Apple）陣營勝出、先進製程晶片皆由 TSMC 代工、TSMC 為「賣鏟者」最大贏家；（7）AI 算力需求自資料中心擴散至終端裝置（PC/手機/機器人）、帶動 N3/N2 製程需求。",
        "source": "CNBC / Spokesman / TradingKey / Computex 2026 2026-06-01 - 06-11", "impact": "正面",
    },
]
