...
SUMMARY = {
    ...
    "bottom_line": '報告日期：2026-08-12 Wed（最新確認收盤：台股 2330 8/11 Tue 官方收 NT$2,395（+15、+0.63% vs 8/10 NT$2,380、開 2,390／高 2,405／低 2,375、量 18,248 張、額 NT$436.67 億、50,065 筆、TWSE 確認）；NYSE TSM 8/11 收 $422.06（+0.86%、創本波收盤新高、Yahoo API 確認）；8/11 排程未執行、本日報一併補記 8/10 行情）。📊 核心判讀：基本面雙重利多落地、價格結構轉強、惟量能與 CPI 是兩大檢核點——（1）⭐ 7 月營收 NT$4,675.81 億（+44.69% YoY、+5.62% MoM）連 3 月創高、優於投顧預期 4,500 億：1-7 月累計 2.87 兆（+37.0%）、Q3 指引達成無虞——8/10 盤後公布、8/11 的 +0.63% 已部分反映；（2）⭐ 8/11 董事會：Q2 配息 NT$7.0（12/10 除息、首推外資美元領息）、資本預算 US$294.4 億延續擴產節奏、Sony 熊本合資（7,470 億日圓、台積電 2,820 億日圓、2029 量產次世代影像感測器）——特殊製程佈局補強、股利政策穩定；（3）📊 價格結構轉強：連 2 紅收 2,395、收復 2,390 且站上全部均線（5MA 2,383 上彎／20MA 2,358／60MA 2,364／120MA 2,183）、大盤續創 8 月反彈新高 45,120.72；⚠️ 量能連 5 日萎縮至 18,248 張（5 日均量的 72%、近月新低）——8/10 大盤大漲 702 點時 2330 僅 +0.42%（資金衝記憶體／封裝補漲）、8/11 相對轉強但無量，突破 2,400-2,410 壓力區需量能回升確認；（4）✅ 籌碼結構明確翻多：外資連 3 買且 8/11 加碼至 +3,498 張、投信連 3 買、三大合計 +3,691 張；全市場外資 8/10 +517.4 億大買、8/11 +223.3 億續買——與 8/7 前的調節完全反轉；（5）📊 美股節奏：8/10 半導體回檔（SOX -2.94%、油價通膨疑慮＋AI 資本支出雜訊）、8/11 反彈（SOX +0.87%、FT 報導 NVIDIA 攜華爾街大行籌 $5,000 億 AI 基建資金）；TSM +0.86% 收 $422.06 創本波收盤新高且逆大盤（S&P -0.32%）——ADR 溢價收斂至 +13.56%、以台股補漲方式進行中；（6）✅ 韓股今晨大漲（三星 +3.55%、SK +2.32%、KOSPI +2.06%）——記憶體行情重啟、半導體風險偏好回暖。💡 技術面：RSI 52.5 中軸上方續升、⭐ MACD 柱 +12.9 連 5 日擴張（+0.5→+3.7→+6.3→+9.6→+12.9）且 DIF -1.7 逼近零軸——上穿零軸將為中期修復的關鍵確認；KDJ 金叉延續（K 79.3／D 70.9）惟 J 96.1 偏高、短線過熱；支撐 2,390／2,383（5MA）／2,375（8/11 低）／2,364（60MA）／2,358（20MA）／2,320、壓力 2,400（整數）／2,405（8/11 高）／2,410（8/10 高）／2,425（7/31 漲停）／2,497（布林上軌）／2,535（史高）。⭐ 今日（8/12 Wed）觀察：（1）2,400-2,410 攻防與量能——放量突破則上看 2,425、無量則提防回測 2,383-2,375 支撐帶；（2）韓股大漲＋美股半導體反彈的外溢效應；（3）📅 今晚美國 7 月 CPI——若超預期恐引發獲利了結、低於預期則降息預期升溫；（4）外資加碼延續性（連 4 買將確立中期翻多）。⚠️ 風險：量能近月新低的無量緩漲結構、KDJ J 96.1 過熱、CPI 變數、AI 資本支出持續性雜訊（8/10 美股回檔主因）、232 條款懸而未決。',

    "risk_alert":  '今日（8/12 Wed）關鍵觀察：（1）⭐ 2,400 整數與 2,405-2,410 壓力區攻防：7 月營收大超預期＋董事會利多＋TSM ADR 創本波收盤新高（$422.06、溢價 +13.56%）＋韓股今晨大漲——開高機率高；⚠️ 但量能連 5 日萎縮至 18,248 張（5 日均量 25,296 的 72%、近月新低），無量突破持續性存疑、今日能否終結連 5 縮為第一檢核點；（2）📅 美國 7 月 CPI 今晚（美東 8/12）公布——短線最大宏觀變數：8/10 美股回檔即因油價上漲引發通膨疑慮（SOX -2.94%、NVDA -2.86%），若 CPI 超預期、今晚美股回檔將壓抑明日台股；（3）✅ 外資連 3 買且加碼（+642→+119→+3,498 張）——連 4 買將確立中期翻多；全市場外資 2 日 +740.7 億回流，延續性為中期關鍵；（4）✅ 記憶體行情重啟：韓股今晨三星 +3.55%、SK +2.32%；台股華邦電 8/10 +9.79%（外資 2 日回補 +56,916 張）——半導體情緒回暖、惟留意資金分流效應（8/10 大盤 +1.59% 時 2330 僅 +0.42% 即為資金衝記憶體所致）；（5）💱 匯率 32.22 持平；232 條款半導體專章結果仍未公布（未能證實）——尾部風險；AI 資本支出持續性雜訊反覆（FT 報導 NVIDIA 籌 $5,000 億 AI 基建資金暫時緩解）；（6）⚠️ 中期：KDJ J 96.1 偏高短線過熱；SOX 自 6/22 史高 14,634.66 仍 -17.3%；2330 自 6/23 史高 2,535 仍 -5.5%——中期反彈確認仍需量能配合、MACD DIF 上穿零軸為下一關鍵訊號。',
}
...
TECHNICAL = {
    ...
    "macd":         12.9,   "macd_signal": 'MACD 黃金交叉續強（DIF -1.7 逼近零軸、DEA -8.2、柱狀圖 +12.9、官方收盤計算）——⭐ 紅柱連 5 日擴張（+0.5→+3.7→+6.3→+9.6→+12.9）、中期動能持續修復；DIF -1.7 距零軸僅一步之遙、上穿零軸將為中期修復的關鍵確認訊號',   "macd_color": "#4CAF50",
    "kdj_k":        79.3,   "kdj_d": 70.9, "kdj_j": 96.1, "kdj_signal": 'KDJ K(79.3)/D(70.9)/J(96.1)（官方收盤計算）——金叉延續、K 與 D 同步走高進入高檔區；⚠️ J 值 96.1 偏高（自 91.7 續升）、短線過熱未消化，無量追高需留意回檔風險',
    "ma5":       "2,383",
    "ma10":      "2,344",
    "ma20":      "2,358",
    "ma60":      "2,364",
    ...
    "bb_lower":  "2,218",
    "vol_ma5":  "25,296",
    "trend":    '📊 連 2 紅收復 2,390、無量緩攻逼近 2,400：2330 8/11 官方收 NT$2,395（+15、+0.63%、開 2,390／高 2,405／低 2,375、量 18,248 張僅 5 日均量 25,296 張的 72%、近月新低）——連 2 日收高（8/10 +0.42% 收 2,380）、站上全部均線且 5MA 2,383 上彎；大盤 +0.43% 收 45,120.72 續創 8 月反彈新高、2330 相對強勢（8/10 大盤 +1.59% 時 2330 僅 +0.42% 補漲落後、8/11 反轉為相對強）。⭐ 技術指標（官方收盤計算）多頭訊號續強：MACD 黃金交叉——DIF -1.7 逼近零軸、DEA -8.2、柱狀圖 +12.9 連 5 日擴張（+0.5→+3.7→+6.3→+9.6→+12.9）；RSI 52.5 中軸上方續升、KDJ 金叉延續（K 79.3／D 70.9）惟 J 96.1 偏高。✅ 籌碼續翻多：外資連 3 買且加碼（+642→+119→+3,498 張）、投信連 3 買（+61→+153→+382）、三大 8/11 合計 +3,691 張；全市場 BFI82U 8/10 +736.1 億（外資 +517.4 億大買）、8/11 +280.1 億——資金全面回流。⭐ 基本面雙重利多：7 月營收 4,675.81 億（+44.69% YoY）連 3 月創高＋8/11 董事會（配息 7 元／US$294.4 億資本預算／Sony 合資）。📊 外部：美股 8/10 回檔 8/11 反彈（SOX +0.87% 收 12,098.47、設備股領漲）、TSM +0.86% 收 $422.06 創本波收盤新高——ADR 溢價收斂至 +13.56%；韓股今晨大漲（三星 +3.55%、SK +2.32%）。下一觀察：（1）2,400 整數與 2,405-2,410 壓力區攻防——放量突破則上看 2,425／2,497（布林上軌）、量能能否終結連 5 縮為關鍵；（2）無量衝高則提防回測 2,390／2,383（5MA）／2,375 支撐帶；（3）📅 今晚美國 7 月 CPI 為短線最大宏觀變數；（4）MACD DIF 上穿零軸為中期修復的下一確認。',
    "support":  "2,390 / 2,383 / 2,375 / 2,364 / 2,358 / 2,320 (連 3 日開盤區、5MA、8/11 低、60MA 季線、20MA、8/4 收)",
    "resist":   "2,400 / 2,405 / 2,410 / 2,425 / 2,497 / 2,535 (整數關卡、8/11 高、8/10 高、7/31 漲停、布林上軌、6/23 史高)",
    "note": '均線與 RSI/MACD/KDJ/布林均依官方收盤價計算（2026-08-11 止），請以看盤軟體為準；8/11 收 NT$2,395（+0.63%）連 2 紅、站上全部均線（5MA 2,383 上彎／20MA 2,358／60MA 2,364／120MA 2,183）；RSI 52.5 續升、MACD 黃金交叉續強（DIF -1.7 逼近零軸／DEA -8.2、柱 +12.9 連 5 日擴張）、KDJ 金叉延續（K79.3/D70.9/J96.1 偏高）；支撐 2,390 / 2,383 / 2,375 / 2,364 / 2,358 / 2,320、壓力 2,400 / 2,405 / 2,410 / 2,425 / 2,497 / 2,535；⭐ 7 月營收大超預期＋董事會利多＋外資連 3 買加碼＋MACD 柱連 5 日擴張 vs ⚠️ 量能連 5 縮近月新低（18,248 張、72% 均量）＋J 值 96.1 偏高＋今晚美國 CPI——今日檢核點為「量能能否終結連 5 縮、放量突破 2,400-2,410」',
}
...
DERIVATIVES = {
    ...
    "put_oi":        "113,000",
    "pcr":           "0.91",
    "pcr_signal":    '中性偏多（Put/Call 估 0.91；8/11 現貨連 2 紅收復 2,390、外資連 3 買且加碼，下檔賣權佈局回升；7 月營收大超預期＋董事會配息利多——上檔 2,400-2,410 買權佈局為觀察點；期權數據以估算標註、請以 TAIFEX 為準）',
    "max_pain":      "2,400",
    "key_strikes": [
        ("2,320", "Call 33,000 / Put 14,000", "8/4 收、下檔支撐"),
        ("2,358", "Call 35,000 / Put 13,000", "20MA"),
        ("2,364", "Call 36,000 / Put 13,000", "60MA 季線"),
        ("2,375", "Call 37,000 / Put 12,000", "8/11 盤中低"),
        ("2,383", "Call 38,000 / Put 12,000", "5MA"),
        ("2,400", "Call 45,000 / Put 15,000", "整數關卡、估最大痛苦"),
        ("2,405", "Call 42,000 / Put 11,000", "8/11 盤中高"),
        ("2,410", "Call 41,000 / Put 10,000", "8/10 盤中高"),
        ("2,425", "Call 39,000 / Put 9,000",  "7/31 漲停收盤"),
        ("2,535", "Call 30,000 / Put 5,000",  "6/23 史高、終極反壓"),
    ],
    "note": '衍生品數據為估算、需每日至台灣期交所(taifex.com.tw)核實；價位錨點按 TWSE 官方收盤（8/11 收 NT$2,395）；估最大痛苦 2,400、下方支撐 2,390（連 3 日開盤區）/ 2,383（5MA）/ 2,375（8/11 低）/ 2,364（60MA）/ 2,358（20MA）/ 2,320（8/4 收）、上方壓力 2,400（整數）/ 2,405（8/11 高）/ 2,410（8/10 高）/ 2,425（7/31 漲停）/ 2,497（布林上軌）/ 2,535（史高）；⭐ 7 月營收 4,675.81 億大超預期＋董事會配息 7 元／Sony 合資＋外資連 3 買加碼＋MACD 柱連 5 日擴張＋TSM ADR 創本波收盤新高（溢價 +13.56%） vs ⚠️ 量能連 5 縮近月新低（18,248 張、72% 均量）＋J 值 96.1 偏高＋今晚美國 7 月 CPI；✅ 基本面錨未變（2nm Q3 放量＋報價漲 10-20%、CoWoS 訂滿至 2027、全年上修 >40%）',
}
