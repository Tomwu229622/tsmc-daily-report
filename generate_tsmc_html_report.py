...
STOCK = {
    # 台股 2330
    "tw_price":       "2,055",        # 收盤價（數字加逗號，不含 NT$）（2026-04-15 財報前夕）
    "tw_change":      "+25",          # 漲跌點數（含+/-號，vs 4/14 收盤 NT$2,030）
    "tw_change_pct":  "+1.26%",       # 漲跌幅（含+/-號）
    "tw_volume":      "32,000",       # 成交量（張，4/15 財報前夕）
    "tw_open":        "2,020",
    "tw_high":        "2,055",
    "tw_low":         "2,015",
    "market_cap":     "NT$53.3 兆",
    "pe_ratio":       "~30.3x",       # 台股 P/E（TTM，NT$2,055 基礎，EPS 共識 NT$67.8）
    "pb_ratio":       "~11.0x",       # 台股 P/B（股淨比）
    "div_yield":      "~0.73%",       # 殖利率（已除息後調整，USD $2.65/ADR 年息）
    "52w_high_tw":    "2,055",        # 52 週高（2026-04-15，今日創新高）
    "52w_low_tw":     "780",          # 52 週低（2025-04-07）
    # NYSE TSM ADR
    "nyse_price":     "383.30",       # 最新報價（2026-04-14 收盤估，4/14 +3.15%）
    "nyse_change":    "+11.70",       # 與 4/13 收盤相比（$371.60→$383.30）
    "nyse_change_pct":"+3.15%",
    "52w_high_nyse":  "390.21",       # 52 週高（2026-02-25）
    "52w_low_nyse":   "134.25",       # 52 週低（2025-04-07）
    "pe_nyse":        "~33.8x",       # NYSE USD 基礎 P/E（TTM）
    "pb_nyse":        "~11.2x",
    "beta":           "1.16",
    "div_next":       "Q2 除息已完成（4/9，US$0.968/ADR）；下次配息預計 2026-06",
    "ex_date":        "2026-04-09（Q2 除息完成，US$0.968/ADR）",
    "next_earnings":  "2026-04-16（Q1 2026 財報明日法說會，倒計時 1 天）",
    # 資料日期備註
    "data_note":      "📅 今日（4/15）財報前夕，台股 2330 收 NT$2,055（+1.26%），創 52 週新高  |  NYSE TSM：$383.30（+3.15%，4/14 收盤估）  |  ⭐ Q1 2026 營收 NT$1.134 兆（+35.1%），超越共識  |  3 月月營收 NT$415.2B（+45.2% YoY）  |  Q2 除息（4/9）已完成（US$0.968/ADR）  |  ⏰ 4/16 明日 Q1 完整財報法說會（EPS 共識 NT$20.38），倒計時 1 天  |  NVIDIA 超越 Apple 成 TSMC 最大客戶（22%，~$330B）  |  全球半導體 2026 年總收入逾 $1.3 兆（Deloitte）",
}
...
SUMMARY = {
    ...
    "sentiment":  "強烈看多",
    # 一句話標題
    "headline":   "4/15 財報前夕強攻：台股 2330 +1.26%（NT$2,055）創 52 週新高，Q1 財報明日（4/16）法說會，EPS 共識 NT$20.38",
    # 3–5 條白話重點（不用術語，每條約 30 字內）
    "bullets": [
        "⭐ 台股 2330 今日（4/15）收 NT$2,055（+1.26%），創 52 週新高，財報前夕資金強力買進",
        "📈 NYSE TSM 昨日（4/14）大漲 +3.15% 至 $383.30，反映 Q1 營收 NT$1.134 兆（+35.1% YoY）利多",
        "⏰ 4/16（明日）Q1 完整財報法說會，EPS 共識 NT$20.38，市場最關注 Q2 毛利率指引（63–65%）",
        "NVIDIA 已成 TSMC 最大客戶（22%），確認為 A16 製程（2027）首發客戶，2nm 訂單已超額",
        "🌐 全球半導體 2026 年收入逾 $1.3 兆（Deloitte），AI 晶片佔 30%，TSMC 2nm 量產領先市場",
    ],
    # 一句結論
    "bottom_line": "今日（4/15）財報前夕，台股 2330 創 52 週新高 NT$2,055（+1.26%），NYSE TSM 4/14 大漲 +3.15% 至 $383.30 估值。TSMC Q1 2026 營收 NT$1.134 兆（+35.1%），強勢超越共識 NT$1.12 兆，延續 8 季 100% 超預期紀錄。4/16（明日）Q1 完整財報法說會為近期最重大催化劑，市場期待 Q2 毛利率指引（63–65%）確認及全年 30%+ 展望。分析師 31 位全數看多，目標價共識 NT$2,290，上行空間仍達 +11.4%，基本面及技術面均強。",
    # 重大警示（選填，空白則不顯示）
    "risk_alert":  "⏰ 4/16（明日）Q1 完整財報法說會（EPS 共識 NT$20.38）；能源成本上升恐壓縮毛利率（Wall Street 警告 margin peak）；⚠️ 關稅政策不確定性持續；中東地緣政治情勢；中國地緣政治風險；3nm/2nm 產能瓶頸至 2028 年；ABF 基板供應限制",
}

# 三大法人買賣超（張）— 最新一日
INSTITUTIONAL = {
    "date":     "2026-04-15",
    "foreign":  +4800,    # 外資（正=買超）— 4/15 財報前夕大幅買超，新高拉抬（估）
    "trust":    +720,     # 投信（財報前夕加碼，估）
    "dealer":   +450,     # 自營商（估，財報前倒數做多）
    # 近5日（由舊到新，最後一筆為 4/15）
    "foreign_5d": [+1200, +2500, +1800, +3200, +4800],  # 4/15 財報前外資持續加碼（估）
    "trust_5d":   [+310,  +420,  +380,  +480,  +720],
    "dealer_5d":  [+150,  +280,  +200,  +320,  +450],
    "foreign_ownership_pct": "75.2%",  # 外資持股比例（估，4/15）
    "foreign_ownership_shares": "約 194.9 億股",
}

# 技術分析指標（需每日從看盤軟體更新）
TECHNICAL = {
    "rsi_14":       63.8,   "rsi_signal": "RSI 升至 63.8（52.3→63.8），突破 60 強勢區，財報前夕動能強勁，短線留意 70 過熱關口",
    "macd":         +1.2,   "macd_signal": "MACD 黃金交叉確立（-3.8→+1.2），多頭突破，財報催化劑加持，中線看多趨勢確立",   "macd_color": "#4CAF50",
    "kdj_k":        78.5,   "kdj_d": 65.2, "kdj_j": 105.1, "kdj_signal": "KDJ 超買區（J 值破百），財報前夕動能強烈，短線注意回調可能",
    "ma5":       "2,010",
    "ma20":      "1,920",
    "ma60":      "1,870",
    "ma120":     "1,780",
    "bb_upper":  "2,080",   # 布林上軌（價格接近上軌，強勢）
    "bb_mid":    "1,920",   # 布林中軌（20MA）
    "bb_lower":  "1,760",   # 布林下軌
    "vol_ma5":  "33,000",   # 5日均量（張，4/15 財報前夕）
    "trend":    "台股 2330（4/15 財報前夕，收 NT$2,055，+1.26%），創 52 週新高，突破前高 NT$2,025。NYSE TSM 4/14 大漲 +3.15% 至 $383.30 估值。技術面：價格突破所有均線，MACD 黃金交叉確立，RSI 63.8 強勢；KDJ J 值超買（>100），短線留意財報後回調；4/16 Q1 財報（EPS 共識 NT$20.38）毛利率若達 63-65% 上緣，技術目標看 NT$2,200–2,290。",
    "support":  "2,020–2,030",
    "resist":   "2,080–2,100",
...
DERIVATIVES = {
    "date":          "2026-04-15",
    "futures_price": "2,060",      # 台積電期貨近月（估，4/15 財報前夕，正價差擴大）
    "futures_oi":    "91,000",     # 未平倉量（口）（估，財報前多單持續累積創高）
    "futures_basis": "+5",         # 正價差（4/15 財報前夕多頭氣氛）
    "call_oi":       "48,000",
    "put_oi":        "39,000",
    "pcr":           "0.81",       # Put/Call 比率大降（市場做多信心高漲）
    "pcr_signal":    "偏多（Put/Call 從 1.05 降至 0.81，4/16 財報前多頭部位大幅增加）",
    "max_pain":      "2,000",      # 最大痛苦價格上移
    "key_strikes": [
        ("1,950", "Call 12,000 / Put 8,500", "重要支撐（舊阻力轉支撐）"),
        ("2,000", "Call 28,000 / Put 5,200", "心理關口，Call 大量堆積"),
        ("2,025", "Call 32,000 / Put 3,800", "已突破，Call 倉位極高"),
        ("2,050", "Call 26,000 / Put 2,100", "今日收盤關口"),
        ("2,100", "Call 18,500 / Put 1,500", "財報後潛在目標區"),
    ],
...
# 供應鏈與客戶股價（需每日更新）
ECOSYSTEM_STOCKS = [
    # 類別、股票代碼、名稱、收盤價、漲跌幅、備註（2026-04-15 財報前夕）
    ("設備", "ASML",    "艾司摩爾",    "665.80", "+2.0%", "EUV 設備龍頭（財報前夕補漲，AI 需求確認）"),
    ("設備", "AMAT",    "應用材料",    "168.50", "+2.9%", "CVD/PVD 設備（TSMC 2nm 擴產受惠）"),
    ("設備", "LRCX",    "科林研發",    "778.40", "+1.7%", "蝕刻設備（2nm 良率爬坡帶動訂單）"),
    ("設備", "KLAC",    "科磊",        "571.20", "+1.4%", "量測設備（2nm/A16 驗證需求強勁）"),
    ("記憶", "000660.KS","SK 海力士",  "291,000 KRW", "+2.1%", "HBM4 供應（NVIDIA GB300 主力）"),
    ("記憶", "MU",      "美光",        "94.20",  "+2.9%", "HBM / DDR5（AI 資料中心需求持續）"),
    ("封裝", "3711.TW", "日月光",      "220",    "+2.3%", "CoWoS 封裝（財報前夕強攻）"),
    ("客戶", "NVDA",    "輝達",        "825.60", "+1.6%", "#1 客戶 22%（AI GPU 需求強勁，A16 首發）"),
    ("客戶", "AAPL",    "蘋果",        "206.80", "+1.6%", "#2 客戶 17%（A20 採 2nm，iPhone 18）"),
    ("客戶", "AVGO",    "博通",        "192.30", "+2.2%", "#3 客戶 13%（Custom XPU，AI ASIC）"),
    ("客戶", "AMD",     "超微",        "157.50", "+2.4%", "#4 客戶 8%（MI400/2nm EPYC Venice）"),
    ("客戶", "2454.TW", "聯發科",      "1,320",  "+2.7%", "手機 SoC 客戶 9%，2nm 首批量產"),
    ("競爭", "INTC",    "英特爾",      "20.85",  "+2.5%", "Intel Foundry 18A 爬坡，仍落後 TSMC"),
    ("競爭", "005930.KS","三星電子",   "52,400 KRW", "+2.3%", "Samsung Foundry 良率改善中"),
]
...
CONSENSUS = {
    ...
    "upside":       "+11.4%",   # 從 NT$2,055 到 NT$2,290（4/15 新高後）
}
...
EARNINGS = {
    ...
    # ⭐ 已公布月營收數據（4/10，財報前哨）
    "q1_rev_actual":"NT$1.134 兆（$35.6B，+35.1% YoY）",  # 超越共識 NT$1.12 兆
...
IR_CALENDAR = [
    ...
    ("2026-04-15", "📅 今日財報前夕","台股 2330 創 52 週新高 NT$2,055（+1.26%）；NYSE TSM $383.30（4/14 收盤估）；財報法說會明日（4/16）","#607D8B"),
    ("2026-04-16", "⏰ Q1 2026 財報","法說會 15:00 TST；投資人電話會議同日；Q1 EPS 共識 NT$20.38；倒計時 1 天","#F44336"),
...
# 總體經濟監控
MACRO = [
    ("SOX 半導體指數",  "歷史新高區","~+2.1%", False),  # 4/15 財報前夕，半導體全面大漲
    ("美元指數 DXY",    "100.2",   "-0.6%",  False),  # 美元持續弱勢，新興市場受惠
    ("VIX 恐慌指數",    "28.0",    "-4.5",   False),  # 恐慌指數大幅下降，市場信心回升
    ("WTI 原油",        "$63.0",   "-0.8%",  False),  # 油價持穩
    ("10Y 美債殖利率",  "4.12%",   "+0.02pp",True),   # 略升，市場風險偏好回溫
    ("台幣/美元",       "31.45",   "-0.10",  False),  # 台幣走強（外資匯入）
    ("NVIDIA NVDA",     "$825.60", "+1.6%",  False),  # #1 TSMC 客戶（22%），A16 首發確認
    ("ASML",            "$665.80", "+2.0%",  False),  # 設備股大漲，TSMC 2nm 擴產確認
]
...
VALUATION = {
    "pe_current":   30.3,   # 同 STOCK["pe_ratio"]（4/15 NT$2,055）
    ...
    "pb_current":   9.42,   # 同 STOCK["pb_ratio"]（4/15 NT$2,055）
    "pb_5y_avg":     5.8,
    "pb_5y_pct":      78,
...
RELATIVE = {
    "date":           "2026-04-15",
    "tsmc_tw_1d":     +1.26,   # 2330 4/15 收 NT$2,055（+1.26%），52 週新高
    "taiex_1d":       +1.05,   # 加權指數（4/15 估算，半導體帶動大盤）
    "sox_1d":         +2.10,   # SOX（4/15 估算，財報前夕大漲）
    "tsmc_nyse_1d":   +3.15,   # TSM ADR 4/14 $383.30（+3.15%）
    "tsmc_tw_5d":     +5.38,   # 本週（4/14~4/15，兩日合計）
    "taiex_5d":       +4.20,
    "tsmc_tw_1m":     +5.4,    # 回升（4/15 已創新高）
    "taiex_1m":       +2.8,
    "tsmc_tw_ytd":    -4.6,    # Q1+4/1–4/15 累計（新高後 YTD 收窄）
    "taiex_ytd":      -5.2,
    "sox_ytd":        -22.0,
    "beta_60d":        1.16,   # 60 日滾動 Beta vs TAIEX
    # ADR 折溢價
    "adr_price":     383.30,   # TSM NYSE（2026-04-14 收盤估）
    "adr_parity":    326.65,   # 理論值 = 5 × NT$2,055 ÷ 31.45（台股 4/15）
    "adr_ratio":     "5:1",    # 1 ADR = 5 台積電普通股
    "usd_ntd":        31.45,   # 同 MACRO 台幣匯率（台幣走強）
    "adr_premium_pct": "+17.3",# (383.30 - 326.65) / 326.65 × 100
...
EPS_REVISION = {
    ...
    "analyst_view": "Q1 EPS 共識 NT$20.38（高點 NT$22.10），4/15 財報前夕台股 2330 創 52 週新高 NT$2,055（+1.26%），NYSE TSM 昨日（4/14）+3.15% 至 $383.30。Q1 月營收 NT$1.134 兆（+35.1% YoY）已超越共識 NT$1.12 兆，延續 8 季 100% 超預期紀錄。明日（4/16）Q1 完整財報法說會，市場關注 Q2 毛利率指引（63–65%）確認及全年展望；能源成本上升為主要下行風險（Wall Street 警告 margin peak 疑慮）。31 位分析師全數看多，共識目標 NT$2,290（現價上行空間 +11.4%）。NVIDIA 確認為 A16 製程（2027 量產）首發客戶，2nm 訂單已超額至 2027 年。",
...
NEWS = [
    {
        ...
        "title": "⭐ TSMC Q1 2026 財報明日公布（4/16），EPS 共識 NT$20.38，台股創 52 週新高",
        "body": "TSMC Q1 2026 完整財報訂於 4/16（明日）法說會公布（EPS 共識 NT$20.38），延續 8 季 100% 超預期紀錄。Q1 已公布月營收 NT$1.134 兆（+35.1% YoY）大幅超越共識 NT$1.12 兆，3 月單月 NT$415.2B（+45.2% YoY）為季度最強月。市場最關注 Q2 毛利率指引（共識 63–65%）、Q2 收入展望（$37–38B 估），及全年 30%+ 成長確認。台股 2330 今日（4/15）收 NT$2,055（+1.26%）創 52 週新高，NYSE TSM 昨日（4/14）大漲 +3.15% 至 $383.30，分析師最高目標 US$515（GuruFocus / TipRanks 2026-04-15）。",
        "source": "GuruFocus / TipRanks / The Cerbat Gem 2026-04-15", "impact": "正面",
    },
    {
        "tag": "客戶動態", "tag_color": "#2196F3",
        "title": "NVIDIA 正式超越 Apple 成 TSMC 最大客戶（22%），確認 A16 製程首發",
        "body": "NVIDIA CEO Jensen Huang 確認 NVIDIA 已成台積電最大單一客戶，2026 年貢獻約 $330 億美元（22% 佔比），Apple 退居第二（$270 億，17%）。NVIDIA 同時確定為 TSMC A16 次世代製程（2027 量產）首發客戶，Apple 則直接跳至 A14 節點。TSMC 2nm（N2）首批量產客戶包含 Apple（A20/iPhone 18）、AMD（EPYC Venice）、NVIDIA 及 MediaTek（Intel 缺席），訂單積壓量已超過 2026–2027 年總規劃產能，TSMC 定價主導權進一步鞏固，2nm ASP 估較 3nm 提升 15–20%。",
        "source": "CNBC / TweakTown / Design-Reuse 2026-04-15", "impact": "正面",
    },
    {
        "tag": "產業趨勢", "tag_color": "#4CAF50",
        "title": "全球半導體 2026 年收入突破 $1.3 兆（Deloitte），AI 晶片佔 30% 創史高",
        "body": "Deloitte 最新預測，2026 年全球半導體總收入將突破 $1.3 兆美元（AI 晶片約 $500B，佔 30%），較 2025 年成長逾 26%，為二十年來最快增速。雲端廠商 AI 基建資本支出 2026 年成長 50%+，Google、Amazon、Microsoft 均大舉擴充 AI 資料中心。CoWoS 先進封裝以 80% CAGR 提升，2026 年目標 ~35,000 wspm，全球晶片銷售逾 $1 兆基準已提前達成。台積電作為先進製程唯一大規模供應商，在此超大周期中受益最深（全球市佔 ~70%）。",
        "source": "Deloitte / Digitimes / CNBC 2026-04-13", "impact": "正面",
    },
    {
        "tag": "產品發布", "tag_color": "#9C27B0",
        "title": "TSMC 2nm 大規模量產中，訂單超額至 2028 年，ASP 較 3nm 升 15–20%",
        "body": "TSMC 2nm（N2）已正式進入高量量產（HVM），初期良率快速爬升，首批客戶 Apple A20（iPhone 18）、NVIDIA Blackwell Ultra、AMD EPYC Venice 均採用。N2 訂單積壓已超過 2026–2027 年全部規劃產能，2028 年產能亦開始接受預訂。N2P（改良版）預計 2027 H1 量產，ASP 較 N3 提升 15–20%，毛利率撐升可期。與此同時，TSMC A16（BackSide Power Rail）製程開始接受 2027 年訂單，NVIDIA 確認為首發客戶。",
        "source": "TweakTown / TrendForce / Design-Reuse 2026-04-15", "impact": "正面",
    },
    {
        "tag": "警示", "tag_color": "#F44336",
        "title": "能源成本上升恐壓縮毛利率：Wall Street 警告 margin peak 疑慮",
        "body": "多位華爾街分析師警告，TSMC 在 Q1 2026 財報（明日 4/16 公布）中，除季度最強營收外，能源成本持續上升可能是潛在拖累。台灣電費調漲及亞利桑那廠高能耗將增加 COGS。雖然毛利率指引 63–65% 仍創歷史高，但部分機構認為此可能為近期峰值（margin peak），若 Q2 指引保守，短線可能引發獲利了結賣壓。此外，先進封裝 ABF 基板供應仍受限，3nm/N2 產能全滿情況下，緊急訂單溢價收益空間有限。",
        "source": "TradingKey / Blockonomi / CoinCentral 2026-04-15", "impact": "負面",
    },
    {
        "tag": "法規政策", "tag_color": "#FF9800",
        "title": "美台貿易框架 15% 關稅優惠初達共識，TSMC 亞利桑那投資為主要籌碼",
        "body": "美台已達成初步貿易框架，台灣廠商（含 TSMC）享 15% 關稅率，以換取在美投資承諾。TSMC 亞利桑那 $1,650 億美元投資（3 座晶圓廠＋2 座先進封裝廠＋R&D 中心）為主要談判籌碼，若關稅豁免正式落地，TSMC 美國業務相對英特爾等本土競爭者具顯著成本優勢。政策仍需國會批准，不確定性存在。川普政府已另行宣布對半導體進口展開 301 調查，後續動向需持續追蹤，但初步框架強化 TSMC 中長期在美競爭力。",
        "source": "Tom's Hardware / WccfTech / CNBC 2026-04-15", "impact": "正面",
    },
]
