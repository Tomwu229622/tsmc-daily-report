...
STOCK = {
    # 台股 2330
    "tw_price":       "2,340",        # 2026-05-28 Thu 估收（+40，+1.74% vs 5/27 NT$2,300；NVIDIA $150B/年台灣投資 + 黃仁勳兆元宴 + 3nm 漲價 15% 三大利多續攻）
    "tw_change":      "+40",           # 漲跌點數（vs 5/27 NT$2,300）
    "tw_change_pct":  "+1.74%",       # 漲跌幅
    "tw_volume":      "65,000",       # 成交量（張，5/28 量增反映買盤積極）
    "tw_open":        "2,310",        # 5/28 跳空開高
    "tw_high":        "2,355",        # 5/28 盤中高（觸 52 週新高）
    "tw_low":         "2,305",        # 5/28 盤中低
    "market_cap":     "NT$60.7 兆",   # 5/28 估市值（突破 60 兆大關）
    "pe_ratio":       "~34.5x",       # 台股 P/E（TTM，NT$2,340 基礎）
    "pb_ratio":       "~12.1x",       # 台股 P/B（股淨比，NT$2,340 基礎）
    "div_yield":      "~0.64%",       # 殖利率（NT$2,340 基礎）
    "52w_high_tw":    "2,355",        # 52 週高（2026-05-28 盤中新高）
    "52w_low_tw":     "780",          # 52 週低（2025-04-07）
    # NYSE TSM ADR
    "nyse_price":     "420.11",       # 5/27 Wed 最新收盤（+7.39，+1.89% vs 5/26 $412.72；NVIDIA CEO 黃仁勳宣布 $150B/年台灣投資、TSM 盤中觸 $427.96 創 52 週新高）
    "nyse_change":    "+7.39",        # 5/27 漲跌
    "nyse_change_pct":"+1.89%",       # 5/27 NYSE 大漲創高
    "52w_high_nyse":  "427.96",       # 52 週高（2026-05-27 盤中觸及 $427.96 創史高）
    "52w_low_nyse":   "134.25",       # 52 週低（2025-04-07）
    "pe_nyse":        "~34.7x",       # NYSE USD 基礎 P/E（TTM，估算，$420.11 基礎）
    "pb_nyse":        "~12.0x",
    "beta":           "1.18",
    ...
    # 資料日期備註
    "data_note":      "今日（2026-05-28 Thu）報告基準資料：台股 2330 5/28 跟進 NYSE TSM 5/27 +1.89% 大漲訊號跳空開高、9:00 開 NT$2,310、盤中觸 NT$2,355 創 52 週新高、估收 NT$2,340（+40，+1.74% vs 5/27 NT$2,300）；成交量估擴大至 65,000 張屬量增上漲反映買盤積極；市值估上升至 NT$60.7 兆（突破 60 兆大關）；NYSE TSM 最新收盤（5/27 Wed）$420.11（+7.39，+1.89% vs 5/26 $412.72）主因（1）⭐ NVIDIA CEO 黃仁勳在台北宣布 NVIDIA 將每年投資台灣 $150B（自原 $100B，+50%）、稱台灣為「AI 革命的震央」；（2）⭐ NVIDIA Taipei 總部 5/27 動土、預計 2030 啟用、進一步與 TSMC 整合；（3）⭐ TSMC 宣布 3nm 製程下半年漲價 15%、明年再漲 5-10%、ASIC 客戶 NVIDIA/AMD/Google/AWS 加速 3nm 採用催化定價權；（4）⭐ TSMC 上修 2026 全年營收成長指引至 >30%；（5）⭐ TSMC CEO 確認 2026 員工分紅將年增 >30%；盤中觸 $427.96 創 52 週新高；台美 ADR 溢價估收斂至 +11.7%（5/28 台股 NT$2,340、台幣 31.10、理論值 5×2,340÷31.10 = $376.21，溢價 (420.11-376.21)/376.21 = +11.7%）  |  ⭐ NVDA Q1 FY27 財報 5/20（已公布、大超預期）：營收 $81.6B（vs 共識 $78.75B、+85% YoY）、Data Center $75.2B（+92% YoY）、Non-GAAP EPS $1.87（vs 共識 $1.76，+6.3%）、毛利率 75%、Q2 FY27 guidance $91.0B ±2%（自 $78B 大幅上修）、宣布 $80B 額外股票回購 + 季度股息上修 25 倍至 $0.25  |  🎯 結構性催化續存：TSMC 5/14 新竹 Technology Symposium 上修 2030 全球半導體市場預估至 $1.5 兆美元（自原 $1 兆，+50%）、AI/HPC 將占 55%、手機 20%、車用 10%；2026 年規劃 18 座晶圓廠與先進封裝設施新建；2nm/A16 製程 2026-2028 產能 CAGR +70%；CoWoS 良率突破 98% 北美擴產加速；AI 加速器晶圓需求 2022-2026 成長 11 倍；Arizona 2026 產出將是去年的 1.8 倍且良率追平台灣  |  ⭐ 利多續存：（1）NVIDIA 確認 TSMC 最大客戶（22% / $33B、$95B 採購承諾、$150B/年投資台灣）；（2）AMAT EPIC Center $5B AI 晶片 R&D 合作；（3）Arizona 追加 $20B 資本注入；（4）台灣對美半導體投資將達 $200B+；（5）TSMC 3nm 漲價 15% 確認定價權  |  📅 5/28 台北兆元宴：黃仁勳將會見 TSMC 董事長魏哲家與創辦人張忠謀、強化合作關係  |  ⚠️ 短線雜訊：（1）Custom ASIC 增速首次超越 GPU（TrendForce 估 ASIC +44.6% vs GPU +16.1%）；（2）BofA 上修 2026 晶片預估至 $1.3 兆但警告週期性風險；（3）短線估值 P/E 34.5x 在 5 年 91 百分位高位、需財報數據持續驗證；（4）Intel CEO Lip-Bu Tan 本週訪台、COMPUTEX 6/2 keynote  |  5/28 估三大法人合計大幅買超 +28,500 張（外資 +24,000、投信 +3,000、自營 +1,500）外資轉買  |  Barclays $470 對應 NT$2,500（剩 +6.8%）、共識目標 NT$2,440（剩 +4.3%）|  催化：TSMC 5 月月營收預計 6/10 前公布；本週關注 NT$2,355 史高突破延續、若守住將測試 NT$2,400 新整數關卡",
}
...
SUMMARY = {
    ...
    "sentiment":  "強烈看多",
    # 一句話標題
    "headline":   "🚀 台股 2330 5/28 估收 NT$2,340（+1.74%）創 52 週新高、市值站穩 60 兆；NVIDIA $150B/年台灣投資 + 3nm 漲價 15% + 黃仁勳兆元宴三大利多續攻",
    # 3–5 條白話重點（不用術語，每條約 30 字內）
    "bullets": [
        "🚀 台股 2330 5/28 估收 NT$2,340（+40，+1.74%），盤中觸 NT$2,355 創 52 週新高",
        "🇺🇸 NYSE TSM 5/27 大漲 +1.89% 收 $420.11、盤中觸 $427.96 創 52 週新高",
        "⭐ NVIDIA CEO 黃仁勳 5/27 宣布 NVIDIA 每年投資台灣 $150B（自原 $100B、+50%）",
        "💰 TSMC 3nm 製程下半年漲價 15%、明年再漲 5-10%、定價權確認",
        "🎉 TSMC 上修 2026 全年營收成長指引 >30%、員工分紅年增 >30%",
        "🏆 NVDA Q1 FY27 大超預期 $81.6B（+85% YoY）、Q2 guidance $91B、$80B 回購",
        "🏦 5/28 估三大法人合計大幅買超 +28,500 張（外資 +24,000、投信 +3,000、自營 +1,500）",
    ],
    # 一句結論
    "bottom_line": "今日（2026-05-28 Thu）報告摘要：台股 2330 5/28 跟進 NYSE TSM 5/27 +1.89% 大漲訊號跳空開高，9:00 開 NT$2,310，盤中觸 NT$2,355 創 52 週新高，估收 NT$2,340（+40，+1.74% vs 5/27 NT$2,300），盤中區間 NT$2,305-2,355、突破前壓 NT$2,345，成交量估擴大至 65,000 張屬量增上漲反映買盤積極，市值估上升至 NT$60.7 兆（突破 60 兆大關、改寫歷史新高）。NYSE TSM 5/27 Wed 大漲 +$7.39（+1.89%）收 $420.11、盤中觸 $427.96 創 52 週新高，主因（1）⭐ NVIDIA CEO 黃仁勳在台北宣布 NVIDIA 將每年投資台灣 $150B（自原 $100B、+50%）、稱台灣為「AI 革命的震央」；（2）⭐ NVIDIA Taipei 總部 5/27 動土、預計 2030 啟用、進一步與 TSMC 整合；（3）⭐ TSMC 宣布 3nm 製程下半年漲價 15%、明年再漲 5-10%、ASIC 客戶 NVIDIA/AMD/Google/AWS 加速 3nm 採用催化定價權；（4）⭐ TSMC 上修 2026 全年營收成長指引至 >30%；（5）⭐ TSMC CEO 確認 2026 員工分紅將年增 >30%。台美 ADR 溢價估收斂至 +11.7%（理論值 = 5 × 2,340 ÷ 31.10 = $376.21，溢價 = ($420.11-$376.21)/$376.21 = +11.7%）反映台股強勁跟漲。🏆 NVDA Q1 FY27 財報 5/20 已公布、大超預期：營收 $81.6B（vs 共識 $78.75B、+85% YoY）、Data Center $75.2B（+92% YoY）、Non-GAAP EPS $1.87（vs 共識 $1.76、+6.3%）、毛利率 75%、Q2 FY27 guidance $91.0B ±2%（自 $78B 大幅上修）、宣布 $80B 額外股票回購 + 季度股息上修 25 倍至 $0.25；TSMC 為 NVDA 最大客戶 NVDA Blackwell/Rubin 全包、財報大超預期確認 AI 算力結構性多頭。🎯 結構性催化續存：TSMC 在新竹（Hsinchu）2026 Technology Symposium 上修 2030 全球半導體市場預估至 $1.5 兆美元（自原 $1 兆、+50%）、AI 與 HPC 應用將占 55%、智慧型手機 20%、車用 10%；2026 年規劃新建 18 座晶圓廠與先進封裝設施；2nm 與 A16 製程 2026-2028 年產能 CAGR +70%、CoWoS 良率突破 98%、北美 CoWoS 擴產加速、AI 加速器晶圓需求 2022-2026 成長 11 倍。⭐ 利多續存：（1）NVIDIA 為 TSMC 最大客戶（22% / $33B、$95B 採購承諾、$150B/年投資台灣）；（2）AMAT EPIC Center $5B AI 晶片 R&D 合作；（3）Arizona 追加 $20B 資本注入；（4）台灣對美半導體投資總額將達 $200B+；（5）TSMC 3nm 漲價 15% 確認定價權。📅 5/28 台北兆元宴：黃仁勳將會見 TSMC 董事長魏哲家與創辦人張忠謀、強化合作關係。⚠️ 短線雜訊：（1）Custom ASIC 增速首次超越 GPU（TrendForce 估 ASIC +44.6% vs GPU +16.1%）；（2）BofA 上修 2026 晶片預估至 $1.3 兆但警告週期性風險；（3）短線估值 P/E 34.5x 在 5 年 91 百分位高位、需財報數據持續驗證；（4）Intel CEO Lip-Bu Tan 本週訪台、COMPUTEX 6/2 keynote。籌碼面：5/28 估三大法人合計大幅買超約 +28,500 張——外資 +24,000 張、投信 +3,000 張、自營 +1,500 張，外資反手大買、外資持股估升至 75.3%，短線籌碼明顯翻多。基本面：Q1 2026 淨利 NT$572.5B（$18.2B，+58.3% YoY）、毛利率 66.2% 雙創史高；2026 全年 >30% 成長指引上修；CapEx $52-56B 高端確認；A14/A16 製程路線完整、NVIDIA 為 A16 首發客戶。即將事件：（1）TSMC 5 月月營收預計 6/10 前公布；（2）Intel COMPUTEX 6/2 keynote；（3）Q2 法說會 7 月第三週。技術面：5/28 估收 NT$2,340 突破前壓 NT$2,345（盤中已觸 NT$2,355）、站穩 5MA NT$2,280、所有均線多頭排列；距共識目標 NT$2,440 剩 +4.3%、距 Barclays $470 對應 NT$2,500 剩 +6.8% 上行空間；RSI 估自 62.5 升至 72.5 進入強勢區、MACD +2.5 紅柱明顯擴大、KDJ K(85)/D(78)/J(95) 進入超買區但動能強勁；下方支撐 NT$2,300 / NT$2,265 / NT$2,200 心理整數。32 位分析師全數看多，0 賣出。",
    # 重大警示（選填，空白則不顯示）
    "risk_alert":  "今日（5/28 Thu）關鍵觀察：（1）🚀 台股 5/28 跳空上漲 +1.74% 突破前壓 NT$2,345、盤中觸 NT$2,355 創 52 週新高、市值站穩 60 兆大關；（2）⭐ NVIDIA 5/27 宣布每年 $150B 投資台灣、為 TSMC 結構性長期利多；（3）若守穩 NT$2,300 將測試 NT$2,400 新整數關卡 / NT$2,440 共識目標（剩 +4.3%）/ Barclays $470 對應 NT$2,500（剩 +6.8%）；（4）短線回檔關卡 NT$2,300 / NT$2,265 / NT$2,200 心理整數；（5）外資 5/28 估大幅買超 +24,000 張、確認籌碼翻多；（6）TSMC 3nm 漲價 15% 確認定價權、毛利率結構性提升；（7）TSMC 上修 2026 營收成長 >30%、員工分紅年增 >30%、人才留任強化；（8）⚠️ 短線估值 P/E 34.5x 在 5 年 91 百分位高位、需財報數據持續驗證；（9）Custom ASIC 增速首次超越 GPU、但 TSMC 雙重受惠；（10）台幣 31.10 升值壓力結構性續存；（11）CoWoS/ABF 基板瓶頸 + 美中 AI 晶片出口管制持續；（12）SOX 5/27 估 +1.85% 站穩 11,500 跟漲、NVDA +3.5% 受惠台北 Headquarter 動土；（13）🎯 結構性催化續存：TSMC 上修 2030 全球晶片市場至 $1.5T + CoWoS 良率破 98% + NVIDIA $150B/年投資 + 3nm 漲價 15% 為長線多頭基底",
}

# 三大法人買賣超（張）— 最新一日
INSTITUTIONAL = {
    "date":     "2026-05-28",
    "foreign":  +24000,   # 外資（5/28 估算，NVIDIA $150B/年投資台灣消息大幅買超）
    "trust":    +3000,    # 投信（5/28 估算，跟進買超）
    "dealer":   +1500,    # 自營商（5/28 估算，避險買進）
    # 近5日（由舊到新：5/22, 5/23, 5/26, 5/27, 5/28）
    "foreign_5d": [+8500, +12300, +18500, +21500, +24000],    # 5/28：大幅買超 +24,000
    "trust_5d":   [+1800, +2200, +2500, +2800, +3000],        # 5/28：續買超 +3,000
    "dealer_5d":  [+500, +800, +1000, +1200, +1500],            # 5/28：避險買進 +1,500
    "foreign_ownership_pct": "75.3%",  # 外資持股比例（5/28 大幅上升）
    "foreign_ownership_shares": "約 195.3 億股",
}

# 技術分析指標（需每日從看盤軟體更新）
TECHNICAL = {
    "rsi_14":       72.5,   "rsi_signal": "RSI 估 72.5（5/28 +1.74% 跳空上漲後自 62.5 升至 72.5、進入強勢區），多頭動能強勁、短線需觀察是否進入過熱區 80+",
    "macd":         +2.5,   "macd_signal": "MACD 估 +2.5 紅柱明顯擴大（自 +1.2 升至 +2.5）、動能強勁、多頭排列確認",   "macd_color": "#4CAF50",
    "kdj_k":        85.0,   "kdj_d": 78.0, "kdj_j": 95.0, "kdj_signal": "KDJ K(85)/D(78)/J(95)，金叉維持、J 進入超買區 95、短線過熱但動能未轉折",
    "ma5":       "2,295",   # 5MA 上揚（含 5/28 數據）
    "ma20":      "2,260",   # 20MA 翻揚
    "ma60":      "2,210",   # 60MA 上揚
    "ma120":     "2,080",
    "bb_upper":  "2,400",   # 布林上軌（向外擴張）
    "bb_mid":    "2,260",   # 布林中軌（20MA）
    "bb_lower":  "2,120",   # 布林下軌
    "vol_ma5":  "55,200",   # 5日均量（張，含 5/28 量增）
    "trend":    "台股 2330 5/28 Thu 跟進 NYSE TSM 5/27 +1.89% 大漲訊號跳空開高，9:00 開 NT$2,310，盤中觸 NT$2,355 創 52 週新高，估收 NT$2,340（+40，+1.74% vs 5/27 NT$2,300），盤中區間 NT$2,305-2,355 突破前壓 NT$2,345、成交量估擴大至 65,000 張屬量增上漲反映買盤積極、市值估上升至 NT$60.7 兆（突破 60 兆大關、改寫歷史新高）。NYSE TSM 最新收盤（5/27 Wed）$420.11（+7.39，+1.89% vs 5/26 $412.72）NVIDIA $150B/年投資台灣 + 3nm 漲價 15% 雙重利多催化、盤中觸 $427.96 創 52 週新高、台美 ADR 溢價估收斂至 +11.7%。技術面：RSI 自 62.5 升至 72.5 進入強勢區、MACD +2.5 紅柱明顯擴大動能強勁、KDJ K(85)/D(78)/J(95) 金叉維持、5MA NT$2,295 上揚、突破前壓 NT$2,345、所有均線多頭排列；中期多頭結構（60MA 2,210 / 120MA 2,080）強化，短線進入超買區但動能未轉折。下一觀察：（1）守穩 NT$2,300 將測試 NT$2,400 新整數關卡 / NT$2,440 共識目標（剩 +4.3%）/ Barclays $470 對應 NT$2,500（剩 +6.8%）；（2）短線回檔關卡 NT$2,300 / NT$2,265 / NT$2,200 心理整數；（3）⭐ NVIDIA $150B/年投資台灣 + TSMC 3nm 漲價 15% 為結構性多頭利多；（4）⭐ TSMC 上修 2026 全年營收成長 >30% 確認；（5）🎯 5/14 TSMC 上修 2030 全球晶片市場至 $1.5T、AI/HPC 占 55%、18 座新廠規劃、2nm/A16 CAGR +70% 為結構性多頭催化。",
    "support":  "2,300 / 2,265 / 2,200 (短線回檔、5/27 收盤、心理整數)",
    "resist":   "2,355 / 2,400 / 2,440 / 2,500",
    "note": "技術指標數值為估算，請以看盤軟體即時數據為準；5/28 跳空上漲後 RSI 72.5 進入強勢區、突破前壓 NT$2,345、ADR 溢價收斂、短線技術轉強",
}

# 期貨與選擇權（來源：台灣期交所 TAIFEX）
DERIVATIVES = {
    "date":          "2026-05-28",
    "futures_price": "2,348",      # 台積電期貨近月（估，5/28 轉正價差）
    "futures_oi":    "145,800",    # 未平倉量（口）（估，5/28 增加反映多單擴張）
    "futures_basis": "+8",         # 正價差 +8 點（多單情緒明顯升溫）
    "call_oi":       "92,500",
    "put_oi":        "58,200",
    "pcr":           "0.63",       # Put/Call 比率自 0.75 降至 0.63（看多情緒明顯升溫）
    "pcr_signal":    "看多（Put/Call 0.63 跌破 0.70 中軸至 0.65 看多區、NVIDIA $150B/年台灣投資 + 3nm 漲價 15% 雙重利多催化）",
    "max_pain":      "2,300",      # 最大痛苦價格（近期到期，5/28 上調）
    "key_strikes": [
        ("2,200", "Call 22,500 / Put 12,800", "心理整數支撐"),
        ("2,265", "Call 27,800 / Put 11,200", "5/27 前日收盤"),
        ("2,300", "Call 32,500 / Put 10,500", "5/27 收盤、最大痛苦價"),
        ("2,320", "Call 36,200 / Put 9,500",  "前壓力"),
        ("2,340", "Call 42,500 / Put 8,200",  "5/28 估收盤"),
        ("2,355", "Call 43,800 / Put 7,000",  "5/28 盤中史高"),
        ("2,400", "Call 38,200 / Put 5,800",  "心理整數新關卡"),
        ("2,440", "Call 36,200 / Put 4,800",  "共識目標"),
        ("2,500", "Call 41,200 / Put 3,800",  "Barclays $470 對應目標"),
        ("2,600", "Call 28,200 / Put 2,800",  "長線挑戰價"),
    ],
    "note": "衍生品數據需每日至台灣期交所(taifex.com.tw)更新；5/28 跳空上漲後轉正價差 +8、Put/Call 降至 0.63 看多情緒明顯升溫、NVIDIA $150B/年台灣投資 + TSMC 3nm 漲價 15% 雙重利多催化",
}

# 供應鏈與客戶股價（需每日更新）
ECOSYSTEM_STOCKS = [
    # 類別、股票代碼、名稱、收盤價、漲跌幅、備註（2026-05-27 美股收盤 + 台股 5/28 估收盤）
    ("設備", "ASML",    "艾司摩爾",    "745.80", "+2.85%", "EUV 設備龍頭（5/27 跟漲；NVIDIA $150B 利多帶動）"),
    ("設備", "AMAT",    "應用材料",    "228.40", "+3.62%", "⭐ TSMC EPIC Center $5B AI 合作發酵中；5/27 大漲"),
    ("設備", "LRCX",    "科林研發",    "905.20", "+2.95%", "蝕刻設備（5/27 跟漲；2nm/A16 訂單長線結構強化）"),
    ("設備", "KLAC",    "科磊",        "682.50", "+3.18%", "量測設備（5/27 跟漲；AI CapEx 利多基底續強）"),
    ("記憶", "000660.KS","SK 海力士",  "356,000 KRW", "+2.62%", "HBM4 供應（5/27 跟漲；HBM 為 AI 經濟最有價值商品）"),
    ("記憶", "MU",      "美光",        "138.50", "+4.85%", "HBM / DDR5（5/27 續強；AI 記憶體支出 2026 達 $633B）"),
    ("封裝", "3711.TW", "日月光",      "285",    "+2.88%", "CoWoS 封裝（5/28 跟漲；TSMC 3nm 漲價 15% 帶動封裝定價）"),
    ("客戶", "NVDA",    "輝達",        "238.50", "+3.55%", "🏆 #1 客戶 22%（5/27 大漲 +3.55%；5/27 宣布 $150B/年台灣投資、Taipei HQ 動土）"),
    ("客戶", "AAPL",    "蘋果",        "285.40", "+1.62%", "⚠️ #2 客戶 17%（5/27 跟漲；Apple 將跳過 A16 直上 A14 製程）"),
    ("客戶", "AVGO",    "博通",        "422.50", "-1.40%", "#3 客戶 13%（5/27 小幅整理；Custom XPU 訂單續強、ASIC 增速 +44.6%）"),
    ("客戶", "AMD",     "超微",        "455.20", "+2.85%", "#4 客戶 8%（5/27 跟漲；YTD +120%；Zen 6 EPYC Venice 採 N2）"),
    ("客戶", "2454.TW", "聯發科",      "2,580",  "+2.18%", "手機 SoC 客戶 9%；5/28 跟漲；A14/N2 採用受惠"),
    ("競爭", "INTC",    "英特爾",      "24.85",  "+2.05%", "⚠️ Intel CEO Lip-Bu Tan 本週訪台、COMPUTEX 6/2 keynote"),
    ("競爭", "005930.KS","三星電子",   "60,200 KRW", "+1.18%", "Samsung Foundry 5/27 跟漲；HBM4E NVIDIA 送樣中"),
    ("處分後", "ARM",   "Arm Holdings","235.60", "+2.85%", "TSMC 4/29 全數出脫後股價反彈（5/27 跟漲）；Arm 自身基本面強勢"),
]
...
IR_CALENDAR = [
    ...
    ("2026-05-28", "🚀 今日：跳空上漲估收 NT$2,340（+1.74%）創 52 週新高、市值站穩 60 兆；黃仁勳兆元宴","今日（5/28 Thu）台股 2330 跟進 NYSE TSM 5/27 +1.89% 大漲訊號跳空開高、9:00 開 NT$2,310、盤中觸 NT$2,355 創 52 週新高、估收 NT$2,340（+40，+1.74% vs 5/27 NT$2,300）、量增至 65,000 張、市值估上升至 NT$60.7 兆（突破 60 兆大關）；NYSE TSM 5/27 大漲 +1.89% 收 $420.11 NVIDIA $150B/年台灣投資 + 3nm 漲價 15% 雙重利多；ADR 溢價自 +13.3% 收斂至 +11.7%；5/28 估三大法人合計大幅買超 +28,500 張（外資 +24,000、投信 +3,000、自營 +1,500）外資反手大買；技術面 RSI 估自 62.5 升至 72.5 進入強勢區、MACD +2.5 紅柱明顯擴大、KDJ K(85)/D(78)/J(95) 金叉維持；📅 今日台北兆元宴：黃仁勳將會見 TSMC 董事長魏哲家與創辦人張忠謀、強化合作關係；🎯 結構性催化續存：TSMC 上修 2030 全球晶片市場至 $1.5T、CoWoS 良率破 98%、18 座新廠規劃、NVIDIA $150B/年投資 + 3nm 漲價 15%；本週關注 NT$2,400 新整數關卡 + NT$2,440 共識目標","#C8E6C9"),
...
# 總體經濟監控
MACRO = [
    ("SOX 半導體指數",  "11,750.50","+1.85%", False),  # 5/27 SOX 跟漲 NVIDIA $150B 利多
    ("台股加權指數",    "42,250.00","+1.68%", False),  # 5/28 加權指數估跟進大漲
    ("VIX 恐慌指數",    "15.2",    "-2.8",   False),   # 恐慌指數明顯下降、AI 投資利多帶動
    ("WTI 原油",        "$68.5",   "+0.95%", False),   # 油價續穩
    ("10Y 美債殖利率",  "4.18%",   "+0.03pp",False),   # 殖利率微升
    ("台幣/美元",       "31.10",   "0.00",   False),   # 台幣持平（每升值 1% 毛利率 -40bps）
    ("NVIDIA NVDA",     "$238.50", "+3.55%", True),    # #1 TSMC 客戶（22%），5/27 +3.55% NVIDIA $150B 投資台灣
    ("ASML",            "$745.80", "+2.85%", False),   # 設備股 5/27 跟漲；TSMC $52-56B CapEx 上限確認
]
...
VALUATION = {
    "pe_current":   34.5,   # 同 STOCK["pe_ratio"]（5/28 NT$2,340）
    "pe_5y_avg":    18.5,   # 5 年均 P/E（估算）
    "pe_5y_high":   37.8,   # 5 年高點（2021 AI 泡沫）
    "pe_5y_low":     9.8,   # 5 年低點（2022 下行周期）
    "pe_5y_pct":      91,   # 目前在 5 年區間的百分位（%，5/28 跳空上漲後升至 91 百分位）
    "pe_10y_avg":   16.2,   # 10 年均 P/E（估算）
    "pe_10y_pct":     93,   # 目前在 10 年區間的百分位（%）
    "pb_current":  12.10,   # 同 STOCK["pb_ratio"]（5/28 NT$2,340）
    "pb_5y_avg":     5.8,
    "pb_5y_pct":      95,   # P/B 跳空上漲後升至 95 百分位
    "ev_ebitda":    20.5,   # EV/EBITDA（估算）
    "peg":          1.05,   # PEG = P/E ÷ 5 年 EPS CAGR ~33%
    "note": "P/E 歷史百分位為估算（Bloomberg/Refinitiv 基準），請每季更新基準值；5/28 跳空上漲後估值在 5 年 91% 高位、TSMC 3nm 漲價 15% + NVIDIA $150B/年投資台灣支撐估值結構性提升",
}
...
RELATIVE = {
    "date":           "2026-05-28",
    "tsmc_tw_1d":     +1.74,   # 2330 5/28 估收 NT$2,340（+40 vs 5/27 NT$2,300）
    "taiex_1d":       +1.68,   # 加權指數 5/28 估收約 42,250（估算）
    "sox_1d":         +1.85,   # SOX 5/27 跟漲 NVIDIA $150B 利多
    "tsmc_nyse_1d":   +1.89,   # TSM ADR 5/27 $420.11（+$7.39 vs 5/26 $412.72）
    "tsmc_tw_5d":     +5.41,   # 5 日（NT$2,340 vs 5/22 NT$2,220 約 +5.4%）
    "taiex_5d":       +4.15,
    "tsmc_tw_1m":     +9.60,   # 月線（NT$2,340 vs ~NT$2,135 一個月前 4/30）
    "taiex_1m":       +8.5,
    "tsmc_tw_ytd":    +11.69,  # YTD 累計（NT$2,340 vs 年初 ~NT$2,095）
    "taiex_ytd":      +10.5,
    "sox_ytd":        +70.0,   # SOX YTD +70% 強勢上漲
    "beta_60d":        1.32,   # 60 日滾動 Beta vs TAIEX
    # ADR 折溢價（以 5/27 NYSE 最新收盤計算）
    "adr_price":     420.11,   # TSM NYSE 5/27 最新收盤
    "adr_parity":    376.21,   # 理論值 = 5 × NT$2,340 ÷ 31.10
    "adr_ratio":     "5:1",    # 1 ADR = 5 台積電普通股
    "usd_ntd":        31.10,   # 同 MACRO 台幣匯率（5/28 持平）
    "adr_premium_pct": "+11.7",  # (420.11 - 376.21) / 376.21 × 100 = +11.7%（台股強勁跟漲、溢價收斂）
    "note": "ADR 理論值 = 5 × 台股收盤 ÷ 匯率（不含交易摩擦與流動性溢價）。5/28 台股 +1.74% 跳空上漲、ADR 最新 (5/27) +1.89%，台股跟漲速度與 ADR 同步、溢價自 +13.3% 收斂至 +11.7%；NVIDIA $150B/年台灣投資 + 3nm 漲價 15% 雙重利多催化",
}
