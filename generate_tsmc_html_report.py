...
STOCK = {
    # 台股 2330
    "tw_price":       "2,445",        # 台股 2330 7/3 Fri 官方收盤 NT$2,445（-20、-0.81% vs 7/2 收 NT$2,465、TWSE 確認）；為最新確認收盤；7/6 Mon 盤中初步跟進 NYSE 假期後續弱、連 2 跌，官方收盤待 TWSE
    "tw_change":      "-20",          # 7/3 Fri 收盤漲跌點數（-0.81%、TWSE 確認）
    "tw_change_pct":  "-0.81%",       # 7/3 Fri 收盤漲跌幅（守穩 NT$2,410、跌幅較 7/2 之 -1.60% 收斂）
    "tw_volume":      "26,455",       # 7/3 Fri 收盤成交量（張，TWSE 確認、含一般+盤後定價）
    "tw_open":        "2,415",        # 7/3 開盤（TWSE 確認）
    "tw_high":        "2,465",        # 7/3 盤中高（TWSE 確認）
    "tw_low":         "2,415",        # 7/3 盤中低（TWSE 確認）
    "market_cap":     "NT$63.4 兆",   # 7/3 收盤市值（NT$2,445 基礎）
    "pe_ratio":       "~36.0x",       # 台股 P/E（TTM，NT$2,445 基礎）
    "pb_ratio":       "~12.7x",       # 台股 P/B（股淨比，NT$2,445 基礎）
    "div_yield":      "~0.61%",       # 殖利率（NT$2,445 基礎）
    "52w_high_tw":    "2,535",        # 52 週/歷史高（2026-06-23 盤中觸 NT$2,535 史高）
    "52w_low_tw":     "780",          # 52 週低（2025-04-07）
    # NYSE TSM ADR
    "nyse_price":     "434.16",       # 7/2 Thu 官方收盤 $434.16（-$10.07、-2.27%；4:00 PM EDT、stockanalysis.com 確認、前收 7/1 $444.23；為最新確認收盤）；NYSE 7/3 Fri 因美國國慶（7/4 週六順延至 7/3）休市、7/6 Mon 重新開盤（美股 7/6 盤待今晚 GMT+8）
    "nyse_change":    "-10.07",       # 7/2 漲跌（最新確認收盤、4:00 PM EDT；連二跌但跌幅較 7/1 之 -6.98% 大幅收斂）
    "nyse_change_pct":"-2.27%",       # 7/2 NYSE 續跌（連二跌、惟跌幅較 7/1 之 -6.98% 大幅收斂、殺盤趨緩）
    "52w_high_nyse":  "479.00",       # 52 週/歷史高（區間，6/30 收 $477.57）
    "52w_low_nyse":   "223.70",       # 52 週低（區間）
    "pe_nyse":        "~37.8x",       # NYSE USD 基礎 P/E（TTM，$434.16 基礎）
    "pb_nyse":        "~12.9x",
    "beta":           "1.18",
    ...
    # 資料日期備註
    "data_note":      "報告日期：2026-07-06 Mon（最新確認收盤：台股 2330 7/3 Fri 官方收 NT$2,445（-20、-0.81% vs 7/2 NT$2,465、量 26,455 張、TWSE 確認）；NYSE TSM 7/2 Thu 官方收 $434.16（-$10.07、-2.27%、stockanalysis.com 確認、前收 7/1 $444.23）為最新確認收盤——因 NYSE 7/3 Fri 逢美國國慶（7/4 週六順延至 7/3）休市；NYSE 7/6 Mon 重新開盤、美股 7/6 盤待今晚 GMT+8；台股 7/6 Mon 盤中初步跟進假期後市場情緒、官方收盤待 TWSE）。【重要更正】前一份 7/6 報告曾將 NYSE 7/2 收盤「更正」為 +0.13%（$434.71、稱盤後 $437.44），經 stockanalysis.com 官方收盤複核確認為誤——正確為 7/2 收 $434.16（-2.27%、前收 7/1 $444.23）；即 NYSE 為連二跌（7/1 -6.98%、7/2 -2.27%）、惟跌幅大幅收斂、殺盤動能趨緩，而非「止穩收紅」。⚠️ 今日頭條——修正收斂、分析師續大幅上調目標：（1）📉→⚖️ 台股 2330 7/3 收 NT$2,445（-0.81%）、跌幅較 7/2 之 -1.60% 收斂、守穩 NT$2,410 支撐；NYSE TSM 7/2 收 $434.16（-2.27%）為連二跌、惟跌幅較 7/1 之 -6.98% 大幅收斂、殺盤動能明顯衰竭、屬估值修正而非基本面惡化；（2）🚀 分析師逆勢大幅續挺——Barclays 將 TSM 目標價自 $470 大幅上調至 $625（維持 Overweight、自 7/2 收 $434.16 隱含約 +43.9% 空間）；Nomura 上調至 NT$3,425（自 NT$2,445 具 +40.1% 空間）、指 AI 基礎設施投資循環尚未見頂、估 2027 資料中心新增產能達 ~32GW；⚠️ 惟 Goldman Sachs 7/1 將 TSM 移出「APAC Conviction List」（戰術性調整、非降評）；（3）📊 台美 ADR 溢價（以 7/2 ADR $434.16 + 台股 7/3 NT$2,445、匯率 ~31.05 計）：理論值 5×2,445÷31.05 = $393.7、溢價 (434.16-393.7)/393.7 = +10.3%。（4）🤝 產業利多——NVIDIA 與 SK 海力士宣布多年期記憶體技術合作、共推 AI 工廠次世代記憶體；NVIDIA 與 TSMC 將 AI/加速運算導入晶圓廠設計與製造（提升週期時間、能效、良率）；BofA 上修 2026 全球半導體市場至 $1.3 兆（原 $1.0 兆）、2030 上看 $2 兆；生成式 AI 晶片估 2026 貢獻 ~$500B（約全球晶片銷售半數）。⭐ 漲價題材續發酵——TSMC 全先進製程（7nm 以下、佔晶圓營收 ~75%）調漲 5-10%，估全年毛利率 +2pp 以上，惟客戶（Apple/NVIDIA/AMD/Qualcomm/Broadcom/MediaTek）成本升；Benzinga 指 NVIDIA 因需求剛性、長期反為利多。⚠️ 近期營收疑慮續存——4-5 月營收合計 +24% YoY 落後華爾街 Q2 約 +35% 預期，6 月營收（7 月上旬公布）為關鍵 catalyst、僅需小幅月增即可使 Q2 營收逼近指引中值。⭐ 中長線結構性利多基底未變：TSMC-Amkor 10 年美國先進封裝長約（Peoria AZ $70 億、2028 投產）、Winbond 特殊 DRAM 自主供應、NVIDIA 確認第 1 大客戶（22%/$33B）+ A16 首發 2026 下半/2027 量產（Apple 跳過 A16 直上 A14）+ Vera Rubin 平台 6 顆晶片全數 TSMC 代工（3nm + HBM4）、2nm 量產 70-80% 良率、2nm/A16 產能 2026-28 估 CAGR ~70%。  |  🎯 即將事件：6 月營收 7 月上旬公布（關鍵 catalyst、攸關 Q2 指引達成）；Q2 2026 財報法說會 7/16（指引 $39.0-40.2B、毛利率 65-67%、漲價後上修空間）  |  ⭐ 中長線基底：5 月營收 NT$4,169.75 億 +30.1% 創單月新高；2nm 量產良率 70-80% 領先全球；NVIDIA 第 1 大客戶 22%/$33B；4 大美國 CSP 2026 AI CapEx 合計 $725B（+77% YoY）；BofA 估 2026 全球半導體市場 $1.3 兆；費半（SOX）YTD +47%  |  ⚠️ 本日（7/6）關鍵觀察：（1）台股 7/6 盤中留意能否守穩 NT$2,410 / NT$2,370 支撐（NYSE 7/2 止穩收紅降低補跌壓力）；（2）ADR 溢價約 +10.4%；（3）下方支撐 NT$2,410 / NT$2,370 / NT$2,340；上方壓力 NT$2,465 / NT$2,505 / NT$2,535 史高；（4）NYSE 7/6 重新開盤方向、美股半導體假期後表現；（5）⚠️ 估值警示：TSM P/E ~37.8x、台股 P/E ~36.0x，留意 6 月營收 miss 風險、下游需求疲弱與漲價客戶反彈",
}
...
SUMMARY = {
    ...
    "sentiment":  "中性偏多",
    # 一句話標題
    "headline":   "⚖️ 修正收斂、分析師大幅續挺：台股 2330 7/3 收 NT$2,445（-0.81%、跌幅收斂）、NYSE TSM 7/2 續跌 -2.27%（$434.16）為連二跌惟跌幅較 7/1 之 -6.98% 大幅收斂、殺盤趨緩；🚀 Barclays 上調目標至 $625（+43.9% 空間）、Nomura NT$3,425；NYSE 7/6 重新開盤",
    # 3–5 條白話重點（不用術語，每條約 30 字內）
    "bullets": [
        "⚖️ 台股 2330 7/3 Fri 官方收 NT$2,445（-20、-0.81%、量 26,455 張）——跌幅較 7/2 之 -1.60% 收斂、守穩 NT$2,410 支撐、殺盤動能衰竭；7/6 Mon 盤中官方收盤待 TWSE",
        "⚖️ NYSE TSM 7/2 Thu 續跌 -2.27%（-$10.07）收 $434.16（前收 7/1 $444.23）——為連二跌（7/1 -6.98%、7/2 -2.27%）惟跌幅大幅收斂、殺盤動能衰竭、反映估值修正而非基本面惡化；NYSE 7/3 因美國國慶休市、7/6 重新開盤",
        "🚀 分析師逆勢大幅續挺：Barclays 將 TSM 目標價自 $470 大幅上調至 $625（維持 Overweight、自 $434.16 具 +43.9% 空間）；Nomura 上調台股目標至 NT$3,425（自 NT$2,445 具 +40.1% 空間）",
        "📊 分析師平均目標約 $490（強力買入）——⚠️ 惟 Goldman Sachs 7/1 將 TSM 移出 APAC Conviction List（戰術調整、非降評）；共識仍全面看多、拉回視為估值修正",
        "🤝 產業利多：NVIDIA 與 SK 海力士宣布多年期記憶體合作（AI 工廠次世代記憶體）；NVIDIA-TSMC 將 AI 導入晶圓廠製造；BofA 上修 2026 全球半導體市場至 $1.3 兆、生成式 AI 晶片估 ~$500B",
        ...
        "⚠️ 風險續追蹤：4-5 月營收 +24% YoY 落後 ~35% 預期、6 月營收（7 月上旬）與 7/16 財報為關鍵；下游手機/PC 需求疲弱；AMD 首發 2nm AI 晶片；估值偏高（TSM P/E ~37.8x、台股 ~36.0x）",
    ],
    # 一句結論
    "bottom_line": "報告日期：2026-07-06 Mon（最新確認收盤：台股 2330 7/3 Fri 官方收 NT$2,445（-20、-0.81% vs 7/2 NT$2,465、量 26,455 張、TWSE 確認）；NYSE TSM 7/2 Thu 官方收 $434.16（-$10.07、-2.27%、stockanalysis.com 確認、前收 7/1 $444.23）為最新確認收盤——NYSE 7/3 Fri 逢美國國慶休市、7/6 Mon 重新開盤；台股 7/6 盤中官方收盤待 TWSE）。【重要更正】前一份 7/6 報告曾將 NYSE 7/2 收盤「更正」為 +0.13%（$434.71），經 stockanalysis.com 官方收盤複核為誤——正確為 7/2 收 $434.16（-2.27%、前收 7/1 $444.23）、即連二跌但跌幅大幅收斂，而非止穩收紅。⚠️ 今日頭條——修正收斂、分析師大幅續挺：（1）⚖️ 台股 2330 7/3 官方收 NT$2,445（-20、-0.81% vs 7/2 NT$2,465），跌幅較 7/2 之 -1.60% 收斂、守穩 NT$2,410 支撐、殺盤動能衰竭；7/6 Mon 官方收盤待 TWSE；（2）⚖️ NYSE TSM 7/2 續跌 -2.27%（-$10.07）收 $434.16（前收 7/1 $444.23）為連二跌（7/1 -6.98%、7/2 -2.27%），惟跌幅大幅收斂——催化仍為技術面過熱獲利了結（費半 YTD +47% 後拉回）、估值修正、4-5 月營收 +24% YoY 落後華爾街 Q2 約 +35% 預期、下游手機/PC 需求疲弱、7/16 財報前觀望，殺盤動能衰竭、屬估值修正而非基本面惡化；NYSE 7/3 因美國國慶休市、7/6 重新開盤；（3）🚀 分析師逆勢大幅續挺——Barclays 將 TSM 目標價自 $470 大幅上調至 $625（維持 Overweight、自 7/2 收 $434.16 隱含約 +43.9% 上行空間）；Nomura（野村）上調台股目標至 NT$3,425（自 NT$2,445 具 +40.1% 空間），指 AI 基礎設施投資循環尚未見頂、估 2027 資料中心新增產能達 ~32GW；（4）⚠️ 惟 Goldman Sachs 7/1 將 TSM 移出「APAC Conviction List」（戰術性調整近期上檔預期、非降評）。📊 台美 ADR 溢價（以 7/2 ADR $434.16 + 台股 7/3 NT$2,445、匯率 ~31.05 計）：理論值 5×2,445÷31.05 = $393.7、溢價 +10.3%。🤝 NVIDIA 與 SK 海力士宣布多年期記憶體技術合作（AI 工廠次世代記憶體）。🤝 產業利多：NVIDIA 與 TSMC 宣布將 AI/加速運算導入晶圓廠設計與製造流程（提升週期時間、能效與良率）；BofA 上修 2026 全球半導體市場規模至 $1.3 兆（原估 $1.0 兆）、估 2030 上看 $2 兆。⭐ 漲價題材續發酵：TSMC 通知客戶全先進製程調漲 5-10%（擴及 N7/N5/N3 及成熟製程、佔晶圓營收 ~74%），利多毛利率（估全年 +2pp 以上），惟客戶（含 Apple/NVIDIA/AMD/Qualcomm/Broadcom/MediaTek）成本升；Benzinga 指 NVIDIA 因 AI 需求剛性與轉嫁能力強、長期反為利多。6 月營收（7 月上旬公布）為關鍵 catalyst——4-5 月營收合計 +24% YoY 低於華爾街 Q2 約 +35% 預期、惟即使小幅月增亦可能使 Q2 營收逼近指引（$39.0-40.2B）中值。⚠️ 南韓公布逾 $1 兆美元 AI/晶片投資計畫（三星+SK 海力士 800 兆韓元）、中長期競爭加劇。⭐ 中長線結構性利多基底未變：（1）🤝 TSMC-Amkor 10 年美國先進封裝長約（Peoria AZ $70 億、2028 投產）；（2）⭐ TSMC-Winbond 特殊 DRAM 自主供應、降低 HBM 對韓系依賴；（3）🏆 NVIDIA 確認 TSMC 第 1 大客戶（22%/$33B）、A16 首發 2026 下半/2027 量產、Vera Rubin 平台 6 顆晶片全數 TSMC 代工（3nm+HBM4）、Apple 跳過 A16 直上 A14；（4）⭐ 2nm 已量產、初期良率 70-80% 領先全球、2nm/A16 產能 2026-28 估 CAGR ~70%；（5）4 大美國 CSP 2026 AI CapEx 合計 $725B（+77% YoY）；（6）⭐ 5 月營收 NT$4,169.75 億 +30.1% 創單月新高、1-5 月累計 NT$1.96 兆；（7）BofA 估 2026 全球半導體市場 $1.3 兆；（8）費半（SOX）Q2 大漲 +87.8% 創 1994 年以來最強單季。⚠️ 下行風險：（1）漲價恐引發客戶反彈與訂單調整；（2）4-5 月營收 +24% YoY 落後 Q2 ~35% 預期、6 月營收與 7/16 財報為關鍵驗證；（3）智慧型手機/PC 等下游終端需求疲弱；（4）估值警示——TSM P/E ~37.8x、台股 P/E ~36.0x；（5）台幣升值（每升 1% 毛利率 -40bps）。基本面未變：Q1 2026 淨利 NT$572.5B（$18.2B、+58.3% YoY）、毛利率 66.2% 雙創史高。技術面（基於 7/3 收 NT$2,445）：5MA NT$2,455 / 20MA NT$2,410 / 60MA NT$2,395 / 120MA NT$2,300；下方支撐 NT$2,410 / NT$2,370 / NT$2,340；上方壓力 NT$2,465 / NT$2,505 / NT$2,535（史高）。分析師仍全面看多（Barclays 上調至 $625、Nomura NT$3,425），拉回被視為估值修正而非基本面惡化。",
    # 重大警示（選填，空白則不顯示）
    "risk_alert":  "今日（7/6 Mon）關鍵觀察：（1）⚖️ 台股 2330 7/3 官方收 NT$2,445（-0.81%）、跌幅收斂、守穩 NT$2,410 支撐；7/6 盤中官方收盤待 TWSE；（2）⚖️ NYSE TSM 7/2 續跌 -2.27%（$434.16、前收 7/1 $444.23）為連二跌（7/1 -6.98%、7/2 -2.27%）、惟跌幅大幅收斂、殺盤動能衰竭、屬估值修正而非基本面惡化；NYSE 7/3 因美國國慶休市、7/6 重新開盤（美股 7/6 盤待今晚 GMT+8）；（3）📊 ADR 溢價約 +10.3%（7/2 ADR $434.16 vs 理論 $393.7）；（4）🚀 分析師逆勢大幅續挺——Barclays 上調目標至 $625（自 $434.16 具 +43.9% 空間）、Nomura NT$3,425（自 NT$2,445 具 +40.1% 空間）、共識強力買入、拉回視為估值修正；⚠️ 惟 Goldman 7/1 將 TSM 移出 APAC Conviction List（戰術調整、非降評）；（5）🤝 NVIDIA-SK 海力士宣布多年期記憶體合作、NVIDIA-TSMC 導入 AI 入廠提升良率、BofA 上修 2026 半導體市場至 $1.3 兆（生成式 AI 晶片 ~$500B）；⭐ 漲價定價力擴及全先進製程（7nm 以下、佔晶圓營收 ~75%）、估全年毛利率 +2pp 以上；（6）⚠️ 4-5 月營收 +24% YoY 落後 ~35% 預期、6 月營收（7 月上旬）與 7/16 財報為關鍵 catalyst；下游手機/PC 需求疲弱、AMD 首發 2nm AI 晶片；（7）🏆 中長線基底未變：NVIDIA #1 客戶（22%/$33B）/A16 首發、Vera Rubin 6 顆晶片全 TSMC 代工、2nm 70-80% 良率、TSMC-Amkor 美國封裝長約；（8）⚠️ 估值警示：TSM P/E ~37.8x、台股 P/E ~36.0x；本日關鍵：台股 7/6 能否守穩 NT$2,410 / NT$2,370；上方壓力 NT$2,465 / NT$2,505 / NT$2,535 史高",
}

# 三大法人買賣超（張）— 最新一日
INSTITUTIONAL = {
    "date":     "2026-07-03",       # 最新資料日（7/3 Fri 官方收盤；三大法人淨額為估算，官方明細以 TWSE 為準）
    "foreign":  -3000,             # 外資 7/3 估賣超約 3,000 張（台股 -0.81%、賣壓較 7/2 收斂）
    "trust":    800,               # 投信 7/3 估買超約 800 張
    "dealer":   200,               # 自營商 7/3 估買超約 200 張
    # 近5日（由舊到新：6/29, 6/30, 7/1, 7/2, 7/3）；7/3 為官方收盤日、三大法人淨額為估算
    "foreign_5d": [2500, 8000, 15000, -8000, -3000],     # 外資 7/3 估賣超約 3,000 張
    "trust_5d":   [400, 1200, 2000, 500, 800],           # 投信 7/3 估買超約 800 張
    "dealer_5d":  [150, 650, 1000, -300, 200],           # 自營 7/3 估買超約 200 張
    "foreign_ownership_pct": "74.9%",  # 外資持股比例（7/3 估持穩 74.9%）
    "foreign_ownership_shares": "約 193.8 億股",
}

# 技術分析指標（需每日從看盤軟體更新）
TECHNICAL = {
    "rsi_14":       55.0,   "rsi_signal": "RSI 估自 60 回落至 55（台股 7/3 收 NT$2,445、-0.81%），中性偏多、退出超買區、動能溫和；守穩 NT$2,410 支撐",
    "macd":         0.40,  "macd_signal": "MACD 估自 +0.50 回落至 +0.40、紅柱續縮但仍為正、動能放緩、多頭趨勢未破；7/3 跌幅收斂、留意 7/6 NYSE 重新開盤後方向",   "macd_color": "#4CAF50",
    "kdj_k":        65.0,   "kdj_d": 62.0, "kdj_j": 71.0, "kdj_signal": "KDJ K(65)/D(62)/J(71) 自高檔回落、7/3 小跌帶動、J 值遠離超買、短線過熱壓力已緩解",
    "ma5":       "2,450",   # 5MA（6/29 2370, 6/30 2465, 7/1 2505, 7/2 2465, 7/3 2445）— 基於 7/3 官方收盤
    "ma20":      "2,415",   # 20MA
    "ma60":      "2,395",   # 60MA 緩升
    "ma120":     "2,300",
    "bb_upper":  "2,560",   # 布林上軌
    "bb_mid":    "2,420",   # 布林中軌（20MA）
    "bb_lower":  "2,270",   # 布林下軌
    "vol_ma5":  "40,000",   # 5日均量（張，估、基於 6/26-7/2 五日均）
    "trend":    "⚖️ 修正收斂、殺盤趨緩：NYSE TSM 7/2 續跌 -2.27% 收 $434.16（前收 7/1 $444.23）為連二跌（7/1 -6.98%、7/2 -2.27%）、惟跌幅大幅收斂、殺盤動能衰竭；台股 2330 7/3 官方收 NT$2,445（-0.81%）跌幅較 7/2 之 -1.60% 收斂、守穩 NT$2,410 支撐、站穩 20MA NT$2,415。📊 技術面（基於 7/3 官方收盤 NT$2,445）：RSI 自 60 回落至 55 退出超買區、MACD +0.40 紅柱續縮但仍為正、KDJ J 值遠離超買、短線過熱壓力已緩解，中期 60MA/120MA 趨勢仍偏多。下一觀察：（1）NYSE 7/6 Mon 重新開盤後方向、美股半導體假期後表現；（2）台股 7/6 能否守穩 NT$2,410 / NT$2,370 支撐；（3）上方壓力 NT$2,465 / NT$2,505 / NT$2,535 史高；（4）🚀 Barclays 上調目標至 $625 + Nomura NT$3,425 + 共識強力買入為中長線支撐、惟須留意 6 月營收（7 月上旬）與 7/16 財報、Goldman 移出 APAC Conviction List；（5）⭐ 中長線基底未變：NVIDIA #1 客戶/A16 首發 + Vera Rubin 6 顆晶片全 TSMC 代工 + 2nm 70-80% 良率。",
    "support":  "2,410 / 2,370 / 2,340 (7/3 守穩 2,410)",
    "resist":   "2,465 / 2,505 / 2,535 (7/2 收、7/1 收、史高)",
    "note": "技術指標數值為估算（基於 7/3 官方收盤 NT$2,445），請以看盤軟體即時數據為準；NYSE TSM 7/2 續跌 -2.27% 收 $434.16（前收 7/1 $444.23）為連二跌但跌幅大幅收斂、殺盤動能衰竭；台股守穩 NT$2,410 支撐、RSI 自 60 回落至 55 退出超買、KDJ J 值遠離超買、MACD 紅柱續縮仍為正；上方壓力 NT$2,465 / NT$2,505 / NT$2,535 史高、下方支撐 NT$2,410 / NT$2,370；🚀 Barclays/Nomura 上調目標 + 漲價定價力+共識偏多 vs ⚠️ 6 月營收與下游需求雜訊拉鋸；NYSE 7/6 重新開盤、台股 7/6 盤中待 TWSE",
}

# 期貨與選擇權（來源：台灣期交所 TAIFEX）
DERIVATIVES = {
    "date":          "2026-07-03",       # 最新資料日（7/3 Fri 盤後估、官方待 TAIFEX 公布）
    "futures_price": "2,440",            # 台積電期貨近月（7/3 收盤附近、逆價差收斂反映止穩）
    "futures_oi":    "178,000",          # 未平倉量（口）（7/3 估）
    "futures_basis": "-5",               # 7/3 估逆價差收斂（止穩後謹慎情緒緩解）
    "call_oi":       "112,000",
    "put_oi":        "78,000",
    "pcr":           "0.70",             # Put/Call 比率（7/3 估自 0.73 回落至 0.70、止穩後避險買盤趨緩、情緒中性）
    "pcr_signal":    "中性（Put/Call 7/3 估 0.70；台股 7/3 收 NT$2,445（-0.81%）跌幅收斂、NYSE TSM 7/2 續跌 -2.27% 但跌幅大幅收斂、避險買盤趨緩、逆價差收斂至 -5；⭐ 台股守穩 NT$2,410、Barclays 上調目標 $625 + Nomura NT$3,425 + 共識偏多為中長線支撐；NYSE 7/6 重新開盤）",
    "max_pain":      "2,450",            # 最大痛苦價格（近期到期、7/3 估）
    "key_strikes": [
        ("2,340", "Call 54,000 / Put 16,000", "整數支撐"),
        ("2,370", "Call 52,000 / Put 12,000", "整數支撐"),
        ("2,410", "Call 50,000 / Put 9,000",  "7/3 守穩、整數支撐"),
        ("2,445", "Call 44,000 / Put 6,500",  "7/3 收"),
        ("2,450", "Call 46,000 / Put 7,000",  "最大痛苦"),
        ("2,505", "Call 38,000 / Put 5,000",  "7/1 收"),
        ("2,535", "Call 30,000 / Put 3,500",  "盤中史高"),
    ],
    "note": "衍生品數據需每日至台灣期交所(taifex.com.tw)更新；7/3 PCR 估自 0.73 回落至 0.70 反映台股跌幅收斂 -0.81% 後避險情緒緩解、逆價差收斂至 -5；NT$2,450 為最大痛苦、7/3 守穩 NT$2,410、下方支撐 NT$2,410 / NT$2,370、上方壓力 NT$2,465 / NT$2,505 / NT$2,535 史高；🚀 Barclays 上調目標 $625 + Nomura NT$3,425 + 漲價定價力+共識偏多結構性利多、⚠️ 留意 6 月營收 miss 風險與下游需求疲弱；中長線基底未變（NVIDIA #1 客戶/A16 首發、Vera Rubin 6 顆晶片全 TSMC 代工、2nm 70-80% 良率、TSMC-Amkor 美國封裝長約）",
}

# 供應鏈與客戶股價（需每日更新）
ECOSYSTEM_STOCKS = [
    # 類別、股票代碼、名稱、收盤價、漲跌幅、備註（美股為 2026-07-02 Thu 最新確認收盤、NYSE 7/3 Fri 因美國國慶休市、7/6 Mon 重新開盤；台股為 7/3 Fri 收盤；價格為估算，7/2 美股半導體於 7/1 拉回後止穩）
    ...
    ("記憶", "2344.TW", "華邦電 Winbond","33.00","-1.49%", "⭐ 與 TSMC 合作將 CUBE 特殊 DRAM 導入 WoW 3D 堆疊/SoIC、降低台灣對 Samsung/SK HBM 依賴（台股 7/2 隨大盤補跌、價格為估算）"),
    ...
    ("封裝", "3711.TW", "日月光",      "328",    "-1.20%", "CoWoS / 先進封裝（台股 7/2 隨大盤補跌；先進封裝瓶頸結構受惠）"),
    ...
    ("客戶", "2454.TW", "聯發科",      "4,750",  "-1.04%", "手機 SoC 客戶 9%；台股 7/2 隨大盤補跌；面臨漲價成本；RTX Spark 由聯發科協同 NVIDIA 設計"),
...
CONSENSUS = {
    ...
    "low_target":   "NT$2,100",
    "avg_target_us":"US$490.34",    # 分析師 12 個月平均目標（高 $625 Barclays / 低 $351；自 7/2 收 $434.16 具 +12.9% 上行空間；Barclays 7/2 上調至 $625、Nomura 上調台股目標至 NT$3,425；Goldman 7/1 移出 APAC Conviction List）
    "analyst_count": 32,
    "buy": 32, "hold": 0, "sell": 0,
    "upside":       "+12.94%",  # 從 NYSE 7/2 收 $434.16 至平均目標 $490.34（拉回視為估值修正、共識強力買入；待 7/16 法說會後重估）
}
...
NEWS = [
    {
        ...
        "title": "⚖️ 修正收斂、殺盤趨緩：NYSE TSM 7/2 續跌 -2.27% 收 $434.16（連二跌惟跌幅較 7/1 之 -6.98% 大幅收斂）；台股 2330 7/3 收 NT$2,445（-0.81%）跌幅收斂",
        "body": "半導體 6/30-7/1 修正後殺盤動能衰竭、雙市跌幅收斂：（1）⚖️ NYSE TSM 7/2 Thu 官方收 $434.16（-$10.07、-2.27%、stockanalysis.com 確認、前收 7/1 $444.23、市值約 $2.15 兆、P/E ~37.8），為連二跌（7/1 -6.98%、7/2 -2.27%）、惟跌幅大幅收斂、殺盤動能衰竭；（2）⚖️ 台股 2330 7/3 Fri 官方收 NT$2,445（-20、-0.81% vs 7/2 NT$2,465、量 26,455 張），跌幅較 7/2 之 -1.60% 明顯收斂、守穩 NT$2,410 支撐；（3）🗓️ NYSE 7/3 Fri 因美國國慶（7/4 週六、聯邦假期順延至 7/3）休市、7/6 Mon 重新開盤；台股 7/6 盤中官方收盤待 TWSE；（4）📊 台美 ADR 溢價約 +10.3%（以 7/2 ADR $434.16 + 台股 7/3 NT$2,445、匯率 ~31.05 計、理論值 $393.7）；（5）📌【重要更正】前一份 7/6 報告曾將 NYSE 7/2 收盤「更正」為 +0.13%（$434.71），經 stockanalysis.com 官方收盤複核為誤——正確為 7/2 收 $434.16（-2.27%）、連二跌但跌幅收斂，而非止穩收紅。",
        "source": "stockanalysis.com / CNBC / Yahoo Finance / Yahoo 奇摩股市 / wantgoo 2026-07-02 - 07-03", "impact": "中性",
    },
    {
        "tag": "產業趨勢", "tag_color": "#4CAF50",
        "title": "🚀 分析師大幅續挺：Barclays 將 TSM 目標價自 $470 大幅上調至 $625（維持 Overweight、+43.9% 空間）；Nomura NT$3,425；惟 Goldman 7/1 移出 APAC Conviction List",
        "body": "拉回中分析師逆勢大幅上調、主流強力看多：（1）🚀 Barclays 將 TSMC 目標價自 $470 大幅上調至 $625（維持 Overweight），自 7/2 收 $434.16 隱含約 +43.9% 上行空間，強調 TSMC 為 AI 資本支出循環的終極受惠者、A14/A16 製程領先；（2）📈 Nomura（野村）7/1 大幅上調台股目標至 NT$3,425（自 NT$2,820、+21.5%），自 7/3 收 NT$2,445 隱含約 +40.1% 空間，指 AI 基礎設施投資循環尚未見頂、預期資料中心新增產能 2027 年升至約 32GW；（3）📊 分析師 12 個月平均目標約 $490（強力買入、17-32 位分析師 0 賣出），多數視拉回為估值修正而非基本面惡化；（4）⚠️ 惟 Goldman Sachs 7/1 將 TSM 移出「APAC Conviction List」，屬對近期上檔空間的戰術性調整、並非降評。",
        "source": "Barclays / Nomura / TradingKey / Morningstar / 鉅亨網 2026-07-01 - 07-02", "impact": "正面",
    },
    {
    ...
    {
        "tag": "產業趨勢", "tag_color": "#4CAF50",
        "title": "📈 AI 超級循環續發酵：BofA 上修 2026 全球半導體市場至 $1.3 兆、生成式 AI 晶片估貢獻 ~$500B；費半（SOX）YTD +47%、AI 晶片市值年內增 $2 兆",
        "body": "產業總量再上修、印證 AI 結構性多頭：（1）📈 美銀（BofA）將 2026 全球半導體市場規模自 $1.0 兆上修至 $1.3 兆、估 2030 上看 $2 兆；另有預估 2026 全球晶片銷售達 $975B、其中生成式 AI 晶片貢獻約 $500B（約全球半數）；（2）🚀 費城半導體指數（SOX）年初至今大漲逾 +47%、AI 晶片股年內合計增添約 $2 兆市值；（3）🏆 TSMC 作為 NVIDIA、AMD 主要代工與先進封裝供應商，被視為此結構性擴張最大受惠者；NVIDIA Blackwell 已售罄至 2026 年中、Rubin 架構提前約兩季；（4）⚠️ 惟 6/30-7/1 半導體曾出現獲利了結拋售，市場關注 7/16 Q2 財報與 6 月營收（7 月上旬）能否驗證高成長預期。",
        "source": "BofA / intellectia.ai / aimultiple / Kavout Market Lens 2026-07", "impact": "正面",
    },
    {
