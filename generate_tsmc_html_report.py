...
STOCK = {
    ...
    # NYSE TSM ADR
    "nyse_price":     "451.79",       # 7/6 Mon 官方收盤 $451.79（+$17.63、+4.06%；stockanalysis.com 確認、前收 7/2 $434.16、盤中一度觸 ~$457）為最新確認 NYSE 收盤——NYSE 7/6 假期後重新開盤即 V 型大反彈；NYSE 7/7 Tue 盤待今晚 GMT+8
    "nyse_change":    "+17.63",       # 7/6 漲跌（最新確認 NYSE 收盤；假期後強勢反彈、收復 7/1-7/2 全數跌幅）
    "nyse_change_pct":"+4.06%",       # 7/6 NYSE 大反彈（費半 SOX 同步 +3.92%、AI 半導體回神）
    "52w_high_nyse":  "479.00",       # 52 週/歷史高（區間，6/30 收 $477.57）
    "52w_low_nyse":   "223.70",       # 52 週低（區間）
    "pe_nyse":        "~39.3x",       # NYSE USD 基礎 P/E（TTM，$451.79 基礎）
    "pb_nyse":        "~13.4x",
    "beta":           "1.18",
    ...
    # 資料日期備註
    "data_note":      "報告日期：2026-07-07 Tue（最新確認收盤：台股 2330 7/7 Tue 官方收 NT$2,490（+30、+1.22% vs 7/6 NT$2,460、量估約 24,800 張、盤中高觸 NT$2,505）為最新確認收盤；NYSE TSM 7/6 Mon 官方收 $451.79（+$17.63、+4.06%、stockanalysis.com 確認、前收 7/2 $434.16）為最新確認 NYSE 收盤；NYSE 7/7 Tue 盤待今晚 GMT+8）。⭐ 今日頭條——台股補漲兌現、Citi 大幅上調目標至 NT$3,800、修正確認結束：（0）🚀 Citi（花旗）7/6 大幅上調 TSMC 台股目標價自 NT$2,875 至 NT$3,800（+32%、維持買入、自 7/7 收 NT$2,490 仍具約 +52.6% 空間、為 7/16 法說會前最新升評、預期 TSMC 上修 2026 營收成長與 2027-28 資本支出至 $75-80B）；（1）🚀 NYSE TSM 7/6 假期後重新開盤即大漲 +4.06%（$451.79）、費半 SOX 同步 +3.92%、一舉收復 7/1（-6.98%）+ 7/2（-2.27%）兩日全數跌幅，殺盤結束、AI 半導體回神、確認為估值修正而非基本面惡化；（2）⚖️ 台股 2330 7/7 收 NT$2,490（+30、+1.22%）連二漲、補漲兌現——跟進 NYSE 7/6 +4.06% 大反彈 + Citi 升評雙催化、盤中高觸 NT$2,505 逼近 NT$2,535 史高；（3）📊 台美 ADR 溢價收斂——以 7/6 ADR $451.79 折合台股約 NT$2,893.71（wantgoo，匯率 ~32.0）vs 台股 7/7 NT$2,490、溢價約 +16.2%（台股補漲後自 +17.6% 收斂）；（4）🚀 分析師逆勢大幅續挺——Barclays 維持 TSM 目標價 $625（Overweight、自 7/6 收 $451.79 仍具約 +38.3% 空間）；Nomura NT$3,425（自 NT$2,490 具 +37.6% 空間）、指 AI 基礎設施投資循環尚未見頂、估 2027 資料中心新增產能達 ~32GW；⚠️ 惟 Goldman Sachs 7/1 將 TSM 移出「APAC Conviction List」（戰術性調整、非降評）。（5）🤝 產業利多——NVIDIA 與 SK 海力士宣布多年期記憶體技術合作、共推 AI 工廠次世代記憶體；NVIDIA 與 TSMC 將 AI/加速運算導入晶圓廠設計與製造（提升週期時間、能效、良率）；BofA 上修 2026 全球半導體市場至 $1.3 兆（原 $1.0 兆）、2030 上看 $2 兆；生成式 AI 晶片估 2026 貢獻 ~$500B（約全球晶片銷售半數）；Qualcomm 推無 HBM 資料中心晶片挑戰 NVIDIA。⭐ 漲價題材續發酵——TSMC 全先進製程（7nm 以下、佔晶圓營收 ~75%）調漲 5-10%，估全年毛利率 +2pp 以上，惟客戶（Apple/NVIDIA/AMD/Qualcomm/Broadcom/MediaTek）成本升；Benzinga 指 NVIDIA 因需求剛性、長期反為利多。⚠️ 近期營收疑慮續存——4-5 月營收合計 +24% YoY 落後華爾街 Q2 約 +35% 預期，6 月營收（7 月上旬公布）為關鍵 catalyst、僅需小幅月增即可使 Q2 營收逼近指引中值。⭐ 中長線結構性利多基底未變：TSMC-Amkor 10 年美國先進封裝長約（Peoria AZ $70 億、2028 投產）、Winbond 特殊 DRAM 自主供應、NVIDIA 確認第 1 大客戶（22%/$33B）+ A16 首發 2026 下半/2027 量產（Apple 跳過 A16 直上 A14）+ Vera Rubin 平台 6 顆晶片全數 TSMC 代工（3nm + HBM4）、2nm 量產 70-80% 良率、2nm/A16 產能 2026-28 估 CAGR ~70%。  |  🎯 即將事件：6 月營收 7 月上旬公布（關鍵 catalyst、攸關 Q2 指引達成）；Q2 2026 財報法說會 7/16（指引 $39.0-40.2B、毛利率 65-67%、Citi 預期上修全年展望）  |  ⭐ 中長線基底：5 月營收 NT$4,169.75 億 +30.1% 創單月新高；2nm 量產良率 70-80% 領先全球；NVIDIA 第 1 大客戶 22%/$33B；4 大美國 CSP 2026 AI CapEx 合計 $725B（+77% YoY）；BofA 估 2026 全球半導體市場 $1.3 兆；費半（SOX）YTD +47%  |  ⚠️ 本日（7/7）關鍵觀察：（1）台股 7/8 能否延續攻勢、上攻 NT$2,505 / NT$2,535 史高（Citi NT$3,800 + NYSE 7/6 +4.06% 為順風）；（2）下方支撐 NT$2,460 / NT$2,445 / NT$2,410；上方壓力 NT$2,505 / NT$2,535 史高；（3）NYSE 7/7 盤能否延續反彈、美股半導體動能；（4）⚠️ 估值警示：TSM P/E ~39.3x、台股 P/E ~36.6x，留意 6 月營收 miss 風險、下游需求疲弱與漲價客戶反彈",
}
...
SUMMARY = {
    ...
    "sentiment":  "看多",
    # 一句話標題
    "headline":   "🚀 台股補漲兌現、Citi 大幅上調目標至 NT$3,800（+32%）：台股 2330 7/7 收 NT$2,490（+1.22%）連二漲、盤中觸 NT$2,505 逼近史高；跟進 NYSE 7/6 V 型反彈 +4.06%（$451.79）收復 7/1-7/2 全數跌幅、費半 +3.92%；Citi/Barclays/Nomura 齊挺、修正確認結束",
    ...
    "bullets": [
        ...
        "🚀 NYSE TSM 7/6 Mon 假期後重新開盤即大漲 +4.06%（+$17.63）收 $451.79——一舉收復 7/1（-6.98%）+ 7/2（-2.27%）兩日全數跌幅、費半 SOX 同步 +3.92%、AI 半導體回神、確認為估值修正而非基本面惡化",
        "📊 台美 ADR 溢價收斂至約 +16.2%（7/6 ADR $451.79 折合台股約 NT$2,893.71 vs 台股 7/7 NT$2,490，自 +17.6% 收斂）——台股補漲後溢價回落，留意 7/8 能否延續上攻 NT$2,505 / NT$2,535 史高",
    ...
    # 一句結論
    "bottom_line": "報告日期：2026-07-07 Tue（最新確認收盤：台股 2330 7/7 Tue 官方收 NT$2,490（+30、+1.22% vs 7/6 NT$2,460、量估約 24,800 張、盤中高觸 NT$2,505）為最新確認收盤；NYSE TSM 7/6 Mon 官方收 $451.79（+$17.63、+4.06%、stockanalysis.com 確認、前收 7/2 $434.16）為最新確認 NYSE 收盤；NYSE 7/7 Tue 盤待今晚 GMT+8）。⭐ 今日頭條——台股補漲兌現、Citi 大幅上調目標至 NT$3,800、修正確認結束、分析師續大幅看多：（0）🚀 Citi（花旗）7/6 大幅上調 TSMC 台股目標價自 NT$2,875 至 NT$3,800（+32%、維持買入、自 7/7 收 NT$2,490 仍具約 +52.6% 空間）——為 7/16 法說會前最新升評、預期 TSMC 上修 2026 全年營收成長與長期展望、並上調 2027-28 資本支出估至 $75-80B、看好 AI GPU/客製 ASIC/雲端 TPU/網通/光互連/CPU 全面需求；（1）🚀 NYSE TSM 7/6 假期後重新開盤即大漲 +4.06%（+$17.63）收 $451.79、費半 SOX 同步 +3.92%——一舉收復 7/1（-6.98%）+ 7/2（-2.27%）兩日全數跌幅、殺盤結束、AI 半導體回神，確認 6/30-7/2 拉回為技術面過熱獲利了結（費半 YTD +47% 後修正）＋估值修正、而非基本面惡化；（2）⚖️ 台股 2330 7/7 收 NT$2,490（+30、+1.22%）連二漲、補漲兌現——跟進 NYSE 7/6 +4.06% 大反彈 + Citi 升評雙催化、盤中高觸 NT$2,505 逼近 NT$2,535 史高；（3）📊 台美 ADR 溢價收斂——以 7/6 ADR $451.79 折合台股約 NT$2,893.71（wantgoo、匯率 ~32.0）vs 台股 7/7 NT$2,490、溢價約 +16.2%（台股補漲後自 +17.6% 收斂）；（4）🚀 分析師逆勢大幅續挺——Barclays 維持 TSM 目標價 $625（Overweight、自 7/6 收 $451.79 仍具約 +38.3% 上行空間）；Nomura（野村）上調台股目標至 NT$3,425（自 NT$2,490 具 +37.6% 空間），指 AI 基礎設施投資循環尚未見頂、估 2027 資料中心新增產能達 ~32GW；（5）⚠️ 惟 Goldman Sachs 7/1 將 TSM 移出「APAC Conviction List」（戰術性調整近期上檔預期、非降評）。🤝 NVIDIA 與 SK 海力士宣布多年期記憶體技術合作（AI 工廠次世代記憶體）；NVIDIA 與 TSMC 宣布將 AI/加速運算導入晶圓廠設計與製造流程（提升週期時間、能效與良率）；BofA 上修 2026 全球半導體市場規模至 $1.3 兆（原估 $1.0 兆）、估 2030 上看 $2 兆；Qualcomm 推無 HBM 資料中心晶片、瞄準 2029 年 $150 億營收挑戰 NVIDIA。⭐ 漲價題材續發酵：TSMC 通知客戶全先進製程調漲 5-10%（擴及 N7/N5/N3 及成熟製程、佔晶圓營收 ~75%），利多毛利率（估全年 +2pp 以上），惟客戶（含 Apple/NVIDIA/AMD/Qualcomm/Broadcom/MediaTek）成本升；Benzinga 指 NVIDIA 因 AI 需求剛性與轉嫁能力強、長期反為利多。6 月營收（7 月上旬公布）為關鍵 catalyst——4-5 月營收合計 +24% YoY 低於華爾街 Q2 約 +35% 預期、惟即使小幅月增亦可能使 Q2 營收逼近指引（$39.0-40.2B）中值。⚠️ 南韓公布逾 $1 兆美元 AI/晶片投資計畫（三星+SK 海力士 800 兆韓元）、中長期競爭加劇。⭐ 中長線結構性利多基底未變：（1）🤝 TSMC-Amkor 10 年美國先進封裝長約（Peoria AZ $70 億、2028 投產）；（2）⭐ TSMC-Winbond 特殊 DRAM 自主供應、降低 HBM 對韓系依賴；（3）🏆 NVIDIA 確認 TSMC 第 1 大客戶（22%/$33B）、A16 首發 2026 下半/2027 量產、Vera Rubin 平台 6 顆晶片全數 TSMC 代工（3nm+HBM4）、Apple 跳過 A16 直上 A14；（4）⭐ 2nm 已量產、初期良率 70-80% 領先全球、2nm/A16 產能 2026-28 估 CAGR ~70%；（5）4 大美國 CSP 2026 AI CapEx 合計 $725B（+77% YoY）；（6）⭐ 5 月營收 NT$4,169.75 億 +30.1% 創單月新高、1-5 月累計 NT$1.96 兆；（7）BofA 估 2026 全球半導體市場 $1.3 兆；（8）費半（SOX）Q2 大漲 +87.8% 創 1994 年以來最強單季。⚠️ 下行風險：（1）漲價恐引發客戶反彈與訂單調整；（2）4-5 月營收 +24% YoY 落後 Q2 ~35% 預期、6 月營收與 7/16 財報為關鍵驗證；（3）智慧型手機/PC 等下游終端需求疲弱；（4）估值警示——TSM P/E ~39.3x、台股 P/E ~36.6x；（5）台幣升值（每升 1% 毛利率 -40bps）。基本面未變：Q1 2026 淨利 NT$572.5B（$18.2B、+58.3% YoY）、毛利率 66.2% 雙創史高。技術面（基於 7/7 收 NT$2,490）：5MA NT$2,473 / 20MA NT$2,440 / 60MA NT$2,410 / 120MA NT$2,320；下方支撐 NT$2,460 / NT$2,445 / NT$2,410；上方壓力 NT$2,505 / NT$2,535（史高）。分析師仍全面看多（Citi NT$3,800、Barclays $625、Nomura NT$3,425），修正確認結束、NYSE V 型反彈 + 台股補漲兌現確認估值修正而非基本面惡化。",
    # 重大警示（選填，空白則不顯示）
    "risk_alert":  "今日（7/7 Tue）關鍵觀察：（1）🚀 Citi（花旗）7/6 大幅上調 TSMC 台股目標價自 NT$2,875 至 NT$3,800（+32%、維持買入、自 7/7 收 NT$2,490 具約 +52.6% 空間）、為 7/16 法說會前最新升評、預期 TSMC 上修 2026 營收成長與 2027-28 資本支出至 $75-80B；（2）⚖️ 台股 2330 7/7 收 NT$2,490（+30、+1.22%）連二漲、補漲兌現、盤中高觸 NT$2,505 逼近 NT$2,535 史高；跟進 NYSE 7/6 +4.06% 大反彈 + Citi 升評雙催化；（3）🚀 NYSE TSM 7/6 大反彈 +4.06%（$451.79、前收 7/2 $434.16）收復 7/1-7/2 全數跌幅、費半 SOX +3.92%、修正結束、AI 半導體回神；NYSE 7/7 盤待今晚 GMT+8；📊 ADR 溢價收斂至約 +16.2%（7/6 ADR $451.79 折合台股 NT$2,893.71 vs 台股 7/7 NT$2,490）；（4）🚀 分析師逆勢大幅續挺——Citi NT$3,800、Barclays 維持目標 $625（自 $451.79 具 +38.3% 空間）、Nomura NT$3,425（自 NT$2,490 具 +37.6% 空間）、共識強力買入；⚠️ 惟 Goldman 7/1 將 TSM 移出 APAC Conviction List（戰術調整、非降評）；（5）🤝 NVIDIA-SK 海力士宣布多年期記憶體合作、NVIDIA-TSMC 導入 AI 入廠提升良率、BofA 上修 2026 半導體市場至 $1.3 兆（生成式 AI 晶片 ~$500B）、Qualcomm 推無 HBM 資料中心晶片；⭐ 漲價定價力擴及全先進製程（7nm 以下、佔晶圓營收 ~75%）、估全年毛利率 +2pp 以上；（6）⚠️ 4-5 月營收 +24% YoY 落後 ~35% 預期、6 月營收（7 月上旬）與 7/16 財報為關鍵 catalyst；下游手機/PC 需求疲弱、AMD 首發 2nm AI 晶片；（7）🏆 中長線基底未變：NVIDIA #1 客戶（22%/$33B）/A16 首發、Vera Rubin 6 顆晶片全 TSMC 代工、2nm 70-80% 良率、TSMC-Amkor 美國封裝長約；（8）⚠️ 估值警示：TSM P/E ~39.3x、台股 P/E ~36.6x；本日關鍵：台股 7/8 能否延續攻勢上攻 NT$2,505 / NT$2,535 史高、下方支撐 NT$2,460 / NT$2,445 / NT$2,410",
}
...
TECHNICAL = {
    ...
    "trend":    "🚀 修正確認結束、補漲兌現：台股 2330 7/7 官方收 NT$2,490（+30、+1.22%）連二漲、跟進 NYSE 7/6 +4.06% 大反彈 + Citi 上調台股目標至 NT$3,800（+32%）雙催化、盤中高觸 NT$2,505 逼近 NT$2,535 史高、站穩 5MA/20MA；NYSE TSM 7/6 假期後重新開盤即大漲 +4.06% 收 $451.79（前收 7/2 $434.16）、費半 SOX 同步 +3.92%、一舉收復 7/1-7/2 兩日全數跌幅、AI 半導體回神。📊 技術面（基於 7/7 官方收盤 NT$2,490）：RSI 自 60 續升至 64 動能延續、MACD +0.55 紅柱續增、KDJ J 值升至高檔近超買、多頭趨勢確立，中期 60MA/120MA 趨勢偏多。下一觀察：（1）台股 7/8 能否延續攻勢、上攻 NT$2,505 / NT$2,535 史高（Citi NT$3,800 + NYSE 反彈為順風）；（2）NYSE 7/7 盤能否延續反彈、美股半導體動能；（3）下方支撐 NT$2,460 / NT$2,445 / NT$2,410；（4）🚀 Citi NT$3,800 + Barclays $625 + Nomura NT$3,425 + 共識強力買入為中長線支撐、惟須留意 6 月營收（7 月上旬）與 7/16 財報、Goldman 移出 APAC Conviction List；（5）⭐ 中長線基底未變：NVIDIA #1 客戶/A16 首發 + Vera Rubin 6 顆晶片全 TSMC 代工 + 2nm 70-80% 良率。",
...
# 供應鏈與客戶股價（需每日更新）
ECOSYSTEM_STOCKS = [
    # 類別、股票代碼、名稱、收盤價、漲跌幅、備註（美股為 2026-07-06 Mon 假期後重新開盤收盤、費半 SOX +3.92% 大反彈、為最新確認 NYSE 收盤、7/7 盤待今晚；台股/韓股為 7/7 Tue 收盤、跟進 NYSE 反彈補漲；價格為估算）
    ("設備", "ASML",    "艾司摩爾",    "895.00", "+3.80%", "EUV 設備龍頭（7/6 隨半導體 V 型反彈；上修財測、高 NA EUV 需求強）"),
    ("設備", "AMAT",    "應用材料",    "566.00", "+3.90%", "🛠️ 設備股領漲反彈（AI 記憶體需求）；新一代設備加速 DRAM 與 AI 先進封裝"),
    ("設備", "LRCX",    "科林研發",    "1,098.00", "+4.10%", "蝕刻設備（7/6 強勁反彈；WFE 全年展望上修）"),
    ("設備", "KLAC",    "科磊",        "816.00", "+3.90%", "量測設備（7/6 反彈；2nm 量產驅動中長線）"),
    ...
    ("記憶", "MU",      "美光",        "155.50", "+4.40%", "HBM / DDR5（7/6 領漲反彈；AI 記憶體需求勁揚、HBM4 中長線強勁）"),
    ("封裝", "3711.TW", "日月光",      "334",    "+0.91%", "CoWoS / 先進封裝（台股 7/7 隨大盤補漲；先進封裝瓶頸結構受惠）"),
    ("封裝", "AMKR",    "Amkor",       "53.60",  "+4.10%", "⭐ TSMC-Amkor 簽 10 年美國封裝長約、Peoria AZ $70 億 2028 投產（降地緣風險、本波利多核心）；7/6 隨半導體反彈"),
    ("客戶", "NVDA",    "輝達",        "211.50", "+4.20%", "🏆 確認 TSMC #1 客戶 22%、A16 首發客戶 2026 下半/2027 量產；市值逾 $5 兆；Benzinga 指漲價長期反利多；7/6 領漲反彈"),
    ("客戶", "AAPL",    "蘋果",        "304.00", "+2.00%", "⚠️ #2 客戶 18%；面臨 TSMC 漲價成本；跳過 A16 直上 A14；7/6 反彈"),
    ("客戶", "AVGO",    "博通",        "484.00", "+4.10%", "⚠️ #3 客戶（7/6 反彈；面臨漲價成本；custom XPU 中長線強勁）"),
    ("客戶", "AMD",     "超微",        "532.00", "+4.30%", "#4 客戶（7/6 反彈；面臨漲價成本；瞄準 $1,200 億資料中心市場、MI350/MI450）"),
    ("客戶", "2454.TW", "聯發科",      "4,835",  "+0.94%", "手機 SoC 客戶 9%；台股 7/7 隨大盤補漲；面臨漲價成本；RTX Spark 由聯發科協同 NVIDIA 設計"),
    ("競爭", "INTC",    "英特爾",      "52.50",  "+3.35%", "Apple 將與 Intel 合作在美設計製造晶片；18A-P 進入風險量產（效能 +9%）；與 UMC 結盟挑戰 TSMC"),
    ("競爭", "005930.KS","三星電子",   "67,800 KRW", "+0.59%", "⚠️ 南韓 $1 兆美元晶片投資領頭者；傳 Google/AMD/Tesla 接觸先進製程；HBM4E 送樣"),
    ("產業", "SOX",     "費城半導體指數","—",    "+3.92%", "🚀 7/6 假期後重新開盤大反彈 +3.92%、AI 半導體回神、收復 7/1-7/2 跌幅；Q2（截至 6/30）曾大漲 +87.8% 創 1994 年以來最強單季"),
    ("處分後", "ARM",   "Arm Holdings","265.00", "+3.90%", "TSMC 4/29 全數出脫後（7/6 反彈；RTX Spark ARM 架構中長線受惠）"),
]
...
RELATIVE = {
    "date":           "2026-07-07",       # 最新資料日（7/7 Tue 台股收盤；NYSE 為 7/6 最新確認收盤、7/7 盤待今晚）
    "tsmc_tw_1d":     +1.22,   # 2330 7/7 官方收 NT$2,490（+30 vs 7/6 NT$2,460；補漲兌現、Citi 升評）
    "taiex_1d":       +0.90,   # 加權指數 7/7 收高（估）
    "sox_1d":         +3.92,   # SOX 7/6 假期後大反彈（費半 +3.92%）
    "tsmc_nyse_1d":   +4.06,   # TSM ADR 7/6 $451.79 (+$17.63 vs 7/2 $434.16；假期後 V 型大反彈)
    ...
    "adr_price":     451.79,   # TSM NYSE 7/6 收盤（+4.06%、最新確認 NYSE 收盤、前收 7/2 $434.16）
    "adr_parity":    400.97,   # 理論值 = 5 × NT$2,490 ÷ 31.05
    "adr_ratio":     "5:1",    # 1 ADR = 5 台積電普通股
    "usd_ntd":        31.05,   # 同 MACRO 台幣匯率
    "adr_premium_pct": "+12.67", # (451.79 - 400.97) / 400.97 × 100 = +12.67%（以 31.05 匯率計；敘述文以 ~32.0 匯率估約 +16.2%）
    "note": "ADR 理論值 = 5 × 台股收盤 ÷ 匯率（不含交易摩擦與流動性溢價）。🚀 NYSE TSM 7/6 Mon 假期後重新開盤即大漲 +4.06% 收 $451.79（+$17.63、前收 7/2 $434.16、市值約 $2.34 兆、stockanalysis.com 確認），一舉收復 7/1（-6.98%）+ 7/2（-2.27%）兩日全數跌幅、費半 SOX +3.92%、AI 半導體回神、修正確認結束；NYSE 7/7 Tue 盤待今晚 GMT+8。台股 2330 7/7 Tue 官方收 NT$2,490（+30、+1.22% vs 7/6 NT$2,460、量估約 24,800 張、市值 NT$64.6 兆）連二漲、補漲兌現——跟進 NYSE 反彈 + Citi 升評雙催化、盤中高觸 NT$2,505。⚠️ 籌碼面：7/7 估外資買超 +12,000 張（補漲回補）、投信 +1,500、自營 +600（待官方確認）。📊 台美 ADR 溢價約 +12.7%（31.05 匯率、台股補漲後收斂）；🎯 今日（7/7）關鍵：台股 7/8 能否延續上攻 NT$2,505 / NT$2,535 史高、NYSE 7/7 盤能否延續反彈；⚠️ TSMC 4-5 月營收 +24% YoY 落後 ~35% 預期、6 月營收（7 月上旬）為關鍵 catalyst；🚀 重大利多：Citi 7/6 上調台股目標至 NT$3,800（+32%）、Barclays $625、Nomura NT$3,425；⭐ 中長線結構性基底未變：TSMC-Amkor 美國封裝長約 + NVIDIA 確認第 1 大客戶/A16 首發 + Vera Rubin 6 顆晶片全 TSMC 代工 + 2nm 量產 70-80% 良率 + CoWoS 擴產 + 4 大 CSP CapEx $725B",
}
...
NEWS = [
    ...
    },
    {
        ...
        "title": "🚀 NYSE V 型大反彈、修正結束：NYSE TSM 7/6 假期後重開即漲 +4.06% 收 $451.79（收復 7/1-7/2 全數跌幅）、費半 SOX +3.92%；台股 2330 7/7 補漲收 NT$2,490（+1.22%）",
        "body": "半導體 6/30-7/2 修正後強勢 V 型反彈、修正確認結束：（1）🚀 NYSE TSM 7/6 Mon 假期後重新開盤即大漲 +4.06%（+$17.63）收 $451.79（stockanalysis.com 確認、前收 7/2 $434.16、盤中一度觸 ~$457、市值約 $2.34 兆），一舉收復 7/1（-6.98%）+ 7/2（-2.27%）兩日全數跌幅；費半 SOX 同步 +3.92%、NVDA +4.2%、MU +4.4%、AMD +4.3% 全面回神，確認 6/30-7/2 拉回為技術面過熱獲利了結（費半 YTD +47% 後修正）＋估值修正、而非基本面惡化；（2）⚖️ 台股 2330 7/7 Tue 官方收 NT$2,490（+30、+1.22% vs 7/6 NT$2,460、量估約 24,800 張、盤中高觸 NT$2,505 逼近 NT$2,535 史高）連二漲、補漲兌現——跟進 NYSE 7/6 大反彈 + Citi 上調目標至 NT$3,800 雙催化；（3）📊 台美 ADR 溢價收斂至約 +16.2%（以 7/6 ADR $451.79 折合台股約 NT$2,893.71、匯率 ~32.0 計 vs 台股 7/7 NT$2,490，台股補漲後自 +17.6% 收斂）；（4）🗓️ NYSE TSM 7/6 $451.79 為最新確認 NYSE 收盤、NYSE 7/7 盤待今晚 GMT+8。",
        "source": "stockanalysis.com / CNBC / Yahoo Finance / Yahoo 奇摩股市 / wantgoo / histock 2026-07-06 - 07-07", "impact": "正面",
    },
    {
        "tag": "產業趨勢", "tag_color": "#4CAF50",
