...
STOCK = {
    # 台股 2330
    "tw_price":       "2,465",        # 2026-07-02 Thu 官方收盤（-40、-1.60% vs 7/1 NT$2,505；預測之補跌兌現、惟僅部分補跌、守穩 NT$2,450 支撐、終結連 3 漲）
    ...
    # NYSE TSM ADR
    "nyse_price":     "444.23",       # 7/1 Wed 收盤（-$33.34，-6.98%；為 7/2 台股報告時最新確認收盤；夜盤重挫後盤後回升 +$3.35 至約 $447.58；7/2 美股盤待今晚開盤；市值約 $2.30 兆、P/E ~38.6）
    "nyse_change":    "-33.34",       # 7/1 漲跌（最新確認收盤、4:00 PM EDT；7/2 美股盤待今晚）
    "nyse_change_pct":"-6.98%",       # 7/1 NYSE 重挫（自 6/30 史新高 $477.57 獲利了結、估值修正、需求疑慮；盤後回升 +$3.35 至約 $447.58 止跌）
    ...
    # 資料日期備註
    "data_note":      "報告日期：2026-07-02 Thu（台股 2330 7/2 Thu 官方收盤 NT$2,465（-40、-1.60%）；NYSE TSM 7/1 Wed 收盤 $444.23（-6.98%）為 7/2 台股報告時最新確認收盤、盤後回升 +$3.35 至約 $447.58、7/2 美股盤待今晚開盤）。⚠️ 今日頭條——前報預測之台股補跌兌現、惟相對抗跌：（1）📉 台股 2330 7/2 官方收盤 NT$2,465（-40、-1.60%、量約 35,000 張）跟進 NYSE 7/1 夜盤重挫 -6.98% 補跌、終結連 3 漲——⭐ 惟跌幅（-1.60%）遠小於美股（-6.98%）、守穩 NT$2,450 心理整數支撐、相對抗跌；（2）📉 NYSE TSM 7/1 重挫 -6.98%（-$33.34）收 $444.23、自 6/30 史新高 $477.57 大幅回落、市值約 $2.30 兆（P/E ~38.6），催化——技術面過熱獲利了結（費半 Q2 +87.8% 史上最強單季後拉回）、估值修正、4-5 月營收合計 +24% YoY 落後華爾街 Q2 約 +35% 預期、下游手機/PC 需求疲弱、7/16 財報前觀望；盤後回升 +$3.35 至約 $447.58 顯示殺盤趨緩；（3）🚀 重大利多——Nomura（野村）7/1 大幅上調 TSM 目標價自 NT$2,820 至 NT$3,425（自 7/2 收 NT$2,465 具 +38.9% 上行空間），指 AI 基礎設施投資循環尚未見頂、估 2027 資料中心新增產能達 ~32GW；（4）📊 分析師共識仍全面偏多——17 位分析師 Strong Buy、0 賣出、平均目標 $487.56（自 7/1 收 $444.23 具 +9.8% 上行空間），拉回被視為估值修正而非基本面惡化；（5）📊 台美 ADR 溢價（以 7/1 ADR $444.23 + 台股 7/2 NT$2,465、匯率 31.05 計）：理論值 5×2,465÷31.05 = $396.94、溢價 (444.23-396.94)/396.94 = +11.91%（台股 7/2 僅部分補跌、溢價自 +10.13% 微升、顯示台股相對抗跌、補跌壓力大致釋放）。⭐ 漲價題材續發酵——TSMC 通知客戶全先進製程調漲 5-10%（擴及 N7/N5/N3 及成熟製程、佔晶圓營收 ~74%），利多毛利率（估全年 +2pp 以上），惟客戶（含 Apple/NVIDIA/AMD/Qualcomm/Broadcom/MediaTek）成本升；Benzinga 指 NVIDIA 因 AI 需求剛性與轉嫁能力強、長期反為利多。⚠️ 近期營收疑慮續存——6 月營收（7 月上旬公布）為關鍵 catalyst、僅需小幅月增即可使 Q2 營收逼近指引中值。⚠️ 南韓公布逾 $1 兆美元 AI/晶片投資計畫（三星+SK 海力士 800 兆韓元），中長期競爭加劇。⭐ 中長線結構性利多基底未變：TSMC-Amkor 10 年美國先進封裝長約（Peoria AZ $70 億、2028 投產）、Winbond 特殊 DRAM 自主供應、NVIDIA 確認第 1 大客戶（22%/$33B）+ A16 首發 2026 下半/2027 量產（Apple 跳過 A16 直上 A14）+ Vera Rubin 平台 6 顆晶片全數 TSMC 代工、2nm 量產 70-80% 良率、2nm/A16 產能 2026-28 估 CAGR ~70%。  |  🎯 即將事件：6 月營收 7 月上旬公布（關鍵 catalyst、攸關 Q2 指引達成）；Q2 2026 財報法說會 7/16（指引 $39.0-40.2B、毛利率 65-67%、漲價後上修空間）  |  ⭐ 中長線基底：5 月營收 NT$4,169.75 億 +30.1% 創單月新高；2nm 量產良率 70-80% 領先全球；NVIDIA 第 1 大客戶 22%/$33B；4 大美國 CSP 2026 AI CapEx 合計 $725B（+77% YoY）；2026 全球半導體市場估 +26% YoY 達 ~$975B；費半（SOX）Q2 大漲 +87.8% 創 1994 年以來最強單季  |  ⚠️ 本日（7/2）關鍵觀察：（1）台股 7/2 補跌 -1.60% 兌現、守穩 NT$2,450 支撐、留意 7/3 能否止穩（NYSE 盤後回升 +$3.35 降低恐慌）；（2）ADR 溢價自 +10.13% 微升至 +11.91%、台股相對抗跌、補跌壓力大致釋放；（3）下方支撐 NT$2,450 / NT$2,410 / NT$2,370；上方壓力 NT$2,505 / NT$2,535 史高；（4）⚠️ 估值警示：TSM P/E ~38.6x、台股 P/E ~36.3x，留意 6 月營收 miss 風險、下游需求疲弱與漲價客戶反彈",
}
...
SUMMARY = {
    ...
    "sentiment":  "中性偏多",
    # 一句話標題
    "headline":   "📉 補跌兌現、惟相對抗跌：台股 2330 7/2 收 NT$2,465（-1.60%）跟進 NYSE 7/1 夜盤重挫 -6.98% 補跌、終結連 3 漲，惟跌幅遠小於美股、守穩 NT$2,450 支撐；⭐ Nomura 大幅上調目標價至 NT$3,425（+38.9% 空間）",
    # 3–5 條白話重點（不用術語，每條約 30 字內）
    "bullets": [
        "📉 台股 2330 7/2 官方收盤 NT$2,465（-40、-1.60%、量約 35,000 張）跟進 NYSE 7/1 夜盤重挫補跌、終結連 3 漲——⭐ 惟跌幅遠小於美股 -6.98%、守穩 NT$2,450 支撐、相對抗跌",
        "📉 NYSE TSM 7/1 Wed 重挫 -6.98%（-$33.34）收 $444.23、自 6/30 史新高 $477.57 大幅回落——技術過熱獲利了結+估值修正+需求疑慮；盤後回升 +$3.35 至約 $447.58 顯示殺盤趨緩",
        "🚀 重大利多：Nomura（野村）7/1 大幅上調 TSM 目標價自 NT$2,820 至 NT$3,425（自 7/2 收 NT$2,465 具 +38.9% 空間）——指 AI 基礎設施投資循環尚未見頂、2027 資料中心新增產能達 ~32GW",
        "📊 ADR 溢價自 +10.13% 微升至 +11.91%（以 7/1 ADR $444.23 + 台股 7/2 NT$2,465、匯率 31.05 計）——台股僅部分補跌、相對抗跌、補跌壓力大致釋放",
        "📈 分析師共識仍全面偏多：17 位 Strong Buy、0 賣出、平均目標 $487.56（自 7/1 收 $444.23 具 +9.8% 上行空間）——拉回被視為估值修正而非基本面惡化",
        "⭐ 漲價題材續發酵：全先進製程調漲 5-10%（含 N7/N5/N3、佔晶圓營收 ~74%）、估貢獻全年毛利率 +2pp 以上；Benzinga 指 NVIDIA 可轉嫁、長期反利多",
        "🏆 中長線基底未變：NVIDIA #1 客戶（22%/$33B）/A16 首發 + Vera Rubin 6 顆晶片全 TSMC 代工 + TSMC-Amkor 美國封裝長約 + 2nm 70-80% 良率；費半 Q2 +87.8% 史上最強單季",
        "⚠️ 風險續追蹤：4-5 月營收 +24% YoY 落後 ~35% 預期、6 月營收（7 月上旬）與 7/16 財報為關鍵；下游手機/PC 需求疲弱；南韓 $1 兆晶片投資；估值偏高（TSM P/E ~38.6x、台股 ~36.3x）",
    ],
    # 一句結論
    "bottom_line": "報告日期：2026-07-02 Thu（台股 2330 7/2 Thu 官方收盤 NT$2,465（-40、-1.60%）；NYSE TSM 7/1 Wed 收盤 $444.23（-6.98%）為 7/2 台股報告時最新確認收盤、盤後回升 +$3.35 至約 $447.58、7/2 美股盤待今晚開盤）。⚠️ 今日頭條——前報預測之台股補跌兌現、惟相對抗跌：（1）📉 台股 2330 7/2 官方收盤 NT$2,465（-40、-1.60%、量約 35,000 張）跟進 NYSE 7/1 夜盤重挫 -6.98% 補跌、終結連 3 漲——⭐ 惟跌幅（-1.60%）遠小於美股（-6.98%）、守穩 NT$2,450 心理整數支撐、相對抗跌，顯示補跌壓力大致釋放；（2）📉 NYSE TSM 7/1 重挫 -6.98%（-$33.34）收 $444.23、自 6/30 史新高 $477.57 大幅回落、市值約 $2.30 兆（P/E ~38.6），催化——技術面過熱獲利了結（費半 Q2 +87.8% 史上最強單季後拉回）、估值修正、4-5 月營收 +24% YoY 落後華爾街 Q2 約 +35% 預期、下游手機/PC 需求疲弱、7/16 財報前觀望；⚠️ 惟盤後回升 +$3.35 至約 $447.58 顯示殺盤趨緩、非基本面惡化；（3）🚀 重大利多——Nomura（野村）7/1 大幅上調 TSM 目標價自 NT$2,820 至 NT$3,425（自 7/2 收 NT$2,465 具 +38.9% 上行空間），指 AI 基礎設施投資循環尚未見頂、估 2027 資料中心新增產能達 ~32GW、AI 晶片需求延續；（4）📊 分析師共識仍全面偏多——17 位分析師 Strong Buy、0 賣出、平均目標 $487.56（自 7/1 收 $444.23 具 +9.8% 上行空間）。📊 台美 ADR 溢價（以 7/1 ADR $444.23 + 台股 7/2 NT$2,465、匯率 31.05 計）：理論值 5×2,465÷31.05 = $396.94、溢價 +11.91%（台股 7/2 僅部分補跌、溢價自 +10.13% 微升、顯示台股相對抗跌、補跌壓力大致釋放）。⭐ 漲價題材續發酵：TSMC 通知客戶全先進製程調漲 5-10%（擴及 N7/N5/N3 及成熟製程、佔晶圓營收 ~74%），利多毛利率（估全年 +2pp 以上），惟客戶（含 Apple/NVIDIA/AMD/Qualcomm/Broadcom/MediaTek）成本升；Benzinga 指 NVIDIA 因 AI 需求剛性與轉嫁能力強、長期反為利多。6 月營收（7 月上旬公布）為關鍵 catalyst——4-5 月營收合計 +24% YoY 低於華爾街 Q2 約 +35% 預期、惟即使小幅月增亦可能使 Q2 營收逼近指引（$39.0-40.2B）中值。⚠️ 南韓公布逾 $1 兆美元 AI/晶片投資計畫（三星+SK 海力士 800 兆韓元）、中長期競爭加劇。⭐ 中長線結構性利多基底未變：（1）🤝 TSMC-Amkor 10 年美國先進封裝長約（Peoria AZ $70 億、2028 投產）；（2）⭐ TSMC-Winbond 特殊 DRAM 自主供應、降低 HBM 對韓系依賴；（3）🏆 NVIDIA 確認 TSMC 第 1 大客戶（22%/$33B）、A16 首發 2026 下半/2027 量產、Vera Rubin 平台 6 顆晶片全數 TSMC 代工、Apple 跳過 A16 直上 A14；（4）⭐ 2nm 已量產、初期良率 70-80% 領先全球、2nm/A16 產能 2026-28 估 CAGR ~70%；（5）4 大美國 CSP 2026 AI CapEx 合計 $725B（+77% YoY）；（6）⭐ 5 月營收 NT$4,169.75 億 +30.1% 創單月新高、1-5 月累計 NT$1.96 兆；（7）2026 全球半導體市場估 +26% YoY 達 ~$975B；（8）費半（SOX）Q2 大漲 +87.8% 創 1994 年以來最強單季。⚠️ 下行風險：（1）漲價恐引發客戶反彈與訂單調整；（2）4-5 月營收 +24% YoY 落後 Q2 ~35% 預期、6 月營收與 7/16 財報為關鍵驗證；（3）智慧型手機/PC 等下游終端需求疲弱；（4）估值警示——TSM P/E ~38.6x、台股 P/E ~36.3x；（5）台幣升值（每升 1% 毛利率 -40bps）。基本面未變：Q1 2026 淨利 NT$572.5B（$18.2B、+58.3% YoY）、毛利率 66.2% 雙創史高。技術面（基於 7/2 收 NT$2,465）：5MA NT$2,423 / 20MA NT$2,420 / 60MA NT$2,390 / 120MA NT$2,290；RSI 回落至 60 中性偏多、KDJ J 值自超買回落、MACD 紅柱縮短但仍為正；下方支撐 NT$2,450 / NT$2,410 / NT$2,370；上方壓力 NT$2,505 / NT$2,535（史高）。分析師仍全面看多（17 位 Strong Buy、平均目標 $487.56、Nomura 上調至 NT$3,425），拉回被視為估值修正而非基本面惡化。",
    # 重大警示（選填，空白則不顯示）
    "risk_alert":  "今日（7/2 Thu）關鍵觀察：（1）📉 前報預測之台股補跌兌現——台股 2330 7/2 收 NT$2,465（-1.60%）跟進 NYSE 7/1 夜盤重挫 -6.98% 補跌、終結連 3 漲，⭐ 惟跌幅遠小於美股、守穩 NT$2,450 支撐、相對抗跌，顯示補跌壓力大致釋放（NYSE 盤後回升 +$3.35 降低恐慌）；（2）📊 ADR 溢價自 +10.13% 微升至 +11.91%、台股相對抗跌；（3）🚀 Nomura 大幅上調目標價自 NT$2,820 至 NT$3,425（自 NT$2,465 具 +38.9% 空間）；分析師共識仍全面偏多——17 位 Strong Buy、平均目標 $487.56（自 $444.23 具 +9.8% 空間）、拉回視為估值修正；（4）⭐ 漲價定價力、擴及全先進製程（佔晶圓營收 ~74%）、估全年毛利率 +2pp 以上；Benzinga 指 NVIDIA 可轉嫁長期反利多；（5）⚠️ 4-5 月營收 +24% YoY 落後 ~35% 預期、6 月營收（7 月上旬）與 7/16 財報為關鍵 catalyst；（6）⚠️ 下游手機/PC 需求疲弱、南韓 $1 兆晶片投資中長期競爭加劇；（7）🏆 中長線基底未變：NVIDIA #1 客戶（22%/$33B）/A16 首發、Vera Rubin 6 顆晶片全 TSMC 代工、2nm 70-80% 良率、TSMC-Amkor 美國封裝長約、費半 Q2 +87.8% 史上最強單季；（8）⚠️ 估值警示：TSM P/E ~38.6x、台股 P/E ~36.3x；本日關鍵：台股 7/3 能否止穩、守穩 NT$2,450 / NT$2,410；上方壓力 NT$2,505 / NT$2,535 史高",
}
...
TECHNICAL = {
    ...
    "trend":    "📉 補跌兌現、惟相對抗跌：台股 2330 7/2 官方收盤 NT$2,465（-40、-1.60%、量約 35,000 張）跟進 NYSE 7/1 夜盤重挫 -6.98% 補跌、終結連 3 漲；⭐ 惟跌幅遠小於美股、守穩 NT$2,450 心理整數支撐、仍站穩 5MA NT$2,423 / 20MA NT$2,420。📊 技術面（基於 7/2 官方收盤 NT$2,465）：RSI 自 68 回落至 60 退出漸近超買區、MACD +0.50 紅柱縮短但仍為正、KDJ J 值自超買高檔（104）回落至 84 退出超買、短線過熱壓力緩解，中期 60MA/120MA 趨勢仍偏多。下一觀察：（1）台股 7/3 能否止穩、守穩 NT$2,450 / NT$2,410 支撐（NYSE 盤後回升 +$3.35 降低恐慌）；（2）下方支撐 NT$2,450 / NT$2,410 / NT$2,370；（3）上方壓力 NT$2,505 / NT$2,535 史高；（4）🚀 Nomura 上調目標至 NT$3,425 + 共識偏多（17 位 Strong Buy、目標 $487.56）為中長線支撐、惟須留意 6 月營收（7 月上旬）與 7/16 財報；（5）⭐ 中長線基底未變：NVIDIA #1 客戶/A16 首發 + Vera Rubin 6 顆晶片全 TSMC 代工 + 2nm 70-80% 良率 + 費半 Q2 +87.8% 史上最強單季。",
    "support":  "2,450 / 2,410 / 2,370 / 2,340 (7/2 守穩、整數、整數、整數)",
    "resist":   "2,505 / 2,535 / 2,560 (7/1 收、史高、布林上軌)",
    "note": "技術指標數值為估算（基於 7/2 官方收盤 NT$2,465），請以看盤軟體即時數據為準；台股 7/2 補跌 -1.60% 終結連 3 漲、惟守穩 NT$2,450 支撐相對抗跌、RSI 自 68 回落至 60 退出漸近超買、KDJ J 值退出超買、MACD 紅柱縮短仍為正；上方壓力 NT$2,505 / NT$2,535 史高、下方支撐 NT$2,450 / NT$2,410；🚀 Nomura 上調目標 NT$3,425 + 漲價定價力+共識偏多 vs ⚠️ 6 月營收與下游需求雜訊拉鋸；7/3 台股盤中待 TWSE",
}
...
DERIVATIVES = {
    ...
    "pcr_signal":    "中性（Put/Call 7/2 估自 0.72 微升至 0.73；台股 7/2 補跌 -1.60% 跟進 NYSE 7/1 重挫、避險買盤續增、期貨維持逆價差；⭐ 惟台股相對抗跌、守穩 NT$2,450、Nomura 上調目標 NT$3,425 + 共識偏多為中長線支撐）",
...
# 供應鏈與客戶股價（需每日更新）
ECOSYSTEM_STOCKS = [
    # 類別、股票代碼、名稱、收盤價、漲跌幅、備註（美股為 2026-07-01 Wed 收盤估、台股為 7/2 Thu 收盤；價格為估算，7/1 美股半導體隨 TSM 重挫拉回、台股 7/2 跟進補跌但相對抗跌）
...
CONSENSUS = {
    ...
    "low_target":   "NT$2,100",
    "avg_target_us":"US$487.56",    # 分析師 12 個月平均目標（7/1 最新彙整、17 位分析師 Strong Buy、0 賣出；自 7/1 收 $444.23 具 +9.8% 上行空間；Nomura 7/1 上調台股目標至 NT$3,425）
    "analyst_count": 32,
...
NEWS = [
    {
        ...
        "title": "📉 補跌兌現、惟相對抗跌：台股 2330 7/2 收 NT$2,465（-1.60%）跟進 NYSE 7/1 夜盤重挫 -6.98% 補跌、終結連 3 漲，惟跌幅遠小於美股、守穩 NT$2,450 支撐",
        "body": "前報預測之台股補跌今日兌現、惟展現相對韌性：（1）📉 台股 2330 7/2 Thu 官方收盤 NT$2,465（-40、-1.60% vs 7/1 NT$2,505、量約 35,000 張）跟進 NYSE 7/1 夜盤重挫 -6.98% 跳空低開補跌、終結連 3 漲；（2）⭐ 惟跌幅（-1.60%）遠小於美股（-6.98%）、守穩 NT$2,450 心理整數支撐、盤中未破 NT$2,420，顯示補跌壓力大致釋放、台股相對抗跌；（3）📉 NYSE TSM 7/1 Wed 收 $444.23（-6.98%、-$33.34）自 6/30 史新高 $477.57 大幅回落、市值約 $2.30 兆（P/E ~38.6），為 7/2 台股報告時最新確認收盤，盤後回升 +$3.35 至約 $447.58 顯示殺盤趨緩、7/2 美股盤待今晚開盤；（4）📊 台美 ADR 溢價自 +10.13% 微升至 +11.91%（以 7/1 ADR $444.23 + 台股 7/2 NT$2,465、匯率 31.05 計、理論值 $396.94），台股相對抗跌。",
        "source": "Yahoo 奇摩股市 / TradingKey / Yahoo Finance / Google Finance 2026-07-02", "impact": "負面",
    },
    {
        "tag": "產業趨勢", "tag_color": "#4CAF50",
        "title": "🚀 Nomura（野村）大幅上調 TSM 目標價自 NT$2,820 至 NT$3,425（+21.5% 上調、自 7/2 收 NT$2,465 具 +38.9% 空間）——AI 投資循環尚未見頂",
        "body": "重大分析師利多、印證 AI 結構性成長論述：（1）🚀 Nomura 證券 7/1 大幅上調 TSMC 目標價自 NT$2,820 至 NT$3,425（上調幅度約 +21.5%），為近期最積極的目標價之一、自 7/2 收 NT$2,465 隱含約 +38.9% 上行空間；（2）📈 Nomura 分析師認為 AI 基礎設施投資循環尚未見頂，預期資料中心新增產能將於 2027 年升至約 32GW，指向 AI 晶片需求延續、TSMC 先進製程與 CoWoS 封裝為核心受惠者；（3）📊 分析師共識仍全面偏多——17 位 Strong Buy、0 賣出、12 個月平均目標 $487.56（自 7/1 收 $444.23 具 +9.8% 上行空間），視 7/1 拉回為估值修正而非基本面惡化；（4）⭐ TSMC 上修 2026 美元營收成長目標至 30% 以上、Q2 指引 $39.0-40.2B、毛利率 65-67%。",
        "source": "GuruFocus / Nomura / 鉅亨網 2026-07-01", "impact": "正面",
    },
    {
        "tag": "客戶動態", "tag_color": "#2196F3",
        "title": "🏆 NVIDIA Vera Rubin AI 平台 6 顆晶片全數 TSMC 代工、包下多數 CoWoS 產能；確認 TSMC #1 客戶（22%/$33B）、A16 首發客戶 2026 下半/2027 量產",
        "body": "客戶結構印證 AI 主導的產業轉變：（1）🏆 NVIDIA 下一代 Vera Rubin AI 運算平台採「6 顆並行晶片」策略（自過往 1-2 顆大幅擴增），全數由 TSMC 代工——標誌 NVIDIA 對 TSMC 產能依賴進一步加深；（2）📦 NVIDIA 已包下 TSMC 多數 CoWoS 先進封裝產能、產能吃緊致 TSMC 將部分較簡易製程委外予 ASE 與 Amkor；（3）🏆 NVIDIA 確認超越 Apple 成 TSMC 最大客戶（約 22%、$33B），傳為最先進 A16 製程首發客戶（2026 下半/2027 量產）；Apple 仍為第 2 大客戶（約 18%）、選擇跳過 A16 直上 A14；（4）⚠️ 主要客戶（NVIDIA/AMD/Apple/Qualcomm/Broadcom/MediaTek）面臨 TSMC 漲價成本，Benzinga 指 NVIDIA 因需求剛性與轉嫁能力強、長期反為利多。",
        "source": "CNBC / Taipei Times / TweakTown / NVIDIA Newsroom 2026-07-01", "impact": "正面",
    },
    {
