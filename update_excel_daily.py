...
tw_price = "NT$2,385"          # 6/18 Thu 實際收盤（+10，+0.42% vs 6/17 實際 NT$2,375；跟進 NYSE 6/17 +1.48% 反彈、漲幅收斂；6/19 端午節休市）
change_pct = "+0.42%"          # 6/18 漲跌幅（跟進 NYSE 6/17 反彈、惟漲幅收斂、TAIEX 僅 +68 點近平盤）
