...
news_summary = "報告日2026-07-20(Mon)。⚠️⚠️全球AI晶片股正式跌入熊市：SOX 7/17收-1.6%(盤中一度-5.7%)、自6/22史高回落-20.2%、單週-9%(3-6月曾自低點飆+105%)；催化：中國Moonshot發表號稱全球最大開源AI模型Kimi K3、Alphabet傳Gemini 3.5 Pro交付落後——AI投資報酬疑慮引爆全面獲利了結；MRVL/ARM/INTC自高點已-30%+。📉台股同步史詩級崩跌：2330 7/17官方收NT$2,290(-180、-7.29%、收盤即當日最低、量爆增97,362張、額2,290億、前日3.2倍)；三大法人7/17合計賣超逾2,617億元創台股史上單日最大、外資提款台積電破千億——2330遭外資賣超44,184張(連7賣、買17,479/賣61,663)；惟投信+1,489(連2買)、自營+2,759(連7買)逆勢承接、合計賣超39,936張。📊台美ADR溢價逆勢擴大至+12.0%($398.37 vs理論值$355.6、匯率~32.2)——台股-7.29%超跌於ADR-2.77%、隱含7/20週一具技術性反彈空間。✅關鍵：本波為AI估值/情緒修正、非基本面惡化——Q2法說會(7/16)大超預期完全未變：營收$40.20B(+33.7% YoY)、EPS$4.31/ADR(+77.4%、連11季超預期)、毛利率67.7%；全年成長上修>40%、CapEx上調$60-64B(含Arizona追加$100B)、股利+33%；管理層:「AI需求比預期更強」——股價與基本面短線脫鉤。💡估值大幅消化：台股P/E降至~26.2x TTM、TSM~29.2x。技術面：跌破5MA~2,412/20MA~2,426、回測60MA~2,331、RSI~40.5、MACD綠柱擴大至-13、KDJ K32/D40/J16死叉墜超賣；支撐2,255/2,200/2,150、壓力2,331/2,412/2,470。⚠️風險：AI情緒面能否止穩、外資連7史詩級賣超能否止穩為兩大變數；美232關稅25%+輸中晶片轉運查驗、Intel 18A競爭。"
